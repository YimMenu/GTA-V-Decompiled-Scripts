								...
								if (!func_80())
								{
									...
									while (iVar0 < 4)
									{
										if (bLocal_110)
										{
											...
											func_74(uLocal_88[0], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_56, &uLocal_59, &Local_61, &uLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_74(uLocal_88[1], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_56, &uLocal_59, &Local_61, &uLocal_60, &uLocal_62, 0f, 2f, 0f, 1000, 0f);
										...
										else if (bLocal_107)
										{
											...
											func_74(uLocal_86[0], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_56, &uLocal_59, &Local_61, &uLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_74(uLocal_86[1], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_56, &uLocal_59, &Local_61, &uLocal_60, &uLocal_62, 0f, 5f, 0f, 1000, 0f);
										...
										else if (bLocal_108)
										{
											...
											func_74(uLocal_87[0], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_56, &uLocal_59, &Local_61, &uLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_74(uLocal_87[1], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_56, &uLocal_59, &Local_61, &uLocal_60, &uLocal_62, 0f, 5f, 0f, 1000, 0f);
...
void func_74(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, struct<3> Param7, int iParam8, float fParam9)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (((((((ENTITY::DOES_ENTITY_EXIST(iParam1) && iParam0 != iParam1) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iParam1))) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(iParam1)) && func_78(iParam0))
		{
			...
			{
				if (func_76(iParam0, iParam1, 1) > fParam9 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam1, 1), *uParam2, 1) > 20f)
				{
					if (!func_75(*uParam2))
					{
						...
						{
							Var0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_61, uLocal_60, Param7) };
							if (!func_75(Var0))
							{
...
void func_81()
{
	...
	{
		case 0:
			if (((PLAYER::_0x5FC472C501CCADB3(PLAYER::PLAYER_ID()) || !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_100 + Vector(0f, 20f, 0f), 170f, 270f, 50f, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1555.4f, 4730.817f, 49.1791f, 15f, 25f, 15f, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1709.211f, 4659.571f, 36.688f, 15f, 25f, 15f, 0, 1, 0))
			{
				if (!bLocal_110)
				{
		...
		case 3:
			Local_103 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
		...
		case 3:
			...
			if (bLocal_107)
			{
				...
				while (iVar2 < 4)
				{
					...
					{
						if ((!PED::IS_PED_IN_COMBAT(uLocal_83[iVar2], 0) && TASK::GET_SCRIPT_TASK_STATUS(uLocal_83[iVar2], 579380604) != 1) && TASK::GET_SCRIPT_TASK_STATUS(uLocal_83[iVar2], 579380604) != 0)
						{
			...
			if (bLocal_108)
			{
				...
				while (iVar3 < 4)
				{
					...
					{
						if ((!PED::IS_PED_IN_COMBAT(uLocal_84[iVar3], 0) && TASK::GET_SCRIPT_TASK_STATUS(uLocal_84[iVar3], 579380604) != 1) && TASK::GET_SCRIPT_TASK_STATUS(uLocal_84[iVar3], 579380604) != 0)
						{
...
void func_106()
{
	...
	else
	{
		...
		if (!PED::IS_PED_INJURED(uLocal_81[7]))
		{
			if (((((TASK::GET_SCRIPT_TASK_STATUS(uLocal_81[7], 1785177548) != 1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_81[7], 1785177548) != 0) || FIRE::IS_ENTITY_ON_FIRE(uLocal_81[7])) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_81[7])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uLocal_81[7])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uLocal_81[7]))
			{
				ENTITY::SET_ENTITY_HEALTH(uLocal_81[7], 0, 0);
			}
		}
		if (!PED::IS_PED_INJURED(uLocal_80))
		{
			if (((((TASK::GET_SCRIPT_TASK_STATUS(uLocal_80, 1785177548) != 1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_80, 1785177548) != 0) || FIRE::IS_ENTITY_ON_FIRE(uLocal_80)) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_80)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uLocal_80)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uLocal_80))
			{
				ENTITY::SET_ENTITY_HEALTH(uLocal_80, 0, 0);
			}
		}
...
void func_117()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uLocal_85[0], 0))
	{
		...
		{
			AUDIO::_0x9D3AF56E94C9AE98(uLocal_85[0], 60000f);
			AUDIO::_SOUND_VEHICLE_HORN_THIS_FRAME(uLocal_85[0]);
		}
	}
	if (!PED::IS_PED_INJURED(uLocal_80))
	{
	...
	else if (HUD::DOES_BLIP_EXIST(uLocal_91))
	{
		HUD::REMOVE_BLIP(&uLocal_91);
	}
	iVar0 = 0;
...
void func_118()
{
	...
	if ((((((((STREAMING::HAS_MODEL_LOADED(joaat("g_m_m_chigoon_02")) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_salvagoon_03"))) && STREAMING::HAS_MODEL_LOADED(joaat("rebel"))) && STREAMING::HAS_MODEL_LOADED(joaat("bobcatxl"))) && STREAMING::HAS_MODEL_LOADED(joaat("sanchez"))) && STREAMING::HAS_MODEL_LOADED(joaat("a_c_rottweiler"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_security_case_01"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@dealgonewrong")) && STREAMING::HAS_ANIM_DICT_LOADED("random@dealgonewrongdead_peds"))
	{
		...
		uLocal_99[0] = GRAPHICS::ADD_DECAL(1110, -1632.953f, 4745.359f, 51.7876f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_99[1] = GRAPHICS::ADD_DECAL(1110, -1634.87f, 4744.458f, 51.8233f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_99[2] = GRAPHICS::ADD_DECAL(1110, -1636.971f, 4736.595f, 52.2814f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_99[3] = GRAPHICS::ADD_DECAL(1110, -1625.561f, 4741.241f, 51.7102f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_99[4] = GRAPHICS::ADD_DECAL(1110, -1621.533f, 4744.576f, 51.9093f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_99[5] = GRAPHICS::ADD_DECAL(1110, -1621.963f, 4737.039f, 51.4174f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_99[6] = GRAPHICS::ADD_DECAL(1110, -1628.517f, 4736.906f, 51.8207f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_99[7] = GRAPHICS::ADD_DECAL(1110, -1629.324f, 4732.146f, 51.6947f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_99[8] = GRAPHICS::ADD_DECAL(1110, -1640.287f, 4738.437f, 52.1756f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_99[9] = GRAPHICS::ADD_DECAL(1110, -1640.055f, 4701.995f, 41.2428f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_99[10] = GRAPHICS::ADD_DECAL(1110, -1641.924f, 4692.236f, 38.3762f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		iVar1 = 0;
		while (iVar1 < 6)
		{
...
void func_120()
{
	...
	while (iVar0 < 5)
	{
		...
		{
			Local_53 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_85[iVar0], 0f, 0f, 0.5f) };
		}
		iLocal_77 = 0;
		while (iLocal_77 < 5)
		{
