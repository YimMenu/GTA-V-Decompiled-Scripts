								...
								if (!func_80())
								{
									...
									while (iVar0 < 4)
									{
										if (bLocal_267)
										{
											...
											func_74(uLocal_176[0], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &Local_113, &uLocal_112, &uLocal_116, 0f, 0f, 0f, 1000, 0f);
											func_74(uLocal_176[1], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &Local_113, &uLocal_112, &uLocal_116, 0f, 2f, 0f, 1000, 0f);
										...
										else if (bLocal_264)
										{
											...
											func_74(uLocal_166[0], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &Local_113, &uLocal_112, &uLocal_116, 0f, 0f, 0f, 1000, 0f);
											func_74(uLocal_166[1], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &Local_113, &uLocal_112, &uLocal_116, 0f, 5f, 0f, 1000, 0f);
										...
										else if (bLocal_265)
										{
											...
											func_74(uLocal_171[0], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &Local_113, &uLocal_112, &uLocal_116, 0f, 0f, 0f, 1000, 0f);
											func_74(uLocal_171[1], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &Local_113, &uLocal_112, &uLocal_116, 0f, 5f, 0f, 1000, 0f);
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam2))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam2, 0))
		{
			...
			if (!HUD::DOES_BLIP_EXIST(*uParam3))
			{
				if (iVar0 == 1)
				{
					*uParam3 = func_70(ENTITY::GET_ENTITY_COORDS(*uParam2, 1), 0);
...
void func_74(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, struct<3> Param7, int iParam10, float fParam11)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (((((((ENTITY::DOES_ENTITY_EXIST(iParam1) && iParam0 != iParam1) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iParam1))) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(iParam1)) && func_78(iParam0))
		{
			...
			{
				if (func_76(iParam0, iParam1, 1) > fParam11 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam1, 1), *uParam2, 1) > 20f)
				{
					if (!func_75(*uParam2))
					{
						...
						{
							Var0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_113, uLocal_112, Param7) };
							if (!func_75(Var0))
							{
...
void func_81()
{
	...
	{
		case 0:
			if (((PLAYER::_0x5FC472C501CCADB3(PLAYER::PLAYER_ID()) || !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_234 + Vector(0f, 20f, 0f), 170f, 270f, 50f, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1555.4f, 4730.817f, 49.1791f, 15f, 25f, 15f, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1709.211f, 4659.571f, 36.688f, 15f, 25f, 15f, 0, 1, 0))
			{
				if (!bLocal_267)
				{
		...
		case 2:
			...
			if (SYSTEM::TIMERA() > 10000)
			{
				...
				{
					if (!PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), -1207771834))
					{
						iLocal_48 = 3;
					}
					else
		...
		case 3:
			Local_243 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
			...
			{
				if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Local_243, uLocal_132, &(Local_439[0]), 1, 1077936128, 0))
				{
					Local_439[1] = { Local_439[0] + Vector(0f, 5f, 0f) };
					if (!CAM::IS_SPHERE_VISIBLE(Local_439[0], 7f) && !CAM::IS_SPHERE_VISIBLE(Local_439[1], 7f))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_166[0], 0))
						{
							ENTITY::SET_ENTITY_COORDS(uLocal_166[0], Local_439[0], 1, 0, 0, 1);
							func_98(uLocal_166[0], uLocal_150[0]);
						}
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_166[1], 0))
						{
							ENTITY::SET_ENTITY_COORDS(uLocal_166[1], Local_439[1], 1, 0, 0, 1);
			...
			if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1603.153f, 4892.943f, 60.1768f, 225f, 225f, 50f, 0, 1, 0))
			{
				if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Local_243, uLocal_132, &(Local_439[0]), 1, 1077936128, 0))
				{
					...
					if (!CAM::IS_SPHERE_VISIBLE(Local_439[0], 7f) && !CAM::IS_SPHERE_VISIBLE(Local_439[1], 7f))
					{
						...
						{
							ENTITY::SET_ENTITY_COORDS(uLocal_171[0], Local_439[0], 1, 0, 0, 1);
							func_98(uLocal_171[0], uLocal_155[0]);
						}
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_171[1], 0))
						{
							ENTITY::SET_ENTITY_COORDS(uLocal_171[1], Local_439[1], 1, 0, 0, 1);
		...
		case 5:
			...
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Local_243, uLocal_132, &(Local_439[0]), 1, 1077936128, 0))
			{
				...
				if (!CAM::IS_SPHERE_VISIBLE(Local_439[0], 7f) && !CAM::IS_SPHERE_VISIBLE(Local_439[1], 7f))
				{
					...
					{
						ENTITY::SET_ENTITY_COORDS(uLocal_176[0], Local_439[0], 1, 0, 0, 1);
						func_98(uLocal_176[0], uLocal_150[0]);
					}
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_176[1], 0))
					{
						ENTITY::SET_ENTITY_COORDS(uLocal_176[1], Local_439[1], 1, 0, 0, 1);
		...
		case 6:
			if (func_68())
			{
				...
				if (iLocal_134 < 5 && iLocal_135 < MISC::GET_GAME_TIMER())
				{
					...
					MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS((Local_90.x + fLocal_120), (Local_90.y + fLocal_121), (Local_90.z + fLocal_122), (Local_90.x - fLocal_120), (Local_90.y - fLocal_121), Local_90.z, 10, 0, -1074790547, 0, 1, 1, -1082130432);
...
void func_98(int iParam0, var uParam1)
{
	...
	Local_436 = { ENTITY::GET_ENTITY_COORDS(iParam0, 1) };
	Local_452 = { Local_243 - Local_436 };
	ENTITY::SET_ENTITY_HEADING(iParam0, MISC::GET_HEADING_FROM_VECTOR_2D(Local_452.x, Local_452.y));
	if (bLocal_267)
	{
...
void func_99()
{
	uLocal_166[0] = VEHICLE::CREATE_VEHICLE(-1207771834, -1595.964f, 4732.479f, 0f, 305f, 1, 1, 0);
	...
	uLocal_166[1] = VEHICLE::CREATE_VEHICLE(-1207771834, -1570.34f, 4733.755f, 0f, 305f, 1, 1, 0);
	...
	uLocal_176[0] = VEHICLE::CREATE_VEHICLE(788045382, Vector(0f, 4732.479f, -1595.964f) + Vector(10f, 10f, 10f), 305f, 1, 1, 0);
	...
	uLocal_176[1] = VEHICLE::CREATE_VEHICLE(788045382, Vector(0f, 4733.755f, -1570.34f) + Vector(10f, 10f, 10f), 305f, 1, 1, 0);
	...
	uLocal_150[0] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_166[0], 26, -9308122, -1, 1, 1);
	uLocal_150[1] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_166[1], 26, -9308122, -1, 1, 1);
	if (!bLocal_267)
	{
		uLocal_150[2] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_166[0], 26, -9308122, 0, 1, 1);
		uLocal_150[3] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_166[1], 26, -9308122, 0, 1, 1);
	}
	uLocal_171[0] = VEHICLE::CREATE_VEHICLE(1069929536, -1356.281f, 5000f, 0f, 125.2811f, 1, 1, 0);
	...
	uLocal_171[1] = VEHICLE::CREATE_VEHICLE(1069929536, -1373.589f, 5000f, 0f, 125.459f, 1, 1, 0);
	...
	uLocal_155[0] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_171[0], 26, 62440720, -1, 1, 1);
	uLocal_155[1] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_171[1], 26, 62440720, -1, 1, 1);
	uLocal_155[2] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_171[0], 26, 62440720, 0, 1, 1);
	uLocal_155[3] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_171[1], 26, 62440720, 0, 1, 1);
	...
	while (iVar0 < 4)
	{
		if (!PED::IS_PED_INJURED(uLocal_150[iVar0]))
		{
			...
			if (bLocal_267)
			{
				WEAPON::GIVE_WEAPON_TO_PED(uLocal_150[0], 2017895192, -1, 1, 1);
				if (!PED::IS_PED_INJURED(uLocal_150[1]))
				{
					WEAPON::GIVE_WEAPON_TO_PED(uLocal_150[1], 453432689, -1, 1, 1);
				}
			...
			{
				WEAPON::GIVE_WEAPON_TO_PED(uLocal_150[iVar0], 453432689, -1, 1, 1);
	...
	while (iVar0 < 4)
	{
		if (!PED::IS_PED_INJURED(uLocal_150[iVar0]))
		{
			...
			{
				WEAPON::GIVE_WEAPON_TO_PED(uLocal_155[iVar0], 453432689, -1, 1, 1);
	...
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-9308122);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(62440720);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1207771834);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(1069929536);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(788045382);
		...
		case 3:
			...
			if (bLocal_264)
			{
				...
				while (iVar2 < 4)
				{
					...
					{
						if ((!PED::IS_PED_IN_COMBAT(uLocal_150[iVar2], 0) && TASK::GET_SCRIPT_TASK_STATUS(uLocal_150[iVar2], 579380604) != 1) && TASK::GET_SCRIPT_TASK_STATUS(uLocal_150[iVar2], 579380604) != 0)
						{
			...
			if (bLocal_265)
			{
				...
				while (iVar3 < 4)
				{
					...
					{
						if ((!PED::IS_PED_IN_COMBAT(uLocal_155[iVar3], 0) && TASK::GET_SCRIPT_TASK_STATUS(uLocal_155[iVar3], 579380604) != 1) && TASK::GET_SCRIPT_TASK_STATUS(uLocal_155[iVar3], 579380604) != 0)
						{
	...
	else
	{
		...
		while (iVar0 < 9)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_137[iVar0]))
			{
				...
				else if (HUD::DOES_BLIP_EXIST(uLocal_184[iVar0]))
				{
		...
		if (!func_134())
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_52[7], 110f, 95f, 40f, 0, 1, 0))
			{
				if (HUD::DOES_BLIP_EXIST(uLocal_181))
				{
					HUD::REMOVE_BLIP(&uLocal_181);
		...
		if (!PED::IS_PED_INJURED(uLocal_137[7]))
		{
			if (((((TASK::GET_SCRIPT_TASK_STATUS(uLocal_137[7], 1785177548) != 1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_137[7], 1785177548) != 0) || FIRE::IS_ENTITY_ON_FIRE(uLocal_137[7])) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_137[7])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uLocal_137[7])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uLocal_137[7]))
			{
				ENTITY::SET_ENTITY_HEALTH(uLocal_137[7], 0, 0);
			}
		}
...
void func_117()
{
	...
	else if (HUD::DOES_BLIP_EXIST(uLocal_183))
	{
		HUD::REMOVE_BLIP(&uLocal_183);
	}
	iVar0 = 0;
...
void func_118()
{
	STREAMING::REQUEST_MODEL(-9308122);
	STREAMING::REQUEST_MODEL(62440720);
	...
	if ((((((((STREAMING::HAS_MODEL_LOADED(-9308122) && STREAMING::HAS_MODEL_LOADED(62440720)) && STREAMING::HAS_MODEL_LOADED(-1207771834)) && STREAMING::HAS_MODEL_LOADED(1069929536)) && STREAMING::HAS_MODEL_LOADED(788045382)) && STREAMING::HAS_MODEL_LOADED(-1788665315)) && STREAMING::HAS_MODEL_LOADED(-1249748547)) && STREAMING::HAS_ANIM_DICT_LOADED("random@dealgonewrong")) && STREAMING::HAS_ANIM_DICT_LOADED("random@dealgonewrongdead_peds"))
	{
		...
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(-1207771834, 1);
		MISC::ENABLE_DISPATCH_SERVICE(5, 0);
		MISC::ENABLE_DISPATCH_SERVICE(3, 0);
		uLocal_160[0] = VEHICLE::CREATE_VEHICLE(1069929536, -1626.94f, 4729.889f, 51.3463f, 347.1188f, 1, 1, 0);
		...
		uLocal_160[1] = VEHICLE::CREATE_VEHICLE(-1207771834, -1619.432f, 4747.792f, 52.7502f, 146.6017f, 1, 1, 0);
		...
		uLocal_160[2] = VEHICLE::CREATE_VEHICLE(1069929536, -1636.216f, 4748.061f, 51.5484f, 199.3236f, 1, 1, 0);
		...
		uLocal_160[3] = VEHICLE::CREATE_VEHICLE(-1207771834, -1641.578f, 4736.783f, 52.5984f, 278.1865f, 1, 1, 0);
		...
		if (!OBJECT::DOES_PICKUP_EXIST(uLocal_214))
		{
			...
			uLocal_214 = OBJECT::CREATE_PICKUP_ROTATE(-831529621, Local_237, -72f, 0f, 42.48f, iVar0, 25000, 2, 1, -1249748547);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1249748547);
		}
		Local_246[0] = { -1640.411f, 4740.702f, 52.6218f };
		Local_246[1] = { -1624.664f, 4746.569f, 51.541f };
		Local_246[2] = { -1626.339f, 4734.232f, 51.6176f };
		Local_246[3] = { -1634.297f, 4741.213f, 51.9737f };
		Local_246[4] = { -1644.717f, 4736.446f, 52.3014f };
		iVar1 = 0;
		while (iVar1 < 5)
		{
			if (!OBJECT::DOES_PICKUP_EXIST(uLocal_215[iVar1]))
			{
				...
				if (iVar1 < 2)
				{
					uLocal_215[iVar1] = OBJECT::CREATE_PICKUP(-1766583645, Local_246[iVar1], iVar2, -1, 1, 0);
				}
				else if (iVar1 == 4)
				{
					uLocal_215[iVar1] = OBJECT::CREATE_PICKUP_ROTATE(-214137936, Local_246[iVar1], 90f, 50f, 0f, 0, 50, 2, 1, 0);
				}
				else
				{
					uLocal_215[iVar1] = OBJECT::CREATE_PICKUP(-105925489, Local_246[iVar1], iVar2, -1, 1, 0);
				}
			}
			iVar1++;
		}
		Local_52[0] = { -1636.535f, 4708.455f, 46.09f };
		fLocal_80[0] = 177.0024f;
		Local_52[1] = { -1621.19f, 4744.868f, 52.4254f };
		fLocal_80[1] = 146.9645f;
		Local_52[2] = { -1622.795f, 4735.975f, 51.474f };
		fLocal_80[2] = 48.6546f;
		Local_52[3] = { -1632.695f, 4742.906f, 51.8604f };
		fLocal_80[3] = 155.0678f;
		Local_52[4] = { -1629.544f, 4738.6f, 52.1784f };
		fLocal_80[4] = 278.3085f;
		Local_52[5] = { -1634.764f, 4745.188f, 51.3926f };
		fLocal_80[5] = 270.3501f;
		Local_52[7] = { -1628.321f, 4731.502f, 51.7644f };
		fLocal_80[7] = 352.9167f;
		Local_52[6] = { -1640.311f, 4738.4f, 52.2f };
		...
		while (iVar1 < 6)
		{
			if (iVar1 <= 3)
			{
				uLocal_137[iVar1] = PED::CREATE_PED(22, 62440720, Local_52[iVar1], fLocal_80[iVar1], 1, 1);
				PED::SET_PED_CONFIG_FLAG(uLocal_137[iVar1], 227, 1);
			}
			else
			{
				uLocal_137[iVar1] = PED::CREATE_PED(22, -9308122, Local_52[iVar1], fLocal_80[iVar1], 1, 1);
			}
			iVar1++;
		}
		iLocal_147[0] = PED::CREATE_PED(26, -1788665315, -1635.005f, 4737.181f, 53.4995f, 33.4155f, 1, 1);
		iLocal_147[1] = PED::CREATE_PED(26, -1788665315, -1625.215f, 4741.119f, 52.5762f, 316.2733f, 1, 1);
		iVar1 = 0;
		while (iVar1 < iLocal_147)
		{
			...
			Local_90 = { ENTITY::GET_ENTITY_COORDS(iLocal_147[iVar1], 1) };
			Local_93 = { Local_90.x, (Local_90.y - 2f), (Local_90.z - 0.5f) };
			Local_96 = { Local_90.x, (Local_90.y + 50f), (Local_90.z - 0.5f) };
			MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Local_93, Local_96, 100, 1, -1074790547, 0, 1, 1, -1082130432);
			iVar1++;
		}
		...
		{
			uLocal_137[8] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_160[0], 26, 62440720, -1, 1, 1);
		...
		uLocal_137[6] = PED::CREATE_PED(22, -9308122, Local_52[6], fLocal_80[6], 1, 1);
		...
		uVar3 = PED::CREATE_SYNCHRONIZED_SCENE(Local_52[6] + Vector(1.05f, 0f, 0f), -7f, 0f, 34.1111f, 0);
		...
		uLocal_137[7] = PED::CREATE_PED(22, 62440720, -1640.311f, 4738.4f, 50.2f, fLocal_80[7], 1, 1);
		...
		uVar4 = PED::CREATE_SYNCHRONIZED_SCENE(Local_52[7] + Vector(0.92f, 0.65f, -0.65f), 0f, 0f, 34.1111f, 0);
		...
		uLocal_136 = PED::CREATE_PED(22, -9308122, Local_117, fLocal_123, 1, 1);
		...
		uLocal_221[0] = GRAPHICS::ADD_DECAL(1110, -1632.953f, 4745.359f, 51.7876f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_221[1] = GRAPHICS::ADD_DECAL(1110, -1634.87f, 4744.458f, 51.8233f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_221[2] = GRAPHICS::ADD_DECAL(1110, -1636.971f, 4736.595f, 52.2814f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_221[3] = GRAPHICS::ADD_DECAL(1110, -1625.561f, 4741.241f, 51.7102f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_221[4] = GRAPHICS::ADD_DECAL(1110, -1621.533f, 4744.576f, 51.9093f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_221[5] = GRAPHICS::ADD_DECAL(1110, -1621.963f, 4737.039f, 51.4174f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_221[6] = GRAPHICS::ADD_DECAL(1110, -1628.517f, 4736.906f, 51.8207f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_221[7] = GRAPHICS::ADD_DECAL(1110, -1629.324f, 4732.146f, 51.6947f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_221[8] = GRAPHICS::ADD_DECAL(1110, -1640.287f, 4738.437f, 52.1756f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_221[9] = GRAPHICS::ADD_DECAL(1110, -1640.055f, 4701.995f, 41.2428f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		SYSTEM::WAIT(0);
		uLocal_221[10] = GRAPHICS::ADD_DECAL(1110, -1641.924f, 4692.236f, 38.3762f, 0f, 0f, -1f, func_119(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		iVar1 = 0;
		while (iVar1 < 6)
		{
...
void func_120()
{
	...
	while (iVar0 < 5)
	{
		...
		{
			Local_99 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_160[iVar0], 0f, 0f, 0.5f) };
		}
		iLocal_133 = 0;
		while (iLocal_133 < 5)
		{
			...
			fLocal_122 = MISC::GET_RANDOM_FLOAT_IN_RANGE(0.1f, 2f);
			SYSTEM::WAIT(0);
			Local_102 = { (Local_99.x - fLocal_120), (Local_99.y - fLocal_121), (Local_99.z + fLocal_122) };
			Local_105 = { (Local_99.x + fLocal_120), (Local_99.y + fLocal_121), Local_99.z };
			MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Local_102, Local_105, 1, 0, -1074790547, 0, 1, 1, -1082130432);
			Local_102 = { (Local_99.x + fLocal_120), (Local_99.y + fLocal_121), (Local_99.z + fLocal_122) };
			Local_105 = { (Local_99.x - fLocal_120), (Local_99.y - fLocal_121), Local_99.z };
			MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Local_102, Local_105, 1, 0, -1074790547, 0, 1, 1, -1082130432);
			Local_102 = { (Local_99.x + fLocal_120), (Local_99.y - fLocal_121), (Local_99.z + fLocal_122) };
			...
			Local_105 = { (Local_99.x + fLocal_120), (Local_99.y - fLocal_121), Local_99.z };
			MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Local_102, Local_105, 1, 0, -1074790547, 0, 1, 1, -1082130432);
			Local_102 = { Local_99.x, (Local_99.y + fLocal_121), (Local_99.z + fLocal_122) };
			Local_105 = { Local_99.x, (Local_99.y - fLocal_121), Local_99.z };
			MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Local_102, Local_105, 1, 0, -1074790547, 0, 1, 1, -1082130432);
			iLocal_133++;
		}
		iVar0++;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_172()) || Global_30770) || func_171()) || func_95(8, -1)) || func_168()) || func_170()) || func_169()) || func_167()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_172()) || Global_110685) || Global_30770) || func_171()) || func_95(8, -1)) || func_170()) || func_169()) || func_167()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_172()) || Global_30770) || func_171()) || func_95(8, -1)) || func_169()) || func_168()) || func_167()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
