		...
		switch (Local_409.f_410)
		{
			...
			case 1:
				if (func_282())
				{
					func_281();
					func_261();
					func_260(&(Local_842[0]), "TAXI_SC_BN_08", 500);
			...
			case 9:
				...
				if (func_138(&Local_409, 5f, 1097859072, 1117782016))
				{
					...
					{
						AI::TASK_LOOK_AT_COORD(Local_409.f_3, -713.4489f, -153.4094f, 37.1441f, 10000, 2049, 3);
					...
					{
						AI::TASK_LOOK_AT_COORD(Local_409.f_3, -1196.372f, -772.4608f, 17.30166f, 10000, 2049, 3);
						Local_409.f_56 = 25;
						Local_409.f_108 = 0;
					}
					else
					{
						AI::TASK_LOOK_AT_COORD(Local_409.f_3, 72.87311f, -1392.597f, 29.76223f, 10000, 2049, 3);
						Local_409.f_56 = 0;
						Local_409.f_108 = 1;
					}
					func_132(&Local_409);
			...
			case 27:
				if (func_116(&Local_409, 1))
				{
					...
					AI::CLEAR_SEQUENCE_TASK(&uLocal_850);
					AI::OPEN_SEQUENCE_TASK(&uLocal_850);
					AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_409.f_29, 1f, -1, 1048576000, 0, 1193033728);
					AI::TASK_USE_NEAREST_SCENARIO_TO_COORD(0, Local_409.f_29, 15f, 5000);
					AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_1497, 1f, -1, 1048576000, 0, 1193033728);
					AI::TASK_USE_NEAREST_SCENARIO_TO_COORD(0, Local_1497, 15f, 0);
					AI::CLOSE_SEQUENCE_TASK(uLocal_850);
					AI::TASK_PERFORM_SEQUENCE(Local_409.f_3, uLocal_850);
...
int func_139(var uParam0, int iParam1)
{
	...
	else if (((ENTITY::IS_ENTITY_AT_COORD(uParam0->f_4, uParam0->f_17, (iParam1 + 1f), (iParam1 + 1f), 2f, !uParam0->f_140, 1, 0) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) < 1) && func_140(1, 1, 1)) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(uParam0->f_4))
	{
		return func_122(uParam0, 1, iParam1);
	}
	return 0;
...
int func_169(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_170(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_179()
{
	...
	iLocal_840 = func_180(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_409.f_427, -1, 0, 1, -1);
	if (iLocal_840 != -1)
	{
		iVar0 = func_180(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_409.f_427, -1, 0, 1, -1);
		if (!func_41(Local_409.f_17, Local_857[iVar0], 0))
		{
			Local_409.f_17 = { Local_857[iVar0] };
			Local_409.f_29 = { Local_1017[iVar0] };
			Local_409.f_26 = { Local_1177[iVar0] };
			Local_409.f_34 = fLocal_1508[iVar0];
			Local_1497 = { Local_1337[iVar0] };
		}
	}
}
...
int func_180(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_198(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Param0, func_181(iVar0, 0), 1);
...
int func_196(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_60() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_94(func_197(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_199()
{
	...
	while (iVar0 < 3)
	{
		if (UI::DOES_BLIP_EXIST(uLocal_846[iVar0]))
		{
			UI::SET_BLIP_ALPHA(uLocal_846[iVar0], 255);
		}
		iVar0++;
	}
}
...
void func_200()
{
	...
	while (iVar0 < 3)
	{
		if (UI::DOES_BLIP_EXIST(uLocal_846[iVar0]))
		{
			UI::SET_BLIP_ALPHA(uLocal_846[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_206(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	*uParam0 = UI::ADD_BLIP_FOR_COORD(func_181(iParam1, 0));
	UI::SET_BLIP_SPRITE(*uParam0, iParam2);
	UI::SET_BLIP_COLOUR(*uParam0, iParam3);
	UI::SET_BLIP_NAME_FROM_TEXT_FILE(*uParam0, func_207(iParam1, 0));
...
void func_209()
{
	Local_857[0] = { -829.8521f, -192.3817f, 36.3936f };
	Local_857[1] = { 129.8964f, -1716.632f, 28.0725f };
	Local_857[7] = { 88.1425f, -1391.791f, 28.1999f };
	Local_857[14] = { -1210.999f, -785.9365f, 16.0056f };
	Local_857[18] = { -723.8204f, -160.7985f, 35.92944f };
	Local_857[22] = { 339.2214f, 158.9484f, 102.1509f };
	Local_857[28] = { 15.1447f, -1127.161f, 27.7764f };
	Local_1017[0] = { -815.6819f, -183.7194f, 36.5695f };
	Local_1017[1] = { 136.1871f, -1712.069f, 28.2916f };
	Local_1017[7] = { 84.2585f, -1379.562f, 28.2919f };
	Local_1017[14] = { -1206.156f, -777.4578f, 16.3283f };
	Local_1017[18] = { -716.0551f, -160.1741f, 35.98816f };
	Local_1017[22] = { 342.1741f, 172.9035f, 102.1543f };
	Local_1017[28] = { 22.1268f, -1109.868f, 28.797f };
	Local_1337[7] = { 76.3885f, -1397.665f, 28.3719f };
	Local_1337[14] = { -1193.429f, -769.2299f, 16.3289f };
	Local_1337[18] = { -710.8855f, -152.4612f, 36.4106f };
	Local_1177[0] = { -821.3112f, -207.0323f, 36.3333f };
	Local_1177[1] = { 138.4111f, -1726.907f, 28.0569f };
	Local_1177[7] = { 96.1429f, -1407.346f, 28.1563f };
	Local_1177[14] = { -1202.809f, -795.3967f, 15.2069f };
	Local_1177[18] = { -710.7402f, -178.9253f, 35.8931f };
	Local_1177[22] = { 348.4406f, 156.2108f, 101.9483f };
	Local_1177[28] = { 40.1115f, -1113.923f, 28.1427f };
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, 0))
	{
		...
		else
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_3, 0))
			{
				...
				{
					case 0:
						if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) != 1 || ((func_164(PLAYER::PLAYER_PED_ID(), uParam0->f_3, 1) < 20f && func_141(uParam0->f_3, uParam0->f_11, 1) <= 28f) && func_141(uParam0->f_4, uParam0->f_11, 1) <= 28f))
						{
					...
					case 1:
						...
						else
						{
							...
							else if (((AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) != 1 && AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) != 0) && AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) != 7) && func_247(uParam0, uParam0->f_3) > 8f)
							{
...
{
	if (func_234() && GAMEPLAY::GET_GAME_TIMER() >= iParam0 + 1000)
	{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, uParam2, func_246(iParam3), 0);
}
...
int func_282()
{
	...
	if (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_1641))
	{
		return 0;
	}
...
int func_298(var uParam0)
{
	if (((((VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, 0) && !func_16(&(Local_190[0].f_3))) && !func_16(&(Local_190[8].f_3))) && !func_16(&(Local_190[5].f_3))) && !func_16(&(Local_190[9].f_3))) && !func_16(&(Local_190[7].f_3)))
	{
		...
		else if ((func_107(&(Local_190[14].f_3)) < 1.5f && func_164(uParam0->f_5, uParam0->f_4, 1) > 4.5f) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_5))
		{
...
bool func_300(int iParam0)
{
	...
	Var9 = { func_304((Var3.x - Var0.x), (Var3.y - Var0.y), 0f) };
	...
	Var24 = { Var24 };
	return func_301(ENTITY::GET_ENTITY_COORDS(iParam0, 1), Var15, Var18, Var21);
}
...
void func_317(var uParam0, char* sParam1, int iParam2)
{
	...
	func_431(2);
	Var0 = { func_336() };
	if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Var0) && func_52()) && !GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, "NULL"))
	{
	}
	else
	{
		...
		switch (Local_1563.f_27)
		{
			case 0:
				if (Local_409.f_410 == 9)
				{
					...
					{
						if (func_367("TX_OBJ_TTB_DO") || UI::DOES_BLIP_EXIST(Local_409.f_9))
						{
							Local_1563.f_27++;
						}
			...
			case 2:
				if (func_410(&Local_409, 18) > GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(2f, 10f))
				{
			...
			case 5:
				if (func_410(&Local_409, 18) > GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(8f, 16f))
				{
				}
				break;
			}
