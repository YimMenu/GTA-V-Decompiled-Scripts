...
void func_23()
{
	switch (iLocal_191)
	{
		case 0:
			...
			iLocal_249 = (GAMEPLAY::GET_GAME_TIMER() - 6000);
		...
		case 1:
			...
			else
			{
				...
				if (func_239())
				{
					...
					{
						AI::OPEN_SEQUENCE_TASK(&uLocal_261);
						AI::TASK_PLANE_MISSION(0, Local_156.x, 0, 0, 3891.478f, 2298.554f, 301.6707f, 4, 40f, 10f, -1f, 300, 30, 1);
						AI::TASK_PLANE_MISSION(0, Local_156.x, 0, 0, 1562.099f, 2167.677f, 329.9366f, 4, 40f, 10f, -1f, 300, 100, 1);
						AI::SET_SEQUENCE_TO_REPEAT(uLocal_261, 1);
						AI::CLOSE_SEQUENCE_TASK(uLocal_261);
						AI::TASK_PERFORM_SEQUENCE(Local_174, uLocal_261);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_261);
						iLocal_191 = 2;
					}
					if (((((!func_22() && !PED::IS_PED_FLEEING(Local_174)) && !PED::IS_PED_RAGDOLL(Local_174)) && !PED::IS_PED_PRONE(Local_174)) && !PED::IS_PED_INJURED(Local_174)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_174, 0))
					{
						...
						{
							if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_249) > 8000)
							{
					...
					switch (iLocal_243)
					{
						...
						case 1:
							if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_156.x))
							{
								if (VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff"))
								{
									...
									VEHICLE::_0x1F2E4E06DEA8992B(Local_156.x, 1);
						...
						case 2:
							if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_156.x))
							{
								...
								if (iLocal_245 == 0)
								{
									if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_244) > 23000)
									{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_97(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_97(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_115(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_108(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_108(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_97(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_188()
{
	...
	{
		func_177();
		GRAPHICS::_0xBF59707B3E5ED531(func_189(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
...
void func_240()
{
	...
	{
		if (func_244(Local_174, 0, 1116471296, 1126825984, 1, 0, 0, 0) || GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_174, 1), 3f, 1))
		{
		...
		else if ((func_241(PLAYER::PLAYER_PED_ID(), Local_174, 1) || GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_174, 1), 3f, 0)) || PED::IS_PED_BEING_JACKED(Local_174))
		{
			if (iLocal_190 != 5 && iLocal_190 != 3)
			{
				bLocal_233 = true;
...
void func_242()
{
	if (func_478(Local_174))
	{
		AI::CLEAR_PED_TASKS(Local_174);
		PED::SET_PED_KEEP_TASK(Local_174, 1);
		AI::TASK_SMART_FLEE_PED(Local_174, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
	}
}
...
int func_266()
{
	if (func_239())
	{
		if (GAMEPLAY::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_156.x, 0), 741814745, 10f, 0))
		{
...
void func_282()
{
	...
	AI::TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	...
	AI::SET_SEQUENCE_TO_REPEAT(uLocal_261, 1);
	AI::CLOSE_SEQUENCE_TASK(uLocal_261);
	AI::TASK_PERFORM_SEQUENCE(Local_182, uLocal_261);
}
	...
	switch (iLocal_190)
	{
		...
		case 4:
			if (!func_478(Local_174))
			{
				...
				AI::TASK_PLAY_ANIM(Local_174, Local_174.f_6, Local_174.f_7, 8f, -8f, -1, 49, 0, 0, 0, 0);
			}
			else
			{
		...
		case 5:
			if (!bLocal_210)
			{
				if (!func_478(Local_174))
				{
					...
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_174, uLocal_760);
					PED::SET_PED_CONFIG_FLAG(Local_174, 132, 1);
					if (!UI::DOES_BLIP_EXIST(Local_174.f_1))
					{
					...
					if (func_478(Local_174) && func_239())
					{
						...
						AI::TASK_ENTER_VEHICLE(0, Local_156.x, 20000, -1, 1073741824, 1, 0);
						AI::CLOSE_SEQUENCE_TASK(uLocal_261);
						AI::TASK_PERFORM_SEQUENCE(Local_174, uLocal_261);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_261);
					}
...
int func_331(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_31() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_92(func_332(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_380()
{
	if (func_478(PLAYER::PLAYER_PED_ID()))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
		{
			...
			CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
			AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_174, -1, 0, 2);
...
void func_383(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_384(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_400()
{
	switch (iLocal_191)
	{
		case 0:
			...
			iLocal_241 = (GAMEPLAY::GET_GAME_TIMER() - 10000);
			iLocal_214 = 0;
...
void func_404()
{
	...
	{
		fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_174, 1), 1);
	}
	if (fVar0 < 50f)
	{
		fLocal_250 = 100f;
	...
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_174, 1), 1) > fLocal_250)
	{
		if (!iLocal_214)
		{
		...
		else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_174, 1), 1) > fLocal_251)
		{
			iLocal_264 = 2;
			iLocal_191 = 0;
			iLocal_190 = 6;
...
void func_406()
{
	if (func_478(Local_174))
	{
		if (func_238(PLAYER::PLAYER_PED_ID(), Local_174, 1) <= 15f)
		{
			if (!PED::IS_PED_HEADTRACKING_PED(Local_174, PLAYER::PLAYER_PED_ID()))
			{
				...
				AI::TASK_LOOK_AT_ENTITY(Local_174, PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
			}
		}
		...
		else if (PED::IS_PED_HEADTRACKING_PED(Local_174, PLAYER::PLAYER_PED_ID()) && !func_22())
		{
			...
			AI::TASK_CLEAR_LOOK_AT(Local_174);
		}
	}
	if (!func_22() && !UI::IS_MESSAGE_BEING_DISPLAYED())
	{
		if (func_478(Local_174) && func_478(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_241) > 15000)
				{
	...
	switch (iLocal_191)
	{
		...
		case 1:
			...
			if (func_239())
			{
				...
				{
					if (!UI::DOES_BLIP_EXIST(Local_156.z))
					{
					...
					func_16(&(Local_170.f_3));
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 80f)
					{
						if (func_421(Local_156.x, 1654.72f, 3239.21f, 39.55f, 1) >= 50f)
						{
							...
							else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 150f)
							{
								if (func_414())
								{
									bLocal_233 = true;
						...
						else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 250f)
						{
							if (func_414())
							{
								bLocal_233 = true;
...
void func_418()
{
	if (func_478(Local_174))
	{
		if (func_238(Local_174, Local_156.x, 1) < 17f)
		{
			if (!bLocal_224)
			{
				if (!func_22())
				{
					if (func_222(&uLocal_595, "EPS6AUD", "EPS6_CLOSE", 9, 0, 0, 0))
					{
						...
						AI::CLEAR_PED_TASKS(Local_174);
						AI::TASK_LOOK_AT_ENTITY(Local_174, PLAYER::PLAYER_PED_ID(), 10000, 48, 2);
			...
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_242) > 10000)
				{
					bLocal_224 = false;
				}
			}
...
void func_419()
{
	...
	else
	{
		...
		if (!UI::DOES_BLIP_EXIST(Local_170.f_3))
		{
	...
	switch (iLocal_194)
	{
		case 0:
			...
			else if (iLocal_195 == 1)
			{
				...
				switch (iLocal_238)
				{
					...
					case 2:
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_247) > 12000)
						{
							iLocal_238 = 0;
						}
						break;
		...
		case 1:
			if (iLocal_195 == 0)
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_182);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_182, PLAYER::PLAYER_PED_ID(), 0);
		...
		case 2:
			if (iLocal_195 == 0)
			{
				if (func_478(Local_182))
				{
					...
					if (UI::IS_MESSAGE_BEING_DISPLAYED())
					{
						...
						AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_182, -1, 0, 2);
						AI::TASK_LOOK_AT_ENTITY(Local_182, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			...
			else if (iLocal_195 == 1)
			{
				...
				else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_248) > 1000 || iLocal_248 == 0)
				{
					if (!func_22())
					{
		...
		case 3:
			if (iLocal_195 == 0)
			{
				...
				if (iLocal_234 == 0)
				{
					...
					{
						AI::CLEAR_PED_TASKS(Local_182);
						AI::TASK_HANDS_UP(Local_182, -1, PLAYER::PLAYER_PED_ID(), -1, 1);
					}
					iLocal_239 = -1;
					iLocal_195 = 1;
				}
			...
			else if (iLocal_195 == 1)
			{
				if (!func_245(Local_182, 1126825984))
				{
					...
					else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_239) > 1200)
					{
						AI::CLEAR_PED_TASKS(Local_182);
						AI::TASK_LOOK_AT_ENTITY(Local_182, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_182, PLAYER::PLAYER_PED_ID(), 0);
		...
		case 5:
			if (iLocal_195 == 0)
			{
				...
				AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_182, PLAYER::PLAYER_PED_ID(), -1);
				iLocal_195 = 1;
			}
			else if (iLocal_195 == 1)
			{
				if (iLocal_211 == 0)
				{
					if ((!UI::IS_MESSAGE_BEING_DISPLAYED() && !func_22()) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.x, 1))
					{
						UNK1::_0x293220DA1B46CEBC(3f, 10f, 1);
		...
		case 4:
			if (iLocal_195 == 0)
			{
				if (func_479(Local_182))
				{
					...
					{
						AI::CLEAR_PED_TASKS(Local_182);
						AI::TASK_CLEAR_LOOK_AT(Local_182);
						AI::OPEN_SEQUENCE_TASK(&uLocal_261);
						AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						AI::TASK_PLAY_ANIM(0, "gestures@m@standing@casual", "gesture_bye_soft", 8f, -8f, -1, 0, 0, 0, 0, 0);
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -2884.934f, 3200.156f, 10.7036f, 1f, 20000, 0.25f, 0, 1193033728);
...
void func_425()
{
	...
	if (func_479(Local_182))
	{
		...
		AI::TASK_SMART_FLEE_PED(Local_182, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
		func_16(&(Local_182.f_1));
	}
}
		...
		switch (iLocal_196)
		{
			...
			case 1:
				if (func_478(Local_182) && func_478(PLAYER::PLAYER_PED_ID()))
				{
					...
					AI::OPEN_SEQUENCE_TASK(&uLocal_261);
					AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_764, 1f, 20000, 0.25f, 0, 1193033728);
					AI::CLOSE_SEQUENCE_TASK(uLocal_261);
					AI::TASK_PERFORM_SEQUENCE(Local_182, uLocal_261);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_261);
					iLocal_196 = 2;
			...
			case 2:
				if (func_478(Local_182) && func_478(PLAYER::PLAYER_PED_ID()))
				{
					if (func_238(Local_182, PLAYER::PLAYER_PED_ID(), 1) < 5f || AI::GET_SCRIPT_TASK_STATUS(Local_182, 242628503) == 7)
					{
						AI::CLEAR_PED_TASKS(Local_182);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_182, PLAYER::PLAYER_PED_ID(), -1);
						iLocal_196 = 0;
	...
	if (func_478(Local_182))
	{
		switch (iLocal_197)
		{
			case 0:
				...
				{
					AI::TASK_PLAY_ANIM(Local_182, "rcmepsilonism6", "cultist_upperstatic", 8f, -8f, -1, 49, 0, 0, 0, 0);
					iLocal_197 = 1;
			...
			case 1:
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_182, Local_199[iLocal_198], 1f, 20000, 0.25f, 0, 1193033728);
			...
			case 3:
				AI::CLEAR_PED_TASKS(Local_182);
				AI::TASK_PLAY_ANIM(Local_182, "rcmepsilonism6", "cultist_idle_a", 16f, -2f, -1, 131072, 0, 0, 0, 0);
			...
			case 4:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_182, "rcmepsilonism6", "cultist_idle_a", 3))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_182, "rcmepsilonism6", "cultist_idle_a") >= 0.98f)
					{
						...
						AI::TASK_PLAY_ANIM(Local_182, "rcmepsilonism6", "cultist_upperstatic", 16f, -8f, -1, 49, 0, 0, 0, 0);
						PED::_0x2208438012482A1A(Local_182, 0, 0);
						iLocal_197 = 1;
...
void func_442()
{
	if (bLocal_232 == 0)
	{
		if (func_479(Local_182) && func_478(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (AI::IS_PED_GETTING_UP(Local_182) || PED::IS_PED_ON_FOOT(Local_182))
				{
					if (!func_22() && !UI::IS_MESSAGE_BEING_DISPLAYED())
					{
			...
			if (func_239())
			{
				...
				else
				{
					...
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 80f)
					{
						...
						else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 120f)
						{
							if (func_414())
							{
								bLocal_233 = true;
...
void func_446()
{
	switch (iLocal_192)
	{
		...
		case 1:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_240) > 12000)
			{
				iLocal_192 = 2;
			}
			break;
...
void func_448()
{
	switch (iLocal_191)
	{
		...
		case 1:
			...
			else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 50f)
			{
				if (!iLocal_214)
				{
					if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
					{
						...
						func_20();
						iLocal_215 = 1;
						iLocal_217 = (GAMEPLAY::GET_GAME_TIMER() - 7500);
					}
					func_405("EPS6_BACKPL", 7500, 1);
					iLocal_214 = 1;
				}
				...
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_217) > 7500 && !UI::IS_MESSAGE_BEING_DISPLAYED())
					{
					...
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 100f)
					{
						iLocal_264 = 1;
						iLocal_191 = 0;
						iLocal_190 = 6;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				...
				{
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-2892.93f, 3192.37f, 11.66f, 11f, 0, 0, 0, 0, 0, 0);
...
void func_488()
{
	...
	if (AI::DOES_SCENARIO_GROUP_EXIST("SANDY_PLANES"))
	{
		if (!AI::IS_SCENARIO_GROUP_ENABLED("SANDY_PLANES"))
		{
			AI::SET_SCENARIO_GROUP_ENABLED("SANDY_PLANES", 1);
		}
	}
