void __EntryFunction__()
{
	...
	iLocal_263 = -1;
	iLocal_761 = -1673356438;
	iLocal_762 = -847807830;
	...
	if (func_481(Local_95.f_35[0]))
	{
		...
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_156.x, 1);
	...
	if (func_478(Local_95.f_28[0]))
	{
		...
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_182, 1);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_182, uLocal_760);
		PED::SET_PED_CONFIG_FLAG(Local_182, 132, 1);
	}
	func_470();
			...
			else
			{
				...
				if (func_239())
				{
					if (func_238(PLAYER::PLAYER_PED_ID(), Local_156.x, 1) > 300f && !ENTITY::IS_ENTITY_ON_SCREEN(Local_156.x))
					{
						...
						TASK::TASK_PLANE_MISSION(0, Local_156.x, 0, 0, 3891.478f, 2298.554f, 301.6707f, 4, 40f, 10f, -1f, 300, 30, 1);
						TASK::TASK_PLANE_MISSION(0, Local_156.x, 0, 0, 1562.099f, 2167.677f, 329.9366f, 4, 40f, 10f, -1f, 300, 100, 1);
						TASK::SET_SEQUENCE_TO_REPEAT(uLocal_261, 1);
						TASK::CLOSE_SEQUENCE_TASK(uLocal_261);
						TASK::TASK_PERFORM_SEQUENCE(Local_174, uLocal_261);
						TASK::CLEAR_SEQUENCE_TASK(&uLocal_261);
						iLocal_191 = 2;
					}
					if (((((!func_22() && !PED::IS_PED_FLEEING(Local_174)) && !PED::IS_PED_RAGDOLL(Local_174)) && !PED::IS_PED_PRONE(Local_174)) && !PED::IS_PED_INJURED(Local_174)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_174, 0))
					{
					...
					switch (iLocal_243)
					{
						...
						case 1:
							if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_156.x))
							{
								...
								{
									VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_156.x, 501, "Eps6_Takeoff", 1);
									VEHICLE::FORCE_PLAYBACK_RECORDED_VEHICLE_UPDATE(Local_156.x, 1);
						...
						case 2:
							...
							else
							{
								...
								{
									VEHICLE::SET_VEHICLE_ENGINE_ON(Local_156.x, 1, 1, 0);
								}
								TASK::CLEAR_SEQUENCE_TASK(&uLocal_261);
								iLocal_243++;
							}
				...
				else
				{
					...
					iLocal_191 = 0;
					iLocal_190 = 6;
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.x, 0))
					{
						bLocal_233 = true;
					}
					AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
...
void func_24()
{
	...
	if (iVar0 < 17)
	{
		STATS::STAT_SET_INT(-1016034844, 17, 1);
		func_25(23, 17);
	}
...
void func_26(int iParam0, bool bParam1)
{
	...
	{
		func_193(&(Global_110725[iVar0].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void func_44(var uParam0)
{
	*uParam0 = 145;
	...
	while (iVar1 < 3)
	{
		...
		func_49(&(uParam0->f_25[0][iVar1]));
		func_49(&(uParam0->f_25[1][iVar1]));
		iVar0 = 0;
		while (iVar0 < 12)
		{
...
int func_54(int iParam0, int iParam1, int iParam2)
{
	...
	Global_76434[1] = { func_105(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_76434[1] = { func_105(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_97(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_97(iParam1), Global_76434[1].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, 0);
		}
	}
...
int func_55(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_170(iParam0, Global_111638.f_2358.f_539[iVar0].f_64, Global_111638.f_2358.f_539[iVar0].f_63))
		{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76434[1] = { func_105(iVar10, iParam1, iParam2, -1) };
		if (!func_95(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76434[1] = { func_105(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1] = { func_105(iVar10, 14, uVar28[iVar1], -1) };
							func_73(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
							func_88(14);
							if (Global_76432 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_97(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_88(iVar0);
						if (Global_76432 == 1)
						{
			...
			{
				Global_76434[1] = { func_105(iVar10, iVar0, func_63(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1] = { func_105(iVar10, 14, uVar69[iVar1], -1) };
			func_73(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
			func_88(14);
			if (Global_76432 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_97(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_97(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
{
	Global_76434[1] = { func_105(iParam0, iParam1, iParam2, -1) };
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								if (!func_66(-1692214353, iVar3, iVar5, iVar4, &iVar6))
								{
									if (iVar6 != -99)
									{
										iVar0 = iVar6;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_97(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_97(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_75(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_75(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_75(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_75(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_88(int iParam0)
{
	...
	{
		func_94(iParam0, Global_76434[1].f_5, Global_76434[1].f_2, 2, Global_76434[1].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76434[1].f_6, 1) && MISC::IS_BIT_SET(Global_76434[1].f_6, 6))
	{
		if (iParam0 == 12)
...
int func_92(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0][func_91(iParam1)];
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_170(iParam0, Global_111638.f_2358.f_539[iVar0].f_61, Global_111638.f_2358.f_539[iVar0].f_60) || iParam3 == 1)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_80(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_103(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_103(Var16.z)] = func_80(iParam1, Var16.x, func_103(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_103(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
...
void func_107(int iParam0)
{
	...
	func_108(&(Global_76434[0]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_92(func_110(iParam1, uParam0->f_2), Global_76431, 0);
			if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_92(iVar1, Global_76431, 0);
				if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_115(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_108(&(Global_76434[0]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_108(&(Global_76434[0]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_108(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_108(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_97(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_170(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_170(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_170(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76434[2] = { func_105(iVar0, 14, iVar4, -1) };
									if (Global_76434[2].f_12 == iVar3)
									{
										if (func_170(iParam0, 14, iVar4))
										{
											if (!func_61(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76434[2])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76434[2] = { func_105(iVar0, iVar2, iVar1, -1) };
						if (!func_61(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76434[2])))
						{
							return 0;
						}
					}
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_97(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_97(iParam1)))
	{
		return 1;
	}
	return 0;
...
{
	func_198(iParam0, 1);
	Global_111638.f_18569[iParam0].f_3 = func_197();
...
void func_240()
{
	...
	{
		if (func_244(Local_174, 0, 1116471296, 1126825984, 1, 0, 0, 0) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_174, 1), 3f, 1))
		{
		...
		else if ((func_241(PLAYER::PLAYER_PED_ID(), Local_174, 1) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_174, 1), 3f, 0)) || PED::IS_PED_BEING_JACKED(Local_174))
		{
			if (iLocal_190 != 5 && iLocal_190 != 3)
			{
				bLocal_233 = true;
		...
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_174, PLAYER::PLAYER_PED_ID(), 1))
		{
...
void func_242()
{
	if (func_478(Local_174))
	{
		...
		PED::SET_PED_KEEP_TASK(Local_174, 1);
		TASK::TASK_SMART_FLEE_PED(Local_174, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
	}
}
...
bool func_247(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_248(&(Local_37[iVar4]), Var1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
int func_266()
{
	if (func_239())
	{
		if (MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_156.x, 0), 741814745, 10f, 0))
		{
	...
	switch (iLocal_190)
	{
		...
		case 2:
			...
			if (func_239())
			{
				if (!func_268())
				{
					func_273(ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 200f, 12, 5000, 0, 0);
				}
				if (func_239())
				{
					ENTITY::FREEZE_ENTITY_POSITION(Local_156.x, 0);
					if (VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(500, "Eps6_LandingSkip"))
					{
						if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_156.x))
						{
							if (!func_268())
							{
								...
								VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_156.x, 500, "Eps6_LandingSkip", 1);
							}
						}
					}
				}
		...
		case 4:
			...
			STREAMING::REQUEST_MODEL(Local_163.f_1);
			STREAMING::REQUEST_MODEL(Local_156.y);
			STREAMING::REQUEST_ANIM_DICT(Local_174.f_6);
			VEHICLE::REQUEST_VEHICLE_RECORDING(501, "Eps6_Takeoff");
			func_272(55);
			if (!func_268())
			{
				while (((((!STREAMING::HAS_MODEL_LOADED(Local_163.f_1) || !CUTSCENE::HAS_CUTSCENE_LOADED()) || !STREAMING::HAS_MODEL_LOADED(Local_156.y)) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_174.f_6)) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff")) || !func_271(55))
				{
			...
			{
				while ((((!STREAMING::HAS_MODEL_LOADED(Local_163.f_1) || !STREAMING::HAS_MODEL_LOADED(Local_156.y)) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_174.f_6)) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff")) || !func_271(55))
				{
					func_521("WAITING FOR MS_ENDCUTSCENE RESOURCES");
					SYSTEM::WAIT(0);
				}
...
void func_270()
{
	switch (iLocal_190)
	{
		...
		case 5:
			if (!func_481(Local_163))
			{
				Local_163 = VEHICLE::CREATE_VEHICLE(Local_163.f_1, Local_163.f_3, Local_163.f_6, 1, 1, 0);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_163, 1084227584);
				VEHICLE::SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Local_163, 1);
	...
	switch (iLocal_190)
	{
		case 0:
			if (func_478(Local_182))
			{
				...
				ENTITY::SET_ENTITY_COORDS(Local_182, -2881.755f, 3188.125f, 10.1136f, 1, 0, 0, 1);
			...
			{
				func_4(&Local_182);
				Local_182 = PED::CREATE_PED(26, iLocal_762, -2881.755f, 3188.125f, 10.1136f, 254.1723f, 1, 1);
			...
			if (func_478(Local_182))
			{
				...
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_182, 1);
				PED::SET_PED_CONFIG_FLAG(Local_182, 167, 1);
				AUDIO::STOP_PED_SPEAKING(Local_182, 1);
				PED::SET_PED_DIES_WHEN_INJURED(Local_182, 1);
				PED::SET_PED_CAN_BE_TARGETTED(Local_182, 0);
				PED::SET_PED_CONFIG_FLAG(Local_182, 185, 1);
				PED::SET_PED_CONFIG_FLAG(Local_182, 188, 0);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_182, uLocal_760);
				PED::SET_PED_CONFIG_FLAG(Local_182, 132, 1);
		...
		case 1:
			...
			{
				ENTITY::SET_ENTITY_HEADING(Local_182, 254.1723f);
				ENTITY::SET_ENTITY_COORDS(Local_182, -2889.89f, 3198.69f, 10.11f, 1, 0, 0, 1);
				TASK::CLEAR_PED_TASKS(Local_182);
			}
			else
			{
				func_4(&Local_182);
				Local_182 = PED::CREATE_PED(26, iLocal_762, -2889.89f, 3198.69f, 10.11f, 254.1723f, 1, 1);
				PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_182);
			}
			if (func_478(Local_182))
			{
...
void func_282()
{
	WEAPON::GIVE_WEAPON_TO_PED(Local_182, -38085395, 0, 1, 1);
	PED::SET_PED_CAN_SWITCH_WEAPON(Local_182, 0);
	AUDIO::STOP_PED_SPEAKING(Local_182, 1);
	PED::SET_PED_DIES_WHEN_INJURED(Local_182, 1);
	PED::SET_PED_CAN_BE_TARGETTED(Local_182, 0);
	TASK::OPEN_SEQUENCE_TASK(&uLocal_261);
	...
	TASK::SET_SEQUENCE_TO_REPEAT(uLocal_261, 1);
	TASK::CLOSE_SEQUENCE_TASK(uLocal_261);
	TASK::TASK_PERFORM_SEQUENCE(Local_182, uLocal_261);
}
...
void func_283()
{
	switch (iLocal_190)
	{
		case 0:
			...
			Local_156.x = VEHICLE::CREATE_VEHICLE(iLocal_761, -2892.93f, 3192.37f, 11.66f, -132.35f, 0, 0, 0);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_156.x, 1084227584);
			...
			VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(Local_156.x, 0);
			VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_156.x, 1);
			func_480(Local_156.x, 0);
		...
		case 2:
			if (func_239())
			{
				...
				ENTITY::FREEZE_ENTITY_POSITION(Local_156.x, 1);
			}
			else
			{
				Local_156.x = VEHICLE::CREATE_VEHICLE(iLocal_761, 595.7562f, 2926.42f, 173.2301f, 283.3833f, 0, 0, 0);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_156.x, 1084227584);
				VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_156.x);
				VEHICLE::SET_VEHICLE_COLOURS(Local_156.x, 157, 157);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(Local_156.x, 157, 5);
		...
		case 4:
			...
			Local_156.x = VEHICLE::CREATE_VEHICLE(Local_156.y, 1684.78f, 3255.58f, 41.78f, 284.26f, 1, 1, 0);
			if (func_481(Local_156.x))
			{
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_156.x, 1084227584);
				VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_156.x);
		...
		case 5:
			...
			if (!bLocal_210)
			{
				...
				Local_156.x = VEHICLE::CREATE_VEHICLE(Local_156.y, 1674.91f, 3252.47f, 41.69f, 284.26f, 1, 1, 0);
				if (func_481(Local_156.x))
				{
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_156.x, 1084227584);
					VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_156.x);
	...
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_156.y, 1);
}
	...
	switch (iLocal_190)
	{
		...
		case 4:
			if (!func_478(Local_174))
			{
				...
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_174, 1);
				PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_174, 0);
				PED::SET_PED_CAN_BE_TARGETTED(Local_174, 0);
				PED::SET_PED_CONFIG_FLAG(Local_174, 185, 1);
				PED::SET_PED_PROP_INDEX(Local_174, 1, 0, 0, false);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_174, uLocal_760);
				PED::SET_PED_CONFIG_FLAG(Local_174, 132, 1);
				TASK::TASK_PLAY_ANIM(Local_174, Local_174.f_6, Local_174.f_7, 8f, -8f, -1, 49, 0, 0, 0, 0);
			}
			else
			{
			...
			{
				iLocal_262 = OBJECT::CREATE_OBJECT(94130617, ENTITY::GET_ENTITY_COORDS(Local_174, 1), 1, 1, 0);
			}
			if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_262))
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_262, Local_174, PED::GET_PED_BONE_INDEX(Local_174, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
			}
			func_288(55);
			break;
			...
			if (!bLocal_210)
			{
				if (!func_478(Local_174))
				{
					...
					if (func_478(Local_174) && func_239())
					{
						...
						TASK::TASK_ENTER_VEHICLE(0, Local_156.x, 20000, -1, 1073741824, 1, 0);
						TASK::CLOSE_SEQUENCE_TASK(uLocal_261);
						TASK::TASK_PERFORM_SEQUENCE(Local_174, uLocal_261);
						TASK::CLEAR_SEQUENCE_TASK(&uLocal_261);
					}
					PED::_0x2208438012482A1A(Local_174, 0, 0);
				}
				else
				{
					...
					PED::_0x2208438012482A1A(Local_174, 1, 0);
				}
				func_286(&iLocal_262);
			}
			else
...
{
	func_295(&Global_105187, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_295(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	*uParam0 = func_234();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_317())
		{
			func_313(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
{
	uVar0 = Global_2583656[iParam0][func_91(iParam1)];
...
void func_318(int iParam0, bool bParam1)
{
	...
	if (func_174(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_319(iParam0, &(Global_111638.f_2358.f_539.f_298[iVar0]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_325(int iParam0)
{
	...
	if (func_174(iVar0) && !PED::IS_PED_INJURED(uParam0))
	{
...
int func_334(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_349(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_335(iVar0, 0), 1);
	...
	switch (iLocal_191)
	{
		case 0:
			...
			if (func_394(1, 1093140480, 0))
			{
				...
				if (func_239())
				{
					ENTITY::SET_ENTITY_COORDS(Local_156.x, 1674.91f, 3252.47f, 41.69f, 1, 0, 0, 1);
...
void func_378()
{
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ep_plane", 0))
	{
		...
		if (func_239())
		{
			ENTITY::SET_ENTITY_COORDS(Local_156.x, 1684.78f, 3255.58f, 41.78f, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(Local_156.x, 284.26f);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_156.x, 1084227584);
		}
		else
...
void func_379()
{
	if (func_478(Local_174))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			...
			PED::FORCE_PED_MOTION_STATE(Local_174, -530524, 0, 1, 0);
		}
	}
}
...
int func_389(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_390(Var18[0], Var18[1], Var6, Var9) || func_390(Var18[0], Var18[1], Var9, Var15)) || func_390(Var18[0], Var18[1], Var12, Var15)) || func_390(Var18[0], Var18[1], Var6, Var12)) || func_390(Var18[1], Var18[3], Var6, Var9)) || func_390(Var18[1], Var18[3], Var9, Var15)) || func_390(Var18[1], Var18[3], Var12, Var15)) || func_390(Var18[1], Var18[3], Var6, Var12)) || func_390(Var18[3], Var18[2], Var6, Var9)) || func_390(Var18[3], Var18[2], Var9, Var15)) || func_390(Var18[3], Var18[2], Var12, Var15)) || func_390(Var18[3], Var18[2], Var6, Var12)) || func_390(Var18[2], Var18[0], Var6, Var9)) || func_390(Var18[2], Var18[0], Var9, Var15)) || func_390(Var18[2], Var18[0], Var12, Var15)) || func_390(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
void func_400()
{
	switch (iLocal_191)
	{
		case 0:
			...
			STREAMING::REQUEST_ANIM_DICT(Local_174.f_6);
			STREAMING::REQUEST_MODEL(Local_163.f_1);
			STREAMING::REQUEST_MODEL(94130617);
			VEHICLE::REQUEST_VEHICLE_RECORDING(501, "Eps6_Takeoff");
			while ((((!func_271(55) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_174.f_6)) || !STREAMING::HAS_MODEL_LOADED(Local_163.f_1)) || !STREAMING::HAS_MODEL_LOADED(94130617)) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff"))
			{
				SYSTEM::WAIT(0);
			}
			if (iLocal_209)
			...
			if (func_239())
			{
				VEHICLE::SET_VEHICLE_ENGINE_ON(Local_156.x, 0, 0, 0);
			}
			if (!HUD::DOES_BLIP_EXIST(Local_174.f_1))
			{
				Local_174.f_1 = func_287(Local_174, 1, 1, 9);
		...
		case 1:
			...
			if (func_239())
			{
				...
				else if (func_401(PLAYER::PLAYER_PED_ID(), Local_174, 5f, 1))
				{
					...
					{
						Local_764 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
						Local_767 = { ENTITY::GET_ENTITY_COORDS(Local_174, 1) };
						if (((Local_764.z - Local_767.z) < 1.5f && !PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
						{
							iLocal_191 = 2;
						}
					}
...
void func_404()
{
	...
	{
		fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_174, 1), 1);
	}
	if (fVar0 < 50f)
	{
		fLocal_250 = 100f;
	...
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_174, 1), 1) > fLocal_250)
	{
		if (!iLocal_214)
		{
		...
		else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_174, 1), 1) > fLocal_251)
		{
			iLocal_264 = 2;
			iLocal_191 = 0;
			iLocal_190 = 6;
			...
			if (func_239())
			{
				...
				if (iLocal_230 == 0)
				{
					if (func_421(Local_156.x, Local_170, 1) < 350f)
					{
						...
						if (((STREAMING::HAS_MODEL_LOADED(Local_163.f_1) && func_271(55)) && STREAMING::HAS_ANIM_DICT_LOADED(Local_174.f_6)) && STREAMING::HAS_MODEL_LOADED(94130617))
						{
							func_285();
							func_270();
							func_15(&uLocal_595, 3, Local_174, "JIMMYBOSTON", 0, 1);
				...
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.x, 0))
				{
					...
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_156.x, Local_253, Local_256, 33.25f, 0, 1, 2))
						{
				...
				{
					if (!HUD::DOES_BLIP_EXIST(Local_156.z))
					{
						Local_156.z = func_417(Local_156.x, 1, 5);
					...
					func_16(&(Local_170.f_3));
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 80f)
					{
						if (func_421(Local_156.x, 1654.72f, 3239.21f, 39.55f, 1) >= 50f)
						{
							...
							else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 150f)
							{
								if (func_414())
								{
									bLocal_233 = true;
						...
						else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 250f)
						{
							if (func_414())
							{
								bLocal_233 = true;
			...
			if (func_481(Local_156.x))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_156.x, Local_253, Local_256, 33.25f, 0, 1, 2))
				{
					...
					if (VEHICLE::GET_LANDING_GEAR_STATE(Local_156.x) == 0 || VEHICLE::GET_LANDING_GEAR_STATE(Local_156.x) == 3)
					{
						...
						if (func_413() && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.x, 0))
						{
				...
				else
				{
					...
					VEHICLE::SET_VEHICLE_ENGINE_ON(Local_156.x, 1, 0, 0);
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_156.x, 1);
					iLocal_191 = 1;
				}
			}
	...
	switch (iLocal_194)
	{
		...
		case 2:
			...
			else if (iLocal_195 == 1)
			{
				...
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.x, 1))
					{
						if (func_22())
						{
							func_20();
		...
		case 3:
			if (iLocal_195 == 0)
			{
				...
				if (iLocal_234 == 0)
				{
					...
					{
						TASK::CLEAR_PED_TASKS(Local_182);
						TASK::TASK_HANDS_UP(Local_182, -1, PLAYER::PLAYER_PED_ID(), -1, 1);
					}
					iLocal_239 = -1;
					iLocal_195 = 1;
				}
		...
		case 5:
			...
			else if (iLocal_195 == 1)
			{
				if (iLocal_211 == 0)
				{
					if ((!HUD::IS_MESSAGE_BEING_DISPLAYED() && !func_22()) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.x, 1))
					{
						RECORDING::_0x293220DA1B46CEBC(3f, 10f, 1);
		...
		case 4:
			...
			else if (iLocal_195 == 1)
			{
				if (iLocal_190 == 0)
				{
					if (iLocal_211 == 0)
					{
						if ((!func_415("EPS6_SPOT") && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.x, 1)) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()))
						{
							func_426("EPS6_GETIN", 7500, 1);
...
void func_425()
{
	...
	if (func_479(Local_182))
	{
		...
		TASK::TASK_SMART_FLEE_PED(Local_182, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
		func_16(&(Local_182.f_1));
	}
}
...
int func_431()
{
	if (func_239() && func_478(Local_182))
	{
		if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.x, 1))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_156.x, PLAYER::PLAYER_PED_ID(), 1))
			{
...
void func_438()
{
	if (func_478(Local_182))
	{
		switch (iLocal_197)
		{
			case 0:
				iLocal_198 = 0;
				Local_199[0] = { -2887.15f, 3197.88f, 10.17f };
				Local_199[1] = { -2888.92f, 3203.76f, 10.6f };
				Local_199[2] = { -2895.37f, 3199.37f, 10.03f };
				...
				{
					TASK::TASK_PLAY_ANIM(Local_182, "rcmepsilonism6", "cultist_upperstatic", 8f, -8f, -1, 49, 0, 0, 0, 0);
					iLocal_197 = 1;
			...
			case 1:
				...
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_182, Local_199[iLocal_198], 1f, 20000, 0.25f, 0, 1193033728);
			...
			case 2:
				if (func_421(Local_182, Local_199[iLocal_198], 1) <= 1.2f)
				{
					iLocal_197 = 3;
			...
			case 3:
				TASK::CLEAR_PED_TASKS(Local_182);
				TASK::TASK_PLAY_ANIM(Local_182, "rcmepsilonism6", "cultist_idle_a", 16f, -2f, -1, 131072, 0, 0, 0, 0);
				PED::_0x2208438012482A1A(Local_182, 0, 0);
				iLocal_197 = 4;
			...
			case 4:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_182, "rcmepsilonism6", "cultist_idle_a", 3))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_182, "rcmepsilonism6", "cultist_idle_a") >= 0.98f)
					{
						...
						TASK::TASK_PLAY_ANIM(Local_182, "rcmepsilonism6", "cultist_upperstatic", 16f, -8f, -1, 49, 0, 0, 0, 0);
						PED::_0x2208438012482A1A(Local_182, 0, 0);
						iLocal_197 = 1;
...
int func_439()
{
	if (func_478(PLAYER::PLAYER_PED_ID()) && func_478(Local_182))
	{
		...
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_182, PLAYER::PLAYER_PED_ID(), 1))
		{
...
void func_440()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_182))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_182, PLAYER::PLAYER_PED_ID(), 1))
		{
			if (ENTITY::IS_ENTITY_DEAD(Local_182, 0))
			{
			...
			if (func_239())
			{
				...
				else
				{
					...
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 80f)
					{
						...
						else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 120f)
						{
							if (func_414())
							{
								bLocal_233 = true;
	...
	switch (iLocal_192)
	{
		case 0:
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
			{
				if (func_239())
				{
					Var0 = { ENTITY::GET_ENTITY_COORDS(Local_156.x, 1) };
					if (Var0.z > 15f)
					{
	...
	switch (iLocal_191)
	{
		case 0:
			...
			if (func_478(Local_182))
			{
				...
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_236, "DEVICE", WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_182, 1), "EPSILONISM_04_SOUNDSET", 0, 0);
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_237, "IDLE_BEEP_NPC", WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_182, 1), "EPSILONISM_04_SOUNDSET", 0, 0);
			}
		...
		case 1:
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 50f)
			{
				if (!iLocal_214)
				{
					if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
				...
				else
				{
					...
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.x, 1), 1) > 100f)
					{
						iLocal_264 = 1;
						iLocal_191 = 0;
						iLocal_190 = 6;
...
void func_470()
{
	...
	Local_163.f_1 = -591610296;
	Local_163.f_3 = { 1692.16f, 3271.055f, 40.633f };
	Local_156.y = -1673356438;
		...
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1] = { func_473(iParam0) };
					...
					{
						Global_7966[1] = { func_473(iParam0) };
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				...
				{
					MISC::CLEAR_AREA_OF_VEHICLES(-2892.93f, 3192.37f, 11.66f, 11f, 0, 0, 0, 0, 0, 0);
			...
			if (func_478(uParam0->f_28[0]) && func_479(PLAYER::PLAYER_PED_ID()))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_28[0], -38085395, -1, 1, 1);
