		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_53) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, 0))
		{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_100(3) && !Global_98778)
						{
							...
							{
								if ((!func_118(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_99())) && !Global_98778)
								{
									func_111(10);
									break;
								}
				...
				case 6:
					...
					if (func_118(uLocal_58, 2097152))
					{
						if (!func_100(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_50))
						{
							func_111(10);
						}
					}
					...
					{
						STATS::PLAYSTATS_ODDJOB_DONE(SYSTEM::ROUND((func_32(&uLocal_71) * 1000f)), iLocal_63, 0);
						func_31(&uLocal_71);
						...
						if (iLocal_63 != -1)
						{
							if (func_118(Global_110289, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_63), 0, Global_98781, 0);
								func_28(func_39(iLocal_63), 0, Global_98781, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_63), 0, Global_98781, 0);
								func_28(func_39(iLocal_63), 0, Global_98781, 0, 0);
							}
						}
						func_4();
						func_122(&Global_110289, 0);
...
void func_7()
{
	if (func_118(Global_111638.f_20006.f_9, 1))
	{
		...
		if (iLocal_91 == Global_111638.f_20006.f_8)
		{
			if (Global_111638.f_20006.f_8 != 2)
			{
				...
				if (iLocal_88 && Global_111638.f_20006.f_8 == 2)
				{
					func_19(62);
				}
				else
...
var func_46()
{
	...
	Var0.f_6 = iLocal_83;
	Var0.f_7 = iLocal_84;
	uVar1 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&Local_51, &Var0, 8, iLocal_61);
...
void func_60()
{
	...
	else if ((PED::IS_PED_INJURED(iLocal_85) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(91, ENTITY::GET_ENTITY_COORDS(iLocal_85, 1), 40f)) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(118, ENTITY::GET_ENTITY_COORDS(iLocal_85, 1), 40f))
	{
		func_79("TRI_DEATH", -1);
		iVar0 = iLocal_69;
		func_73(iLocal_69);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_85))
	{
		...
		{
			if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_85, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) <= 144f)
			{
...
void func_103()
{
	...
	if (bLocal_87)
	{
		...
		{
			func_105(iLocal_91, iVar8, &Var5, &Var6, &uVar7);
			if (!func_104(Var5))
			{
...
void func_119()
{
	...
	if (Global_111638.f_20006.f_8 < iLocal_91)
	{
		func_86(&uLocal_58, 8388608);
	}
}
