		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_85) && !ENTITY::IS_ENTITY_DEAD(iLocal_85, 0))
		{
			...
			switch (iLocal_95)
			{
				...
				case 6:
					...
					if (func_118(uLocal_94, 2097152))
					{
						if (!func_100(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_52))
						{
							func_111(10);
						}
					}
					...
					{
						STATS::PLAYSTATS_ODDJOB_DONE(SYSTEM::ROUND((func_32(&uLocal_107) * 1000f)), iLocal_99, 0);
						func_31(&uLocal_107);
...
void func_4()
{
	...
	uLocal_130 = PED::ADD_SCENARIO_BLOCKING_AREA((Local_121.x - 3f), (Local_121.y - 3f), (Local_121.z - 3f), (Local_121.x + 3f), (Local_121.y + 3f), (Local_121.z + 3f), 0, 1, 1, 1);
	func_7();
	func_5();
}
	...
	if (func_118(Global_111638.f_20006.f_9, 1))
	{
		...
		if (iLocal_135 == Global_111638.f_20006.f_8)
		{
			if (Global_111638.f_20006.f_8 != 2)
			{
				...
				if (iLocal_132 && Global_111638.f_20006.f_8 == 2)
				{
					func_19(62);
				}
				else
...
void func_8(int iParam0, bool bParam1)
{
	...
	if (bParam1 != MISC::IS_BIT_SET(Global_31146[iVar0].f_11, 13))
	{
		MISC::SET_BIT(&(Global_31146[iVar0].f_11), 18);
	}
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_31146[iVar0].f_11), 13);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_31146[iVar0].f_11), 13);
	}
}
...
void func_11(int iParam0, bool bParam1)
{
	...
	if (bParam1 == MISC::IS_BIT_SET(Global_31146[iVar0].f_11, 4))
	{
		return;
	}
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_31146[iVar0].f_11), 4);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_31146[iVar0].f_11), 4);
	}
	if (Global_31143 == 1)
	{
		Global_31144 = 1;
...
void func_12(int iParam0, bool bParam1)
{
	...
	if (bParam1 == MISC::IS_BIT_SET(Global_31146[iVar0].f_11, 5))
	{
		return;
	}
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_31146[iVar0].f_11), 5);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_31146[iVar0].f_11), 5);
	}
	if (Global_31143 == 1)
	{
		Global_31144 = 1;
...
void func_13(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam1 == MISC::IS_BIT_SET(Global_31146[iVar0].f_11, 6))
	{
		return;
	}
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_31146[iVar0].f_11), 6);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_31146[iVar0].f_11), 6);
	}
	if (bParam2)
	{
		MISC::SET_BIT(&(Global_31146[iVar0].f_11), 11);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_31146[iVar0].f_11), 11);
	}
	if (Global_31143 == 1)
	{
		Global_31144 = 1;
...
void func_60()
{
	...
	else if ((PED::IS_PED_INJURED(iLocal_129) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(91, ENTITY::GET_ENTITY_COORDS(iLocal_129, 1), 40f)) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(118, ENTITY::GET_ENTITY_COORDS(iLocal_129, 1), 40f))
	{
		func_79("TRI_DEATH", -1);
		iVar0 = iLocal_105;
		func_73(iLocal_105);
	...
	if (MISC::GET_GAME_TIMER() > iLocal_134 && fLocal_93 < (30f * 30f))
	{
		...
		if (MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) <= 0.5f)
		{
			...
			while (iVar15 < iVar13)
			{
				...
				{
					if (ENTITY::GET_ENTITY_MODEL(uVar2[iVar15]) == -178150202)
					{
						iVar14 = uVar2[iVar15];
					}
				}
...
void func_62(var uParam0, char* sParam1, char[4] cParam2, int iParam3)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, cParam2, func_63(iParam3), 0);
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_97()) || Global_110685) || Global_30770) || func_96()) || func_82(8, -1)) || func_95()) || func_94()) || func_93()) || func_84()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_97()) || Global_30770) || func_96()) || func_82(8, -1)) || func_93()) || func_95()) || func_94()) || func_84()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_97()) || Global_110685) || Global_30770) || func_96()) || func_82(8, -1)) || func_93()) || func_95()) || func_94()) || func_84()) || Global_111638.f_7683.f_919[iVar0] == 5) || Global_41978 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_97()) || Global_110685) || Global_30770) || func_96()) || func_82(8, -1)) || func_95()) || func_94()) || func_84()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_97()) || Global_30770) || func_96()) || func_82(8, -1)) || func_94()) || func_93()) || func_84()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_97()) || func_94()) || Global_110685) || Global_30770) || func_96()) || Global_42596) || func_82(8, -1)) || func_93()) || func_92()) || func_84()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_97()) || Global_110685) || Global_30770) || func_96()) || func_82(8, -1)) || func_93()) || func_92()) || func_95()) || func_94()) || func_84())
						{
							return 0;
						}
						break;
...
void func_103()
{
	if (bLocal_131)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_125))
		{
			...
			iLocal_125 = OBJECT::CREATE_OBJECT(1566872341, Var1, 1, 1, 0);
			ENTITY::SET_ENTITY_HEADING(iLocal_125, fVar0);
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_125, 1);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(1566872341);
		}
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_129))
		{
			...
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-178150202);
		}
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_128))
		{
			...
			iLocal_128 = OBJECT::CREATE_OBJECT(463086472, Var4, 1, 1, 0);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(463086472);
		}
		...
		{
			func_105(iLocal_135, iVar18, &Var11, &Var14, &uVar17);
			if (!func_104(Var11))
			{
...
int func_108()
{
	if (bLocal_131)
	{
		if (!STREAMING::HAS_MODEL_LOADED(1566872341))
		{
			return 0;
		}
		if (!STREAMING::HAS_MODEL_LOADED(1281480215))
		{
			return 0;
		}
		if (!STREAMING::HAS_MODEL_LOADED(-178150202))
		{
			return 0;
		}
		...
		if (!STREAMING::HAS_MODEL_LOADED(1027109416))
		{
			return 0;
		}
		if (!STREAMING::HAS_MODEL_LOADED(463086472))
		{
			return 0;
		}
	}
...
void func_109()
{
	if (bLocal_131)
	{
		STREAMING::REQUEST_MODEL(1566872341);
		STREAMING::REQUEST_MODEL(1281480215);
		STREAMING::REQUEST_MODEL(-178150202);
		STREAMING::REQUEST_MODEL(1027109416);
		STREAMING::REQUEST_MODEL(463086472);
...
int func_120(struct<3> Param0, var uParam3)
{
	...
	Var1[0] = { func_121(0) };
	Var1[2] = { func_121(2) };
	fVar11 = SYSTEM::VDIST2(Var1[0], Param0);
	fVar13 = 0f;
	iVar12 = 1;
	while (iVar12 <= (3 - 1))
	{
		fVar13 = SYSTEM::VDIST2(Param0, Var1[iVar12]);
		if (fVar13 < fVar11)
		{
			iVar0 = iVar12;
			fVar11 = fVar13;
...
void func_127(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		func_128(&(Global_22350.f_5660[iVar0]));
