...
void func_4()
{
	...
	iLocal_86 = PED::ADD_SCENARIO_BLOCKING_AREA((Local_79.x - 3f), (Local_79.f_1 - 3f), (Local_79.f_2 - 3f), (Local_79.x + 3f), (Local_79.f_1 + 3f), (Local_79.f_2 + 3f), false, true, true, true);
	func_7();
	func_5();
}
