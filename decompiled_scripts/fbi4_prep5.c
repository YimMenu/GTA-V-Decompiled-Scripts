...
void func_1()
{
	switch (iLocal_85)
	{
		case 0:
			...
			UI::CLEAR_HELP(1);
			func_21();
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_192))
			{
				if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_192, "PRE_FKICKOFF"))
				{
					while ((GAMEPLAY::GET_GAME_TIMER() - iLocal_380) < 2000)
					{
						SYSTEM::WAIT(0);
					}
				}
...
void func_23()
{
	switch (iLocal_85)
	{
		...
		case 2:
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_379) > 2000)
			{
				func_22(&uLocal_200);
...
int func_88(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_92() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_89(func_91(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_89(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0][func_90(iParam1)];
...
int func_96(int iParam0, struct<3> Param1, float fParam4)
{
	switch (iParam0)
	{
		...
		case 1:
			UI::REQUEST_ADDITIONAL_TEXT(sLocal_193, 0);
			UI::REQUEST_ADDITIONAL_TEXT(sLocal_209, 6);
	...
	switch (iLocal_85)
	{
		case 0:
			if (func_95(iLocal_84, bLocal_28))
			{
				...
				{
					UI::SET_BLIP_COLOUR(uLocal_200, 2);
					UI::SET_BLIP_ROUTE_COLOUR(uLocal_200, 2);
				}
...
void func_108(var uParam0, struct<3> Param1, int iParam4, bool bParam5, char* sParam6)
{
	if (!UI::DOES_BLIP_EXIST(*uParam0))
	{
		*uParam0 = func_109(Param1, 5, iParam4);
		if (bParam5)
		{
			UI::SET_BLIP_NAME_FROM_TEXT_FILE(*uParam0, sParam6);
		}
	}
}
		...
		case 0:
			if (func_95(iLocal_84, 0))
			{
				if (func_281())
				{
					...
					func_116(&iVar5, Var1, fVar4, 0, 0, 0, 0, 0, -1903012613, 0, 145, 1);
					func_113(0, -1, 1);
					iVar0 = GAMEPLAY::GET_GAME_TIMER();
					while (!func_112(28) && (GAMEPLAY::GET_GAME_TIMER() - iVar0) < 2000)
					{
						SYSTEM::WAIT(0);
					}
					func_25(500, 1);
		...
		if (Global_111638.f_2358.f_539.f_2407[0][iParam1] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[0][iParam1]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[0][iParam1], Param2, fParam5, 0, 0, 0);
				...
				func_178(iParam0, &(Global_111638.f_2358.f_539.f_2407[0][iParam1].f_31), &(Global_111638.f_2358.f_539.f_2407[0][iParam1].f_81));
		...
		else if (Global_111638.f_2358.f_539.f_2407[1][iParam1] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[1][iParam1]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[1][iParam1], Param2, fParam5, 0, 0, 0);
				...
				func_178(iParam0, &(Global_111638.f_2358.f_539.f_2407[1][iParam1].f_31), &(Global_111638.f_2358.f_539.f_2407[1][iParam1].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == -1435919434)
...
void func_118(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_122(iParam1, &(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_31), &(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_81));
			if (bParam3)
			{
				...
				Global_111638.f_20113[iParam0].f_31 = func_121(*iParam1);
				...
				func_119(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_5, Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_7, iVar3, 1, &(Global_111638.f_20113[iParam0].f_1));
				...
				func_119(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_6, -1, iVar3, 0, &(Global_111638.f_20113[iParam0].f_2));
			}
		}
	}
}
...
int func_123(int iParam0, bool bParam1, var uParam2)
{
	*uParam2 = 0;
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_124(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != 873639469) && ENTITY::GET_ENTITY_MODEL(iParam0) != -1177863319)
		{
			*uParam2 = 2;
			return 0;
		}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_155(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_173(iParam0, 0, 0)) || func_173(iParam0, 1, 0)) || func_173(iParam0, 2, 0)) || func_172(iParam0) != 145) || func_171(iParam0)) || func_170(iParam0)) || func_124(iParam0)) || func_169(iParam0)) || !func_159(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_170(iParam0))
		{
		}
...
int func_178(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_147(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_181(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_181(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_180(uParam0);
	if (func_179(*uParam0))
	{
...
void func_186(struct<3> Param0, float fParam3, int iParam4)
{
	...
	while (iVar0 < 68)
	{
		if (func_194(&(Global_75441.f_555[0]), iVar0))
		{
...
void func_187(int iParam0)
{
	...
	if (func_194(&(Global_75441.f_555[0]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_193(iParam0, 0)) && Global_76350.f_66 == 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0].f_14] != 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0].f_14] > 3) && (!func_191(0, Global_75441.f_555[0].f_12) || !func_191(1, Global_75441.f_555[0].f_12)))
			{
				func_190(&(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]), &Global_76350);
...
int func_191(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_192(&(Global_111638.f_32744.f_5038[iVar0])))
	{
		return 0;
	}
	return func_160(Global_111638.f_32744.f_5038[iVar0][iParam0].f_66, 0);
}
...
int func_194(var uParam0, int iParam1)
{
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_195(Global_111638.f_32744.f_1864[uParam0->f_14], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_195(Global_111638.f_2358.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_195(Global_111638.f_2358.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, 0))
		{
...
{
	return func_197(&(Global_105187.f_2890), Param0, fParam3, 0);
}
	...
	if (func_213(uParam0))
	{
		...
		if (func_212(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_199(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_199(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_200(iParam0, uVar1[iVar6], 1) && func_97(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_195(Param1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_201(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_155(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_155(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_155(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == 340154634 || uParam1->f_66 == -1960756985)
		{
			...
			while (iVar2 <= 9)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_155(iVar2)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_155(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_155(iVar3)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_155(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_155(iVar4)))
					{
					}
					else
					{
						GAMEPLAY::SET_BIT(&(uParam1->f_77), func_155(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_204(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_203())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_155(iVar5 + 1)))
				{
...
int func_213(var uParam0)
{
	...
	if (uParam0->f_12.f_66 == -2122757008 && func_97(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
{
	return func_222(Global_105187.f_2890.f_12.f_66, Param0, iParam3);
}
	...
	if (!bLocal_28 && iLocal_84 != 3)
	{
		if (iLocal_84 > 0)
		{
			if (!bLocal_196)
			{
				...
				{
					iLocal_380 = GAMEPLAY::GET_GAME_TIMER();
					func_231(4);
					return;
				}
			}
...
int func_240(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				case 0:
					func_269(99, 1);
					func_268(-656546900, iParam3);
					break;
				
				case 1:
					func_268(-2098183071, iParam3);
					break;
				
				case 2:
					func_268(1578119842, iParam3);
					break;
			}
			func_253(0);
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_268(-1190521599, iParam3);
							break;
						
						case 1:
							func_268(490143716, iParam3);
							break;
						
						case 2:
							func_268(121069433, iParam3);
							break;
					}
					if (func_249(1))
					{
				...
				case 21:
					...
					{
						case 0:
							func_268(219506691, iParam3);
							break;
						
						case 1:
							func_268(1871505786, iParam3);
							break;
						
						case 2:
							func_268(-2024399847, iParam3);
							break;
					}
					break;
				...
				case 25:
					...
					{
						case 0:
							func_268(27639974, iParam3);
							break;
						
						case 1:
							func_268(422258364, iParam3);
							break;
						
						case 2:
							func_268(316202960, iParam3);
							break;
					}
					break;
				...
				case 113:
					...
					{
						case 0:
							func_268(1806738963, iParam3);
							break;
						
						case 1:
							func_268(1576781520, iParam3);
							break;
						
						case 2:
							func_268(671882196, iParam3);
							break;
					}
					break;
				...
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case -123529621:
							...
							{
								case 0:
									func_268(408653638, iParam3);
									break;
								
								case 1:
									func_268(-424799277, iParam3);
									break;
								
								case 2:
									func_268(-558138038, iParam3);
									break;
							}
							break;
						...
						case -1215733929:
							...
							{
								case 0:
									func_268(2038531975, iParam3);
									break;
								
								case 1:
									func_268(-572903575, iParam3);
									break;
								
								case 2:
									func_268(-953947924, iParam3);
									break;
							}
							if (func_249(0))
							{
						...
						case 468388854:
							...
							{
								case 0:
									func_268(-445823242, iParam3);
									break;
								
								case 1:
									func_268(-1386757215, iParam3);
									break;
								
								case 2:
									func_268(-727828275, iParam3);
									break;
							}
							break;
						...
						case 499562112:
							...
							{
								case 0:
									func_268(-1744069936, iParam3);
									break;
								
								case 1:
									func_268(799609312, iParam3);
									break;
								
								case 2:
									func_268(181688102, iParam3);
									break;
							}
							func_248(iParam3);
							break;
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_268(-330339780, iParam3);
					break;
				
				case 1:
					func_268(1697564429, iParam3);
					break;
				
				case 2:
					func_268(1674823841, iParam3);
					break;
			}
			break;
...
void func_243(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_245()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_245()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_244(iParam0));
...
bool func_249(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_245()].f_6174.f_10, iParam0);
}
...
void func_273(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_92() == 0)
		{
			...
			func_246(func_91(iParam0), uVar0, -1, 1, 0);
		}
	}
	else
	{
...
{
	func_283(225514697, 12, 20, bParam0);
	func_283(225514697, 12, 21, bParam0);
	func_283(225514697, 12, 22, bParam0);
	func_283(-1692214353, 12, 13, bParam0);
	func_283(-1692214353, 12, 14, bParam0);
	func_283(-1692214353, 12, 15, bParam0);
	func_283(-1686040670, 12, 17, bParam0);
	func_283(-1686040670, 12, 18, bParam0);
	func_283(-1686040670, 12, 19, bParam0);
}

int func_283(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	Global_76434[1] = { func_285(iParam0, iParam1, iParam2, -1) };
	if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0) && !GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 6))
	{
		if (bParam3)
		{
			func_284(iParam1, Global_76434[1].f_5, Global_76434[1].f_2, 0, Global_76434[1].f_1, 1, 0);
		}
		else
		{
			func_284(iParam1, Global_76434[1].f_5, Global_76434[1].f_2, 0, Global_76434[1].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
void func_287(int iParam0)
{
	...
	func_288(&(Global_76434[0]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_89(func_291(iParam1, uParam0->f_2), Global_76431, 0);
...
void func_295(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_288(&(Global_76434[0]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_288(&(Global_76434[0]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_288(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_288(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_296(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_352()
{
	Var0[0] = { 344.0985f, -1605.154f, 28.2928f };
	Var0[1] = { 365.6985f, -1580.435f, 28.2928f };
	Var0[2] = { 407.9943f, -1616.259f, 28.2928f };
	Var0[3] = { 387.3322f, -1641.258f, 29.0912f };
	func_353(&Var0, 4);
}
...
void func_353(var uParam0, int iParam1)
{
	...
	{
		func_357(&uLocal_87, *uParam0[iVar0]);
		iVar0++;
	}
	func_356(&uLocal_87);
...
void func_354(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_355(uParam1, *uParam1[iVar1] + Var9))
		{
			Var9 = { -Var9 };
		}
