...
void func_6(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_8(Global_111638.f_18528[iVar0], &Var2, &fVar3))
			{
...
void func_100()
{
	...
	switch (iLocal_82)
	{
		...
		case 1:
			func_106();
			if (func_105(PLAYER::PLAYER_PED_ID(), Local_200, 2f) && func_104(28))
			{
				if (!iLocal_196)
				{
					PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
			...
			else
			{
				...
				else
				{
					...
					if (!func_105(PLAYER::PLAYER_PED_ID(), Local_200, 75f))
					{
						if (!iLocal_195)
						{
							func_22(&uLocal_197);
					...
					else if (func_105(PLAYER::PLAYER_PED_ID(), Local_200, 12f))
					{
						if (iLocal_195)
						{
							func_22(&uLocal_197);
...
void func_186(struct<3> Param0, float fParam1, int iParam2)
{
	int iVar0;
...
{
	return func_197(&(Global_105187.f_2890), Param0, fParam1, 0);
}
...
int func_199(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_200(iParam0, uVar1[iVar3], 1) && func_97(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_195(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
...
{
	return func_222(Global_105187.f_2890.f_12.f_66, Param0, iParam1);
}
...
void func_224()
{
	if (!bLocal_28 && iLocal_81 != 3)
	{
		if (iLocal_81 > 0)
		{
			...
			if (!bLocal_193)
			{
				if (!func_105(PLAYER::PLAYER_PED_ID(), Local_200, 150f))
				{
					func_231(2);
				}
				else if (!func_105(PLAYER::PLAYER_PED_ID(), Local_200, 75f))
				{
					if (!bLocal_201)
					{
						HUD::CLEAR_PRINTS();
...
void func_287(int iParam0)
{
	...
	func_288(&(Global_76434[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_295(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_288(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_288(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_296(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
