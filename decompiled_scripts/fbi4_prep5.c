...
int func_148(int iParam0)
{
	if (iParam0 != func_68())
	{
		if (func_127(iParam0, 1, 1))
		{
			if (Global_2426097[iParam0 /*443*/].f_314.f_6 != -1 && Global_2426097[iParam0 /*443*/].f_314.f_9 != func_68())
			{
...
{
	return func_197(&(Global_105407.f_2890), Param0, fParam3, 0);
}
...
{
	return func_222(Global_105407.f_2890.f_12.f_66, Param0, iParam3);
}
...
void func_287(int iParam0)
{
	...
	func_288(&(Global_76647[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_295(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 7, -1, false, -1, func_296(iParam0));
			if (iVar57 > iVar56)
			{
