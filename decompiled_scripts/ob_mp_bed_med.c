...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() || func_73() == 5)) && !func_61())
		{
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_334, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) > 6f)
			{
				func_82();
			}
		}
...
void func_1()
{
	uLocal_328 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uLocal_327);
	switch (iLocal_323)
	{
		case 0:
			break;
...
void func_2()
{
	...
	switch (iLocal_323)
	{
		...
		case 1:
			Local_340 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0) };
			if (func_44(1, 0, 1))
			{
				if ((((((func_50(Local_334, Var0) && Local_340.z < (Local_334.z + 1f)) && func_54(9)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_AT_COORDS(Local_334)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_336, Local_337, 2f, 0, 1, 0)) && func_49()) && !func_46(PLAYER::PLAYER_ID()))
				{
					if (func_42(iLocal_329, 1))
					{
						...
						func_17(1, 1, 1, 0, 0, 0);
						Local_334 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_330, sLocal_331, Local_338, Local_339, 0, 2) };
						Var1 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_330, sLocal_331, Local_338, Local_339, 0, 2) };
						fLocal_335 = Var1.z;
		...
		case 7:
			...
			if (((INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(Local_334)) && !func_8()) && !func_6()) && Global_1312467.f_8 == 0)
			{
				bLocal_325 = true;
				MISC::CLEAR_BIT(&uLocal_321, 0);
				uLocal_327 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_338, Local_339, 2, 0, 0, 1065353216, 0, 1065353216);
...
var func_16(struct<2> Param0, Vector3 vParam1, struct<2> Param2, Vector3 vParam3)
{
