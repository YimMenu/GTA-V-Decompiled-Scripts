...
{
	func_372(&Global_105407, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_382(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2552060[iParam0 /*3*/][func_383(iParam1)];
...
int func_384(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2588062[iParam0 /*3*/][func_383(iParam1)];
