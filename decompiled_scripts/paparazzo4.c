...
void func_216()
{
	if ((iLocal_309 && func_206(Local_56.f_28[2])) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[2]))
	{
		...
		{
			if ((!PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[2], true) || (func_215(Local_56.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[1], true))) || (func_215(Local_56.f_35[0]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[0], true)))
			{
				func_217(1);
...
void func_219()
{
	...
	{
		if ((((((!PED::IS_PED_FLEEING(Local_56.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[1], true)) && !TASK::IS_PED_GETTING_UP(Local_56.f_28[1])) && !PED::IS_PED_PRONE(Local_56.f_28[1])) && !PED::IS_PED_RAGDOLL(Local_56.f_28[1])) && !func_218(Local_56.f_28[1], 63541484)) && !func_218(Local_56.f_28[1], 242628503))
		{
			func_217(1);
			PED::SET_PED_FLEE_ATTRIBUTES(Local_56.f_28[1], 128, true);
			TASK::TASK_SMART_FLEE_PED(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
...
void func_231()
{
	...
	{
		if (((((((iLocal_234 < 4 && !PED::IS_PED_FLEEING(Local_56.f_28[1])) && !func_248()) && MISC::GET_GAME_TIMER() > iLocal_235) && func_226(Local_56.f_28[1], PLAYER::PLAYER_PED_ID()) < 10f) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[1], true)) && !PED::IS_PED_FLEEING(Local_56.f_28[1]))
		{
...
int func_260(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_262(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_274()
{
	if ((func_215(Local_56.f_35[1]) && (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[1]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_35[1], PLAYER::PLAYER_PED_ID(), true))) && !bLocal_263)
	{
	...
	if (((func_206(Local_56.f_28[0]) && func_206(PLAYER::PLAYER_PED_ID())) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[0])) && !PED::IS_PED_FLEEING(Local_56.f_28[0]))
	{
		if (func_215(Local_56.f_35[0]))
		{
			if (iLocal_224 == 2)
			{
				if (iLocal_295 == 0)
				{
					if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[0], false) || PED::IS_PED_BEING_JACKED(Local_56.f_28[0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_35[0], PLAYER::PLAYER_PED_ID(), true)) || func_282(Local_56.f_35[0]))
					{
						iLocal_295 = 1;
						iLocal_224 = 2;
					}
...
void func_278()
{
	...
	switch (iLocal_295)
	{
		case 1:
			...
			bVar0 = false;
			func_220();
			if ((func_215(Local_56.f_35[0]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_35[0], PLAYER::PLAYER_PED_ID(), true)) && func_272(PLAYER::PLAYER_PED_ID(), Local_56.f_28[0], 5f, 1))
			{
				bVar0 = func_250(&uLocal_58, "PAP4AUD", "PAP4_CARSHOT", 7, 0, 0, 0);
			}
			else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[0], false) || func_282(Local_56.f_35[0]))
			{
...
void func_285()
{
	...
	if ((((!bLocal_308 && func_206(PLAYER::PLAYER_PED_ID())) && func_206(Local_56.f_28[1])) && func_206(Local_56.f_28[0])) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0))
	{
		...
		fVar2 = func_286(PLAYER::PLAYER_PED_ID(), Var0, 1);
		fVar3 = func_286(PLAYER::PLAYER_PED_ID(), Var1, 1);
		if (fVar2 < fVar3)
		{
			Var4 = { Var1 };
		}
...
void func_287()
{
	...
	{
		if ((((((!TASK::IS_PED_GETTING_UP(Local_56.f_28[0]) && !PED::IS_PED_PRONE(Local_56.f_28[0])) && !PED::IS_PED_RAGDOLL(Local_56.f_28[0])) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[0], true)) && !func_218(Local_56.f_28[0], -1794415470)) && !PED::IS_PED_FLEEING(Local_56.f_28[0])) || PED::IS_PED_BEING_STEALTH_KILLED(Local_56.f_28[0]))
		{
...
void func_291(bool bParam0)
{
	...
	else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_265))
	{
		...
		{
			TASK::TASK_PLAY_ANIM(Local_56.f_28[1], sLocal_252, sLocal_268, 1000f, -8f, -1, 57, 0f, false, false, false);
			PED::_0x2208438012482A1A(Local_56.f_28[1], false, false);
		}
...
void func_293()
{
	...
	if (func_206(PLAYER::PLAYER_PED_ID()))
	{
		if (bLocal_278)
		{
			if ((((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) && func_301()) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_320, fLocal_321)) || !func_206(Local_56.f_28[1])) || !func_206(Local_56.f_28[2]))
			{
				iLocal_305 = 1;
				iLocal_304 = 3;
				iLocal_295 = 5;
			...
			else if ((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), true)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), true)) && func_298(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_298(PLAYER::PLAYER_PED_ID()) != joaat("object"))
			{
				func_276();
				iLocal_305 = 1;
				iLocal_304 = 3;
			...
			else if (((((func_254(Local_56.f_28[0], 1126825984) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), true)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), true)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), true)) || iLocal_262) && (func_298(PLAYER::PLAYER_PED_ID()) == joaat("weapon_unarmed") || func_298(PLAYER::PLAYER_PED_ID()) == joaat("object")))
			{
		...
		else
		{
			...
			else if ((func_206(Local_56.f_28[0]) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[0])) && (((((((ENTITY::GET_ENTITY_HEALTH(Local_56.f_28[0]) < 150 || (func_267(Local_56.f_28[0], 0, 0, 0, 0) && func_301())) || (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), true) && func_298(PLAYER::PLAYER_PED_ID()) == joaat("weapon_stungun"))) || !func_272(PLAYER::PLAYER_PED_ID(), Local_56.f_28[0], 20f, 1)) || (func_206(Local_56.f_28[1]) && PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0))) || (func_206(Local_56.f_28[1]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), true))) || (func_206(Local_56.f_28[2]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), true))) || iLocal_259))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[0], sLocal_252, sLocal_253, 3))
				{
					iLocal_259 = 1;
		...
		if (func_206(Local_56.f_28[1]))
		{
			if (((((((((func_267(Local_56.f_28[1], 0, 0, 0, 0) && func_301()) || ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), true) && func_298(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_298(PLAYER::PLAYER_PED_ID()) != joaat("object"))) || ((func_254(Local_56.f_28[1], 1126825984) && func_298(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_298(PLAYER::PLAYER_PED_ID()) != joaat("object"))) || !func_215(Local_56.f_35[1])) || PED::IS_PED_RAGDOLL(Local_56.f_28[1])) || func_295(Local_56.f_28[1])) || func_277(Local_56.f_28[0])) || func_277(Local_56.f_28[2])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_320, fLocal_321))
			{
...
void func_297()
{
	if (func_206(Local_56.f_28[0]))
	{
		if ((((((!PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[0], true) && iLocal_260) && !bLocal_261) && !func_277(Local_56.f_28[0])) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[0])) && !PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID())) && iLocal_295 == 0)
		{
			if (PED::IS_PED_IN_COMBAT(Local_56.f_28[0], 0) || PED::IS_PED_IN_MELEE_COMBAT(Local_56.f_28[0]))
			{
				TASK::CLEAR_PED_TASKS(Local_56.f_28[0]);
...
void func_305(bool bParam0, bool bParam1)
{
	...
	if ((((((func_215(Local_56.f_35[0]) && func_206(Local_56.f_28[0])) && bLocal_278) && iLocal_260) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[0], 0)) && !PED::IS_PED_FLEEING(Local_56.f_28[0])) && !iLocal_264)
	{
		...
		{
			if (((((iLocal_305 && !func_218(Local_56.f_28[0], -1794415470)) && !func_218(Local_56.f_28[0], 355471868)) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_56.f_35[0], -1, false)) && !PED::IS_PED_FLEEING(Local_56.f_28[0])) && !iLocal_264)
			{
				if (!func_303() && !func_249())
				{
					...
					if (bVar0 || bParam0)
					{
						...
						PED::_0x2208438012482A1A(Local_56.f_28[0], false, false);
						if (bParam1)
						{
						...
						if ((((func_206(Local_56.f_28[2]) && !PED::IS_PED_FLEEING(Local_56.f_28[2])) && !iLocal_262) && !iLocal_309) && !PED::IS_PED_RAGDOLL(Local_56.f_28[2]))
						{
							if (bParam0 || (func_215(Local_56.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[1], true)))
							{
							...
							else if (func_215(Local_56.f_35[1]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_56.f_35[1], 0, false))
							{
...
void func_306()
{
	...
	if (func_206(Local_56.f_28[1]))
	{
		if ((((!func_218(Local_56.f_28[1], 242628503) && !PED::IS_PED_FLEEING(Local_56.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0)) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_317)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[1], false))
		{
			...
			if (func_215(Local_56.f_35[1]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_56.f_35[1], -1, false))
			{
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(Local_313, Local_314, fLocal_315, false, true, true);
	...
	switch (iLocal_225)
	{
		...
		case 1:
			...
			if ((((func_206(Local_56.f_28[0]) && func_206(Local_56.f_28[1])) && func_206(Local_56.f_28[2])) && ENTITY::DOES_ENTITY_EXIST(Local_56.f_41[0])) && ENTITY::DOES_ENTITY_EXIST(Local_56.f_41[1]))
			{
				...
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_56.f_41[0], Local_56.f_28[0], PED::GET_PED_BONE_INDEX(Local_56.f_28[0], 28422), Local_236, Local_237, false, false, false, false, 2, true);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_56.f_41[1], Local_56.f_28[1], PED::GET_PED_BONE_INDEX(Local_56.f_28[1], 57005), Local_238, Local_239, false, false, false, false, 2, true);
					func_319();
				}
			}
...
void func_311(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_342(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
...
void func_349()
{
	...
	{
		func_354(PLAYER::PLAYER_PED_ID(), Local_293);
	...
	if (func_206(Local_56.f_28[2]) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[2]))
	{
		...
		if (func_206(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[2], true))
			{
				...
				if (func_215(iVar0) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar0, true) || !func_206(Local_56.f_28[0])))
				{
					TASK::OPEN_SEQUENCE_TASK(&iVar1);
