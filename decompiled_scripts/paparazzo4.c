...
int func_71(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0][func_70(iParam1)];
...
void func_214()
{
	if ((func_206(Local_98.f_28[0]) && func_215(Local_98.f_35[0])) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480))
	{
	...
	if ((func_206(Local_98.f_28[1]) && func_215(Local_98.f_35[1])) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_481))
	{
...
void func_216()
{
	...
	{
		if (((((!PED::IS_PED_FLEEING(Local_98.f_28[2]) && !AI::IS_PED_GETTING_UP(Local_98.f_28[2])) && !PED::IS_PED_PRONE(Local_98.f_28[2])) && !PED::IS_PED_RAGDOLL(Local_98.f_28[2])) && !func_218(Local_98.f_28[2], 63541484)) && !func_218(Local_98.f_28[2], 242628503))
		{
...
void func_219()
{
	...
	{
		if ((((((!PED::IS_PED_FLEEING(Local_98.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 1)) && !AI::IS_PED_GETTING_UP(Local_98.f_28[1])) && !PED::IS_PED_PRONE(Local_98.f_28[1])) && !PED::IS_PED_RAGDOLL(Local_98.f_28[1])) && !func_218(Local_98.f_28[1], 63541484)) && !func_218(Local_98.f_28[1], 242628503))
		{
			func_217(1);
			PED::SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[1], 128, 1);
			AI::TASK_SMART_FLEE_PED(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
	...
	if (UI::DOES_BLIP_EXIST(*iParam0))
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - *uParam3) > 500)
		{
			if (UI::GET_BLIP_COLOUR(*iParam0) == 1)
			{
				...
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_230(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_230(sParam2, 0, 0))
					{
...
void func_231()
{
	...
	{
		if (((((((iLocal_344 < 4 && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !func_248()) && GAMEPLAY::GET_GAME_TIMER() > iLocal_345) && func_226(Local_98.f_28[1], PLAYER::PLAYER_PED_ID()) < 10f) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 1)) && !PED::IS_PED_FLEEING(Local_98.f_28[1]))
		{
		...
		if (PED::IS_PED_IN_VEHICLE(Local_98.f_28[0], Local_98.f_35[0], 0))
		{
			if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_98.f_35[0]))
			{
				if (func_250(&uLocal_160, "PAP4AUD", "PAP4_BLOCKED", 7, 0, 0, 0))
				{
					...
					if (UI::DOES_BLIP_EXIST(iLocal_159))
					{
						UI::SET_BLIP_SCALE(iLocal_159, 0.7f);
					}
				}
			}
		}
...
bool func_256(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_257(&(Local_52[iVar4]), Var1, iParam1, &(Local_52[iVar4].f_3), iParam0, iParam5);
...
{
	Var0 = { func_262(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
{
	Var0 = { func_262(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	...
	switch (iLocal_436)
	{
		case 1:
			...
			if (bVar0)
			{
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_438, 2f, 20000, 1048576000, 0, 1193033728);
				}
			...
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_437)
			{
				if ((func_206(Local_98.f_28[0]) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0)) && iLocal_385)
				{
					...
					if ((((func_206(Local_98.f_28[2]) && !PED::IS_PED_FLEEING(Local_98.f_28[2])) && !iLocal_387) && !iLocal_465) && !PED::IS_PED_RAGDOLL(Local_98.f_28[2]))
					{
						...
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_441, 2f, 20000, 1048576000, 0, 1193033728);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
		...
		case 3:
			if (func_226(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0]) > 20f)
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_438, 1f, 20000, 1048576000, 0, 1193033728);
...
{
	if ((func_206(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_215(uParam0))
	{
...
void func_285()
{
	if ((((!bLocal_464 && func_206(PLAYER::PLAYER_PED_ID())) && func_206(Local_98.f_28[1])) && func_206(Local_98.f_28[0])) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0))
	{
		...
		AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Var8, 3f, 20000, 1048576000, 0, 1193033728);
...
void func_287()
{
	...
	{
		if ((((((!AI::IS_PED_GETTING_UP(Local_98.f_28[0]) && !PED::IS_PED_PRONE(Local_98.f_28[0])) && !PED::IS_PED_RAGDOLL(Local_98.f_28[0])) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], 1)) && !func_218(Local_98.f_28[0], -1794415470)) && !PED::IS_PED_FLEEING(Local_98.f_28[0])) || PED::IS_PED_BEING_STEALTH_KILLED(Local_98.f_28[0]))
		{
...
int func_290()
{
	Var0 = { ENTITY::GET_ENTITY_COORDS(Local_98.f_28[0], 1) + Vector(1f, 0f, 0f) };
	Var3 = { ENTITY::GET_ENTITY_COORDS(Local_98.f_28[1], 1) - Vector(1f, 0f, 0f) };
...
void func_293()
{
	if (func_206(PLAYER::PLAYER_PED_ID()))
	{
		if (bLocal_407)
		{
			...
			else if ((((func_254(Local_98.f_28[0], 1126825984) && func_301()) && func_298(PLAYER::PLAYER_PED_ID()) != -1569615261) && func_298(PLAYER::PLAYER_PED_ID()) != 966099553) || PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
			{
		...
		if (func_206(Local_98.f_28[2]) && !iLocal_465)
		{
			if (((((((((((func_253(Local_98.f_28[2], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_301()) || (func_253(Local_98.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_301())) || (func_253(Local_98.f_28[1], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_301())) || func_295(Local_98.f_28[2])) || func_295(Local_98.f_28[0])) || func_295(Local_98.f_28[1])) || PED::IS_PED_RAGDOLL(Local_98.f_28[2])) || !func_215(Local_98.f_35[1])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_484, fLocal_487)) || func_277(Local_98.f_28[0])) || func_277(Local_98.f_28[1]))
			{
				if (!PED::IS_PED_FLEEING(Local_98.f_28[2]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], 0))
				{
					...
					bLocal_391 = false;
					iLocal_387 = 1;
					if (func_298(PLAYER::PLAYER_PED_ID()) != -1569615261)
					{
						func_276();
					}
					iLocal_460 = 3;
...
int func_301()
{
	if (func_298(PLAYER::PLAYER_PED_ID()) == 741814745)
	{
...
void func_304()
{
	if (func_206(Local_98.f_28[0]))
	{
		if (func_215(Local_98.f_35[0]) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(Local_98.f_28[0], Local_98.f_35[0]) && !func_218(Local_98.f_28[0], -1273030092))
			{
				...
				if (UI::DOES_BLIP_EXIST(iLocal_159))
				{
					UI::SET_BLIP_SCALE(iLocal_159, 1f);
				}
				func_213(0);
			}
						...
						if ((((func_206(Local_98.f_28[2]) && !PED::IS_PED_FLEEING(Local_98.f_28[2])) && !iLocal_387) && !iLocal_465) && !PED::IS_PED_RAGDOLL(Local_98.f_28[2]))
						{
							if (bParam0 || (func_215(Local_98.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[1], 1)))
							{
								...
								else if (func_215(Local_98.f_35[0]))
								{
									...
									AI::TASK_ENTER_VEHICLE(0, Local_98.f_35[0], 20000, 0, 2f, 1, 0);
									AI::CLOSE_SEQUENCE_TASK(uVar2);
									AI::TASK_PERFORM_SEQUENCE(Local_98.f_28[2], uVar2);
									AI::CLEAR_SEQUENCE_TASK(&uVar2);
								}
...
void func_306()
{
	if (func_206(Local_98.f_28[1]))
	{
		if ((((!func_218(Local_98.f_28[1], 242628503) && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_481)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 0))
		{
	...
	switch (iLocal_327)
	{
		...
		case 1:
			...
			if ((((func_206(Local_98.f_28[0]) && func_206(Local_98.f_28[1])) && func_206(Local_98.f_28[2])) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[0])) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[1]))
			{
				...
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_98.f_41[0], Local_98.f_28[0], PED::GET_PED_BONE_INDEX(Local_98.f_28[0], 28422), Local_346, Local_349, 0, 0, 0, 0, 2, 1);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_98.f_41[1], Local_98.f_28[1], PED::GET_PED_BONE_INDEX(Local_98.f_28[1], 57005), Local_352, Local_355, 0, 0, 0, 0, 2, 1);
					func_319();
				}
			}
...
void func_331(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_332(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_345(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_322(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_349()
{
	...
	GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_412, 50f, 0, 0, 0, 0, 0, 0);
	func_319();
	if (func_356())
	{
		func_353(0, -1, 1);
	...
	{
		func_351(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
	}
	func_350(1, 1, 1);
}
	...
	if (func_206(Local_98.f_28[2]) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[2]))
	{
		...
		if (func_206(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], 1))
			{
				...
				if (func_215(uVar0) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uVar0, 1) || !func_206(Local_98.f_28[0])))
				{
					AI::OPEN_SEQUENCE_TASK(&uVar1);
