...
void func_1()
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(uLocal_448) && !ENTITY::IS_ENTITY_DEAD(uLocal_448, 0)) && !ENTITY::IS_ENTITY_DEAD(uLocal_240, 0))
	{
		...
		else
		{
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_448, 1), ENTITY::GET_ENTITY_COORDS(uLocal_240, 1), 1) < 3f && iLocal_451 == 0)
			{
				iLocal_451 = 1;
			}
		}
...
void func_104()
{
	...
	STREAMING::REQUEST_MODEL(2120901815);
	while (!STREAMING::HAS_MODEL_LOADED(2120901815))
	{
		SYSTEM::WAIT(0);
	}
	uLocal_448 = PED::CREATE_PED(4, 2120901815, 396.8498f, 143.3195f, 101.4659f, 360f, 1, 1);
	if ((ENTITY::DOES_ENTITY_EXIST(uLocal_448) && !ENTITY::IS_ENTITY_DEAD(uLocal_448, 0)) && !ENTITY::IS_ENTITY_DEAD(uLocal_240, 0))
	{
		PED::SET_IK_TARGET(uLocal_448, 1, uLocal_240, 0, 0f, 0f, 0f, 0, -1, -1);
	}
