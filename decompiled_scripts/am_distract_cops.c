	...
	while (true)
	{
		...
		switch (func_250(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				...
				{
					func_248();
					Local_93[NETWORK::PARTICIPANT_ID_TO_INT()] = 1;
				}
				else if (func_249() == 4)
				{
					Local_93[NETWORK::PARTICIPANT_ID_TO_INT()] = 3;
				}
				break;
			...
			case 3:
				...
				{
					Local_93[NETWORK::PARTICIPANT_ID_TO_INT()] = 4;
				}
				break;
...
void func_11()
{
	if (Local_73 == 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iLocal_228)))
		{
			...
			if (func_277(iVar0, 1, 1))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_73.f_1, 0))
				{
					if (GAMEPLAY::IS_BIT_SET(Local_93[iLocal_228].f_1, 0))
					{
						iLocal_229 = 1;
	...
	iLocal_228++;
	if (iLocal_228 == NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (iLocal_229 == 0)
		{
			if (GAMEPLAY::IS_BIT_SET(Local_73.f_1, 0))
...
void func_14()
{
	if (!GAMEPLAY::IS_BIT_SET(iLocal_222, 1))
	{
		if ((GAMEPLAY::IS_BIT_SET(Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_1, 0) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) >= (Local_73.f_16 - 1)) && Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_2 < 10)
		{
			Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_2++;
		}
		if (Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_2 > 0)
		{
			iVar0 = (Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_2 * Global_262145.f_8101);
			...
			if (GAMEPLAY::IS_BIT_SET(iLocal_222, 4))
			{
				if (!GAMEPLAY::IS_BIT_SET(iLocal_222, 5))
				{
					func_15(66, 1, -1);
				}
			}
		}
		GAMEPLAY::SET_BIT(&iLocal_222, 1);
	}
}
...
int func_39(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_70(PLAYER::PLAYER_ID()) || (func_69() && func_68())) && !GAMEPLAY::IS_BIT_SET(Global_2537071.f_4591, 31)) && !bParam4)
	{
		uVar1 = func_67();
		if (ENTITY::DOES_ENTITY_EXIST(uVar1))
		{
			if (PED::IS_PED_A_PLAYER(uVar1))
			{
				...
				{
					if (func_277(NETWORK::_NETWORK_GET_PED_PLAYER(uVar1), 0, 1))
					{
						if ((iParam1 > -1 && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
						{
							...
							{
								return func_52(iParam0, NETWORK::_NETWORK_GET_PED_PLAYER(uVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
...
int func_111(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iParam1) || iParam5)
	{
		...
		UI::_SET_NOTIFACTION_COLOR_NEXT(func_39(iParam1, -2, 1, 0, 0));
		UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(func_116(&Var1));
		if (!iParam3 == 0)
		{
...
void func_112(int iParam0, char* sParam1, int iParam2, char* sParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
...
{
	func_246();
	if (UI::DOES_BLIP_EXIST(uLocal_223))
	{
		if (func_244() || func_243())
		{
			UI::SET_BLIP_DISPLAY(uLocal_223, 0);
		}
		else
		{
			UI::SET_BLIP_DISPLAY(uLocal_223, 4);
		}
	}
	switch (Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_3)
	{
		case 0:
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_73.f_2, Local_73.f_5, Local_73.f_5, 1000f, 0, 1, 0))
			{
				func_220();
				GAMEPLAY::SET_BIT(&(Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_1), 0);
				GAMEPLAY::SET_BIT(&(Global_2537071.f_4592), 0);
				Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_3 = 1;
			}
			if (Local_73.f_7 > 1)
			{
				Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_3 = 2;
			}
			break;
...
void func_130()
{
	if (!GAMEPLAY::IS_BIT_SET(iLocal_222, 5))
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_222, 4))
		{
			if (Local_73.f_17 == 0)
			{
				GAMEPLAY::SET_BIT(&iLocal_222, 4);
			}
			else
			{
				GAMEPLAY::SET_BIT(&iLocal_222, 5);
			}
		}
...
void func_161(int iParam0, int iParam1, int iParam2)
{
	if (func_180())
	{
		...
		if (func_169(PLAYER::PLAYER_ID()))
		{
			...
			Global_1590535[PLAYER::PLAYER_ID()].f_211.f_6 = func_167(iParam0, 1);
		}
...
int func_178(int iParam0)
{
	if (iParam0 < 0)
	{
		if (GAMEPLAY::ABSI(iParam0) > func_170(PLAYER::PLAYER_ID()))
		{
...
void func_193()
{
	if (func_9(&uLocal_226, 10000, 0))
	{
		...
		{
			PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), Local_73.f_16, 0);
...
void func_194()
{
	...
	{
		func_197();
		Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_3 = 0;
	}
	else if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_73.f_2, Local_73.f_6, Local_73.f_6, 950f, 0, 1, 0))
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_222, 0) && GAMEPLAY::IS_BIT_SET(iLocal_222, 3))
		{
			if (!UI::IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_196())
			{
				if (!func_244())
				{
					func_195("DCP_LEAVE", -1);
				}
				GAMEPLAY::SET_BIT(&iLocal_222, 0);
			}
		}
	}
	else
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_222, 3))
		{
			GAMEPLAY::SET_BIT(&iLocal_222, 3);
		}
		if (GAMEPLAY::IS_BIT_SET(iLocal_222, 0))
		{
			GAMEPLAY::CLEAR_BIT(&iLocal_222, 0);
		}
	}
}
...
void func_197()
{
	...
	func_5(&uLocal_226);
	func_198();
	GAMEPLAY::CLEAR_BIT(&(Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_1), 0);
	GAMEPLAY::CLEAR_BIT(&iLocal_222, 3);
	GAMEPLAY::SET_BIT(&(Global_2537071.f_4592), 0);
	if (!GAMEPLAY::IS_BIT_SET(iLocal_222, 5))
	{
		GAMEPLAY::SET_BIT(&iLocal_222, 5);
...
void func_198()
{
	if (GAMEPLAY::IS_BIT_SET(iLocal_222, 2))
	{
		func_199(1, 1, 0);
		GAMEPLAY::CLEAR_BIT(&iLocal_222, 2);
	}
}
...
void func_206(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Global_2425662[Global_2439138.f_1894.f_703.f_16].f_404, 0) && func_207())
		{
			iParam0 = 23;
		}
	}
...
void func_220()
{
	if (!GAMEPLAY::IS_BIT_SET(iLocal_222, 2))
	{
		...
		GAMEPLAY::SET_BIT(&iLocal_222, 2);
	}
}

void func_221(struct<3> Param0, int iParam3, int iParam4)
{
...
void func_222(struct<3> Param0, var uParam3, int iParam4, int iParam5)
{
	func_223(Param0, 0f, 0f, 0f, uParam3, 0, iParam4, iParam5);
}

void func_223(struct<3> Param0, struct<3> Param3, var uParam6, int iParam7, int iParam8, var uParam9)
{
	if (func_232(PLAYER::PLAYER_ID()) || uParam9)
	{
		if (Var0.f_10 == 1)
		{
			func_231(&Param0, &Param3);
		}
		Var0 = { Param0 };
		Var0.f_3 = { Param3 };
		Var0.f_6 = uParam6;
...
int func_227(struct<3> Param0, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)
{
	iVar0 = 0;
		...
		if (uParam12[iVar0]->f_9)
		{
			switch (uParam12[iVar0]->f_10)
			{
				case 0:
					...
					{
						case 0:
							if (func_230(Param0, Param0.f_6, *uParam12[iVar0], uParam12[iVar0]->f_6))
							{
								return 0;
							}
							break;
						...
						case 1:
							if (func_228(Param0, Param0.f_3, *uParam12[iVar0], uParam12[iVar0]->f_6))
							{
								return 0;
							}
							break;
...
bool func_228(struct<3> Param0, struct<3> Param3, struct<3> Param6, float fParam9)
{
	fVar6 = (fParam9 * 0.7071068f);
	Var0 = { Param6 - Vector(fVar6, fVar6, fVar6) };
	Var3 = { Param6 + Vector(fVar6, fVar6, fVar6) };
	return func_229(Param0, Param3, Var0, Var3);
}

int func_229(struct<3> Param0, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
...
int func_230(struct<3> Param0, float fParam3, struct<3> Param4, float fParam7)
{
	Var0 = { Param4 - Param0 };
...
void func_240(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	func_241(Param0, 0f, 0f, 0f, fParam3, 0, iParam4, iParam6, iParam5, iParam7);
}

void func_241(struct<3> Param0, struct<3> Param3, var uParam6, int iParam7, int iParam8, var uParam9, var uParam10, var uParam11)
{
	if (func_232(PLAYER::PLAYER_ID()) || uParam9)
	{
...
void func_246()
{
	if (!GAMEPLAY::IS_BIT_SET(iLocal_222, 6))
	{
		if (((((((func_247(60000) && func_249() == 1) && Local_73.f_7 <= 1) && !UI::IS_HELP_MESSAGE_BEING_DISPLAYED()) && !UI::IS_PAUSE_MENU_ACTIVE()) && func_277(PLAYER::PLAYER_ID(), 1, 1)) && !func_196()) && Local_73.f_16 != 5)
		{
			if (!func_244())
			{
				func_195("DCP_HELP1", -1);
			}
			GAMEPLAY::SET_BIT(&iLocal_222, 6);
		}
	}
}
...
void func_248()
{
	...
	{
		uLocal_223 = UI::ADD_BLIP_FOR_RADIUS(Local_73.f_2, Local_73.f_5);
		UI::SET_BLIP_COLOUR(uLocal_223, 50);
		UI::SET_BLIP_ALPHA(uLocal_223, 220);
		UI::_0x75A16C3DA34F1245(uLocal_223, 0);
		UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_223, "DCP_BLIPN");
		if (func_244())
		{
			UI::SET_BLIP_DISPLAY(uLocal_223, 0);
		}
...
int func_255()
{
	...
	if (func_256() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_256()) == 0)
		{
			return 1;
		}
	}
...
void func_269(struct<21> Param0)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		func_268(16, 1);
		Local_93[NETWORK::PARTICIPANT_ID_TO_INT()] = 0;
	}
	else
	{
		func_266();
...
void func_275(var uParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_267();
