...
void func_87(bool bParam0)
{
	...
	{
		MISC::CLEAR_AREA_OF_VEHICLES(Local_911, 50f, 0, 0, 0, 0, 0, 0);
...
void func_152(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_146(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_146(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
			...
			if ((func_283(Local_523[0]) && func_283(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_523[0]))
			{
				if (func_228() || func_27(Local_523[0], PLAYER::PLAYER_PED_ID(), 5f, 1))
				{
					if (func_27(Local_523[0], PLAYER::PLAYER_PED_ID(), 12f, 1))
					{
						...
						{
							TASK::CLEAR_PED_TASKS(Local_523[0]);
							TASK::OPEN_SEQUENCE_TASK(&uLocal_866);
							TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4000);
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_523[0].f_9, 1f, 20000, 0.25f, 0, 40000f);
							TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
							TASK::TASK_PERFORM_SEQUENCE(Local_523[0], uLocal_866);
							TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
							iLocal_881 = 1;
							TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_523[0], 5000, 0, 2);
						}
					}
				}
			}
		...
		if (iLocal_887 == 1)
		{
			if ((func_283(Local_523[1]) && func_283(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_523[1]))
			{
				if (func_27(Local_523[1], PLAYER::PLAYER_PED_ID(), 8f, 1))
				{
					...
					{
						TASK::CLEAR_PED_TASKS(Local_523[1]);
						TASK::OPEN_SEQUENCE_TASK(&uLocal_866);
						TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4000);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_523[1].f_9, 1f, 20000, 0.25f, 0, 40000f);
						TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
						TASK::TASK_PERFORM_SEQUENCE(Local_523[1], uLocal_866);
						TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
						TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_523[1], 3500, 0, 2);
						iLocal_887 = 0;
					}
				}
			}
			...
			if (iLocal_875 == 0)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_605, -662.7688f, -208.3171f, 35.49321f, -674.6289f, -214.6519f, 38.80591f, 6.5f, 0, 1, 0))
				{
					...
					if (func_283(Local_523[2]))
					{
						...
						{
							PED::SET_PED_PANIC_EXIT_SCENARIO(Local_523[2], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
						}
						TASK::OPEN_SEQUENCE_TASK(&uLocal_866);
						...
						TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
						TASK::TASK_PERFORM_SEQUENCE(Local_523[2], uLocal_866);
						TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
					}
					iLocal_875 = 1;
				}
	...
	if (func_221(Local_651) && func_283(iLocal_605))
	{
		switch (iLocal_515)
		{
			...
			case 4:
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&uLocal_866);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_651, -2f, 2f, 0f), 2f, 20000, 0.25f, 0, 40000f);
					if (func_283(Local_627.f_1))
					{
...
void func_241()
{
	...
	switch (iLocal_522)
	{
		case 0:
			...
			iLocal_885 = 0;
			iLocal_887 = 0;
			MISC::CLEAR_AREA_OF_VEHICLES(-628.8963f, -183.1741f, 36.76265f, 50f, 1, 0, 0, 0, 0, 0);
			MISC::CLEAR_AREA_OF_VEHICLES(-679.2649f, -250.0605f, 35.60568f, 21.75f, 1, 0, 0, 0, 0, 0);
			MISC::CLEAR_AREA_OF_VEHICLES(-655.583f, -298.5198f, 34.45316f, 39.75f, 1, 0, 0, 0, 0, 0);
			MISC::CLEAR_AREA_OF_VEHICLES(-670.7004f, -99.16148f, 36.77983f, 60f, 1, 0, 0, 0, 0, 0);
			MISC::CLEAR_AREA_OF_VEHICLES(-561.3182f, -153.0898f, 36.6348f, 50f, 1, 0, 0, 0, 0, 0);
			MISC::CLEAR_AREA_OF_VEHICLES(-590.6263f, -247.0923f, 34.69418f, 35f, 1, 0, 0, 0, 0, 0);
			MISC::CLEAR_AREA_OF_VEHICLES(Local_911, 50f, 0, 0, 0, 0, 0, 0);
			if (!func_248())
			{
				return;
			...
			{
				TASK::TASK_START_SCENARIO_IN_PLACE(Local_523[0], "WORLD_HUMAN_WINDOW_SHOP_BROWSE", 0, 1);
			}
			if (func_283(Local_523[2]))
			{
				TASK::TASK_START_SCENARIO_IN_PLACE(Local_523[2], "WORLD_HUMAN_WINDOW_SHOP_BROWSE", 0, 1);
			}
			if (func_283(Local_523[4]))
			{
				TASK::TASK_START_SCENARIO_IN_PLACE(Local_523[4], "WORLD_HUMAN_STAND_MOBILE", 0, 0);
			}
			if (func_283(Local_523[1]))
			{
				TASK::TASK_START_SCENARIO_IN_PLACE(Local_523[1], "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
...
void func_243()
{
	if (func_283(Local_523[4]) && func_283(iLocal_605))
	{
		if (Local_523[4].f_13 == 0)
		{
			...
			{
				TASK::CLEAR_PED_TASKS(Local_523[4]);
				...
				TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
				TASK::TASK_PERFORM_SEQUENCE(Local_523[4], uLocal_866);
				TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
				Local_523[4].f_13 = 1;
			}
		}
	...
	if (!Local_523[iParam0].f_14)
	{
		if (func_283(Local_523[iParam0]) && func_283(iLocal_605))
		{
			if (!Local_523[iParam0].f_13)
			{
				if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_605))
				{
					if (func_232() > Local_523[iParam0].f_12)
					{
						...
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_523[iParam0].f_6, 1f, 20000, 0.25f, 0, 40000f);
						TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
						TASK::TASK_PERFORM_SEQUENCE(Local_523[iParam0], uLocal_866);
						TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
			...
			else if (func_27(Local_523[iParam0], iLocal_605, 3f, 1))
			{
				...
				TASK::CLEAR_PED_TASKS(Local_523[iParam0]);
				TASK::OPEN_SEQUENCE_TASK(&uLocal_866);
				TASK::TASK_LOOK_AT_ENTITY(0, iLocal_605, -1, 0, 2);
				if (Var0.y > 0.7f)
				{
					TASK::TASK_PLAY_ANIM(0, sLocal_907, Local_523[iParam0].f_15, 8f, -4f, -1, 0, 0, 0, 0, 0);
				}
				else
				{
				...
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_605, 0);
				TASK::TASK_PAUSE(0, 1000);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_523[iParam0].f_9, 1f, 20000, 0.25f, 0, 40000f);
				TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
				TASK::TASK_PERFORM_SEQUENCE(Local_523[iParam0], uLocal_866);
				TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_438(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_465(int iParam0)
{
	...
	func_57(Local_651);
	func_55(&iLocal_699);
	MISC::CLEAR_AREA_OF_VEHICLES(-669.0843f, -209.1426f, 36.27277f, 25.25f, 0, 0, 0, 0, 0, 0);
	MISC::CLEAR_AREA_OF_VEHICLES(Local_911, 50f, 0, 0, 0, 0, 0, 0);
...
void func_471()
{
	...
	if (func_482())
	{
		...
		MISC::CLEAR_AREA_OF_VEHICLES(-633.4493f, -248.2691f, 35.87451f, 50f, 0, 0, 0, 0, 0, 0);
		MISC::CLEAR_AREA_OF_VEHICLES(Local_911, 50f, 0, 0, 0, 0, 0, 0);
		func_472();
		func_249();
		iLocal_604 = Local_453.f_28[0];
