...
int func_106()
{
	if (MISC::IS_BIT_SET(Global_111638.f_18569[58], 0) && !MISC::IS_BIT_SET(Global_111638.f_18569[58], 3))
	{
		return 1;
	}
	return 0;
...
int func_111()
{
	if (MISC::IS_BIT_SET(Global_111638.f_18569[60], 0) && !MISC::IS_BIT_SET(Global_111638.f_18569[60], 3))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_111638.f_18569[61], 0) && !MISC::IS_BIT_SET(Global_111638.f_18569[61], 3))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_111638.f_18569[62], 3))
	{
		return 0;
	}
	if ((MISC::IS_BIT_SET(Global_111638.f_18569[58], 2) || MISC::IS_BIT_SET(Global_111638.f_18569[59], 2)) || MISC::IS_BIT_SET(Global_111638.f_18569[62], 2))
	{
		return 1;
	}
	return 0;
