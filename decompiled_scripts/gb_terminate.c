...
void func_1()
{
	switch (Local_82.f_8)
	{
		...
		case 2:
			if (GAMEPLAY::IS_BIT_SET(Local_82.f_1, 5))
			{
				func_40(3);
			}
			func_38();
...
void func_2()
{
	if (!func_13(func_37()))
	{
		func_12(1);
		func_40(2);
		GAMEPLAY::SET_BIT(&(Local_82.f_1), 2);
	}
	if (func_11() == func_10() || !func_9(func_11(), 0, 1))
	{
		func_12(3);
		func_40(2);
		GAMEPLAY::SET_BIT(&(Local_82.f_1), 3);
	}
	if (GAMEPLAY::IS_BIT_SET(Local_82.f_1, 0))
	{
		if (func_3(&(Local_82.f_4), func_5(), 0))
		{
			GAMEPLAY::SET_BIT(&(Local_82.f_1), 4);
		}
	}
	if (GAMEPLAY::IS_BIT_SET(Local_82.f_1, 4))
	{
		func_12(2);
		func_40(2);
	}
	if (GAMEPLAY::IS_BIT_SET(Local_82.f_1, 1) || GAMEPLAY::IS_BIT_SET(Local_82.f_1, 7))
	{
		func_12(0);
		func_40(2);
	}
...
bool func_23(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_1377170.f_241.f_136[func_25(10)][iParam0], func_24(10));
}
...
void func_38()
{
	...
	while (iVar2 < iVar1)
	{
		if (func_42() < 2)
		{
			if (GAMEPLAY::IS_BIT_SET(Local_93[iVar2].f_1, 1))
			{
				func_39(PLAYER::INT_TO_PLAYERINDEX(iVar2));
				GAMEPLAY::SET_BIT(&(Local_82.f_1), 1);
			}
			if (GAMEPLAY::IS_BIT_SET(Local_93[iVar2].f_1, 4))
			{
				func_39(func_11());
				GAMEPLAY::SET_BIT(&(Local_82.f_1), 7);
			}
			if (GAMEPLAY::IS_BIT_SET(Local_93[iVar2].f_1, 0))
			{
				GAMEPLAY::SET_BIT(&(Local_82.f_1), 0);
			}
			if (GAMEPLAY::IS_BIT_SET(Local_93[iVar2].f_1, 2))
			{
				GAMEPLAY::SET_BIT(&(Local_82.f_1), 4);
			}
		}
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Local_93[iVar2].f_1, 3))
			{
				iVar0++;
			}
		}
	...
	if (func_42() == 2)
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Local_82.f_1), 5);
		}
...
int func_44()
{
	if (GAMEPLAY::IS_BIT_SET(Local_82.f_1, 6))
	{
		return 1;
	}
	func_50(func_10());
	...
	if (func_37() != func_10())
	{
		...
		GAMEPLAY::SET_BIT(&(Local_82.f_1), 6);
		return 1;
	}
...
int func_61(bool bParam0)
{
	...
	{
		bVar0 = false;
		if (Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57 != func_10())
		{
			if (func_9(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57, 0, 1))
			{
		...
		if (bVar0)
		{
			if (bParam0)
			{
				...
				if (Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57 != func_10() && NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57))
				{
					Global_1626725 = func_63(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57, -2, 0, 0, 0);
					if (!func_62(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57))
					{
						func_93(88);
					}
				}
...
int func_63(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_17(PLAYER::PLAYER_ID()) || (func_91() && func_90())) && !GAMEPLAY::IS_BIT_SET(Global_2537071.f_4591, 31)) && !bParam4)
	{
		uVar1 = func_89();
		if (ENTITY::DOES_ENTITY_EXIST(uVar1))
		{
			if (PED::IS_PED_A_PLAYER(uVar1))
			{
				...
				{
					if (func_9(NETWORK::_NETWORK_GET_PED_PLAYER(uVar1), 0, 1))
					{
						if ((iParam1 > -1 && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
						{
							...
							{
								return func_76(iParam0, NETWORK::_NETWORK_GET_PED_PLAYER(uVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
...
int func_92(int iParam0)
{
	switch (iParam0)
	{
		...
		case 180:
		case 148:
			if (Global_1590535[PLAYER::PLAYER_ID()] == 148 && func_8(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_35, 1))
			{
				return 1;
			}
			else
...
void func_96()
{
	switch (func_620())
	{
		...
		case 1:
			if (!GAMEPLAY::IS_BIT_SET(uLocal_80, 2))
			{
				func_600();
			}
		...
		case 2:
			if (!GAMEPLAY::IS_BIT_SET(Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_1, 3))
			{
				func_394(0, func_10());
				func_302();
				func_97();
...
void func_97()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_1, 3))
	{
		if ((GAMEPLAY::IS_BIT_SET(Local_82.f_1, 2) || GAMEPLAY::IS_BIT_SET(Local_82.f_1, 4)) || GAMEPLAY::IS_BIT_SET(Local_82.f_1, 4))
		{
			GAMEPLAY::SET_BIT(&(Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_1), 3);
			return;
		}
		if (func_301())
		{
		...
		if (GAMEPLAY::IS_BIT_SET(Local_82.f_1, 7))
		{
			func_98(151, 1, &Var0, 0);
		}
		else
		{
			func_98(151, GAMEPLAY::IS_BIT_SET(Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_1, 1), &Var0, 0);
		}
		GAMEPLAY::SET_BIT(&(Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_1), 3);
	}
}
...
void func_98(int iParam0, bool bParam1, var uParam2, bool bParam3)
{
	...
	func_269(iParam0, bParam1, uParam2, &iVar0, &uVar4);
	...
	if (iVar0 > 0)
	{
		...
		func_130(iParam0, iVar0, iVar7, uVar4, iVar5, uParam2);
	...
	switch (iParam0)
	{
		...
		case 190:
			if (func_122())
			{
				...
				{
					Var7 = { func_150() };
					unk_0x8586789730B10CAF(iParam1, GAMEPLAY::GET_HASH_KEY(func_149(Var7)), func_148(Var7), iParam4);
				}
			}
			else if (func_151())
			{
		...
		case 226:
			if (func_136())
			{
				if (!func_151())
				{
					unk_0x8586789730B10CAF(iParam1, GAMEPLAY::GET_HASH_KEY(func_149(func_135(PLAYER::PLAYER_ID()))), 5, iParam4);
				}
			}
			else if (func_151())
			{
...
int func_138(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (!bVar0)
	{
		if (!UNK3::_0xB24F0944DA203D9E(func_21()) || UNK3::_0x810E8431C0614BF9())
		{
			Global_4264536 = 1;
			return 0;
		}
...
int func_145(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, var uParam5, bool bParam6, var uParam7, var uParam8, int iParam9, int iParam10)
{
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 5)
...
int func_154(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, char* sParam8, bool bParam9, int iParam10)
{
	iVar0 = func_164(iParam0, uParam2, iParam3, iParam4, iParam5, iParam6, iParam7, bParam9);
...
var func_164(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	uVar0 = func_165(iParam0, 0, uParam1, iParam4, iParam5, 0, iParam6, 1, iParam2, iParam3, bParam7);
	return uVar0;
}

int func_165(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
...
void func_176(int iParam0, int iParam1, int iParam2)
{
	if (func_193())
	{
		...
		if (func_15(PLAYER::PLAYER_ID()))
		{
			...
			Global_1590535[PLAYER::PLAYER_ID()].f_211.f_6 = func_180(iParam0, 1);
		}
...
int func_191(int iParam0)
{
	if (iParam0 < 0)
	{
		if (GAMEPLAY::ABSI(iParam0) > func_182(PLAYER::PLAYER_ID()))
		{
...
int func_211(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iParam1) || iParam5)
	{
		...
		UI::_SET_NOTIFACTION_COLOR_NEXT(func_63(iParam1, -2, 1, 0, 0));
		UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(func_216(&Var1));
		if (!iParam3 == 0)
		{
...
var func_237(struct<5> Param0, int iParam5)
{
...
{
	uVar0 = Global_2583656[iParam0][func_120(iParam1)];
	...
	else if (iParam0 == 190)
	{
		if (uParam1->f_10 > 0)
		{
			if (func_122())
			{
				...
				iVar7 = func_262(PLAYER::PLAYER_ID(), Var0, *uParam3);
				if (Var0.f_1 == 1)
				{
	...
	else if (iParam0 == 168)
	{
		if (bParam1)
		{
			if (func_29(PLAYER::PLAYER_ID()))
			{
				if (uParam2->f_5)
				{
					*iParam3 = (*iParam3 + func_275(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_182));
				}
				else
				{
					*uParam4 = uParam2->f_7;
...
int func_275(int iParam0)
{
	if (func_282(iParam0))
	{
		...
		if (iVar1 < func_276(iParam0))
		{
			...
			{
				iVar0 = (iVar0 + func_280(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 6)));
				iVar2++;
			}
		}
	}
...
void func_302()
{
	...
	if ((!GAMEPLAY::IS_BIT_SET(Local_82.f_1, 2) && !GAMEPLAY::IS_BIT_SET(Local_82.f_1, 4)) && !GAMEPLAY::IS_BIT_SET(Local_82.f_1, 3))
	{
		if (GAMEPLAY::IS_BIT_SET(Local_82.f_1, 7))
		{
			sVar1 = "GBTER_B_SSH";
	...
	else if (GAMEPLAY::IS_BIT_SET(Local_82.f_1, 3))
	{
	}
	else
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Local_82.f_1, 4) || func_31(func_37(), 1, 0))
		{
...
var func_330(int iParam0, bool bParam1)
{
	if (!bParam1)
	{
		if (func_6(iParam0, 1))
...
int func_355()
{
	...
	if (((func_375(Global_1590535[PLAYER::PLAYER_ID()].f_274.f_28) || func_374(PLAYER::PLAYER_ID())) || func_373(PLAYER::PLAYER_ID())) || func_368(PLAYER::PLAYER_ID()))
	{
...
bool func_370(int iParam0, bool bParam1)
{
	if (Global_1590373 != func_10())
	{
		...
		if (bParam1)
		{
			...
			{
				if (GAMEPLAY::IS_BIT_SET(Global_2425662[Global_1590373].f_195, 24) || func_371(Global_1590373))
				{
					return 1;
				}
			}
...
void func_396(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, int iParam5, bool bParam6, int iParam7)
{
	if (func_515(iParam2))
	{
		return;
	...
	{
		if (func_468(uParam1, iParam2, uParam3, Global_1574185, 0, func_511(), iParam7))
		{
			func_467(1);
			if ((!func_466() && !func_465()) || GAMEPLAY::IS_BIT_SET(Global_2537071.f_4588, 1))
			{
				if (func_464())
				{
					func_463();
				...
				else
				{
					...
					if (uParam3->f_27 == 0)
					{
						...
						while (iVar52 < 32)
						{
							...
							if ((func_455(iVar35) && func_451(iVar35, iParam2)) && func_9(iVar35, 0, 1))
							{
								...
								*uParam4[iVar52] = { func_175(iVar35) };
								...
								if (func_432(iParam5))
								{
									func_431(iVar35, uParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar43, iVar47, &Var57, uParam0[iVar52]->f_40, iVar48, bParam6);
								}
								else
								{
									func_431(iVar35, uParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar46, iVar47, &Var57, uParam0[iVar52]->f_40, iVar48, bParam6);
								}
							...
							if (func_455(iVar35))
							{
								if (func_9(PLAYER::INT_TO_PLAYERINDEX(iVar52), 0, 1))
								{
									...
									*uParam4[iVar52] = { func_175(iVar35) };
									...
									uParam3->f_38[iVar44].f_1 = iVar53;
									func_411(iVar35, PLAYER::GET_PLAYER_NAME(iVar35), uParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar51, iVar50);
									iVar53++;
								}
							}
							iVar52++;
						...
						{
							func_408(uParam3, uParam1, iParam2);
						}
					...
					if (uParam3->f_27 == 2)
					{
						if (!GAMEPLAY::IS_BIT_SET(uParam3->f_33, 7))
						{
							func_405(uParam3, uParam1);
							func_404(uParam1, 0, 1);
		...
		if (iVar2 != func_10())
		{
			if (func_9(iVar2, 0, 1))
			{
				if (uParam0->f_38[iVar0].f_1 != -1)
				{
					...
					func_409(uParam1, uParam0->f_38[iVar0].f_1, iVar1, Global_1590535[iVar0].f_211.f_6);
				}
			}
		}
		iVar0++;
...
void func_411(int iParam0, char* sParam1, var uParam2, var uParam3, int iParam4, char* sParam5, var uParam6, var uParam7, var uParam8, char* sParam9, int iParam10, int iParam11, int iParam12)
{
...
void func_431(int iParam0, var uParam1, var uParam2, int iParam3, char* sParam4, var uParam5, var uParam6, var uParam7, char* sParam8, int iParam9, int iParam10, int iParam11, int iParam12, float fParam13, int iParam14, int iParam15, char* sParam16, int iParam17, int iParam18, bool bParam19)
{
...
int func_464()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2537071.f_4588, 0) && func_335())
	{
		return 1;
	}
	if (GAMEPLAY::IS_BIT_SET(Global_2537071.f_4588, 1) && func_335())
	{
		return 1;
	}
	return 0;
...
int func_468(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, char* sParam6)
{
	StringCopy(&Var0, "", 16);
	bVar5 = iParam1 == 20;
	...
	if (!func_399(&(uParam2->f_19)))
	{
		if (func_507() == 1)
		{
			func_495(bVar6, uParam0, 0);
			func_4(&(uParam2->f_19), 0, 0);
			func_496(uParam0, uParam2, 0);
	...
	if (func_399(&(uParam2->f_19)) || bParam5)
	{
		...
		else
		{
			...
			if (!GAMEPLAY::IS_BIT_SET(uParam2->f_33, 0))
			{
				...
				UI::_0x55598D21339CB998(fVar7);
				if (func_495(bVar6, uParam0, 0))
				{
					func_461(uParam0, 0, 0);
					uVar4 = func_492(iParam1, &(Global_4456448.f_194997), bParam4);
					Var0 = { func_490(iParam1) };
					if (bParam4)
					{
						func_487(uParam0, uVar4, "", 0, -1, -1, 1);
					}
					else if (iParam1 == 27)
					{
						func_480(uParam0, func_484(uParam2), func_481(uParam2), -1);
					}
					else if (iParam1 == 28)
					{
						...
						func_474(uParam0, sVar9, func_475(), -1);
					}
					else if (func_417())
					{
						uParam2->f_34 = Global_1574186;
						func_487(uParam0, uVar4, &Var0, 1, -1, Global_1574186, 1);
					}
					else if (bVar5)
					{
						iVar8 = func_469(iParam1);
						uParam2->f_34 = Global_1574186;
						func_487(uParam0, uVar4, "", 0, iVar8, Global_1574186, 1);
					}
					else
					{
						iVar8 = func_469(iParam1);
						func_487(uParam0, uVar4, &Var0, 1, iVar8, -1, 1);
					}
...
char* func_476(var uParam0)
{
	...
	switch (func_32(PLAYER::PLAYER_ID()))
	{
		...
		case 192:
			if (func_477(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_181))
			{
				return "GB_DPAD_BSET";
			}
			return "GB_DPAD_BBUY";
...
void func_480(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
	{
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(*uParam0, "SET_TITLE");
...
void func_487(var uParam0, char* sParam1, char* sParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
	{
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(*uParam0, "SET_TITLE");
...
{
	if (iParam0 == 20 && (!func_417() || GAMEPLAY::IS_STRING_NULL_OR_EMPTY(uParam1)))
	{
		uVar0 = func_493();
		return uVar0;
	}
...
bool func_495(bool bParam0, var uParam1, bool bParam2)
{
	if (bParam0)
	{
...
int func_497()
{
	...
	else if (!func_392(PLAYER::PLAYER_ID(), 1, 0) && Global_1311716[0] > 0)
	{
		return 0;
	}
...
{
	iVar0 = 2;
	bVar1 = ((func_426(iParam0) && !func_454(iParam0)) && !GAMEPLAY::IS_BIT_SET(Global_1628237[iParam0].f_1, 8));
...
void func_519()
{
	...
	{
		func_520(151, ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(func_37()), 1), &uLocal_81, 1140457472, 1144750080, 0);
	}
}

void func_520(int iParam0, struct<3> Param1, var uParam4, float fParam5, float fParam6, int iParam7)
{
	if ((((func_426(PLAYER::PLAYER_ID()) && !func_454(PLAYER::PLAYER_ID())) && !GAMEPLAY::IS_BIT_SET(Global_1628237[PLAYER::PLAYER_ID()].f_1, 8)) && (func_423(PLAYER::PLAYER_ID()) || func_518(PLAYER::PLAYER_ID()))) || func_562(Param1))
	{
		return;
	}
	...
	else
	{
		...
		if (*uParam4 && func_9(PLAYER::PLAYER_ID(), 1, 1))
		{
			*uParam4 = 0;
			...
			if (iParam7 && !func_426(PLAYER::PLAYER_ID()))
			{
...
void func_532(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Global_2425662[Global_2439138.f_1894.f_703.f_16].f_404, 0) && func_533())
		{
			iParam0 = 23;
		}
	}
...
{
	if (GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()) == func_550())
	{
		return;
	}
...
void func_557(struct<3> Param0, int iParam3, int iParam4)
{
		...
		if ((ENTITY::DOES_ENTITY_EXIST(Var0) && ENTITY::IS_ENTITY_A_PED(Var0)) && ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(Var0) == PLAYER::GET_PLAYER_PED(func_37()))
		{
			if (Var0.f_5)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Var0.f_1) && ENTITY::IS_ENTITY_A_PED(Var0.f_1))
				{
					...
					{
						GAMEPLAY::SET_BIT(&(Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_1), 1);
					}
				}
			}
		}
...
void func_565()
{
	if (!GAMEPLAY::IS_BIT_SET(iLocal_80, 3))
	{
...
void func_566(int iParam0, bool bParam1, int iParam2)
{
	...
	if (bParam1)
	{
		...
		else if (UI::DOES_BLIP_EXIST(Global_2416079[iVar0]))
		{
			GAMEPLAY::SET_BIT(&(Global_2416079.f_370), iVar0);
			GAMEPLAY::CLEAR_BIT(&(Global_2416079.f_375), iVar0);
			UI::SET_BLIP_FLASHES(Global_2416079[iVar0], 1);
			UI::SET_BLIP_FLASH_INTERVAL(Global_2416079[iVar0], 250);
			func_567(iParam0);
			if (iParam2 < 0)
			{
				GAMEPLAY::SET_BIT(&(Global_2416079.f_375), iVar0);
			}
			else
			{
	...
	if (!bParam1)
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2416079.f_370), iVar0);
		GAMEPLAY::CLEAR_BIT(&(Global_2416079.f_375), iVar0);
		if (UI::DOES_BLIP_EXIST(Global_2416079[iVar0]))
		{
			func_567(iParam0);
			UI::SET_BLIP_FLASHES(Global_2416079[iVar0], 0);
		}
	}
}
...
void func_567(int iParam0)
{
	...
	if (func_9(iParam0, 0, 1))
	{
		if (UI::DOES_BLIP_EXIST(Global_2416079[iVar0]))
		{
			...
			UI::SET_BLIP_PRIORITY(Global_2416079[iVar0], Global_2416079.f_1501[iVar0]);
		}
	}
}
...
int func_568(int iParam0)
{
	...
	if (func_9(iParam0, 0, 1))
	{
		if (UI::DOES_BLIP_EXIST(Global_2416079[iVar0]))
		{
			iVar1 = UI::GET_BLIP_SPRITE(Global_2416079[iVar0]);
			if (GAMEPLAY::IS_BIT_SET(Global_2416079.f_386, iVar0) || GAMEPLAY::IS_BIT_SET(Global_2416079.f_385, iVar0))
			{
				return 1;
			}
			else if ((GAMEPLAY::IS_BIT_SET(Global_2416079.f_371, iVar0) || GAMEPLAY::IS_BIT_SET(Global_2416079.f_370, iVar0)) || GAMEPLAY::IS_BIT_SET(Global_2416079.f_388, iVar0))
			{
				return func_571(10);
			}
			else
...
int func_573()
{
	...
	if (iVar0 > -1 && iVar0 < 4)
	{
		return GAMEPLAY::IS_BIT_SET(Global_4456448.f_271[iVar0].f_9568, 4);
	}
	return 0;
}
...
int func_575(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4, bool bParam5, var uParam6)
{
	if (bParam5)
	{
...
void func_600()
{
	...
	if (PLAYER::PLAYER_ID() != func_60())
	{
		if (GAMEPLAY::IS_BIT_SET(iLocal_80, 0))
		{
			if (!func_335())
			{
				sVar0 = "GBTER_START";
		...
		else
		{
			...
			GAMEPLAY::SET_BIT(&(Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_1), 0);
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(iLocal_80, 0))
	{
		if (!func_335())
		{
			sVar3 = "GBTER_BOSS";
...
void func_602(char* sParam0, var uParam1, int iParam2, int iParam3)
{
...
{
	Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_2 = iParam0;
}
...
int func_620()
{
	return Local_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_2;
}
...
int func_627()
{
	...
	if (func_550() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_550()) == 0)
		{
			return 1;
		}
	}
...
void func_637(bool bParam0, int iParam1)
{
	...
	if (Global_1628237[PLAYER::PLAYER_ID()].f_11.f_33 != -1)
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Global_1574650.f_1, 14) && !func_426(PLAYER::PLAYER_ID()))
		{
			func_546(0);
		}
	}
	...
	func_298(29);
	Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57 = func_10();
...
{
	if (!func_661(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_337[iParam0], func_662(), 0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_337[iParam0] = { func_662() };
	}
	if (!func_661(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_324[iParam0], func_662(), 0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_324[iParam0] = { func_662() };
	}
}

bool func_661(struct<3> Param0, struct<3> Param3, bool bParam6)
{
	if (bParam6)
	{
...
{
	if (!func_661(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_150[iParam0], func_662(), 0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_150[iParam0] = { func_662() };
	}
	if (!func_661(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_125[iParam0], func_662(), 0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_125[iParam0] = { func_662() };
	}
}
...
void func_672(int iParam0, int iParam1)
{
	...
	func_248(func_673(iParam0), iParam1, -1, 1);
...
void func_675(int iParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		{
			func_677(iParam0, (Global_1590535[PLAYER::PLAYER_ID()].f_274.f_183[iParam0].f_2 - (func_681(iVar2, bParam2) / 2)));
		}
...
void func_686(int iParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
		func_248(15384, iParam1, -1, 1);
		return;
	}
	func_248(func_685(iParam0), iParam1, -1, 1);
}
...
void func_694(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_95(0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57 = func_11();
	}
	if (func_92(iParam0))
	{
		func_698();
...
void func_710()
{
	if (func_720())
	{
		...
		{
			func_719(11);
			uVar0 = func_119(7226, -1, 0);
			GAMEPLAY::SET_BIT(&uVar0, 2);
			func_117(7226, uVar0, -1, 1, 0);
		}
	}
	if (func_718(48))
	{
