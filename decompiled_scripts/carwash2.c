void __EntryFunction__()
{
	...
	fLocal_633 = 2.1f;
	fLocal_634 = 3f;
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-1239896389) > 1)
	{
...
int func_16(var uParam0, int iParam1)
{
	...
	switch (uParam0->f_339)
	{
		...
		case 6:
			...
			{
				func_36(*uParam0[0], *uParam0[1], 3f, !Global_76622);
				if (!GAMEPLAY::IS_POSITION_OCCUPIED(uParam0->f_172[6].f_1[0], 2f, 0, 1, 0, 0, 0, iParam1, 0))
				{
...
{
	fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Param0, Param3, 1);
	Var1 = { Param0 };
	...
	while (fVar7 < fVar0)
	{
		...
		if (bParam7)
		{
			GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(Var1, fParam6, 0);
		}
...
int func_52(var uParam0, int iParam1)
{
	...
	if (uParam0->f_348 == 0)
	{
		GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iParam1), &Var4, &Var7);
		if (uParam0->f_359 == 0)
		{
		...
		if (Global_76622)
		{
			uParam0->f_348 = WORLDPROBE::START_SHAPE_TEST_CAPSULE(Var1 - Vector(0.1f, 0f, 0f), Var1 + Vector(0.1f, 0f, 0f), 0.75f, 18, iParam1, 4);
		}
		else
		{
			uParam0->f_348 = WORLDPROBE::START_SHAPE_TEST_CAPSULE(Var1 - Vector(0.1f, 0f, 0f), Var1 + Vector(0.1f, 0f, 0f), 0.75f, 2, iParam1, 4);
		}
		return 0;
	}
	else
...
bool func_54(int iParam0)
{
	...
	Var6.x = GAMEPLAY::ABSF((Var3.x - Var0.x));
	Var6.y = GAMEPLAY::ABSF((Var3.y - Var0.y));
	Var6.z = GAMEPLAY::ABSF((Var3.z - Var0.z));
	return ((Var6.x >= 1.4f && Var6.y >= 1.4f) && Var6.z >= 1.4f);
}
...
int func_55(int iParam0)
{
	...
	if (ENTITY::GET_ENTITY_MODEL(iParam0) == -206690185)
	{
		return 1;
	}
	if (ENTITY::GET_ENTITY_MODEL(iParam0) == 1511880420)
	{
		return 1;
	}
	if (ENTITY::GET_ENTITY_MODEL(iParam0) == 682791951)
	{
		return 1;
	}
	return 0;
...
{
	if (ENTITY::GET_ENTITY_MODEL(uParam0) == 1435400154)
	{
		return 1;
	}
	if (ENTITY::GET_ENTITY_MODEL(iParam0) == -382832258)
	{
		return 1;
	}
	if (ENTITY::GET_ENTITY_MODEL(iParam0) == 186956100)
	{
		return 1;
	}
	return 0;
...
float func_84(var uParam0, int iParam1)
{
	...
	return GAMEPLAY::_0x7F8F6405F4777AF6(ENTITY::GET_ENTITY_COORDS(iParam1, 1), uParam0->f_14[0], uParam0->f_14[1], 0);
}

float func_85(var uParam0, int iParam1, float fParam2)
{
	fVar3 = GAMEPLAY::_0x7F8F6405F4777AF6(ENTITY::GET_ENTITY_COORDS(iParam1, 1), *uParam0[0], *uParam0[1], 0);
	if (fVar3 <= 1f)
	{
		...
		if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iParam1))
		{
			Var0 = { GAMEPLAY::_0x21C235BC64831E5A(ENTITY::GET_ENTITY_COORDS(iParam1, 1), *uParam0[0], *uParam0[1], 0) };
				...
				if (uParam0->f_1 == 0)
				{
					if (uParam0->f_19 == 0)
					{
						if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_20)
						{
							...
							uParam0->f_19 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(Var1, Var4, 2, uParam0->f_3, 4);
							FIRE::STOP_FIRE_IN_RANGE(uParam0->f_10, uParam0->f_7);
						}
					}
					else
					{
						iVar13 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_19, &uVar0, &Var7, &uVar10, &iVar14);
						if (iVar13 == 2)
						{
							if (func_97(iVar14, 1))
							{
		...
		case 3:
			...
			if (uParam0->f_1 == 0)
			{
				...
				if ((PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID())) || (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !VEHICLE::ARE_ALL_VEHICLE_WINDOWS_INTACT(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))))
				{
					...
					if ((GAMEPLAY::ABSF(Var7.x) < uParam0->f_8 && GAMEPLAY::ABSF(Var7.y) < 1.2f) && Var7.z < (-uParam0->f_9 * 0.25f))
					{
...
int func_92(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam1) && !ENTITY::IS_ENTITY_DEAD(iParam1, 0))
		{
...
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_96(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), Param0, fParam3))
	{
		return 1;
	}
	...
	return GAMEPLAY::IS_POSITION_OCCUPIED(Param0, fParam3, 0, 1, 0, 0, 0, 0, 1);
}
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (VEHICLE::IS_ANY_VEHICLE_NEAR_POINT(uParam0->f_2, 4f))
			{
				...
				{
					iVar7 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_20, &uVar0, &uVar1, &uVar4, &iVar8);
					if (iVar7 == 2)
					{
						if (func_97(iVar8, 1))
						{
...
void func_100(var uParam0)
{
	...
	if (func_79(*uParam0))
	{
		...
		{
			iVar10 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_20, &iVar0, &Var4, &uVar7, &iVar11);
			if (iVar10 == 2)
			{
				if (iVar0 > 0)
				{
	...
	if (Var1.z < uParam0->f_23)
	{
		Var1.z = (Var1.z + (uParam0->f_14 * SYSTEM::TIMESTEP()));
		if (Var1.z > uParam0->f_23)
		{
			Var1.z = uParam0->f_23;
		}
	...
	if (uParam0->f_22 != 0f)
	{
		Var1.z = func_91(Var1.z, uParam0->f_22, uParam0->f_24);
	}
		...
		case 2:
			if (uParam0->f_36 == 0)
			{
				if (bLocal_66)
				{
					...
					uParam0->f_36 = WORLDPROBE::START_SHAPE_TEST_CAPSULE(Var0, Var0 + Vector(1f, 0f, 0f), 2.5f, 2, 0, 4);
				}
				else
				{
					Var0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_1, -3f, fVar31, 0.5f) };
					uParam0->f_36 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(Var0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_1, 0f, fVar31, 0.5f), 2, 0, 7);
				}
				if (uParam0->f_36 == 0)
				{
				}
			...
			{
				iVar11 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_36, &iVar19, &Var12, &uVar15, &iVar10);
				if (iVar11 == 2)
				{
					if (func_97(iVar10, 1))
					{
					...
					while (iVar18 < uParam0->f_3)
					{
						...
						if (uParam0->f_38[iVar18] == 0)
						{
							if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_41[iVar18])
							{
								...
								{
									uParam0->f_38[iVar18] = WORLDPROBE::_0xE6AC6C45FBE83004(Var7, Var4, fLocal_74, 2, 0, 4);
								}
								else
								{
									uParam0->f_38[iVar18] = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(Var7, Var4, 2, 0, 7);
								}
								if (uParam0->f_38[iVar18] == 0)
								{
								}
						...
						{
							iVar11 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_38[iVar18], &iVar19, &Var12, &uVar15, &iVar10);
							if (iVar11 == 2)
							{
...
void func_109(var uParam0, bool bParam1, bool bParam2)
{
	...
	switch (uParam0->f_2)
	{
		case 0:
			...
			{
				Var0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_1, 0f, uParam0->f_18[0], 0f) };
				uParam0->f_36 = WORLDPROBE::START_SHAPE_TEST_CAPSULE(Var0, Var0 + Vector(1f, 0f, 0f), 2.25f, 2, 0, 4);
			}
			else
			{
				iVar15 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_36, &iVar13, &Var16, &uVar19, &iVar14);
				if (iVar15 == 2)
				{
					if (func_97(iVar14, 1))
					{
			...
			while (iVar12 < uParam0->f_3)
			{
				...
				if (uParam0->f_38[iVar12] == 0)
				{
					if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_41[iVar12])
					{
						if (iLocal_73 == 1 || VEHICLE::GET_VEHICLE_MOD(uParam0->f_37, 0) != -1)
						{
							uParam0->f_38[iVar12] = WORLDPROBE::_0xE6AC6C45FBE83004(Var6, Var3, fLocal_74, 2, 0, 4);
						}
						else
						{
							uParam0->f_38[iVar12] = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(Var6, Var3, 2, 0, 7);
						}
						if (uParam0->f_38[iVar12] == 0)
						{
						}
				...
				{
					iVar15 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_38[iVar12], &iVar13, &Var16, &uVar19, &iVar14);
					if (iVar15 == 2)
					{
...
{
	return GAMEPLAY::ACOS(func_106(Param3, Param0)) <= fParam6;
}
		...
		if (func_334(uVar0))
		{
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(uVar0, -1, 0) == PLAYER::PLAYER_PED_ID())
			{
				...
				if (func_127())
				{
					...
					Global_4263954[iVar1] = ENTITY::GET_ENTITY_MODEL(iVar0);
...
void func_133(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_135()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_135()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_134(iParam0));
...
bool func_139(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_135()].f_6174.f_10, iParam0);
}
...
{
	Var0 = { func_180(*uParam1[0], *uParam1[1], fParam2, 0) };
	uVar3 = func_179(*uParam1[0], *uParam1[1], 1);
	...
	Var0 = { func_180(*uParam1[0], *uParam1[1], 1.1f, 0) };
	AI::TASK_VEHICLE_DRIVE_TO_COORD(uVar4, iParam0, Var0, fParam3, 0, ENTITY::GET_ENTITY_MODEL(iParam0), 262144, 0.5f, 1000f);
}
...
void func_181()
{
	...
	if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Var0, &fVar3, 0, 0) && (Var0.z - fVar3) > 1.35f)
	{
		Local_76.f_342 = 1;
	}
	if (!Global_76622)
...
{
	uParam0->f_2 = { Param1 };
	uParam0->f_19 = OBJECT::CREATE_OBJECT(1435400154, Param1, 0, 1, 0);
	uParam0->f_5 = { Param1 };
	uParam0->f_23 = Param1.z;
	uParam0->f_24 = Param1.z;
	...
	if (fParam5 == 0f)
	{
		if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Param1, &fVar0, 0, 0))
		{
...
{
	if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Param1 + Vector(0.3f, 0f, 0f), &uVar0, 0, 0))
	{
	}
	uParam0->f_24 = { Param1 };
	uParam0->f_30 = fParam5;
	Param1.z = (Param1.z + fParam6);
	uParam0->f_24 = { Param1 };
	uParam0->f_1 = OBJECT::CREATE_OBJECT(186956100, Param1, 0, 1, 0);
	...
	uParam0->f_3[0] = OBJECT::CREATE_OBJECT(-382832258, Var1, 0, 1, 0);
	...
	Var1 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_1, (fParam5 / 2f), 0f, 1.5f) };
	uParam0->f_3[1] = OBJECT::CREATE_OBJECT(-382832258, Var1, 0, 1, 0);
...
void func_189(var uParam0, struct<3> Param1, float fParam4, float fParam5, int iParam6, float fParam7)
{
	...
	*uParam0 = 1;
	...
	uParam0->f_3 = OBJECT::CREATE_OBJECT(186956100, Param1, 0, 1, 0);
	uParam0->f_1 = iParam6;
	...
	if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Param1, &fVar0, 0, 0))
	{
		uParam0->f_9 = GAMEPLAY::ABSF((Param1.z - fVar0));
	}
	uParam0->f_7 = fParam7;
	uParam0->f_10 = { Param1 };
...
{
	uParam0->f_1[1] = { Param1 };
	uParam0->f_8[1] = { Param4 };
	*uParam0 = 1;
...
{
	uParam0->f_7[0] = { Param1 };
	uParam0->f_7[1] = { Param4 };
	if (GAMEPLAY::ABSF((Param4.x - Param1.x)) > GAMEPLAY::ABSF((Param4.y - Param1.y)))
	{
		uParam0->f_29 = 0;
	}
	else
...
{
	uParam0->f_14[0] = { Param1 };
	uParam0->f_14[1] = { Param4 };
}
...
void func_211(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	while (fVar1 < fVar0)
	{
		if (bParam7)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(Var2, fParam6, 0);
		}
		if (bParam9)
		{
			GAMEPLAY::CLEAR_AREA_OF_OBJECTS(Var2, fParam6, 0);
		}
		if (bParam8)
		{
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Var2, fParam6, 0, 0, 0, 0, 0, 0);
		}
		if (bParam10)
		{
		...
		if (bParam11)
		{
			GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(Var2, fParam6, 0);
		}
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_225(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_225(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_225(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_257(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_225(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_225(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_225(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
void func_235(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_236(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_237(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_225(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_242(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_225(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_242(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_249(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_249(Var16.z)] = func_242(iParam1, Var16.x, func_249(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_249(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_237(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_237(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_237(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_237(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_140(func_268(iParam1, uParam0->f_2), Global_76431, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_140(func_267(iParam1, uParam0->f_2), Global_76431, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_140(iVar1, Global_76431, 0);
				if (!GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_271(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_265(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_265(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_225(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_326(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_225(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_225(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_335()
{
	...
	while (true)
	{
		...
		else
		{
			...
			{
				Var16 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_76.f_7[0] + Local_76.f_7[1] / Vector(2f, 2f, 2f), Local_76.f_24, Local_630) };
				Var19 = { fLocal_633, SYSTEM::VDIST(Local_76.f_7[0], Local_76.f_7[1]), fLocal_634 };
				uVar22 = Local_76.f_24;
				if (iLocal_561 == 0)
				{
					if (GAMEPLAY::GET_GAME_TIMER() > iVar0)
					{
						iLocal_561 = WORLDPROBE::START_SHAPE_TEST_BOX(Var16, Var19, 0f, 0f, uVar22, 0, 18, iVar3, 4);
					}
				}
				else
				{
...
void func_336(int iParam0, var uParam1, int iParam2)
{
	if (func_334(iParam0))
	{
		...
		{
			func_178(iParam0, GAMEPLAY::_0x21C235BC64831E5A(ENTITY::GET_ENTITY_COORDS(iParam0, 1), *uParam1[0], *uParam1[1], 0) + Vector(0.1f, 0f, 0f));
...
{
	return GAMEPLAY::ACOS(GAMEPLAY::ABSF(func_106(Param3, Param0))) <= fParam6;
}
...
int func_338(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	switch (uParam1->f_13)
	{
			...
			if (func_361(uParam1->f_16))
			{
				...
				while (iVar0 < *uParam0)
				{
					if (func_374(uParam0[iVar0]) && (*uParam0)[iVar0])
					{
						...
						else if (uParam0[iVar0]->f_7 || (GAMEPLAY::GET_MISSION_FLAG() && uParam1->f_16 == 0))
						{
							func_360(uParam1, 6);
						}
		...
		case 4:
			...
			if (uParam0[uParam1->f_12]->f_7 || (GAMEPLAY::GET_MISSION_FLAG() && uParam1->f_16 == 0))
			{
				func_360(uParam1, 6);
				return 0;
			}
		...
		case 5:
			...
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(uParam0[uParam1->f_12]->f_5))
			{
				...
				if (SCRIPT::HAS_SCRIPT_LOADED(uParam0[uParam1->f_12]->f_5))
				{
					...
					SYSTEM::START_NEW_SCRIPT(uParam0[uParam1->f_12]->f_5, iParam5);
...
int func_345(var uParam0, char* sParam1, var uParam2)
{
	...
	if (func_347(uParam0) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
	{
		UI::CLEAR_HELP(1);
...
{
	Var0 = 2;
	Var8 = { func_37(Param0[1] - Param0[0]) * Vector(fParam8, fParam8, fParam8) };
...
void func_371(struct<3> Param0, struct<3> Param3, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	...
	GRAPHICS::DRAW_DEBUG_LINE(Var13[0], Var13[1], iParam7, iParam8, iParam9, iParam10);
...
int func_379()
{
	...
	if (func_380() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_380()) == 0)
		{
			return 1;
		}
	}
...
void func_397(var uParam0, int iParam1)
{
	...
	if (Global_76622)
	{
		iVar3 = NETWORK::_NETWORK_GET_PED_PLAYER(PLAYER::PLAYER_PED_ID());
		if (iVar3 != func_25())
		{
