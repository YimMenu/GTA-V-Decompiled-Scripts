void __EntryFunction__()
{
	...
	fLocal_633 = 2.1f;
	fLocal_634 = 3f;
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(-1239896389) > 1)
	{
...
int func_16(var uParam0, int iParam1)
{
	...
	switch (uParam0->f_339)
	{
		...
		case 6:
			...
			{
				func_36(*uParam0[0], *uParam0[1], 3f, !Global_76622);
				if (!MISC::IS_POSITION_OCCUPIED(uParam0->f_172[6].f_1[0], 2f, 0, 1, 0, 0, 0, iParam1, 0))
				{
...
bool func_54(int iParam0)
{
	...
	Var6.y = MISC::ABSF((Var3.y - Var0.y));
	Var6.z = MISC::ABSF((Var3.z - Var0.z));
...
float func_84(var uParam0, int iParam1)
{
	...
	return MISC::_0x7F8F6405F4777AF6(ENTITY::GET_ENTITY_COORDS(iParam1, 1), uParam0->f_14[0], uParam0->f_14[1], 0);
}

float func_85(var uParam0, int iParam1, float fParam2)
{
	fVar3 = MISC::_0x7F8F6405F4777AF6(ENTITY::GET_ENTITY_COORDS(iParam1, 1), *uParam0[0], *uParam0[1], 0);
	if (fVar3 <= 1f)
	{
		...
		if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iParam1))
		{
			Var0 = { MISC::_0x21C235BC64831E5A(ENTITY::GET_ENTITY_COORDS(iParam1, 1), *uParam0[0], *uParam0[1], 0) };
		...
		case 3:
			...
			if (uParam0->f_1 == 0)
			{
				...
				if ((PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID())) || (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !VEHICLE::ARE_ALL_VEHICLE_WINDOWS_INTACT(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))))
				{
					...
					if ((MISC::ABSF(Var7.x) < uParam0->f_8 && MISC::ABSF(Var7.y) < 1.2f) && Var7.z < (-uParam0->f_9 * 0.25f))
					{
...
void func_133(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_135()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_135()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_139(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_135()].f_6174.f_10, iParam0);
}
...
void func_181()
{
	...
	if (MISC::GET_GROUND_Z_FOR_3D_COORD(Var0, &fVar3, 0, 0) && (Var0.z - fVar3) > 1.35f)
	{
		Local_76.f_342 = 1;
	}
	if (!Global_76622)
...
void func_189(var uParam0, struct<3> Param1, float fParam4, float fParam5, int iParam6, float fParam7)
{
	...
	*uParam0 = 1;
	...
	if (MISC::GET_GROUND_Z_FOR_3D_COORD(Param1, &fVar0, 0, 0))
	{
		uParam0->f_9 = MISC::ABSF((Param1.z - fVar0));
	}
	uParam0->f_7 = fParam7;
	uParam0->f_10 = { Param1 };
...
void func_208(var uParam0, struct<3> Param1, struct<3> Param4)
{
	...
	if (MISC::ABSF((Param4.x - Param1.x)) > MISC::ABSF((Param4.y - Param1.y)))
	{
		uParam0->f_29 = 0;
	}
	else
...
void func_211(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	while (fVar1 < fVar0)
	{
		...
		if (bParam8)
		{
			MISC::CLEAR_AREA_OF_VEHICLES(Var2, fParam6, 0, 0, 0, 0, 0, 0);
		}
		if (bParam10)
		{
...
void func_271(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_265(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_265(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_336(int iParam0, var uParam1, int iParam2)
{
	if (func_334(iParam0))
	{
		...
		{
			func_178(iParam0, MISC::_0x21C235BC64831E5A(ENTITY::GET_ENTITY_COORDS(iParam0, 1), *uParam1[0], *uParam1[1], 0) + Vector(0.1f, 0f, 0f));
			...
			if (func_361(uParam1->f_16))
			{
				...
				while (iVar0 < *uParam0)
				{
					if (func_374(uParam0[iVar0]) && (*uParam0)[iVar0])
					{
						...
						else if (uParam0[iVar0]->f_7 || (MISC::GET_MISSION_FLAG() && uParam1->f_16 == 0))
						{
							func_360(uParam1, 6);
						}
...
int func_376(int iParam0)
{
	...
	if (MISC::ABSF((Var3.z - Var0.z)) > 2.9f)
	{
		return 1;
	}
	if (Global_76622)
