...
int func_67(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		if ((Var0[1 /*3*/].f_1 - Var0[0 /*3*/].f_1) > Var1.y)
		{
			return 1;
		}
		if ((Var0[1 /*3*/].f_2 - Var0[0 /*3*/].f_2) > Var1.z)
		{
			return 1;
		}
	}
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76434[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1 /*14*/] = { func_130(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1 /*14*/] = { func_130(iVar10, 14, uVar15[iVar1], -1) };
			func_100(iParam0, Global_76434[1 /*14*/].f_12, Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4);
			func_122(14);
			if (Global_76432 == 1)
			{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &Var2) && Var2.z != -1)
				{
					...
					{
						(*iParam0)[Var2.z] = func_107(iParam1, Var2.x, 14, iVar0);
					}
					else if (Var2.y != -1)
					{
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.x != 0 && Var2.x != -1) && Var2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_114(Var2.z)] = Var2.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_114(Var2.z)] = func_107(iParam1, Var2.x, func_114(Var2.z), iVar0);
					}
				}
				else if (Var2.y != -1)
				{
					(*uParam0)[func_114(Var2.z)] = Var2.y;
				}
			}
			iVar4++;
		}
...
void func_132(int iParam0)
{
	...
	func_133(&(Global_76434[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_139(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_133(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_133(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		...
		else if (MISC::GET_GAME_TIMER() < iLocal_270)
		{
			...
			if (func_221())
			{
				...
				if (bLocal_244)
				{
					...
					else if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_56, Global_19, 1, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1722.09f, 3843f, 33.6f, 1740.11f, 3854.94f, 39.22f, 12f, 0, 1, 0))
					{
						iLocal_52 = 1;
						iLocal_53 = 0;
					}
...
void func_212()
{
	if (!bLocal_244 && func_220(PLAYER::PLAYER_PED_ID(), Local_56, 150f))
	{
...
int func_215(struct<3> Param0, int iParam1)
{
	return func_216(Param0, iParam1);
}

int func_216(struct<3> Param0, var uParam1)
{
	int iVar0;
...
int func_221()
{
	...
	{
		uLocal_65 = func_222(iLocal_67, 0, 0);
	}
	return 0;
}
	...
	switch (iLocal_63)
	{
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_67))
			{
				...
				Local_73 = { func_241() };
				Local_73.z = func_240((fLocal_261 + 180f), 0f, 360f);
				...
				uLocal_266 = GRAPHICS::ADD_DECAL(1110, Local_260, 0f, 0f, -1f, func_204(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		...
		case 2:
			...
			else if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_258) > 0.5f)
			{
				iLocal_63++;
			}
			break;
		...
		case 3:
			...
			else if (func_237(uLocal_258, 0.9f))
			{
				ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), -4f, 1);
				iLocal_63 = 4;
				bLocal_243 = true;
			}
			else if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_258) > 0.99f)
			{
				iLocal_63++;
			}
			break;
		...
		case 4:
			...
			if (iLocal_242)
			{
				...
				PED::FORCE_PED_MOTION_STATE(iLocal_67, -1871534317, 0, 0, 0);
				PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
				PED::_0x2208438012482A1A(iLocal_67, 0, 0);
				...
				ENTITY::SET_ENTITY_HEADING(iLocal_67, Var0.z);
			}
			else
			{
				if (!bLocal_243)
	...
	if (!PED::IS_PED_INJURED(iLocal_67) && !func_260())
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_67, 80f, 80f, 15f, 0, 1, 0))
		{
			...
			else if (func_214(PLAYER::PLAYER_PED_ID(), iLocal_67, 15f, 1) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 4f)
			{
				...
				if (!HUD::DOES_BLIP_EXIST(uLocal_65))
				{
					uLocal_65 = func_254(iLocal_67, 1, 1, 5);
				}
			}
			else
			{
...
void func_261()
{
	...
	if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_246) && STREAMING::HAS_MODEL_LOADED(iLocal_248)) && STREAMING::HAS_MODEL_LOADED(iLocal_247)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_249)) && STREAMING::HAS_CLIP_SET_LOADED(sLocal_250)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_253)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_254)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_255)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_252)) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		...
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_71, 0f, Var1.y, 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_71, Var1.x, (Var1.y * 0.75f), 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_71, Var1.x, 0f, 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_71, 0f, 0f, Var1.z, 500f, 10000f, 1);
		...
		Local_57 = { ENTITY::GET_ENTITY_COORDS(iLocal_67, 1) };
		MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Local_57.x, (Local_57.y + 0.1f), (Local_57.z + 0.1f), Local_57.x, (Local_57.y - 0.1f), (Local_57.z - 0.1f), 1, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
		...
		iLocal_70 = 1;
		Local_57 = { ENTITY::GET_ENTITY_COORDS(iLocal_69, 1) };
...
int func_279(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_314(Global_111638.f_24990.f_43[iParam1]))
		{
			return 0;
		}
	...
	if (Global_20805 == 4)
	{
		...
		if (iVar0 > -1)
		{
			if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_19673[iVar0 /*6*/])))
			{
				...
				uVar2 = HUD::_GET_TEXT_SUBSTRING(HUD::_GET_LABEL_TEXT(&cVar1), iVar0 * 3, iVar0 * 3 + 1);
				return func_338(uVar2);
			}
			else
			{
				return -1;
