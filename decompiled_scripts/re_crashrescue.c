void __EntryFunction__()
{
	...
	iLocal_258 = 131961260;
	iLocal_259 = -409745176;
	iLocal_260 = -685276541;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
	{
		if (!PED::IS_PED_INJURED(iLocal_75))
		{
			...
			AI::TASK_WANDER_STANDARD(iLocal_75, 1193033728, 0);
...
void func_1()
{
	switch (iLocal_283)
	{
		...
		case 1:
			if (func_25(iLocal_75))
			{
				if (func_9(&uLocal_88, "RECRAAU", sLocal_285, 3, 0, 0, 0) || GAMEPLAY::GET_GAME_TIMER() > iLocal_284)
				{
					iLocal_283++;
				}
			}
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_284 && CAM::IS_SCREEN_FADED_IN())
			{
				if (!PED::IS_PED_INJURED(iLocal_75))
				{
		...
		case 4:
			if ((GAMEPLAY::GET_GAME_TIMER() > iLocal_284 && func_9(&uLocal_88, "RECRAAU", sLocal_285, 3, 0, 0, 0)) || GAMEPLAY::GET_GAME_TIMER() > iLocal_284 + 6000)
			{
				func_322();
			}
			break;
	...
	switch (iLocal_55)
	{
		case 0:
			...
			if (iVar0 == 1)
			{
				...
				GAMEPLAY::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_76, 1), 20f, 1, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_76, 1), 20f, 0);
				SYSTEM::WAIT(0);
				iLocal_55 = 1;
			}
			break;
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_75) && !PED::IS_PED_INJURED(iLocal_76))
			{
				if (func_76(&uLocal_88, "RECRAAU", "RECRA_ARRIV", "RECRA_ARRIV_1", 3, 0, 0))
				{
					...
					PED::_0x2208438012482A1A(iLocal_75, 0, 0);
					GAMEPLAY::CLEAR_AREA(Local_60, 4f, 1, 0, 0, 0);
					func_66(&iVar1);
					uLocal_271 = PED::CREATE_SYNCHRONIZED_SCENE(Local_80, Local_83, 2);
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_75, uLocal_271, sLocal_269, "helping_friend_inside_victim", 1000f, -1000f, 0, 0, 1148846080, 0);
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_76, uLocal_271, sLocal_269, "helping_friend_inside_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
...
void func_31(int iParam0, int iParam1)
{
	...
	if (iParam1 <= func_48(iParam0))
	{
		...
		{
			func_33(func_39(iParam0, iParam1), Local_48.x, Local_48.y);
		}
...
void func_52(int iParam0, bool bParam1)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (!func_55(iParam0))
		{
			GAMEPLAY::SET_BIT(&(Global_111638.f_26429.f_1), iVar0);
			if (!bParam1)
			{
...
int func_55(int iParam0)
{
	...
	{
		return GAMEPLAY::IS_BIT_SET(Global_111638.f_26429.f_1, iParam0);
	}
	return 0;
}
...
{
	GAMEPLAY::SET_BIT(&(Global_111638.f_1.f_116), iParam0);
	switch (iParam0)
	{
		case 10:
			GAMEPLAY::SET_BIT(&(Global_111638.f_1.f_119), 14);
			break;
		
		case 13:
			GAMEPLAY::SET_BIT(&(Global_111638.f_1.f_119), 16);
			break;
		
		case 12:
			GAMEPLAY::SET_BIT(&(Global_111638.f_1.f_119), 15);
			break;
		
		case 11:
			GAMEPLAY::SET_BIT(&(Global_111638.f_1.f_119), 17);
			break;
	}
	if (!bParam1)
	{
		...
		UI::_SET_NOTIFICATION_MESSAGE(uVar1, uVar1, 0, iVar0, "", 0);
		if (!func_46(45))
		{
...
void func_61(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam1 == 1)
	{
		if ((iLocal_51 != 0 && iLocal_51 != 966099553) && iLocal_51 != -72657034)
		{
...
int func_67(int iParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iParam0), &(Var0[0]), &(Var0[1]));
		Var7 = { func_68() };
		if ((Var0[1] - Var0[0]) > Var7.x)
		{
			return 1;
		}
		if ((Var0[1].f_1 - Var0[0].f_1) > Var7.y)
		{
			return 1;
		}
		if ((Var0[1].f_2 - Var0[0].f_2) > Var7.z)
		{
			return 1;
		}
	}
...
void func_77(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_79(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76434[1] = { func_130(iVar10, iParam1, iParam2, -1) };
		if (!func_129(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76434[1] = { func_130(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1] = { func_130(iVar10, 14, uVar28[iVar1], -1) };
							func_100(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
							func_122(14);
							if (Global_76432 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_90(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_90(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_90(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_122(iVar0);
						if (Global_76432 == 1)
						{
			...
			{
				Global_76434[1] = { func_130(iVar10, iVar0, func_89(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1] = { func_130(iVar10, 14, uVar69[iVar1], -1) };
			func_100(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
			func_122(14);
			if (Global_76432 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_90(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_90(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_90(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
int func_81(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_194(iParam0, Global_111638.f_2358.f_539[iVar0].f_64, Global_111638.f_2358.f_539[iVar0].f_63))
		{
...
{
	Global_76434[1] = { func_130(iParam0, iParam1, iParam2, -1) };
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_194(iParam0, Global_111638.f_2358.f_539[iVar0].f_61, Global_111638.f_2358.f_539[iVar0].f_60) || iParam3 == 1)
		{
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								if (!func_93(-1692214353, iVar3, iVar5, iVar4, &iVar6))
								{
									if (iVar6 != -99)
									{
										iVar0 = iVar6;
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_101(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_90(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_90(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_107(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_114(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_114(Var16.z)] = func_107(iParam1, Var16.x, func_114(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_114(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_102(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_102(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_102(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_102(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_122(int iParam0)
{
	...
	{
		func_128(iParam0, Global_76434[1].f_5, Global_76434[1].f_2, 2, Global_76434[1].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_124(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2548434[iParam0][func_125(iParam2)];
	if (iVar0 != 0)
	{
...
int func_126(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0][func_125(iParam1)];
...
void func_132(int iParam0)
{
	...
	func_133(&(Global_76434[0]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_126(func_136(iParam1, uParam0->f_2), Global_76431, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_126(func_135(iParam1, uParam0->f_2), Global_76431, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
...
void func_139(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_133(&(Global_76434[0]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_133(&(Global_76434[0]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_133(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_133(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_90(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_194(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76434[1] = { func_130(iVar0, iParam1, iParam2, -1) };
	if (!GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_194(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_194(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76434[2] = { func_130(iVar0, 14, iVar4, -1) };
									if (Global_76434[2].f_12 == iVar3)
									{
										if (func_194(iParam0, 14, iVar4))
										{
											if (!func_86(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76434[2])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76434[2] = { func_130(iVar0, iVar2, iVar1, -1) };
						if (!func_86(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76434[2])))
						{
							return 0;
						}
					}
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_90(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_90(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_202(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_203(Var18[0], Var18[1], Var6, Var9) || func_203(Var18[0], Var18[1], Var9, Var15)) || func_203(Var18[0], Var18[1], Var12, Var15)) || func_203(Var18[0], Var18[1], Var6, Var12)) || func_203(Var18[1], Var18[3], Var6, Var9)) || func_203(Var18[1], Var18[3], Var9, Var15)) || func_203(Var18[1], Var18[3], Var12, Var15)) || func_203(Var18[1], Var18[3], Var6, Var12)) || func_203(Var18[3], Var18[2], Var6, Var9)) || func_203(Var18[3], Var18[2], Var9, Var15)) || func_203(Var18[3], Var18[2], Var12, Var15)) || func_203(Var18[3], Var18[2], Var6, Var12)) || func_203(Var18[2], Var18[0], Var6, Var9)) || func_203(Var18[2], Var18[0], Var9, Var15)) || func_203(Var18[2], Var18[0], Var12, Var15)) || func_203(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
		...
		else if (GAMEPLAY::GET_GAME_TIMER() < iLocal_284)
		{
			...
			if (func_221())
			{
				...
				if (bLocal_256)
				{
					...
					else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_76, PLAYER::PLAYER_PED_ID(), 1) || func_214(iLocal_76, PLAYER::PLAYER_PED_ID(), 1.25f, 1))
					{
					...
					else if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_60, Global_19, 1, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1722.09f, 3843f, 33.6f, 1740.11f, 3854.94f, 39.22f, 12f, 0, 1, 0))
					{
						iLocal_54 = 1;
						iLocal_55 = 0;
					}
...
void func_212()
{
	if (!bLocal_256 && func_220(PLAYER::PLAYER_PED_ID(), Local_60, 150f))
	{
		...
		if ((STREAMING::HAS_MODEL_LOADED(iLocal_258) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_269)) && OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(1728.778f, 3851.287f, 33.7826f, 5f, 291348133, 0))
		{
			uLocal_257 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(1728.778f, 3851.287f, 33.7826f, 5f, 291348133, 1, 0, 1);
			...
			uLocal_271 = PED::CREATE_SYNCHRONIZED_SCENE(Local_80, Local_83, 2);
			AI::TASK_SYNCHRONIZED_SCENE(iLocal_76, uLocal_271, sLocal_269, "helping_friend_idle_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
			bLocal_256 = true;
		}
	}
}
...
int func_216(struct<3> Param0, var uParam3)
{
	...
	UI::SET_BLIP_SCALE(iVar0, func_217(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	UI::SET_BLIP_ROUTE(iVar0, uParam3);
	return iVar0;
}
...
int func_221()
{
	...
	if (PED::IS_PED_GROUP_MEMBER(iLocal_75, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID())))
	{
		...
		else if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_75, 20f, 20f, 20f, 0, 1, 0) || !func_230())
		{
			PED::REMOVE_PED_FROM_GROUP(iLocal_75);
		}
		else if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_ON_FOOT(iLocal_75))
			{
				...
				{
					AI::CLEAR_PED_TASKS(iLocal_75);
					AI::TASK_LEAVE_ANY_VEHICLE(iLocal_75, 0, 0);
				}
			}
		}
		return 1;
	}
	else if (UI::DOES_BLIP_EXIST(uLocal_73))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_75, Global_19, 0, 1, 0) && func_230())
		{
...
int func_225(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_217(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
	else if (ENTITY::IS_ENTITY_AN_OBJECT(iParam0))
	{
...
int func_232()
{
	...
	if (iVar0 == 1938952078 || iVar0 == 1917016601)
	{
		return 1;
	}
	return 0;
...
void func_233()
{
	switch (iLocal_56)
	{
		...
		case 4:
			if (iLocal_67 == 0)
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_66 && !func_339())
				{
					if (func_221())
					{
	...
	switch (iLocal_71)
	{
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_75))
			{
				...
				GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Local_80, &(Local_80.f_2), 0, 0);
				Local_83 = { func_241() };
				Local_83.z = func_240((fLocal_275 + 180f), 0f, 360f);
				...
				GAMEPLAY::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_75, 1), 5f, 1, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_75, 1), 20f, 0);
				GRAPHICS::REMOVE_PARTICLE_FX_IN_RANGE(ENTITY::GET_ENTITY_COORDS(iLocal_75, 1), 7f);
				uLocal_280 = GRAPHICS::ADD_DECAL(1110, Local_272, 0f, 0f, -1f, func_204(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
				if (PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()) == 1)
				{
					PED::SET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID(), 0, 0);
				}
				AI::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_270, sLocal_263, "HELPING_VICTIM_TO_FEET_PLAYER", 1000f, -4f, 0, 0, 1148846080, 0);
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_75, uLocal_270, sLocal_263, "HELPING_VICTIM_TO_FEET_VICTIM", 1000f, -4f, 0, 0, 1148846080, 0);
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_270, 0);
		...
		case 2:
			...
			else if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_270) > 0.5f)
			{
				iLocal_71++;
			}
			break;
		...
		case 3:
			...
			else if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_270) > 0.99f)
			{
				iLocal_71++;
			}
			break;
		...
		case 4:
			...
			if (iLocal_254)
			{
				...
				PED::FORCE_PED_MOTION_STATE(iLocal_75, -1871534317, 0, 0, 0);
				PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
				PED::_0x2208438012482A1A(iLocal_75, 0, 0);
				...
				ENTITY::SET_ENTITY_HEADING(iLocal_75, Var0.z);
			}
			else
			{
				if (!bLocal_255)
...
int func_239()
{
	...
	{
		GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iVar10), &(Var0[0]), &(Var0[1]));
		Var7 = { func_68() };
		if ((Var0[1] - Var0[0]) > Var7.x)
		{
			return 0;
...
void func_242()
{
	if (!PED::IS_PED_INJURED(iLocal_75) && !func_260())
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_75, 80f, 80f, 15f, 0, 1, 0))
		{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_75, 2.5f, 2.5f, 2.5f, 0, 1, 1) && func_257(1, 0, 1))
			{
				PED::SET_PED_AS_GROUP_MEMBER(iLocal_75, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID()));
				...
				switch (iLocal_68)
				{
					...
					case 1:
						if (!func_339())
						{
							...
							{
								uLocal_73 = func_254(iLocal_75, 1, 1, 5);
								UI::_0x75A16C3DA34F1245(uLocal_73, 0);
							}
...
int func_253()
{
	if ((Global_111627 == func_49() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_111628)
	{
		return 1;
	}
	return 0;
...
int func_260()
{
	if (!PED::IS_PED_INJURED(iLocal_75))
	{
		if (GAMEPLAY::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_75, 31086, 0f, 0f, 0f), 1f, 1))
		{
			return 1;
		}
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_261()
{
	...
	if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_258) && STREAMING::HAS_MODEL_LOADED(iLocal_260)) && STREAMING::HAS_MODEL_LOADED(iLocal_259)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_261)) && STREAMING::HAS_CLIP_SET_LOADED(sLocal_262)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_265)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_266)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_267)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_264)) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		...
		GAMEPLAY::GET_MODEL_DIMENSIONS(iLocal_260, &uVar0, &Var3);
		...
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, 0f, Var3.y, 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, Var3.x, (Var3.y * 0.75f), 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, Var3.x, 0f, 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, 0f, 0f, Var3.z, 500f, 10000f, 1);
		...
		VEHICLE::_0x192547247864DFDD(iLocal_79, 1);
		...
		Local_63 = { ENTITY::GET_ENTITY_COORDS(iLocal_75, 1) };
		GAMEPLAY::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Local_63.x, (Local_63.y + 0.1f), (Local_63.z + 0.1f), Local_63.x, (Local_63.y - 0.1f), (Local_63.z - 0.1f), 1, 1, -1074790547, 0, 1, 1, -1082130432);
		...
		iLocal_78 = 1;
		Local_63 = { ENTITY::GET_ENTITY_COORDS(iLocal_77, 1) };
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_292(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_295()
{
	func_301(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_300(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_299(&uVar0, TIME::GET_CLOCK_HOURS());
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_312()) || Global_110685) || Global_30770) || func_311()) || func_22(8, -1)) || func_310()) || func_309()) || func_308()) || func_307()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_312()) || Global_30770) || func_311()) || func_22(8, -1)) || func_308()) || func_310()) || func_309()) || func_307()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_312()) || Global_110685) || Global_30770) || func_311()) || func_22(8, -1)) || func_308()) || func_310()) || func_309()) || func_307()) || Global_111638.f_7683.f_919[iVar0] == 5) || Global_41978 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_312()) || Global_110685) || Global_30770) || func_311()) || func_22(8, -1)) || func_310()) || func_309()) || func_307()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_312()) || Global_30770) || func_311()) || func_22(8, -1)) || func_309()) || func_308()) || func_307()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_312()) || func_309()) || Global_110685) || Global_30770) || func_311()) || Global_42596) || func_22(8, -1)) || func_308()) || func_306()) || func_307()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_312()) || Global_110685) || Global_30770) || func_311()) || func_22(8, -1)) || func_308()) || func_306()) || func_310()) || func_309()) || func_307())
						{
							return 0;
						}
						break;
	...
	if (Global_20805 == 4)
	{
		...
		if (iVar0 > -1)
		{
			if (UI::DOES_TEXT_LABEL_EXIST(&(Global_19673[iVar0])))
			{
				...
				uVar7 = UI::_GET_TEXT_SUBSTRING(UI::_GET_LABEL_TEXT(&cVar1), iVar0 * 3, iVar0 * 3 + 1);
