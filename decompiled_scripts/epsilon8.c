...
void func_31(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_33()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_33()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_39(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_33()].f_6174.f_10, iParam0);
}
...
bool func_68(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	return (uVar1 || (MISC::GET_GAME_TIMER() - Local_37[iVar0].f_3) < iParam2);
}
...
int func_145(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_164(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_150(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_164(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_145(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_145(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_145(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_145(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_181(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_175(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_175(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_164(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
		...
		if (func_19(iLocal_615))
		{
			if (PED::IS_PED_IN_VEHICLE(iLocal_578, iLocal_615, 0))
			{
				...
				if (iLocal_333 == 0)
				{
					...
					{
						TASK::TASK_HELI_MISSION(iLocal_578, iLocal_615, 0, 0, (Local_209.x + 600f), (Local_209.y + 600f), (Local_209.z + 100f), 4, 200f, -1f, -1f, -1, 100, -1082130432, 0);
...
void func_292()
{
		...
		else if (HUD::DOES_BLIP_EXIST(iLocal_911[iLocal_256]))
		{
			if (iLocal_256 != 0)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -367.5617f, -107.3702f, 32.44559f, -356.0586f, -74.55742f, 50.42249f, 82.25f, 0, 1, 0))
				{
					...
					{
						PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_580[iLocal_256], 1, 0);
						if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_580[iLocal_256], 780511057) != 1)
						{
					...
					else
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(uLocal_616[iLocal_256], 0))
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_580[iLocal_256], -1817882002) != 1)
							{
				...
				else
				{
					...
					if (iLocal_341[iLocal_256] == 1)
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (!ENTITY::IS_ENTITY_DEAD(uLocal_616[iLocal_256], 0))
							{
								...
								{
									if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_580[iLocal_256], -1794415470) != 1)
									{
					...
					else if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_580[iLocal_256], 780511057) != 1)
					{
						TASK::TASK_COMBAT_PED(uLocal_580[iLocal_256], PLAYER::PLAYER_PED_ID(), 0, 16);
					}
				}
	...
	if (iLocal_299 != -1)
	{
		...
		else if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_570[iLocal_299], -1273030092) != 1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_570[iLocal_299], -1273030092) != 0)
		{
...
void func_303()
{
	...
	if ((func_95(uLocal_570[5]) && func_18(iLocal_632)) && func_18(iLocal_615))
	{
		switch (iLocal_387)
		{
			...
			case 3:
				if ((func_289(uLocal_570[5], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_615, -1.5f, 0f, 0f), 0.5f) && TASK::GET_SCRIPT_TASK_STATUS(uLocal_570[5], 713668775) != 1) && TASK::GET_SCRIPT_TASK_STATUS(uLocal_570[5], 713668775) != 0)
				{
				...
				else if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_570[5], 713668775) != 1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_570[5], 713668775) != 0)
				{
		...
		else if (iLocal_336 == 0 && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, 0))
		{
			...
			else if (iLocal_277 == 1)
			{
				...
				if (func_95(uLocal_570[5]))
				{
					...
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_570[5], -875674219) != 1)
						{
		...
		if (func_19(uLocal_616[0]))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(uLocal_580[0], uLocal_616[0]))
			{
				...
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, 0))
				{
					...
					else if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_616[0]))
					{
...
void func_310()
{
		...
		if ((func_19(iLocal_633) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -383.1558f, -102.7442f, 37.43079f, -371.1183f, -109.4619f, 40.42916f, 13f, 0, 1, 0)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_95(iLocal_596))
			{
				if (iLocal_338 == 1)
				{
					if (iLocal_340 == 1)
					{
						if ((((TASK::GET_SCRIPT_TASK_STATUS(iLocal_596, 242628503) == 1 && iLocal_366 == 1) && MISC::GET_GAME_TIMER() > iLocal_289 + 3200) && !PED::IS_PED_RAGDOLL(iLocal_596)) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_596, PLAYER::PLAYER_PED_ID(), 1))
						{
		...
		if (func_19(uLocal_616[3]))
		{
			if (func_19(iLocal_632))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(uLocal_580[3], -403.493f, -39.7956f, 45.1741f, 8f, 8f, 8f, 0, 1, 0))
				{
					...
					if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_580[3], -1273030092) == 1)
					{
				...
				else
				{
					...
					if (iLocal_363 == 1)
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, 0))
						{
							...
							else if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_580[3], -1273030092) != 1)
							{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_616[iLocal_256]))
	{
		if (!ENTITY::IS_ENTITY_DEAD(uLocal_616[iLocal_256], 0))
		{
			if (((MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(uLocal_616[iLocal_256], 1), -1813897027, 4f, 1) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(uLocal_616[iLocal_256], 1), 615608432, 4f, 1)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(uLocal_616[iLocal_256], 1), -37975472, 4f, 1)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(uLocal_616[iLocal_256], 1), 741814745, 4f, 1))
			{
				iLocal_311 = 1;
			}
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_616[iLocal_256], 0))
...
int func_329(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_336() || func_335(Global_4456448.f_232883)) || func_334())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_332(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_352()
{
	...
	if ((((STREAMING::HAS_MODEL_LOADED(-956048545) && STREAMING::HAS_MODEL_LOADED(-599568815)) && STREAMING::HAS_MODEL_LOADED(884422927)) && STREAMING::HAS_MODEL_LOADED(-1255452397)) && STREAMING::HAS_MODEL_LOADED(1162065741))
	{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC01"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), Local_650[iLocal_910], 50f) && !MISC::IS_POSITION_OCCUPIED(Local_650[iLocal_910], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(Local_650[iLocal_910], 8f))
					{
						...
						if (!MISC::GET_GROUND_Z_FOR_3D_COORD(Local_650[iLocal_910], &uVar2, 0, 0))
						{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC02"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), Local_696[iLocal_910], 50f) && !MISC::IS_POSITION_OCCUPIED(Local_696[iLocal_910], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(Local_696[iLocal_910], 8f))
					{
						...
						if (!MISC::GET_GROUND_Z_FOR_3D_COORD(Local_696[iLocal_910], &fVar2, 0, 0))
						{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC03"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), Local_742[iLocal_910], 50f) && func_289(PLAYER::PLAYER_PED_ID(), Local_742[iLocal_910], 220f)) && !MISC::IS_POSITION_OCCUPIED(Local_742[iLocal_910], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(Local_742[iLocal_910], 8f))
					{
						...
						if (!MISC::GET_GROUND_Z_FOR_3D_COORD(Local_742[iLocal_910], &fVar2, 0, 0))
						{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC04"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), Local_788[iLocal_910], 50f) && !MISC::IS_POSITION_OCCUPIED(Local_788[iLocal_910], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(Local_788[iLocal_910], 8f))
					{
						...
						if (!MISC::GET_GROUND_Z_FOR_3D_COORD(Local_788[iLocal_910], &fVar2, 0, 0))
						{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC05"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), Local_834[iLocal_910], 50f) && func_289(PLAYER::PLAYER_PED_ID(), Local_834[iLocal_910], 170f)) && !MISC::IS_POSITION_OCCUPIED(Local_834[iLocal_910], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(Local_834[iLocal_910], 8f))
					{
						...
						if (!MISC::GET_GROUND_Z_FOR_3D_COORD(Local_834[iLocal_910], &fVar2, 0, 0))
						{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC06"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), Local_880[iLocal_910], 50f) && func_289(PLAYER::PLAYER_PED_ID(), Local_880[iLocal_910], 170f)) && !MISC::IS_POSITION_OCCUPIED(Local_880[iLocal_910], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(Local_880[iLocal_910], 8f))
					{
						...
						if (!MISC::GET_GROUND_Z_FOR_3D_COORD(Local_880[iLocal_910], &fVar2, 0, 0))
						{
...
void func_450()
{
	...
	while (((!HUD::HAS_ADDITIONAL_TEXT_LOADED(0) || !STREAMING::HAS_MODEL_LOADED(1269098716)) || !STREAMING::HAS_MODEL_LOADED(-1008861746)) || !STREAMING::HAS_MODEL_LOADED(-245247470))
	{
		SYSTEM::WAIT(0);
	}
