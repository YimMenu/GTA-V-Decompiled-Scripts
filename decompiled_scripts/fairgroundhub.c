void __EntryFunction__()
{
	...
	fLocal_35 = 180f;
	iLocal_38 = 3;
	Var1 = { ScriptParam_0.f_1[0] };
	func_77(Var1);
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(195))
	{
		func_75();
	}
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-532584526) > 1)
	{
	...
	{
		iVar4[0] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1643.524f, -1124.681f, 17.4326f, 0.3f, 1446187959, 1, 0, 1);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iVar4[1]))
	{
		iVar4[1] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1645.146f, -1126.613f, 17.4326f, 0.3f, -881525183, 1, 0, 1);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iVar4[2]))
	{
		iVar4[2] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1646.768f, -1128.545f, 17.4326f, 0.3f, -881525183, 1, 0, 1);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iVar4[3]))
	{
		iVar4[3] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1648.39f, -1130.478f, 17.4326f, 0.3f, -881525183, 1, 0, 1);
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < iVar4)
		...
		case 0:
			...
			if (func_43(uParam1->f_16))
			{
				...
				while (iVar0 < *uParam0)
				{
					...
					{
						uParam1->f_12 = iVar0;
						if (uParam0[iVar0]->f_7 || (GAMEPLAY::GET_MISSION_FLAG() && uParam1->f_16 == 0))
						{
							func_39(uParam1, 6);
						}
...
int func_6()
{
	...
	if (!func_64(14) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-892862129) > 0)
	{
		return 1;
	}
	return 0;
...
{
	Var0 = 2;
	Var8 = { func_18(Param0[1] - Param0[0]) * Vector(fParam8, fParam8, fParam8) };
...
{
	return func_70(Param0[0], Param0[1], 0.5f, 1);
}
