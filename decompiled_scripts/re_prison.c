void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_88();
		Local_312 = { ENTITY::GET_ENTITY_COORDS(iLocal_311, 1) };
		switch (iLocal_310)
		{
			case 0:
				func_86();
...
int func_3()
{
	...
	if (!func_2(14) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-892862129) > 0)
	{
		return 1;
	}
	return 0;
...
void func_5()
{
	switch (iLocal_50)
	{
		...
		case 1:
			iLocal_124 = VEHICLE::CREATE_VEHICLE(1912215274, 1797.785f, 2599.697f, 44.5769f, 269.6189f, 1, 1, 0);
			iLocal_126 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_124, 6, 1581098148, -1, 1, 1);
			func_26(&iLocal_126);
			iLocal_50++;
			break;
		...
		case 2:
			...
			{
				OBJECT::_DOOR_CONTROL(741314661, 1845f, 2605f, 45f, 0, 0f, 50f, 0);
				OBJECT::_DOOR_CONTROL(741314661, 1819.274f, 2608.537f, 44.6195f, 0, 0f, 50f, 0);
		...
		case 3:
			if (func_14(&uLocal_136))
			{
				...
				{
					iLocal_125 = VEHICLE::CREATE_VEHICLE(1912215274, 1755.159f, 2614.456f, 44.5652f, 179.3394f, 1, 1, 0);
					iLocal_127 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_125, 6, 1581098148, -1, 1, 1);
					func_26(&iLocal_127);
...
{
	WEAPON::GIVE_WEAPON_TO_PED(*iParam0, -494615257, -1, 0, 1);
	...
	if (bLocal_574)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_569, 0))
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_570, 0))
			{
				...
				AI::TASK_VEHICLE_AIM_AT_COORD(iLocal_570, Var0);
			}
			if (bLocal_572)
			{
				if (!func_28())
			...
			if (bLocal_572)
			{
				Var3 = { ENTITY::GET_ENTITY_COORDS(iLocal_569, 1) };
...
void func_30()
{
	...
	while (iVar0 < 10)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_318.f_64[iVar0]) && !PED::IS_PED_INJURED(Local_318.f_64[iVar0]))
		{
			...
			if ((((func_16(Local_318.f_64[iVar0], 0, &Local_128, &uLocal_135, 0, 1, 0, 1, 1) || GAMEPLAY::IS_BULLET_IN_AREA(Local_318[iVar0], 20f, 1)) || GAMEPLAY::IS_SNIPER_BULLET_IN_AREA(Local_318[iVar0] - Vector(20f, 20f, 20f), Local_318[iVar0] + Vector(20f, 20f, 20f))) || iLocal_418) || func_32(&(Local_318.f_64[iVar0])))
			{
				if (!func_2(5))
				{
	...
	while (iVar0 < 3)
	{
		...
		{
			Var1 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_408[iVar0], 0f, 3.5f, -2f) };
			AI::TASK_VEHICLE_AIM_AT_COORD(uLocal_408[iVar0], Var1);
...
void func_35()
{
	if (!iLocal_102)
	{
		...
		while (iVar0 < 12)
		{
			uLocal_52[iVar0] = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Local_65[iVar0], 10f, 10f, 10f, 0f, 0, 7);
			iVar0++;
		}
		iLocal_102 = 1;
	}
...
void func_65()
{
	...
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(1456041926);
}
...
void func_67()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			WEAPON::GIVE_WEAPON_TO_PED(Local_629.f_27[iVar0], -1074790547, -1, 1, 1);
...
void func_68()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			Local_629.f_27[iVar0] = PED::CREATE_PED(6, 1456041926, Local_629[iVar0], Local_629.f_10[iVar0], 1, 1);
			SYSTEM::WAIT(0);
		}
		iVar0++;
	}
	Var1 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_629[1], Local_629.f_10[1], -2f, 0f, 0f) };
	Var4 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_629[1], Local_629.f_10[1], -1f, 0f, 0f) };
	Var7 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_629[2], Local_629.f_10[2], 1f, 0f, 0f) };
	Var10 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_629[2], Local_629.f_10[2], -1f, 0f, 0f) };
	Local_629.f_31[0] = PED::CREATE_PED(6, 1456041926, Var1, Local_629.f_10[1], 1, 1);
	Local_629.f_31[1] = PED::CREATE_PED(6, 1456041926, Var4, Local_629.f_10[1], 1, 1);
	Local_629.f_31[2] = PED::CREATE_PED(6, 1456041926, Var7, Local_629.f_10[2], 1, 1);
	Local_629.f_31[3] = PED::CREATE_PED(6, 1456041926, Var10, Local_629.f_10[2], 1, 1);
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_629.f_31[iVar0]))
		{
			WEAPON::GIVE_WEAPON_TO_PED(Local_629.f_31[iVar0], -1074790547, -1, 1, 1);
...
void func_69()
{
	if (bLocal_574)
	{
		iLocal_569 = VEHICLE::CREATE_VEHICLE(353883353, 10f, 10f, -30f, 0f, 1, 1, 0);
		...
		iLocal_570 = PED::CREATE_PED(6, 1456041926, 10f, 10f, -20f, 0f, 1, 1);
		PED::SET_PED_INTO_VEHICLE(iLocal_570, iLocal_569, -1);
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_569, 0))
		{
			VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(iLocal_569, 101, "PrisonHeli", 1);
		}
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(353883353);
	}
}
...
void func_71()
{
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[0][0], 1879.944f, 2461.988f, 53.5496f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[0][1], 1831.631f, 2522.218f, 54.1376f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[0][2], 1789.07f, 2490.558f, 54.1381f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[0][3], 1789.8f, 2426.876f, 44.7729f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[1][0], 1879.944f, 2461.988f, 53.5496f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[1][1], 1831.631f, 2522.218f, 54.1376f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[1][2], 1789.07f, 2490.558f, 54.1381f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[1][3], 1789.8f, 2426.876f, 44.7729f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[2][0], 1655.908f, 2349.021f, 55.1775f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[2][1], 1733.875f, 2385.521f, 44.9049f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[2][2], 1662.234f, 2446.357f, 44.5652f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[2][3], 1524.631f, 2426.997f, 44.6212f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[3][0], 1455.081f, 2432.642f, 51.3366f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[3][1], 1576.174f, 2407.076f, 44.8143f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[3][2], 1578.1f, 2486.227f, 44.5655f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[3][3], 1512.837f, 2560.419f, 44.8417f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[4][0], 1484.2f, 2584.409f, 51.9283f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[4][1], 1535.154f, 2538.926f, 44.496f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[4][2], 1570.661f, 2587.814f, 44.5655f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[4][3], 1538.227f, 2655.531f, 44.9156f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[5][0], 1505.538f, 2727.242f, 37.6965f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[5][1], 1545.95f, 2632.524f, 44.7178f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[5][2], 1599.355f, 2658.319f, 44.5652f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[5][3], 1599.041f, 2713.393f, 44.4309f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[6][0], 1606.661f, 2815.673f, 37.9512f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[6][1], 1602.887f, 2721.398f, 44.651f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[6][2], 1599.355f, 2658.319f, 44.5652f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[6][3], 1719.225f, 2766.111f, 44.6846f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[7][0], 1783.204f, 2811.375f, 44.4414f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[7][1], 1709.275f, 2764.432f, 44.5747f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[7][2], 1599.355f, 2658.319f, 44.5652f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[7][3], 1822.456f, 2749.189f, 44.9326f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	AI::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[9][0], 1606.661f, 2815.673f, 37.9512f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[9][1], 1602.887f, 2721.398f, 44.651f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[9][2], 1599.355f, 2658.319f, 44.5652f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[9][3], 1719.225f, 2766.111f, 44.6846f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	AI::ADD_PATROL_ROUTE_LINK(0, 1);
	AI::ADD_PATROL_ROUTE_LINK(1, 2);
	AI::ADD_PATROL_ROUTE_LINK(2, 3);
	AI::ADD_PATROL_ROUTE_LINK(3, 0);
...
void func_72()
{
	...
	while (iVar0 < 10)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_318.f_64[iVar0]) && !ENTITY::IS_ENTITY_DEAD(Local_318.f_64[iVar0], 0))
		{
			...
			WEAPON::GIVE_WEAPON_TO_PED(Local_318.f_64[iVar0], 100416529, -1, 1, 1);
...
void func_73()
{
	...
	{
		uLocal_404[0] = VEHICLE::CREATE_VEHICLE(353883353, 1823.845f, 2621.267f, 57f, 53f, 1, 1, 0);
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_404[0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_404[0], 0))
		{
			uLocal_408[0] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_404[0], 6, 1456041926, -1, 1, 1);
	...
	{
		uLocal_404[1] = VEHICLE::CREATE_VEHICLE(353883353, 1761.418f, 2410.378f, 61f, 13f, 1, 1, 0);
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_404[1]) && !ENTITY::IS_ENTITY_DEAD(uLocal_404[1], 0))
		{
			uLocal_408[1] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_404[1], 6, 1456041926, -1, 1, 1);
	...
	{
		uLocal_404[2] = VEHICLE::CREATE_VEHICLE(353883353, 1534.635f, 2585.162f, 61f, 250f, 1, 1, 0);
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_404[2]) && !ENTITY::IS_ENTITY_DEAD(uLocal_404[2], 0))
		{
			uLocal_408[2] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_404[2], 6, 1456041926, -1, 1, 1);
...
void func_74()
{
	...
	while (iVar0 < 10)
	{
		...
		{
			Local_318.f_64[iVar0] = PED::CREATE_PED(6, 1456041926, Local_318[iVar0], Local_318.f_31[iVar0], 1, 1);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(1456041926);
			SYSTEM::WAIT(0);
		}
		iVar0++;
...
int func_77()
{
	if (bLocal_618)
	{
		if (!STREAMING::HAS_MODEL_LOADED(-1313105063))
		{
			return 0;
		}
	}
...
int func_78()
{
	...
	if (!STREAMING::HAS_MODEL_LOADED(353883353))
	{
		return 0;
	}
	if (!STREAMING::HAS_MODEL_LOADED(1456041926))
	{
		return 0;
	}
	return 1;
...
void func_83()
{
	...
	STREAMING::REQUEST_MODEL(353883353);
	STREAMING::REQUEST_MODEL(1456041926);
}
...
void func_86()
{
	...
	Local_128.f_4 = 75;
	Local_128.f_6 = 15;
	OBJECT::_DOOR_CONTROL(741314661, 1845f, 2605f, 45f, 1, 0, 0, 0);
	OBJECT::_DOOR_CONTROL(741314661, 1819.274f, 2608.537f, 44.6195f, 1, 0f, 50f, 0);
...
void func_87()
{
	Local_65[0] = { 1809.816f, 2482.877f, 44.4744f };
	Local_65[1] = { 1755.823f, 2424.904f, 44.4319f };
	Local_65[2] = { 1661.2f, 2410.096f, 44.4265f };
	Local_65[3] = { 1555.966f, 2476.43f, 44.4042f };
	Local_65[4] = { 1549.141f, 2583.103f, 44.4225f };
	Local_65[5] = { 1581.156f, 2671.974f, 44.481f };
	Local_65[6] = { 1655.49f, 2743.69f, 44.4665f };
	Local_65[7] = { 1768.776f, 2748.527f, 44.4402f };
	Local_65[8] = { 1831.2f, 2696f, 44.4578f };
	Local_65[9] = { 1803.121f, 2617.781f, 44.5082f };
	Local_65[10] = { 1817.221f, 2608.387f, 44.6204f };
	Local_65[11] = { 1843.838f, 2608.361f, 44.6178f };
}
