...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		else if (iLocal_128 != -1 && iLocal_128 <= 126)
		{
			...
			{
				Local_150 = { ENTITY::GET_ENTITY_COORDS(iLocal_123, true) - ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_123) * Vector(0.6f, 0.6f, 0.6f) };
				Local_150.f_2 = (Local_150.f_2 + 0.5f);
				Local_153 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_123, 0f, -0.12f, -0.0315f) };
			}
		}
		else
		{
...
void func_8(int iParam0)
{
	...
	if (iLocal_128 == 126)
	{
		...
		iVar1 = (NETWORK::GET_CLOUD_TIME_AS_INT() - iLocal_134);
	...
	else
	{
		...
		iVar3 = (NETWORK::GET_CLOUD_TIME_AS_INT() - iLocal_134);
	...
	iLocal_134 = NETWORK::GET_CLOUD_TIME_AS_INT();
}
	...
	switch (iLocal_140)
	{
		case 0:
			if (func_159() && func_158())
			{
				...
				else if ((iLocal_130 != -1 && func_154(iLocal_130, 1)) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()))
				{
					...
					MISC::SET_BIT(&(Local_161[PLAYER::PLAYER_ID() /*3*/]), 0);
					MISC::SET_BIT(&Global_2515597, 4);
				}
				MISC::SET_BIT(&Global_2515597, 3);
			}
			else if (iLocal_130 != -1)
			{
				func_151(&iLocal_130);
				MISC::CLEAR_BIT(&Global_2515597, 3);
			}
		...
		case 2:
			if (Local_156.f_2 == PLAYER::PLAYER_ID() && func_138())
			{
				iLocal_131 = 0;
				func_153(1);
				MISC::CLEAR_BIT(&(Local_161[PLAYER::PLAYER_ID() /*3*/]), 0);
				MISC::SET_BIT(&(Local_161[PLAYER::PLAYER_ID() /*3*/]), 1);
				func_137(&uLocal_143);
			}
			else if (Local_156.f_2 != -1 || !func_138())
			{
				func_153(0);
				MISC::CLEAR_BIT(&(Local_161[PLAYER::PLAYER_ID() /*3*/]), 0);
				MISC::CLEAR_BIT(&Global_2515597, 4);
		...
		case 4:
			...
			else if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar0) >= 0.96f)
			{
				...
				MISC::CLEAR_BIT(&iLocal_133, 4);
				MISC::CLEAR_BIT(&(Local_161[PLAYER::PLAYER_ID() /*3*/]), 1);
				MISC::CLEAR_BIT(&(Local_161[PLAYER::PLAYER_ID() /*3*/]), 2);
				MISC::CLEAR_BIT(&(Local_161[PLAYER::PLAYER_ID() /*3*/]), 3);
				func_141(PLAYER::PLAYER_ID(), 1, 0, 0);
				MISC::CLEAR_BIT(&Global_2515597, 4);
				iLocal_139 = 0;
				if (iLocal_128 == 126)
...
{
	Local_161[PLAYER::PLAYER_ID() /*3*/].f_1 = iParam0;
	MISC::SET_BIT(&(Local_161[PLAYER::PLAYER_ID() /*3*/]), 2);
}
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		switch (iLocal_131)
		{
			...
			case 1:
				...
				{
					STREAMING::REMOVE_ANIM_DICT(sLocal_138);
					iLocal_131 = 0;
					return 1;
				}
				break;
...
int func_38(char* sParam0, bool bParam1, bool bParam2)
{
	...
	if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_138))
	{
		if ((!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar0) || PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar0) >= 0.96f) || bParam1)
		{
			...
			iLocal_132 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_153, ENTITY::GET_ENTITY_ROTATION(iLocal_123, 2), 2, false, bParam2, 1f, 0f, 1f);
...
{
	Local_161[PLAYER::PLAYER_ID() /*3*/].f_2 = fParam0;
	MISC::SET_BIT(&(Local_161[PLAYER::PLAYER_ID() /*3*/]), 3);
}
...
int func_132()
{
	...
	switch (iLocal_131)
	{
		case 0:
			func_31(0);
			Var0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_123, 0.06f, -0.8958f, 0.2f) };
			...
			if (!func_136(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Var0, 0.8f, 0))
			{
				if (!func_133(PLAYER::PLAYER_PED_ID(), 2106541073))
				{
					TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), Var0, 1f, 4000, ENTITY::GET_ENTITY_HEADING(iLocal_123), 0.125f);
				}
			}
			else
			{
...
int func_159()
{
	...
	if ((((((((((((((!MISC::IS_BIT_SET(Global_2515597, 5) && !func_166()) && !func_36(0)) && !func_165()) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false)) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_123)) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_150, 0.55f, 0.8f, 1.5f, false, true, 1)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_138, "EXIT", 3)) && !func_164(PLAYER::PLAYER_ID())) && !func_163()) && iVar0) && !MISC::IS_BIT_SET(Global_1678289.f_4, 2)) && func_160(PLAYER::PLAYER_PED_ID()) <= 9) && !Global_2405074.f_2674) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
	{
		return 1;
	}
	return 0;
...
void func_168()
{
	if (func_163())
	{
		if (MISC::IS_BIT_SET(Local_161[Local_156.f_2 /*3*/], 2))
		{
		...
		if (MISC::IS_BIT_SET(Local_161[Local_156.f_2 /*3*/], 3))
		{
		...
		if (!MISC::IS_BIT_SET(Local_161[Local_156.f_2 /*3*/], 1) && !MISC::IS_BIT_SET(Local_161[Local_156.f_2 /*3*/], 0))
		{
			Local_156.f_2 = -1;
		}
	}
	else if (MISC::IS_BIT_SET(Local_161[iLocal_129 /*3*/], 0))
	{
		if (!func_163())
		{
...
void func_191()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !MISC::IS_BIT_SET(iLocal_133, 2))
	{
		...
		NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_161, 97);
		if (!func_192())
		{
			func_206(0);
		}
...
void func_200()
{
	if (iLocal_128 == 126)
	{
		...
		else if (MISC::IS_BIT_SET(Global_2515597, 1))
		{
			MISC::CLEAR_BIT(&Global_2515597, 1);
			func_206(0);
		}
		else if (MISC::IS_BIT_SET(Global_1678289.f_6, 10))
		{
			if (iLocal_140 != 0)
			{
				if (MISC::IS_BIT_SET(iLocal_133, 3))
