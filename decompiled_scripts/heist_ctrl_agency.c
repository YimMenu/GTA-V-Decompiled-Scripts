	...
	while (!func_330(2))
	{
		if (!Global_76891)
		{
			...
			if (func_327(3, 0))
			{
				...
				else if (!MISC::IS_BIT_SET(uLocal_41, 9))
				{
		...
		if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(-1126021687) > 0 || SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(-356834946) > 0)
		{
			func_4();
		}
		if (func_330(12))
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_187(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_211(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_212(iParam0) && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_89532[26].f_6) == 0)
			{
				Global_111638.f_7256[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_111638.f_7256[iParam0], 1, 1);
			}
...
int func_258(var uParam0, int iParam1)
{
	...
	else
	{
		...
		if (func_240(func_100()) != iParam1 || bVar0)
		{
			...
			else if (!((MISC::IS_BIT_SET(Global_111638.f_9080.f_2[27], 1) && !Global_3) && !func_3(0)))
			{
				if (uParam0->f_23)
				{
					bVar1 = true;
