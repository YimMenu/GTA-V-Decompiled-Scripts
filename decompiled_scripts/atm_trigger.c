void __EntryFunction__()
{
	...
	if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Local_507, &fVar3, 0, 0))
	{
	...
	while (bVar2)
	{
		...
		if (((ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)) && !CUTSCENE::IS_CUTSCENE_PLAYING()) && PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
		{
			if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == iVar1 && !PED::IS_PED_JUMPING(PLAYER::PLAYER_PED_ID()))
			{
				...
				if ((((((((((((((!PED::IS_PED_USING_ANY_SCENARIO(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !func_82(0)) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_496, 1f, 1f, 1f, 0, 1, 1)) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0)) && !func_81()) && !func_80(iScriptParam_0, 0)) && !func_79()) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 4f) && func_77(PLAYER::PLAYER_ID()) != 171) && !func_76(Global_4456448.f_232883)) && !func_75(Global_4456448.f_232883)) && !func_74(Global_4456448.f_232883)) && !GAMEPLAY::IS_BIT_SET(Global_4456448.f_28, 1)) && !func_73(PLAYER::PLAYER_ID()))
				{
					if (AI::DOES_SCENARIO_EXIST_IN_AREA(Local_496, 2f, 0))
					{
						bVar5 = false;
					}
					bVar6 = false;
					...
					if (AI::IS_SCENARIO_OCCUPIED(Local_496, 2f, 1))
					{
						bVar6 = true;
					}
					if (Global_76622)
					...
					if (!bVar6)
					{
						...
						if (func_69(iLocal_593, 1))
						{
							...
							if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
							{
								...
								if (func_63(0, &Var7))
								{
									AI::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), Local_507, 1f, 5000, ENTITY::GET_ENTITY_HEADING(iScriptParam_0), 0.25f);
									iLocal_499 = 0;
								}
							}
							SYSTEM::WAIT(100);
...
void func_6(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	while (bVar4)
	{
		...
		if (!bVar5)
		{
			if (!Global_76622)
			{
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_594, "SET_DATA_SLOT_EMPTY");
				GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
				func_32(iLocal_594);
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_594, "UPDATE_TEXT");
				GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
			}
			bVar5 = true;
		}
		...
		if ((!bVar0 && !Global_76622) && !bParam3)
		{
			...
			AI::TASK_USE_NEAREST_SCENARIO_TO_COORD(PLAYER::PLAYER_PED_ID(), Local_496, 2f, -1);
			bVar0 = true;
		}
		func_55(uParam2);
	}
...
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_594, "SET_INPUT_SELECT");
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_594, "GET_CURRENT_SELECTION");
	uVar0 = GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION();
	while (!GRAPHICS::_0x768FF8961BA904D6(uVar0) && !func_64(uParam0, 1))
	{
		func_40();
	}
	iLocal_600 = GRAPHICS::_0x2DE7EFA66B906036(uVar0);
	switch (*uParam1)
	{
		case 0:
			switch (iLocal_600)
...
int func_10(var uParam0, int iParam1)
{
	...
	if (func_19())
	{
		...
		if (UNK3::_0xD47A2C1BA117471D(func_18(791613967), iParam1))
		{
	...
	iLocal_599 = NETWORKCASH::_0xF70EFA14FE091429(iParam1);
	bLocal_514 = true;
	if (Global_76622 && NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_11(1918, 1, -1);
...
{
	if (!NETWORKCASH::_0x7303E27CC6532080(iParam1, 0, 0, 0, &uVar0, -1, 0))
	{
		return 0;
	}
	if (func_19())
	{
		...
		if (UNK3::_0xC2F7FE5309181C7D(func_18(791613967), iParam1))
		{
			iVar3 = UNK3::_0x350AA5EBC03D3BD2();
			while (iVar3 == 1 && !func_64(uParam0, 1))
			{
	...
	if (GAMEPLAY::IS_PC_VERSION())
	{
		if (iLocal_518 == 0)
		{
			if (CONTROLS::_IS_INPUT_DISABLED(2))
			{
				if (fLocal_519 == -1f)
				{
					fLocal_519 = CONTROLS::GET_CONTROL_NORMAL(2, 239);
					fLocal_520 = CONTROLS::GET_CONTROL_NORMAL(2, 240);
				}
				else if (fLocal_519 != CONTROLS::GET_CONTROL_NORMAL(2, 239) || fLocal_520 != CONTROLS::GET_CONTROL_NORMAL(2, 240))
				{
					GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iParam0, "SHOW_CURSOR");
...
void func_26(var uParam0, int iParam1, var uParam2)
{
	...
	switch (*uParam2)
	{
		...
		case 4:
			...
			while (iVar0 > GAMEPLAY::GET_GAME_TIMER() && !func_64(uParam0, 1))
			{
				func_40();
			}
			func_24(uParam2, 11);
		...
		case 2:
			if (func_23())
			{
				...
				UI::_ADD_TEXT_COMPONENT_SUBSTRING_CASH(NETWORKCASH::NETWORK_GET_VC_BANK_BALANCE(), 1);
				GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
				GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iParam1, "SET_DATA_SLOT");
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(1);
		...
		case 5:
			...
			UI::_ADD_TEXT_COMPONENT_SUBSTRING_CASH(iLocal_596, 1);
			GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
			GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iParam1, "SET_DATA_SLOT");
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(1);
	...
	GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
	func_27(NETWORKCASH::_0xA6FA3979BED01B81());
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
}
...
bool func_28(var uParam0)
{
	...
	while (!NETWORKCASH::_0xE154B48B68EF72BC(iVar0) && !func_64(uParam0, 1))
	{
		func_40();
	}
	while (iVar1 > GAMEPLAY::GET_GAME_TIMER() && !func_64(uParam0, 1))
	{
		func_40();
	}
...
int func_29(int iParam0)
{
	...
	while (iVar2 > 0)
	{
		if (Global_2097152[func_30()].f_10753.f_1[iVar1] > 0 && Global_2097152[func_30()].f_10753.f_132[iVar1] != 1262307134)
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(Global_2097152[func_30()].f_10753.f_1[iVar1]);
			switch (Global_2097152[func_30()].f_10753.f_115[iVar1])
			{
				case 0:
				...
				case 2:
					...
					UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_2097152[func_30()].f_10753.f_18[iVar1]));
					GRAPHICS::_END_TEXT_COMMAND_SCALEFORM();
					break;
...
void func_32(int iParam0)
{
	...
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iParam0, "SET_DATA_SLOT");
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(3);
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_FLOAT(SYSTEM::TO_FLOAT(Global_58686[iVar0]));
	func_31("W_BA_BAL");
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	iVar1 = 4;
	iVar2 = 0;
	...
	if (iVar5 > -1)
	{
		...
		while (iVar2 < iVar4)
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(Global_111638.f_20559.f_233[iVar0].f_2[iVar5].f_2);
...
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_595, "CLEAR_ALL");
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_595, "SET_CLEAR_SPACE");
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(200);
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	if (GAMEPLAY::IS_PC_VERSION())
	{
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_595, "TOGGLE_MOUSE_BUTTONS");
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(1);
		GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	}
	iVar0 = 0;
	if (Global_76622)
	{
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_595, "SET_DATA_SLOT");
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(iVar0);
		func_54(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 201, 1));
		...
		if (bParam0)
		{
			...
			if (bParam1)
			{
				func_54(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 198, 1));
			}
			else
			{
				func_54(CONTROLS::_0x80C2FD58D720C801(2, 7, 1));
			}
			func_31("MPATM_NAV");
			if (GAMEPLAY::IS_PC_VERSION())
			{
	...
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_595, "SET_DATA_SLOT");
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(iVar0);
	func_54(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 202, 1));
	func_31("MPATM_EXIT");
	if (GAMEPLAY::IS_PC_VERSION())
	{
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(1);
	...
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	iVar0++;
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_595, "DRAW_INSTRUCTIONAL_BUTTONS");
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
}
...
void func_55(int iParam0)
{
	...
	switch (iLocal_499)
	{
		...
		case 1:
			...
			iVar65 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(iLocal_500);
		...
		case 2:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&sVar32) && (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar65) || PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar65) >= 0.99f))
			{
				...
				if ((((GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_510, "idle_a") && iVar66 == 0) || (GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_510, "idle_b") && iVar66 == 1)) || (GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_510, "idle_c") && iVar66 == 2)) || (GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_510, "idle_d") && iVar66 == 3))
				{
					iVar66++;
					if (iVar66 >= iVar64)
					{
...
void func_59(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_94753, iParam0))
		{
			GAMEPLAY::SET_BIT(&Global_94753, iParam0);
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_94753, iParam0))
	{
		GAMEPLAY::CLEAR_BIT(&Global_94753, iParam0);
	}
}

bool func_60(int iParam0)
{
	return GAMEPLAY::IS_BIT_SET(Global_94754, iParam0);
}
...
int func_67()
{
	if (iLocal_590 == 0)
	{
		...
		iLocal_590 = WORLDPROBE::START_SHAPE_TEST_CAPSULE(Var0, Var0 - Vector(3f, 0f, 0f), 0.33f, 2, PLAYER::PLAYER_PED_ID(), 4);
		return iLocal_589;
	}
	else
	{
		iVar3 = 0;
		iVar11 = WORLDPROBE::GET_SHAPE_TEST_RESULT(iLocal_590, &iVar3, &uVar4, &uVar7, &uVar10);
		if (iVar11 == 2)
		{
			iLocal_589 = 0;
			if (iVar3 != 0)
...
int func_89()
{
	...
	if (func_90() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_90()) == 0)
		{
			return 1;
		}
	}
...
void func_106(char* sParam0, int iParam1)
{
	...
	{
		if (func_83(sParam0) && !UI::IS_HELP_MESSAGE_FADING_OUT())
		{
			UI::CLEAR_HELP(0);
		}
	}
