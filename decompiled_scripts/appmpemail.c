void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if ((Global_19486.f_1 != 9 && Global_21839 == 0) && Global_21838 == 0)
		{
			...
			{
				if (MISC::ARE_STRINGS_EQUAL(&(Global_4268500[iLocal_36]), "CELL_FINV"))
				{
				}
				else
				{
	...
	if (Global_4268500[iLocal_36].f_24 == 1)
	{
		if (Global_19464 == 0)
		{
			if (PAD::IS_CONTROL_PRESSED(2, Global_19457))
			{
				...
				HUD::THEFEED_REMOVE_ITEM(Global_4268500[iLocal_36].f_16);
				func_58(Global_19467, "SET_DATA_SLOT_EMPTY", 8f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_53();
				if (iLocal_34 > 0)
				{
	...
	if (Global_19464 == 0)
	{
		if ((func_3(2, Global_19455, 0) || Global_4269750 == 1) || Global_21865 == 1)
		{
			...
			if (iLocal_34 == iLocal_33 || iLocal_34 > iLocal_33)
			{
				...
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_1374.f_56[0]));
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_1374.f_56[1]));
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_1374.f_56[2]));
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_1374.f_56[3]));
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_1374.f_56[4]));
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_1374.f_56[5]));
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_1374.f_56[6]));
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_1374.f_56[7]));
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_1374.f_56[8]));
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_1374.f_56[9]));
				GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
			...
			if (Global_4268500[iLocal_36].f_24 != 0)
			{
				...
				{
					GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("CELL_FROM_FIELD");
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4268500[iLocal_36].f_50));
					GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
				}
				else
				{
					GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("CELL_FROM_FIELD");
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1798[Global_4268500[iLocal_36].f_17].f_3));
					GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
				}
				switch (Global_4268500[iLocal_36].f_32)
				{
					...
					case 1:
						GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(Global_4268500[iLocal_36]));
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4268500[iLocal_36].f_33));
						if (Global_4268500[iLocal_36].f_66 == 1 && !MISC::ARE_STRINGS_EQUAL(&(Global_4268500[iLocal_36].f_67), "NULL"))
						{
							HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4268500[iLocal_36].f_67));
						}
						if ((Global_4268500[iLocal_36].f_66 == 2 && !MISC::ARE_STRINGS_EQUAL(&(Global_4268500[iLocal_36].f_67), "NULL")) && !MISC::ARE_STRINGS_EQUAL(&(Global_4268500[iLocal_36].f_83), "NULL"))
						{
							if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_4268500[iLocal_36].f_67)))
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_4268500[iLocal_36].f_67));
							}
							else
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4268500[iLocal_36].f_67));
							}
							if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_4268500[iLocal_36].f_83)))
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_4268500[iLocal_36].f_83));
							}
							else
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4268500[iLocal_36].f_83));
							}
						}
						GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
						break;
					...
					case 2:
						GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(Global_4268500[iLocal_36]));
						HUD::ADD_TEXT_COMPONENT_INTEGER(Global_4268500[iLocal_36].f_49);
						GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
						break;
...
void func_42()
{
	...
	if (Global_4268500[iLocal_36].f_24 != 0)
	{
		...
		while (iVar0 < 59)
		{
			if (MISC::ARE_STRINGS_EQUAL(&(Global_4268500[iLocal_36]), &(Local_62[iVar0])))
			{
	...
	while (iVar13 < 11)
	{
		...
		if (Global_4268500[iVar16].f_24 != 0)
		{
			if (Global_4268500[iVar16].f_99[Global_19486] == 1)
			{
				...
				{
					GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("CELL_2000");
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4268500[iVar16].f_50));
					GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
				}
				else
				{
	...
	while (iVar13 < (iLocal_1373 + iLocal_32))
	{
		...
		while (iVar14 < iLocal_1373 && iVar45 == 0)
		{
			...
			if (iVar34[iVar14] == 0)
			{
				...
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_1374.f_23[0]));
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_1374.f_23[1]));
				GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
				iVar34[iVar14] = 1;
