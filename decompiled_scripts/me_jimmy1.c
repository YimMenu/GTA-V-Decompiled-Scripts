...
void func_46(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		else if (func_42(iLocal_299) && ENTITY::IS_ENTITY_AT_COORD(iLocal_299, Local_291, 50f, 50f, 50f, 0, 1, 0))
		{
			func_50(iLocal_299);
		}
		else
...
void func_60(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_62(Global_111638.f_18528[iVar0], &Var2, &fVar3))
			{
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76434[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1 /*14*/] = { func_141(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1 /*14*/] = { func_141(iVar10, 14, uVar15[iVar1], -1) };
			func_111(iParam0, Global_76434[1 /*14*/].f_12, Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4);
			func_133(14);
			if (Global_76432 == 1)
			{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &Var2) && Var2.z != -1)
				{
					...
					{
						(*iParam0)[Var2.z] = func_118(iParam1, Var2.x, 14, iVar0);
					}
					else if (Var2.y != -1)
					{
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.x != 0 && Var2.x != -1) && Var2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_125(Var2.z)] = Var2.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_125(Var2.z)] = func_118(iParam1, Var2.x, func_125(Var2.z), iVar0);
					}
				}
				else if (Var2.y != -1)
				{
					(*uParam0)[func_125(Var2.z)] = Var2.y;
				}
			}
			iVar4++;
		}
...
void func_143(int iParam0)
{
	...
	func_144(&(Global_76434[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_150(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_144(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_144(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
int func_224()
{
	...
	{
		Var0 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_304, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) };
		if (Var0.y < -1f)
		{
			return 1;
		}
	...
	switch (iLocal_296)
	{
		case 0:
			...
			if (func_336() == 1)
			{
				...
				MISC::CLEAR_AREA_OF_VEHICLES(Local_292, 10f, 0, 0, 0, 0, 0, 0);
			}
			else
			{
...
void func_249()
{
	...
	{
		if (func_225(PLAYER::PLAYER_PED_ID(), uLocal_301[0]) < 30f)
		{
			if (!func_27() && func_229())
			{
...
void func_253(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_323(&(Global_98744.f_3));
				if (iVar6 > -1)
				{
...
void func_278(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::_GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_280(Var7.f_1)) && iVar9 < 51)
			{
...
int func_335(struct<3> Param0, int iParam1, int iParam2)
{
	int iVar0;
				...
				if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_304))
				{
					...
					while (iVar2 < 3)
					{
						if (func_42(uLocal_301[iVar2]))
						{
							...
							else if (((iVar2 == 1 && !func_42(uLocal_301[0])) || ((iVar2 == 2 && !func_42(uLocal_301[0])) && !func_42(uLocal_301[1]))) && !func_350())
							{
								func_348(&uLocal_67, 6, uLocal_301[iVar2], "MEJimmyKidnapper2", 1, 1);
								func_28();
								func_4(&uLocal_67, "MEJ1AUD", "MEJ1_NERD", "MEJ1_NERD_2", 7, 0, 0);
							}
							else if ((iVar2 == 1 && func_42(uLocal_301[0])) || (iVar2 == 2 && (func_42(uLocal_301[0]) || func_42(uLocal_301[1]))))
							{
								func_345(uLocal_301[iVar2], 1);
							}
						}
						iVar2++;
					}
...
void func_383()
{
	...
	if ((func_42(PLAYER::PLAYER_PED_ID()) && func_42(uLocal_301[0])) && func_49(iLocal_304))
	{
		if (iLocal_254 == -1 && iLocal_255 == -1)
		{
			...
			else if (func_225(PLAYER::PLAYER_PED_ID(), uLocal_301[0]) < 50f && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_304))
			{
		...
		else if (((iLocal_254 < 8 && func_225(PLAYER::PLAYER_PED_ID(), uLocal_301[0]) < 50f) && !func_27()) && !func_382("MEJ1_02", 0, 0))
		{
...
void func_392()
{
	...
	switch (iLocal_296)
	{
		...
		case 2:
			...
			{
				if (func_388(PLAYER::PLAYER_PED_ID(), Local_290, 150f) || func_384(&uLocal_67, 14, "MEJ1AUD", "MEJ1_CLOSE", 7, 0, 0, 1))
				{
					iLocal_296 = 3;
				}
			}
...
int func_393()
{
	if (((func_49(iLocal_304) && func_42(PLAYER::PLAYER_PED_ID())) && func_42(iLocal_301[0])) && func_42(iLocal_299))
	{
		...
		else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_312, Local_313, fLocal_316, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_314, Local_315, fLocal_317, 0, 1, 0))
		{
			ENTITY::SET_ENTITY_COORDS(iLocal_304, Local_306, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(iLocal_304, fLocal_307);
			return 1;
...
{
	return func_496(&(Global_105187.f_2890), Param0, fParam1, 0);
}
...
int func_498(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_499(iParam0, uVar1[iVar3], 1) && func_424(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_288(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
