void __EntryFunction__()
{
	...
	iLocal_99 = 49;
	iLocal_100 = 64;
	uLocal_105 = UI::_0x4A9923385BDB9DAD();
	uLocal_106 = UI::_GET_BLIP_INFO_ID_ITERATOR();
	...
	fLocal_386 = 800f;
	fLocal_387 = 100f;
	iLocal_402 = 115168927;
	iLocal_404 = 1269098716;
...
void func_3()
{
	...
	else if (func_42(iLocal_392) && func_42(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_392, PLAYER::PLAYER_PED_ID(), 1))
		{
			if (WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_392, 0, 2) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(iLocal_392))
			{
				...
				AI::TASK_PERFORM_SEQUENCE(iLocal_392, uVar0);
		...
		else
		{
			...
			{
				if (iLocal_356 < 4 && GAMEPLAY::GET_GAME_TIMER() > iLocal_350)
				{
					func_28();
					if (!func_27())
					{
						...
						{
							iLocal_356++;
							iLocal_350 = GAMEPLAY::GET_GAME_TIMER() + 9000;
						}
					}
				}
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_392, -1519143300) != 1)
				{
					AI::TASK_HANDS_UP(iLocal_392, -1, 0, -1, 0);
				}
			}
			else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_392, -1519143300) == 1)
			{
				AI::CLEAR_PED_TASKS(iLocal_392);
			}
		}
	}
}
...
bool func_30(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_31(&(Local_52[iVar4]), Var1, iParam1, &(Local_52[iVar4].f_3), iParam0, iParam5);
...
void func_46(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		else if (func_42(iLocal_392) && ENTITY::IS_ENTITY_AT_COORD(iLocal_392, Local_380, 50f, 50f, 50f, 0, 1, 0))
		{
			func_50(iLocal_392);
		}
		else
	...
	{
		AUDIO::_0x18EB48CFC41F2EA0(iLocal_403, 0);
	}
	if (bParam0)
	{
		func_48(&iLocal_403);
	...
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392))
	{
		...
		switch (iLocal_389)
		{
			case 0:
				...
				AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_392, -1, 2050, 4);
				if (func_49(iVar0))
				{
				...
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_392, 0);
					...
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_296, 1f, 20000, 1048576000, 0, 1193033728);
					AI::CLOSE_SEQUENCE_TASK(uVar1);
					AI::TASK_PERFORM_SEQUENCE(iLocal_392, uVar1);
				...
				if ((((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) && !PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())) || (PED::IS_PED_IN_ANY_VEHICLE(iLocal_392, 1) && !PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_392))) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(iLocal_392))
				{
					...
					AI::TASK_PERFORM_SEQUENCE(iLocal_392, uVar2);
			...
			case 2:
				if (func_49(iVar0))
				{
					...
					if (VEHICLE::IS_VEHICLE_STOPPED(iVar0))
					{
						...
						AI::TASK_PERFORM_SEQUENCE(iLocal_392, uVar3);
						AI::CLEAR_SEQUENCE_TASK(&uVar3);
						iLocal_299 = GAMEPLAY::GET_GAME_TIMER() + 25000;
						iLocal_389 = 3;
					}
				}
				else
			...
			case 3:
				...
				if (((!func_27() && func_82(iLocal_392, Local_296, 4f)) || bLocal_300) || GAMEPLAY::GET_GAME_TIMER() > iLocal_299)
				{
					if (bLocal_300)
					{
						if (func_27())
...
void func_89(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_90(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76434[1] = { func_141(iVar10, iParam1, iParam2, -1) };
		if (!func_140(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76434[1] = { func_141(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1] = { func_141(iVar10, 14, uVar28[iVar1], -1) };
							func_111(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
							func_133(14);
							if (Global_76432 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_101(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_101(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_101(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_133(iVar0);
						if (Global_76432 == 1)
						{
			...
			{
				Global_76434[1] = { func_141(iVar10, iVar0, func_100(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1] = { func_141(iVar10, 14, uVar69[iVar1], -1) };
			func_111(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
			func_133(14);
			if (Global_76432 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_101(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_101(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_101(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
int func_92(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_205(iParam0, Global_111638.f_2358.f_539[iVar0].f_64, Global_111638.f_2358.f_539[iVar0].f_63))
		{
...
{
	Global_76434[1] = { func_141(iParam0, iParam1, iParam2, -1) };
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_205(iParam0, Global_111638.f_2358.f_539[iVar0].f_61, Global_111638.f_2358.f_539[iVar0].f_60) || iParam3 == 1)
		{
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								if (!func_104(-1692214353, iVar3, iVar5, iVar4, &iVar6))
								{
									if (iVar6 != -99)
									{
										iVar0 = iVar6;
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_101(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_101(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_118(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_125(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_125(Var16.z)] = func_118(iParam1, Var16.x, func_125(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_125(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
...
void func_133(int iParam0)
{
	...
	{
		func_139(iParam0, Global_76434[1].f_5, Global_76434[1].f_2, 2, Global_76434[1].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_135(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2548434[iParam0][func_136(iParam2)];
	if (iVar0 != 0)
	{
...
int func_137(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0][func_136(iParam1)];
...
void func_143(int iParam0)
{
	...
	func_144(&(Global_76434[0]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_137(func_146(iParam1, uParam0->f_2), Global_76431, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_137(iVar1, Global_76431, 0);
				if (!GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_150(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_144(&(Global_76434[0]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_144(&(Global_76434[0]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_144(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_144(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_101(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_205(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76434[1] = { func_141(iVar0, iParam1, iParam2, -1) };
	if (!GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_205(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_205(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76434[2] = { func_141(iVar0, 14, iVar4, -1) };
									if (Global_76434[2].f_12 == iVar3)
									{
										if (func_205(iParam0, 14, iVar4))
										{
											if (!func_97(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76434[2])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76434[2] = { func_141(iVar0, iVar2, iVar1, -1) };
						if (!func_97(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76434[2])))
						{
							return 0;
						}
					}
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_101(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_101(iParam1)))
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_389)
		{
			case 0:
				...
				else
				{
					...
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2f, 20000, 1048576000, 0, 1193033728);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_293, 1f, 20000, 1048576000, 0, 1193033728);
					AI::CLOSE_SEQUENCE_TASK(uVar1);
					AI::TASK_PERFORM_SEQUENCE(iLocal_392, uVar1);
					AI::CLEAR_SEQUENCE_TASK(&uVar1);
				}
			...
			case 3:
				...
				if (((!func_27() && (func_82(iLocal_392, Local_287, 2f) || func_82(iLocal_392, Local_290, 2f))) || bLocal_300) || GAMEPLAY::GET_GAME_TIMER() > iLocal_299)
				{
					if (bLocal_300)
					{
						if (func_27())
...
int func_217(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_218(Var18[0], Var18[1], Var6, Var9) || func_218(Var18[0], Var18[1], Var9, Var15)) || func_218(Var18[0], Var18[1], Var12, Var15)) || func_218(Var18[0], Var18[1], Var6, Var12)) || func_218(Var18[1], Var18[3], Var6, Var9)) || func_218(Var18[1], Var18[3], Var9, Var15)) || func_218(Var18[1], Var18[3], Var12, Var15)) || func_218(Var18[1], Var18[3], Var6, Var12)) || func_218(Var18[3], Var18[2], Var6, Var9)) || func_218(Var18[3], Var18[2], Var9, Var15)) || func_218(Var18[3], Var18[2], Var12, Var15)) || func_218(Var18[3], Var18[2], Var6, Var12)) || func_218(Var18[2], Var18[0], Var6, Var9)) || func_218(Var18[2], Var18[0], Var9, Var15)) || func_218(Var18[2], Var18[0], Var12, Var15)) || func_218(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
	...
	if (func_42(iLocal_392) && func_49(iLocal_403))
	{
		switch (iLocal_274)
		{
			...
			case 2:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_273, 1);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "enter_back", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_322 = 0;
				iLocal_323 = -1;
				iLocal_274 = 12;
				break;
			...
			case 4:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_273, 1);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "enter_left", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_274 = 5;
				break;
			...
			case 5:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_273) >= 0.9f)
					{
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_273, 0);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "left", 8f, -8f, 4, iLocal_276, 1148846080, 0);
						iLocal_274 = 6;
					}
				}
				break;
			...
			case 7:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_273, 1);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "exit_left", 8f, -8f, 4, iLocal_276, 1148846080, 0);
			...
			case 8:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_273, 1);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "enter_right", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_274 = 9;
				break;
			...
			case 9:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_273) >= 0.9f)
					{
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_273, 0);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "right", 8f, -8f, 4, iLocal_276, 1148846080, 0);
						iLocal_274 = 10;
					}
				}
				break;
			...
			case 11:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_273, 1);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "exit_right", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				if (iLocal_277 || !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_403, 7))
				{
					iLocal_274 = 13;
				}
			...
			case 12:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_273) >= 0.9f)
					{
						...
						{
							iLocal_322 = 1;
							iLocal_323 = GAMEPLAY::GET_GAME_TIMER() + 1000;
						}
						uLocal_273 = PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_273, 1);
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_273, 0);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "back", 8f, -8f, 4, iLocal_276, 1148846080, 0);
						iLocal_274 = 3;
					}
				}
				break;
			...
			case 14:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_273, 1);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "exit_back", 4f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_274 = 15;
				break;
			...
			case 15:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_273) >= 0.95f)
					{
						...
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "enter_backseat", 8f, -8f, 4, iLocal_276, 1148846080, 0);
						iLocal_274 = 16;
					}
				}
				else
			...
			case 17:
				if (PED::IS_PED_IN_VEHICLE(iLocal_392, iLocal_403, 0) && iLocal_277)
				{
					...
					{
						AI::TASK_LEAVE_ANY_VEHICLE(iLocal_392, 0, 65536);
...
int func_224()
{
	...
	{
		Var0 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_403, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) };
		if (Var0.y < -1f)
		{
			return 1;
		}
	...
	if (func_42(iLocal_392))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_392, 0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				{
					AI::TASK_LEAVE_ANY_VEHICLE(iLocal_392, 0, 4416);
				}
			}
		}
	}
...
void func_228()
{
	if ((iLocal_349 < 3 && GAMEPLAY::GET_GAME_TIMER() > iLocal_343) && (func_231() || func_230()))
	{
			...
			if (iLocal_344 > 60)
			{
				if (!func_27() && func_229())
				{
					if (func_4(&uLocal_107, "MEJ1AUD", "MEJ1_STILL", sLocal_345[iLocal_349], 7, 0, 0))
					{
						iLocal_349++;
						iLocal_344 = 0;
						iLocal_343 = GAMEPLAY::GET_GAME_TIMER() + 9000;
					}
				}
			}
		}
...
void func_232()
{
	if ((iLocal_332 < 6 && GAMEPLAY::GET_GAME_TIMER() > iLocal_324) && func_231())
	{
	...
	switch (iLocal_389)
	{
		case 0:
			...
			if (func_336() == 1)
			{
				...
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_383, 10f, 0, 0, 0, 0, 0, 0);
			}
			else
			{
...
void func_247()
{
	if (func_42(PLAYER::PLAYER_PED_ID()) && GAMEPLAY::GET_GAME_TIMER() > iLocal_374)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
		...
		iLocal_374 = GAMEPLAY::GET_GAME_TIMER() + 1000;
	}
}

void func_248()
{
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_357)
	{
		if ((!func_27() && func_229()) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
		{
			if (func_45(&uLocal_107, "MEJ1AUD", "MEJ1_SHOOT", 7, 0, 0, 0))
			{
				iLocal_357 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			}
		}
	}
}
...
void func_249()
{
	if ((iLocal_372 < 12 && GAMEPLAY::GET_GAME_TIMER() > iLocal_358) && func_42(uLocal_394[0]))
	{
		if (func_225(PLAYER::PLAYER_PED_ID(), uLocal_394[0]) < 30f)
		{
			if (!func_27() && func_229())
			{
				...
				{
					iLocal_372++;
					iLocal_358 = GAMEPLAY::GET_GAME_TIMER() + 9000;
				}
			}
		}
	}
...
void func_250()
{
	if ((iLocal_342 < 3 && GAMEPLAY::GET_GAME_TIMER() > iLocal_333) && (func_231() || func_230()))
	{
		if (PLAYER::HAS_PLAYER_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID()))
		{
			if (bLocal_376)
			{
				...
				{
					iLocal_342++;
					iLocal_333 = GAMEPLAY::GET_GAME_TIMER() + 9000;
					PLAYER::CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID());
				}
			}
			else if (!func_27())
...
void func_251()
{
	if (iLocal_278 == 0)
	{
		if (((iLocal_280 == -1 && !func_27()) && func_229()) && func_231())
		{
			...
			{
				iLocal_279++;
				iLocal_319 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			}
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_319)
			{
	...
	{
		if (((!func_27() && func_229()) && func_231()) && GAMEPLAY::GET_GAME_TIMER() > iLocal_319)
		{
...
void func_252()
{
	if (((((iLocal_375 && ENTITY::DOES_ENTITY_EXIST(uLocal_394[0])) && ENTITY::DOES_ENTITY_EXIST(uLocal_394[1])) && ENTITY::DOES_ENTITY_EXIST(uLocal_394[2])) && func_42(iLocal_392)) && !UI::IS_MESSAGE_BEING_DISPLAYED())
	{
...
{
	func_255(&Global_105187, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_255(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	*uParam0 = func_16();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_276())
		{
			func_272(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_267(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	uVar0 = Global_2583656[iParam0][func_136(iParam1)];
...
void func_277(int iParam0, bool bParam1)
{
	...
	if (func_18(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_278(iParam0, &(Global_111638.f_2358.f_539.f_298[iVar0]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
int func_291(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_293() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_137(func_292(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_295(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_310(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Param0, func_296(iVar0, 0), 1);
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_318(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
	...
	switch (iLocal_389)
	{
		case 0:
			...
			if ((((func_49(iLocal_403) && func_42(uLocal_394[0])) && func_42(uLocal_394[1])) && func_42(uLocal_394[2])) && func_42(iLocal_392))
			{
				...
				AI::TASK_VEHICLE_DRIVE_WANDER(uLocal_394[0], iLocal_403, 12f, 786468);
		...
		case 1:
			...
			{
				if (iLocal_322 && GAMEPLAY::GET_GAME_TIMER() > iLocal_323)
				{
				...
				if ((((((((((ENTITY::GET_ENTITY_HEALTH(iLocal_403) < 850 || func_352()) || func_350()) || func_349(iLocal_403, &uLocal_454, &uLocal_456, &uLocal_453, &fLocal_455, 6, 1082130432)) || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_403) < 50f) || VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(iLocal_403) < 50f) || (func_42(uLocal_394[0]) && !PED::IS_PED_IN_VEHICLE(uLocal_394[0], iLocal_403, 0))) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 2, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 3, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 0, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 1, 5000))
				{
					...
					{
						AI::TASK_VEHICLE_TEMP_ACTION(uLocal_394[0], iLocal_403, 20, 1000);
					}
					VEHICLE::_SET_VEHICLE_HALT(iLocal_403, 20f, 1, 0);
				...
				if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_403))
				{
					...
					while (iVar2 < 3)
					{
						if (func_42(uLocal_394[iVar2]))
						{
							...
							AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
							AI::CLOSE_SEQUENCE_TASK(uVar3);
							AI::TASK_PERFORM_SEQUENCE(uLocal_394[iVar2], uVar3);
							AI::CLEAR_SEQUENCE_TASK(&uVar3);
							if (iVar2 == 0 && !func_350())
							{
								func_28();
					...
					else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_403, 0))
					{
						iLocal_277 = 1;
						if (AUDIO::IS_AUDIO_SCENE_ACTIVE("M_E_JIMMY_STOP_KIDNAPPERS"))
						{
		...
		case 3:
			...
			if ((func_49(iLocal_403) && func_42(PLAYER::PLAYER_PED_ID())) && func_42(iLocal_392))
			{
				...
				if (bLocal_437)
				{
					if (func_225(PLAYER::PLAYER_PED_ID(), iLocal_392) < 5f)
					{
						AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_392);
						func_341();
					}
				}
...
void func_340()
{
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392))
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_318)
		{
			if (!func_27() && !UI::IS_MESSAGE_BEING_DISPLAYED())
			{
				if (func_45(&uLocal_107, "MEJ1AUD", "MEJ1_HERE", 7, 0, 0, 0))
				{
					iLocal_318 = GAMEPLAY::GET_GAME_TIMER() + 15000;
				}
			}
		}
	}
...
int func_349(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, float fParam6)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		Var1 = { func_36(ENTITY::GET_ENTITY_COORDS(iVar0, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_350()
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_49(iLocal_403))
	{
		...
		if (func_49(iVar0))
		{
			...
			if ((((func_351(iVar1) || iVar1 == -1973172295) || iVar1 == -1536924937) || iVar1 == -1779120616) || iVar1 == 1127131465)
			{
...
int func_352()
{
	if (iLocal_440)
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_441)
		{
			return 1;
		}
	}
	else
	{
		...
		{
			iLocal_440 = 1;
			iLocal_441 = GAMEPLAY::GET_GAME_TIMER() + 1000;
		}
	}
	return 0;
}
...
int func_359(char* sParam0)
{
	if (!func_360(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_344(sParam0)) || func_344("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_360(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_367() || func_366(Global_4456448.f_232883)) || func_365())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_363(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_381()
{
	if (iLocal_312 > 0 && GAMEPLAY::GET_GAME_TIMER() > iLocal_312)
	{
		if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392))
		{
			if ((func_225(PLAYER::PLAYER_PED_ID(), iLocal_392) < 50f && !func_27()) && !func_382("MEJ1_02", 0, 0))
			{
				if (iLocal_315)
				{
					...
					{
						iLocal_312 = GAMEPLAY::GET_GAME_TIMER() + 10000;
						iLocal_315 = 0;
					}
				}
...
void func_383()
{
	if ((func_42(PLAYER::PLAYER_PED_ID()) && func_42(uLocal_394[0])) && func_49(iLocal_403))
	{
		if (iLocal_310 == -1 && iLocal_311 == -1)
		{
			...
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_403, PLAYER::PLAYER_PED_ID(), 1) || bLocal_313)
			{
				...
				if (func_4(&uLocal_107, "MEJ1AUD", "MEJ1_RAM", "MEJ1_RAM_3", 7, 0, 0))
				{
					...
					AI::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_394[0], iLocal_403, PLAYER::PLAYER_PED_ID(), 8, 25f, 786468, 100f, 1f, 1);
					UNK1::_0x293220DA1B46CEBC(3f, 0f, 3);
					iLocal_274 = 2;
					fLocal_386 = 200f;
					fLocal_387 = 500f;
			...
			else if (func_225(PLAYER::PLAYER_PED_ID(), uLocal_394[0]) < 50f && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_403))
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_320)
				{
					...
					if (bVar0)
					{
						iLocal_320 = GAMEPLAY::GET_GAME_TIMER() + 10000;
					}
				}
			}
		}
		...
		else if (((iLocal_310 < 8 && func_225(PLAYER::PLAYER_PED_ID(), uLocal_394[0]) < 50f) && !func_27()) && !func_382("MEJ1_02", 0, 0))
		{
			if (!iLocal_314 && func_45(&uLocal_107, "MEJ1AUD", "MEJ1_DSPOT", 7, 0, 0, 0))
			{
				iLocal_319 = GAMEPLAY::GET_GAME_TIMER() + 5000;
				iLocal_314 = 1;
				iLocal_312 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			}
		...
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(iParam0))
			{
				...
				if (func_49(iVar5))
				{
					...
					AI::CLEAR_SEQUENCE_TASK(&uVar3);
					AI::OPEN_SEQUENCE_TASK(&uVar3);
					AI::TASK_PLAY_ANIM(0, "missfam3", sVar0, 4f, -8f, -1, 16 | iParam2, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "missfam3", sVar1, 8f, -8f, iParam1, 16 | iParam2 | 1, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "missfam3", sVar2, 8f, -4f, -1, 16 | iParam2, 0, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uVar3);
...
void func_392()
{
	...
	switch (iLocal_389)
	{
		case 0:
			...
			UI::SET_BLIP_COLOUR(iLocal_391, 3);
			UI::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_391, "MEJ1_JIM");
			UI::SET_BLIP_ROUTE(iLocal_391, 1);
		...
		case 1:
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_377, 1) < 1400f)
			{
				iLocal_389 = 2;
			}
			break;
...
int func_393()
{
	if (((func_49(iLocal_403) && func_42(PLAYER::PLAYER_PED_ID())) && func_42(iLocal_394[0])) && func_42(iLocal_392))
	{
		...
		else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_421, Local_424, fLocal_433, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_427, Local_430, fLocal_434, 0, 1, 0))
		{
			ENTITY::SET_ENTITY_COORDS(iLocal_403, Local_405, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(iLocal_403, fLocal_408);
			return 1;
...
void func_394()
{
	if (func_49(iLocal_403))
	{
		...
		if (!func_42(iLocal_392))
		{
			if (STREAMING::HAS_MODEL_LOADED(func_52(14)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_272))
			{
				...
				AI::SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_392, 1);
				AI::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_392, 1);
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_273, 0);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "base", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_274 = 0;
			}
		}
	}
	else if (STREAMING::HAS_MODEL_LOADED(iLocal_404))
	{
		...
		iLocal_322 = 0;
		iLocal_323 = -1;
		AUDIO::_DYNAMIC_MIXER_RELATED_FN(iLocal_403, "M_E_JIMMY_ENEMY_VEHICLE_GROUP", 0);
	}
}
...
void func_400()
{
	...
	if (UI::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		...
		if (func_66(0) && func_42(PLAYER::PLAYER_PED_ID()))
		{
			...
			func_436(&iVar0, Var1, fVar4, 1, 0, 1, 1, 1, -1903012613, 0, 145, 1);
		}
		if (func_396())
		{
			iVar5 = func_435();
			...
			switch (iVar5)
			{
				...
				case 3:
					func_401(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
...
void func_409(bool bParam0)
{
	...
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392))
	{
		...
		else
		{
			Var2 = { func_411() };
			func_410(&Var2, &fVar5);
			func_436(&iVar1, Var2, fVar5, 1, 0, 1, 1, 1, -1903012613, 0, 145, 1);
...
{
	Var0[0] = { -2539.17f, 1866.73f, 166.1f };
	fVar16[0] = 216.03f;
	Var0[1] = { -2022.33f, 826.23f, 162.32f };
	fVar16[1] = 172.12f;
	Var0[2] = { -1038.3f, 253f, 64.21f };
	fVar16[2] = 270.02f;
	Var0[3] = { -3140.89f, 1024.06f, 18.33f };
	fVar16[3] = 152.08f;
	Var0[4] = { -2641.3f, -110.03f, 18.7f };
	fVar16[4] = 221.35f;
	iVar22 = 0;
	iVar23 = 1;
	while (iVar23 < 5)
	{
		if (SYSTEM::VDIST2(Var0[iVar23], *uParam0) < SYSTEM::VDIST2(Var0[iVar22], *uParam0))
		{
			iVar22 = iVar23;
		}
		iVar23++;
...
int func_423(var uParam0)
{
	...
	if (uParam0->f_12.f_66 == -2122757008 && func_424(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
void func_438(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	if ((func_18(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_268(iParam1, &(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_31), &(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_81));
			if (bParam3)
			{
				...
				Global_111638.f_20113[iParam0].f_31 = func_441(*iParam1);
				...
				func_439(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_5, Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_7, iVar3, 1, &(Global_111638.f_20113[iParam0].f_1));
				...
				func_439(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_6, -1, iVar3, 0, &(Global_111638.f_20113[iParam0].f_2));
			}
		}
	}
}
...
int func_442(int iParam0, bool bParam1, var uParam2)
{
	*uParam2 = 0;
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_443(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != 873639469) && ENTITY::GET_ENTITY_MODEL(iParam0) != -1177863319)
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_444(int iParam0)
{
	if (iParam0 != func_10())
	{
		if (func_362(iParam0, 1, 1))
		{
			...
			{
				return func_445(Global_2425662[iParam0].f_310.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_448(int iParam0)
{
	if (iParam0 != func_10())
	{
		if (func_362(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_445(Global_2425662[iParam0].f_310.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_449(int iParam0)
{
	if (iParam0 != func_10())
	{
		if (func_362(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_445(Global_2425662[iParam0].f_310.f_5) == 7;
			}
		}
	}
	return 0;
...
int func_466(int iParam0)
{
	if (iParam0 != func_10())
	{
		if (func_362(iParam0, 1, 1))
		{
			...
			{
				return func_445(Global_2425662[iParam0].f_310.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_467(int iParam0)
{
	if (iParam0 != func_10())
	{
		if (func_362(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1 && Global_2425662[iParam0].f_310.f_8 != func_10())
			{
				return func_445(Global_2425662[iParam0].f_310.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_468(int iParam0)
{
	if (iParam0 != func_10())
	{
		if (func_362(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_445(Global_2425662[iParam0].f_310.f_5) == 9;
			}
		}
	}
	return 0;
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_215(iParam0, 0, 0)) || func_215(iParam0, 1, 0)) || func_215(iParam0, 2, 0)) || func_262(iParam0) != 145) || func_476(iParam0)) || func_475(iParam0)) || func_443(iParam0)) || func_474(iParam0)) || !func_473(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_475(iParam0))
		{
		}
...
int func_480(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_465(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_483(*uParam0, ((*uParam1)[38] - 1)))
	{
...
void func_486(struct<3> Param0, float fParam3, int iParam4)
{
	...
	while (iVar0 < 68)
	{
		if (func_494(&(Global_75441.f_555[0]), iVar0))
		{
...
void func_487(int iParam0)
{
	...
	if (func_494(&(Global_75441.f_555[0]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_493(iParam0, 0)) && Global_76350.f_66 == 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0].f_14] != 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0].f_14] > 3) && (!func_491(0, Global_75441.f_555[0].f_12) || !func_491(1, Global_75441.f_555[0].f_12)))
			{
				func_490(&(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]), &Global_76350);
...
int func_491(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_492(&(Global_111638.f_32744.f_5038[iVar0])))
	{
		return 0;
	}
	return func_425(Global_111638.f_32744.f_5038[iVar0][iParam0].f_66, 0);
}
...
int func_494(var uParam0, int iParam1)
{
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_288(Global_111638.f_32744.f_1864[uParam0->f_14], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_288(Global_111638.f_2358.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_288(Global_111638.f_2358.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	if (func_423(uParam0))
	{
		...
		if (func_511(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_498(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_498(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_499(iParam0, uVar1[iVar6], 1) && func_424(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_288(Param1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_500(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_267(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_267(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_267(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == 340154634 || uParam1->f_66 == -1960756985)
		{
			...
			while (iVar2 <= 9)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_267(iVar2)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_267(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_267(iVar3)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_267(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_267(iVar4)))
					{
					}
					else
					{
						GAMEPLAY::SET_BIT(&(uParam1->f_77), func_267(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_267(iVar5 + 1)))
				{
