	...
	switch (iLocal_85)
	{
		...
		case 1:
			...
			if (func_317(PLAYER::PLAYER_PED_ID()))
			{
				...
				else if ((MISC::GET_GAME_TIMER() > iLocal_292 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
				{
					iLocal_85 = 2;
				}
			}
...
int func_39(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_76434[1 /*14*/] = { func_90(iVar0, iParam1, uVar6[iParam1], -1) };
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76434[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1 /*14*/] = { func_90(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1 /*14*/] = { func_90(iVar10, 14, uVar15[iVar1], -1) };
			func_58(iParam0, Global_76434[1 /*14*/].f_12, Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4);
			func_73(14);
			if (Global_76432 == 1)
			{
...
void func_92(int iParam0)
{
	...
	func_93(&(Global_76434[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_93(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_93(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
void func_167(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_168(&uVar1, Var0.f_3, Global_98781, iParam1, iParam2);
	}
}
...
void func_229()
{
	...
	while (MISC::GET_GAME_TIMER() < iLocal_296 + 11000 && !CAM::IS_SCREEN_FADED_OUT())
	{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_293))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_293) == 1f)
				{
					if (func_317(Local_91))
					{
						...
						TASK::TASK_SYNCHRONIZED_SCENE(Local_91, uLocal_294, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
		...
		else if (!iLocal_302)
		{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_294) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_294) == 1f)
			{
				if (func_317(Local_91))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(Local_91, uLocal_295, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_295) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_295) >= 0.323f)
		{
			if (!iLocal_298)
			{
	...
	if (func_228(Local_91))
	{
		...
		PED::_0x2208438012482A1A(Local_91, 0, 0);
		ENTITY::SET_ENTITY_COORDS(Local_91, 1655.77f, -20.04f, 135.8f, 1, 0, 0, 1);
			...
			if (!func_266())
			{
				if (func_260(1, 20f, 1))
				{
					if ((!iLocal_305 || MISC::GET_GAME_TIMER() > iLocal_306 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, 1, 0))
					{
						...
						if (func_317(Local_91))
						{
							ENTITY::FREEZE_ENTITY_POSITION(Local_91, 0);
						}
					...
					if (!iLocal_90)
					{
						if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_293))
						{
							if (func_317(Local_91))
							{
								...
								TASK::TASK_SYNCHRONIZED_SCENE(Local_91, uLocal_293, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
...
void func_267()
{
	...
	switch (iLocal_85)
	{
		case 0:
			...
			uLocal_94 = func_277(Local_91, 1, 1, 5);
			SYSTEM::SETTIMERA(0);
			iLocal_85 = 1;
			break;
...
void func_269()
{
	...
	if (!func_266())
	{
		if ((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", 0, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", 0, -1))
		{
			if (AUDIO::HAS_SOUND_FINISHED(uLocal_289))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_289, "DOM", Local_91, "EXTREME_04_SOUNDSET", 0, 0);
			}
		}
	}
}
...
int func_274(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_258(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_281()
{
	...
	MISC::CLEAR_AREA_OF_VEHICLES(Local_91.f_1, 20f, 0, 0, 0, 0, 0, 0);
...
void func_282(var uParam0, struct<3> Param1, float fParam2)
{
	func_283(uParam0, iLocal_79, Param1, fParam2, 26);
...
void func_283(var uParam0, int iParam1, struct<3> Param2, var uParam3, int iParam4)
{
	func_284(uParam0);
...
void func_298()
{
	...
	if (iLocal_84 == 1)
	{
		...
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_91, 1), 1);
			if (iLocal_89 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			else if (HUD::DOES_BLIP_EXIST(uLocal_94))
			{
	...
	if (Global_76876 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_301(Global_76877, Global_76879, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_318()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_91))
	{
		...
		ENTITY::FREEZE_ENTITY_POSITION(Local_91, 1);
		...
		PED::SET_PED_CONFIG_FLAG(Local_91, 137, 1);
		PED::SET_PED_CONFIG_FLAG(Local_91, 118, 0);
		PED::SET_PED_CONFIG_FLAG(Local_91, 208, 1);
...
int func_319(var uParam0, int iParam1, struct<3> Param2, var uParam3, char* sParam4, int iParam5)
{
	if (func_320(uParam0, iParam1, Param2, uParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
...
int func_320(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
