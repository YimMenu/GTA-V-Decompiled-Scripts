		...
		case 1:
			...
			if (func_317(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (func_228(Local_155))
				{
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() > iLocal_370 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
						{
							iLocal_149 = 2;
						}
					}
				}
				else if ((GAMEPLAY::GET_GAME_TIMER() > iLocal_370 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
				{
					iLocal_149 = 2;
				}
			}
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_82(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_82(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_93(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_93(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_82(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_173()
{
	...
	{
		func_162();
		GRAPHICS::_0xBF59707B3E5ED531(func_174(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_371))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_371) == 1f)
				{
					if (func_317(Local_155))
					{
						...
						AI::TASK_SYNCHRONIZED_SCENE(Local_155, uLocal_372, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_372, 0);
		...
		else if (!iLocal_380)
		{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_372) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_372) == 1f)
			{
				if (func_317(Local_155))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(Local_155, uLocal_373, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_373, 1);
	...
	switch (iLocal_149)
	{
		case 0:
			...
			if (!func_266())
			{
				if (func_260(1, 20f, 1))
				{
					if ((!iLocal_383 || GAMEPLAY::GET_GAME_TIMER() > iLocal_384 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, 1, 0))
					{
					...
					if (!iLocal_154)
					{
						if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_371))
						{
							if (func_317(Local_155))
							{
								...
								AI::TASK_SYNCHRONIZED_SCENE(Local_155, uLocal_371, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
								PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_371, 1);
								CAM::SET_CAM_ACTIVE(uLocal_363, 1);
...
void func_247(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_248(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_264(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	{
		VEHICLE::_SET_VEHICLE_HALT(uParam0, uParam1, iParam2, iParam4);
	}
...
void func_267()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (((((((CONTROLS::IS_CONTROL_PRESSED(0, 30) || CONTROLS::IS_CONTROL_PRESSED(0, 31)) || CONTROLS::IS_CONTROL_PRESSED(0, 23)) || CONTROLS::IS_CONTROL_PRESSED(0, 21)) || CONTROLS::IS_CONTROL_PRESSED(0, 22)) || (func_279() && CONTROLS::IS_CONTROL_PRESSED(0, 1))) || (func_279() && CONTROLS::IS_CONTROL_PRESSED(0, 2))) || (func_279() && CONTROLS::IS_CONTROL_PRESSED(0, 32)))
			{
...
void func_268()
{
	if (func_317(Local_155))
	{
		...
		{
			AI::TASK_PERFORM_SEQUENCE(Local_155, uLocal_171);
		}
	}
}
...
void func_281()
{
	...
	AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_82.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 0.25f, 0, 40000f);
	AI::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 0);
	GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_155.f_1, 20f, 0, 0, 0, 0, 0, 0);
	...
	if (func_317(Local_155))
	{
		if (AI::GET_SCRIPT_TASK_STATUS(Local_155, 242628503) != 1)
		{
			AI::OPEN_SEQUENCE_TASK(&uLocal_171);
			...
			AI::SET_SEQUENCE_TO_REPEAT(uLocal_171, 1);
			AI::CLOSE_SEQUENCE_TASK(uLocal_171);
			AI::TASK_PERFORM_SEQUENCE(Local_155, uLocal_171);
		}
	}
	if (func_317(Local_155))
...
void func_298()
{
	if (iLocal_148 == 1)
	{
		...
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_155, 1), 1);
			if (iLocal_153 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			if (fVar0 > 150f)
			{
				...
				{
					UI::SET_BLIP_FLASHES(uLocal_170, 1);
				}
			}
			else if (UI::DOES_BLIP_EXIST(uLocal_170))
			{
				UI::SET_BLIP_FLASHES(uLocal_170, 0);
			}
		}
