void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (func_317(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, 1, 0))
			{
	...
	switch (iLocal_149)
	{
		...
		case 1:
			...
			if (func_317(PLAYER::PLAYER_PED_ID()))
			{
				...
				else if ((MISC::GET_GAME_TIMER() > iLocal_370 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0))
				{
					iLocal_149 = 2;
				}
			}
...
void func_10(int iParam0, bool bParam1)
{
	...
	{
		func_178(&(Global_110725[iVar0].f_9));
	}
	if (bParam1)
	{
...
void func_29(var uParam0)
{
	*uParam0 = 145;
	...
	while (iVar1 < 3)
	{
		...
		func_34(&(uParam0->f_25[0][iVar1]));
		func_34(&(uParam0->f_25[1][iVar1]));
		iVar0 = 0;
		while (iVar0 < 12)
		{
...
int func_39(int iParam0, int iParam1, int iParam2)
{
	...
	Global_76434[1] = { func_90(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_76434[1] = { func_90(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_82(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_82(iParam1), Global_76434[1].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, 0);
		}
	}
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_155(iParam0, Global_111638.f_2358.f_539[iVar0].f_64, Global_111638.f_2358.f_539[iVar0].f_63))
		{
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76434[1] = { func_90(iVar10, iParam1, iParam2, -1) };
		if (!func_80(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76434[1] = { func_90(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1] = { func_90(iVar10, 14, uVar28[iVar1], -1) };
							func_58(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
							func_73(14);
							if (Global_76432 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_73(iVar0);
						if (Global_76432 == 1)
						{
			...
			{
				Global_76434[1] = { func_90(iVar10, iVar0, func_48(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1] = { func_90(iVar10, 14, uVar69[iVar1], -1) };
			func_58(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
			func_73(14);
			if (Global_76432 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
{
	Global_76434[1] = { func_90(iParam0, iParam1, iParam2, -1) };
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								if (!func_51(-1692214353, iVar3, iVar5, iVar4, &iVar6))
								{
									if (iVar6 != -99)
									{
										iVar0 = iVar6;
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_82(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_82(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_60(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_60(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_60(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_60(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_73(int iParam0)
{
	...
	{
		func_79(iParam0, Global_76434[1].f_5, Global_76434[1].f_2, 2, Global_76434[1].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76434[1].f_6, 1) && MISC::IS_BIT_SET(Global_76434[1].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_75(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2548434[iParam0][func_76(iParam2)];
	if (iVar0 != 0)
	{
...
int func_77(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0][func_76(iParam1)];
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_155(iParam0, Global_111638.f_2358.f_539[iVar0].f_61, Global_111638.f_2358.f_539[iVar0].f_60) || iParam3 == 1)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_65(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_88(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_88(Var16.z)] = func_65(iParam1, Var16.x, func_88(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_88(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
...
void func_92(int iParam0)
{
	...
	func_93(&(Global_76434[0]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_77(func_96(iParam1, uParam0->f_2), Global_76431, 0);
			if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_77(func_95(iParam1, uParam0->f_2), Global_76431, 0);
			if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_77(iVar1, Global_76431, 0);
				if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_93(&(Global_76434[0]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_93(&(Global_76434[0]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_93(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_93(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_82(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_155(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_155(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_155(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76434[2] = { func_90(iVar0, 14, iVar4, -1) };
									if (Global_76434[2].f_12 == iVar3)
									{
										if (func_155(iParam0, 14, iVar4))
										{
											if (!func_46(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76434[2])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76434[2] = { func_90(iVar0, iVar2, iVar1, -1) };
						if (!func_46(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76434[2])))
						{
							return 0;
						}
					}
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_82(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_82(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_167(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != -1)
	{
		...
		func_168(&uVar32, Var0.f_3, Global_98781, iParam1, iParam2);
	}
}
...
{
	func_183(iParam0, 1);
	Global_111638.f_18569[iParam0].f_3 = func_182();
...
void func_229()
{
	...
	while (MISC::GET_GAME_TIMER() < iLocal_374 + 11000 && !CAM::IS_SCREEN_FADED_OUT())
	{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_371))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_371) == 1f)
				{
					if (func_317(Local_155))
					{
						...
						TASK::TASK_SYNCHRONIZED_SCENE(Local_155, uLocal_372, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
		...
		else if (!iLocal_380)
		{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_372) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_372) == 1f)
			{
				if (func_317(Local_155))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(Local_155, uLocal_373, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_373) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_373) >= 0.323f)
		{
			if (!iLocal_376)
			{
	...
	if (func_317(Local_155))
	{
		if (iVar0 < 3)
		{
			...
			Var4 = { ENTITY::GET_ENTITY_COORDS(Local_155, 1) };
			if (Var4.z > 155f)
			{
				fVar7 = 155f;
			}
			...
			if (!func_266())
			{
				if (func_260(1, 20f, 1))
				{
					if ((!iLocal_383 || MISC::GET_GAME_TIMER() > iLocal_384 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, 1, 0))
					{
						...
						if (func_317(Local_155))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_155, "Dom", 0, 1198698306, 0);
						}
						SYSTEM::WAIT(0);
						iLocal_383 = 0;
					...
					if (!iLocal_154)
					{
						if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_371))
						{
							if (func_317(Local_155))
							{
								...
								TASK::TASK_SYNCHRONIZED_SCENE(Local_155, uLocal_371, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
...
int func_256(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((((((((((((((func_257(Var18[0], Var18[1], Var6, Var9) || func_257(Var18[0], Var18[1], Var9, Var15)) || func_257(Var18[0], Var18[1], Var12, Var15)) || func_257(Var18[0], Var18[1], Var6, Var12)) || func_257(Var18[1], Var18[3], Var6, Var9)) || func_257(Var18[1], Var18[3], Var9, Var15)) || func_257(Var18[1], Var18[3], Var12, Var15)) || func_257(Var18[1], Var18[3], Var6, Var12)) || func_257(Var18[3], Var18[2], Var6, Var9)) || func_257(Var18[3], Var18[2], Var9, Var15)) || func_257(Var18[3], Var18[2], Var12, Var15)) || func_257(Var18[3], Var18[2], Var6, Var12)) || func_257(Var18[2], Var18[0], Var6, Var9)) || func_257(Var18[2], Var18[0], Var9, Var15)) || func_257(Var18[2], Var18[0], Var12, Var15)) || func_257(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
void func_267()
{
	...
	switch (iLocal_149)
	{
		case 0:
			...
			uLocal_170 = func_277(Local_155, 1, 1, 5);
			SYSTEM::SETTIMERA(0);
			iLocal_149 = 1;
			break;
...
void func_268()
{
	if (func_317(Local_155))
	{
		...
		{
			TASK::TASK_PERFORM_SEQUENCE(Local_155, uLocal_171);
		}
	}
}
...
void func_269()
{
	...
	if (!func_266())
	{
		if ((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", 0, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", 0, -1))
		{
			if (AUDIO::HAS_SOUND_FINISHED(uLocal_367))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_367, "DOM", Local_155, "EXTREME_04_SOUNDSET", 0, 0);
			}
		}
	}
}
...
{
	Var0 = { func_258(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
void func_281()
{
	...
	MISC::CLEAR_AREA_OF_VEHICLES(Local_155.f_1, 20f, 0, 0, 0, 0, 0, 0);
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_173))
	{
		iLocal_173 = VEHICLE::CREATE_VEHICLE(788045382, 1662.88f, -14.255f, 172.7742f, 205.3516f, 1, 1, 0);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_174))
	{
		iLocal_174 = VEHICLE::CREATE_VEHICLE(1131912276, 1633.766f, -23.6768f, 127.0535f, 55.7565f, 1, 1, 0);
	}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_179))
	{
		iLocal_179 = OBJECT::CREATE_AMBIENT_PICKUP(1735599485, 1665.264f, -11.4427f, 172.7747f, 7, -1, 1269906701, 1, 1);
	}
...
void func_282(var uParam0, struct<3> Param1, float fParam4)
{
	func_283(uParam0, iLocal_81, Param1, fParam4, 26);
...
void func_283(var uParam0, int iParam1, struct<3> Param2, var uParam5, int iParam6)
{
	func_284(uParam0);
...
int func_285(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)
{
	bVar0 = false;
	if (func_228(iParam0))
	{
		...
		case 0:
			...
			if (func_293(1, 1093140480, 0))
			{
				if (!iLocal_383 || MISC::GET_GAME_TIMER() > iLocal_384 + 3500)
				{
					...
					if (func_228(Local_82.f_28[0]))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_82.f_28[0], "Hudson", 0, 882848737, 0);
					}
					SYSTEM::WAIT(0);
					CAM::STOP_GAMEPLAY_HINT(0);
...
int func_293(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if ((!PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_BOAT(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
		{
			if (!func_264(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_298()
{
	if (iLocal_148 == 1)
	{
		...
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_155, 1), 1);
			if (iLocal_153 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			else if (HUD::DOES_BLIP_EXIST(uLocal_170))
			{
...
bool func_316(int iParam0, int iParam1, float fParam2, int iParam3)
{
...
void func_318()
{
	...
	STREAMING::REQUEST_MODEL(798951501);
	STREAMING::REQUEST_MODEL(1165008631);
	STREAMING::REQUEST_MODEL(1269906701);
	STREAMING::REQUEST_MODEL(1131912276);
	while (((!STREAMING::HAS_MODEL_LOADED(798951501) || !STREAMING::HAS_MODEL_LOADED(1165008631)) || !STREAMING::HAS_MODEL_LOADED(1269906701)) || !STREAMING::HAS_MODEL_LOADED(1131912276))
	{
		SYSTEM::WAIT(0);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_175))
	{
		iLocal_175 = OBJECT::CREATE_OBJECT_NO_OFFSET(798951501, 1658.299f, -7.930665f, 173.71f, 1, 1, 0);
...
int func_319(var uParam0, int iParam1, struct<3> Param2, var uParam5, char* sParam6, int iParam7)
{
	if (func_320(uParam0, iParam1, Param2, uParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
...
int func_320(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	if (!func_159(iParam1))
	{
...
void func_322(int iParam0)
{
	...
	STREAMING::REQUEST_MODEL(788045382);
	STREAMING::REQUEST_PTFX_ASSET();
	if (iParam0 == 1)
	{
		while ((((!STREAMING::HAS_MODEL_LOADED(Local_155.f_5) || !STREAMING::HAS_MODEL_LOADED(788045382)) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmextreme4")) || !STREAMING::HAS_ANIM_DICT_LOADED("skydive@parachute@")) || !STREAMING::HAS_PTFX_ASSET_LOADED())
		{
			SYSTEM::WAIT(0);
		}
	}
		...
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1] = { func_325(iParam0) };
					...
					{
						Global_7966[1] = { func_325(iParam0) };
