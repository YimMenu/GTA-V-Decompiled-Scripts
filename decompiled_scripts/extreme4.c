...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_82(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_82(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_82(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_167(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_168(&sVar1, Var0.f_3, Global_98781, bParam1, bParam2);
	}
}
...
void func_229()
{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_293))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_293) == 1f)
				{
					if (func_317(Local_91))
					{
						...
						TASK::TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_294, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1000f, 0);
						...
						PED::_0x2208438012482A1A(Local_91, false, false);
		...
		else if (!iLocal_302)
		{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_294) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_294) == 1f)
			{
				if (func_317(Local_91))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_295, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1000f, 0);
	...
	if (func_317(Local_91))
	{
		if (iVar0 < 3)
		{
			...
			Var4 = { ENTITY::GET_ENTITY_COORDS(Local_91, true) };
			if (Var4.f_2 > 155f)
			{
				fVar5 = 155f;
			}
			...
			ENTITY::SET_ENTITY_COORDS(Local_91, 1657.046f, -17.4571f, fVar5, true, false, false, true);
		}
	}
	...
	if (func_228(Local_91))
	{
		...
		PED::_0x2208438012482A1A(Local_91, false, false);
		ENTITY::SET_ENTITY_COORDS(Local_91, 1655.77f, -20.04f, 135.8f, true, false, false, true);
...
void func_232(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
					...
					if (!iLocal_90)
					{
						if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_293))
						{
							if (func_317(Local_91))
							{
								...
								TASK::TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_293, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1000f, 0);
...
void func_281()
{
	...
	MISC::CLEAR_AREA_OF_VEHICLES(Local_91.f_1, 20f, false, false, false, false, false, false);
	...
	if (func_317(Local_91))
	{
		PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_91, false);
...
int func_285(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
...
void func_297()
{
	...
	if (iLocal_305)
	{
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			CAM::_SET_GAMEPLAY_HINT_ANIM_CLOSEUP(true);
			CAM::SET_GAMEPLAY_ENTITY_HINT(Local_91, 0f, 0f, 0f, true, 30000, 2000, 2000, 0);
			CAM::SET_GAMEPLAY_HINT_FOV(fVar0);
			CAM::_SET_GAMEPLAY_HINT_ANIM_OFFSETZ(fVar1);
			CAM::_SET_GAMEPLAY_HINT_ANGLE(fVar2);
			CAM::_SET_GAMEPLAY_HINT_ANIM_OFFSETX(fVar3);
...
void func_318()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_91))
	{
		...
		WEAPON::REMOVE_ALL_PED_WEAPONS(Local_91, true);
