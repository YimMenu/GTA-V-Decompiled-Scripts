...
void __EntryFunction__()
{
	...
	{
		func_2();
		if (((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_1(PLAYER::PLAYER_ID(), 1, 1)) && !Global_1574216) && Global_31345 == 0)
		{
			func_113();
		}
		SYSTEM::WAIT(0);
...
void func_5(int iParam0)
{
	...
	{
		MISC::SET_BIT(&Global_31595, iParam0);
		Global_31598 = 1;
		func_6();
	}
}
...
{
	if (MISC::IS_BIT_SET(Global_31593, iParam0))
	{
		return 1;
	}
	return 0;
...
void func_31(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		MISC::SET_BIT(&Global_31594, iParam0);
		func_5(iParam0);
	}
	else
	{
		MISC::CLEAR_BIT(&Global_31594, iParam0);
	}
}
...
{
	if (MISC::IS_BIT_SET(Global_31594, iParam0))
	{
		return 1;
	}
	return 0;
...
{
	if (MISC::IS_BIT_SET(Global_31596, iParam0))
	{
		if (iParam1 != 0)
		{
			if (iParam1 == Global_31597)
			{
				MISC::CLEAR_BIT(&Global_31596, iParam0);
				iLocal_93 = 1;
				return 1;
			}
			else
