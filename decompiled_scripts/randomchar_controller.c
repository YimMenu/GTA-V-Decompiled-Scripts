...
void func_1()
{
	...
	while (iVar2 < 63)
	{
		...
		{
			func_3(iLocal_54[Global_110725[iVar0 /*10*/].f_8], 0, 0);
				...
				if (!func_43(74))
				{
					...
					else if (func_23(iLocal_56))
					{
						...
						while (iVar1 <= 262)
						{
							...
							{
								if (HUD::DOES_BLIP_EXIST(Global_31146[iVar3 /*23*/].f_19))
								{
									HUD::SET_BLIP_FLASHES(Global_31146[iVar3 /*23*/].f_19, 1);
									HUD::SET_BLIP_FLASH_TIMER(Global_31146[iVar3 /*23*/].f_19, 10000);
									switch (func_9())
									{
										case 1:
...
void func_61(int iParam0)
{
	...
	while (iVar1 < Global_111638.f_7683.f_198)
	{
		...
		{
			func_62(Global_111638.f_7683.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
	...
	if (!func_82(iVar0) || iVar0 == 52)
	{
		if (!MISC::IS_BIT_SET(Global_111638.f_18569.f_390[iLocal_52], iLocal_51))
		{
			...
			else if (Global_110725[iVar0 /*10*/].f_8 != -1)
			{
				...
				{
					if (MISC::IS_BIT_SET(Global_31146[iLocal_54[Global_110725[iVar0 /*10*/].f_8] /*23*/].f_11, 6))
					{
						func_81(iLocal_54[Global_110725[iVar0 /*10*/].f_8]);
					}
				}
			}
		}
		else if (Global_110725[iVar0 /*10*/].f_8 != -1)
		{
			if (iLocal_53[Global_110725[iVar0 /*10*/].f_8])
			{
				if (!MISC::IS_BIT_SET(Global_31146[iLocal_54[Global_110725[iVar0 /*10*/].f_8] /*23*/].f_11, 6))
				{
					func_77(iLocal_54[Global_110725[iVar0 /*10*/].f_8]);
				}
			}
		}
	}
...
void func_83(int iParam0)
{
	...
	if (MISC::IS_BIT_SET(Global_111638.f_18569[iParam0 /*6*/], 0) && !MISC::IS_BIT_SET(Global_111638.f_18569[iParam0 /*6*/], 3))
	{
		if (!Global_111638.f_18569[iParam0 /*6*/].f_1)
		{
			...
			Global_111638.f_18569[iParam0 /*6*/].f_2 = uVar1;
		...
		if (MISC::IS_BIT_SET(Global_111638.f_18569[iParam0 /*6*/], 1))
		{
			if (!MISC::IS_BIT_SET(Global_111638.f_18569[iParam0 /*6*/], 2))
			{
				...
				if (Var0.f_15 > 0 && bVar3)
				{
					...
					{
						func_122(Global_111638.f_18569[iParam0 /*6*/].f_2, &uVar4, &uVar5, &uVar6, &iVar7, &iVar8, &iVar9);
	...
	iVar14 = 0;
	if ((((iVar12 && !MISC::IS_BIT_SET(Global_111638.f_18569[iParam0 /*6*/], 3)) && MISC::IS_BIT_SET(Global_111638.f_18569[iParam0 /*6*/], 0)) && MISC::IS_BIT_SET(Global_111638.f_18569[iParam0 /*6*/], 1)) && MISC::IS_BIT_SET(Global_111638.f_18569[iParam0 /*6*/], 2))
	{
	...
	if (Global_110725[iParam0 /*10*/].f_7 != iVar14)
	{
		if (func_105(&(Global_110725[iParam0 /*10*/].f_8)))
		{
			...
			{
				iVar15 = iLocal_54[Global_110725[iParam0 /*10*/].f_8];
				if (iVar14 == 0)
				{
					func_3(iVar15, 0, 0);
					func_104(iVar15, 0);
			...
			Global_110725[iParam0 /*10*/].f_7 = iVar14;
		}
	}
...
void func_100(int iParam0, var uParam1)
{
	...
	Global_31143 = 1;
	Global_31146[iVar0 /*23*/].f_10 = uParam1;
	Global_37196 = 1;
	MISC::SET_BIT(&(Global_31146[iVar0 /*23*/].f_11), 18);
}
