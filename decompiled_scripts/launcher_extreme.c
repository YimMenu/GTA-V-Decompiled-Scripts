void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110725[Var0].f_9 != -1)
			{
				...
				func_284(&(Global_110725[Var0].f_9));
			}
		}
		func_272(&Var0, 1);
	}
	...
	while (true)
	{
		...
		else if (Var0 == 19)
		{
			...
			if ((((((!func_190() && func_189(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(uLocal_96)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", 0, -1))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_96, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_95 == 0 && func_189(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var61, Var0.f_15, Var0.f_15, Var0.f_15, 0, 0, 0))
			{
...
int func_157(int iParam0)
{
	...
	iVar0 = func_159(&(Global_110725[iParam0].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
var func_168(struct<3> Param0, int iParam3)
{
	...
	HUD::SET_BLIP_SCALE(uVar0, func_169(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_208(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_208(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_220(&(Local_37[iVar4]), Var1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
{
	Var0 = { func_225(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_189(PLAYER::PLAYER_PED_ID()) && func_189(uParam0))
	{
...
{
	Var0 = { func_225(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
...
int func_251(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -63.19179f, -808.9167f, 320.2477f };
			uParam0->f_17[1] = { -68.8908f, -813.6761f, 324.29f };
			uParam0->f_24 = 10f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_252(&(uParam0->f_28[0]), 52, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
					...
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_28[0], -72657034, 1, 0, 0);
