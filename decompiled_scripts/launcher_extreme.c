...
{
	if ((((func_189(PLAYER::PLAYER_PED_ID()) && func_189(iParam0->f_28[0])) && !func_190()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_195(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_208(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_208(uParam1) && uParam1->f_4 == 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
