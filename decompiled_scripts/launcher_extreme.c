...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		else if (Var0 == 19)
		{
			...
			if ((((((!func_190() && func_189(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(uLocal_56)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", 0, -1))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_56, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_55 == 0 && func_189(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var1, Var0.f_15, Var0.f_15, Var0.f_15, 0, 0, 0))
			{
...
var func_168(struct<3> Param0, int iParam1)
{
	var uVar0;
...
int func_191(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_189(PLAYER::PLAYER_PED_ID()) && func_189(iParam0->f_28[0])) && !func_190()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_195(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_245(var uParam0, struct<3> Param1, float fParam2)
{
	func_246(uParam0, iLocal_53, Param1, fParam2, 26);
...
void func_246(var uParam0, int iParam1, struct<3> Param2, var uParam3, int iParam4)
{
	func_247(uParam0);
