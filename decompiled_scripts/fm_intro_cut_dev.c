...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_1664231)
		{
			if (!Global_1664233)
			{
				Global_1664230 = unk_0x67D02A194A2FC2BD("OPENING_CREDITS");
				Global_1664233 = 1;
			}
			else if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_1664230))
			{
				if (!Global_1664232)
				{
...
{
	if (func_179(PLAYER::PLAYER_ID()) && MISC::IS_BIT_SET(Global_1678289.f_4, 22))
	{
		return 0;
	}
	if (Global_1315709)
