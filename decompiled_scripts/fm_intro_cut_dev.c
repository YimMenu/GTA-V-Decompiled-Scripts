void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_1662465)
		{
			if (!Global_1662467)
			{
				Global_1662464 = unk_0x67D02A194A2FC2BD("OPENING_CREDITS");
				Global_1662467 = 1;
			}
		...
		if (func_1(&uLocal_74, &(Local_63[0].f_4)))
		{
		}
	}
}
		...
		switch (uParam0->f_6)
		{
			case 0:
				...
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					*uParam0 = 0;
					...
					func_185(1, 0);
					func_161(1, 1);
					if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(-270023808) < 1 || !func_160())
					{
						if (uParam0->f_292)
						{
							if (func_159() == 0)
			...
			case 2:
				if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
				{
					...
					else if (AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_START") && (STREAMING::IS_NEW_LOAD_SCENE_LOADED() || func_134(&(uParam0->f_17), 5000, 0)))
					{
...
int func_128(var uParam0)
{
	...
	else
	{
		...
		STREAMING::REQUEST_MODEL(func_69());
		if ((STREAMING::HAS_MODEL_LOADED(-1903012613) && STREAMING::HAS_MODEL_LOADED(1349725314)) && STREAMING::HAS_MODEL_LOADED(func_69()))
		{
			iVar0 = 0;
			while (iVar0 < 15)
			{
...
void func_162(int iParam0)
{
	...
	if (Global_1312877)
	{
		...
		NETWORK::_NETWORK_TRANSITION_TRACK(uVar2, 1, uVar0, iParam0, 0);
	}
	if (iParam0 == 2)
	{
		func_163();
...
void func_190(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_188() == 1 || HUD::IS_PAUSE_MENU_ACTIVE()) || iParam0)
	{
		func_187(0);
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (bParam1)
			{
				...
				if (!func_201(uVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar27))
				{
					if (!bVar22)
					{
