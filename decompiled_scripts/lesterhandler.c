	...
	while (!MISC::IS_BIT_SET(iLocal_216, 1))
	{
		...
		else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_46, false))
			{
				...
				if (Global_77512 == 86)
				{
					if (!Global_112288 == 1 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 718.0749f, -976.0472f, 22.91482f, 718.0593f, -979.455f, 27.1191f, 5.75f, false, true, 0))
					{
						func_3(7, 1);
						Global_112284 = 0;
						Global_112288 = 1;
...
void func_23()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_26(Global_112293.f_2361.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_24(iVar0) && (!func_16(14) || Global_111244))
			{
