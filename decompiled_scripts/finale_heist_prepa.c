...
int func_58(int iParam0, struct<3> Param1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			...
			if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Param1, fParam12, fParam12, 2f, 0, 1, 2))
			{
				...
				{
					UI::CLEAR_THIS_PRINT(func_68(func_69()));
				}
				*iParam7 = 1;
	...
	else
	{
		...
		if (!*iParam8)
		{
			...
			{
				UI::CLEAR_THIS_PRINT(func_61(func_69(), 0));
			}
		...
		case 0:
			...
			else if (func_82(1, Local_361, 0))
			{
				if (((func_82(2, Local_456.f_1, Local_456.f_4) && func_82(4, Local_361, 0)) && func_82(3, Local_361, 0)) && func_82(5, Local_361, 0))
				{
					...
					{
						iVar0 = UI::GET_BLIP_FROM_ENTITY(Local_456);
		...
		case 1:
			if (bParam1)
			{
				if (((func_82(2, Local_456.f_1, Local_456.f_4) && func_82(4, Local_361, 0)) && func_82(3, Local_361, 0)) && func_82(5, Local_361, 0))
				{
					...
					GAMEPLAY::CLEAR_AREA_OF_PEDS(Local_389[0].f_1, 5f, 0);
					func_77();
					func_75();
					bLocal_28 = false;
					func_36(1, 1, 1);
...
void func_72()
{
	...
	iLocal_662 = 1;
	func_380(27, 0);
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_40554[13], 4, 1, 0);
	iLocal_663 = 0;
}
...
void func_73()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar0 <= (15 - 1))
		{
			GAMEPLAY::CLEAR_BIT(&(Local_389[iVar1].f_15), iVar0);
			iVar0++;
		}
...
void func_77()
{
	...
	while (iVar0 <= 2)
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[iVar0], false);
		if (!func_78(Local_389[iVar0], -1098463898))
		{
			switch (iVar0)
			{
				case 0:
				case 1:
					AI::TASK_START_SCENARIO_AT_POSITION(Local_389[iVar0], "WORLD_HUMAN_HANG_OUT_STREET", Local_389[iVar0].f_1, Local_389[iVar0].f_4, 0, 0, 1);
					break;
				
				case 2:
					AI::TASK_USE_MOBILE_PHONE(Local_389[iVar0], 1, 1);
					break;
				}
		}
		WEAPON::GIVE_WEAPON_TO_PED(Local_389[iVar0], 453432689, -1, 0, 0);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_389[iVar0], uLocal_481);
	...
	switch (iParam0)
	{
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				...
				{
					if (!PED::IS_PED_DEAD_OR_DYING(Global_95241.f_9[iVar0], 1))
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95241.f_9[iVar0], 1, 1);
						Local_389[iVar0] = Global_95241.f_9[iVar0];
						if (func_377(Local_389[iVar0]))
						{
							PED::SET_PED_TARGET_LOSS_RESPONSE(Local_389[iVar0], 2);
							AUDIO::STOP_PED_SPEAKING(Local_389[iVar0], 1);
							func_87(iVar0);
							iVar1++;
						}
					}
				...
				else if (func_86(&(Local_389[iVar0]), Local_389[iVar0].f_5, Local_389[iVar0].f_1, Local_389[iVar0].f_4, 0, 0, 0, 1))
				{
					...
					PED::SET_PED_NAME_DEBUG(Local_389[iVar0], &cVar2);
					iVar1++;
				}
				iVar0++;
			}
		...
		case 4:
			...
			while (iVar6 <= 3)
			{
				...
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95241[iVar6], 1, 1);
		...
		case 5:
			if (func_83(&uLocal_358, 798951501, 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1))
			{
				if (func_7(Local_456))
				{
...
void func_87(int iParam0)
{
	if (func_377(Local_389[iParam0]))
	{
		if (iParam0 == 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(Local_389[iParam0], 0, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_389[iParam0], 3, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_389[iParam0], 4, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_389[iParam0], 8, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_389[iParam0], 9, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_389[iParam0], 10, 0, 0, 0);
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(Local_389[iParam0], 0, 1, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_389[iParam0], 3, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_389[iParam0], 4, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_389[iParam0], 8, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_389[iParam0], 9, 2, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(Local_389[iParam0], 10, 0, 1, 0);
		}
	}
}
		...
		switch (*iParam2)
		{
			case 0:
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, 0))
				{
					...
					if (func_66(func_60(func_69()), 0, 0))
					{
						UI::CLEAR_THIS_PRINT(func_60(func_69()));
					}
					if (*iParam0 == iParam8)
					{
						*iParam2 = 1;
				...
				else
				{
					...
					{
						UI::CLEAR_THIS_PRINT(func_61(func_69(), bParam9));
					}
					if (func_69() != 33)
					{
						func_94(iParam0);
...
int func_107(int iParam0, int iParam1)
{
	...
	{
		case 0:
			AI::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, 0), Local_364, 4, 20f, 786469, 3.5f, 5f, 1);
			iLocal_83[iParam0] = 3;
			break;
...
int func_109(int iParam0, int iParam1)
{
	...
	{
		case 0:
			if (!GAMEPLAY::IS_POSITION_OCCUPIED(Local_300[iLocal_665], 1.5f, 0, 0, 1, 0, 0, iParam1, 0))
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam1, Local_300[iLocal_665], fVar0, 20000, 0.25f, 0, Local_300[iLocal_665].f_3);
				iLocal_83[iParam0] = 1;
			}
			break;
...
int func_111(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Local_456) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_456, 0)) && !ENTITY::IS_ENTITY_AT_COORD(Local_456, Local_364, 2f, 2f, 2f, 0, 1, 0))
		{
...
void func_119()
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_389[iVar0]) && !PED::IS_PED_INJURED(Local_389[iVar0]))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_389[iVar0], PLAYER::PLAYER_PED_ID(), 1))
			{
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_389[iVar0]);
				if (((WEAPON::IS_PED_CURRENT_WEAPON_SILENCED(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_BEING_STEALTH_KILLED(Local_389[iVar0])) || PED::WAS_PED_KILLED_BY_STEALTH(Local_389[iVar0])) || PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_389[iVar0]))
				{
					if (!bLocal_374)
					{
...
void func_120(int iParam0)
{
	switch (Local_389[iParam0].f_20)
	{
		case 1:
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 1500)
				{
					if (!func_78(Local_389[iParam0], -875674219))
					{
						PED::_0xF1C03A5352243A30(Local_389[iParam0]);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_389[iParam0], PLAYER::PLAYER_PED_ID(), 0);
					}
					Local_389[iParam0].f_14 = GAMEPLAY::GET_GAME_TIMER();
				}
			}
			else
			{
		...
		case 2:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 6000)
			{
				if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 2))
				{
					func_127(iParam0);
					func_125();
					return;
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 8))
				{
					Local_389[iParam0].f_17 = 1;
				}
				else
		...
		case 4:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 8))
				{
					...
					else if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 9) && !bLocal_372)
					{
						func_127(iParam0);
						func_125();
						return;
		...
		case 6:
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0].f_14) > iVar0)
			{
				if (!PED::IS_PED_BEING_STUNNED(Local_389[iParam0], 0) && !AI::IS_PED_IN_WRITHE(Local_389[iParam0]))
				{
					Local_389[iParam0].f_14 = GAMEPLAY::GET_GAME_TIMER();
					func_127(iParam0);
				}
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 3000)
			{
				func_125();
				return;
			}
		...
		case 7:
			if ((GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0].f_14) > 350)
			{
				if (!bLocal_374 && func_124(iParam0, 15))
				{
					func_73();
					func_134(iParam0);
					UI::_0xC594B315EDF2D4AF(Local_389[iParam0]);
					return;
				}
				else
				{
					...
					if ((func_78(Local_389[iParam0], -2128726980) || func_78(Local_389[iParam0], -982327190)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 2)
					{
						if (!func_78(Local_389[iParam0], 1392476864))
						{
							AI::TASK_ARREST_PED(Local_389[iParam0], PLAYER::PLAYER_PED_ID());
						}
					}
				}
			}
			if (!iLocal_658)
			{
				if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 1) && GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 14))
				{
					if (iParam0 == 0)
					{
						sVar3 = "PRA_COPSHT1";
...
void func_123(int iParam0)
{
	...
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[0], false);
	}
	if (func_377(Local_389[1]))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[1], false);
	}
	if (func_377(Local_389[2]))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[2], false);
	}
	if (iParam0 != -1)
	{
...
int func_124(int iParam0, int iParam1)
{
	...
	while (iVar0 <= 14)
	{
		if (iVar0 != iParam1)
		{
			if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, iVar0))
			{
				return 0;
			}
		}
...
void func_125()
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			func_195(&(Local_389[iVar0].f_6));
			Local_389[iVar0].f_14 = GAMEPLAY::GET_GAME_TIMER();
...
void func_127(int iParam0)
{
	if (Local_389[iParam0].f_20 != 7)
	{
		if (func_377(Local_389[iParam0]))
		{
			if (func_78(Local_389[iParam0], 242628503) || PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(Local_389[iParam0]))
			{
				AI::CLEAR_PED_TASKS(Local_389[iParam0]);
			}
			else if (func_78(Local_389[iParam0], -1098463898) || func_78(Local_389[iParam0], 993674639))
			{
				PED::_0xF1C03A5352243A30(Local_389[iParam0]);
			}
			PED::SET_PED_AS_COP(Local_389[iParam0], 1);
			AI::TASK_ARREST_PED(Local_389[iParam0], PLAYER::PLAYER_PED_ID());
			WEAPON::GIVE_WEAPON_TO_PED(Local_389[iParam0], 453432689, -1, 0, 1);
			ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_389[iParam0]);
			PLAYER::_0xBC9490CA15AEA8FB(PLAYER::PLAYER_ID());
			func_128(iParam0);
...
{
	if ((iLocal_80 != 2 && !iLocal_659) && !ENTITY::IS_ENTITY_DEAD(Local_389[iParam0], 0))
	{
		if (func_133(iParam0) && func_131(Local_389[iParam0], 30f))
		{
			...
			if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 3))
			{
				iLocal_659 = 1;
			}
			else if (!func_124(iParam0, 15) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0))
			{
				func_129();
				iLocal_656 = 0;
				if (iParam0 == 2)
				...
				{
					AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_389[iParam0], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", 0);
				}
				iLocal_659 = 1;
			}
		}
...
void func_134(int iParam0)
{
	...
	{
		AI::CLEAR_PED_TASKS(Local_389[iParam0]);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_389[iParam0], uLocal_481);
		if (iParam0 == 2)
		{
			AI::OPEN_SEQUENCE_TASK(&uVar0);
			if (!func_63(Local_389[iParam0], Local_389[iParam0].f_1, 3f))
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_389[iParam0].f_1, 1f, 120000, 0.25f, 0, Local_389[iParam0].f_4);
			}
			else
			{
				AI::TASK_ACHIEVE_HEADING(0, Local_389[iParam0].f_4, 0);
			}
			...
			AI::TASK_PERFORM_SEQUENCE(Local_389[iParam0], uVar0);
		...
		func_135();
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[iParam0], false);
...
void func_135()
{
	if (func_12(&uLocal_92, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
	{
		if (!func_103())
		{
			if ((!GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_666, "NONE") && !GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_672, "NONE")) && !func_66("PR_TAKBACK", 0, 0))
			{
...
void func_151(int iParam0)
{
	switch (Local_389[iParam0].f_21)
	{
		case 0:
			if (func_103())
			{
				if (PED::IS_PED_BEING_STEALTH_KILLED(Local_389[iParam0]))
				{
					func_129();
				}
			}
			...
			{
				if (iLocal_648[2] && !AUDIO::IS_PED_IN_CURRENT_CONVERSATION(Local_389[iParam0]))
				{
					AI::CLEAR_PED_TASKS(Local_389[iParam0]);
					AI::TASK_START_SCENARIO_IN_PLACE(Local_389[iParam0], "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				}
			}
			break;
...
void func_152(int iParam0)
{
	...
	if (!func_173(iParam0))
	{
		if (func_154(Local_389[iParam0], 1, 50f, 140f, 0, 1, 1, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_389[iParam0], 1), 100f))
		{
			if ((!PED::IS_PED_BEING_STEALTH_KILLED(Local_389[iParam0]) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_389[iParam0])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_389[iParam0]))
			{
				func_125();
			}
			else if (!bLocal_374)
	...
	else if (func_153(Local_389[iParam0], PLAYER::PLAYER_PED_ID(), 5f, 1))
	{
		if (!bLocal_374)
		{
			PLAYER::_SWITCH_CRIME_TYPE(PLAYER::PLAYER_ID(), 41);
...
bool func_157(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_158(&(Local_38[iVar4]), Var1, iParam1, &(Local_38[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (GAMEPLAY::GET_GAME_TIMER() - Local_38[iVar4].f_3) < iParam4);
}
...
{
	Var0 = { func_163(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
{
	Var0 = { func_163(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_389[iParam0], 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
	{
		return 1;
	}
	return 0;
...
void func_174(int iParam0)
{
	...
	{
		if (((!bLocal_372 && !PED::IS_PED_BEING_STEALTH_KILLED(Local_389[iParam0])) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_389[iParam0])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_389[iParam0]))
		{
			func_175(iParam0);
		}
	}
...
void func_177(int iParam0, int iParam1, int iParam2)
{
	if (!func_149(iParam0) || iParam2)
	{
		...
		{
			if (Local_389[func_150(iParam0)].f_20 != 3 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 9))
				{
					if (iParam0 == 0)
					{
						sVar0 = "PRA_CWCAR1";
		...
		{
			if (Local_389[func_150(iParam0)].f_20 != 4 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (!bLocal_373)
				{
					if (iParam0 == 0)
		...
		else if (iParam1 == 5)
		{
			if (Local_389[func_150(iParam0)].f_20 != 5)
			{
				if (iParam0 == 0)
				{
					...
					AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_389[iParam0], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", 0);
				}
				else if (iParam0 == 1)
				{
		...
		Local_389[iParam0].f_14 = GAMEPLAY::GET_GAME_TIMER();
		Local_389[func_150(iParam0)].f_14 = GAMEPLAY::GET_GAME_TIMER();
...
void func_178(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	if (bParam3)
	{
		if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 12))
		{
			return;
		}
	}
	...
	if ((!GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, sParam1) && !func_66("PR_TAKBACK", 0, 0)) && !func_66("PR_GOVEH", 0, 0))
	{
		func_179();
		func_121(&uLocal_483, cLocal_482, sParam1, 7, 0, 0);
		if (bParam2)
...
void func_182(int iParam0, int iParam1, int iParam2)
{
	if (!func_149(iParam0) || iParam2)
	{
		if (iParam1 == 1)
		{
			if (Local_389[iParam0].f_19 != 1 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (!bLocal_372)
				{
					if (iParam0 == 0)
		...
		{
			if (Local_389[iParam0].f_19 != 2 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPPLY1";
		...
		{
			if (Local_389[iParam0].f_19 != 4 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPST1";
		...
		else if (iParam1 == 5)
		{
			if (Local_389[iParam0].f_19 != 5)
			{
				...
				AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_389[iParam0], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", 0);
				func_183(iParam0, iParam1, 0);
			}
		}
		else if (iParam1 == 7)
		...
		if (bLocal_372)
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 12))
			{
				GAMEPLAY::SET_BIT(&(Local_389[iParam0].f_15), 12);
			}
		}
	}
}
...
void func_184(int iParam0)
{
	if ((!func_149(iParam0) && Local_389[iParam0].f_20 != 6) && Local_389[iParam0].f_20 != 7)
	{
		...
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_382)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 340.0758f, -1598.255f, 28.29322f, 346.4939f, -1603.684f, 38.29278f, 6.22f, 0, 1, 0))
				{
					...
					else if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 11))
					{
						if ((((fVar0 > 16f && !Local_389[iParam0].f_16) && !GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 10)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_389[iParam0], Local_309[1], Local_309[1].f_3, Local_309[1].f_6, 0, 1, 0))
						{
							func_186(iParam0, 11);
							return;
						}
				...
				if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[1], Local_309[1].f_3, Local_309[1].f_6, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_389[iParam0], Local_309[1], Local_309[1].f_3, Local_309[1].f_6, 0, 1, 0)) && !GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 10)) && !GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 11))
				{
					if ((fVar0 > 12f && !Local_389[iParam0].f_16) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0))
					{
						func_186(iParam0, 11);
					}
				}
		...
		else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[5], Local_309[5].f_3, Local_309[5].f_6, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_389[iParam0], Local_309[5], Local_309[5].f_3, Local_309[5].f_6, 0, 1, 0))
		{
...
{
	if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, iParam1))
	{
		GAMEPLAY::CLEAR_BIT(&(Local_389[iParam0].f_15), iParam1);
		Local_389[iParam0].f_17 = 1;
	}
}
...
void func_186(int iParam0, int iParam1)
{
	if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, iParam1))
	{
		GAMEPLAY::SET_BIT(&(Local_389[iParam0].f_15), iParam1);
		Local_389[iParam0].f_17 = 1;
	}
}
...
void func_187(int iParam0)
{
	...
	{
		bVar0 = false;
		if (((func_153(Local_389[iParam0], PLAYER::PLAYER_PED_ID(), 5f, 1) && !PED::IS_PED_BEING_STEALTH_KILLED(Local_389[iParam0])) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_389[iParam0])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_389[iParam0]))
		{
	...
	else if (!func_153(Local_389[iParam0], PLAYER::PLAYER_PED_ID(), 5.5f, 1))
	{
		func_185(iParam0, 5);
		func_185(iParam0, 3);
	}
...
int func_188(int iParam0)
{
	...
	if (Local_389[iParam0].f_20 != 7)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_389[iParam0], 1f, -1f, 0f), 1f, 1f, 2f, 0, 1, 0))
		{
			return 1;
		}
	}
...
{
	if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(Local_389[iParam0], PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_RAGDOLL(Local_389[iParam0]))
		{
			*iParam1 = 1;
		}
		else
...
void func_190(int iParam0)
{
	if (Local_389[iParam0].f_20 != 6 && Local_389[iParam0].f_20 != 7)
	{
		...
		while (iVar0 <= 5)
		{
			if (Local_389[iParam0].f_16)
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 12))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[iVar0], Local_309[iVar0].f_3, Local_309[iVar0].f_6, 0, 1, 0))
					{
						iLocal_382 = 1;
						iLocal_381 = GAMEPLAY::GET_GAME_TIMER();
						if (iVar0 == 4)
			...
			else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[iVar0], Local_309[iVar0].f_3, Local_309[iVar0].f_6, 0, 1, 0) || GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 12))
			{
				func_191(iParam0, iVar0);
			}
			iVar0++;
	...
	else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[3], Local_309[3].f_3, Local_309[3].f_6, 0, 1, 0))
	{
		func_193(iParam0, 3);
	}
	else
		...
		case 4:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				if (func_7(iVar0))
				{
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, Local_309[4], Local_309[4].f_3, Local_309[4].f_6, 0, 1, 0))
					{
						func_185(iParam0, 8);
						func_185(iParam0, 7);
					}
					else if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 7))
					{
						func_186(iParam0, 7);
					}
				}
...
void func_193(int iParam0, int iParam1)
{
	...
	{
		case 1:
			if ((!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 6) && !GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 1)) && !GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 9))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 10))
				{
					func_186(iParam0, 10);
				}
			}
		...
		case 2:
			if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 1))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 6))
				{
					func_186(iParam0, 6);
				}
			}
		...
		case 3:
			if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 14))
			{
				func_186(iParam0, 14);
			}
			break;
		...
		case 4:
			if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 8))
			{
				...
				{
					GAMEPLAY::SET_BIT(&(Local_389[iParam0].f_15), 9);
					func_186(iParam0, 8);
				}
				else
				{
					GAMEPLAY::CLEAR_BIT(&(Local_389[iParam0].f_15), 9);
					func_186(iParam0, 8);
				}
			}
			break;
		...
		case 5:
			if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 4))
			{
				if ((!PED::IS_PED_BEING_STEALTH_KILLED(Local_389[iParam0]) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_389[iParam0])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_389[iParam0]))
				{
					func_186(iParam0, 4);
...
{
	if (func_153(PLAYER::PLAYER_PED_ID(), Local_389[iParam0], 30f, 1))
	{
		if (func_157(Local_389[iParam0], PLAYER::PLAYER_PED_ID(), 140f, 1, 250, 7))
		{
...
void func_197()
{
	...
	while (iVar0 <= 1)
	{
		...
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_389[iVar0]))
			{
				if (func_7(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_389[iVar0], PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1))
					{
						ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_389[iVar0]);
						func_125();
					}
	...
	switch (Local_389[iParam0].f_19)
	{
		case 1:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				...
				{
					if ((GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 13) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_376) > 2500) && !iLocal_661)
					{
						if (iParam0 == 0)
						{
							sVar0 = "PRA_COPST1";
						...
						func_121(&uLocal_483, cLocal_482, sVar0, 7, 0, 0);
						GAMEPLAY::CLEAR_BIT(&(Local_389[iParam0].f_15), 13);
						GAMEPLAY::CLEAR_BIT(&(Local_389[func_150(iParam0)].f_15), 13);
						iLocal_661 = 1;
					}
					Local_389[iParam0].f_17 = 1;
				}
		...
		case 2:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1500, 2000)
			{
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (!func_153(Local_389[iParam0], PLAYER::PLAYER_PED_ID(), 1.5f, 1))
				{
					GAMEPLAY::CLEAR_BIT(&(Local_389[iParam0].f_15), 5);
				}
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
		...
		case 7:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				...
				if (((fVar1 < 12f && !Local_389[iParam0].f_16) && !GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 10)) && !func_78(Local_389[iParam0], -875674219))
				{
					GAMEPLAY::CLEAR_BIT(&(Local_389[iParam0].f_15), 11);
				}
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
...
void func_201(int iParam0)
{
	if (!iLocal_661)
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 13))
		{
			if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 10))
			{
				if (Local_389[iParam0].f_16)
		...
		else if (func_133(iParam0))
		{
			if (bVar0)
			{
				if (!func_153(PLAYER::PLAYER_PED_ID(), Local_389[iParam0], 10f, 1))
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 10) && !GAMEPLAY::IS_BIT_SET(Local_389[iParam0].f_15, 6))
					{
						GAMEPLAY::CLEAR_BIT(&(Local_389[iParam0].f_15), 13);
					}
				}
...
void func_202(int iParam0)
{
	...
	if (Local_389[iParam0].f_20 != 6 && Local_389[iParam0].f_20 != 7)
	{
		if (func_153(PLAYER::PLAYER_PED_ID(), Local_389[iParam0], 12f, 1))
		{
			if (bVar0)
			{
				if (Local_389[iParam0].f_16)
...
void func_203(int iParam0)
{
	if (!func_173(iParam0))
	{
		...
		else if (func_154(Local_389[iParam0], 1, 70f, 150f, 0, 1, 0, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_389[iParam0], 1), 100f))
		{
			func_125();
		}
...
int func_204(int iParam0)
{
	if (func_377(Local_389[iParam0]))
	{
		...
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_389[iParam0], fVar0, fVar0, fVar0, 0, 1, 0))
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_389[iParam0]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_389[iParam0]))
			{
				if (Local_389[iParam0].f_16)
				{
					return 1;
...
void func_205()
{
	...
	{
		if ((((func_377(Local_389[0]) && func_377(Local_389[1])) && func_12(&uLocal_92, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))) && func_63(Local_389[0], Local_389[0].f_1, 3f)) && func_63(Local_389[1], Local_389[1].f_1, 3f))
		{
		...
		else if ((func_377(Local_389[2]) && func_12(&uLocal_144, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))) && func_63(Local_389[2], Local_389[2].f_1, 3f))
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_389[2].f_15, 2) && !GAMEPLAY::IS_BIT_SET(Local_389[2].f_15, 4))
			{
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_71(iLocal_80, bLocal_28))
			{
				...
				if (OBJECT::_DOES_DOOR_EXIST(Global_40554[13]))
				{
					AUDIO::_0x06C0023BED16DD6B(Global_40554[13], 1);
				}
				iLocal_678 = 0;
...
var func_246()
{
	func_256(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_255(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_254(&uVar0, TIME::GET_CLOCK_HOURS());
	func_249(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_248(&uVar0, TIME::GET_CLOCK_MONTH());
	func_247(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_252(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_273(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_274(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_274(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_279(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_279(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_279(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_279(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_279(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_274(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_287(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
...
int func_287(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_274(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_291(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_291(Var16.z)] = func_287(iParam1, Var16.x, func_291(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_291(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_299(func_298(iParam1, uParam0->f_2), Global_76431, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_299(iVar1, Global_76431, 0);
				if (!GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_299(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0][func_300(iParam1)];
...
void func_306(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_296(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_296(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_274(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_385()
{
	...
	{
		OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_369, -1156020871, 391.8602f, -1636.07f, 29.9744f, 1, 1, 0);
	}
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_40554[13], 1, 1, 0);
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(iLocal_369, 1, 1, 0);
}

void func_386()
{
	Var0[0] = { 331.7678f, -1596.396f, 31.53864f };
	Var0[1] = { 348.4934f, -1576.657f, 31.83304f };
	Var0[2] = { 356.2655f, -1567.396f, 28.29265f };
	Var0[3] = { 368.4805f, -1576.274f, 28.26307f };
	Var0[4] = { 364.8242f, -1580.737f, 28.29278f };
	Var0[5] = { 350.2896f, -1606.614f, 28.29278f };
	Var0[6] = { 346.1393f, -1608.523f, 31.53354f };
	func_390(&uLocal_92, &Var0, 7);
	Var0[0] = { 353.657f, -1613.421f, 28.29278f };
	Var0[1] = { 391.3156f, -1601.633f, 28.29278f };
	Var0[2] = { 397.667f, -1607.168f, 28.29278f };
	Var0[3] = { 376.649f, -1633.096f, 26.96452f };
...
void func_391()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar2 <= (15 - 1))
		{
			GAMEPLAY::CLEAR_BIT(&(Local_389[iVar1].f_15), iVar2);
			iVar2++;
		}
		iVar1++;
	}
...
void func_396()
{
	...
	if (OBJECT::_DOES_DOOR_EXIST(Global_40554[13]))
	{
		AUDIO::_0x06C0023BED16DD6B(Global_40554[13], 0);
	}
	OBJECT::_SET_DOOR_AJAR_ANGLE(Global_40554[13], 0f, 1, 1);
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_40554[13], 4, 1, 1);
...
void func_403()
{
	...
	while (iVar0 <= 2)
	{
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_462[iVar0].f_5);
		iVar0++;
	}
}
