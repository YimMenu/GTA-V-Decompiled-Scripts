...
void func_72()
{
	...
	iLocal_662 = 1;
	func_380(27, 0);
	OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_41132[13 /*31*/], 4, true, false);
	iLocal_663 = 0;
}
	...
	switch (iParam0)
	{
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				...
				{
					if (!PED::IS_PED_DEAD_OR_DYING(Global_95867.f_9[iVar0], true))
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95867.f_9[iVar0], true, true);
		...
		case 4:
			...
			while (iVar6 <= 3)
			{
				...
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95867[iVar6], true, true);
...
int func_111(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Local_456) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_456, false)) && !ENTITY::IS_ENTITY_AT_COORD(Local_456, Local_364, 2f, 2f, 2f, false, true, 0))
		{
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_71(iLocal_80, bLocal_28))
			{
				...
				{
					AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Global_41132[13 /*31*/], true);
				}
				iLocal_678 = 0;
...
int func_273(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_77059[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_274(iParam1)) && Global_77059[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_274(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_279(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 8, -1, false, -1, func_274(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_287(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 8, -1, false, -1, func_274(iParam2));
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_299(func_301(iParam1, uParam0->f_2), Global_77056, 0);
...
int func_299(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12074)
	{
		...
		iVar0 = Global_2555716[iParam0 /*3*/][func_300(iParam1)];
...
void func_306(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_296(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77229)
		{
			...
			func_296(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 8, -1, false, -1, func_274(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_385()
{
	...
	OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_41132[13 /*31*/], 1, true, false);
