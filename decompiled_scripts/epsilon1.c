...
void func_1()
{
	...
	switch (iLocal_145)
	{
		case 0:
			...
			if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_151, "DEFAULT"))
			{
				func_349(1);
			}
			else
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_87(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_87(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_98(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_98(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_87(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_178()
{
	...
	{
		func_167();
		GRAPHICS::_0xBF59707B3E5ED531(func_179(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
		...
		case 0:
			...
			if (func_214(iLocal_147))
			{
				...
				if (func_214(iLocal_150))
				{
					...
					AI::TASK_WARP_PED_INTO_VEHICLE(iLocal_147, iLocal_150, -1);
			...
			if (func_214(PLAYER::PLAYER_PED_ID()))
			{
				AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_152, "back_armsdown", 1000f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (func_214(iLocal_150))
				{
					if (func_240(iLocal_147, iLocal_150, -1))
					{
						if (iLocal_329)
						{
							...
							{
								AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_147, iLocal_150, fLocal_324, 786599);
	...
	switch (iLocal_145)
	{
		case 0:
			...
			if (func_281(1, 1093140480, 0))
			{
				...
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-1630.38f, 4200.79f, 83.01f, 70f, 0, 0, 0, 0, 0, 0);
				iLocal_145 = 1;
			}
			break;
...
void func_268(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_269(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_292()
{
	...
	while (((!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_152) || !UI::HAS_ADDITIONAL_TEXT_LOADED(0)) || !STREAMING::HAS_MODEL_LOADED(iLocal_149)) || !STREAMING::HAS_MODEL_LOADED(iLocal_148))
	{
		SYSTEM::WAIT(0);
	}
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar72)
			{
				if (iVar8 < 51)
				{
					...
					{
						if (!DLC1::_IS_DLC_DATA_EMPTY(Var9) && !func_296(Var9.f_1))
						{
							if (iVar7 == 0)
							{
...
void func_339(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	if (iVar0 != 0)
	{
		unk_0x9FE5633880ECD8ED(uParam0, iParam1, iVar0, uParam3);
	}
}
...
int func_342(int iParam0)
{
	...
	while (iVar0 < DLC1::GET_NUM_DLC_WEAPONS())
	{
		if (DLC1::GET_DLC_WEAPON_DATA(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (DLC1::_IS_DLC_DATA_EMPTY(Var1) || func_296(Var1.f_1))
				{
					return 0;
				}
			}
