...
int func_7(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar2 = 0;
		func_13(&iVar2);
		iVar3 = func_12(Var1, Global_111638.f_7683.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_10(Global_111638.f_7683.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_8(Global_111638.f_7683.f_765[iVar2 /*10*/]))
				{
					Global_111638.f_7683.f_765[iVar2 /*10*/] = { Var1 };
					func_9(&Var1);
					return 1;
...
int func_44(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_76434[1 /*14*/] = { func_95(iVar0, iParam1, uVar6[iParam1], -1) };
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &Var2) && Var2.z != -1)
				{
					...
					{
						(*iParam0)[Var2.z] = func_70(iParam1, Var2.x, 14, iVar0);
					}
					else if (Var2.y != -1)
					{
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.x != 0 && Var2.x != -1) && Var2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_93(Var2.z)] = Var2.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_93(Var2.z)] = func_70(iParam1, Var2.x, func_93(Var2.z), iVar0);
					}
				}
				else if (Var2.y != -1)
				{
					(*uParam0)[func_93(Var2.z)] = Var2.y;
				}
			}
			iVar4++;
		}
...
void func_172(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_173(&uVar1, Var0.f_3, Global_98781, iParam1, iParam2);
	}
}
...
void func_215()
{
	...
	switch (iLocal_83)
	{
		case 0:
			...
			func_242(PLAYER::PLAYER_PED_ID(), Local_256, 201.2074f, 0, 1);
	...
	if (Global_76876 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_302(Global_76877, Global_76879, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_318(var uParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_319(uParam0);
		...
		while (iVar1 <= (8 - 1))
		{
			...
			if (bParam2)
			{
				if (iVar1 == Global_111638.f_2358.f_539.f_1763 || (Global_111638.f_2358.f_539.f_1763 == -1 && iVar1 == 4))
				{
					...
					{
						if (WEAPON::HAS_PED_GOT_WEAPON(iParam0, Global_111638.f_2358.f_539.f_1730[iVar1 /*4*/][iVar0], 0))
						{
							WEAPON::SET_CURRENT_PED_WEAPON(iParam0, Global_111638.f_2358.f_539.f_1730[iVar1 /*4*/][iVar0], 1);
						}
					}
				}
			}
