...
int func_233(var uParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4)
{
	...
	func_234(uParam0, iLocal_81, Param1, fParam2);
	if (func_309(*uParam0))
	{
...
void func_234(var uParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_235(uParam0);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_299(24) != Global_102203.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_296(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_252(Global_102203.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}

void func_252(int iParam0, struct<3> Param1, var uParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_286(iParam3, &Var0, Param1, uParam2, func_289(iParam0));
...
void func_286(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4)
{
	if (func_283(&(Global_75441.f_555[0 /*21*/]), iParam0))
	{
	...
	if (Global_76876 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_320(Global_76877, Global_76879, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
int func_341(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_342(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
...
int func_342(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
