		...
		if (bParam2)
		{
			if (!Global_77248)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8327[iParam1 /*4*/] = { func_205(iParam0) };
					...
					{
						Global_8278[1 /*6*/] = { func_205(iParam0) };
				...
				case 2:
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						if (func_309(Local_96.f_35[0]))
						{
							...
							if (func_309(Local_96.f_28[0]))
							{
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_96.f_28[0], 1862763509);
							...
							if (func_309(Local_96.f_28[1]))
							{
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_96.f_28[1], 1862763509);
...
void func_251(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102858.f_4))
	{
		...
		{
			if (func_299(24) != Global_102858.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_296(ENTITY::GET_ENTITY_COORDS(Global_102858.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_252(Global_102858.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_253(int iParam0, int iParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_112293.f_32747.f_4801 = func_272();
			}
...
void func_254(int iParam0, int iParam1)
{
	...
	func_291(iParam0, &(Global_112293.f_32747.f_5510));
}
...
int func_283(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_290(Global_112293.f_32747.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_290(Global_112293.f_2361.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_290(Global_112293.f_2361.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_286(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_283(&(Global_76066.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_288(iParam0);
			func_287(uParam1, &(Global_112293.f_32747.f_69[Global_76066.f_555[0 /*21*/].f_14 /*78*/]));
	...
	if (Global_77502 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_320(Global_77503, Global_77505, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_332(0) || Global_77517) || Global_77506 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77502)
...
{
	return func_334(iParam0, Global_42009);
}
...
int func_366()
{
	...
	iVar0 = func_367(&(Global_99370.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_370()
{
	...
	{
		if (func_365(&(Global_99370.f_3)) > -1)
		{
			return 1;
		}
	}
