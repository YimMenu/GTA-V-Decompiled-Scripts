		...
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1] = { func_205(iParam0) };
					...
					{
						Global_7966[1] = { func_205(iParam0) };
...
int func_233(var uParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6)
{
	...
	func_234(uParam0, iLocal_83, Param1, fParam4);
	if (func_309(*uParam0))
	{
...
void func_234(var uParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_235(uParam0);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_299(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_296(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_252(Global_102203.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_252(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_286(iParam5, &Var0, Param1, uParam4, func_289(iParam0));
...
void func_253(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_283(&(Global_75441.f_555[0]), iParam0))
	{
		return;
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_278(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_283(var uParam0, int iParam1)
{
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_290(Global_111638.f_32744.f_1864[uParam0->f_14], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_290(Global_111638.f_2358.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_290(Global_111638.f_2358.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, 0))
		{
...
void func_286(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6)
{
	if (func_283(&(Global_75441.f_555[0]), iParam0))
	{
		...
		{
			func_288(iParam0);
			func_287(uParam1, &(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]));
...
int func_303(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((((((((((((((func_304(Var18[0], Var18[1], Var6, Var9) || func_304(Var18[0], Var18[1], Var9, Var15)) || func_304(Var18[0], Var18[1], Var12, Var15)) || func_304(Var18[0], Var18[1], Var6, Var12)) || func_304(Var18[1], Var18[3], Var6, Var9)) || func_304(Var18[1], Var18[3], Var9, Var15)) || func_304(Var18[1], Var18[3], Var12, Var15)) || func_304(Var18[1], Var18[3], Var6, Var12)) || func_304(Var18[3], Var18[2], Var6, Var9)) || func_304(Var18[3], Var18[2], Var9, Var15)) || func_304(Var18[3], Var18[2], Var12, Var15)) || func_304(Var18[3], Var18[2], Var6, Var12)) || func_304(Var18[2], Var18[0], Var6, Var9)) || func_304(Var18[2], Var18[0], Var9, Var15)) || func_304(Var18[2], Var18[0], Var12, Var15)) || func_304(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_310(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_315(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_315(int iParam0, var uParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	switch (iParam0)
	{
		...
		case 39:
			if (bParam1)
			{
				...
				MISC::CLEAR_AREA_OF_VEHICLES(-1035.73f, 365.44f, 68.91f, 27f, 0, 0, 0, 0, 0, 0);
...
int func_341(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_342(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
...
int func_342(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	if (!func_152(iParam1))
	{
