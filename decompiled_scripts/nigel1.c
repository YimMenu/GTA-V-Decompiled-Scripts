					...
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						if (func_309(Local_96.f_35[0]))
						{
							...
							if (func_309(Local_96.f_28[0]))
							{
								...
								AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_96.f_28[0]);
							...
							if (func_309(Local_96.f_28[1]))
							{
								...
								AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_96.f_28[1]);
							...
							AI::TASK_VEHICLE_DRIVE_WANDER(Local_96.f_28[0], Local_96.f_35[0], 20f, 786603);
						}
...
void func_248(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_249(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
var func_272()
{
	func_282(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_281(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_280(&uVar0, TIME::GET_CLOCK_HOURS());
	func_275(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_274(&uVar0, TIME::GET_CLOCK_MONTH());
	func_273(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_278(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_292(iVar0 + 1));
			}
			iVar0++;
		}
