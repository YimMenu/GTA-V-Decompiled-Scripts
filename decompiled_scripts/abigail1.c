	...
	switch (iLocal_153)
	{
		case 0:
			...
			if (func_303(iLocal_149))
			{
				...
				{
					AI::TASK_PLAY_ANIM(iLocal_149, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0, 0, 0, 0);
		...
		case 4:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				{
					AI::CLEAR_PED_TASKS(iLocal_149);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_149, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 1048576000, 0, 1193033728);
				}
			}
			else
			{
				iLocal_152 = GAMEPLAY::GET_GAME_TIMER() + 10000;
				iLocal_153++;
			}
			break;
		
		case 5:
			if ((iLocal_155 == 0 && CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 4) && GAMEPLAY::GET_GAME_TIMER() > (iLocal_152 - 300))
			{
				GRAPHICS::_START_SCREEN_EFFECT("CamPushInNeutral", 0, 0);
				AUDIO::PLAY_SOUND_FRONTEND(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 1);
				iLocal_155 = 1;
			}
			if (func_224(1000) || GAMEPLAY::GET_GAME_TIMER() > iLocal_152)
			{
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_76(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_59(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_76(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_87(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_87(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_76(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_167()
{
	...
	{
		func_156();
		GRAPHICS::_0xBF59707B3E5ED531(func_168(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
...
var func_254()
{
	func_264(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_263(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_262(&uVar0, TIME::GET_CLOCK_HOURS());
	func_257(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_256(&uVar0, TIME::GET_CLOCK_MONTH());
	func_255(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_260(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_343(bool bParam0)
{
	...
	if (!func_360())
	{
		...
		{
			func_161(iVar0, 1, 0);
			func_344(get_this_script_name(), iVar0);
		}
		else
		{
...
int func_345(char* sParam0, int iParam1, int iParam2)
{
	...
	func_354(0);
	func_353(1);
	clear_bit(&(Global_98744.f_20), 9);
	clear_bit(&(Global_98744.f_20), 6);
	clear_bit(&(Global_98744.f_20), 20);
	clear_bit(&(Global_98744.f_20), 21);
	clear_bit(&(Global_98744.f_20), 5);
	...
	if (func_351())
	{
		if (func_350())
		{
			if (Global_98781 >= func_347())
			{
				if (!is_bit_set(Global_89532[iParam2 /*34*/].f_15, 16))
				{
		...
		{
			iVar2 = func_346(get_this_script_name());
			if (iVar2 > -1)
			{
...
void func_353(int iParam0)
{
	...
	{
		_0xFDB423997FA30340();
		set_bit(&(Global_98744.f_20), 3);
	}
	else if (is_bit_set(Global_98744.f_20, 3))
	{
		_0xE1CD1E48E025E661();
		clear_bit(&(Global_98744.f_20), 3);
	}
}
...
void func_354(int iParam0)
{
	if (iParam0 == 1)
	{
		if (is_bit_set(Global_98744.f_20, 4))
		{
			func_356();
			clear_bit(&(Global_98744.f_20), 4);
		}
	}
	else
	{
		func_355();
		set_bit(&(Global_98744.f_20), 4);
	}
}
...
void func_361()
{
	...
	{
		if (is_string_null_or_empty(&Global_76854))
		{
			switch (func_209())
			{
				case 0:
