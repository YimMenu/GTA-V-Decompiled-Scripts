void __EntryFunction__()
{
	...
	if (func_521())
	{
		...
		switch (iVar0)
		{
			case 0:
				...
				{
					func_447(&iLocal_713, 225.012f, 2310.695f, 77.257f, 218.1301f, 0, 0, 0, 0, 0, -1903012613, 0, 145, 1);
				}
				else
				{
					func_447(&iLocal_713, 232.0044f, 2314.844f, 76.9871f, 173.0429f, 0, 0, 0, 0, 0, -1903012613, 0, 145, 1);
				}
			...
			case 1:
				func_447(&iLocal_713, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, -1903012613, 0, 145, 1);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			Local_692 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
			func_421();
			func_420();
			switch (iLocal_98)
			{
			...
			case 2:
				...
				if (iLocal_100 == 1)
				{
					...
					if (iLocal_473 > 0)
					{
						...
						{
							if (func_23(Local_132[iVar0]))
							{
								PED::EXPLODE_PED_HEAD(Local_132[iVar0], 100416529);
								ENTITY::SET_ENTITY_HEALTH(Local_132[iVar0], 0, 0);
							}
							iVar0++;
						}
					}
...
{
	Var1 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Param0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f), 0f, uParam4, 0f) };
	if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Var1, &uVar0, 0, 0))
	{
		Var1.z = uVar0;
	}
	*uParam3 = { Var1 };
...
void func_7()
{
	...
	while (iVar0 <= (iLocal_473 - 1))
	{
		Local_132[iVar0].f_15 = 0;
		Local_132[iVar0].f_16 = 0;
		Local_132[iVar0].f_17 = 0;
		iVar0++;
	}
}
	...
	if (func_59(Local_692, Local_385.f_1, 210f))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_405))
		{
			if (func_59(Local_692, Local_405.f_1, 150f))
			{
				...
				{
					Local_405 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_405.f_1, 10f, func_48(), 1, 0, 1);
					if (func_433(Local_405))
					{
						ENTITY::SET_ENTITY_COORDS(Local_405, func_47(), 1, 0, 0, 1);
						ENTITY::SET_ENTITY_HEADING(Local_405, func_46());
						ENTITY::FREEZE_ENTITY_POSITION(Local_405, 1);
					}
				}
			}
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_411))
		{
			if (func_59(Local_692, Local_411.f_1, 150f))
			{
				...
				{
					Local_411 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_411.f_1, 10f, func_45(), 1, 0, 1);
				}
			}
		}
	}
	...
	if (func_23(Local_385))
	{
		if (func_433(Local_393))
		{
			if (func_58(2))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(Local_385, uVar0, func_41(), func_51(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_393, uVar0, func_50(), func_41(), 1000f, -8f, iVar1, 1148846080);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_385, 1);
				PED::SET_PED_MONEY(Local_385, 0);
				PED::SET_PED_CAN_BE_TARGETTED(Local_385, 0);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_385, 1862763509);
				AI::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_385, 0);
				AI::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(Local_385, 0);
				PED::SET_PED_KEEP_TASK(Local_385, 1);
				PED::SET_PED_CONFIG_FLAG(Local_385, 118, 0);
			}
		}
	}
}
...
void func_67()
{
	if (func_433(Local_112.f_9))
	{
		...
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9(sLocal_496, Local_112.f_9, 0);
		}
	}
	if (func_433(Local_385))
	{
		if (CUTSCENE::_0xB56BBBCC2955D9CB())
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9(sLocal_495, Local_385, 0);
		}
	}
}
		...
		case 0:
			...
			if (iLocal_102 == 4)
			{
				if (func_23(Local_385))
				{
					...
					{
						if (func_112(Local_385, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f))
						{
							AUDIO::STOP_PED_SPEAKING(Local_385, 0);
				...
				{
					ENTITY::FREEZE_ENTITY_POSITION(Local_399, 0);
				}
				if (ENTITY::DOES_ENTITY_EXIST(Local_405))
				{
					ENTITY::FREEZE_ENTITY_POSITION(Local_405, 0);
				}
					...
					else if (func_23(Local_385))
					{
						if (!func_64(Local_385, 1805844857))
						{
							if (!PED::IS_PED_FLEEING(Local_385))
							{
								...
								{
									func_73(&Local_385);
									AI::TASK_SMART_FLEE_PED(Local_385, PLAYER::PLAYER_PED_ID(), 50f, -1, 0, 0);
									PED::SET_PED_KEEP_TASK(Local_385, 1);
								}
							}
						}
...
void func_98(bool bParam0)
{
	if (iLocal_471 > 0)
	{
		...
		{
			func_38(&(Local_291[iVar0]), bParam0);
			iVar0++;
		}
	}
	if (iLocal_469 > 0)
	{
		...
		{
			func_38(&(Local_340[iVar0]), bParam0);
			iVar0++;
		}
	}
	if (iLocal_472 > 0)
	...
	if (func_23(Local_385))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_385, 0);
		PED::SET_PED_KEEP_TASK(Local_385, 1);
	}
	...
	if (iLocal_473 > 0)
	{
		...
		while (iVar0 <= (iLocal_473 - 1))
		{
			if (iLocal_111 == 4)
			{
				if (func_23(Local_132[iVar0]))
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_132[iVar0], -2065892691);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_132[iVar0], 0);
					if (Global_110347 == 0)
					{
						PED::SET_PED_KEEP_TASK(Local_132[iVar0], 0);
					}
					else
					{
						PED::SET_PED_KEEP_TASK(Local_132[iVar0], 1);
					}
				}
			}
			func_42(&(Local_132[iVar0]), bParam0);
			iVar0++;
		}
	}
	if (iLocal_470 > 0)
	{
		...
		{
			func_99(&(Local_254[iVar0]), bParam0);
			iVar0++;
		}
	}
}
			...
			if (!PED::IS_PED_RAGDOLL(*iParam0) || AI::IS_PED_GETTING_UP(*iParam0))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(func_109()))
				{
					*iParam2 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					...
					AI::TASK_SYNCHRONIZED_SCENE(*iParam0, *iParam2, func_109(), func_74(), 1000f, -4f, 4626, 0, 1148846080, 0);
	...
	switch (iLocal_100)
	{
		case 0:
			...
			while (iVar0 <= (iLocal_473 - 1))
			{
				if (func_23(Local_132[iVar0]))
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_132[iVar0], iLocal_664);
					if (!PED::IS_PED_FLEEING(Local_132[iVar0]))
					{
						func_121(iVar0);
					}
				}
			...
			iLocal_477 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_100 = 1;
			break;
				...
				if (!iLocal_445)
				{
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&cLocal_671))
					{
						...
						while (iVar0 <= (iLocal_470 - 1))
						{
							if (iVar0 < Var1.f_5)
							{
								Var1.f_5[iVar0] = Local_254[iVar0];
							}
							iVar0++;
						}
...
{
	if (func_23(Local_132[iParam0]))
	{
		AI::CLEAR_PED_SECONDARY_TASK(Local_132[iParam0]);
		AI::CLEAR_PED_TASKS(Local_132[iParam0]);
		AI::TASK_CLEAR_LOOK_AT(Local_132[iParam0]);
		PED::SET_PED_HEARING_RANGE(Local_132[iParam0], 30f);
		PED::SET_PED_SEEING_RANGE(Local_132[iParam0], 30f);
		PED::SET_PED_ID_RANGE(Local_132[iParam0], 30f);
		PED::SET_PED_COMBAT_RANGE(Local_132[iParam0], 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0], 1, 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0], 3, 1);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0], 5, 1);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0], 0, 1);
		PED::SET_PED_FLEE_ATTRIBUTES(Local_132[iParam0], 512, 1);
		PED::SET_PED_ACCURACY(Local_132[iParam0], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10, 20));
		PED::SET_PED_SHOOT_RATE(Local_132[iParam0], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(15, 20));
		PED::SET_PED_FIRING_PATTERN(Local_132[iParam0], 445831135);
		if (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2) == 0)
		{
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_132[iParam0], ENTITY::GET_ENTITY_COORDS(Local_132[iParam0], 1), 45f, 0, 0);
		}
		else
		{
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_132[iParam0], ENTITY::GET_ENTITY_COORDS(Local_132[iParam0], 1), 35f, 0, 0);
		}
		AI::TASK_LOOK_AT_ENTITY(Local_132[iParam0], PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
		AI::TASK_COMBAT_PED(Local_132[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_132[iParam0], 0);
		Local_132[iParam0].f_14 = 2;
	}
}
	...
	switch (iLocal_100)
	{
		...
		case 2:
			...
			else
			{
				...
				if (func_23(Local_385))
				{
					AI::TASK_LOOK_AT_ENTITY(Local_385, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					PED::SET_PED_KEEP_TASK(Local_385, 1);
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_184(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_181(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_133(Global_102203.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_134(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_164(&(Global_75441.f_555[0]), iParam0))
	{
		return;
	}
...
var func_153()
{
	func_163(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_162(&uVar0, TIME::GET_CLOCK_MINUTES());
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_159(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_164(var uParam0, int iParam1)
{
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_174(Global_111638.f_32744.f_1864[uParam0->f_14], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_174(Global_111638.f_2358.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_174(Global_111638.f_2358.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, 0))
		{
...
void func_167(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_164(&(Global_75441.f_555[0]), iParam0))
	{
		...
		{
			func_172(iParam0);
			func_171(uParam1, &(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]));
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_176(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_188(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_189(Var18[0], Var18[1], Var6, Var9) || func_189(Var18[0], Var18[1], Var9, Var15)) || func_189(Var18[0], Var18[1], Var12, Var15)) || func_189(Var18[0], Var18[1], Var6, Var12)) || func_189(Var18[1], Var18[3], Var6, Var9)) || func_189(Var18[1], Var18[3], Var9, Var15)) || func_189(Var18[1], Var18[3], Var12, Var15)) || func_189(Var18[1], Var18[3], Var6, Var12)) || func_189(Var18[3], Var18[2], Var6, Var9)) || func_189(Var18[3], Var18[2], Var9, Var15)) || func_189(Var18[3], Var18[2], Var12, Var15)) || func_189(Var18[3], Var18[2], Var6, Var12)) || func_189(Var18[2], Var18[0], Var6, Var9)) || func_189(Var18[2], Var18[0], Var9, Var15)) || func_189(Var18[2], Var18[0], Var12, Var15)) || func_189(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
{
	return func_193(Global_102203.f_2890.f_12.f_66, Param0, iParam3);
}
...
void func_197(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_198(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_199(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76434[1] = { func_249(iVar10, iParam1, iParam2, -1) };
		if (!func_248(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76434[1] = { func_249(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1] = { func_249(iVar10, 14, uVar28[iVar1], -1) };
							func_219(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
							func_241(14);
							if (Global_76432 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_209(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_209(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_209(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_241(iVar0);
						if (Global_76432 == 1)
						{
			...
			{
				Global_76434[1] = { func_249(iVar10, iVar0, func_208(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1] = { func_249(iVar10, 14, uVar69[iVar1], -1) };
			func_219(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
			func_241(14);
			if (Global_76432 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_209(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_209(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_209(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
int func_200(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_313(iParam0, Global_111638.f_2358.f_539[iVar0].f_64, Global_111638.f_2358.f_539[iVar0].f_63))
		{
...
{
	Global_76434[1] = { func_249(iParam0, iParam1, iParam2, -1) };
...
int func_207(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_313(iParam0, Global_111638.f_2358.f_539[iVar0].f_61, Global_111638.f_2358.f_539[iVar0].f_60) || iParam3 == 1)
		{
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								if (!func_212(-1692214353, iVar3, iVar5, iVar4, &iVar6))
								{
									if (iVar6 != -99)
									{
										iVar0 = iVar6;
...
void func_219(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_220(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_221(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_209(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_226(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_209(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_226(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_233(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_233(Var16.z)] = func_226(iParam1, Var16.x, func_233(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_233(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_221(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_221(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_221(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_221(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_241(int iParam0)
{
	...
	{
		func_247(iParam0, Global_76434[1].f_5, Global_76434[1].f_2, 2, Global_76434[1].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_243(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2548434[iParam0][func_244(iParam2)];
	if (iVar0 != 0)
	{
...
int func_245(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0][func_244(iParam1)];
...
void func_251(int iParam0)
{
	...
	func_252(&(Global_76434[0]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_245(func_255(iParam1, uParam0->f_2), Global_76431, 0);
...
void func_258(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_252(&(Global_76434[0]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_252(&(Global_76434[0]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_252(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_252(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_209(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_313(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76434[1] = { func_249(iVar0, iParam1, iParam2, -1) };
	if (!GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_313(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_313(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76434[2] = { func_249(iVar0, 14, iVar4, -1) };
									if (Global_76434[2].f_12 == iVar3)
									{
										if (func_313(iParam0, 14, iVar4))
										{
											if (!func_205(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76434[2])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76434[2] = { func_249(iVar0, iVar2, iVar1, -1) };
						if (!func_205(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76434[2])))
						{
							return 0;
						}
					}
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_209(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_209(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_315()
{
	...
	if (func_23(Local_112.f_9))
	{
		Var1 = { ENTITY::GET_ENTITY_COORDS(Local_112.f_9, 0) };
		...
		switch (iLocal_100)
		{
			case 0:
				...
				Local_707 = { ENTITY::GET_ENTITY_COORDS(Local_112.f_9, 0) };
				...
				iLocal_417 = 0;
				sLocal_487 = "BB2_J8";
				iLocal_463 = GAMEPLAY::GET_GAME_TIMER();
			...
			case 1:
				if (!iLocal_448)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						if (iLocal_475 == -1)
						{
							iLocal_475 = GAMEPLAY::GET_GAME_TIMER();
						}
						...
						else
						{
							...
							{
								if (func_120(iLocal_463, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_112(Local_112.f_9, Local_692, 30f))
									{
...
int func_316(var uParam0)
{
	if (func_23(*uParam0))
	{
		...
		if (!func_317(uParam0))
		{
			if (GAMEPLAY::IS_PROJECTILE_IN_AREA(Var0 - Vector(7f, 7f, 7f), Var0 + Vector(7f, 7f, 7f), 0))
			{
				return 1;
			}
		}
...
void func_319(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
	if (UI::DOES_BLIP_EXIST(*uParam0))
	{
		if (bParam5)
		{
			...
			if (iParam6 && !func_62())
			{
				if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_318(sParam2, 0, 0))
				{
		...
		else
		{
			...
			if (iParam6 && !func_62())
			{
				if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_318(sParam1, 0, 0))
				{
...
void func_326()
{
	if (func_23(Local_112.f_9))
	{
		if (((Local_112.f_10 != 23 && Local_112.f_10 != 24) && Local_112.f_10 != 21) && Local_112.f_10 != 22)
		{
			...
			WEAPON::SET_CURRENT_PED_WEAPON(Local_112.f_9, -1569615261, 1);
...
int func_327(int iParam0, struct<3> Param1, bool bParam4, bool bParam5, bool bParam6, int iParam7)
{
	if (func_23(iParam0))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 1))
		{
			...
			{
				if (!WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(iParam0, 911657153, 0))
				{
...
int func_328(int iParam0, struct<3> Param1, float fParam4, float fParam5)
{
	if (func_112(iParam0, Param1, fParam4))
	{
		...
		{
			if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iParam0, 1), fParam5, 1))
			{
				return 1;
			}
		}
...
int func_329(int iParam0, struct<3> Param1)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (func_112(iParam0, Param1, 3.5f) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam0))
			{
				return 1;
			}
		}
...
int func_338(char* sParam0)
{
	if (!func_339(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_325(sParam0)) || func_325("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_339(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_346() || func_345(Global_4456448.f_232883)) || func_344())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_342(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_361(var uParam0, struct<3> Param1)
{
	...
	if (GAMEPLAY::IS_PROJECTILE_IN_AREA(Var0, Var3, 0))
	{
		if (GAMEPLAY::_0x8D7A43EC6A5FEA45(Var0, Var3, -1813897027, uParam0, 0))
		{
		}
		else if (GAMEPLAY::_0x8D7A43EC6A5FEA45(Var0, Var3, 615608432, uParam0, 0))
		{
		}
		else if (GAMEPLAY::_0x8D7A43EC6A5FEA45(Var0, Var3, -37975472, uParam0, 0))
		{
		}
		else if (GAMEPLAY::_0x8D7A43EC6A5FEA45(Var0, Var3, -1600701090, uParam0, 0))
		{
		}
		else if (GAMEPLAY::_0x8D7A43EC6A5FEA45(Var0, Var3, 741814745, uParam0, 0))
		{
		}
		else if (GAMEPLAY::_0x8D7A43EC6A5FEA45(Var0, Var3, 1233104067, uParam0, 0))
		{
		}
		else
		{
	...
	if (func_23(Local_112.f_9))
	{
		if (iLocal_253 == 0)
		{
			...
			if (func_372())
			{
				if (iLocal_448 || iLocal_98 == 7)
				{
					if (bLocal_455)
					{
						PED::SET_PED_MOVEMENT_CLIPSET(Local_112.f_9, func_371(), 1048576000);
						iLocal_253 = 2;
					}
					else
					{
						PED::SET_PED_MOVEMENT_CLIPSET(Local_112.f_9, func_370(), 1048576000);
						iLocal_253 = 1;
					}
				}
			}
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_112.f_10)
			{
				...
				case 3:
					if (func_120(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
				...
				case 7:
					if (func_120(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 1000)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
						{
							PED::_0xF1C03A5352243A30(Local_112.f_9);
				...
				case 29:
					if (func_120(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						if (iVar0 == -1569615261)
						{
							WEAPON::GIVE_WEAPON_TO_PED(Local_112.f_9, 453432689, -1, 0, 1);
							WEAPON::SET_CURRENT_PED_WEAPON(Local_112.f_9, 453432689, 0);
						}
						AI::TASK_COMBAT_PED(Local_112.f_9, PLAYER::PLAYER_PED_ID(), 0, 16);
						AI::TASK_SET_SPHERE_DEFENSIVE_AREA(Local_112.f_9, Local_695, 30f);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
						Local_112.f_10 = 30;
					}
					break;
				...
				case 13:
					if (func_120(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
						{
							PED::_0xFE07FF6495D52E2A(Local_112.f_9, Local_692);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_112.f_9, &iVar0, 1);
						if (iVar0 != -1569615261)
						{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_112.f_9, 5, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_112.f_9, 17, 1);
						AI::OPEN_SEQUENCE_TASK(&uLocal_484);
						...
						AI::CLOSE_SEQUENCE_TASK(uLocal_484);
						AI::TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_484);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_484);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
						PED::SET_PED_KEEP_TASK(Local_112.f_9, 1);
						Local_112.f_10 = 14;
					}
				...
				case 15:
					...
					if (func_102(Local_254[0]))
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0], 0) && func_112(Local_254[0], Local_254[0].f_1, 3f)) && func_369(ENTITY::GET_ENTITY_HEADING(Local_254[0]), Local_254[0].f_4, 20f))
						{
							if (PED::IS_PED_IN_VEHICLE(Local_112.f_9, Local_254[0], 0) && !PED::IS_PED_BEING_JACKED(Local_112.f_9))
							{
								Local_112.f_10 = 16;
							}
							else if (func_120(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
								{
									PED::_0xFE07FF6495D52E2A(Local_112.f_9, Local_692);
								...
								AI::TASK_ENTER_VEHICLE(Local_112.f_9, Local_254[0], 25000, -1, 2f, 8388608, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
								Local_112.f_10 = 16;
							}
						}
				...
				case 16:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0], 0) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_112(Local_254[0], Local_254[0].f_1, 3f)) || !func_369(ENTITY::GET_ENTITY_HEADING(Local_254[0]), Local_254[0].f_4, 20f))
					{
						Local_112.f_10 = 13;
					}
					else if (PED::IS_PED_SITTING_IN_VEHICLE(Local_112.f_9, Local_254[0]))
					{
						Local_112.f_10 = 31;
					}
				...
				case 17:
					if (func_102(Local_254[0]) && PED::IS_PED_SITTING_IN_VEHICLE(Local_112.f_9, Local_254[0]))
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_112.f_9, Local_254[0], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 350f, 30f, 1);
...
int func_367(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)
{
	...
	{
		Var0 = { ENTITY::GET_ENTITY_COORDS(iParam0, 1) };
		if (GAMEPLAY::IS_BULLET_IN_AREA(Var0, fParam4, 1))
		{
			return 1;
		}
		...
		Var3.y = (Var3.y - fParam5);
		Var3.z = (Var3.z - fParam5);
		Var6.x = (Var6.x + fParam5);
		Var6.y = (Var6.y + fParam5);
		Var6.z = (Var6.z + fParam5);
		if (GAMEPLAY::IS_PROJECTILE_IN_AREA(Var3, Var6, 1))
		{
			return 1;
		}
	}
...
bool func_375(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar4 == -1)
	{
		...
		Local_56[iVar4].f_1 = iParam0;
		Local_56[iVar4].f_2 = iParam1;
	}
	Var1 = { PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f) };
	uVar0 = func_376(&(Local_56[iVar4]), Var1, iParam1, &(Local_56[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (GAMEPLAY::GET_GAME_TIMER() - Local_56[iVar4].f_3) < iParam4);
}
...
int func_378()
{
	...
	while (iVar0 < Local_56)
	{
		if ((Local_56[iVar0] == 0 && Local_56[iVar0].f_1 == 0) && Local_56[iVar0].f_2 == 0)
		{
			return iVar0;
		}
		iVar0++;
...
{
	Var0 = { func_190(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_381(int iParam0, int iParam1)
{
	...
	while (iVar0 < Local_56)
	{
		if (Local_56[iVar0].f_1 == iParam0 && Local_56[iVar0].f_2 == iParam1)
		{
			return iVar0;
		}
		iVar0++;
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_112.f_9, 0) && PED::GET_VEHICLE_PED_IS_IN(Local_112.f_9, 0) == iVar0)
			{
				if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					if (!iLocal_447)
					{
						if (!func_62())
						{
							iLocal_462 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_447 = 1;
						}
					}
					else if (!iLocal_422[0])
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_462) > 7500)
						{
							func_389(0);
						}
					}
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_462) > 10000)
						{
							func_389(1);
						}
					}
			...
			else
			{
				...
				else if (Local_112.f_10 == 24 && func_64(Local_112.f_9, -1519143300))
				{
					if (func_112(Local_112.f_9, Local_692, 25f))
					{
						...
						{
							if (func_120(iLocal_464, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_62())
								{
									func_3();
								...
								{
									iLocal_464 = GAMEPLAY::GET_GAME_TIMER();
								}
							}
						}
						else
				...
				else
				{
					...
					if (!func_62())
					{
						if (func_120(iLocal_463, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_112(Local_112.f_9, Local_692, 20f))
							{
		...
		switch (iLocal_100)
		{
			...
			case 1:
				if (!iLocal_449)
				{
					...
					{
						if (!UI::DOES_BLIP_EXIST(uLocal_456))
						{
							if (iLocal_436)
							{
...
{
	iVar0 = 0;
	iVar0 = UI::ADD_BLIP_FOR_COORD(Param0);
	UI::SET_BLIP_PRIORITY(iVar0, iParam3);
		...
		switch (iLocal_100)
		{
			...
			case 1:
				...
				if (!iLocal_448)
				{
					...
					{
						if (func_120(iLocal_463, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3500, 7000)))
						{
							if (func_112(Local_112.f_9, Local_692, 30f))
							{
								if (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 101) < 30)
...
void func_398(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (Local_132[iVar0].f_14 != 5)
		{
			func_106(Local_132[iVar0], 1);
			Local_132[iVar0].f_14 = 4;
			func_116(&(Local_132[iVar0].f_6));
		}
		iVar0++;
	}
...
void func_399(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_23(Local_132[iVar0]))
		{
			func_374(Local_132[iVar0], &(Local_132[iVar0].f_17), 1126825984, 7);
			switch (Local_132[iVar0].f_14)
			{
				case 0:
					break;
				...
				case 1:
					...
					if (func_120(Local_132[iVar0].f_15, iVar2))
					{
						func_121(iVar0);
					}
					break;
				...
				case 2:
					func_400(Local_132[iVar0], &(Local_132[iVar0].f_6), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
					break;
				
				case 3:
					if (!func_64(Local_132[iVar0], -2017877118))
					{
						func_121(iVar0);
					}
					break;
				...
				case 4:
					if (!func_64(Local_132[iVar0], 1805844857))
					{
						func_106(Local_132[iVar0], 1);
					}
					func_116(&(Local_132[iVar0].f_6));
...
void func_401(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_23(Local_132[iVar0]))
		{
			Local_132[iVar0].f_15 = GAMEPLAY::GET_GAME_TIMER();
			Local_132[iVar0].f_14 = 1;
		}
		iVar0++;
	}
}
	...
	if (func_23(Local_112.f_9))
	{
		...
		switch (iLocal_100)
		{
			...
			case 2:
				...
				func_403(0);
				func_358(&(Local_112.f_8), "", "", &iLocal_466, iLocal_467, 0);
				iLocal_466 = GAMEPLAY::GET_GAME_TIMER();
	...
	if (!iLocal_431)
	{
		if (!func_62())
		{
			if (func_112(Local_112.f_9, Local_692, (22f + 5f)))
			{
				...
				if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_683))
				{
...
int func_412(int iParam0, struct<3> Param1, float fParam4)
{
	...
	fVar3 = GAMEPLAY::ABSF((Var0.z - Param1.z));
	if (fVar3 <= fParam4)
	{
		return 1;
	}
...
void func_422()
{
	...
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_385, 0) || PED::IS_PED_INJURED(Local_385))
		{
			iLocal_102 = 3;
			return;
		}
...
int func_423(bool bParam0)
{
	if (func_23(Local_385))
	{
		...
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(Local_385, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0))
			{
				return 1;
			}
		}
		...
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_385, 1), 15f))
		{
			return 1;
		}
...
{
	Var0 = { func_190(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
		...
		if (Global_111638.f_2358.f_539.f_2407[0][iParam1] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[0][iParam1]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[0][iParam1], Param2, fParam5, 0, 0, 0);
				...
				func_484(iParam0, &(Global_111638.f_2358.f_539.f_2407[0][iParam1].f_31), &(Global_111638.f_2358.f_539.f_2407[0][iParam1].f_81));
		...
		else if (Global_111638.f_2358.f_539.f_2407[1][iParam1] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[1][iParam1]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[1][iParam1], Param2, fParam5, 0, 0, 0);
				...
				func_484(iParam0, &(Global_111638.f_2358.f_539.f_2407[1][iParam1].f_31), &(Global_111638.f_2358.f_539.f_2407[1][iParam1].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == -1435919434)
...
void func_449(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	if ((func_89(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_177(iParam1, &(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_31), &(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_81));
			if (bParam3)
			{
				...
				Global_111638.f_20113[iParam0].f_31 = func_452(*iParam1);
				...
				func_450(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_5, Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_7, iVar3, 1, &(Global_111638.f_20113[iParam0].f_1));
				...
				func_450(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_6, -1, iVar3, 0, &(Global_111638.f_20113[iParam0].f_2));
			}
		}
	}
}
...
int func_453(int iParam0, bool bParam1, var uParam2)
{
	*uParam2 = 0;
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_148(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != 873639469) && ENTITY::GET_ENTITY_MODEL(iParam0) != -1177863319)
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_454(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			...
			{
				return func_455(Global_2425662[iParam0].f_310.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_458(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_455(Global_2425662[iParam0].f_310.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_459(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_455(Global_2425662[iParam0].f_310.f_5) == 7;
			}
		}
	}
	return 0;
...
int func_476(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1 && Global_2425662[iParam0].f_310.f_8 != func_82())
			{
				return func_455(Global_2425662[iParam0].f_310.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_477(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1 && Global_2425662[iParam0].f_310.f_8 != func_82())
			{
				return func_455(Global_2425662[iParam0].f_310.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_478(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_455(Global_2425662[iParam0].f_310.f_5) == 9;
			}
		}
	}
	return 0;
...
int func_484(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_475(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_487(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_487(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_486(uParam0);
	if (func_485(*uParam0))
	{
...
void func_490(struct<3> Param0, float fParam3, int iParam4)
{
	...
	while (iVar0 < 68)
	{
		if (func_164(&(Global_75441.f_555[0]), iVar0))
		{
...
void func_491(int iParam0)
{
	...
	if (func_164(&(Global_75441.f_555[0]), iParam0))
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_75441.f_555[0].f_9, 13))
		{
			if (((((iParam0 == 24 && func_170(iParam0, 0)) && Global_76350.f_66 == 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0].f_14] != 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0].f_14] > 3) && (!func_492(0, Global_75441.f_555[0].f_12) || !func_492(1, Global_75441.f_555[0].f_12)))
			{
				func_171(&(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]), &Global_76350);
...
int func_492(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_493(&(Global_111638.f_32744.f_5038[iVar0])))
	{
		return 0;
	}
	return func_138(Global_111638.f_32744.f_5038[iVar0][iParam0].f_66, 0);
}
...
{
	return func_495(&(Global_105187.f_2890), Param0, fParam3, 0);
}
	...
	if (func_512(uParam0))
	{
		...
		if (func_511(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_497(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_497(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_499(iParam0, uVar1[iVar6], 1) && func_498(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_174(Param1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_500(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_176(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_176(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_176(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == 340154634 || uParam1->f_66 == -1960756985)
		{
			...
			while (iVar2 <= 9)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_176(iVar2)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_176(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_176(iVar3)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_176(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_176(iVar4)))
					{
					}
					else
					{
						GAMEPLAY::SET_BIT(&(uParam1->f_77), func_176(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_176(iVar5 + 1)))
				{
...
int func_512(var uParam0)
{
	...
	if (uParam0->f_12.f_66 == -2122757008 && func_498(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
void func_522()
{
	...
	GAMEPLAY::CLEAR_AREA(Local_103, 15f, 0, 0, 0, 0);
...
void func_523()
{
	if (func_23(Local_112.f_9))
	{
		...
		AI::OPEN_SEQUENCE_TASK(&uLocal_484);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "idle_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "idle_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "idle_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
		AI::SET_SEQUENCE_TO_REPEAT(uLocal_484, 1);
		AI::CLOSE_SEQUENCE_TASK(uLocal_484);
		AI::TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_484);
		AI::CLEAR_SEQUENCE_TASK(&uLocal_484);
	}
	...
	while (iVar0 <= 5)
	{
		if (func_23(Local_132[iVar0]))
		{
			func_360(Local_132[iVar0]);
			if (Local_132[iVar0].f_5 != 0)
			{
				WEAPON::GIVE_WEAPON_TO_PED(Local_132[iVar0], Local_132[iVar0].f_5, -1, 1, 1);
			}
			PED::SET_PED_CONFIG_FLAG(Local_132[iVar0], 137, 1);
			func_524(Local_132[iVar0], "BACKUP_", iVar0);
			if (func_102(Local_254[0]))
			{
				if (iVar0 == 1)
				{
					PED::SET_PED_INTO_VEHICLE(Local_132[iVar0], Local_254[0], -1);
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_132[iVar0], 1, 0);
				}
				else if (iVar0 == 2)
				{
					PED::SET_PED_INTO_VEHICLE(Local_132[iVar0], Local_254[0], 2);
				}
				else if (iVar0 == 3)
				{
					PED::SET_PED_INTO_VEHICLE(Local_132[iVar0], Local_254[0], 1);
			...
			{
				case 0:
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 0, 0, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 2, 1, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 3, 0, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 4, 0, 0, 0);
					break;
				
				case 1:
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 0, 0, 3, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 2, 0, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 3, 2, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 4, 0, 1, 0);
					break;
				
				case 2:
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 0, 1, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 2, 0, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 3, 0, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 4, 0, 2, 0);
					break;
				
				case 3:
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 0, 0, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 2, 0, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 3, 1, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0], 4, 0, 2, 0);
					break;
			}
			if (iVar0 == 0)
			{
				...
				AI::SET_SEQUENCE_TO_REPEAT(uLocal_484, 1);
				AI::CLOSE_SEQUENCE_TASK(uLocal_484);
				AI::TASK_PERFORM_SEQUENCE(Local_132[iVar0], uLocal_484);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_484);
				if (func_23(Local_132[iVar0]))
				{
					func_97(&uLocal_499, 4, Local_132[iVar0], "HILLBILLY", 0, 1);
					PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(Local_132[iVar0], 1);
				}
			}
		}
		iVar0++;
...
int func_525()
{
	...
	if (iLocal_473 > 0)
	{
		...
		{
			if (func_54(&(Local_132[iVar2]), Local_132[iVar2].f_19, Local_132[iVar2].f_1, Local_132[iVar2].f_4, 0, 0, 0))
			{
				if (func_23(Local_132[iVar2]))
				{
					PED::SET_PED_CONFIG_FLAG(Local_132[iVar2], 132, 1);
					iVar0++;
					iVar1++;
				}
			}
	...
	if (iVar1 == iLocal_473)
	{
		...
		while (iVar2 <= (iLocal_473 - 1))
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_132[iVar2].f_19);
			iVar2++;
		}
	}
	if (iLocal_470 > 0)
	{
		...
		{
			if (func_527(&(Local_254[iVar2]), Local_254[iVar2].f_5, Local_254[iVar2].f_1, Local_254[iVar2].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iLocal_471 > 0)
	{
		...
		{
			if (func_57(&(Local_291[iVar2]), Local_291[iVar2].f_5, Local_291[iVar2].f_1, Local_291[iVar2].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iLocal_469 > 0)
	{
		...
		{
			if (func_57(&(Local_340[iVar2]), Local_340[iVar2].f_8, Local_340[iVar2].f_1, Local_340[iVar2].f_7, 1))
			{
				ENTITY::FREEZE_ENTITY_POSITION(Local_340[iVar2], 1);
				iVar0++;
			}
			iVar2++;
		}
	...
	if (iLocal_472 > 0)
	{
		...
		{
			if (func_526(&(Local_377[iVar2]), Local_377[iVar2].f_5, Local_377[iVar2].f_2, Local_377[iVar2].f_6, Local_377[iVar2].f_1, 1))
			{
				iVar0++;
			}
			iVar2++;
...
int func_526(var uParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6, bool bParam7)
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam6))
...
void func_530()
{
	iVar0 = 0;
	iLocal_111 = 4;
	Local_112.f_11 = -681546704;
	Local_112.f_13 = { 162.5572f, 2289.158f, 93.1489f };
	Local_112.f_16 = 292.4985f;
	Local_112.f_12 = 453432689;
	Local_112.f_10 = 0;
	Local_112.f_17 = 0;
	Local_112.f_18 = 0;
	Local_112.f_19 = 0;
	func_8();
	Local_132[0].f_19 = 2064532783;
	Local_132[0].f_1 = { 164.3371f, 2290.645f, 93.1434f };
	Local_132[0].f_4 = 119.9981f;
	Local_132[0].f_5 = 453432689;
	Local_132[1].f_19 = 2064532783;
	Local_132[1].f_1 = { 162.4443f, 2283.816f, 92.9438f };
	Local_132[1].f_4 = 299.9979f;
	Local_132[1].f_5 = 453432689;
	Local_132[2].f_19 = 2064532783;
	Local_132[2].f_1 = { 163.1961f, 2282.257f, 93.6852f };
	Local_132[2].f_4 = 299.9979f;
	Local_132[2].f_5 = 453432689;
	Local_132[3].f_19 = 2064532783;
	Local_132[3].f_1 = { 163.9295f, 2283.512f, 92.6928f };
	Local_132[3].f_4 = 299.9979f;
	Local_132[3].f_5 = 453432689;
	iVar0 = 0;
	while (iVar0 <= (iLocal_473 - 1))
	{
		Local_132[iVar0].f_15 = 0;
		Local_132[iVar0].f_16 = 0;
		Local_132[iVar0].f_17 = 0;
		Local_132[iVar0].f_14 = 0;
		iVar0++;
	}
	iLocal_473 = 4;
	Local_254[0].f_5 = -16948145;
	Local_254[0].f_1 = { 167.6809f, 2285.204f, 92.2978f };
	Local_254[0].f_4 = 164.9999f;
	Local_254[1].f_5 = -1800170043;
	Local_254[1].f_1 = { 183.4f, 2287.07f, 91.09f };
	Local_254[1].f_4 = 208.2f;
	iLocal_470 = 2;
	iLocal_471 = 0;
	iLocal_469 = 0;
	iLocal_472 = 0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_545()) || Global_110685) || Global_30770) || func_551()) || func_95(8, -1)) || func_550()) || func_549()) || func_543()) || func_544()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_545()) || Global_30770) || func_551()) || func_95(8, -1)) || func_543()) || func_550()) || func_549()) || func_544()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_545()) || Global_110685) || Global_30770) || func_551()) || func_95(8, -1)) || func_543()) || func_550()) || func_549()) || func_544()) || Global_111638.f_7683.f_919[iVar0] == 5) || Global_41978 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_545()) || Global_110685) || Global_30770) || func_551()) || func_95(8, -1)) || func_550()) || func_549()) || func_544()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_545()) || func_549()) || Global_110685) || Global_30770) || func_551()) || Global_42596) || func_95(8, -1)) || func_543()) || func_548()) || func_544()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
