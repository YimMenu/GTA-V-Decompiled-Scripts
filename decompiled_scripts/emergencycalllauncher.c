...
void func_3()
{
	if (func_6())
	{
		...
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GAMEPLAY::GET_HASH_KEY(&uLocal_210)) == 0)
		{
			func_4();
		}
		else
...
void func_7()
{
	switch (iLocal_44)
	{
		...
		case 1:
			if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-97856636) == 0)
			{
				if (!func_35(130))
				{
					iLocal_43 = 1;
