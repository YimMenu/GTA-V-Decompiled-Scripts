						...
						if ((func_48() && !func_47()) && iLocal_48 != 2)
						{
							if (!PED::IS_PED_INJURED(iLocal_58))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(iLocal_58, Local_118, 5f, 5f, 5f, 0, 1, 0))
								{
									...
									{
										iLocal_121[8] = OBJECT::CREATE_OBJECT(334347537, -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
...
void func_1()
{
	if (iLocal_150 && !iLocal_149)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_121[8]))
		{
			uLocal_133 = OBJECT::CREATE_PICKUP_ROTATE(-1997886297, ENTITY::GET_ENTITY_COORDS(iLocal_121[8], 1), ENTITY::GET_ENTITY_ROTATION(iLocal_121[8], 2) + Vector(2.8157f, -159.5768f, -14.1956f), 0, -1, 2, 1, 0);
...
void func_18(int iParam0, int iParam1)
{
	...
	if (iParam1 <= func_39(iParam0))
	{
		...
		{
			func_20(func_24(iParam0, iParam1), Local_44.x, Local_44.y);
		}
	...
	switch (iLocal_70)
	{
		...
		case 2:
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_58))
			{
				if (!PED::IS_PED_INJURED(iLocal_58))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_58, Local_112, Global_19, 1, 1, 0) && func_117(1, 0, 1))
					{
	...
	switch (iLocal_143)
	{
		...
		case 2:
			...
			if (!PED::IS_PED_INJURED(iLocal_58))
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_115, 1f, -1, 0.25f, 0, 311.3569f);
				AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
				AI::CLOSE_SEQUENCE_TASK(uLocal_95);
				AI::TASK_PERFORM_SEQUENCE(iLocal_58, uLocal_95);
...
void func_120()
{
	...
	if ((iLocal_137 - iLocal_136) > 60000)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_58))
		{
			...
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_58, Local_115, 1f, -1, 0.25f, 0, 1193033728);
			}
			else
			{
...
var func_123(struct<3> Param0, int iParam3)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_124(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_126(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_124(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
	...
	if (!PED::IS_PED_INJURED(iLocal_58))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
		{
			if (!func_132())
			{
				...
				{
					AI::TASK_GO_TO_ENTITY(iLocal_58, PLAYER::PLAYER_PED_ID(), -1, 6f, 1073741824, 1073741824, 0);
				}
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_58, 0))
				{
...
int func_132()
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
	{
		...
		{
			if ((((!VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(PED::SET_EXCLUSIVE_PHONE_RELATIONSHIPS(PLAYER::PLAYER_PED_ID()))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(PED::SET_EXCLUSIVE_PHONE_RELATIONSHIPS(PLAYER::PLAYER_PED_ID())))) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(PED::SET_EXCLUSIVE_PHONE_RELATIONSHIPS(PLAYER::PLAYER_PED_ID())))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(PED::SET_EXCLUSIVE_PHONE_RELATIONSHIPS(PLAYER::PLAYER_PED_ID())))) && ENTITY::GET_ENTITY_MODEL(PED::SET_EXCLUSIVE_PHONE_RELATIONSHIPS(PLAYER::PLAYER_PED_ID())) != 782665360)
			{
				return 1;
			}
		}
	...
	switch (iLocal_69)
	{
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_58) && ENTITY::DOES_ENTITY_EXIST(iLocal_121[8]))
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_121[8], 1) + Vector(0f, 0.39f, 0.35f), 1f, -1, 0f, 512, func_135(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_121[8], 1)));
	...
	switch (iLocal_68)
	{
		...
		case 16:
			if (!PED::IS_PED_INJURED(iLocal_58))
			{
				...
				AI::TASK_TURN_PED_TO_FACE_COORD(0, Local_109, 0);
				AI::CLOSE_SEQUENCE_TASK(uLocal_95);
				AI::TASK_PERFORM_SEQUENCE(iLocal_58, uLocal_95);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_95);
				iLocal_68++;
...
void func_141()
{
	...
	{
		AI::OPEN_SEQUENCE_TASK(&uLocal_95);
		AI::TASK_GO_STRAIGHT_TO_COORD(0, Local_109, 1f, -1, 1193033728, 1056964608);
		AI::TASK_PLAY_ANIM(0, "random@domestic", "f_attack_end", 2f, -2f, -1, 1, 0, 0, 0, 0);
		AI::CLOSE_SEQUENCE_TASK(uLocal_95);
		AI::TASK_PERFORM_SEQUENCE(iLocal_57, uLocal_95);
		AI::CLEAR_SEQUENCE_TASK(&uLocal_95);
...
void func_152()
{
	...
	func_4(43, 1);
	func_4(44, 1);
	GAMEPLAY::CLEAR_AREA(Local_63, 2f, 1, 0, 0, 0);
	GAMEPLAY::CLEAR_AREA(Local_60, 2f, 1, 0, 0, 0);
...
void func_154()
{
	iLocal_121[0] = OBJECT::CREATE_OBJECT(578126062, -470.3661f, 541.385f, 120.0205f, 1, 1, 0);
	ENTITY::SET_ENTITY_ROTATION(iLocal_121[0], -13.7262f, 0.5001f, -0.5886f, 2, 1);
	ENTITY::FREEZE_ENTITY_POSITION(iLocal_121[0], 1);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(578126062);
	iLocal_121[1] = OBJECT::CREATE_OBJECT(-1471068014, -470.8998f, 540.7595f, 120.169f, 1, 1, 0);
	ENTITY::SET_ENTITY_ROTATION(iLocal_121[1], -7.3906f, -12.8136f, -63.733f, 2, 1);
	ENTITY::FREEZE_ENTITY_POSITION(iLocal_121[1], 1);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1471068014);
	iLocal_121[2] = OBJECT::CREATE_OBJECT(1682675077, -468.3266f, 540.7725f, 120.1762f, 1, 1, 0);
	ENTITY::SET_ENTITY_ROTATION(iLocal_121[2], -7.041683f, 10.17298f, 45.7617f, 2, 1);
	ENTITY::FREEZE_ENTITY_POSITION(iLocal_121[2], 1);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(1682675077);
	iLocal_121[3] = OBJECT::CREATE_OBJECT(-1157632529, -468.7787f, 541.864f, 119.9098f, 1, 1, 0);
	ENTITY::SET_ENTITY_ROTATION(iLocal_121[3], -8.5884f, 12.6893f, 57.1792f, 2, 1);
	ENTITY::FREEZE_ENTITY_POSITION(iLocal_121[3], 1);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1157632529);
	iLocal_121[4] = OBJECT::CREATE_OBJECT(1916612968, -470.9009f, 541.2538f, 120.0578f, 1, 1, 0);
	ENTITY::SET_ENTITY_ROTATION(iLocal_121[4], -16.4886f, 2.4979f, -3.8769f, 2, 1);
	ENTITY::FREEZE_ENTITY_POSITION(iLocal_121[4], 1);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(1916612968);
	iLocal_121[5] = OBJECT::CREATE_OBJECT(-1256588656, -472.0366f, 542.0591f, 119.8243f, 1, 1, 0);
	ENTITY::SET_ENTITY_ROTATION(iLocal_121[5], -3.5946f, -15.0978f, -75.5026f, 2, 1);
	ENTITY::FREEZE_ENTITY_POSITION(iLocal_121[5], 1);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1256588656);
	iLocal_121[6] = OBJECT::CREATE_OBJECT(-988623986, -472.7543f, 542.3022f, 119.7628f, 1, 1, 0);
	ENTITY::SET_ENTITY_ROTATION(iLocal_121[6], 6.402527f, -15.68665f, -104.1308f, 2, 1);
	ENTITY::FREEZE_ENTITY_POSITION(iLocal_121[6], 1);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-988623986);
	iLocal_121[7] = OBJECT::CREATE_OBJECT(-1603796423, -471.8675f, 543.6655f, 119.4991f, 1, 1, 0);
	ENTITY::SET_ENTITY_ROTATION(iLocal_121[7], -8.3642f, 1.9344f, 2.6889f, 2, 1);
	ENTITY::FREEZE_ENTITY_POSITION(iLocal_121[7], 1);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1603796423);
	iLocal_121[8] = OBJECT::CREATE_OBJECT(334347537, -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
	iLocal_121[9] = OBJECT::CREATE_OBJECT(-675277761, -473.195f, 537.2585f, 123.3303f, 1, 1, 0);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-675277761);
	iLocal_121[10] = OBJECT::CREATE_OBJECT(886428669, -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(886428669);
}
...
void func_158()
{
	if (!PED::IS_PED_INJURED(iLocal_58) && !PED::IS_PED_INJURED(iLocal_57))
	{
		...
		{
			if (PED::_0x6CD5A433374D4CFB(iLocal_58, PLAYER::PLAYER_PED_ID()) || PED::_0x6CD5A433374D4CFB(iLocal_57, PLAYER::PLAYER_PED_ID()))
			{
...
void func_163()
{
	...
	{
		AI::CLEAR_PED_TASKS(iLocal_58);
		AI::TASK_SMART_FLEE_COORD(iLocal_58, ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 1), 150f, -1, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_58, 1);
	}
	iLocal_49 = 11;
}
...
void func_166()
{
	...
	STREAMING::REQUEST_MODEL(334347537);
	STREAMING::REQUEST_MODEL(-675277761);
	STREAMING::REQUEST_MODEL(886428669);
	STREAMING::REQUEST_MODEL(578126062);
	STREAMING::REQUEST_MODEL(-1471068014);
	STREAMING::REQUEST_MODEL(1682675077);
	STREAMING::REQUEST_MODEL(-1157632529);
	STREAMING::REQUEST_MODEL(1916612968);
	STREAMING::REQUEST_MODEL(-1256588656);
	STREAMING::REQUEST_MODEL(-988623986);
	STREAMING::REQUEST_MODEL(-1603796423);
	STREAMING::REQUEST_ANIM_DICT("random@domestic");
	STREAMING::REQUEST_ANIM_DICT("random@security_van");
	if ((((((((((((((STREAMING::HAS_MODEL_LOADED(iLocal_96) && STREAMING::HAS_MODEL_LOADED(iLocal_97)) && STREAMING::HAS_MODEL_LOADED(334347537)) && STREAMING::HAS_MODEL_LOADED(-675277761)) && STREAMING::HAS_MODEL_LOADED(886428669)) && STREAMING::HAS_MODEL_LOADED(578126062)) && STREAMING::HAS_MODEL_LOADED(-1471068014)) && STREAMING::HAS_MODEL_LOADED(1682675077)) && STREAMING::HAS_MODEL_LOADED(-1157632529)) && STREAMING::HAS_MODEL_LOADED(1916612968)) && STREAMING::HAS_MODEL_LOADED(-1256588656)) && STREAMING::HAS_MODEL_LOADED(-988623986)) && STREAMING::HAS_MODEL_LOADED(-1603796423)) && STREAMING::HAS_ANIM_DICT_LOADED("random@domestic")) && STREAMING::HAS_ANIM_DICT_LOADED("random@security_van"))
	{
		bLocal_50 = true;
	}
	else
...
int func_181()
{
	if ((Global_111627 == func_40() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_111628)
	{
		return 1;
	}
	return 0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_219()) || Global_110685) || Global_30770) || func_218()) || func_77(8, -1)) || func_217()) || func_216()) || func_215()) || func_214()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_219()) || Global_30770) || func_218()) || func_77(8, -1)) || func_215()) || func_217()) || func_216()) || func_214()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_219()) || Global_110685) || Global_30770) || func_218()) || func_77(8, -1)) || func_215()) || func_217()) || func_216()) || func_214()) || Global_111638.f_7683.f_919[iVar0] == 5) || Global_41978 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_219()) || Global_110685) || Global_30770) || func_218()) || func_77(8, -1)) || func_217()) || func_216()) || func_214()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_219()) || Global_30770) || func_218()) || func_77(8, -1)) || func_216()) || func_215()) || func_214()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_219()) || func_216()) || Global_110685) || Global_30770) || func_218()) || Global_42596) || func_77(8, -1)) || func_215()) || func_213()) || func_214()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_219()) || Global_110685) || Global_30770) || func_218()) || func_77(8, -1)) || func_215()) || func_213()) || func_217()) || func_216()) || func_214())
						{
							return 0;
						}
						break;
