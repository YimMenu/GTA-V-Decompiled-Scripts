	...
	switch (iLocal_168)
	{
		...
		case 1:
			...
			else
			{
				...
				else if (((((iLocal_346 < 15 && !func_229()) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_343) > 10000) && func_228(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_169)) && func_211(&uLocal_173, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0))
				{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_83(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_83(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_101(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_94(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_94(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_83(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_174()
{
	...
	{
		func_163();
		GRAPHICS::_0xBF59707B3E5ED531(func_175(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
...
int func_244(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_251() || func_250(Global_4456448.f_232883)) || func_249())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_247(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_265()
{
	if (!UI::DOES_BLIP_EXIST(iLocal_170) && func_464(iLocal_169))
	{
		...
		case 0:
			...
			if (func_464(iLocal_169))
			{
				...
				if (func_3(iLocal_162))
				{
					...
					AI::OPEN_SEQUENCE_TASK(&uLocal_344);
					...
					AI::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, iLocal_162, Local_347, 20f, 786469, 10f);
					AI::TASK_VEHICLE_PARK(0, iLocal_162, Local_347, 49.567f, 3, 1092616192, 0);
					AI::TASK_LEAVE_VEHICLE(0, iLocal_162, 256);
					AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uLocal_344);
					AI::TASK_PERFORM_SEQUENCE(iLocal_169, uLocal_344);
				}
				else
				{
		...
		case 1:
			...
			else
			{
				...
				if (iLocal_339 == 0)
				{
					...
					if (((((iLocal_345 < 7 && !func_229()) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_342) > 10000) && func_228(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_169)) && func_211(&uLocal_173, "SONARAU", "SONAR_FOLLOW", 7, 0, 0, 0))
					{
						iLocal_342 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_345++;
					}
	...
	if (UI::DOES_BLIP_EXIST(*uParam0))
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - *iParam3) > 500)
		{
			if (UI::GET_BLIP_COLOUR(*uParam0) == 1)
			{
				...
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_271(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_271(sParam2, 0, 0))
					{
			...
			switch (iLocal_351)
			{
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_169, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 1193033728);
						}
...
void func_303(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_305()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_305()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_304(iParam0));
...
bool func_307(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_305()].f_6174.f_10, iParam0);
}
...
void func_341(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_342(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_360()
{
	...
	if ((!func_229() && UI::HAS_ADDITIONAL_TEXT_LOADED(0)) && STREAMING::HAS_MODEL_LOADED(iLocal_161))
	{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_432(iVar0 + 1));
			}
			iVar0++;
		}
