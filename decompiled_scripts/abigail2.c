		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &Var2) && Var2.z != -1)
				{
					...
					{
						(*iParam0)[Var2.z] = func_66(iParam1, Var2.x, 14, iVar0);
					}
					else if (Var2.y != -1)
					{
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.x != 0 && Var2.x != -1) && Var2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_89(Var2.z)] = func_66(iParam1, Var2.x, func_89(Var2.z), iVar0);
					}
				}
				else if (Var2.y != -1)
				{
...
void func_168(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_169(&uVar1, Var0.f_3, Global_98781, iParam1, iParam2);
	}
}
...
void func_269()
{
	switch (iLocal_60)
	{
		...
		case 1:
			...
			else if (ENTITY::IS_ENTITY_AT_COORD(iLocal_61, Local_239, 5f, 5f, 5f, 0, 1, 0))
			{
				func_234(3);
			}
			else
			{
				...
				if (iLocal_231 == 0)
				{
					if (((func_464(iLocal_56) && PED::IS_PED_IN_VEHICLE(iLocal_61, iLocal_56, 1)) && func_228(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_211(&uLocal_65, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0))
					{
						iLocal_231 = 1;
					}
...
int func_391(var uParam0, int iParam1, struct<3> Param2, var uParam3, char* sParam4, int iParam5)
{
	if (func_392(uParam0, iParam1, Param2, uParam3, 1))
	{
...
int func_395(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)
{
	...
	if (func_160(iParam1))
	{
		...
		if (Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, uParam3, 0, 0, 0);
