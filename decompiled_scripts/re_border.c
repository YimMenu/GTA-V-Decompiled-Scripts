		...
		while (iVar0 < 3)
		{
			if (!PED::IS_PED_INJURED(uLocal_85[iVar0]))
			{
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_85[iVar0], 0)) < 400f)
				{
					...
					{
						if (!func_55() && !AI::IS_PED_IN_WRITHE(uLocal_85[iVar0]))
						{
...
int func_85()
{
	if ((Global_111627 == func_29() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_111628)
	{
		return 1;
	}
	return 0;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_105(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_108()
{
	func_114(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_113(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_112(&uVar0, TIME::GET_CLOCK_HOURS());
	func_111(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_110(&uVar0, TIME::GET_CLOCK_MONTH());
	func_109(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
Vector3 func_146()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_51, 1);
		iLocal_60 = 1;
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_54, 1) < fVar0)
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_54, 1);
			iLocal_60 = 2;
		}
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_57, 1) < fVar0)
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_57, 1);
			iLocal_60 = 3;
		}
		if (iLocal_60 == 1)
		{
