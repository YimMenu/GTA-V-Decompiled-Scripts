...
int func_93(struct<3> Param0, int iParam3)
{
	if (iParam3 != -1)
	{
		...
		if (SYSTEM::VDIST2(Param0, Global_41432[iParam3 /*5*/]) <= (Global_41432[iParam3 /*5*/].f_3 * Global_41432[iParam3 /*5*/].f_3))
		{
			return 1;
		}
...
void func_107()
{
	...
	if (iLocal_92 != Global_7359)
	{
		...
		func_79(Global_19467, "SET_TITLEBAR_TIME", SYSTEM::TO_FLOAT(iLocal_91), SYSTEM::TO_FLOAT(iLocal_92), -1f, -1f, -1f, &Local_94, 0, 0, 0, 0);
		if (Global_19429 == 0)
		{
			func_89();
		}
