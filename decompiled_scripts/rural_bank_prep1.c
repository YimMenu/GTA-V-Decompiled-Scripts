	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102423.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102423.f_4, false))
		{
			if (func_146(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_143(ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
...
int func_165(int iParam0)
{
	if (!func_164())
	{
		if (func_37(Local_94[0 /*2*/]) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_94[0 /*2*/], 1364.248f, 3620.511f, 33.89069f, 1350.9f, 3616.225f, 37.12358f, 6.5f, false, true, 0))
		{
			...
			{
				if (PED::IS_PED_IN_VEHICLE(iParam0, Local_94[0 /*2*/], false) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_94[0 /*2*/], -1, 0) == iParam0)
				{
					return 1;
				}
			}
...
bool func_181()
{
	return MISC::IS_BIT_SET(Global_2540612.f_833, 2);
}
...
{
	func_274(&Global_105407, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_284(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2552060[iParam0 /*3*/][func_285(iParam1)];
...
int func_287(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2588062[iParam0 /*3*/][func_285(iParam1)];
...
void func_338(int iParam0, struct<3> Param1)
{
	...
	{
		HUD::SET_BLIP_COORDS(Global_31346[iParam0 /*23*/].f_19, Param1);
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 <= 2)
