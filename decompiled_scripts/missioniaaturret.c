...
int func_66(struct<3> Param0, var uParam1, var uParam2, var uParam3)
{
...
void func_448(var uParam0, var uParam1, int iParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5, bool bParam6, int iParam7, int iParam8, int iParam9)
{
	if (uParam0->f_20 < 17)
	{
