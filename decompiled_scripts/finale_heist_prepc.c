void __EntryFunction__()
{
	...
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(-1800170043, true);
...
void func_1()
{
	switch (iLocal_93)
	{
		case 0:
			...
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_143))
			{
				func_16(sLocal_143);
			}
			else
		...
		case 1:
			if (func_7())
			{
				...
				if (OBJECT::_DOES_DOOR_EXIST(Local_119))
				{
					OBJECT::_SET_DOOR_AJAR_ANGLE(Local_119, 0f, 1, 0);
					OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Local_119, 1, 1, 1);
				}
				func_2();
				func_462();
			}
...
void func_10(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_12(Global_111638.f_18528[iVar0], &Var2, &fVar5))
			{
...
void func_20()
{
	func_203(&iLocal_176, &uLocal_177, &iLocal_95, &uLocal_147, &uLocal_146, Local_157, 0, 0, 1090519040);
	func_196();
	switch (iLocal_93)
	{
		case 0:
			if (func_65(iLocal_92, bLocal_28))
			{
				...
				if (!OBJECT::_DOES_DOOR_EXIST(Local_96))
				{
					OBJECT::ADD_DOOR_TO_SYSTEM(Local_96, -190780785, -440.0606f, -2171.827f, 11.3672f, 1, 1, 0);
					OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Local_96, 1, 1, 1);
				}
				if (!OBJECT::_DOES_DOOR_EXIST(Local_119))
				{
					OBJECT::ADD_DOOR_TO_SYSTEM(Local_119, -190780785, -445.3054f, -2171.827f, 11.3672f, 1, 1, 0);
					OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Local_119, 1, 1, 1);
				}
		...
		case 1:
			...
			{
				VEHICLE::_0x02398B627547189C(iLocal_176, 0);
				VEHICLE::_0x79DF7E806202CE01(iLocal_176, 200);
...
void func_23(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam1 == 1)
	{
		if ((iLocal_37 != 0 && iLocal_37 != 966099553) && iLocal_37 != -72657034)
		{
			if (func_5(PLAYER::PLAYER_PED_ID()))
			{
...
void func_35()
{
	...
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Local_119, 2, 1, 1);
	func_42(1, func_43());
	if (func_4(iLocal_176))
	{
...
int func_55(int iParam0, int iParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
	{
		if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar0, -1, 0) == PLAYER::PLAYER_PED_ID())
		{
			...
			{
				VEHICLE::_SET_VEHICLE_HALT(iVar0, iParam0, iParam1, 0);
				return 0;
			}
		}
		else
...
void func_77()
{
	if (Global_98744.f_12[0] == 1)
	{
		...
		if (!func_4(Local_178))
		{
			func_79(&Local_178, Var0, fVar3, 1, 0, 0, 0, 1, -1903012613, 0, 145, 1);
		}
		func_78(Local_178, 0);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_178, 1);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(-1800170043, true);
		if (!func_456())
		{
		...
		if (Global_111638.f_2358.f_539.f_2407[0][iParam1] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[0][iParam1]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[0][iParam1], Param2, fParam5, 0, 0, 0);
				...
				func_142(iParam0, &(Global_111638.f_2358.f_539.f_2407[0][iParam1].f_31), &(Global_111638.f_2358.f_539.f_2407[0][iParam1].f_81));
		...
		else if (Global_111638.f_2358.f_539.f_2407[1][iParam1] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[1][iParam1]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[1][iParam1], Param2, fParam5, 0, 0, 0);
				...
				func_142(iParam0, &(Global_111638.f_2358.f_539.f_2407[1][iParam1].f_31), &(Global_111638.f_2358.f_539.f_2407[1][iParam1].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == -1435919434)
...
void func_81(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	if ((func_150(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_85(iParam1, &(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_31), &(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_81));
			if (bParam3)
			{
				...
				Global_111638.f_20113[iParam0].f_31 = func_84(*iParam1);
				...
				func_82(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_5, Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_7, iVar3, 1, &(Global_111638.f_20113[iParam0].f_1));
				...
				func_82(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_6, -1, iVar3, 0, &(Global_111638.f_20113[iParam0].f_2));
			}
		}
	}
}
...
int func_86(int iParam0, bool bParam1, var uParam2)
{
	*uParam2 = 0;
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_87(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != 873639469) && ENTITY::GET_ENTITY_MODEL(iParam0) != -1177863319)
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_88(int iParam0)
{
	if (iParam0 != func_91())
	{
		if (func_90(iParam0, 1, 1))
		{
			...
			{
				return func_89(Global_2425662[iParam0].f_310.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_94(int iParam0)
{
	if (iParam0 != func_91())
	{
		if (func_90(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_89(Global_2425662[iParam0].f_310.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_95(int iParam0)
{
	if (iParam0 != func_91())
	{
		if (func_90(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_89(Global_2425662[iParam0].f_310.f_5) == 7;
			}
		}
	}
	return 0;
...
int func_112(int iParam0)
{
	if (iParam0 != func_91())
	{
		if (func_90(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1 && Global_2425662[iParam0].f_310.f_8 != func_91())
			{
				return func_89(Global_2425662[iParam0].f_310.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_113(int iParam0)
{
	if (iParam0 != func_91())
	{
		if (func_90(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1 && Global_2425662[iParam0].f_310.f_8 != func_91())
			{
				return func_89(Global_2425662[iParam0].f_310.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_114(int iParam0)
{
	if (iParam0 != func_91())
	{
		if (func_90(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_89(Global_2425662[iParam0].f_310.f_5) == 9;
			}
		}
	}
	return 0;
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_137(iParam0, 0, 0)) || func_137(iParam0, 1, 0)) || func_137(iParam0, 2, 0)) || func_136(iParam0) != 145) || func_135(iParam0)) || func_134(iParam0)) || func_87(iParam0)) || func_133(iParam0)) || !func_123(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_134(iParam0))
		{
		}
...
void func_152(int iParam0)
{
	...
	if (func_159(&(Global_75441.f_555[0]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_158(iParam0, 0)) && Global_76350.f_66 == 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0].f_14] != 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0].f_14] > 3) && (!func_156(0, Global_75441.f_555[0].f_12) || !func_156(1, Global_75441.f_555[0].f_12)))
			{
				func_155(&(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]), &Global_76350);
...
int func_156(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_157(&(Global_111638.f_32744.f_5038[iVar0])))
	{
		return 0;
	}
	return func_124(Global_111638.f_32744.f_5038[iVar0][iParam0].f_66, 0);
}
...
int func_159(var uParam0, int iParam1)
{
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_160(Global_111638.f_32744.f_1864[uParam0->f_14], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_160(Global_111638.f_2358.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_160(Global_111638.f_2358.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, 0))
		{
...
{
	return func_162(&(Global_105187.f_2890), Param0, fParam3, 0);
}
	...
	if (func_179(uParam0))
	{
		...
		if (func_178(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_164(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_164(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_166(iParam0, uVar1[iVar6], 1) && func_165(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_160(Param1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_167(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		else if (uParam1->f_66 == 340154634 || uParam1->f_66 == -1960756985)
		{
			...
			while (iVar2 <= 9)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_119(iVar2)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_119(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_119(iVar3)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_119(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_119(iVar4)))
					{
					}
					else
					{
						GAMEPLAY::SET_BIT(&(uParam1->f_77), func_119(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_170(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_169())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_119(iVar5 + 1)))
				{
...
int func_179(var uParam0)
{
	...
	if (uParam0->f_12.f_66 == -2122757008 && func_165(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
int func_190()
{
	...
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_95241[func_191()], 0))
		{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), -1800170043))
		{
...
int func_192(int iParam0, struct<3> Param1, float fParam4)
{
	switch (iParam0)
	{
		...
		case 1:
			UI::REQUEST_ADDITIONAL_TEXT(sLocal_144, 0);
		...
		case 2:
			if (func_4(Global_95241[func_191()]))
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95241[func_191()], 1, 1);
...
void func_196()
{
	if (func_56(PLAYER::PLAYER_PED_ID(), Local_157, 50f))
	{
		if (!iLocal_167)
		{
			...
			AUDIO::_0x06C0023BED16DD6B(Local_119, 1);
	...
	else if (!func_56(PLAYER::PLAYER_PED_ID(), Local_157, 70f))
	{
		if (iLocal_167)
		{
			...
			AUDIO::_0x06C0023BED16DD6B(Local_119, 0);
	...
	if (iLocal_94 == 0)
	{
		if (iLocal_92 == 4)
		{
			if (func_4(iLocal_176))
			{
				...
				else if (func_198(*uParam0) && !func_50())
				{
					func_199(uParam0);
				}
				else
		...
		else if (func_202(*uParam0) || func_50())
		{
			if (bParam1)
			{
				if (Local_119.f_22 != 1)
...
void func_199(var uParam0)
{
	if (OBJECT::_DOES_DOOR_EXIST(*uParam0))
	{
		if (uParam0->f_22 != 0)
		{
			...
			{
				GAMEPLAY::CLEAR_AREA(-442.9902f, -2168.623f, 9.3184f, 5f, 0, 0, 0, 0);
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(*uParam0, 1, 1, 1);
				uParam0->f_1 = 0f;
				OBJECT::_SET_DOOR_AJAR_ANGLE(*uParam0, uParam0->f_1, 1, 1);
				uParam0->f_22 = 0;
...
int func_200(struct<16> Param0, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22)
{
	if (func_4(iLocal_176))
	{
		if (GAMEPLAY::IS_AREA_OCCUPIED(Param0.f_15[0], Param0.f_15[1], 0, 1, 1, 0, 0, 0, 0))
		{
			return 1;
		}
	}
...
void func_203(int iParam0, var uParam1, int iParam2, var uParam3, var uParam4, struct<3> Param5, int iParam8, bool bParam9, int iParam10)
{
	if (func_4(*iParam0))
	{
		switch (*iParam2)
		{
			case 0:
				...
				else
				{
					...
					{
						UI::CLEAR_THIS_PRINT(func_54(func_41(), bParam9));
					}
					if (func_41() != 33)
					{
						func_208(iParam0);
			...
			case 2:
			case 1:
				if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, 0) && !func_211(*iParam0)) && !func_210(*iParam0))
				{
					func_19(uParam4);
					if (!ENTITY::IS_ENTITY_AT_COORD(*iParam0, Param5, iParam10, iParam10, 2f, 0, 1, 2))
					{
						func_204(uParam3, *iParam0, 1);
					}
					*iParam2 = 0;
				}
				break;
...
void func_204(var uParam0, int iParam1, int iParam2)
{
	if (!UI::DOES_BLIP_EXIST(*uParam0))
	{
		*uParam0 = func_205(iParam1, iParam2, 5);
	}
}
				...
				if (func_4(iVar0))
				{
					...
					else if (iVar1 == -1323100960)
					{
						...
						if (func_5(iVar2))
						{
							...
							if (ENTITY::GET_ENTITY_MODEL(iVar0) == 1917016601)
							{
								*uParam1 = *uParam0;
								func_207(uParam0);
								*uParam0 = iVar0;
...
{
	if ((func_416(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_4(iParam0))
	{
...
void func_212()
{
	func_203(&iLocal_176, &uLocal_177, &iLocal_95, &uLocal_147, &uLocal_146, Local_157, 0, 1, 1090519040);
	func_196();
	func_240();
	switch (iLocal_93)
	{
		...
		case 1:
			...
			if (func_223(iLocal_176, Local_157, &uLocal_146, iLocal_94, iLocal_95, &iLocal_145, &iLocal_175, 0, 0, 1086324736) && func_50())
			{
				iLocal_93 = 2;
			}
			break;
...
int func_223(int iParam0, struct<3> Param1, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, float fParam11)
{
...
{
	if ((ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) && ENTITY::GET_ENTITY_MODEL(iParam0) == -1800170043)
	{
...
void func_226()
{
	...
	while (iVar0 < 3)
	{
		...
		if (!PED::IS_PED_INJURED(iVar1))
		{
			...
			else if (func_228(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1))
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iVar1, -1273030092) != 1 && AI::GET_SCRIPT_TASK_STATUS(iVar1, -1273030092) != 0)
				{
					AI::TASK_VEHICLE_MISSION_COORS_TARGET(iVar1, PED::GET_VEHICLE_PED_IS_IN(iVar1, 0), Local_154, 4, 20f, 786469, 2f, 10f, 1);
				}
			}
			else
			{
...
int func_234(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_238() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_235(func_237(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_235(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0][func_236(iParam1)];
...
void func_241(int iParam0, int iParam1)
{
	if (!iLocal_189[iParam0])
	{
		if (func_242(iParam1))
		{
			if (func_193(&(uLocal_185[iParam0]), -1800170043, Local_193[iParam0], fLocal_203[iParam0], 1))
			{
				iLocal_189[iParam0] = 1;
				func_167(uLocal_185[iParam0], &(Global_111638.f_32744.f_4803[iParam0]), 0, 1);
...
void func_243()
{
	func_203(&iLocal_176, &uLocal_177, &iLocal_95, &uLocal_147, &uLocal_146, Local_154, 0, 0, 1090519040);
	switch (iLocal_93)
	{
		case 0:
			if (func_65(iLocal_92, bLocal_28))
...
int func_245()
{
	...
	{
		case 0:
			STATS::STAT_GET_INT(-1744069936, &uVar0, -1);
			break;
		
		case 1:
			STATS::STAT_GET_INT(799609312, &uVar0, -1);
			break;
		
		case 2:
			STATS::STAT_GET_INT(181688102, &uVar0, -1);
			break;
	}
	return uVar0;
}
...
void func_247()
{
	...
	switch (iLocal_93)
	{
		...
		case 1:
			...
			if (func_223(iLocal_176, Local_154, &uLocal_146, iLocal_94, iLocal_95, &iLocal_145, &iLocal_175, 0, 1, 1086324736) || func_232())
			{
...
void func_260(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_261(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_262(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76434[1] = { func_310(iVar10, iParam1, iParam2, -1) };
		if (!func_309(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76434[1] = { func_310(iVar10, iVar0, uVar11[iVar0], -1) };
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1] = { func_310(iVar10, 14, uVar28[iVar1], -1) };
							func_282(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
							func_304(14);
							if (Global_76432 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_272(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_272(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_272(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_304(iVar0);
						if (Global_76432 == 1)
						{
			...
			{
				Global_76434[1] = { func_310(iVar10, iVar0, func_271(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1] = { func_310(iVar10, 14, uVar69[iVar1], -1) };
			func_282(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
			func_304(14);
			if (Global_76432 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_272(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_272(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_272(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
int func_263(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_375(iParam0, Global_111638.f_2358.f_539[iVar0].f_64, Global_111638.f_2358.f_539[iVar0].f_63))
		{
...
{
	Global_76434[1] = { func_310(iParam0, iParam1, iParam2, -1) };
...
int func_270(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_375(iParam0, Global_111638.f_2358.f_539[iVar0].f_61, Global_111638.f_2358.f_539[iVar0].f_60) || iParam3 == 1)
		{
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								if (!func_275(-1692214353, iVar3, iVar5, iVar4, &iVar6))
								{
									if (iVar6 != -99)
									{
										iVar0 = iVar6;
...
void func_282(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_283(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_284(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_272(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_289(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_272(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_289(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_296(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_296(Var16.z)] = func_289(iParam1, Var16.x, func_296(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_296(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_284(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_284(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_284(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_284(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_304(int iParam0)
{
	...
	{
		func_308(iParam0, Global_76434[1].f_5, Global_76434[1].f_2, 2, Global_76434[1].f_1, 1, 0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 1) && GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_306(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2548434[iParam0][func_236(iParam2)];
	if (iVar0 != 0)
	{
...
void func_312(int iParam0)
{
	...
	func_313(&(Global_76434[0]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_320(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_313(&(Global_76434[0]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_313(&(Global_76434[0]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_313(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_313(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_272(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_375(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76434[1] = { func_310(iVar0, iParam1, iParam2, -1) };
	if (!GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_375(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_375(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76434[2] = { func_310(iVar0, 14, iVar4, -1) };
									if (Global_76434[2].f_12 == iVar3)
									{
										if (func_375(iParam0, 14, iVar4))
										{
											if (!func_268(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76434[2])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76434[2] = { func_310(iVar0, iVar2, iVar1, -1) };
						if (!func_268(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76434[2])))
						{
							return 0;
						}
					}
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_272(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_272(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_379()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			func_380(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, 1), ENTITY::GET_ENTITY_HEADING(iVar0), 24, 0);
		}
	}
}
...
void func_380(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_394(iParam5, &Var0, Param1, uParam4, func_136(iParam0));
...
var func_383()
{
	...
	func_386(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_385(&uVar0, TIME::GET_CLOCK_MONTH());
	func_384(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
void func_394(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6)
{
	if (func_159(&(Global_75441.f_555[0]), iParam0))
	{
		...
		{
			func_395(iParam0);
			func_155(uParam1, &(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]));
...
int func_404(int iParam0)
{
	...
	else if (VEHICLE::_0x27B926779DEB502D(uParam0, 1))
	{
		iVar8 += 25;
	}
	...
	else if (VEHICLE::_0x27B926779DEB502D(uParam0, 0))
	{
		iVar8 += 25;
	}
...
void func_411()
{
	if (!func_4(iLocal_176))
	{
		if (!func_4(uLocal_177) && !func_4(Local_178))
		{
			func_407(1);
			return;
		}
	...
	else
	{
		...
		{
			if (!func_413(PLAYER::PLAYER_PED_ID(), uLocal_177, 500f, 1))
			{
				iVar0++;
			}
		}
...
int func_419(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				case 0:
					func_447(99, 1);
					func_446(-656546900, iParam3);
					break;
				
				case 1:
					func_446(-2098183071, iParam3);
					break;
				
				case 2:
					func_446(1578119842, iParam3);
					break;
			}
			func_431(0);
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_446(-1190521599, iParam3);
							break;
						
						case 1:
							func_446(490143716, iParam3);
							break;
						
						case 2:
							func_446(121069433, iParam3);
							break;
					}
					if (func_427(1))
					{
				...
				case 21:
					...
					{
						case 0:
							func_446(219506691, iParam3);
							break;
						
						case 1:
							func_446(1871505786, iParam3);
							break;
						
						case 2:
							func_446(-2024399847, iParam3);
							break;
					}
					break;
				...
				case 25:
					...
					{
						case 0:
							func_446(27639974, iParam3);
							break;
						
						case 1:
							func_446(422258364, iParam3);
							break;
						
						case 2:
							func_446(316202960, iParam3);
							break;
					}
					break;
				...
				case 113:
					...
					{
						case 0:
							func_446(1806738963, iParam3);
							break;
						
						case 1:
							func_446(1576781520, iParam3);
							break;
						
						case 2:
							func_446(671882196, iParam3);
							break;
					}
					break;
				...
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case -123529621:
							...
							{
								case 0:
									func_446(408653638, iParam3);
									break;
								
								case 1:
									func_446(-424799277, iParam3);
									break;
								
								case 2:
									func_446(-558138038, iParam3);
									break;
							}
							break;
						...
						case -1215733929:
							...
							{
								case 0:
									func_446(2038531975, iParam3);
									break;
								
								case 1:
									func_446(-572903575, iParam3);
									break;
								
								case 2:
									func_446(-953947924, iParam3);
									break;
							}
							if (func_427(0))
							{
						...
						case 468388854:
							...
							{
								case 0:
									func_446(-445823242, iParam3);
									break;
								
								case 1:
									func_446(-1386757215, iParam3);
									break;
								
								case 2:
									func_446(-727828275, iParam3);
									break;
							}
							break;
						...
						case 499562112:
							...
							{
								case 0:
									func_446(-1744069936, iParam3);
									break;
								
								case 1:
									func_446(799609312, iParam3);
									break;
								
								case 2:
									func_446(181688102, iParam3);
									break;
							}
							func_426(iParam3);
							break;
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_446(-330339780, iParam3);
					break;
				
				case 1:
					func_446(1697564429, iParam3);
					break;
				
				case 2:
					func_446(1674823841, iParam3);
					break;
			}
			break;
...
void func_422(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_424()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_424()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_423(iParam0));
...
bool func_427(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_424()].f_6174.f_10, iParam0);
}
...
void func_453()
{
	...
	if (Global_98744.f_12[0] != 1)
	{
		...
		{
			func_455(PLAYER::PLAYER_PED_ID(), Var0, fVar3);
		}
		else
		{
			func_454(Var0, fVar3, 1, 0);
		}
	}
	else
	{
...
void func_455(int iParam0, struct<3> Param1, float fParam4)
{
	if (func_416(uParam0))
	{
...
struct<23> func_459(int iParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, struct<3> Param10, struct<3> Param13, struct<3> Param16)
{
	Var0.f_15 = 2;
	Var0 = iParam0;
	Var0.f_1 = 0f;
...
void func_460()
{
	...
	{
		case 80:
			Local_178 = { func_461(-311.1739f, -771.6993f, 52.2467f, 182.106f, -1800170043, 13) };
			Local_157 = { -442.189f, -2183.603f, 9.31981f };
			break;
		
		case 81:
			Local_178 = { func_461(-657.8753f, -272.2921f, 34.7628f, 30.6575f, -1800170043, 4) };
			Local_157 = { -442.189f, -2183.603f, 9.31981f };
			break;
		
		case 82:
			Local_178 = { func_461(307.123f, -1084.801f, 28.3597f, 299.7018f, -1800170043, 0) };
			Local_157 = { -442.189f, -2183.603f, 9.31981f };
			break;
	}
	iLocal_189[0] = 0;
	iLocal_189[1] = 0;
	iLocal_189[2] = 0;
	Local_193[0] = { -438.2076f, -2181.515f, 9.3253f };
	Local_193[1] = { -442.1008f, -2181.29f, 9.3195f };
	Local_193[2] = { -445.3427f, -2181.132f, 9.3183f };
	fLocal_203[0] = 181.2117f;
	fLocal_203[1] = 180.056f;
	fLocal_203[2] = 181.0495f;
}

struct<7> func_461(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	Var0.f_1 = { Param0 };
	Var0.f_4 = fParam3;
	Var0.f_6 = iParam4;
	...
	while (iVar1 < Global_30779)
	{
		if (bParam2)
		{
			if (Global_30779[iVar1] == 0 && !bVar0)
			{
				...
				Global_30801[iVar1] = (GAMEPLAY::GET_GAME_TIMER() + iParam3);
				Global_30812 = 1;
				bVar0 = true;
			}
