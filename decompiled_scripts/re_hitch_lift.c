...
void func_68()
{
	...
	if (iLocal_58 == 1)
	{
		...
		{
			if (ENTITY::IS_ENTITY_AT_COORD(iLocal_71, -1046.832f, -2518.146f, 12.9447f, 20f, 20f, 5f, 0, 1, 0) || SYSTEM::TIMERB() > 15000)
			{
				PED::DELETE_PED(&iLocal_71);
				func_24();
			}
...
void func_132()
{
	if (!PED::IS_PED_INJURED(iLocal_71))
	{
		...
		else if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_77, 50f, 50f, 50f, 0, 1, 0))
		{
			if (HUD::DOES_BLIP_EXIST(uLocal_69))
			{
				HUD::REMOVE_BLIP(&uLocal_69);
...
void func_146()
{
	if (bLocal_92)
	{
		...
		{
			if ((((PED::IS_PED_INJURED(iLocal_72) || !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID(), 150f, 150f, 150f, 0, 1, 0)) || SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_77) < 250f) || SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_79) < 250f) || iLocal_94)
			{
				if (HUD::DOES_BLIP_EXIST(uLocal_100))
				{
					HUD::REMOVE_BLIP(&uLocal_100);
			...
			else
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_72))
				{
					...
					func_147(iLocal_139, PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_153, &uLocal_156, &Local_158, &uLocal_157, &uLocal_159, 0f, 0f, 0f, 1500, 0f);
...
void func_147(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, struct<3> Param7, int iParam8, float fParam9)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (((((((ENTITY::DOES_ENTITY_EXIST(iParam1) && iParam0 != iParam1) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iParam1))) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(iParam1)) && func_152(iParam0))
		{
			...
			{
				if (func_149(iParam0, iParam1, 1) > fParam9 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam1, 1), *uParam2, 1) > 20f)
				{
					if (!func_148(*uParam2))
					{
						...
						{
							Var0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_158, uLocal_157, Param7) };
							if (!func_148(Var0))
							{
			...
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_67, 1) > 320f && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (PED::IS_PED_IN_VEHICLE(iLocal_71, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
					{
						...
						{
							if (!CAM::IS_SPHERE_VISIBLE(Local_62, 7f) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_62) < 110f)
							{
								STREAMING::REQUEST_MODEL(iLocal_81);
								if (STREAMING::HAS_MODEL_LOADED(iLocal_81))
								{
									...
									{
										iLocal_139 = VEHICLE::CREATE_VEHICLE(iLocal_82, Local_62, func_157(Local_62, func_158(PLAYER::PLAYER_ID()), 1), 1, 1, 0);
...
void func_190()
{
	if (iLocal_58 == 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_71))
		{
			...
			{
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -3024.265f, 660.8264f, 1.1982f, -3140.823f, 803.707f, 35.131f, 93f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_71)) || func_184(PLAYER::PLAYER_PED_ID(), iLocal_71) < 12f)
				{
					func_191();
					iLocal_57 = 2;
				}
