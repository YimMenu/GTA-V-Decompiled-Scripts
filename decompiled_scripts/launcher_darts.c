void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			fVar24 = 0f;
			if (MISC::GET_GROUND_Z_FOR_3D_COORD(Var0.f_1[0], &fVar24, 0, 0))
			{
				if (fVar24 != 0f)
				{
...
void func_51(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_52(iParam0) && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_89532[26].f_6) == 0)
			{
				Global_111638.f_7256[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_111638.f_7256[iParam0], 1, 1);
			}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_60(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
