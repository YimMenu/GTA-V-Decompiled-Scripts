void __EntryFunction__()
{
	...
	{
		Local_90 = { ENTITY::GET_ENTITY_COORDS(iScriptParam_0, 1) };
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_115(uLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
	...
	while (true)
	{
		...
		{
			fVar24 = 0f;
			if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Var0.f_1[0], &fVar24, 0, 0))
			{
				if (fVar24 != 0f)
				{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_85) && !ENTITY::IS_ENTITY_DEAD(iLocal_85, 0))
		{
			...
			uLocal_93 = SYSTEM::VDIST2(Local_87, Var0.f_1[0]);
			uLocal_93 = uLocal_93;
			Local_111 = { Local_87 };
			Local_114 = { Var0.f_1[0] };
			Local_111.z = 0f;
			Local_114.z = 0f;
			...
			switch (iLocal_95)
			{
				case 0:
					...
					else
					{
						...
						if ((Local_87.z - Var0.f_1[0].f_2) > 500f)
						{
						}
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						if (bVar26)
						{
							if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_85, Var0.f_1[0], fLocal_117, fLocal_117, 2f, 0, 1, iLocal_103))
							{
								bVar26 = false;
							}
							...
							if (bVar26)
							{
								...
								if (func_77(uLocal_86))
								{
									...
									else if (!func_115(uLocal_94, 2048) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_75(&iLocal_96);
...
void func_2()
{
	if (bLocal_146)
	{
		...
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-472443277);
	}
}
			...
			if (fVar32 < (10f * 10f))
			{
				...
				if (!func_101(6) && !func_101(7))
				{
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_143, 0))
					{
						...
						AI::TASK_LOOK_AT_ENTITY(iLocal_143, uLocal_144, -1, 2049, 3);
				...
				else
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_143, 0))
					{
						...
						{
							AI::TASK_USE_NEAREST_SCENARIO_TO_COORD(iLocal_143, 1991.677f, 3044.957f, 46.21505f, 0.5f, 0);
						}
						else
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_143, 1991.677f, 3044.957f, 46.21505f, 1f, 20000, 1048576000, 0, 1193033728);
						}
					...
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_144, 0))
					{
						...
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_144, 1990.37f, 3045.121f, 46.21502f, 1f, 20000, 1048576000, 0, 1193033728);
						}
...
void func_51(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_52(iParam0) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_89532[26].f_6) == 0)
			{
				Global_111638.f_7256[iParam0] = 1;
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_111638.f_7256[iParam0], 1, 1);
			}
...
var func_54()
{
	...
	func_57(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_56(&uVar0, TIME::GET_CLOCK_MONTH());
	func_55(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_60(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_78(var uParam0, struct<3> Param1, struct<3> Param4, var uParam7)
{
	...
	{
		case 0:
			uParam0->f_2 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(Param1, Param4, 19, uParam7, 7);
			*uParam0 = 1;
			break;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_96()) || Global_110685) || Global_30770) || func_95()) || func_81(8, -1)) || func_94()) || func_93()) || func_92()) || func_83()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_96()) || Global_30770) || func_95()) || func_81(8, -1)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_96()) || Global_110685) || Global_30770) || func_95()) || func_81(8, -1)) || func_94()) || func_93()) || func_83()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_96()) || Global_30770) || func_95()) || func_81(8, -1)) || func_93()) || func_92()) || func_83()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_96()) || func_93()) || Global_110685) || Global_30770) || func_95()) || Global_42596) || func_81(8, -1)) || func_92()) || func_91()) || func_83()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_96()) || Global_110685) || Global_30770) || func_95()) || func_81(8, -1)) || func_92()) || func_91()) || func_94()) || func_93()) || func_83())
						{
							return 0;
						}
						break;
...
void func_102()
{
	if (bLocal_146)
	{
		...
		if ((fVar6 > 45f || Global_111600) && !ENTITY::DOES_ENTITY_EXIST(iLocal_143))
		{
			...
			fVar21 = 142.6717f;
			fVar22 = 44.8785f;
			uVar23 = INTERIOR::GET_INTERIOR_AT_COORDS(func_71(iLocal_148));
			...
			iLocal_143 = PED::CREATE_PED(26, iLocal_141, func_104(iLocal_148 == 1, Var7, Var13), func_103(iLocal_148 == 1, fVar19, fVar21), 1, 1);
			iLocal_144 = PED::CREATE_PED(26, iLocal_142, func_104(iLocal_148 == 1, Var10, Var16), func_103(iLocal_148 == 1, fVar20, fVar22), 1, 1);
...
int func_105()
{
	if (bLocal_146)
	{
		return ((STREAMING::HAS_MODEL_LOADED(iLocal_141) && STREAMING::HAS_MODEL_LOADED(iLocal_142)) && STREAMING::HAS_MODEL_LOADED(-472443277));
	}
	return 1;
}
...
void func_106()
{
	if (bLocal_146)
	{
		...
		STREAMING::REQUEST_MODEL(-472443277);
...
void func_116()
{
	...
	iLocal_105 = 67;
	bVar0 = false;
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_71(2), 100f, 100f, 100f, 0, 0, 0))
	{
		bVar0 = true;
	}
	if (!bVar0)
