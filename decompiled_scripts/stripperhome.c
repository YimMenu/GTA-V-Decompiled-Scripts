...
int func_12()
{
	...
	if (func_267(uLocal_333, 8192))
	{
		...
		{
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(96.12f, -1284.91f, 29.43f, 5f, 668467214, 0))
			{
				OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(668467214, 96.12f, -1284.91f, 29.43f, 1, 0f, 0);
			}
...
void func_26()
{
	...
	if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(96.12f, -1284.91f, 29.43f, 5f, 668467214, 0))
	{
		OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(668467214, 96.12f, -1284.91f, 29.43f, 0, 0f, 0);
	}
...
void func_40(bool bParam0)
{
	...
	{
		STATS::_0x0BCA1D2C47B0D269(131, func_44(), 0f);
		STATS::_0x0BCA1D2C47B0D269(108, func_43(), 0f);
		STATS::_0x0BCA1D2C47B0D269(102, func_42(), 0f);
		STATS::_0x0BCA1D2C47B0D269(8, func_41(), 0f);
	}
	iLocal_66 = 0;
	iLocal_67 = 0;
	iLocal_68 = 0;
...
void func_94(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		AI::TASK_PLAY_ANIM(0, sVar2, func_95(0, bParam2, bParam1, bVar1), 8f, -8f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, sVar2, func_95(1, bParam2, bParam1, bVar1), 8f, -4f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, sVar2, func_95(2, bParam2, bParam1, bVar1), 8f, -4f, iParam3, 1, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, sVar2, func_95(3, bParam2, bParam1, bVar1), 8f, -4f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(0, sVar2, func_95(4, bParam2, bParam1, bVar1), 4f, -2f, -1, 0, 0, 0, 0, 0);
...
void func_108()
{
	...
	if (!bLocal_71 && iLocal_75 >= 5)
	{
		...
		{
			if (ENTITY::GET_ENTITY_MODEL(iVar0) == -613725916)
			{
				bLocal_71 = false;
			}
	...
	switch (iLocal_75)
	{
		...
		case 2:
			if (!CAM::IS_CAM_RENDERING(uLocal_284[0]))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_340, 0))
				{
					if (ENTITY::GET_ENTITY_MODEL(iLocal_340) == -613725916)
					{
				...
				if (func_145(iLocal_330, 0, sLocal_277, "", &Local_289, (func_200(&uLocal_255) * 0.2f), 0))
				{
					if (!func_171())
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_340))
						{
							if (ENTITY::GET_ENTITY_MODEL(iLocal_340) != -613725916)
							{
								GAMEPLAY::CLEAR_AREA(Local_305, 20f, 1, 0, 0, 0);
							}
						}
						else
						{
	...
	if (bParam1)
	{
		if (!bVar0)
		{
			...
			switch (iParam2)
			{
				...
				case 6:
				case 7:
					GAMEPLAY::SET_BIT(&(Global_2097152[func_128()].f_6174.f_1272), iParam0);
...
void func_142()
{
	...
	else
	{
		...
		AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_314, 1f, -1, 0.25f, 0, fLocal_326);
		if (iVar0 < 15000)
		{
	...
	switch (uParam4->f_3)
	{
		...
		case 2:
			...
			if (fParam5 >= 0.99f || fParam5 == -1f)
			{
				...
				TIME::SET_CLOCK_TIME(func_153(iVar4), func_152(iVar4), func_151(iVar4));
			...
			TIME::SET_CLOCK_TIME(func_153(iVar4), func_152(iVar4), func_151(iVar4));
			if (func_149(iVar4) != TIME::GET_CLOCK_DAY_OF_MONTH())
			{
				TIME::SET_CLOCK_DATE(func_149(iVar4), func_148(iVar4), func_146(iVar4));
			}
			func_256();
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_147(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_169()
{
	...
	func_167(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_168(&uVar0, TIME::GET_CLOCK_HOURS());
	func_162(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_163(&uVar0, TIME::GET_CLOCK_MONTH());
	func_161(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
int func_192()
{
	if ((UI::IS_MESSAGE_BEING_DISPLAYED() || AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()) || Global_20805 != 0)
	{
		return 0;
	}
	return 1;
...
void func_201()
{
	...
	while (iVar0 < 4)
	{
		...
		{
			uLocal_284[iVar0] = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var1[iVar0], Var14[iVar0], uVar27[iVar0], 0, 2);
			CAM::SHAKE_CAM(uLocal_284[iVar0], "HAND_SHAKE", 0.3f);
		}
		iVar0++;
	}
	Local_289.f_4 = CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", 0);
	CAM::ADD_CAM_SPLINE_NODE(Local_289.f_4, Var1[0], Var14[0], 6000, 3, 2);
	CAM::ADD_CAM_SPLINE_NODE(Local_289.f_4, Var1[1], Var14[1], 6000, 3, 2);
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		if (AI::GET_SCRIPT_TASK_STATUS(iParam0, 242628503) != 1)
		{
			...
			if (iParam0 == PLAYER::PLAYER_PED_ID())
			{
				...
				else if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(func_204()))
				{
					AI::TASK_FOLLOW_WAYPOINT_RECORDING(0, func_204(), 0, 552, -1);
				}
				else
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_302, 1f, -1, 0.25f, 64, 1193033728);
				}
			}
			if (iParam0 != PLAYER::PLAYER_PED_ID())
			{
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(func_204()))
				{
					AI::TASK_FOLLOW_WAYPOINT_RECORDING(0, func_204(), 0, 546, -1);
				}
				else
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Param1, 1f, -1, 0.25f, 1, 1193033728);
				}
				if (func_25(iParam0, Param1, 1) > 5f)
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
					AI::TASK_PLAY_ANIM(0, "gestures@f@standing@casual", "gesture_come_here_soft", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
void func_205(int iParam0, int iParam1)
{
	...
	{
		AI::TASK_VEHICLE_PARK(iParam0, iParam1, Local_308, fLocal_327, 3, 1092616192, 0);
	}
}
...
{
	if (VEHICLE::IS_VEHICLE_MODEL(iParam0, -150975354))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(iParam0, -50547061))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(iParam0, 1621617168))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(iParam0, 1394036463))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(iParam0, 788747387))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(iParam0, 745926877))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(iParam0, -1660661558))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(iParam0, 353883353))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(iParam0, 837858166))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(iParam0, 744705981))
	{
		return 1;
	}
	else if (VEHICLE::IS_VEHICLE_MODEL(iParam0, 1949211328))
	{
		return 1;
	}
	return 0;
...
void func_215(bool bParam0)
{
	...
	switch (iLocal_78)
	{
		...
		case 3:
			...
			if (!func_171())
			{
				if (func_192())
				{
					...
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_308, 10f, 0, 0, 0, 0, 0, 0);
					GAMEPLAY::CLEAR_AREA_OF_PEDS(Local_308, 10f, 0);
		...
		case 4:
			...
			else if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_308, 3f, 3f, 2f, 1, 1, 2) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_305, 5f, 5f, 2f, 1, 1, 1))
			{
				if (func_36(1, 0, 1))
				{
					iLocal_74 = 1;
		...
		case 7:
			iLocal_79 = 7;
			if ((!func_171() && !UI::IS_MESSAGE_BEING_DISPLAYED()) && !func_267(uLocal_333, 2048))
			{
				Var0 = { func_71(uLocal_76[0]) };
...
void func_216()
{
	...
	else if (func_267(uLocal_333, 4))
	{
		...
		if ((((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || func_4(&uLocal_255) > 35f) || SYSTEM::VDIST(Local_308, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 75f) || bVar3) || bVar6)
		{
			if (!bVar4 && !bVar2)
			{
				AI::TASK_PLAY_ANIM(uLocal_274[0], sVar0, func_95(4, 1, 1, func_98(iLocal_340)), 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			if (bVar3)
			{
				iLocal_335 = 2000;
...
void func_222(float fParam0, struct<3> Param1)
{
	...
	if (!func_267(uLocal_331, 1) && !func_267(uLocal_331, 128))
	{
		if (SYSTEM::VDIST(Param1, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 75f)
		{
			...
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_308, 5f, 0, 0, 0, 0, 0, 0);
		}
	}
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_224(int iParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		if (DECISIONEVENT::IS_SHOCKING_EVENT_IN_SPHERE(110, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 10f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iParam0, PLAYER::PLAYER_PED_ID()))
		{
			return 1;
		}
	}
...
void func_225()
{
	...
	if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_8(&uLocal_258);
		Local_320 = { ENTITY::GET_ENTITY_COORDS(uLocal_274[0], 1) };
		iLocal_78 = 4;
	}
	else
	{
...
int func_235(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_54() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_232(func_233(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_254(int iParam0, int iParam1)
{
	...
	{
		fVar7 = GAMEPLAY::ABSF((Var0.z - Var3.z));
		if (fVar7 > 8f)
		{
			return 1;
		}
...
void func_255()
{
	if (!ENTITY::IS_ENTITY_DEAD(uLocal_274[0], 0))
	{
		...
		{
			func_196(uLocal_274[0], OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), 0f, 2f, 0f));
			iLocal_74 = 1;
			iLocal_75 = 0;
		}
	}
...
void func_259(bool bParam0)
{
	...
	{
		iLocal_73 = func_169();
		func_159(&iLocal_73, 0, 0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5, 7), 0, 0, 0);
	}
	else if (bParam0)
	{
...
void func_262(int iParam0)
{
	if (!PED::IS_PED_INJURED(uParam0))
	{
		...
		if (AI::GET_SCRIPT_TASK_STATUS(iParam0, 242628503) != 1)
		{
			...
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_305, 1.5f, -1, 0.25f, 0, 1193033728);
			AI::CLOSE_SEQUENCE_TASK(uLocal_339);
			AI::TASK_PERFORM_SEQUENCE(iParam0, uLocal_339);
		}
	}
...
int func_268(var uParam0, bool bParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Var0) > 100f)
		{
			...
			else if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Var0) < fLocal_329)
			{
				fLocal_329 = SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Var0);
			}
			return 0;
...
{
	if (ENTITY::GET_ENTITY_MODEL(uParam0) == 1846523796)
	{
		func_281(iParam0, 2, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3));
		func_280(iParam0, 2, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3));
...
void func_282(int iParam0, int iParam1, bool bParam2)
{
	if (!PED::IS_PED_INJURED(uParam0))
	{
		...
		bVar0 = false;
		if (ENTITY::GET_ENTITY_MODEL(iParam0) == 695248020)
		{
			bVar0 = true;
		}
		switch (iParam1)
...
int func_288()
{
	...
	else if (AI::GET_IS_WAYPOINT_RECORDING_LOADED(func_204()))
	{
		return 1;
	}
	return 0;
...
void func_290()
{
	if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(func_204()))
	{
		AI::REQUEST_WAYPOINT_RECORDING(func_204());
	}
}
