	...
	if (bParam1)
	{
		if (!bVar0)
		{
			...
			switch (iParam2)
			{
				...
				case 6:
				case 7:
					MISC::SET_BIT(&(Global_2097152[func_128()].f_6174.f_1272), iParam0);
		...
		case 3:
			...
			if (!func_171())
			{
				if (func_192())
				{
					...
					MISC::CLEAR_AREA_OF_VEHICLES(Local_308, 10f, 0, 0, 0, 0, 0, 0);
...
void func_216()
{
	...
	else if (func_267(uLocal_333, 4))
	{
		...
		bVar4 = TASK::GET_SCRIPT_TASK_STATUS(uLocal_274[0], 242628503) == 7;
...
void func_222(float fParam0, struct<3> Param1)
{
	...
	if (!func_267(uLocal_331, 1) && !func_267(uLocal_331, 128))
	{
		if (SYSTEM::VDIST(Param1, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 75f)
		{
			...
			MISC::CLEAR_AREA_OF_VEHICLES(Local_308, 5f, 0, 0, 0, 0, 0, 0);
		}
	}
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
