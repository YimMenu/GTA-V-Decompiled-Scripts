	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (func_207(1, 1093140480, 0))
			{
				...
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_158, sLocal_157, 2, 25967894, 0);
				func_199();
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76434[1] = { func_116(iVar10, iParam1, iParam2, -1) };
		if (!func_115(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76434[1] = { func_116(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1] = { func_116(iVar10, 14, uVar28[iVar1], -1) };
							func_85(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
							func_107(14);
							if (Global_76432 == 1)
							{
								iVar2 = 0;
			...
			{
				Global_76434[1] = { func_116(iVar10, iVar0, func_74(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1] = { func_116(iVar10, 14, uVar69[iVar1], -1) };
			func_85(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
			func_107(14);
			if (Global_76432 == 1)
			{
...
int func_66(var uParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_180(uParam0, Global_111638.f_2358.f_539[iVar0].f_64, Global_111638.f_2358.f_539[iVar0].f_63))
		{
...
{
	Global_76434[1] = { func_116(iParam0, iParam1, iParam2, -1) };
...
int func_73(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_180(uParam0, Global_111638.f_2358.f_539[iVar0].f_61, Global_111638.f_2358.f_539[iVar0].f_60) || iParam3 == 1)
		{
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								if (!func_78(-1692214353, iVar3, iVar5, iVar4, &iVar6))
								{
									if (iVar6 != -99)
									{
										iVar0 = iVar6;
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_92(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_99(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_99(Var16.z)] = func_92(iParam1, Var16.x, func_99(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_99(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_87(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_87(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_87(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_87(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_107(int iParam0)
{
	...
	{
		func_114(iParam0, Global_76434[1].f_5, Global_76434[1].f_2, 2, Global_76434[1].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76434[1].f_6, 1) && MISC::IS_BIT_SET(Global_76434[1].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_109(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2548434[iParam0][func_110(iParam2)];
	if (iVar0 != 0)
	{
...
int func_112(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0][func_110(iParam1)];
...
void func_118(int iParam0)
{
	...
	func_119(&(Global_76434[0]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_125(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_119(&(Global_76434[0]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_119(&(Global_76434[0]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_119(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_119(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
int func_180(int iParam0, int iParam1, int iParam2)
{
	...
	Global_76434[1] = { func_116(iVar0, iParam1, iParam2, -1) };
	if (!MISC::IS_BIT_SET(Global_76434[1].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_180(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_180(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76434[2] = { func_116(iVar0, 14, iVar4, -1) };
									if (Global_76434[2].f_12 == iVar3)
									{
										if (func_180(iParam0, 14, iVar4))
										{
											if (!func_71(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76434[2])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76434[2] = { func_116(iVar0, iVar2, iVar1, -1) };
						if (!func_71(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76434[2])))
						{
							return 0;
						}
					}
...
int func_195(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_196(Var18[0], Var18[1], Var6, Var9) || func_196(Var18[0], Var18[1], Var9, Var15)) || func_196(Var18[0], Var18[1], Var12, Var15)) || func_196(Var18[0], Var18[1], Var6, Var12)) || func_196(Var18[1], Var18[3], Var6, Var9)) || func_196(Var18[1], Var18[3], Var9, Var15)) || func_196(Var18[1], Var18[3], Var12, Var15)) || func_196(Var18[1], Var18[3], Var6, Var12)) || func_196(Var18[3], Var18[2], Var6, Var9)) || func_196(Var18[3], Var18[2], Var9, Var15)) || func_196(Var18[3], Var18[2], Var12, Var15)) || func_196(Var18[3], Var18[2], Var6, Var12)) || func_196(Var18[2], Var18[0], Var6, Var9)) || func_196(Var18[2], Var18[0], Var9, Var15)) || func_196(Var18[2], Var18[0], Var12, Var15)) || func_196(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
bool func_225(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_226(&(Local_37[iVar4]), Var1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
void func_240()
{
	...
	else if (!iLocal_169)
	{
		if (func_29(Local_81.f_35[0]))
		{
			Var0 = { ENTITY::GET_ENTITY_COORDS(Local_81.f_35[0], 1) };
			uVar3 = ENTITY::GET_ENTITY_HEADING(Local_81.f_35[0]);
			func_38(&(Local_81.f_35[0]));
			Local_81.f_35[0] = VEHICLE::CREATE_VEHICLE(534258863, Var0, uVar3, 1, 1, 0);
...
void func_250()
{
	uLocal_153[0] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2333.23f, 2574.97f, 47.03f, 5f, -26664553, 1, 0, 1);
	uLocal_153[1] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2329.65f, 2576.64f, 47.03f, 5f, 914592203, 1, 0, 1);
...
int func_270(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { 2337.376f, 2585.722f, 45.11065f };
			uParam0->f_17[1] = { 2302.158f, 2586.505f, 47.99957f };
			uParam0->f_24 = 26f;
			uParam0->f_27 = 0;
		...
		case 3:
			...
			MISC::CLEAR_AREA_OF_VEHICLES(2321.252f, 2578.851f, 46.7f, 10f, 0, 0, 0, 0, 0, 0);
			iVar3 = 0;
			while (iVar3 <= (iVar0 - 1))
			{
...
void func_284(int iParam0, bool bParam1)
{
	...
	{
		func_323(&(Global_110725[iVar0].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void func_301(var uParam0)
{
	*uParam0 = 145;
	...
	while (iVar1 < 3)
	{
		...
		func_306(&(uParam0->f_25[0][iVar1]));
		func_306(&(uParam0->f_25[1][iVar1]));
		iVar0 = 0;
		while (iVar0 < 12)
		{
...
int func_311(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_76434[1] = { func_116(iVar0, iParam1, uVar31[iParam1], -1) };
...
{
	func_328(iParam0, 1);
	Global_111638.f_18569[iParam0].f_3 = func_327();
