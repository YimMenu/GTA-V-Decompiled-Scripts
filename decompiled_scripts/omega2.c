...
{
	if (GAMEPLAY::IS_BIT_SET(Global_98744.f_20, 17))
	{
		return 0;
	}
...
void func_218()
{
	...
	if (func_220())
	{
		if (GAMEPLAY::GET_GAME_TIMER() < iLocal_146 && !func_219(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 5f, 1))
		{
...
void func_240()
{
	if (!iLocal_167)
	{
		if (func_29(Local_81.f_35[0]))
		{
			...
			{
				INTERIOR::_LOAD_INTERIOR(uLocal_170);
				iLocal_167 = 1;
			}
		}
	}
...
void func_249()
{
	...
	if (func_220())
	{
		if (UI::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			...
			iLocal_146 = GAMEPLAY::GET_GAME_TIMER() + 3500;
			func_250();
			func_47(1);
		}
	}
...
int func_270(var uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 3:
			...
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(2321.252f, 2578.851f, 46.7f, 10f, 0, 0, 0, 0, 0, 0);
			iVar3 = 0;
			while (iVar3 <= (iVar0 - 1))
			{
...
void func_319()
{
	...
	{
		func_19();
		GRAPHICS::_0xBF59707B3E5ED531(func_320(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
