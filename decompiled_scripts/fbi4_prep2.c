...
int func_101(int iParam0, struct<3> Param1, int iParam4, int iParam5, int iParam6, var uParam7, int iParam8, var uParam9, var uParam10, int iParam11, float fParam12)
{
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			...
			if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Param1, fParam12, fParam12, 2f, 0, 1, 2))
			{
				...
				{
					UI::CLEAR_THIS_PRINT(func_107(func_66()));
				}
				*uParam7 = 1;
	...
	else
	{
		...
		if (!*iParam8)
		{
			...
			{
				UI::CLEAR_THIS_PRINT(func_103(func_66(), 0));
			}
...
int func_110(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
				...
				if (!func_459())
				{
					...
					else if ((((func_124(2, Local_282.f_1, Local_282.f_4) && func_124(5, Local_270.f_1, Local_270.f_4)) && func_124(6, Local_276.f_1, Local_276.f_4)) && func_124(3, Local_252.f_1, Local_252.f_4)) && func_124(4, Local_221, 0))
					{
						...
						if (func_446(Local_252))
						{
							...
							{
								AI::TASK_PLAY_ANIM_ADVANCED(Local_252, "mini@repair", "fixing_a_ped", ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270, Local_249), 0f, 0f, -ENTITY::GET_ENTITY_HEADING(Local_270), 1000f, -1.5f, -1, 1, 0, 2, 0);
						...
						{
							iVar0 = UI::GET_BLIP_FROM_ENTITY(Local_282);
		...
		case 1:
			if (bParam1)
			{
				if ((((func_124(2, Local_282.f_1, Local_282.f_4) && func_124(5, Local_270.f_1, Local_270.f_4)) && func_124(4, Local_221, 0)) && func_124(6, Local_276.f_1, Local_276.f_4)) && func_124(3, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270, Local_249), -ENTITY::GET_ENTITY_HEADING(Local_270)))
				{
...
int func_123()
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), -1323100960))
		{
		...
		switch (*iParam2)
		{
			case 0:
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, 0))
				{
					...
					if (func_94(func_102(func_66()), 0, 0))
					{
						UI::CLEAR_THIS_PRINT(func_102(func_66()));
					}
					if (*iParam0 == iParam8)
					{
						*iParam2 = 1;
				...
				else
				{
					...
					{
						UI::CLEAR_THIS_PRINT(func_103(func_66(), bParam9));
					}
					if (func_66() != 33)
					{
						func_134(iParam0);
...
int func_146(int iParam0, int iParam1)
{
	switch (iLocal_97[iParam0])
	{
		case 0:
			...
			{
				AI::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, 0), Local_224, 4, 20f, 786469, 2f, 10f, 1);
				iLocal_97[iParam0] = 5;
			}
			break;
...
int func_147(int iParam0, int iParam1)
{
	...
	if (func_446(Local_252))
	{
		...
		{
			case 0:
				Var0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_252, Var3) };
				if (!GAMEPLAY::IS_POSITION_OCCUPIED(Var0, 1.5f, 0, 0, 1, 0, 0, Local_252, 0))
				{
					if (!bLocal_248)
					{
						if (iParam0 == 0)
					...
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam1, Var0, 1f, 20000, 0.25f, 0, 82.7989f);
						PED::SET_PED_STEALTH_MOVEMENT(iParam1, 1, 0);
						if (iParam0 == 2)
						{
							WEAPON::GIVE_WEAPON_TO_PED(iParam1, -1716189206, -1, 1, 1);
							iLocal_97[iParam0] = 2;
						}
						else
						{
							WEAPON::GIVE_WEAPON_TO_PED(iParam1, -1569615261, -1, 1, 1);
							iLocal_97[iParam0] = 1;
						}
					}
				}
...
int func_152(int iParam0, int iParam1)
{
	if (!func_151())
	{
		if (func_446(Local_252))
		{
			if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam1, -408.0286f, -2175.476f, 5.31836f, -394.644f, -2175.297f, 15.31835f, 21.52f, 0, 1, 0) && !func_153(iParam0)) && !PED::IS_PED_IN_MELEE_COMBAT(Local_252)) && !PED::IS_PED_IN_ANY_VEHICLE(iParam1, 0))
			{
	...
	if (func_446(Local_252))
	{
		...
		switch (iLocal_96)
		{
			...
			case 5:
				if (func_6(Local_270))
				{
					if (func_95(Local_252, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270, Local_249), 2f))
					{
...
int func_167(char* sParam0)
{
	if (!func_168(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_188(sParam0)) || func_188("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_190(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		Var1 = { func_192(ENTITY::GET_ENTITY_COORDS(iVar0, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
void func_193()
{
	if (func_6(Local_270))
	{
		if (!func_121(Local_252, -2017877118))
		{
			if (!func_95(Local_252, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270, Local_249), 0.5f))
			{
				if (!func_121(Local_252, 713668775))
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_252, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270, Local_249), 1f, 60000, 0.3f, 512, -ENTITY::GET_ENTITY_HEADING(Local_270));
				}
			}
...
bool func_195(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_196(&(Local_50[iVar4]), Var1, iParam1, &(Local_50[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (GAMEPLAY::GET_GAME_TIMER() - Local_50[iVar4].f_3) < iParam4);
}
...
void func_211(int iParam0)
{
	switch (iParam0)
	{
		...
		case 8:
			if (func_121(Local_252, 242628503) || AI::GET_SCRIPT_TASK_STATUS(Local_252, 242628503) == 2)
			{
				AI::CLEAR_PED_TASKS(Local_252);
			}
			if (func_6(Local_276))
...
int func_272(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_282(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_314(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_282(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
void func_292(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_293(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_294(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_282(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_299(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_282(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_299(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_306(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_306(Var16.z)] = func_299(iParam1, Var16.x, func_306(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_306(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_294(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_294(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_294(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_294(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_318(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0][func_317(iParam1)];
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_318(func_328(iParam1, uParam0->f_2), Global_76431, 0);
...
void func_331(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_325(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_325(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_282(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_386(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_282(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_282(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_390()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			func_391(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, 1), ENTITY::GET_ENTITY_HEADING(iVar0), 24, 0);
		}
	}
}
...
var func_412()
{
	...
	func_415(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_414(&uVar0, TIME::GET_CLOCK_MONTH());
	func_413(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_418(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_434(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_457(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_452() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_318(func_451(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_462()
{
	Var0[0] = { -1138.69f, -1893.385f, 2.453f };
	Var0[1] = { -1067.893f, -1941.208f, 12.1445f };
	Var0[2] = { -1062.374f, -2034.396f, 12.1273f };
	Var0[3] = { -1178.806f, -2101.68f, 12.3805f };
	Var0[4] = { -1250.224f, -2047.043f, 8.9687f };
	func_463(&Var0, 5);
}
...
void func_464(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_465(uParam1, *uParam1[iVar1] + Var9))
		{
			Var9 = { -Var9 };
		}
