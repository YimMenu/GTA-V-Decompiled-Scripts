...
void func_96()
{
	func_131(&iLocal_268, &iLocal_269, &iLocal_95, &iLocal_219, &iLocal_218, Local_224, Local_282, 0, 11f);
	switch (iLocal_93)
	{
		case 0:
				...
				if (!func_459())
				{
					...
					else if ((((func_124(2, Local_282.f_1, Local_282.f_4) && func_124(5, Local_270.f_1, Local_270.f_4)) && func_124(6, Local_276.f_1, Local_276.f_4)) && func_124(3, Local_252.f_1, Local_252.f_4)) && func_124(4, Local_221, 0))
					{
						...
						if (func_446(Local_252))
						{
							...
							{
								TASK::TASK_PLAY_ANIM_ADVANCED(Local_252, "mini@repair", "fixing_a_ped", ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270, Local_249), 0f, 0f, -ENTITY::GET_ENTITY_HEADING(Local_270), 1000f, -1.5f, -1, 1, 0f, 2, 0);
								PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_252, false, false);
							}
							func_120();
							func_118();
...
int func_124(int iParam0, struct<3> Param1, float fParam4)
{
	switch (iParam0)
	{
		...
		case 3:
			...
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_95867.f_9[0], true))
				{
	...
	if (func_446(Local_252))
	{
		...
		switch (iLocal_97[iParam0])
		{
			case 0:
				...
				if (!MISC::IS_POSITION_OCCUPIED(Var0, 1.5f, false, false, true, false, false, Local_252, false))
				{
					if (!bLocal_248)
					{
						if (iParam0 == 0)
...
int func_169(int iParam0)
{
	if (iParam0 != func_77())
	{
		...
		else if ((Global_1312902 && iParam0 == PLAYER::PLAYER_ID()) && func_170(iParam0, 1, 0))
		{
			return Global_2426865[iParam0 /*449*/].f_319.f_6 != -1;
		}
	}
...
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_252, sParam0, "S_M_M_TRUCKER_01_BLACK_FULL_02", "SPEECH_PARAMS_FORCE", false);
}
...
{
	func_252();
	func_131(&iLocal_268, &iLocal_269, &iLocal_95, &iLocal_219, &iLocal_218, Local_224, Local_282, 0, 1090519040);
	func_156();
	func_145();
	switch (iLocal_93)
	{
...
int func_272(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_77059[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iVar0), Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_282(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iVar0), Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4, iParam4);
						}
						func_314(iVar0);
						if (Global_77057 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iParam1), Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_282(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iParam1), Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4, iParam4);
		}
		if (Global_77057 == 1)
		{
			iVar2 = 0;
...
int func_294(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 8, -1, false, -1, func_282(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_299(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 8, -1, false, -1, func_282(iParam2));
...
int func_318(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12074)
	{
		...
		iVar0 = Global_2555716[iParam0 /*3*/][func_317(iParam1)];
...
void func_331(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_325(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77229)
		{
			...
			func_325(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 8, -1, false, -1, func_282(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_386(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_77059[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_282(iParam1)) && Global_77059[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_282(iParam1)))
	{
		return 1;
	}
	return 0;
