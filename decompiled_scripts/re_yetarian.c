void __EntryFunction__()
{
	...
	iLocal_146 = -1;
	cLocal_151 = "REYE_AU";
	func_173(ScriptParam_0.f_1[0]);
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(27))
	{
		func_172();
	}
	if (func_145(ScriptParam_0.f_1[0], 30, 0, 0, 0))
	{
		func_143(30);
	}
	else
	...
	while (true)
	{
		...
		if (AI::DOES_SCENARIO_GROUP_EXIST("DEALERSHIP"))
		{
			...
			{
				AI::SET_SCENARIO_GROUP_ENABLED("DEALERSHIP", 0);
			}
		}
				...
				if (func_58())
				{
					if (!iLocal_112)
					{
						...
						if (!bLocal_110)
						{
							if (!bLocal_111)
							{
								AI::OPEN_SEQUENCE_TASK(&uLocal_147);
								...
								AI::CLOSE_SEQUENCE_TASK(uLocal_147);
							}
							else
							{
								AI::OPEN_SEQUENCE_TASK(&uLocal_147);
							...
							AI::TASK_PERFORM_SEQUENCE(uLocal_90, uLocal_147);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_147);
							iLocal_112 = 1;
						}
						else
						{
					...
					else
					{
						...
						if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_90, 0), 1) >= 100f && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(uLocal_90, 0), 3f))
						{
							PED::DELETE_PED(&uLocal_90);
						}
						if (Local_47[0].f_18 >= 5 && Local_47[1].f_18 >= 5)
						{
							func_4();
						}
					}
...
void func_8(int iParam0, int iParam1)
{
	...
	if (iParam1 <= func_31(iParam0))
	{
		...
		{
			func_10(func_16(iParam0, iParam1), Local_43.x, Local_43.y);
		}
...
void func_36()
{
	if (iLocal_114 == 0)
	{
		if (!func_57())
		{
			if (func_2(Local_47[0].f_1))
			{
				func_56(&uLocal_152, 5, Local_47[0].f_1, "YETARIAN_GOON", 0, 1);
			}
			else if (func_2(Local_47[1].f_1))
			{
				func_56(&uLocal_152, 5, Local_47[1].f_1, "YETARIAN_GOON", 0, 1);
			}
			else
			{
				iLocal_114 = 1;
	...
	else if (iLocal_115 == 0)
	{
		if (!func_57())
		{
			if (func_2(Local_47[0].f_1))
			{
				func_37(Local_47[0].f_1, "FIGHT", 34);
				iLocal_115 = 1;
			}
			else if (func_2(Local_47[1].f_1))
			{
				func_37(Local_47[1].f_1, "FIGHT", 34);
				iLocal_115 = 1;
			}
			else
			{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_38(iParam2), 1);
}
...
int func_58()
{
	if (func_2(uLocal_90))
	{
		if (!bLocal_110)
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_90, 0), 1) <= 7f || AI::GET_SCRIPT_TASK_STATUS(uLocal_90, 242628503) == 7)
			{
				if (!iLocal_112)
				{
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_90, 0), 1) <= 7f)
					{
					}
					if (AI::GET_SCRIPT_TASK_STATUS(uLocal_90, 242628503) == 7)
					{
					}
				}
				return 1;
		...
		else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_90, 0), 1) <= 4.5f || AI::GET_SCRIPT_TASK_STATUS(uLocal_90, 242628503) == 7)
		{
			if (!iLocal_112)
			{
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_90, 0), 1) <= 4.5f)
				{
				}
				if (AI::GET_SCRIPT_TASK_STATUS(uLocal_90, 242628503) == 7)
				{
...
int func_60()
{
	iVar0 = INTERIOR::GET_INTERIOR_AT_COORDS(Local_47[0].f_10);
	if (iVar0 != 0)
	{
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (func_60())
			{
				...
				{
					OBJECT::ADD_DOOR_TO_SYSTEM(-1831288286, -2051651622, -31.72f, -1101.85f, 26.57f, 1, 1, 0);
				}
					...
					if (func_65())
					{
						if (iLocal_119 == 0)
						{
							if (bLocal_109)
							{
								...
								AI::TASK_PLAY_ANIM(0, "cellphone@", "cellphone_call_out", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
								AI::CLOSE_SEQUENCE_TASK(uLocal_147);
								AI::TASK_PERFORM_SEQUENCE(uLocal_90, uLocal_147);
								AI::CLEAR_SEQUENCE_TASK(&uLocal_147);
							}
...
int func_63()
{
	if ((((((((func_64(PLAYER::PLAYER_PED_ID()) != -1569615261 && func_64(PLAYER::PLAYER_PED_ID()) != 966099553) && func_64(PLAYER::PLAYER_PED_ID()) != -1716189206) && func_64(PLAYER::PLAYER_PED_ID()) != 1737195953) && func_64(PLAYER::PLAYER_PED_ID()) != 1317494643) && func_64(PLAYER::PLAYER_PED_ID()) != -1786099057) && func_64(PLAYER::PLAYER_PED_ID()) != -2067956739) && func_64(PLAYER::PLAYER_PED_ID()) != 1141786504) && func_64(PLAYER::PLAYER_PED_ID()) != -102323637)
	{
...
int func_65()
{
	if (!PED::IS_COP_PED_IN_AREA_3D(Local_126, Local_129) && !(GAMEPLAY::IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && GAMEPLAY::IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0)))
	{
	...
	else if (PED::IS_COP_PED_IN_AREA_3D(Local_126, Local_129) || (GAMEPLAY::IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && GAMEPLAY::IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0)))
	{
		if (INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == GAMEPLAY::GET_HASH_KEY("rm_showroom"))
		{
			func_35(&(Local_47[0].f_1), 1, 0, 1);
			func_35(&(Local_47[1].f_1), 1, 0, 1);
			func_66(&uLocal_92);
			func_66(&uLocal_91);
			func_100();
		}
...
int func_67(int iParam0)
{
	if (func_71())
	{
		...
		if (iParam0 && func_17(Global_111627))
		{
		...
		case 1:
			if (!func_2(uLocal_91) || !func_2(uLocal_92))
			{
				...
				if (func_2(uLocal_91))
				{
					...
					WEAPON::GIVE_WEAPON_TO_PED(uLocal_91, 453432689, 999, 0, 0);
					...
					AI::OPEN_SEQUENCE_TASK(&uLocal_147);
					AI::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_b", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_f", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_no_a", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_d", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					AI::SET_SEQUENCE_TO_REPEAT(uLocal_147, 1);
					AI::CLOSE_SEQUENCE_TASK(uLocal_147);
					AI::TASK_PERFORM_SEQUENCE(uLocal_91, uLocal_147);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_147);
				...
				if (func_2(uLocal_92))
				{
					...
					WEAPON::GIVE_WEAPON_TO_PED(uLocal_92, 453432689, 999, 0, 0);
					...
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_96, uLocal_92, PED::GET_PED_BONE_INDEX(uLocal_92, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
					AI::OPEN_SEQUENCE_TASK(&uLocal_147);
					AI::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_b", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_f", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_no_a", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					...
					AI::SET_SEQUENCE_TO_REPEAT(uLocal_147, 1);
					AI::CLOSE_SEQUENCE_TASK(uLocal_147);
					AI::TASK_PERFORM_SEQUENCE(uLocal_92, uLocal_147);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_147);
					ENTITY::FREEZE_ENTITY_POSITION(uLocal_91, 1);
				}
			}
			...
			{
				func_80();
				uLocal_123 = VEHICLE::CREATE_VEHICLE(142944341, -46.2722f, -1097.466f, 25.42f, 112.5363f, 1, 1, 0);
				...
				uLocal_124 = VEHICLE::CREATE_VEHICLE(-1008861746, -41.07354f, -1099.567f, 25.42f, 138.4292f, 1, 1, 0);
				...
				uLocal_125 = VEHICLE::CREATE_VEHICLE(850565707, -36.74456f, -1101.583f, 25.42f, 155.1573f, 1, 1, 0);
...
int func_96()
{
	if (((((((((((STREAMING::HAS_MODEL_LOADED(Local_47[0]) && STREAMING::HAS_MODEL_LOADED(Local_47[1])) && WEAPON::HAS_WEAPON_ASSET_LOADED(Local_47[0].f_17)) && WEAPON::HAS_WEAPON_ASSET_LOADED(Local_47[1].f_17)) && func_60()) && STREAMING::HAS_ANIM_DICT_LOADED("cellphone@")) && STREAMING::HAS_ANIM_DICT_LOADED("cellphone@str")) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("reyetarian_simeonoffice")) && STREAMING::HAS_MODEL_LOADED(iLocal_122)) && STREAMING::HAS_MODEL_LOADED(850565707)) && STREAMING::HAS_MODEL_LOADED(-1008861746)) && STREAMING::HAS_MODEL_LOADED(142944341))
	{
		return 1;
	}
	return 0;
...
{
	switch (Local_47[iParam0].f_18)
	{
		case 0:
			break;
		
		case 1:
			if (!Local_47[iParam0].f_19)
			{
				if (!func_2(Local_47[iParam0].f_1))
				{
					Local_47[iParam0].f_1 = PED::CREATE_PED(22, Local_47[iParam0], Local_47[iParam0].f_10, Local_47[iParam0].f_13, 1, 1);
					if (func_2(Local_47[iParam0].f_1))
					{
						if (iParam0 == 0)
						{
							AI::TASK_START_SCENARIO_AT_POSITION(Local_47[iParam0].f_1, "PROP_HUMAN_SEAT_CHAIR", Local_132[iParam0], fLocal_139[iParam0], 0, 0, 1);
							PED::_0xA3A9299C4F2ADB98(Local_47[iParam0].f_1);
							PED::_0x425AECF167663F48(Local_47[iParam0].f_1, 1);
							PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_47[iParam0].f_1, -37.34785f, -1102.022f, 25.42232f, 3f, 0, 0);
							PED::SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0].f_1, 37, 1);
						}
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47[iParam0].f_1, 1);
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_47[iParam0].f_1, iLocal_148);
						ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(Local_47[iParam0].f_1, 0, iLocal_148);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0].f_1, 23, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0].f_1, 1, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0].f_1, 28, 1);
						WEAPON::SET_PED_CHANCE_OF_FIRING_BLANKS(Local_47[iParam0].f_1, 0.7f, 0.3f);
						iLocal_116[iParam0] = 0;
						if (func_55() == 0)
						{
							WEAPON::GIVE_WEAPON_TO_PED(Local_47[iParam0].f_1, Local_47[iParam0].f_17, -1, 1, 1);
						}
						STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_47[iParam0]);
						Local_47[iParam0].f_19 = 1;
						Local_47[iParam0].f_18 = 2;
					}
				}
			}
			break;
		...
		case 2:
			if (func_2(Local_47[iParam0].f_1))
			{
				if (iLocal_113)
				{
					func_99(Local_47[iParam0].f_1, &(Local_47[iParam0].f_2), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
					AI::CLEAR_PED_TASKS(Local_47[iParam0].f_1);
					PED::SET_PED_USING_ACTION_MODE(Local_47[iParam0].f_1, 1, -1, "DEFAULT_ACTION");
					AI::OPEN_SEQUENCE_TASK(&uLocal_147);
					AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 12, 2);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_47[iParam0].f_14, 1f, -1, 3f, 0, 1193033728);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
					AI::CLOSE_SEQUENCE_TASK(uLocal_147);
					AI::TASK_PERFORM_SEQUENCE(Local_47[iParam0].f_1, uLocal_147);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_147);
					Local_47[iParam0].f_18 = 3;
				}
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(Local_47[iParam0].f_1, 0), 1) >= 250f)
				{
					Local_47[iParam0].f_18 = 5;
				}
			}
			else
			{
		...
		case 3:
			...
			{
				func_99(Local_47[iParam0].f_1, &(Local_47[iParam0].f_2), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
				if (AI::GET_SCRIPT_TASK_STATUS(Local_47[iParam0].f_1, 242628503) == 7 || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(Local_47[iParam0].f_1, 0), 1) <= 5f)
				{
					AI::TASK_LOOK_AT_ENTITY(Local_47[iParam0].f_1, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					AI::TASK_COMBAT_PED(Local_47[iParam0].f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
					PED::SET_PED_ALERTNESS(Local_47[iParam0].f_1, 3);
					PED::SET_PED_KEEP_TASK(Local_47[iParam0].f_1, 1);
					Local_47[iParam0].f_18 = 4;
				}
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(Local_47[iParam0].f_1, 0), 1) >= 250f)
				{
					Local_47[iParam0].f_18 = 5;
		...
		case 4:
			...
			else
			{
				if (iLocal_116[iParam0] == 0)
				{
					...
					{
						WEAPON::GIVE_WEAPON_TO_PED(Local_47[iParam0].f_1, Local_47[iParam0].f_17, -1, 0, 1);
						iLocal_116[iParam0] = 1;
					}
				}
				if (AI::GET_SCRIPT_TASK_STATUS(Local_47[iParam0].f_1, 780511057) == 7)
				{
					AI::TASK_COMBAT_PED(Local_47[iParam0].f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
				}
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(Local_47[iParam0].f_1, 0), 1) >= 75f)
				{
					Local_47[iParam0].f_18 = 5;
				}
			}
		...
		case 5:
			func_98(&(Local_47[iParam0].f_2));
			if (ENTITY::DOES_ENTITY_EXIST(Local_47[iParam0].f_1))
			{
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_47[iParam0].f_1));
			}
			Local_47[iParam0].f_18 = 6;
			break;
...
int func_99(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
	...
	if (!PED::IS_PED_INJURED(uParam0))
	{
		if (!UI::DOES_PED_HAVE_AI_BLIP(uParam0))
		{
			if (iParam8 == -1)
			{
				UI::_0xD30C50DF888D58B5(uParam0, 1);
			}
			else
			{
			...
			uParam1->f_7 = uParam0;
			UI::_0xE52B8E7F85D39A08(uParam0, iParam2);
			UI::_0x97C65887D4B37FA9(uParam0, fParam6);
		...
		UI::_0x0C4BBF625CA98C4E(uParam0, iParam4);
		...
		*uParam1 = UI::_0x7CD934010E115C2C(uParam0);
		...
		{
			uParam1->f_1 = UI::_0x56176892826A4FE8(uParam0);
...
void func_100()
{
	...
	if (AI::DOES_SCENARIO_GROUP_EXIST("DEALERSHIP"))
	{
		if (!AI::IS_SCENARIO_GROUP_ENABLED("DEALERSHIP"))
		{
			AI::SET_SCENARIO_GROUP_ENABLED("DEALERSHIP", 1);
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_109(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_125()
{
	func_123(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_122(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_121(&uVar0, TIME::GET_CLOCK_HOURS());
	func_119(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_120(&uVar0, TIME::GET_CLOCK_MONTH());
	func_118(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
int func_129()
{
	if ((Global_111627 == func_32() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_111628)
	{
		return 1;
	}
	return 0;
...
void func_130()
{
	...
	Local_47[0].f_10 = { -29.66f, -1103.44f, 26.42f };
	Local_47[0].f_13 = 58.7988f;
	Local_47[0].f_14 = { -35.19f, -1101.72f, 25.42f };
	Local_47[0] = -39239064;
	Local_47[0].f_17 = 453432689;
	Local_132[0] = { -30.35f, -1104.29f, 25.89f };
	fLocal_139[0] = 177.22f;
	Local_47[1].f_10 = { -36.8032f, -1090.619f, 25.4223f };
	Local_47[1].f_13 = 257.6675f;
	Local_47[1].f_14 = { -34.66f, -1097.23f, 25.42f };
	Local_47[1] = -984709238;
	Local_47[1].f_17 = 453432689;
	Local_132[1] = { -29.11f, -1104.99f, 25.89f };
	...
	func_131(194, 0);
	func_131(195, 0);
	STREAMING::REQUEST_MODEL(Local_47[0]);
	STREAMING::REQUEST_MODEL(Local_47[1]);
	STREAMING::REQUEST_MODEL(iLocal_122);
	STREAMING::REQUEST_MODEL(850565707);
	STREAMING::REQUEST_MODEL(-1008861746);
	STREAMING::REQUEST_MODEL(142944341);
	WEAPON::REQUEST_WEAPON_ASSET(Local_47[0].f_17, 31, 0);
	WEAPON::REQUEST_WEAPON_ASSET(Local_47[1].f_17, 31, 0);
...
void func_138(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_139(iParam0) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_89532[26].f_6) == 0)
			{
				Global_111638.f_7256[iParam0] = 1;
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_111638.f_7256[iParam0], 1, 1);
			}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_110685) || Global_30770) || func_163()) || func_52(8, -1)) || func_162()) || func_161()) || func_160()) || func_159()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_164()) || Global_30770) || func_163()) || func_52(8, -1)) || func_160()) || func_162()) || func_161()) || func_159()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_110685) || Global_30770) || func_163()) || func_52(8, -1)) || func_162()) || func_161()) || func_159()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_164()) || func_161()) || Global_110685) || Global_30770) || func_163()) || Global_42596) || func_52(8, -1)) || func_160()) || func_158()) || func_159()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
