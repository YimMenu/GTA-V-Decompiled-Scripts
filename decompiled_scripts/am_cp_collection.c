...
int func_5()
{
	...
	while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if (!func_6(iVar1))
			{
				if ((!MISC::IS_BIT_SET(Local_3443[iVar0].f_2, 0) || Local_3443[iVar0].f_3 != 6) || (MISC::IS_BIT_SET(Local_802.f_2, 0) && !MISC::IS_BIT_SET(Local_3443[iVar0].f_2, 1)))
				{
					return 0;
				}
			}
		...
		if (func_33(Var0))
		{
			if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Var0.f_1))
			{
				if (func_32(iLocal_83, &Var2, &uVar5))
				{
					...
					if (MISC::IS_BIT_SET(Local_3443[Local_802.f_713[iLocal_83]].f_1, iLocal_83))
					{
						if (func_26(&(Local_802.f_729[iLocal_83].f_1), Var0, Var2, uVar5, 1, 1, 1, 0, 1, 0, 0, 0, 0, 0))
						{
							...
							ENTITY::_SET_ENTITY_SOMETHING(NETWORK::NET_TO_VEH(Local_802.f_729[iLocal_83].f_1), 1);
	...
	if (func_34())
	{
		...
		while (iVar0 < 10)
		{
			if (Local_802.f_713[iVar0] == NETWORK::PARTICIPANT_ID_TO_INT())
			{
				if (func_126(iVar0))
				{
					if (!MISC::IS_BIT_SET(Local_3443[NETWORK::PARTICIPANT_ID_TO_INT()].f_1, iVar0))
					{
						MISC::SET_BIT(&(Local_3443[NETWORK::PARTICIPANT_ID_TO_INT()].f_1), iVar0);
					}
				}
				else if (MISC::IS_BIT_SET(Local_3443[NETWORK::PARTICIPANT_ID_TO_INT()].f_1, iVar0))
				{
					MISC::CLEAR_BIT(&(Local_3443[NETWORK::PARTICIPANT_ID_TO_INT()].f_1), iVar0);
				}
			}
			else if (MISC::IS_BIT_SET(Local_3443[NETWORK::PARTICIPANT_ID_TO_INT()].f_1, iVar0))
			{
	...
	if (iParam4 && !bParam7)
	{
		if (func_13(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_130(PLAYER::PLAYER_ID()), Param0, 1) <= (fVar2 + fParam3))
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_129(iVar1) || !bParam10) && !Global_2425662[iVar1].f_259)
					{
						...
						if (!bParam7)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_130(iVar1), Param0, 1) <= (fVar2 + fParam3))
								{
				...
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam7 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_129(iVar1)))
					{
						if ((!bParam6 || (bParam6 == 1 && PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) != PLAYER::GET_PLAYER_TEAM(iVar1))) || PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_31(iVar1), Param0, 1) < fParam3)
								{
									return 1;
								}
							}
	...
	if (Local_802.f_8 == 5)
	{
		if (func_38(&(Local_802.f_669)))
		{
			if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_802.f_729[iLocal_367].f_1))
			{
				...
				else if (MISC::IS_BIT_SET(iLocal_786, iLocal_367) && !AUDIO::HAS_SOUND_FINISHED(uLocal_787[iLocal_367]))
				{
...
void func_174()
{
	...
	{
		if (HUD::DOES_BLIP_EXIST(Local_374[iVar0]))
		{
			HUD::REMOVE_BLIP(&(Local_374[iVar0]));
...
void func_175()
{
	if (!MISC::IS_BIT_SET(Local_3443[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 0) && (func_190() || MISC::IS_BIT_SET(Local_802.f_2, 2)))
	{
		if (func_59(func_189()))
		{
			func_188();
			...
			if (func_311(0))
			{
				...
				else
				{
					...
					if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar1))
					{
						...
						{
							if (MISC::IS_BIT_SET(Local_802.f_2, 0) && Local_3443[NETWORK::PARTICIPANT_ID_TO_INT()].f_4 >= Global_262145.f_11274)
							{
								sVar0 = "CPC_LOSEBONUS";
							}
							else
		...
		MISC::SET_BIT(&(Local_3443[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 0);
		func_176(132);
	}
}
...
void func_191()
{
	if (!MISC::IS_BIT_SET(Local_3443[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 1))
	{
		if (func_6(PLAYER::PLAYER_ID()))
		{
			MISC::SET_BIT(&(Local_3443[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 1);
			return;
		}
...
void func_285()
{
	if (Local_802.f_674[0] > -1)
	{
		...
		{
			uVar22 = func_300();
			iVar23 = NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(uVar22);
...
void func_318()
{
	if (!MISC::IS_BIT_SET(Local_3443[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 2))
	{
		MISC::SET_BIT(&(Local_3443[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 2);
		func_319(1);
	}
}
...
void func_349(var uParam0, struct<3> Param1, var uParam4, var uParam5, int iParam6)
{
	...
	else if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
{
	HUD::SET_BLIP_ALPHA(uParam0, func_357(uParam0, iParam1, fParam2, fParam3));
}
...
void func_458(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		if (MISC::IS_BIT_SET(Global_2425662[Global_2439138.f_1894.f_703.f_16].f_404, 0) && func_459())
		{
			iParam0 = 23;
		}
	}
	...
	if (func_34())
	{
		if (func_13(PLAYER::PLAYER_ID(), 1, 1))
		{
			...
			while (iVar0 < 10)
			{
				...
				{
					if (!HUD::DOES_BLIP_EXIST(uLocal_775[iVar0]))
					{
						uLocal_775[iVar0] = HUD::ADD_BLIP_FOR_ENTITY(NETWORK::NET_TO_ENT(Local_802.f_729[iVar0].f_1));
						HUD::SET_BLIP_PRIORITY(uLocal_775[iVar0], 9);
						HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_775[iVar0], "AMCH_AC");
						HUD::SET_BLIP_SPRITE(uLocal_775[iVar0], func_484(iVar0));
					...
					else
					{
						...
						{
							HUD::SHOW_HEIGHT_ON_BLIP(uLocal_775[iVar0], 1);
						}
						else
						{
							HUD::SHOW_HEIGHT_ON_BLIP(uLocal_775[iVar0], 0);
						}
					}
				}
				else if (HUD::DOES_BLIP_EXIST(uLocal_775[iVar0]))
				{
					HUD::REMOVE_BLIP(&(uLocal_775[iVar0]));
				}
				iVar0++;
			}
		}
...
{
	iVar0 = 2;
	bVar1 = ((func_431(iParam0) && !func_7(iParam0)) && !MISC::IS_BIT_SET(Global_1628237[iParam0].f_1, 8));
...
{
	if (iParam0 == 20 && (!func_541() || MISC::IS_STRING_NULL_OR_EMPTY(uParam1)))
	{
		uVar0 = func_615();
		return uVar0;
	}
...
void func_684()
{
	...
	while (iVar5 < 10)
	{
		if (MISC::IS_BIT_SET(iLocal_786, iVar5) && !AUDIO::HAS_SOUND_FINISHED(uLocal_787[iVar5]))
		{
