...
void func_8()
{
	...
	if (!Global_96456)
	{
		Global_96640 = CLOCK::GET_CLOCK_MONTH();
		Global_96639 = CLOCK::GET_CLOCK_DAY_OF_MONTH();
		Global_96638 = CLOCK::GET_CLOCK_HOURS();
		Global_96456 = 1;
		Global_96461 = CLOCK::GET_CLOCK_DAY_OF_WEEK();
		Global_96460 = CLOCK::GET_CLOCK_HOURS();
		func_12();
		return;
	}
