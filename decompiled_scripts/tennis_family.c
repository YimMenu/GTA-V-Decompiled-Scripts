...
void func_3(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	switch (func_309(uParam1))
	{
		...
		case 10:
			...
			Var6 = { func_284(&(uParam0->f_247)) };
			if (Var6.z < (uParam0->f_189.f_3[0 /*3*/].f_2 - 1f) && SYSTEM::VDIST2(uParam0->f_189.f_29, func_284(&(uParam0->f_247))) < (26.75f * 26.75f))
			{
				func_104(uParam1, (1 - func_272(uParam1)));
				func_270(uParam1, 14);
			}
		...
		case 12:
			...
			else if (Var6.z < (uParam0->f_189.f_3[0 /*3*/].f_2 - 1f) && SYSTEM::VDIST2(uParam0->f_189.f_29, func_284(&(uParam0->f_247))) < (26.75f * 26.75f))
			{
				func_104(uParam1, (1 - func_178(uParam1)));
				func_270(uParam1, 14);
				if (func_64(uParam1) != iParam3 && uParam0->f_1657 != 1)
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0 /*3*/][func_38(iParam1)];
...
int func_107(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	if (func_134(uParam0, &(uParam1->f_247), uParam1->f_189.f_29, bVar6))
	{
		...
		else if (func_131(uParam0, &(uParam1->f_189), &(uParam1->f_1661), Var11.z, func_287(&(uParam1->f_247))))
		{
			bVar26 = true;
		}
...
void func_108(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	func_129(&iVar0, &uVar1, &iVar2, &iVar2, 1, 1);
	if (uParam0->f_31 != 4)
	{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, uParam1, uParam2, func_112(iParam3), 0);
}
...
void func_116(var uParam0, bool bParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		Var0 = { func_117(bParam1, func_284(uParam0), ENTITY::GET_ENTITY_COORDS(*uParam0, 1)) };
	}
	uParam0->f_27 = { Var0 };
	uParam0->f_30 = { Var0 };
	uParam0->f_25 = 0f;
...
Vector3 func_121(var uParam0, var uParam1, int iParam2, int iParam3, struct<3> Param4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	Var0.z = func_125(fVar20, fVar21, fVar14);
...
void func_129(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, int iParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_140(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	if (iVar0 == 72)
	{
		iVar11 = func_144(uParam0, &Var12, &Var13, &Local_242, &Local_244, &Local_245, 0, &fVar15, &fVar16, &uVar14);
		if (iVar11 == 0)
		{
	...
	{
		iVar11 = func_144(uParam0, &Var12, &Var13, &Local_238, &Local_240, &Local_241, 1, &fVar15, &fVar16, &uVar14);
		if (iVar11 == 0)
		{
			func_143(uParam0, 0.5f);
			func_142(uParam0, 1f);
...
int func_144(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, float fParam7, float fParam8, var uParam9)
{
	...
	*fParam8 = MISC::_0x7F8F6405F4777AF6(Var5, func_117(bParam6, *uParam5, *uParam4), func_117(bParam6, *uParam4, *uParam5), 0);
				...
				if ((uParam3[iVar18 /*12*/])->f_1 >= 0f)
				{
					...
					if (iVar3 < (*uParam4 - 2) && iVar3 >= 0)
					{
						if (iVar14 == 0 && (iVar18 == 72 || iVar18 == 73))
						{
							...
							if (iVar18 == 72)
							{
								iVar23 = func_144(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &Local_242, &Local_244, &Local_245, 0, &fVar24, &fVar25, &Var16);
							}
							else
							{
								iVar23 = func_144(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &Local_238, &Local_240, &Local_241, 1, &fVar24, &fVar25, &Var16);
							}
							if (iVar23 != 0)
							{
...
void func_184(var uParam0, var uParam1, var uParam2)
{
	...
	uVar0 = *uParam1;
	Var1 = { func_185(SYSTEM::TO_FLOAT(*uParam2), SYSTEM::TO_FLOAT(uParam2->f_1), uVar0, &(uParam1->f_40), &(uParam1->f_43)) };
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_247))
	{
		if (uParam0->f_1657 != 1 && !func_276(&(uParam0->f_247)))
		{
...
Vector3 func_185(float fParam0, float fParam1, var uParam2, var uParam3, var uParam4)
{
	struct<3> Var0;
	struct<3> Var1;
	
	Var0 = { func_190(*uParam3) };
	func_186(&Var0, uParam2, 0f, 0f, 1f);
...
void func_186(var uParam0, var uParam1, struct<3> Param2)
{
	float fVar0;
	float fVar1;
...
void func_240(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
	...
	switch (func_148(&(uParam0->f_4)))
	{
		...
		case 5:
			if (func_76(uParam0) == 75)
			{
				...
				else if ((ENTITY::IS_ENTITY_AT_COORD(uParam0->f_32, func_71(&(uParam0->f_4)), Var2, 0, 1, 0) || TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0), 2106541073) == 7) && !func_229(&(uParam0->f_4), 256))
				{
					func_236(&(uParam0->f_4), 0);
					func_218(&(uParam0->f_4), 4);
				}
...
void func_263(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!PED::IS_PED_INJURED(func_266(uParam0[iParam1 /*94*/])) && !PED::IS_PED_INJURED(func_266(uParam0[iParam2 /*94*/])))
	{
		...
		else
		{
			if (!bParam4)
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_266(uParam0[iParam1 /*94*/]), PED::GET_PED_BONE_INDEX(func_266(uParam0[iParam1 /*94*/]), 28422), Local_236, Local_237, 0, 0, 0, 0, 2, 1);
			}
			ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_266(uParam0[iParam2 /*94*/]), PED::GET_PED_BONE_INDEX(func_266(uParam0[iParam2 /*94*/]), 28422), Local_236, Local_237, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
void func_291(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!func_230(uParam0, 1))
	{
		...
		{
			(uParam0[iParam3 /*94*/])->f_37 = { ENTITY::GET_ENTITY_COORDS(func_266(uParam0[iParam3 /*94*/]), 1) };
		...
		{
			(uParam0[iParam4 /*94*/])->f_37 = { ENTITY::GET_ENTITY_COORDS(func_266(uParam0[iParam4 /*94*/]), 1) };
...
void func_335(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_337(Global_111638.f_18528[iVar0], &Var2, &fVar3))
			{
