...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_77059[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_64(iVar0), Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_64(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_64(iVar0), Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4, iParam4);
						}
						func_96(iVar0);
						if (Global_77057 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_64(iParam1), Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_64(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_64(iParam1), Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4, iParam4);
		}
		if (Global_77057 == 1)
		{
			iVar2 = 0;
...
int func_55(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_168(iParam0, Global_112293.f_2361.f_539[iVar0 /*65*/].f_64, Global_112293.f_2361.f_539[iVar0 /*65*/].f_63))
		{
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_168(iParam0, Global_112293.f_2361.f_539[iVar0 /*65*/].f_61, Global_112293.f_2361.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 8, -1, false, -1, func_64(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 8, -1, false, -1, func_64(iParam2));
...
int func_100(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12074)
	{
		...
		iVar0 = Global_2555716[iParam0 /*3*/][func_99(iParam1)];
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_100(func_110(iParam1, uParam0->f_2), Global_77056, 0);
...
void func_113(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_107(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77229)
		{
			...
			func_107(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 8, -1, false, -1, func_64(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_168(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_77059[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_64(iParam1)) && Global_77059[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_64(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_192(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2592627[iParam0 /*3*/][func_99(iParam1)];
...
{
	func_270(&Global_105842, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_360(int iParam0)
{
	if (iParam0 != func_259())
	{
		...
		else if ((Global_1312902 && iParam0 == PLAYER::PLAYER_ID()) && func_361(iParam0, 1, 0))
		{
			return Global_2426865[iParam0 /*449*/].f_319.f_6 != -1;
		}
	}
	...
	if (func_457(Local_244))
	{
		...
		switch (iLocal_95)
		{
			...
			case 2:
				...
				{
					TASK::TASK_DRIVE_BY(Local_244, PLAYER::PLAYER_PED_ID(), 0, Local_209, 35f, 65, false, -753768974);
				}
				break;
	...
	switch (iLocal_92)
	{
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Rocco", 0))
			{
				...
				{
					PED::SET_PED_INTO_VEHICLE(Local_237, Local_251, -1);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_237, false, false);
				}
			}
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Rocco_Goon", 0))
			{
				...
				{
					PED::SET_PED_INTO_VEHICLE(Local_244, Local_251, 0);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_244, false, false);
				}
			}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102858.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102858.f_4, false))
		{
			if (func_441(24) != Global_102858.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_438(ENTITY::GET_ENTITY_COORDS(Global_102858.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
