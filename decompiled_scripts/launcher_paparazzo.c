	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110725[Var0].f_9 != -1)
			{
				...
				func_282(&(Global_110725[Var0].f_9));
			}
		}
		func_270(&Var0, 1);
	}
...
{
	if ((((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && !func_146()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_192(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
bool func_215(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_216(&(Local_37[iVar4]), Var1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
{
	Var0 = { func_221(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
{
	Var0 = { func_221(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
...
int func_241(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -476.3686f, 229.5744f, 82.07077f };
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_247(&(uParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
					...
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uVar10, 0);
					AI::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uVar10, "rcmpaparazzo_4", "pap_4_rcm_leadin", 8f, -8f, 1, 16, 1148846080, 0);
				}
				else
				{
					bVar11 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				...
				if (func_126(uParam0->f_28[1]))
				{
					...
					AI::TASK_PLAY_ANIM(uParam0->f_28[1], "rcmpaparazzo_4", "Idle_Camman", 8f, -8f, -1, 57, 0, 0, 0, 0);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[2]))
			{
				...
				if (func_126(uParam0->f_28[2]))
				{
					...
					AI::TASK_PLAY_ANIM(uParam0->f_28[2], "rcmpaparazzo_4", "Idle_Prod", 8f, -8f, -1, 57, 0, 0, 0, 0);
...
void func_245(var uParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_246(uParam0);
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_127(uParam0->f_41[0]))
			{
				...
				if (func_127(uParam0->f_28[0]))
				{
					AI::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_94, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
...
int func_254(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -82.64143f, 302.7307f, 104.6349f };
			uParam0->f_17[1] = { -68.78405f, 296.6317f, 107.8958f };
			uParam0->f_24 = 11f;
			uParam0->f_27 = 0;
			uParam0->f_26 = 1;
			uParam0->f_25 = 1;
		...
		case 3:
			if (func_127(uParam0->f_28[0]) && func_127(PLAYER::PLAYER_PED_ID()))
			{
				...
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_94, 1);
				AI::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_94, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
...
int func_255(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -154.9816f, 287.0432f, 96.63823f };
			uParam0->f_17[1] = { -155.4946f, 274.4067f, 90.82359f };
			uParam0->f_24 = 15f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
			uParam0->f_26 = 0;
		...
		case 3:
			if (func_127(uParam0->f_28[0]))
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo1beckon"))
				{
					...
					AI::TASK_PLAY_ANIM(0, sVar7, "pap_idle_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sVar7, "pap_idle_action_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sVar7, "pap_idle_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sVar7, "pap_idle_action_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::SET_SEQUENCE_TO_REPEAT(uVar6, 1);
					AI::CLOSE_SEQUENCE_TASK(uVar6);
					AI::TASK_PERFORM_SEQUENCE(uParam0->f_28[0], uVar6);
...
void func_270(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		switch (*iParam0)
		{
			...
			case 48:
				ENTITY::REMOVE_MODEL_HIDE(-260.62f, 292.13f, 90.6f, 10f, 684586828, 1);
				ENTITY::REMOVE_MODEL_HIDE(-261.58f, 291.66f, 92.06f, 10f, 1620484584, 1);
				ENTITY::REMOVE_MODEL_HIDE(-261.54f, 292.54f, 92.1f, 10f, -1111368675, 1);
	...
	func_256(*iParam0, 0);
	if (UI::DOES_BLIP_EXIST(uLocal_97))
	{
		UI::REMOVE_BLIP(&uLocal_97);
	}
	if (iLocal_95 != -1)
	{
	...
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			...
			while (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-570008042) > 0)
			{
				SYSTEM::WAIT(0);
			}
		}
