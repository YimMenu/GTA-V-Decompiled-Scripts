		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_204(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_204(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
void func_270(int iParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			...
			while (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(-570008042) > 0)
			{
				SYSTEM::WAIT(0);
			}
		}
