...
void func_9()
{
	...
	else
	{
		...
		{
			case 0:
				func_307(&(Local_847[0]), "TAXI_SC_BN_02", 200);
...
void func_82(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_84()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_84()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_83(iParam0));
...
bool func_88(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_84()].f_6174.f_10, iParam0);
}
...
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(*uParam0, func_105());
...
int func_123(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	switch (*iParam0)
	{
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(*uParam2, 0))
			{
				func_129(&uLocal_45, *uParam2, 0, 0, 1, 1, 1);
...
int func_125(var uParam0)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_126(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return uVar0;
}
...
int func_137(char* sParam0)
{
	if (!func_138(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_128(sParam0)) || func_128("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_138(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_145() || func_144(Global_4456448.f_232883)) || func_143())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_141(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_188(var uParam0, int iParam1)
{
	...
	else if (((ENTITY::IS_ENTITY_AT_COORD(uParam0->f_4, uParam0->f_17, (iParam1 + 1f), (iParam1 + 1f), 2f, !uParam0->f_140, 1, 0) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) < 1) && func_189(1, 1, 1)) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(uParam0->f_4))
	{
		return func_172(uParam0, 1, iParam1);
	}
	return 0;
...
float func_192(struct<3> Param0, int iParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, 0))
	{
		...
		else
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_3, 0))
			{
				...
				{
					case 0:
						if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) != 1 || ((func_211(PLAYER::PLAYER_PED_ID(), uParam0->f_3, 1) < 20f && func_190(uParam0->f_3, uParam0->f_11, 1) <= 28f) && func_190(uParam0->f_4, uParam0->f_11, 1) <= 28f))
						{
					...
					case 1:
						...
						else
						{
							...
							else if (((AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) != 1 && AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) != 0) && AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) != 7) && func_264(uParam0, uParam0->f_3) > 8f)
							{
...
void func_245(var uParam0, struct<3> Param1, struct<3> Param4, int iParam7)
{
	if (!CAM::DOES_CAM_EXIST(*uParam0))
	{
...
{
	if (func_251() && GAMEPLAY::GET_GAME_TIMER() >= iParam0 + 1000)
	{
...
int func_261(var uParam0, float fParam1)
{
	...
	switch (iLocal_87)
	{
		...
		case 1:
			if ((func_211(uParam0->f_4, uParam0->f_3, 0) <= fParam1 && !uParam0->f_142) && GAMEPLAY::ABSF((Var0.z - Var3.z)) < 5f)
			{
				if (uParam0->f_409 == 0)
				{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, uParam2, func_263(iParam3), 0);
}
...
int func_309(var uParam0)
{
	...
	{
		if ((!PED::IS_PED_STOPPED(uParam0->f_2) && !func_164(&(Local_190[0].f_3))) && !func_164(&(Local_190[1].f_3)))
		{
...
int func_311(var uParam0)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, 0))
	{
		...
		if (Var0.y < -10f && !func_164(&(Local_190[0].f_3)))
		{
...
{
	if ((((((VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, 0) && !func_164(&(Local_190[0].f_3))) && !func_164(&(Local_190[1].f_3))) && !func_164(&(Local_190[5].f_3))) && !func_164(&(Local_190[9].f_3))) && !func_164(&(Local_190[7].f_3))) && !func_164(&(Local_190[8].f_3)))
	{
		Var0 = { ENTITY::GET_ENTITY_SPEED_VECTOR(uParam0->f_4, 1) };
		if (GAMEPLAY::ABSF(Var0.x) > 2.5f && !func_164(&(Local_190[0].f_3)))
		{
			...
			else if (func_161(&(Local_190[11].f_3)) < 1.5f && (GAMEPLAY::ABSF(uLocal_342) - GAMEPLAY::ABSF(Var0.x)) < 0f)
			{
...
{
	if (((((VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, 0) && !func_164(&(Local_190[0].f_3))) && !func_164(&(Local_190[8].f_3))) && !func_164(&(Local_190[5].f_3))) && !func_164(&(Local_190[9].f_3))) && !func_164(&(Local_190[7].f_3)))
	{
		...
		else if ((func_161(&(Local_190[14].f_3)) < 1.5f && func_211(uParam0->f_5, uParam0->f_4, 1) > 4.5f) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_5))
		{
...
{
	if (((VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, 0) && !func_164(&(Local_190[9].f_3))) && !func_164(&(Local_190[7].f_3))) && !func_164(&(Local_190[4].f_3)))
	{
...
bool func_315(int iParam0)
{
	...
	Var9 = { func_319((Var3.x - Var0.x), (Var3.y - Var0.y), 0f) };
...
int func_325(var uParam0)
{
	...
	{
		Var0 = { ENTITY::GET_ENTITY_SPEED_VECTOR(uParam0->f_4, 1) };
		if (GAMEPLAY::ABSF(Var0.x) > 3f && !func_164(&(Local_190[0].f_3)))
		{
...
void func_333(var uParam0, char* sParam1, int iParam2)
{
	...
	func_428(2);
	Var0 = { func_337() };
	if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Var0) && func_228()) && !GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, "NULL"))
	{
	}
	else
	{
...
void func_371(var uParam0, var uParam1, bool bParam2)
{
	if (!func_225(uParam0->f_55, 1))
	{
		...
		{
			case 0:
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_124)) && func_228())
				{
					*uParam1++;
				}
				break;
...
int func_373(var uParam0, var uParam1)
{
	...
	if ((((!PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) && (CAM::DOES_CAM_EXIST(*uParam0) && !CAM::IS_CAM_ACTIVE(*uParam0))) && (CAM::DOES_CAM_EXIST(uParam0->f_1) && !CAM::IS_CAM_ACTIVE(uParam0->f_1))) && !UI::IS_MESSAGE_BEING_DISPLAYED()) && !func_228())
	{
...
void func_420(var uParam0)
{
	switch (uParam0->f_411)
	{
		...
		case 9:
			func_424(uParam0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 17));
			iVar0 = func_422((uParam0->f_418.f_2 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 17)), 0, 16);
