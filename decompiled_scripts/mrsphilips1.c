			...
			switch (iLocal_142)
			{
				case 0:
					if (func_223(1, 1093140480, 0))
					{
						...
						{
							OBJECT::ADD_DOOR_TO_SYSTEM(1736361794, 132154435, 1972.77f, 3815.37f, 33.66f, 1, 1, 0);
						}
						if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(1736361794))
						{
...
int func_32(var uParam0, int iParam1, int iParam2)
{
	...
	{
		PED::CLEAR_PED_PROP(uParam0, Global_76434[1].f_12);
	}
	else
	{
		uVar31 = { func_79(iVar0, 0) };
		Global_76434[1] = { func_83(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(uParam0, func_75(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(uParam0, func_75(iParam1), Global_76434[1].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_75(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, 0);
		}
	}
...
int func_33(var uParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_148(uParam0, Global_111638.f_2358.f_539[iVar0].f_64, Global_111638.f_2358.f_539[iVar0].f_63))
		{
...
int func_35(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
				...
				if (MISC::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							...
							func_51(uParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
							func_66(14);
							if (Global_76432 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_75(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_75(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_75(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_66(iVar0);
						if (Global_76432 == 1)
						{
			...
			{
				Global_76434[1] = { func_83(iVar10, iVar0, func_41(uParam0, iVar0, -1), -1) };
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_75(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_75(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_75(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
int func_74(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_148(uParam0, Global_111638.f_2358.f_539[iVar0].f_61, Global_111638.f_2358.f_539[iVar0].f_60) || iParam3 == 1)
		{
...
int func_148(var uParam0, int iParam1, int iParam2)
{
	...
	{
		if (PED::GET_PED_PROP_INDEX(uParam0, Global_76434[1].f_12) == Global_76434[1].f_3 && (PED::GET_PED_PROP_TEXTURE_INDEX(uParam0, Global_76434[1].f_12) == Global_76434[1].f_4 || Global_76434[1].f_3 == -1))
		{
			return 1;
		}
	}
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_75(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_75(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_223(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_230(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_231(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
	{
		if (VEHICLE::_GET_HAS_ROCKET_BOOST(uParam0))
		{
			if (VEHICLE::_IS_VEHICLE_ROCKET_BOOST_ACTIVE(uParam0))
			{
				VEHICLE::_SET_VEHICLE_ROCKET_BOOST_ACTIVE(uParam0, 0);
			}
		}
	}
}
