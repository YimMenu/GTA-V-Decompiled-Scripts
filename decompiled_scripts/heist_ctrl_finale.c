void __EntryFunction__()
{
	...
	while (!func_395(3))
	{
		if (!Global_76891 && !func_394(14))
		{
			...
			func_220();
			func_152();
			if (func_150(0) || GAMEPLAY::IS_BIT_SET(Local_182.f_449, 2))
			{
				func_68(&Local_182);
				func_5(&Local_182);
				func_4(&Local_182);
		...
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-618416399) > 0 || SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-924773780) > 0)
		{
			func_3();
		}
		if (func_395(34))
		{
			if (!func_2(0))
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_111638.f_1.f_120[4], 9))
				{
					func_397(4, 9, 1);
				}
			}
			else if (GAMEPLAY::IS_BIT_SET(Global_111638.f_1.f_120[4], 9))
			{
				func_397(4, 9, 0);
			}
		}
...
var func_178()
{
	...
	func_181(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_180(&uVar0, TIME::GET_CLOCK_MONTH());
	func_179(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_184(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_224(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	if ((!PED::IS_PED_INJURED((*iParam0)[iParam0->f_7]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && (*iParam0)[iParam0->f_7] != PLAYER::PLAYER_PED_ID())
	{
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			PLAYER::_0xD2B315B6689D537D(PLAYER::PLAYER_ID(), func_395(68));
		}
...
void func_225()
{
	...
	{
		func_101();
		GRAPHICS::_0xBF59707B3E5ED531(func_226(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
...
void func_239(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_240(iParam0) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_89532[26].f_6) == 0)
			{
				Global_111638.f_7256[iParam0] = 1;
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_111638.f_7256[iParam0], 1, 1);
			}
...
int func_285(int iParam0, int iParam1)
{
	...
	else
	{
		...
		if (func_267(func_100()) != iParam1 || bVar0)
		{
			...
			else if (!((GAMEPLAY::IS_BIT_SET(Global_111638.f_9080.f_2[27], 1) && !Global_3) && !func_2(0)))
			{
				if (iParam0->f_23)
				{
					bVar1 = true;
