...
int func_187(struct<3> Param0)
{
	...
	fVar0 = SYSTEM::VDIST2(Param0, Global_94094[func_188(Param0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_188(struct<3> Param0, bool bParam3)
{
	...
	while (iVar0 <= (7 - 1))
	{
		if (Global_94094[iVar0 /*9*/].f_7 != 263)
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, Global_94094[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_189(struct<3> Param0)
{
	...
	fVar0 = SYSTEM::VDIST2(Param0, Global_94158[func_190(Param0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_241(float fParam0)
{
	if (iLocal_42 == 1)
	{
		if (func_76(PLAYER::PLAYER_PED_ID(), Global_94901[1 /*15*/], fParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_76(PLAYER::PLAYER_PED_ID(), Global_94901[0 /*15*/], fParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_76(PLAYER::PLAYER_PED_ID(), Global_94901[3 /*15*/], fParam0))
		{
			return 1;
		}
	}
...
int func_246(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2552060[iParam0 /*3*/][func_247(iParam1)];
