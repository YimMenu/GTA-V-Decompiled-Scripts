	...
	switch (iLocal_36)
	{
		case 0:
			...
			if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				...
				while (iVar4 <= 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_111003.f_225[iVar4]))
					{
						uLocal_284[iVar4] = Global_111003.f_225[iVar4];
						Global_111003.f_225[iVar4] = 0;
				...
				while (iVar4 <= 1)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_111003.f_222[iVar4]))
					{
						uLocal_281[iVar4] = Global_111003.f_222[iVar4];
						Global_111003.f_222[iVar4] = 0;
