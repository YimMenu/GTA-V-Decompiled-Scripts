void __EntryFunction__()
{
	...
	GAMEPLAY::SET_BIT(&Global_76870, 7);
...
void func_6()
{
	...
	if (Local_868.f_10 < IntToFloat(Local_941[iLocal_940]))
	{
		return;
	}
	if (Local_868.f_10 >= IntToFloat(Local_941[iVar3]))
	{
		iLocal_940 = iVar3;
		return;
	}
	...
	if (Local_941[iLocal_940].f_1 == Local_941[iVar3].f_1)
	{
		fLocal_939 = Local_941[iLocal_940].f_1;
		return;
	}
	fVar0 = SYSTEM::TO_FLOAT(GAMEPLAY::ABSI((Local_941[iLocal_940 + 1] - Local_941[iLocal_940])));
	fVar1 = (Local_941[iVar3].f_1 - Local_941[iLocal_940].f_1);
	fVar2 = (1f - ((SYSTEM::TO_FLOAT(Local_941[iVar3]) - Local_868.f_10) / fVar0));
	fLocal_939 = (Local_941[iLocal_940].f_1 + (fVar2 * fVar1));
	if (Local_941[iLocal_940].f_1 < Local_941[iVar3].f_1)
	{
		fLocal_939 = func_7(fLocal_939, Local_941[iLocal_940].f_1, Local_941[iVar3].f_1);
	}
	else
	{
		fLocal_939 = func_7(fLocal_939, Local_941[iVar3].f_1, Local_941[iLocal_940].f_1);
	}
}
...
void func_9(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, float fParam7, bool bParam8)
{
	...
	else
	{
		...
		uParam0->f_14.f_1 = (uParam0->f_14.f_1 + func_7(((((Var10.y - uParam0->f_14.f_1) * 0.05f) * fVar9) * fParam7), -3f, 3f));
		uParam0->f_14.f_2 = (uParam0->f_14.f_2 + func_7(((((Var10.z - uParam0->f_14.f_2) * 0.05f) * fVar9) * fParam7), -3f, 3f));
	}
	if (uParam0->f_26)
	{
...
void func_17(var uParam0)
{
	...
	*uParam0 = { func_18(&(Local_159[uParam0->f_4[0]]), &(Local_159[uParam0->f_4[1]]), &(Local_159[uParam0->f_4[2]]), &(Local_159[uParam0->f_4[3]]), uParam0->f_3) };
...
Vector3 func_18(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4)
{
	...
	Var0.y = (0.5f * ((((2f * uParam1->f_1) + ((-uParam0->f_1 + uParam2->f_1) * fParam4)) + (((((2f * uParam0->f_1) - (5f * uParam1->f_1)) + (4f * uParam2->f_1)) - uParam3->f_1) * fVar3)) + ((((-uParam0->f_1 + (3f * uParam1->f_1)) - (3f * uParam2->f_1)) + uParam3->f_1) * fVar4)));
	Var0.z = (0.5f * ((((2f * uParam1->f_2) + ((-uParam0->f_2 + uParam2->f_2) * fParam4)) + (((((2f * uParam0->f_2) - (5f * uParam1->f_2)) + (4f * uParam2->f_2)) - uParam3->f_2) * fVar3)) + ((((-uParam0->f_2 + (3f * uParam1->f_2)) - (3f * uParam2->f_2)) + uParam3->f_2) * fVar4)));
	return Var0;
}
...
void func_29()
{
	iLocal_925[0] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1643.524f, -1124.681f, 17.4326f, 2f, 1446187959, 1, 0, 1);
	iLocal_925[1] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1645.146f, -1126.613f, 17.4326f, 2f, -881525183, 1, 0, 1);
	iLocal_925[2] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1646.768f, -1128.545f, 17.4326f, 2f, -881525183, 1, 0, 1);
	iLocal_925[3] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1648.39f, -1130.478f, 17.4326f, 2f, -881525183, 1, 0, 1);
	iVar0 = 0;
...
{
	Local_159[(233 - iLocal_865)] = fParam0;
	Local_159[(233 - iLocal_865)].f_1 = fParam1;
	Local_159[(233 - iLocal_865)].f_2 = fParam2;
	iLocal_865++;
}
...
void func_33(int iParam0, float fParam1, int iParam2)
{
	...
	{
		Local_941[(Local_941.x - 1)] = 232;
		Local_941[(Local_941.x - 1)].f_1 = 0.01f;
		Local_941[(Local_941.x - 1)].f_2 = 0;
		return;
	}
	Local_941[iLocal_1038] = (iParam0 + iLocal_1039);
	if (Local_941[iLocal_1038] >= 234)
	{
		Local_941[iLocal_1038] = 233;
	}
	Local_941[iLocal_1038].f_1 = fParam1;
	Local_941[iLocal_1038].f_2 = iParam2;
	iLocal_1038++;
}
...
int func_46(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((((((((((((((func_47(Var18[0], Var18[1], Var6, Var9) || func_47(Var18[0], Var18[1], Var9, Var15)) || func_47(Var18[0], Var18[1], Var12, Var15)) || func_47(Var18[0], Var18[1], Var6, Var12)) || func_47(Var18[1], Var18[3], Var6, Var9)) || func_47(Var18[1], Var18[3], Var9, Var15)) || func_47(Var18[1], Var18[3], Var12, Var15)) || func_47(Var18[1], Var18[3], Var6, Var12)) || func_47(Var18[3], Var18[2], Var6, Var9)) || func_47(Var18[3], Var18[2], Var9, Var15)) || func_47(Var18[3], Var18[2], Var12, Var15)) || func_47(Var18[3], Var18[2], Var6, Var12)) || func_47(Var18[2], Var18[0], Var6, Var9)) || func_47(Var18[2], Var18[0], Var9, Var15)) || func_47(Var18[2], Var18[0], Var12, Var15)) || func_47(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_71(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_103(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_71(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
int func_62(var uParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_176(uParam0, Global_111638.f_2358.f_539[iVar0].f_64, Global_111638.f_2358.f_539[iVar0].f_63))
		{
...
int func_69(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_176(uParam0, Global_111638.f_2358.f_539[iVar0].f_61, Global_111638.f_2358.f_539[iVar0].f_60) || iParam3 == 1)
		{
...
void func_81(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_82(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_88(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_95(Var16.z)] = func_88(iParam1, Var16.x, func_95(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_115(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_115(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_71(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_176(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_71(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_71(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_186(bool bParam0)
{
	...
	{
		UI::CLEAR_HELP(1);
		GAMEPLAY::CLEAR_BIT(&Global_76870, 7);
		func_1(500, 1);
	}
	func_228(303, 0, 0);
...
void func_193(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_195()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_195()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_194(iParam0));
...
bool func_198(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_195()].f_6174.f_10, iParam0);
}
...
void func_224()
{
	...
	{
		iLocal_925[0] = OBJECT::CREATE_OBJECT(1446187959, -1643.524f, -1124.681f, 17.4326f, 1, 1, 0);
	}
	if (!func_56(iLocal_925[1]))
	{
		iLocal_925[1] = OBJECT::CREATE_OBJECT(-881525183, -1645.146f, -1126.613f, 17.4326f, 1, 1, 0);
	}
	if (!func_56(iLocal_925[2]))
	{
		iLocal_925[2] = OBJECT::CREATE_OBJECT(-881525183, -1646.768f, -1128.545f, 17.4326f, 1, 1, 0);
	}
	if (!func_56(iLocal_925[3]))
	{
		iLocal_925[3] = OBJECT::CREATE_OBJECT(-881525183, -1648.39f, -1130.478f, 17.4326f, 1, 1, 0);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_925)
	{
