...
{
	UI::CLEAR_THIS_PRINT(Local_341[iParam0].f_2);
}
...
{
	if (Local_341[iParam0].f_1 < Local_341[iParam0] || Local_341[iParam0] == -1)
	{
		func_35(Local_341[iParam0].f_2, 7500, 1);
		Local_341[iParam0].f_1++;
	}
}
...
void func_40()
{
	switch (iLocal_93)
	{
		case 0:
			...
			if (func_185(iLocal_273, 5f, 5, 1056964608, 0, 1, 0))
			{
				if (bLocal_533)
				{
					...
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_530, 1f, 20000, 1048576000, 0, 1193033728);
				...
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_527, 8f, 1, 0, 0, 0, 0, 0);
				if (!bLocal_533)
				{
		...
		case 1:
			...
			else if ((func_62(iLocal_289, Local_530, 2f) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_474) > 5000) || bLocal_475)
			{
				if (bLocal_476)
				{
...
void func_65(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_67(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_68(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_78(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_78(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_78(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_110(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_78(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_78(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_78(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_89(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_78(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_78(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_95(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_102(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_102(Var16.z)] = func_95(iParam1, Var16.x, func_102(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_102(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_114(func_124(iParam1, uParam0->f_2), Global_76431, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_114(func_123(iParam1, uParam0->f_2), Global_76431, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_114(iVar1, Global_76431, 0);
				if (!GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_121(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_121(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_78(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_182(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_78(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_78(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_93)
	{
		...
		case 1:
			...
			if (iLocal_305)
			{
				if (func_200(5))
				{
					if (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || !func_29())
					{
						func_34(5);
					}
				}
			...
			{
				if (func_200(2) && (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || !func_29()))
				{
					func_34(2);
				}
			...
			else if (iLocal_309)
			{
				if (iLocal_310)
				{
					if (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || (iLocal_466 >= 4 && !func_29()))
					{
						func_34(3);
						iLocal_310 = 0;
					}
...
void func_191()
{
	if (iLocal_466 == 0)
	{
		if (bLocal_336)
		{
			if (bLocal_337)
			{
				...
				if (func_3(&uLocal_96, Local_438[0].f_1, Local_438[0].f_2, 7, 0, 0, 0))
				{
					AI::OPEN_SEQUENCE_TASK(&uVar0);
			...
			else if (func_3(&uLocal_96, Local_438[1].f_1, Local_438[1].f_2, 7, 0, 0, 0))
			{
				iLocal_466 += 4;
			}
		}
		...
		{
			if (func_3(&uLocal_96, Local_438[2].f_1, Local_438[2].f_2, 7, 0, 0, 0))
			{
				iLocal_466 += 4;
			}
		}
	...
	else if (iLocal_469)
	{
		if (!func_29())
		{
			if (func_3(&uLocal_96, Local_438[8].f_1, Local_438[8].f_2, 7, 0, 0, 0))
			{
				iLocal_469 = 0;
				iLocal_467 = GAMEPLAY::GET_GAME_TIMER();
			}
	...
	else
	{
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_467) > Local_438[3] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
				if (func_3(&uLocal_96, Local_438[3].f_1, Local_438[3].f_2, 7, 0, 0, 0))
				{
					if (!bLocal_337)
					{
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_467) > Local_438[4] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
				if (func_3(&uLocal_96, Local_438[4].f_1, Local_438[4].f_2, 7, 0, 0, 0))
				{
					iLocal_466++;
				}
			}
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_467) > Local_438[5] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
				if (func_3(&uLocal_96, Local_438[5].f_1, Local_438[5].f_2, 7, 0, 0, 0))
				{
					iLocal_466++;
				}
			}
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_467) > Local_438[6] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
				if (func_3(&uLocal_96, Local_438[6].f_1, Local_438[6].f_2, 7, 0, 0, 0))
				{
					iLocal_466++;
				}
			}
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_467) > Local_438[7] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
				if (func_3(&uLocal_96, Local_438[7].f_1, Local_438[7].f_2, 7, 0, 0, 0))
				{
					iLocal_466++;
				}
			}
...
int func_192()
{
	...
	while (iLocal_572 <= 8)
	{
		if (func_193(Local_341[iLocal_572].f_2, 0, 0))
		{
			return 1;
		}
		iLocal_572++;
...
{
	func_206(&Global_105187, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_206(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	*uParam0 = func_15();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_229())
		{
			func_225(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_218(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_242(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_264())
		{
			*uParam0 = func_248(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_244(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_246() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_114(func_245(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_248(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_263(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Param0, func_249(iVar0, 0), 1);
...
var func_265()
{
	func_275(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_274(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_273(&uVar0, TIME::GET_CLOCK_HOURS());
	func_268(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_267(&uVar0, TIME::GET_CLOCK_MONTH());
	func_266(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_271(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_292()
{
	if (!bLocal_604)
	{
		...
		{
			func_295(1);
			if (((func_294(Local_584[0], Local_584[2], 1f) && !PED::IS_PED_IN_MELEE_COMBAT(iLocal_290)) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !AI::IS_PED_GETTING_UP(iLocal_290))
			{
		...
		if (!bLocal_604)
		{
			...
			{
				if (((GAMEPLAY::GET_GAME_TIMER() > uLocal_606[0] && func_197(PLAYER::PLAYER_PED_ID(), iLocal_290, 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !AI::IS_PED_GETTING_UP(iLocal_290))
				{
					func_293(0, 0);
				}
...
void func_295(bool bParam0)
{
	...
	Local_584[0] = { Local_584[1] };
	Local_584[1] = { Local_584[2] };
	Local_584[2] = { Local_584[3] };
	Local_584[3] = { Local_584[4] };
	Local_584[4] = { Local_584[5] };
	if (bParam0)
	{
		Local_584[5] = { ENTITY::GET_ENTITY_COORDS(iLocal_290, 1) };
	}
	else
	{
		Local_584[5] = { ENTITY::GET_ENTITY_COORDS(Local_277, 1) };
	}
}

void func_296()
{
	if (func_299() && GAMEPLAY::GET_GAME_TIMER() > iLocal_412)
	{
	...
	switch (iLocal_417)
	{
		...
		case 2:
			if (func_32(iLocal_290))
			{
				if (func_197(PLAYER::PLAYER_PED_ID(), iLocal_290, 25f, 1))
				{
					if (func_193("MET1KSTKRED", 0, 0) || func_193("MET1KSTKBLU", 0, 0))
					{
						if (func_3(&uLocal_96, Local_418[iLocal_415].f_1, Local_418[iLocal_415].f_2, 7, 1, 0, 0))
						{
							bLocal_375 = true;
							bLocal_376 = false;
							bLocal_410 = false;
					...
					else if (func_3(&uLocal_96, Local_418[iLocal_415].f_1, Local_418[iLocal_415].f_2, 7, 0, 0, 0))
					{
						bLocal_375 = true;
						bLocal_376 = false;
						bLocal_410 = false;
		...
		case 5:
			if (func_193("MET1KSTKRED", 0, 0) || func_193("MET1KSTKBLU", 0, 0))
			{
				if (func_3(&uLocal_96, Local_428[iLocal_416].f_1, Local_428[iLocal_416].f_2, 7, 1, 0, 0))
				{
					bLocal_375 = false;
					bLocal_376 = true;
					bLocal_410 = false;
			...
			else if (func_3(&uLocal_96, Local_428[iLocal_416].f_1, Local_428[iLocal_416].f_2, 7, 0, 0, 0))
			{
				bLocal_375 = false;
				bLocal_376 = true;
				bLocal_410 = false;
	...
	if (UI::DOES_BLIP_EXIST(*uParam0))
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - *uParam3) > 500)
		{
			if (UI::GET_BLIP_COLOUR(*uParam0) == 1)
			{
				...
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_193(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_193(sParam2, 0, 0))
					{
...
int func_301()
{
	...
	else if (bLocal_336)
	{
		...
		else if (func_62(iLocal_289, ENTITY::GET_ENTITY_COORDS(iLocal_290, 0), 10f))
		{
			return 1;
		}
...
bool func_302(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_303(&(Local_37[iVar4]), Var1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
{
	Var0 = { func_308(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_321(char* sParam0)
{
	if (!func_322(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_291(sParam0)) || func_291("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
void func_343()
{
	Var0 = { ENTITY::GET_ENTITY_COORDS(iLocal_290, 1) };
	Local_584[0] = { Var0.x, Var0.y, (Var0.z + 15f) };
	Local_584[1] = { Var0.x, Var0.y, (Var0.z + 12f) };
	Local_584[2] = { Var0.x, Var0.y, (Var0.z + 9f) };
	Local_584[3] = { Var0.x, Var0.y, (Var0.z + 6f) };
	Local_584[4] = { Var0.x, Var0.y, (Var0.z + 3f) };
	Local_584[5] = { Var0 };
}
	...
	switch (iLocal_93)
	{
		case 0:
			if (func_32(iLocal_290))
			{
				...
				{
					if (func_200(4) && (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || !func_29()))
					{
						func_34(4);
					}
					iLocal_374 = GAMEPLAY::GET_GAME_TIMER();
					...
					Local_320[0] = { Local_479 };
					Local_320[1] = { Local_320[0] };
					Local_320[2] = { Local_320[1] };
					...
					{
						Local_584[0] = { ENTITY::GET_ENTITY_COORDS(Local_277, 1) };
						Local_584[1] = { Local_584[0] };
						Local_584[2] = { Local_584[1] };
					}
...
void func_345()
{
	...
	{
		case 0:
			if ((((GAMEPLAY::GET_GAME_TIMER() - iLocal_374) > 4000 && func_32(iLocal_290)) && !func_192()) && !func_29())
			{
				func_27(&uLocal_96, 4, iLocal_290, "Stalker", 0, 1);
				iLocal_380 = 1;
			}
		...
		case 1:
			if (func_32(iLocal_290))
			{
				...
				else if (func_346() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_331) > 6000)
				{
					iLocal_380 = 7;
				}
		...
		case 2:
			if (func_193("MET1KSTKRED", 0, 0) || func_193("MET1KSTKBLU", 0, 0))
			{
				if (func_3(&uLocal_96, Local_381[iLocal_372].f_1, Local_381[iLocal_372].f_2, 7, 1, 0, 0))
				{
					bLocal_375 = true;
					bLocal_376 = false;
					bLocal_410 = false;
			...
			else if (func_3(&uLocal_96, Local_381[iLocal_372].f_1, Local_381[iLocal_372].f_2, 7, 0, 0, 0))
			{
				bLocal_375 = true;
				bLocal_376 = false;
				bLocal_410 = false;
		...
		case 5:
			if (func_193("MET1KSTKRED", 0, 0) || func_193("MET1KSTKBLU", 0, 0))
			{
				if (func_3(&uLocal_96, Local_397[iLocal_373].f_1, Local_397[iLocal_373].f_2, 7, 1, 0, 0))
				{
					bLocal_375 = false;
					bLocal_376 = true;
					bLocal_410 = false;
			...
			else if (func_3(&uLocal_96, Local_397[iLocal_373].f_1, Local_397[iLocal_373].f_2, 7, 0, 0, 0))
			{
				bLocal_375 = false;
				bLocal_376 = true;
				bLocal_410 = false;
...
int func_346()
{
	if (func_294(Local_320[0], Local_320[2], 2f))
	{
		return 1;
	}
	iLocal_331 = GAMEPLAY::GET_GAME_TIMER();
...
void func_348()
{
	...
	{
		Local_320[0] = { Local_320[1] };
		Local_320[1] = { Local_320[2] };
		Local_320[2] = { ENTITY::GET_ENTITY_COORDS(iLocal_273, 1) };
		iLocal_330 = GAMEPLAY::GET_GAME_TIMER();
	}
}
...
void func_352()
{
	if (func_32(Local_277))
	{
		...
		{
			func_295(0);
			if (func_294(Local_584[3], Local_584[5], 2f) && func_353())
			{
				iLocal_92 = 6;
				iLocal_93 = 0;
			}
			else if (func_294(Local_584[0], Local_584[5], 2f))
			{
				iLocal_92 = 6;
				iLocal_93 = 0;
			}
...
void func_354()
{
	...
	if (iLocal_617 == 1)
	{
		...
		else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_613) < iLocal_614 && func_355(1))
		{
	...
	if (iLocal_617 == 2)
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_613) < iLocal_614 && func_355(0))
		{
...
int func_358(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		Var1 = { func_308(ENTITY::GET_ENTITY_COORDS(iVar0, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
			...
			if (func_32(iLocal_290))
			{
				if (func_32(Local_277))
				{
					if (!iLocal_335)
					{
						...
						{
							AI::TASK_PLAY_ANIM(iLocal_289, "missmichael_event@tracy", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
int func_362(struct<3> Param0, float fParam3, int iParam4)
{
	...
	else if (iLocal_292)
	{
		if (STREAMING::HAS_MODEL_LOADED(iLocal_291) && STREAMING::HAS_MODEL_LOADED(Local_277.f_1))
		{
			...
			Local_277 = VEHICLE::CREATE_VEHICLE(Local_277.f_1, Param0, fParam3, 1, 1, 0);
...
void func_364()
{
	if (func_62(PLAYER::PLAYER_PED_ID(), Local_487[3], Local_487[3].f_3))
	{
		if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(Local_277.f_1, Local_546[0], 0))
		{
			iVar0 = 0;
		}
		else
	...
	else
	{
		if (func_365())
		{
			if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(Local_277.f_1, Local_546[2], 0))
			{
				iVar0 = 2;
			}
			else
		...
		else if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(Local_277.f_1, Local_546[4], 0))
		{
			iVar0 = 4;
		}
		else
			...
			if (!func_366())
			{
				...
				if (iLocal_305)
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, 0))
					{
						...
						{
							iLocal_306 = 0;
							if (iLocal_316 == 5 && !func_62(PLAYER::PLAYER_PED_ID(), Local_487[iLocal_520], Local_487[iLocal_520].f_3))
							{
								uLocal_297 = func_288(Local_487[iLocal_520], 5, 1);
							}
				...
				else
				{
					switch (iLocal_316)
					{
						...
						case 2:
							if (func_29())
							{
								if (AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE() >= Local_487[iLocal_520].f_7)
								{
									uLocal_297 = func_288(Local_487[iLocal_520], 5, 1);
									iLocal_316 = 3;
								}
						...
						case 3:
							...
							if (func_62(PLAYER::PLAYER_PED_ID(), Local_487[iLocal_520], Local_487[iLocal_520].f_3))
							{
								iLocal_316 = 5;
							}
							else if (!func_29())
						...
						case 4:
							...
							else if (!func_29() && GAMEPLAY::GET_GAME_TIMER() > iLocal_543)
							{
								if (!func_194())
								{
									if (bLocal_312 && !GAMEPLAY::ARE_STRINGS_EQUAL(Local_487[iLocal_520].f_6, "NULL"))
									{
...
void func_368()
{
	...
	{
		if (func_346() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_331) > 18000)
		{
...
void func_369()
{
	...
	Var27.f_1 = 3;
	Var27.f_1.f_4 = 3;
	Var3[0] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_273, -8f, 2f, 0f) };
	Var3[1] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_273, -8f, 8f, 0f) };
	Var3[2] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_273, 8f, 2f, 0f) };
	Var3[3] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_273, 8f, 8f, 0f) };
	Var27[0][0] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3);
	if (Var27[0][0] < 2)
	{
		Var27[0][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 3);
	}
	else
	{
		Var27[0][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 1);
	}
	if (Var27[0][0] > 1)
	{
		Var27[0][2] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 3);
	}
	else
	{
		Var27[0][2] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 1);
	}
	Var16[0][0] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(300, 600);
	Var16[0][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(400, 1000);
	Var16[0][2] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	Var16[0][3] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	AI::OPEN_SEQUENCE_TASK(&(uVar0[0]));
	AI::TASK_PAUSE(0, Var16[0][0]);
	AI::TASK_LOOK_AT_COORD(0, Var3[Var27[0][0]], Var16[0][1], 2048, 2);
	AI::TASK_LOOK_AT_COORD(0, Var3[Var27[0][1]], Var16[0][2], 2048, 2);
	AI::TASK_LOOK_AT_COORD(0, Var3[Var27[0][2]], Var16[0][3], 2048, 2);
	AI::CLOSE_SEQUENCE_TASK(uVar0[0]);
	AI::TASK_PERFORM_SEQUENCE(iLocal_289, uVar0[0]);
	AI::CLEAR_SEQUENCE_TASK(&(uVar0[0]));
	Var27[1][0] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3);
	...
	if (Var27[1][0] < 2)
	{
		Var27[1][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 3);
	}
	else
	{
		Var27[1][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 1);
	}
	if (Var27[1][0] > 1)
	{
		Var27[1][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 3);
	...
	Var16[1][0] = 0;
	Var16[1][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	Var16[1][2] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	Var16[1][3] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	AI::OPEN_SEQUENCE_TASK(&(uVar0[1]));
	AI::TASK_PAUSE(0, Var16[1][0]);
	AI::TASK_LOOK_AT_COORD(0, Var3[Var27[1][0]], Var16[1][1], 2048, 2);
	AI::TASK_LOOK_AT_COORD(0, Var3[Var27[1][1]], Var16[1][2], 2048, 2);
	AI::TASK_LOOK_AT_COORD(0, Var3[Var27[1][2]], Var16[1][3], 2048, 2);
...
{
	Var0 = { func_308(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	...
	switch (iLocal_93)
	{
		case 0:
			...
			if (!func_366())
			{
				if (!func_2())
				{
					if (((func_393(&iLocal_289, Local_483, iLocal_486, 1) && func_383(&iLocal_273, 15, Local_479, fLocal_482, 1, 0)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_296)) && func_32(iLocal_273))
					{
						iLocal_293 = 1;
...
void func_381()
{
	...
	{
		case 0:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_369) > 5000 && func_197(iLocal_289, PLAYER::PLAYER_PED_ID(), 25f, 1))
			{
				iLocal_371 = 9;
			}
			break;
...
int func_387(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_391(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_390(*uParam0, ((*uParam1)[38] - 1)))
	{
...
void func_394()
{
	switch (iLocal_93)
	{
		...
		case 2:
			...
			{
				STREAMING::REQUEST_ANIM_DICT(sLocal_296);
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(Local_534[0], Local_534[1], Local_534.f_7, 0, 0, 1);
				uLocal_542 = PED::ADD_SCENARIO_BLOCKING_AREA(227.4f, -66.5f, 67.5f, 249f, -30.8f, 72.5f, 0, 1, 1, 1);
				GAMEPLAY::CLEAR_AREA(Local_479, 30f, 0, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_479, 30f, 0, 0, 0, 0, 0, 0);
				iLocal_93 = 0;
				iLocal_92 = 2;
			}
			break;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_428(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_425(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_399(Global_102203.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_441(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_443(Global_111638.f_18528[iVar0], &Var2, &fVar5))
			{
...
void func_446(bool bParam0, bool bParam1)
{
	...
	{
		Var0[0] = { func_464() };
		if (PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(Var0[0], &(Var0[1]), &fVar7, 1, 1077936128, 0))
		{
		}
		else
		{
			func_463(Var0[0], &(Var0[1]), &fVar7);
		}
		Local_618 = { Var0[1] };
		fLocal_621 = fVar7;
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_618, 10f, 0, 0, 0, 0, 0, 0);
	...
	else if ((((iLocal_92 == 3 || iLocal_92 == 4) || iLocal_92 == 5) && func_32(iLocal_273)) && func_32(iLocal_289))
	{
		if (func_32(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, 0))
			{
				...
				Local_618 = { ENTITY::GET_ENTITY_COORDS(iLocal_273, 1) };
			}
		}
	}
	else
...
{
	Local_341[iParam0].f_1 = iParam1;
}

void func_458(int iParam0)
{
	if (Local_341[iParam0] == -1)
	{
	}
	else
	{
		Local_341[iParam0].f_1 = Local_341[iParam0];
	}
}
...
void func_460(struct<3> Param0, float fParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		while (!func_393(&iLocal_289, Param0.x, Param0.y, (Param0.z + 5f), 0, 1))
		{
			SYSTEM::WAIT(0);
		}
...
{
	Var0[0] = { -170.324f, -52.57f, 51.683f };
	fVar13[0] = 159.9f;
	Var0[1] = { 1196.14f, -1069.13f, 40.3586f };
	fVar13[1] = 107.2f;
	Var0[2] = { -1513.565f, -676.1716f, 27.4587f };
	fVar13[2] = 53.2f;
	Var0[3] = { 55.9539f, 342.8233f, 111.6553f };
	fVar13[3] = 242.4f;
	iVar18 = 0;
	iLocal_572 = 1;
	while (iLocal_572 < 4)
	{
		if (SYSTEM::VDIST2(Var0[iLocal_572], Param0) < SYSTEM::VDIST2(Var0[iVar18], Param0))
		{
			iVar18 = iLocal_572;
		}
		iLocal_572++;
...
void func_466(bool bParam0)
{
	...
	else
	{
		if (func_32(PLAYER::PLAYER_PED_ID()))
		{
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_487[3], Local_487[3].f_1, (Local_487[3].f_2 + 8f), 1, 0, 0, 1);
			func_460(Local_487[3], 71.4f, 1);
			func_459(PLAYER::PLAYER_PED_ID(), iLocal_273, -1);
		}
		if (func_32(iLocal_273))
...
{
	return func_470(&(Global_105187.f_2890), Param0, fParam3, 0);
}
	...
	if (func_493(uParam0))
	{
		...
		if (func_492(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_475(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_475(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_477(iParam0, uVar1[iVar6], 1) && func_476(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_241(Param1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_480(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_218(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_218(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_218(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == 340154634 || uParam1->f_66 == -1960756985)
		{
			...
			while (iVar2 <= 9)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_218(iVar2)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_218(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_218(iVar3)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_218(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_218(iVar4)))
					{
					}
					else
					{
						GAMEPLAY::SET_BIT(&(uParam1->f_77), func_218(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_483(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_482())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_218(iVar5 + 1)))
				{
...
int func_509(int iParam0, bool bParam1, var uParam2)
{
	*uParam2 = 0;
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_414(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != 873639469) && ENTITY::GET_ENTITY_MODEL(iParam0) != -1177863319)
		{
			*uParam2 = 2;
			return 0;
		}
...
void func_544()
{
	...
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(-1177863319, 1);
	func_545(1);
	iLocal_317 = 0;
	iLocal_333 = 0;
	iLocal_293 = 0;
...
{
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(-713569950, iParam0);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(-2072933068, iParam0);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(-784816453, iParam0);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(475220373, iParam0);
	...
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(-1700801569, iParam0);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(850991848, iParam0);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(569305213, iParam0);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(-2137348917, iParam0);
...
void func_547()
{
	Local_546[0] = { -224.0988f, -62.9169f, 48.8994f };
	fLocal_565[0] = 250.2f;
	Local_546[1] = { -98.7688f, -90.0482f, 56.5581f };
	fLocal_565[1] = 72.7f;
	Local_546[2] = { -190.0195f, -64.3358f, 50.6959f };
	fLocal_565[2] = 70.37f;
	Local_546[3] = { -254.3389f, -16.5055f, 48.7322f };
	fLocal_565[3] = 170.42f;
	Local_546[4] = { -145.0999f, -91.2274f, 54.1001f };
	fLocal_565[4] = 249.33f;
	Local_546[5] = { -35.9104f, -97.4508f, 56.3653f };
...
{
	Local_381[0] = 0;
	Local_381[0].f_1 = "MET1AUD";
	Local_381[0].f_2 = "MET1_TRCC1";
	Local_381[1] = 0;
	Local_381[1].f_1 = "MET1AUD";
	Local_381[1].f_2 = "MET1_TRCC2";
	Local_381[2] = 0;
	Local_381[2].f_1 = "MET1AUD";
	Local_381[2].f_2 = "MET1_TRCC3";
	Local_381[3] = 0;
	Local_381[3].f_1 = "MET1AUD";
	Local_381[3].f_2 = "MET1_TRCC4";
	Local_381[4] = 0;
	Local_381[4].f_1 = "MET1AUD";
	Local_381[4].f_2 = "MET1_TRCC5";
	Local_397[0] = 0;
	Local_397[0].f_1 = "MET1AUD";
	Local_397[0].f_2 = "MET1_ST1";
	Local_397[1] = 0;
	Local_397[1].f_1 = "MET1AUD";
	Local_397[1].f_2 = "MET1_ST2";
	Local_397[2] = 0;
	Local_397[2].f_1 = "MET1AUD";
	Local_397[2].f_2 = "MET1_ST3";
	Local_397[3] = 0;
	Local_397[3].f_1 = "MET1AUD";
	Local_397[3].f_2 = "MET1_ST4";
	Local_418[0] = 0;
	Local_418[0].f_1 = "MET1AUD";
	Local_418[0].f_2 = "MET1_STW1";
	Local_418[1] = 0;
	Local_418[1].f_1 = "MET1AUD";
	Local_418[1].f_2 = "MET1_STW2";
	Local_418[2] = 0;
	Local_418[2].f_1 = "MET1AUD";
	Local_418[2].f_2 = "MET1_STW3";
	Local_428[0] = 0;
	Local_428[0].f_1 = "MET1AUD";
	Local_428[0].f_2 = "MET1_TRFC1";
	Local_428[1] = 0;
	Local_428[1].f_1 = "MET1AUD";
	Local_428[1].f_2 = "MET1_TRFC2";
	Local_428[2] = 0;
	Local_428[2].f_1 = "MET1AUD";
	Local_428[2].f_2 = "MET1_TRFC3";
	Local_438[0] = 0;
	Local_438[0].f_1 = "MET1AUD";
	Local_438[0].f_2 = "MET1_TSDEAD1";
	Local_438[1] = 0;
	Local_438[1].f_1 = "MET1AUD";
	Local_438[1].f_2 = "MET1_TSDEAD2";
	Local_438[2] = 0;
	Local_438[2].f_1 = "MET1AUD";
	Local_438[2].f_2 = "MET1_TSESCP1";
	Local_438[3] = 5000;
	Local_438[3].f_1 = "MET1AUD";
	Local_438[3].f_2 = "MET1_GOHOM1";
	Local_438[4] = 8000;
	Local_438[4].f_1 = "MET1AUD";
	Local_438[4].f_2 = "MET1_GOHOM2";
	Local_438[5] = 8000;
	Local_438[5].f_1 = "MET1AUD";
	Local_438[5].f_2 = "MET1_GOHOM3";
	Local_438[6] = 8000;
	Local_438[6].f_1 = "MET1AUD";
	Local_438[6].f_2 = "MET1_GOHOM4";
	Local_438[7] = 8000;
	Local_438[7].f_1 = "MET1AUD";
	Local_438[7].f_2 = "MET1_GOHOM5";
	Local_438[8] = 0;
	Local_438[8].f_1 = "MET1AUD";
	Local_438[8].f_2 = "MET1_GOHOMC";
}

void func_551()
{
	Local_341[0] = { func_552("MET1INITDRV", 1) };
	Local_341[1] = { func_552("MET1TCAR", 1) };
	Local_341[2] = { func_552("MET1WAIT", 1) };
	Local_341[3] = { func_552("MET1WANT", -1) };
	Local_341[4] = { func_552("MET1CHASE", 1) };
	Local_341[5] = { func_552("MET1GETBKT", 1) };
	Local_341[6] = { func_552("MET1DLT", 1) };
	Local_341[7] = { func_552("MET1HOME", 1) };
	Local_341[8] = { func_552("MET1HOTEL", 1) };
}
...
void func_557(bool bParam0, bool bParam1)
{
	...
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(Local_534[0], Local_534[1], Local_534.f_7, 1);
	...
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(-1177863319, 0);
	func_545(0);
