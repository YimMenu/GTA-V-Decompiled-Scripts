	...
	switch (iLocal_93)
	{
		case 0:
			...
			if (func_185(iLocal_273, 5f, 5, 1056964608, 0, 1, 0))
			{
				...
				MISC::CLEAR_AREA_OF_VEHICLES(Local_527, 8f, true, false, false, false, false, false);
				if (!bLocal_533)
				{
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 7, -1, false, -1, func_78(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 7, -1, false, -1, func_78(iParam2));
...
void func_112(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2552060[iParam0 /*3*/][func_113(iParam2)];
	if (iVar0 != 0)
	{
...
int func_114(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2552060[iParam0 /*3*/][func_113(iParam1)];
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_121(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_121(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 7, -1, false, -1, func_78(iParam0));
			if (iVar57 > iVar56)
			{
...
{
	func_206(&Global_105407, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_226(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2588062[iParam0 /*3*/][func_113(iParam1)];
...
void func_295(bool bParam0)
{
	...
	{
		Local_584[5 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_277, true) };
	}
}
		...
		case 0:
			if (func_32(iLocal_290))
			{
				...
				else
				{
					...
					{
						Local_584[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_277, true) };
...
int func_362(struct<3> Param0, float fParam3, int iParam4)
{
	...
	else if (iLocal_292)
	{
		if (STREAMING::HAS_MODEL_LOADED(iLocal_291) && STREAMING::HAS_MODEL_LOADED(Local_277.f_1))
		{
			...
			Local_277 = VEHICLE::CREATE_VEHICLE(Local_277.f_1, Param0, fParam3, true, true, false);
...
int func_383(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)
{
	...
	if (!func_17(iParam1))
	{
		...
		if ((iParam1 == 17 && Global_111858.f_2359.f_539.f_3618[0 /*197*/][0 /*98*/] == Var0) || (iParam1 == 15 && Global_111858.f_2359.f_539.f_3618[0 /*197*/][1 /*98*/] == Var0))
		{
			...
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_3618[0 /*197*/][iVar98 /*98*/], Param2, fParam5, false, false, false);
		...
		else
		{
			...
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var0, Param2, fParam5, false, false, false);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(*iParam0, 5f);
				VEHICLE::_0xAB04325045427AAE(*iParam0, false);
				VEHICLE::SET_VEHICLE_CAN_SAVE_IN_GARAGE(*iParam0, false);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(*iParam0, true);
	...
	switch (iLocal_93)
	{
		...
		case 2:
			if (!func_2())
			{
				...
				MISC::CLEAR_AREA_OF_VEHICLES(Local_479, 30f, false, false, false, false, false, false);
				iLocal_93 = 0;
				iLocal_92 = 2;
			}
			break;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102423.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102423.f_4, false))
		{
			if (func_428(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_425(ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
...
void func_446(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		...
		Local_618 = { Var0[1 /*3*/] };
		fLocal_621 = fVar7;
		MISC::CLEAR_AREA_OF_VEHICLES(Local_618, 10f, false, false, false, false, false, false);
...
int func_510(int iParam0)
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
		{
			...
			{
				return func_511(Global_2426097[iParam0 /*443*/].f_314.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_514(int iParam0)
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
		{
			if (Global_2426097[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_511(Global_2426097[iParam0 /*443*/].f_314.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_515(int iParam0)
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
		{
			if (Global_2426097[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_511(Global_2426097[iParam0 /*443*/].f_314.f_6) == 7;
			}
		}
	}
	return 0;
...
int func_531(int iParam0)
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
		{
			...
			{
				return func_511(Global_2426097[iParam0 /*443*/].f_314.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_532(int iParam0)
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
		{
			if (Global_2426097[iParam0 /*443*/].f_314.f_6 != -1 && Global_2426097[iParam0 /*443*/].f_314.f_9 != func_9())
			{
				return func_511(Global_2426097[iParam0 /*443*/].f_314.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_533(int iParam0)
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
		{
			if (Global_2426097[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_511(Global_2426097[iParam0 /*443*/].f_314.f_6) == 9;
			}
		}
	}
	return 0;
