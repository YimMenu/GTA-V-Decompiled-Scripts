...
{
	HUD::CLEAR_THIS_PRINT(Local_341[iParam0].f_2);
}
	...
	switch (iLocal_93)
	{
		case 0:
			...
			if (func_185(iLocal_273, 5f, 5, 1056964608, 0, 1, 0))
			{
				...
				MISC::CLEAR_AREA_OF_VEHICLES(Local_527, 8f, 1, 0, 0, 0, 0, 0);
				if (!bLocal_533)
				{
					MISC::CLEAR_AREA_OF_VEHICLES(-820.2315f, 176.7027f, 70.6122f, 8f, 1, 0, 0, 0, 0, 0);
				}
				if (bLocal_533)
				{
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_121(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_121(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_191()
{
	...
	else
	{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[3] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[4] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[5] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[6] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[7] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
...
int func_248(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_263(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_249(iVar0, 0), 1);
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_271(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_292()
{
	if (!bLocal_604)
	{
		...
		{
			func_295(1);
			if (((func_294(Local_584[0], Local_584[2], 1f) && !PED::IS_PED_IN_MELEE_COMBAT(iLocal_290)) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !TASK::IS_PED_GETTING_UP(iLocal_290))
			{
...
void func_354()
{
	if (iLocal_617 == 0)
	{
		...
		else if ((MISC::GET_GAME_TIMER() - iLocal_613) > iLocal_616 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277, 0f, -0.5f, -1.5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277, 0f, 6f, 2f), 12f, 0, 1, 0))
		{
			iLocal_613 = MISC::GET_GAME_TIMER();
			iLocal_617 = 1;
		}
		...
		case 0:
			if (!func_366())
			{
				...
				if (func_362(Local_277.f_6, Local_277.f_9, 0))
				{
					...
					TASK::OPEN_SEQUENCE_TASK(&uVar0);
					TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_277, ENTITY::GET_ENTITY_COORDS(iLocal_273, 1), 4, 35f, 2883621, 10f, 12f, 1);
					TASK::TASK_VEHICLE_ESCORT(0, Local_277, iLocal_273, -1, 25f, 2883621, -1082130432, 20, 1101004800);
					TASK::CLOSE_SEQUENCE_TASK(uVar0);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_290, uVar0);
					TASK::CLEAR_SEQUENCE_TASK(&uVar0);
...
int func_362(struct<3> Param0, float fParam3, int iParam4)
{
	...
	else if (iLocal_292)
	{
		...
		{
			MISC::CLEAR_AREA_OF_VEHICLES(Local_277.f_6, 5f, 0, 0, 0, 0, 0, 0);
					...
					switch (iLocal_316)
					{
						...
						case 4:
							...
							else if (!func_29() && MISC::GET_GAME_TIMER() > iLocal_543)
							{
								if (!func_194())
								{
									if (bLocal_312 && !MISC::ARE_STRINGS_EQUAL(Local_487[iLocal_520].f_6, "NULL"))
									{
...
void func_369()
{
	...
	Var27[0][0] = MISC::GET_RANDOM_INT_IN_RANGE(0, 3);
	if (Var27[0][0] < 2)
	{
		Var27[0][1] = MISC::GET_RANDOM_INT_IN_RANGE(2, 3);
	}
	else
	{
		Var27[0][1] = MISC::GET_RANDOM_INT_IN_RANGE(0, 1);
	}
	if (Var27[0][0] > 1)
	{
		Var27[0][2] = MISC::GET_RANDOM_INT_IN_RANGE(2, 3);
	}
	else
	{
		Var27[0][2] = MISC::GET_RANDOM_INT_IN_RANGE(0, 1);
	}
	Var16[0][0] = MISC::GET_RANDOM_INT_IN_RANGE(300, 600);
	Var16[0][1] = MISC::GET_RANDOM_INT_IN_RANGE(400, 1000);
	Var16[0][2] = MISC::GET_RANDOM_INT_IN_RANGE(500, 1000);
	Var16[0][3] = MISC::GET_RANDOM_INT_IN_RANGE(500, 1000);
	TASK::OPEN_SEQUENCE_TASK(&(uVar0[0]));
	TASK::TASK_PAUSE(0, Var16[0][0]);
	TASK::TASK_LOOK_AT_COORD(0, Var3[Var27[0][0]], Var16[0][1], 2048, 2);
	TASK::TASK_LOOK_AT_COORD(0, Var3[Var27[0][1]], Var16[0][2], 2048, 2);
	TASK::TASK_LOOK_AT_COORD(0, Var3[Var27[0][2]], Var16[0][3], 2048, 2);
	TASK::CLOSE_SEQUENCE_TASK(uVar0[0]);
	TASK::TASK_PERFORM_SEQUENCE(iLocal_289, uVar0[0]);
	TASK::CLEAR_SEQUENCE_TASK(&(uVar0[0]));
	Var27[1][0] = MISC::GET_RANDOM_INT_IN_RANGE(0, 3);
	...
	if (Var27[1][0] < 2)
	{
		Var27[1][1] = MISC::GET_RANDOM_INT_IN_RANGE(2, 3);
	}
	else
	{
		Var27[1][1] = MISC::GET_RANDOM_INT_IN_RANGE(0, 1);
	}
	if (Var27[1][0] > 1)
	{
		Var27[1][1] = MISC::GET_RANDOM_INT_IN_RANGE(2, 3);
	...
	Var16[1][0] = 0;
	Var16[1][1] = MISC::GET_RANDOM_INT_IN_RANGE(500, 1000);
	Var16[1][2] = MISC::GET_RANDOM_INT_IN_RANGE(500, 1000);
	Var16[1][3] = MISC::GET_RANDOM_INT_IN_RANGE(500, 1000);
	TASK::OPEN_SEQUENCE_TASK(&(uVar0[1]));
	TASK::TASK_PAUSE(0, Var16[1][0]);
	TASK::TASK_LOOK_AT_COORD(0, Var3[Var27[1][0]], Var16[1][1], 2048, 2);
	TASK::TASK_LOOK_AT_COORD(0, Var3[Var27[1][1]], Var16[1][2], 2048, 2);
	TASK::TASK_LOOK_AT_COORD(0, Var3[Var27[1][2]], Var16[1][3], 2048, 2);
		...
		if ((iParam1 == 17 && Global_111638.f_2358.f_539.f_3618[0][0] == Var0) || (iParam1 == 15 && Global_111638.f_2358.f_539.f_3618[0][1] == Var0))
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_3618[0][iVar98]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_3618[0][iVar98], Param2, fParam5, 0, 0, 0);
				...
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 2, MISC::IS_BIT_SET(Global_111638.f_2358.f_539.f_3618[0][iVar98].f_92, 28));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 3, MISC::IS_BIT_SET(Global_111638.f_2358.f_539.f_3618[0][iVar98].f_92, 29));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 0, MISC::IS_BIT_SET(Global_111638.f_2358.f_539.f_3618[0][iVar98].f_92, 30));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 1, MISC::IS_BIT_SET(Global_111638.f_2358.f_539.f_3618[0][iVar98].f_92, 31));
	...
	switch (iLocal_93)
	{
		...
		case 2:
			if (!func_2())
			{
				...
				MISC::CLEAR_AREA_OF_VEHICLES(Local_479, 30f, 0, 0, 0, 0, 0, 0);
				iLocal_93 = 0;
				iLocal_92 = 2;
			}
			break;
...
void func_446(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		...
		Local_618 = { Var0[1] };
		fLocal_621 = fVar7;
		MISC::CLEAR_AREA_OF_VEHICLES(Local_618, 10f, 0, 0, 0, 0, 0, 0);
...
void func_466(bool bParam0)
{
	...
	else
	{
		...
		if (func_32(iLocal_273))
		{
			MISC::CLEAR_AREA_OF_VEHICLES(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_273, 0f, -8f, 0f), 6f, 0, 0, 0, 0, 0, 0);
		}
	}
	...
	if (func_32(PLAYER::PLAYER_PED_ID()))
	{
		if (bParam0)
		{
			if (func_497())
			{
				...
				fLocal_621 = 251.1f;
				bLocal_622 = true;
				MISC::CLEAR_AREA_OF_VEHICLES(99.6208f, -21.0027f, 67.0114f, 7f, 0, 0, 0, 0, 0, 0);
				func_495();
				while (!func_494())
				{
					SYSTEM::WAIT(0);
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_241(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
