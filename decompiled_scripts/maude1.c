		...
		case 0:
			...
			if (iLocal_144 == 1)
			{
				...
				if (func_17(iLocal_158))
				{
					...
					{
						if (func_14(iLocal_158, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f))
						{
		...
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_158, "special_ped@maude@base", "base", 3))
		{
			if (!PED::IS_PED_RAGDOLL(iLocal_158) || TASK::IS_PED_GETTING_UP(iLocal_158))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@exit_flee"))
				{
					...
					PED::_0x2208438012482A1A(iLocal_158, 0, 0);
	...
	switch (iLocal_143)
	{
		case 0:
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_156))
			{
				...
				{
					iLocal_156 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2727.4f, 4145.56f, 43.68f, 10f, -380698483, 1, 0, 1);
		...
		case 1:
			...
			if (func_17(iLocal_158))
			{
				Var0 = { ENTITY::GET_ENTITY_COORDS(iLocal_158, 0) };
				if (!func_243(0))
				{
...
void func_29(int iParam0, bool bParam1)
{
	...
	{
		func_197(&(Global_110725[iVar0].f_9));
	}
	if (bParam1)
	{
...
int func_58(int iParam0, int iParam1, int iParam2)
{
	...
	Global_76434[1] = { func_109(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_76434[1] = { func_109(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_101(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_101(iParam1), Global_76434[1].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_101(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, 0);
		}
	}
...
int func_59(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_174(iParam0, Global_111638.f_2358.f_539[iVar0].f_64, Global_111638.f_2358.f_539[iVar0].f_63))
		{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76434[1] = { func_109(iVar10, iParam1, iParam2, -1) };
		if (!func_99(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76434[1] = { func_109(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1] = { func_109(iVar10, 14, uVar28[iVar1], -1) };
							func_77(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
							func_92(14);
							if (Global_76432 == 1)
							{
								iVar2 = 0;
			...
			{
				Global_76434[1] = { func_109(iVar10, iVar0, func_67(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1] = { func_109(iVar10, 14, uVar69[iVar1], -1) };
			func_77(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
			func_92(14);
			if (Global_76432 == 1)
			{
...
{
	Global_76434[1] = { func_109(iParam0, iParam1, iParam2, -1) };
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								if (!func_70(-1692214353, iVar3, iVar5, iVar4, &iVar6))
								{
									if (iVar6 != -99)
									{
										iVar0 = iVar6;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_101(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_101(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_92(int iParam0)
{
	...
	{
		func_98(iParam0, Global_76434[1].f_5, Global_76434[1].f_2, 2, Global_76434[1].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76434[1].f_6, 1) && MISC::IS_BIT_SET(Global_76434[1].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2548434[iParam0][func_95(iParam2)];
	if (iVar0 != 0)
	{
...
int func_96(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0][func_95(iParam1)];
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_174(iParam0, Global_111638.f_2358.f_539[iVar0].f_61, Global_111638.f_2358.f_539[iVar0].f_60) || iParam3 == 1)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_84(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_107(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_107(Var16.z)] = func_84(iParam1, Var16.x, func_107(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_107(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
...
void func_111(int iParam0)
{
	...
	func_112(&(Global_76434[0]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_119(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_112(&(Global_76434[0]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_112(&(Global_76434[0]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_112(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_112(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_101(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_174(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_174(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76434[2] = { func_109(iVar0, 14, iVar4, -1) };
									if (Global_76434[2].f_12 == iVar3)
									{
										if (func_174(iParam0, 14, iVar4))
										{
											if (!func_65(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76434[2])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76434[2] = { func_109(iVar0, iVar2, iVar1, -1) };
						if (!func_65(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76434[2])))
						{
							return 0;
						}
					}
...
void func_186(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != -1)
	{
		...
		func_187(&uVar32, Var0.f_3, Global_98781, iParam1, iParam2);
	}
}
...
{
	func_202(iParam0, 1);
	Global_111638.f_18569[iParam0].f_3 = func_201();
		...
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1] = { func_228(iParam0) };
					...
					{
						Global_7966[1] = { func_228(iParam0) };
...
bool func_253(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_254(&(Local_37[iVar4]), Var1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_325(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_322(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_278(Global_102203.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_278(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_312(iParam5, &Var0, Param1, uParam4, func_315(iParam0));
...
void func_279(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_309(&(Global_75441.f_555[0]), iParam0))
	{
		return;
	}
...
int func_309(var uParam0, int iParam1)
{
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_316(Global_111638.f_32744.f_1864[uParam0->f_14], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_316(Global_111638.f_2358.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_316(Global_111638.f_2358.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, 0))
		{
...
void func_312(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6)
{
	if (func_309(&(Global_75441.f_555[0]), iParam0))
	{
		...
		{
			func_314(iParam0);
			func_313(uParam1, &(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]));
...
int func_329(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_330(Var18[0], Var18[1], Var6, Var9) || func_330(Var18[0], Var18[1], Var9, Var15)) || func_330(Var18[0], Var18[1], Var12, Var15)) || func_330(Var18[0], Var18[1], Var6, Var12)) || func_330(Var18[1], Var18[3], Var6, Var9)) || func_330(Var18[1], Var18[3], Var9, Var15)) || func_330(Var18[1], Var18[3], Var12, Var15)) || func_330(Var18[1], Var18[3], Var6, Var12)) || func_330(Var18[3], Var18[2], Var6, Var9)) || func_330(Var18[3], Var18[2], Var9, Var15)) || func_330(Var18[3], Var18[2], Var12, Var15)) || func_330(Var18[3], Var18[2], Var6, Var12)) || func_330(Var18[2], Var18[0], Var6, Var9)) || func_330(Var18[2], Var18[0], Var9, Var15)) || func_330(Var18[2], Var18[0], Var12, Var15)) || func_330(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
{
	return func_333(Global_102203.f_2890.f_12.f_66, Param0, iParam3);
}
...
void func_361()
{
	if (Global_92921)
	{
		func_375(&iLocal_328, 2662.644f, 4284.535f, 43.5787f, 19.8376f, 0, 0, 1, 0, 0, -1903012613, 0, 145, 1);
	...
	else
	{
		...
		{
			func_375(&iLocal_328, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, -1903012613, 0, 145, 1);
		}
...
int func_363(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { 2729.092f, 4143.17f, 41.36332f };
			uParam0->f_17[1] = { 2714.735f, 4145.382f, 45.30732f };
			uParam0->f_24 = 12.8f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
...
int func_364(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_365(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
...
int func_365(int iParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	if (!func_178(iParam1))
	{
...
void func_367(var uParam0, var uParam1, struct<3> Param2, float fParam5)
{
	func_4(uParam0);
		...
		if (Global_111638.f_2358.f_539.f_2407[0][iParam1] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[0][iParam1]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[0][iParam1], Param2, fParam5, 0, 0, 0);
				...
				func_414(iParam0, &(Global_111638.f_2358.f_539.f_2407[0][iParam1].f_31), &(Global_111638.f_2358.f_539.f_2407[0][iParam1].f_81));
		...
		else if (Global_111638.f_2358.f_539.f_2407[1][iParam1] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[1][iParam1]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[1][iParam1], Param2, fParam5, 0, 0, 0);
				...
				func_414(iParam0, &(Global_111638.f_2358.f_539.f_2407[1][iParam1].f_31), &(Global_111638.f_2358.f_539.f_2407[1][iParam1].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == -1435919434)
...
void func_377(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	if ((func_178(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_319(iParam1, &(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_31), &(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_81));
			if (bParam3)
			{
				...
				Global_111638.f_20113[iParam0].f_31 = func_380(*iParam1);
				...
				func_378(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_5, Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_7, iVar3, 1, &(Global_111638.f_20113[iParam0].f_1));
				...
				func_378(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_6, -1, iVar3, 0, &(Global_111638.f_20113[iParam0].f_2));
			}
		}
	}
}
...
int func_381(int iParam0, bool bParam1, var uParam2)
{
	*uParam2 = 0;
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_293(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != 873639469) && ENTITY::GET_ENTITY_MODEL(iParam0) != -1177863319)
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_382(int iParam0)
{
	if (iParam0 != func_385())
	{
		if (func_384(iParam0, 1, 1))
		{
			...
			{
				return func_383(Global_2425662[iParam0].f_310.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_388(int iParam0)
{
	if (iParam0 != func_385())
	{
		if (func_384(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_383(Global_2425662[iParam0].f_310.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_389(int iParam0)
{
	if (iParam0 != func_385())
	{
		if (func_384(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_383(Global_2425662[iParam0].f_310.f_5) == 7;
			}
		}
	}
	return 0;
...
int func_406(int iParam0)
{
	if (iParam0 != func_385())
	{
		if (func_384(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1 && Global_2425662[iParam0].f_310.f_8 != func_385())
			{
				return func_383(Global_2425662[iParam0].f_310.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_407(int iParam0)
{
	if (iParam0 != func_385())
	{
		if (func_384(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1 && Global_2425662[iParam0].f_310.f_8 != func_385())
			{
				return func_383(Global_2425662[iParam0].f_310.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_408(int iParam0)
{
	if (iParam0 != func_385())
	{
		if (func_384(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_383(Global_2425662[iParam0].f_310.f_5) == 9;
			}
		}
	}
	return 0;
...
void func_420(struct<3> Param0, float fParam3, int iParam4)
{
	...
	while (iVar0 < 68)
	{
		if (func_309(&(Global_75441.f_555[0]), iVar0))
		{
...
void func_421(int iParam0)
{
	...
	if (func_309(&(Global_75441.f_555[0]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_75441.f_555[0].f_9, 13))
		{
			if (((((iParam0 == 24 && func_207(iParam0, 0)) && Global_76350.f_66 == 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0].f_14] != 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0].f_14] > 3) && (!func_422(0, Global_75441.f_555[0].f_12) || !func_422(1, Global_75441.f_555[0].f_12)))
			{
				func_313(&(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]), &Global_76350);
...
int func_422(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_423(&(Global_111638.f_32744.f_5038[iVar0])))
	{
		return 0;
	}
	return func_283(Global_111638.f_32744.f_5038[iVar0][iParam0].f_66, 0);
}
...
{
	return func_425(&(Global_105187.f_2890), Param0, fParam3, 0);
}
...
int func_427(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_429(iParam0, uVar1[iVar6], 1) && func_428(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_316(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_442(var uParam0)
{
	...
	if (uParam0->f_12.f_66 == -2122757008 && func_428(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
