						...
						if (!func_2(iLocal_158, 1805844857))
						{
							if (!PED::IS_PED_FLEEING(iLocal_158))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_158, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 3))
								{
									...
									AI::TASK_SMART_FLEE_PED(iLocal_158, PLAYER::PLAYER_PED_ID(), 50f, -1, 0, 0);
...
int func_10()
{
	if (func_17(iLocal_158))
	{
		...
		{
			if (!PED::IS_PED_RAGDOLL(iLocal_158) || AI::IS_PED_GETTING_UP(iLocal_158))
			{
				STREAMING::REQUEST_ANIM_DICT("special_ped@maude@exit_flee");
				if (STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@exit_flee"))
				{
					...
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_150, 0);
					if (func_2(iLocal_158, 1785177548))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_158, -1000f, 1);
					}
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_158, iLocal_150, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 1000f, -4f, 4626, 0, 1148846080, 0);
	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (func_17(iLocal_158))
			{
				...
				{
					AI::TASK_LOOK_AT_ENTITY(iLocal_158, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				}
				PED::SET_PED_KEEP_TASK(iLocal_158, 1);
			}
...
void func_119(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_112(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_112(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_192()
{
	...
	{
		func_181();
		GRAPHICS::_0xBF59707B3E5ED531(func_193(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
...
int func_239(struct<3> Param0, struct<3> Param3, int iParam6, float fParam7)
{
	if (iLocal_153 < iLocal_151)
	{
		if (!func_20())
		{
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() - iLocal_152) > (iParam6 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2000))
				{
	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (func_11(iLocal_158))
			{
				...
				{
					CUTSCENE::_0x2A56C06EBEF2B0D9(sLocal_160, iLocal_158, 0);
				}
			}
			func_352();
				...
				if (func_17(iLocal_158))
				{
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_160, 0) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_161, 0))
					{
						if (STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
						{
							...
							PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_147, 0);
							AI::TASK_SYNCHRONIZED_SCENE(iLocal_158, iLocal_147, "special_ped@maude@base", "base", 1000f, -8f, 4688, 0, 1148846080, 0);
							iVar0 = 0;
							iVar0 = 16;
							iVar0 = 64;
							iVar0 = 512;
...
var func_298()
{
	func_308(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_307(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_306(&uVar0, TIME::GET_CLOCK_HOURS());
	func_301(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_300(&uVar0, TIME::GET_CLOCK_MONTH());
	func_299(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_304(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_335(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_337(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
	...
	if (iLocal_148 == 0)
	{
		if (func_11(Local_81.f_28[0]))
		{
			if (!func_350(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 7f, 1))
			{
				...
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 0f, 1.2f, 0f, 1f, -1, 1036831949, 1);
				}
			...
			AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 4000, 0, 2);
		}
		iLocal_148++;
	}
	else if (iLocal_148 == 1)
	{
		if ((iLocal_149 == -1 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_149) > 3000) || (func_11(Local_81.f_28[0]) && func_350(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 4.5f, 1)))
		{
			return 1;
		}
	}
	...
	if (func_442(uParam0))
	{
		...
		if (func_441(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_427(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_316(Param1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_430(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_318(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_318(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_318(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == 340154634 || uParam1->f_66 == -1960756985)
		{
			...
			while (iVar2 <= 9)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_318(iVar2)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_318(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_318(iVar3)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_318(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_318(iVar4)))
					{
					}
					else
					{
						GAMEPLAY::SET_BIT(&(uParam1->f_77), func_318(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_433(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_432())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_318(iVar5 + 1)))
				{
