...
int func_30()
{
	...
	else
	{
		...
		if (iVar2 >= 50)
		{
			STATS::_UPDATE_STAT_INT(1488317176, 100, 0);
		}
		else if (iVar2 >= 38)
		{
			STATS::_UPDATE_STAT_INT(1488317176, 75, 0);
		}
		else if (iVar2 >= 25)
		{
			func_44(290, 0, 0);
			STATS::_UPDATE_STAT_INT(1488317176, 50, 0);
		}
		else if (iVar2 >= 13)
		{
			STATS::_UPDATE_STAT_INT(1488317176, 25, 0);
		}
	}
