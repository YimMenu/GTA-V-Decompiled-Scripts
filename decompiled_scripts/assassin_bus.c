void __EntryFunction__()
{
	...
	iLocal_1705 = 1;
	iLocal_1727 = -1;
	iLocal_1730 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5, 15);
	iLocal_1735 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5, 10);
	iLocal_1740 = 1000;
	fLocal_1752 = 0.5f;
	fLocal_1756 = 15f;
...
void func_1(struct<39> Param0, var uParam39, var uParam40)
{
	...
	switch (iLocal_1044)
	{
		...
		case 1:
			...
			if (func_102(&uLocal_150, 1, 0) && AUDIO::_0x6F259F82D873B8B8())
			{
...
void func_10(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_12()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_12()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_18(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_12()].f_6174.f_10, iParam0);
}
...
void func_58(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_64(uParam0->f_1, 256) || (func_64(uParam0->f_1, 8192) && CONTROLS::_0x6CD79468A1E595C6(2)))
	{
		...
		if (GAMEPLAY::IS_PC_VERSION())
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(func_64(uParam0->f_1, 4096));
			GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
		}
		iVar5 = 0;
		iVar6 = 0;
...
void func_67(var uParam0, bool bParam1)
{
	...
	func_63(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 215, true));
	func_62("ES_HELP");
	if (GAMEPLAY::IS_PC_VERSION())
	{
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(true);
	...
	if (bParam1)
	{
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0->f_4, "SET_DATA_SLOT");
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(1);
		func_63(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 216, true));
		func_62("ES_XPAND");
		if (GAMEPLAY::IS_PC_VERSION())
		{
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(true);
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_556)
			{
				case 0:
					...
					UI::END_TEXT_COMMAND_DISPLAY_TEXT(fVar20, (fVar1 + func_90((2f * 2f))), 0);
					break;
...
void func_79(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	...
	UI::SET_TEXT_JUSTIFICATION(1);
	UI::SET_TEXT_SCALE(1f, func_81(14f));
	UI::SET_TEXT_CENTRE(0);
	UI::SET_TEXT_FONT(0);
	func_87();
...
void func_80(int iParam0, int iParam1, float fParam2, float fParam3, char* sParam4, int iParam5)
{
	...
	switch (iParam5)
	{
		case 4:
		case 5:
			UI::SET_TEXT_SCALE(1f, func_81(18f));
			UI::SET_TEXT_FONT(4);
			if (iParam0 < 0)
			{
...
void func_103(var uParam0)
{
	...
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(2);
	func_63(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 188, true));
	func_62("ES_HELP_TU");
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(1);
	func_63(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 187, true));
	func_62("ES_HELP_TD");
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_INT(0);
	func_63(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 202, true));
	func_62("ES_HELP_AB");
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	GRAPHICS::_POP_SCALEFORM_MOVIE_FUNCTION_VOID();
...
void func_104(var uParam0)
{
	fVar0 = 0f;
	UI::SET_TEXT_JUSTIFICATION(0);
	UI::SET_TEXT_SCALE(1f, func_81(16f));
	if (uParam0->f_31 == 0)
	{
		if (uParam0->f_29)
		{
...
var func_136()
{
	...
	func_139(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_138(&uVar0, TIME::GET_CLOCK_MONTH());
	func_137(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_142(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
float func_165(var uParam0)
{
	if (func_168(uParam0))
	{
		...
		{
			return (func_166(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
int func_174(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_176() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_19(func_175(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_204(int iParam0, bool bParam1)
{
	...
	if (func_165(&uLocal_1837) > fLocal_1757)
	{
		...
		fLocal_1757 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 3f);
		func_183(&uLocal_1837);
	}
}
...
{
	iLocal_1735 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iParam0, iParam1);
	func_183(&uLocal_1825);
	func_183(&uLocal_1831);
	iLocal_1731++;
}
...
{
	iLocal_1730 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iParam0, iParam1);
	func_183(&uLocal_1822);
	func_183(&uLocal_1831);
	iLocal_1729++;
}
...
void func_223(var uParam0)
{
	if (func_168(uParam0))
	{
		if (!func_167(uParam0))
		{
			uParam0->f_2 = (func_166(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
...
void func_224()
{
	UI::REMOVE_BLIP(&(Local_2246[0].f_9));
	UI::REMOVE_BLIP(&(Local_2246[1].f_9));
	UI::REMOVE_BLIP(&(Local_2246[2].f_9));
	UI::REMOVE_BLIP(&(Local_2246[3].f_9));
}
...
{
	AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iParam0, uParam1, "OJASbs_102", 52, 0, 20, -1, -1082130432, 0, 1073741824);
	Local_1758 = { -455.2892f, -326.1364f, 41.22218f };
	AI::WAYPOINT_RECORDING_GET_NUM_POINTS("OJASbs_102", &uLocal_1748);
	ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iParam0, 1, 1);
	fLocal_1753 = VEHICLE::_0x53AF99BAA671CA47(uParam1);
	VEHICLE::_SET_VEHICLE_ENGINE_POWER_MULTIPLIER(uParam1, (fLocal_1752 * 100f));
...
void func_243(var uParam0)
{
	if (!PED::IS_PED_INJURED(*uParam0))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if ((AI::GET_SCRIPT_TASK_STATUS(*uParam0, 1805844857) != 1 && AI::GET_SCRIPT_TASK_STATUS(*uParam0, -1824940423) != 1) && AI::GET_SCRIPT_TASK_STATUS(*uParam0, 242628503) != 1)
			{
				AI::TASK_SMART_FLEE_PED(*uParam0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			}
			PED::SET_PED_MAX_MOVE_BLEND_RATIO(*uParam0, 2f);
		}
		else if (((AI::GET_SCRIPT_TASK_STATUS(*uParam0, 1805844857) != 1 && AI::GET_SCRIPT_TASK_STATUS(*uParam0, 1805844857) != 0) && AI::GET_SCRIPT_TASK_STATUS(*uParam0, 242628503) != 1) && AI::GET_SCRIPT_TASK_STATUS(*uParam0, 242628503) != 0)
		{
			AI::TASK_SMART_FLEE_PED(*uParam0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
		}
	}
...
int func_254(char* sParam0)
{
	if (!func_255(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_274(sParam0)) || func_274("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_255(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_262() || func_261(Global_4456448.f_232883)) || func_260())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_258(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		if (AI::GET_SCRIPT_TASK_STATUS(iParam0, 242628503) != 1 && AI::GET_SCRIPT_TASK_STATUS(iParam0, 242628503) != 0)
		{
			if (func_231(iParam0, Local_1758, 1) <= 50f)
			{
				...
				AI::TASK_GO_TO_COORD_ANY_MEANS(0, Local_1758, 2f, 0, 0, 786603, -1082130432);
	...
	if (func_165(&uLocal_1834) > 1f)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iParam1))
			{
				...
				uVar1 = AI::GET_VEHICLE_WAYPOINT_PROGRESS(iParam1);
				...
				if (fLocal_1754 != 0f)
				{
					AI::SET_DRIVE_TASK_CRUISE_SPEED(iParam0, fLocal_1754);
				}
			}
		}
	}
...
void func_279()
{
	if (!iLocal_1710)
	{
		...
		{
			AI::CLEAR_PED_TASKS(iLocal_1846);
			AI::TASK_PLAY_ANIM(iLocal_1846, "oddjobs@assassinate@bus@", "looking_for_help", 8f, -8f, -1, 1, 0, 0, 0, 0);
	...
	else if (ENTITY::DOES_ENTITY_EXIST(iLocal_1846))
	{
		...
		{
			if (AI::GET_SCRIPT_TASK_STATUS(iLocal_1846, 1805844857) != 1)
			{
				AI::CLEAR_PED_TASKS(iLocal_1846);
				AI::TASK_SMART_FLEE_PED(iLocal_1846, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
			}
		}
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= 2)
		{
			if (!PED::IS_PED_INJURED(Local_2246[iParam1].f_14[iVar0]))
			{
				...
				AI::CLEAR_PED_TASKS(Local_2246[iParam1].f_14[iVar0]);
				AI::OPEN_SEQUENCE_TASK(&uVar1);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iParam0, 0);
				AI::TASK_PLAY_ANIM(0, "misscommon@response", sVar2, 8f, -8f, -1, 0, 0, 0, 0, 0);
				AI::TASK_WANDER_STANDARD(0, 1193033728, 0);
				AI::CLOSE_SEQUENCE_TASK(uVar1);
				AI::TASK_PERFORM_SEQUENCE(Local_2246[iParam1].f_14[iVar0], uVar1);
...
void func_307(var uParam0, var uParam1)
{
	...
	{
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_2246[iVar0].f_1, 15f, 0, 0, 0, 0, 0, 0);
	}
	if (iLocal_1705)
	{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1, 0))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uParam0->f_1))
		{
			if (Local_2246[iVar0])
			{
				...
				if ((((GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Var3, Local_2246[iVar0].f_21, 1) <= fVar1 && PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) && STREAMING::_0x7D41E9D2D17C5B2D(uLocal_1845)) && !func_334(iVar0)) && !bLocal_1701)
				{
					iLocal_1705 = 0;
				}
				if (iLocal_1747 > 0)
	...
	switch (iLocal_1725)
	{
		case 0:
			if (Local_2246[iParam2])
			{
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Var0, 0f, 0f, 0f, 1) > 0.23f)
				{
					bLocal_1702 = true;
				...
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(Local_2246[iParam2].f_1, 30f, 0);
				GAMEPLAY::CLEAR_AREA_OF_PEDS(Local_2246[iParam2].f_1, 30f, 0);
				...
				else
				{
					...
					AI::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), Var7, 5000, 0, 2);
				}
			...
			if (func_168(&uLocal_1816))
			{
				if (func_165(&uLocal_1816) > fLocal_1755)
				{
					...
					if (iParam2 == 0)
					{
						...
						{
							AI::TASK_ENTER_VEHICLE(iVar3, uParam0->f_1, 20000, 0, 2f, 258, 0);
		...
		case 2:
			...
			if ((func_165(&uLocal_1816) > 1.5f && !bLocal_1702) || (bLocal_1702 && !func_221()))
			{
				...
				func_183(&uLocal_1816);
				UI::REMOVE_BLIP(&(Local_2246[iParam2].f_9));
	...
	if (iLocal_1725 == 1)
	{
		if (func_310(iLocal_144))
		{
			...
			if (iParam2 == iLocal_1727)
			{
				...
				GAMEPLAY::CLEAR_AREA(Local_2246[iLocal_1727].f_5, 30f, 0, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(Local_2246[iLocal_1727].f_5, 30f, 0);
...
{
	if (func_311() && GAMEPLAY::GET_GAME_TIMER() >= iParam0 + 1000)
	{
...
void func_314(var uParam0, var uParam1, int iParam2)
{
	...
	{
		AI::TASK_PLAY_ANIM(*uParam1, "oddjobs@assassinate@bus@", "base", 8f, -16f, -1, 1, 0, 0, 0, 0);
	}
}
...
void func_316(var uParam0, int iParam1)
{
	...
	GAMEPLAY::CLEAR_AREA(Local_2246[iParam1].f_1, 10f, 0, 0, 0, 0);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_2246[iParam1].f_14[0]))
	{
		...
		AI::TASK_LOOK_AT_ENTITY(Local_2246[iParam1].f_14[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
		AI::TASK_PLAY_ANIM(Local_2246[iParam1].f_14[0], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0, 0, 0);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_2246[iParam1].f_14[0], 1);
		AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_2246[iParam1].f_14[0], "PASSENGERS_Group", 0);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_2246[iParam1].f_14[1]))
	{
		...
		AI::TASK_LOOK_AT_ENTITY(Local_2246[iParam1].f_14[1], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
		AI::TASK_PLAY_ANIM(Local_2246[iParam1].f_14[1], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0, 0, 0);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_2246[iParam1].f_14[1], 1);
		AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_2246[iParam1].f_14[1], "PASSENGERS_Group", 0);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_2246[iParam1].f_14[2]))
	{
		...
		AI::TASK_LOOK_AT_ENTITY(Local_2246[iParam1].f_14[2], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
		AI::TASK_PLAY_ANIM(Local_2246[iParam1].f_14[2], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0, 0, 0);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_2246[iParam1].f_14[2], 1);
		AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_2246[iParam1].f_14[2], "PASSENGERS_Group", 0);
	}
	if (iParam1 == 3)
	{
...
void func_323(var uParam0)
{
	...
	{
		uLocal_1806 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, CAM::_GET_GAMEPLAY_CAM_COORDS(), CAM::_GET_GAMEPLAY_CAM_ROT(2), 35f, 0, 2);
	}
	if (!CAM::DOES_CAM_EXIST(uLocal_1807))
	{
		uLocal_1807 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, CAM::_GET_GAMEPLAY_CAM_COORDS(), CAM::_GET_GAMEPLAY_CAM_ROT(2), 34f, 0, 2);
	}
...
void func_324(var uParam0, int iParam1)
{
	...
	if (bLocal_1712)
	{
		...
		GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Var0, &fVar8, 0, 0);
	}
	else if (bLocal_1713)
	{
		Var0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Var4, fVar7, 2.519f, 5.6f, 0.1098f) };
	...
	if (!PED::IS_PED_INJURED(iVar3))
	{
		AI::CLEAR_PED_TASKS_IMMEDIATELY(iVar3);
...
void func_327(var uParam0, int iParam1, bool bParam2)
{
	...
	GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Local_1764, &uVar0, 0, 0);
	...
	if (bParam2)
	{
		AI::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_1761, 5000, 0, 2);
	}
}
...
void func_337()
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			if (!UI::DOES_BLIP_EXIST(Local_2246[iVar0].f_9))
			{
				...
				UI::SET_BLIP_NAME_FROM_TEXT_FILE(Local_2246[iVar0].f_9, &(Local_2246[iVar0].f_10));
			}
		}
		iVar0++;
	}
...
var func_338(struct<3> Param0, int iParam3)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_61(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_345(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_61(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, iParam1);
	}
	else if (ENTITY::IS_ENTITY_AN_OBJECT(iParam0))
	{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0))
				{
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(uParam0->f_1, iVar0, 0) != 0)
					{
						...
						if (bParam1)
						{
							if ((iVar0 % 2) == 0)
							{
								AI::TASK_PLAY_ANIM(iVar1, "veh@bus@passenger@rps@idle_panic", "sit", 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0, 0, 0);
							}
							else
							{
								AI::TASK_PLAY_ANIM(iVar1, "veh@bus@passenger@rds@idle_panic", "sit", 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0, 0, 0);
							}
						}
					}
				}
...
void func_351(var uParam0)
{
	if (!iLocal_1723)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_8) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_8, 0))
		{
			...
			{
				VEHICLE::_SET_VEHICLE_ENGINE_POWER_MULTIPLIER(uParam0->f_8, 0f);
				iLocal_1723 = 1;
			}
		}
	}
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
				{
					if ((iVar0 != iLocal_1805 && ENTITY::GET_ENTITY_MODEL(iVar0) != -713569950) && ENTITY::GET_ENTITY_MODEL(iVar0) != -2072933068)
					{
						...
						VEHICLE::_0x02398B627547189C(iLocal_1805, 0);
					}
				}
			}
		}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_1796[3]))
	{
		...
		if ((STREAMING::HAS_MODEL_LOADED(uParam0->f_16) && STREAMING::HAS_MODEL_LOADED(uParam0->f_14)) && STREAMING::HAS_MODEL_LOADED(-106498753))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_1796[0]))
			{
				...
				{
					AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(uLocal_1796[0], 435.0773f, -650.2194f, 27.74271f, 2f, -1);
				}
				else
				{
					AI::TASK_WANDER_STANDARD(uLocal_1796[0], 1193033728, 0);
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_1796[1]))
			{
				...
				{
					AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(uLocal_1796[1], 436.3171f, -642.8832f, 27.73943f, 2f, -1);
				}
				else
				{
					AI::TASK_WANDER_STANDARD(uLocal_1796[1], 1193033728, 0);
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_1796[2]))
			{
				...
				{
					AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(uLocal_1796[2], 435.6569f, -645.5588f, 27.73775f, 2f, -1);
				}
				else
				{
					AI::TASK_WANDER_STANDARD(uLocal_1796[2], 1193033728, 0);
				}
			}
			...
			{
				AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(uLocal_1796[3], 436.6802f, -629.7325f, 27.71444f, 2f, -1);
			}
			else
			{
				AI::TASK_WANDER_STANDARD(uLocal_1796[3], 1193033728, 0);
			}
			return 1;
		}
	}
...
int func_407(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_177(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Param0, func_408(iVar0, 0), 1);
...
int func_435(var uParam0, var uParam1, bool bParam2)
{
	...
	if ((!UI::HAS_ADDITIONAL_TEXT_LOADED(3) && !func_441(&(uParam0->f_34))) && !func_436(uParam1))
	{
		func_488(uParam1);
		return 0;
	}
...
void func_448(var uParam0, var uParam1)
{
	...
	PED::SET_PED_INTO_VEHICLE(*uParam1, uParam1->f_8, -1);
	iLocal_1706 = 0;
	AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(*uParam1, uParam1->f_8, "OJASbs_102", 52, 0, 20, -1, -1082130432, 0, 1073741824);
	Local_1758 = { -455.2892f, -326.1364f, 41.22218f };
	AI::WAYPOINT_RECORDING_GET_NUM_POINTS("OJASbs_102", &iLocal_1748);
	ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(*uParam1, 1, 1);
	fLocal_1753 = VEHICLE::_0x53AF99BAA671CA47(uParam1->f_8);
	VEHICLE::_SET_VEHICLE_ENGINE_POWER_MULTIPLIER(uParam1->f_8, (fLocal_1752 * 100f));
...
{
	GAMEPLAY::CLEAR_AREA(Local_1776, 50f, 1, 0, 0, 0);
...
{
	uParam0->f_1 = (func_166(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
void func_457(var uParam0, var uParam1)
{
	...
	if (uParam0->f_14 != 0 && uParam0->f_274 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam1->f_7))
		{
			...
			if (uParam0->f_274 == 1)
			{
				AI::TASK_PLAY_ANIM(uParam1->f_7, "ODDJOBS@ASSASSINATE@VICE@HOOKER", "idle_b", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
...
void func_461(var uParam0, var uParam1, bool bParam2)
{
	...
	while ((!UI::HAS_ADDITIONAL_TEXT_LOADED(3) || !func_441(&(uParam0->f_34))) || !func_436(uParam1))
	{
		func_488(uParam1);
		SYSTEM::WAIT(0);
	}
		...
		case 0:
			...
			if (bLocal_1680)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_1646))
				{
					...
					GAMEPLAY::CLEAR_AREA(-26.48f, -110.66f, 56.0227f, 3f, 1, 0, 0, 0);
					...
					func_286(1, 1, 1, 0, 0, 0);
					GAMEPLAY::CLEAR_AREA_OF_PEDS(Local_1653, 5f, 0);
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
					{
					...
					AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_1687, "oddjobs@assassinate@bus@call", "ass_bus_call_p1", 1000f, -2f, 2, 0, 1148846080, 0);
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_157(Param1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_503(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_159(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_159(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_159(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == 340154634 || uParam1->f_66 == -1960756985)
		{
			...
			while (iVar2 <= 9)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_159(iVar2)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_159(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_159(iVar3)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_159(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_159(iVar4)))
					{
					}
					else
					{
						GAMEPLAY::SET_BIT(&(uParam1->f_77), func_159(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_159(iVar5 + 1)))
				{
