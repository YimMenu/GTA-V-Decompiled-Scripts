...
int func_289(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2592627[iParam0 /*3*/][func_69(iParam1)];
...
{
	if (((!func_333(0) || Global_77517) || Global_77506 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77502)
...
void func_402(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96701[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96701[iVar0]) == func_403(iParam0, iParam1))
				{
