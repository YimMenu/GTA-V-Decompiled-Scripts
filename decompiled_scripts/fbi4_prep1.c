...
int func_149(int iParam0, struct<3> Param1, float fParam4)
{
	switch (iParam0)
	{
		...
		case 4:
			...
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_95867.f_9[1], true))
				{
...
void func_162(int* iParam0)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_37(iVar0))
		{
			if (!VEHICLE::_IS_VEHICLE_SEAT_ACCESSIBLE(*iParam0, iVar0, -1, false, false))
			{
				iParam0->f_6 = 18;
				iParam0->f_1 = MISC::GET_GAME_TIMER();
			}
...
int func_252(int iParam0)
{
	if (iParam0 != func_88())
	{
		...
		else if ((Global_1312902 && iParam0 == PLAYER::PLAYER_ID()) && func_253(iParam0, 1, 0))
		{
			return Global_2426865[iParam0 /*449*/].f_319.f_6 != -1;
		}
	}
...
int func_348(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12074)
	{
		...
		iVar0 = Global_2555716[iParam0 /*3*/][func_347(iParam1)];
