...
int func_2(var uParam0)
{
	...
	MemCopy(&sVar1, {func_109(*uParam0)}, 4);
...
int func_184(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_175(2))
	{
		if (!func_146())
		{
			if (((func_127(PLAYER::PLAYER_PED_ID()) && func_127(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_190(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
...
void func_191(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam2))
		{
			...
			else
			{
				...
				{
					fVar0 = func_190(PLAYER::PLAYER_PED_ID(), Param4, 1);
					fVar1 = func_190(PLAYER::PLAYER_PED_ID(), Param5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
...
void func_239(var uParam0, var uParam1, struct<3> Param2, float fParam3)
{
	func_240(uParam0);
