		...
		case 0:
			...
			if (bLocal_170)
			{
				...
				if (func_298(PLAYER::PLAYER_PED_ID(), iLocal_349) > 32f)
				{
					...
					AI::OPEN_SEQUENCE_TASK(&uLocal_182);
					AI::TASK_FOLLOW_WAYPOINT_RECORDING(0, sLocal_655, func_295(), 1040, -1);
				...
				AI::OPEN_SEQUENCE_TASK(&uLocal_182);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_669, 1f, 20000, 0.5f, 0, 1193033728);
				AI::CLOSE_SEQUENCE_TASK(uLocal_182);
			...
			while (iVar5 <= 3)
			{
				...
				{
					if ((PED::IS_PED_IN_MELEE_COMBAT(Local_576[iVar5]) || PED::IS_PED_RESPONDING_TO_EVENT(Local_576[iVar5], 55)) || PED::IS_PED_RESPONDING_TO_EVENT(Local_576[iVar5], 42))
					{
						AI::CLEAR_PED_TASKS(Local_576[iVar5]);
						AI::OPEN_SEQUENCE_TASK(&uLocal_182);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
						AI::TASK_PAUSE(0, 2000);
						AI::TASK_WANDER_STANDARD(0, 1193033728, 0);
						AI::CLOSE_SEQUENCE_TASK(uLocal_182);
						AI::TASK_PERFORM_SEQUENCE(Local_576[iVar5], uLocal_182);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_182);
					...
					if (bLocal_170)
					{
						switch (iLocal_456)
						{
							...
							case 1:
								...
								{
									AI::OPEN_SEQUENCE_TASK(&uLocal_182);
									AI::TASK_LOOK_AT_ENTITY(0, iLocal_449, -1, 0, 2);
									AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -2003.36f, -503.77f, 10.48f, 2f, 20000, 1f, 10241, 1193033728);
									AI::TASK_ENTER_VEHICLE(0, iLocal_449, 20000, -1, 1f, 1, 0);
									AI::TASK_CLEAR_LOOK_AT(0);
									AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 2000, 0, 2);
									AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_449, -2014.96f, -455.47f, 10.48f, 10f, 0, iLocal_454, 8, 3f, 50f);
									AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_449, 10f, 786599);
									AI::CLOSE_SEQUENCE_TASK(uLocal_182);
									AI::TASK_PERFORM_SEQUENCE(iLocal_349, uLocal_182);
									AI::CLEAR_SEQUENCE_TASK(&uLocal_182);
						...
						if (AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE() > 2)
						{
							if (!bLocal_171)
							{
								if (func_7(iLocal_449))
								{
									...
									AI::TASK_ENTER_VEHICLE(0, iLocal_449, 20000, -1, 2f, 1, 0);
									AI::TASK_CLEAR_LOOK_AT(0);
									AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 2000, 0, 2);
									AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_449, -2018.17f, -461f, 10.56f, 10f, 0, iLocal_454, 8, 3f, 50f);
									AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_449, -2014.96f, -455.47f, 10.48f, 10f, 0, iLocal_454, 8, 3f, 50f);
									AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_449, 10f, 786599);
									AI::CLOSE_SEQUENCE_TASK(uLocal_182);
									AI::TASK_PERFORM_SEQUENCE(iLocal_349, uLocal_182);
								...
								if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_349, 1))
								{
									if (iLocal_455 <= 2)
									{
										if (func_7(iLocal_449))
										{
											...
											AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 2000, 0, 2);
											AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_449, -2018.17f, -461f, 10.56f, 10f, 0, iLocal_454, 8, 3f, 50f);
											AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_449, -2024.98f, -479.55f, 10.57f, 10f, 0, iLocal_454, 8, 3f, 50f);
											AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_449, 10f, 786599);
											AI::CLOSE_SEQUENCE_TASK(uLocal_182);
											AI::TASK_PERFORM_SEQUENCE(iLocal_349, uLocal_182);
											AI::CLEAR_SEQUENCE_TASK(&uLocal_182);
...
bool func_47(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_48(&(Local_40[iVar4]), Var1, iParam1, &(Local_40[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (GAMEPLAY::GET_GAME_TIMER() - Local_40[iVar4].f_3) < iParam4);
}
...
{
	Var0 = { func_53(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
void func_57()
{
	...
	{
		if ((func_62(iLocal_349, 1, 0, 0, 0) || func_58(iLocal_349, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_349, 1), 10f, 0))
		{
			if (func_40())
			{
...
{
	Var0 = { func_53(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
...
int func_98(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_141(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_141(iParam1), Global_76434[1].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_141(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, 0);
		}
	}
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_141(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_141(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_141(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_132(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_141(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_141(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_141(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
void func_117(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_118(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_119(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_141(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_124(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_141(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_119(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_119(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_119(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_119(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_136(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0][func_135(iParam1)];
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_124(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_147(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_147(Var16.z)] = func_124(iParam1, Var16.x, func_147(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_147(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
...
void func_158(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_152(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_152(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_141(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_213(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_141(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_141(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_226()
{
	...
	{
		func_30();
		GRAPHICS::_0xBF59707B3E5ED531(func_227(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
...
void func_280()
{
	if (func_440(iLocal_349))
	{
		...
		{
			Var3 = { func_53(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - ENTITY::GET_ENTITY_COORDS(iLocal_349, 1)) };
...
void func_293()
{
	...
	while (iVar0 <= 1)
	{
		if (func_313(Local_576[iVar0]) && PED::IS_PED_RAGDOLL(Local_576[iVar0]))
		{
			AI::CLEAR_PED_TASKS(Local_576[iVar0]);
			AI::OPEN_SEQUENCE_TASK(&uLocal_182);
			if (func_44(Local_576[iVar0], PLAYER::PLAYER_PED_ID(), 1) < func_44(Local_576[iVar0], iLocal_349, 1))
			{
				AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
			}
			...
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[iVar0].f_8, 0.7f, 20000, 1f, 1, 1193033728);
			AI::CLOSE_SEQUENCE_TASK(uLocal_182);
			AI::TASK_PERFORM_SEQUENCE(Local_576[iVar0], uLocal_182);
			AI::CLEAR_SEQUENCE_TASK(&uLocal_182);
		}
		if (func_440(Local_576[iVar0]))
		{
			...
			{
				AI::CLEAR_PED_TASKS(Local_576[iVar0]);
				AI::TASK_SMART_FLEE_PED(Local_576[iVar0], PLAYER::PLAYER_PED_ID(), 200f, -1, 1, 0);
	...
	if (iLocal_626 == 0)
	{
		if (iLocal_658 > 114)
		{
			if (func_313(Local_576[2]) && func_313(Local_576[3]))
			{
				...
				{
					AI::OPEN_SEQUENCE_TASK(&uLocal_182);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[iVar1].f_5, 0.7f, 20000, 1f, 1, 1193033728);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[iVar1].f_8, 0.7f, 20000, 1f, 1, 1193033728);
					AI::CLOSE_SEQUENCE_TASK(uLocal_182);
					AI::TASK_PERFORM_SEQUENCE(Local_576[iVar1], uLocal_182);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_182);
					iVar1++;
				}
				AI::TASK_LOOK_AT_ENTITY(Local_576[2], Local_576[3], -1, 0, 2);
				AI::TASK_LOOK_AT_ENTITY(Local_576[3], Local_576[2], -1, 0, 2);
			}
			if (func_313(iLocal_649))
			{
				AI::CLEAR_PED_TASKS(iLocal_649);
	...
	else
	{
		...
		while (iVar2 <= 3)
		{
			if (func_313(Local_576[iVar2]) && PED::IS_PED_RAGDOLL(Local_576[iVar2]))
			{
				AI::CLEAR_PED_TASKS(Local_576[iVar2]);
				AI::OPEN_SEQUENCE_TASK(&uLocal_182);
				if (func_44(Local_576[iVar2], PLAYER::PLAYER_PED_ID(), 1) < func_44(Local_576[iVar2], iLocal_349, 1))
				{
					AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
				}
				...
				AI::TASK_PAUSE(0, 3000);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[iVar2].f_8, 0.7f, 20000, 1f, 1, 1193033728);
				AI::CLOSE_SEQUENCE_TASK(uLocal_182);
				AI::TASK_PERFORM_SEQUENCE(Local_576[iVar2], uLocal_182);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_182);
			}
			if (func_440(Local_576[iVar2]))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_576[iVar2]))
				{
					AI::CLEAR_PED_TASKS(Local_576[iVar2]);
					AI::TASK_SMART_FLEE_PED(Local_576[iVar2], PLAYER::PLAYER_PED_ID(), 200f, -1, 1, 0);
...
var func_295()
{
	AI::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_655, func_296(), &uVar0);
	return uVar0;
}
...
Vector3 func_296()
{
	...
	{
		AI::WAYPOINT_RECORDING_GET_COORD(sLocal_655, iLocal_659 + 1, &Var0);
	}
	else
	{
		AI::WAYPOINT_RECORDING_GET_COORD(sLocal_655, (iLocal_657 - 1), &Var0);
	}
	return Var0;
}
...
void func_297()
{
	if (AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_655))
	{
		...
		{
			AI::WAYPOINT_RECORDING_GET_COORD(sLocal_655, iLocal_658, &Local_660);
		}
	}
}
...
void func_300(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_302(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_309(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_310(Var18[0], Var18[1], Var6, Var9) || func_310(Var18[0], Var18[1], Var9, Var15)) || func_310(Var18[0], Var18[1], Var12, Var15)) || func_310(Var18[0], Var18[1], Var6, Var12)) || func_310(Var18[1], Var18[3], Var6, Var9)) || func_310(Var18[1], Var18[3], Var9, Var15)) || func_310(Var18[1], Var18[3], Var12, Var15)) || func_310(Var18[1], Var18[3], Var6, Var12)) || func_310(Var18[3], Var18[2], Var6, Var9)) || func_310(Var18[3], Var18[2], Var9, Var15)) || func_310(Var18[3], Var18[2], Var12, Var15)) || func_310(Var18[3], Var18[2], Var6, Var12)) || func_310(Var18[2], Var18[0], Var6, Var9)) || func_310(Var18[2], Var18[0], Var9, Var15)) || func_310(Var18[2], Var18[0], Var12, Var15)) || func_310(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
void func_314()
{
	switch (iLocal_157)
	{
		case 0:
			...
			if (UI::DOES_BLIP_EXIST(iLocal_672))
			{
				UI::SET_BLIP_ALPHA(iLocal_672, 0);
			}
			UI::CLEAR_PRINTS();
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				if (!GAMEPLAY::IS_STRING_NULL(sLocal_655))
				{
					if (AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_655))
					{
						AI::OPEN_SEQUENCE_TASK(&uLocal_182);
						AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_296(), 3f, 20000, 1048576000, 0, 1193033728);
						AI::TASK_FOLLOW_WAYPOINT_RECORDING(0, sLocal_655, func_295(), 1040, -1);
						AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						AI::TASK_PLAY_ANIM(0, "move_f@runner", "idle", 4f, -4f, -1, 1, 0, 0, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(uLocal_182);
				...
				if (UI::DOES_BLIP_EXIST(iLocal_672))
				{
					UI::SET_BLIP_ALPHA(iLocal_672, 255);
				}
				AUDIO::RESTART_SCRIPTED_CONVERSATION();
			}
			break;
...
void func_315()
{
	...
	{
		case 0:
			if (!UI::DOES_BLIP_EXIST(iLocal_350))
			{
				iLocal_350 = func_317(iLocal_349, 1, 1, 5);
				UI::SET_BLIP_AS_FRIENDLY(iLocal_350, 1);
			}
			iLocal_157 = 1;
			break;
...
void func_318()
{
	switch (iLocal_157)
	{
		...
		case 1:
			...
			if (Local_429.z == 0 && iLocal_659 < 105)
			{
...
void func_321()
{
		...
		case 1:
			if (iLocal_709 >= 7)
			{
				if (func_7(iLocal_631))
				{
					...
					{
						AI::OPEN_SEQUENCE_TASK(&uLocal_182);
						AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(0, iLocal_631, "Fanatic1Quad", 16, 14, 0, -1, -1082130432, 0, 1073741824);
						AI::TASK_LEAVE_VEHICLE(0, iLocal_631, 0);
	...
	if (func_313(iLocal_628))
	{
		DECISIONEVENT::ADD_SHOCKING_EVENT_FOR_ENTITY(84, iLocal_628, 1f);
	}
}
...
void func_323(bool bParam0)
{
	if (!func_7(iLocal_631))
	{
		...
		iLocal_628 = PED::CREATE_PED(4, 1077785853, -1870.54f, -628.1f, 10.09f, 80f, 1, 1);
		...
		Local_635 = { ENTITY::GET_ENTITY_COORDS(iLocal_628, 1) };
		GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(ENTITY::GET_ENTITY_COORDS(iLocal_628, 1), &(Local_635.f_2), 0, 0);
		...
		iLocal_629 = PED::CREATE_PED(5, -945854168, -1869.76f, -627.7f, 10.1f, 0f, 1, 1);
		...
		AI::TASK_PERFORM_SEQUENCE(iLocal_629, uLocal_182);
		AI::CLEAR_SEQUENCE_TASK(&uLocal_182);
		iLocal_630 = PED::CREATE_PED(5, -945854168, -1873.61f, -628.88f, 11.16f, 0f, 1, 1);
		...
		if (bParam0)
		{
			iLocal_631 = VEHICLE::CREATE_VEHICLE(-48031959, Local_632, 36.64f, 1, 1, 0);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_631, 1084227584);
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_631, 1, 1);
			iLocal_627 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_631, 20, 189425762, -1, 1, 1);
			iLocal_723 = 1;
		}
		else
		{
			iLocal_631 = VEHICLE::CREATE_VEHICLE(-48031959, -1871.55f, -640.01f, 10.65f, 297.76f, 1, 1, 0);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_631, 1084227584);
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_631, 1, 1);
			iLocal_627 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_631, 4, 189425762, -1, 1, 1);
			AI::OPEN_SEQUENCE_TASK(&uLocal_182);
			AI::TASK_LOOK_AT_ENTITY(0, iLocal_628, -1, 0, 2);
			AI::TASK_LEAVE_VEHICLE(0, iLocal_631, 0);
	...
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-48031959);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-945854168);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(189425762);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(1077785853);
}
...
int func_324()
{
	...
	STREAMING::REQUEST_MODEL(-48031959);
	STREAMING::REQUEST_MODEL(-945854168);
	STREAMING::REQUEST_MODEL(189425762);
	STREAMING::REQUEST_MODEL(1077785853);
	if (((((((((STREAMING::HAS_ANIM_DICT_LOADED("mini@cpr@char_a@cpr_def") && STREAMING::HAS_ANIM_DICT_LOADED("mini@cpr@char_b@cpr_def")) && STREAMING::HAS_ANIM_DICT_LOADED("mini@cpr@char_a@cpr_str")) && STREAMING::HAS_ANIM_DICT_LOADED("mini@cpr@char_b@cpr_str")) && STREAMING::HAS_ANIM_DICT_LOADED("rcmfanatic1")) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("Fanatic1Quad")) && STREAMING::HAS_MODEL_LOADED(-945854168)) && STREAMING::HAS_MODEL_LOADED(189425762)) && STREAMING::HAS_MODEL_LOADED(1077785853)) && STREAMING::HAS_MODEL_LOADED(-48031959))
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_654)
		{
			case 0:
				if (func_326())
				{
					...
					{
						iLocal_649 = PED::CREATE_PED(26, -1788665315, Local_650, fLocal_653, 1, 1);
						PED::SET_PED_CAN_RAGDOLL(iLocal_649, 1);
					}
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1788665315);
...
int func_326()
{
	STREAMING::REQUEST_MODEL(-1788665315);
	if (STREAMING::HAS_MODEL_LOADED(-1788665315))
	{
		return 1;
	}
	return 0;
...
void func_327()
{
	if (!func_440(Local_576[0]))
	{
		...
		STREAMING::REQUEST_MODEL(-771835772);
		STREAMING::REQUEST_MODEL(-945854168);
		if ((STREAMING::HAS_MODEL_LOADED(iLocal_625) && STREAMING::HAS_MODEL_LOADED(-771835772)) && STREAMING::HAS_MODEL_LOADED(-945854168))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(Local_576[0]))
			{
				...
				Local_576[0] = PED::CREATE_PED(5, Local_576[0].f_1, Local_576[0].f_2, Local_576[0].f_11, 1, 1);
				PED::SET_PED_COMBAT_MOVEMENT(Local_576[0], 3);
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_576[0], 17, 1);
				func_328(Local_576[0]);
				if (func_313(Local_576[0]))
				{
					AI::OPEN_SEQUENCE_TASK(&uLocal_182);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[0].f_5, 2f, 20000, 1048576000, 0, 1193033728);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[0].f_8, 2f, 20000, 1048576000, 0, 1193033728);
					AI::CLOSE_SEQUENCE_TASK(uLocal_182);
					AI::TASK_PERFORM_SEQUENCE(Local_576[0], uLocal_182);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_182);
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(Local_576[1]))
			{
				...
				Local_576[1] = PED::CREATE_PED(5, Local_576[1].f_1, Local_576[1].f_2, Local_576[1].f_11, 1, 1);
				PED::SET_PED_COMBAT_MOVEMENT(Local_576[1], 3);
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_576[1], 17, 1);
				if (func_313(Local_576[1]))
				{
					AI::OPEN_SEQUENCE_TASK(&uLocal_182);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[1].f_5, 2.05f, 20000, 1048576000, 0, 1193033728);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[1].f_8, 2.05f, 20000, 1048576000, 0, 1193033728);
					AI::CLOSE_SEQUENCE_TASK(uLocal_182);
					AI::TASK_PERFORM_SEQUENCE(Local_576[1], uLocal_182);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_182);
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(Local_576[2]))
			{
				...
				Local_576[2] = PED::CREATE_PED(5, Local_576[2].f_1, Local_576[2].f_2, Local_576[2].f_11, 1, 1);
				PED::SET_PED_COMBAT_MOVEMENT(Local_576[2], 3);
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_576[2], 17, 1);
				func_328(Local_576[2]);
			}
			else if (func_313(Local_576[2]))
			{
				AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_576[2]);
				ENTITY::SET_ENTITY_COORDS(Local_576[2], Local_576[2].f_2, 1, 0, 0, 1);
				ENTITY::SET_ENTITY_HEADING(Local_576[2], Local_576[2].f_11);
				func_328(Local_576[2]);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(Local_576[3]))
			{
				...
				Local_576[3] = PED::CREATE_PED(4, Local_576[3].f_1, Local_576[3].f_2, Local_576[3].f_11, 1, 1);
				PED::SET_PED_COMBAT_MOVEMENT(Local_576[3], 3);
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_576[3], 17, 1);
				func_328(Local_576[3]);
			}
			else if (func_313(Local_576[3]))
			{
				AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_576[3]);
				ENTITY::SET_ENTITY_COORDS(Local_576[3], Local_576[3].f_2, 1, 0, 0, 1);
				ENTITY::SET_ENTITY_HEADING(Local_576[3], Local_576[3].f_11);
				func_328(Local_576[3]);
			}
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-945854168);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-771835772);
...
void func_328(int iParam0)
{
	if (func_313(uParam0))
	{
		...
		ENTITY::SET_ENTITY_COORDS(iParam0, Var0.x, Var0.y, fVar3, 1, 0, 0, 1);
	}
}
...
int func_331()
{
	if ((iLocal_348 == 0 && !UI::IS_MESSAGE_BEING_DISPLAYED()) && !func_40())
	{
		return 1;
	}
	return 0;
...
void func_336()
{
	if ((!func_40() && iLocal_348 == 0) && !UI::IS_MESSAGE_BEING_DISPLAYED())
	{
		...
		case 1:
			...
			if (func_331())
			{
				if (Local_419.z == 0)
				{
					...
					if (iVar0 <= 52)
					{
						if ((Local_439.z == 0 && Local_434.z == 0) && iLocal_656 == 2)
						{
			...
			if (Local_419.z == 1 && Local_424.z == 1)
			{
				if (func_440(iLocal_349))
				{
...
int func_343()
{
	...
	STREAMING::REQUEST_MODEL(-1041692462);
	if (STREAMING::HAS_MODEL_LOADED(663522487) && STREAMING::HAS_MODEL_LOADED(-1041692462))
	{
		return 1;
	}
	return 0;
...
void func_345()
{
	switch (iLocal_157)
	{
		...
		case 1:
					...
					if (PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1799.071f, -468.6591f, 40.07401f, -1820.119f, -492.4139f, 41.74369f, 18.25f, 0, 1, 0))
						{
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1798.076f, -468.2297f, 39.02536f, -1816.664f, -484.317f, 43.64211f, 12.5f, 0, 1, 0))
							{
								...
								if (func_319(Local_439.x, Local_439.y, 0, &(Local_414.f_4)))
								{
									if (Local_414.f_4 != -1)
									{
										Local_414.f_3 = 1;
			...
			if (Local_434.z == 0)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1772.762f, -532.9971f, 35.58929f, -1797.246f, -492.1292f, 39.2704f, 26f, 0, 1, 0) || func_346(PLAYER::PLAYER_PED_ID(), -1812.91f, -468.5253f, 41.32029f, 1) < 10f)
				{
					if (func_40())
					{
						func_15();
					}
					if (func_319(Local_434.x, Local_434.y, 0, &(Local_414.f_4)))
					{
						if (Local_414.f_4 != -1)
						{
							Local_414.f_3 = 1;
			...
			if (iLocal_166 == 1)
			{
				if (Local_444.z == 0)
				{
					...
					{
						if (func_319(Local_444.x, Local_444.y, 0, &uVar0))
						{
							Local_444.z = 1;
							iLocal_166 = 0;
							iLocal_395 = GAMEPLAY::GET_GAME_TIMER();
	...
	switch (iLocal_157)
	{
		case 0:
			...
			if (CUTSCENE::_0xB56BBBCC2955D9CB())
			{
				...
				CUTSCENE::_0x2A56C06EBEF2B0D9("Mary_Ann", iLocal_349, 161007533);
			}
			iLocal_460 = 0;
			iLocal_164 = 0;
			if (iLocal_644 == -1)
			...
			if (func_354(1, 1093140480, 0))
			{
				if (func_440(iLocal_349))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_349, "Mary_Ann", 0, -1552967674, 0);
...
void func_350()
{
	if (func_440(iLocal_349))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Mary_Ann", -1552967674))
		{
...
int func_354(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_357(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
	...
	if (func_313(iLocal_349))
	{
		if (!GAMEPLAY::IS_STRING_NULL(sLocal_655))
		{
			if (AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_655))
			{
				AI::OPEN_SEQUENCE_TASK(&uLocal_182);
				AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
				AI::TASK_FOLLOW_WAYPOINT_RECORDING(0, sLocal_655, func_295(), 1052, -1);
				AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				AI::TASK_PLAY_ANIM(0, "move_f@runner", "idle", 4f, -4f, -1, 1, 0, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(uLocal_182);
				AI::TASK_PERFORM_SEQUENCE(iLocal_349, uLocal_182);
...
{
	AI::WAYPOINT_RECORDING_GET_COORD(sLocal_655, iParam0, &Var0);
	AI::WAYPOINT_RECORDING_GET_COORD(sLocal_655, iParam0 + 1, &Var4);
...
void func_376()
{
	if (iLocal_348 == 2)
	{
		if (iLocal_367 < 2)
		{
			if ((Local_434.z || Local_439.z) && iLocal_158 == 2)
			{
				iLocal_348 = 1;
	...
	if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_349))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !ENTITY::IS_ENTITY_DEAD(iVar0, 0))
		{
			if (!PED::IS_PED_RAGDOLL(iVar0) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(iLocal_349, iVar0))
			{
				...
				Var1 = { -ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_349, ENTITY::GET_ENTITY_COORDS(iVar0, 1)) };
		...
		if (iLocal_158 < 8 && iLocal_158 > 1)
		{
			...
			if (iLocal_658 > iLocal_659)
			{
				if (iLocal_656 != 1)
				{
					...
					{
						func_347("Can't do overtake line, overtake timer is = ", (GAMEPLAY::GET_GAME_TIMER() - iLocal_390));
					}
				}
			}
			else if (iLocal_658 < iLocal_659)
			...
			else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_349, 1), Local_678[func_393()], 1) < GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_678[func_393()], 1))
			{
				if (iLocal_656 != 2)
				{
					iLocal_656 = 2;
			...
			func_392();
			func_381((GAMEPLAY::GET_GAME_TIMER() - iLocal_711), "", -1, -1, "", iLocal_656, 2, "", 0, 1, -1, -1, 0, 12, -1, -1, 0, 6, -1, 0, 0, 1, -1, 0, -1082130432, 1, 1);
		}
	}
}
...
void func_395()
{
	if (iLocal_709 < iLocal_677)
	{
		...
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_678[iLocal_709], 4f, 4f, 3f, 0, 1, 0) || !UI::DOES_BLIP_EXIST(iLocal_672))
			{
				func_12(&iLocal_672);
				func_12(&iLocal_673);
				if (iLocal_674 != 0)
				{
					...
					iLocal_675 = GRAPHICS::CREATE_CHECKPOINT(func_397(iLocal_709), Local_678[iLocal_709] + Vector(2f, 0f, 0f), Local_678[iLocal_709 + 1], 3.2f, uVar5, uVar6, uVar7, iLocal_676, 0);
				...
				if (iLocal_709 < (iLocal_677 - 1))
				{
					iLocal_674 = GRAPHICS::CREATE_CHECKPOINT(func_397(iLocal_709), Local_678[iLocal_709] + Vector(2f, 0f, 0f), Local_678[iLocal_709 + 1], 3.2f, uVar1, uVar2, uVar3, iVar4, 0);
					...
					iLocal_672 = UI::ADD_BLIP_FOR_COORD(Local_678[iLocal_709]);
					UI::_0x75A16C3DA34F1245(iLocal_672, 0);
					UI::SET_BLIP_SCALE(iLocal_672, 1.2f);
					iLocal_673 = UI::ADD_BLIP_FOR_COORD(Local_678[iLocal_709 + 1]);
					if (iLocal_709 + 1 == (iLocal_677 - 1))
					{
						UI::SET_BLIP_SCALE(iLocal_673, 1.2f);
						UI::SET_BLIP_SPRITE(iLocal_673, 38);
						UI::_0x75A16C3DA34F1245(iLocal_673, 0);
					}
					else
					{
						UI::SET_BLIP_SCALE(iLocal_673, 0.7f);
						UI::_0x75A16C3DA34F1245(iLocal_673, 0);
					}
				}
				else if (iLocal_709 == (iLocal_677 - 1))
				{
					...
					UI::GET_HUD_COLOUR(iVar0, &uVar1, &uVar2, &uVar3, &iVar4);
					iLocal_674 = GRAPHICS::CREATE_CHECKPOINT(func_397(iLocal_709), Local_678[iLocal_709] + Vector(2f, 0f, 0f), Local_678[iLocal_709], 3.2f, uVar1, uVar2, uVar3, iVar4, 0);
					GRAPHICS::SET_CHECKPOINT_CYLINDER_HEIGHT(iLocal_674, 1.6f, 1.6f, 100f);
					iLocal_672 = UI::ADD_BLIP_FOR_COORD(Local_678[iLocal_709]);
					UI::SET_BLIP_SCALE(iLocal_672, 1.2f);
					UI::SET_BLIP_SPRITE(iLocal_672, 38);
					UI::_0x75A16C3DA34F1245(iLocal_672, 0);
				}
			}
		}
			...
			if (func_346(PLAYER::PLAYER_PED_ID(), Local_669, 1) < 4f)
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (iLocal_674 != 0)
					{
						...
						iVar0 = 1;
						UI::GET_HUD_COLOUR(iVar0, &uVar5, &uVar6, &uVar7, &iLocal_676);
						iLocal_675 = GRAPHICS::CREATE_CHECKPOINT(10, Local_678[iLocal_709] + Vector(2f, 0f, 0f), Local_678[iLocal_709], 3.2f, uVar5, uVar6, uVar7, iLocal_676, 0);
						GRAPHICS::SET_CHECKPOINT_RGBA(iLocal_675, uVar5, uVar6, uVar7, iLocal_676);
						GRAPHICS::_SET_CHECKPOINT_ICON_RGBA(iLocal_675, uVar5, uVar6, uVar7, iLocal_676);
					}
					AUDIO::PLAY_SOUND_FRONTEND(-1, "CHECKPOINT_NORMAL", "HUD_MINI_GAME_SOUNDSET", 0);
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		fVar8 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_678[iLocal_709], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
		if (iLocal_674 != 0)
		{
			if (fVar8 > 100f)
			{
	...
	{
		if (ENTITY::IS_ENTITY_AT_COORD(iLocal_349, Local_678[iLocal_710], 3f, 3f, 3f, 0, 1, 0))
		{
			iLocal_710++;
		}
	}
...
int func_397(int iParam0)
{
	...
	else if (iParam0 == 0)
	{
		...
		Var3 = { Local_678[iParam0 + 1] };
	}
	else
	{
		Var6 = { Local_678[(iParam0 - 1)] };
		Var3 = { Local_678[iParam0 + 1] };
	}
	Var9 = { Var6 - Var0 };
	Var12 = { Var3 - Var0 };
...
void func_400()
{
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_660, 1) > 60f || func_404(60f))
	{
		AUDIO::TRIGGER_MUSIC_EVENT("RC6A_FAIL");
		iLocal_160 = 6;
		iLocal_157 = 0;
	...
	else if (Local_177.f_1 == 0)
	{
		...
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_660, 1) > 40f || func_404(40f))
			{
				if (func_40())
				{
...
int func_404(float fParam0)
{
	if (iLocal_709 < (iLocal_677 - 1))
	{
		AI::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_655, Local_678[iLocal_709], &iVar0);
		if (iVar0 < iLocal_658)
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_678[iLocal_709], 1) > fParam0)
			{
				return 1;
			}
		}
...
void func_421(int iParam0)
{
	...
	STREAMING::REQUEST_MODEL(-1552967674);
	while (!STREAMING::HAS_MODEL_LOADED(-1552967674))
	{
		SYSTEM::WAIT(0);
	}
	func_5();
	...
	iLocal_395 = GAMEPLAY::GET_GAME_TIMER();
	iLocal_391 = 0;
	iLocal_349 = PED::CREATE_PED(26, -1552967674, -1865.9f, -448.81f, 45.13f, -143.87f, 1, 1);
	...
	switch (iParam0)
	{
		...
		case 4:
			...
			if (func_313(iLocal_628))
			{
				DECISIONEVENT::ADD_SHOCKING_EVENT_FOR_ENTITY(97, iLocal_628, -1f);
			}
			func_429();
			func_4(1);
			if (func_424(1))
...
void func_429()
{
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(663522487);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_625);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-771835772);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-945854168);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1788665315);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(189425762);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1552967674);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_454);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-48031959);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1041692462);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-14495224);
}
...
void func_430()
{
	STREAMING::REQUEST_MODEL(663522487);
	STREAMING::REQUEST_MODEL(-1041692462);
	STREAMING::REQUEST_MODEL(-14495224);
	while ((!STREAMING::HAS_MODEL_LOADED(663522487) || !STREAMING::HAS_MODEL_LOADED(-1041692462)) || !STREAMING::HAS_MODEL_LOADED(-14495224))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (!func_7(Local_549.f_2))
	{
		...
		Local_549 = PED::CREATE_PED_INSIDE_VEHICLE(Local_549.f_2, 4, 663522487, -1, 1, 1);
		Local_549.f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_549.f_2, 4, 663522487, 0, 1, 1);
	...
	if (!func_7(Local_563.f_2))
	{
		...
		Local_563 = PED::CREATE_PED_INSIDE_VEHICLE(Local_563.f_2, 4, 663522487, -1, 1, 1);
		Local_563.f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_563.f_2, 4, 663522487, 0, 1, 1);
...
void func_437()
{
	...
	Local_678[0] = { -1868.36f, -447.84f, 45.2f };
	Local_678[1] = { -1835.81f, -468.73f, 43.45f };
	Local_678[2] = { -1753.45f, -523.3f, 37.35f };
	Local_678[3] = { Local_663 };
	Local_678[4] = { -1755.65f, -558.99f, 36.11f };
	Local_678[5] = { -1828.99f, -516.33f, 27.87f };
	Local_678[6] = { -1819.2f, -555.86f, 15.77f };
	Local_678[7] = { Local_666 };
	Local_678[8] = { -1918.04f, -583.45f, 10.76f };
	Local_678[9] = { Local_669 };
	...
	Local_439.y = "FAN1_CHEAT_1";
	Local_439.x = "FAN1_CHEAT";
	Local_434.y = "FAN1_CHEAT_2";
	Local_434.x = "FAN1_CHEAT";
	Local_444.y = "FAN1_CATCHC_1";
...
void func_438()
{
	if (AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_655))
	{
		...
		{
			Var2 = { 0f, 0f, 0f };
			AI::WAYPOINT_RECORDING_GET_COORD(sLocal_655, iVar1, &Var2);
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Var2, 4f, 0, 0, 0, 0, 0, 0);
...
void func_454()
{
	...
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(189425762);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(663522487);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(1404403376);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1552967674);
	func_464();
	func_4(1);
