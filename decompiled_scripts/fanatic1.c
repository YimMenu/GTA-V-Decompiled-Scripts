		...
		case 0:
			...
			while (iVar5 <= 3)
			{
				if (func_313(Local_576[iVar5]))
				{
					...
					{
						TASK::CLEAR_PED_TASKS(Local_576[iVar5]);
						TASK::OPEN_SEQUENCE_TASK(&uLocal_182);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
						TASK::TASK_PAUSE(0, 2000);
						TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
						TASK::CLOSE_SEQUENCE_TASK(uLocal_182);
						TASK::TASK_PERFORM_SEQUENCE(Local_576[iVar5], uLocal_182);
						TASK::CLEAR_SEQUENCE_TASK(&uLocal_182);
...
bool func_47(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_40[iVar4].f_3) < iParam4);
}
...
void func_158(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_152(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_152(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_293()
{
	...
	while (iVar0 <= 1)
	{
		...
		{
			TASK::CLEAR_PED_TASKS(Local_576[iVar0]);
			TASK::OPEN_SEQUENCE_TASK(&uLocal_182);
			...
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[iVar0].f_8, 0.7f, 20000, 1f, 1, 1193033728);
			TASK::CLOSE_SEQUENCE_TASK(uLocal_182);
			TASK::TASK_PERFORM_SEQUENCE(Local_576[iVar0], uLocal_182);
			TASK::CLEAR_SEQUENCE_TASK(&uLocal_182);
		}
		if (func_440(Local_576[iVar0]))
		{
			...
			{
				TASK::CLEAR_PED_TASKS(Local_576[iVar0]);
				TASK::TASK_SMART_FLEE_PED(Local_576[iVar0], PLAYER::PLAYER_PED_ID(), 200f, -1, 1, 0);
	...
	if (iLocal_626 == 0)
	{
		if (iLocal_658 > 114)
		{
			if (func_313(Local_576[2]) && func_313(Local_576[3]))
			{
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&uLocal_182);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[iVar1].f_5, 0.7f, 20000, 1f, 1, 1193033728);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[iVar1].f_8, 0.7f, 20000, 1f, 1, 1193033728);
					TASK::CLOSE_SEQUENCE_TASK(uLocal_182);
					TASK::TASK_PERFORM_SEQUENCE(Local_576[iVar1], uLocal_182);
					TASK::CLEAR_SEQUENCE_TASK(&uLocal_182);
					iVar1++;
				}
				TASK::TASK_LOOK_AT_ENTITY(Local_576[2], Local_576[3], -1, 0, 2);
				TASK::TASK_LOOK_AT_ENTITY(Local_576[3], Local_576[2], -1, 0, 2);
			}
			if (func_313(iLocal_649))
			{
				TASK::CLEAR_PED_TASKS(iLocal_649);
	...
	else
	{
		...
		while (iVar2 <= 3)
		{
			...
			{
				TASK::CLEAR_PED_TASKS(Local_576[iVar2]);
				TASK::OPEN_SEQUENCE_TASK(&uLocal_182);
				...
				TASK::TASK_PAUSE(0, 3000);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[iVar2].f_8, 0.7f, 20000, 1f, 1, 1193033728);
				TASK::CLOSE_SEQUENCE_TASK(uLocal_182);
				TASK::TASK_PERFORM_SEQUENCE(Local_576[iVar2], uLocal_182);
				TASK::CLEAR_SEQUENCE_TASK(&uLocal_182);
			}
			if (func_440(Local_576[iVar2]))
			{
				...
				{
					TASK::CLEAR_PED_TASKS(Local_576[iVar2]);
					TASK::TASK_SMART_FLEE_PED(Local_576[iVar2], PLAYER::PLAYER_PED_ID(), 200f, -1, 1, 0);
...
int func_324()
{
	...
	if (((((((((STREAMING::HAS_ANIM_DICT_LOADED("mini@cpr@char_a@cpr_def") && STREAMING::HAS_ANIM_DICT_LOADED("mini@cpr@char_b@cpr_def")) && STREAMING::HAS_ANIM_DICT_LOADED("mini@cpr@char_a@cpr_str")) && STREAMING::HAS_ANIM_DICT_LOADED("mini@cpr@char_b@cpr_str")) && STREAMING::HAS_ANIM_DICT_LOADED("rcmfanatic1")) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Fanatic1Quad")) && STREAMING::HAS_MODEL_LOADED(-945854168)) && STREAMING::HAS_MODEL_LOADED(189425762)) && STREAMING::HAS_MODEL_LOADED(1077785853)) && STREAMING::HAS_MODEL_LOADED(-48031959))
	{
		return 1;
	}
	return 0;
	...
	if (!func_440(Local_576[0]))
	{
		...
		if ((STREAMING::HAS_MODEL_LOADED(iLocal_625) && STREAMING::HAS_MODEL_LOADED(-771835772)) && STREAMING::HAS_MODEL_LOADED(-945854168))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(Local_576[0]))
			{
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&uLocal_182);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[0].f_5, 2f, 20000, 1048576000, 0, 1193033728);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[0].f_8, 2f, 20000, 1048576000, 0, 1193033728);
					TASK::CLOSE_SEQUENCE_TASK(uLocal_182);
					TASK::TASK_PERFORM_SEQUENCE(Local_576[0], uLocal_182);
					TASK::CLEAR_SEQUENCE_TASK(&uLocal_182);
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(Local_576[1]))
			{
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&uLocal_182);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[1].f_5, 2.05f, 20000, 1048576000, 0, 1193033728);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_576[1].f_8, 2.05f, 20000, 1048576000, 0, 1193033728);
					TASK::CLOSE_SEQUENCE_TASK(uLocal_182);
					TASK::TASK_PERFORM_SEQUENCE(Local_576[1], uLocal_182);
					TASK::CLEAR_SEQUENCE_TASK(&uLocal_182);
				}
			}
			...
			{
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_576[2]);
			...
			{
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_576[3]);
	...
	switch (iLocal_157)
	{
		case 0:
			...
			if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
			{
				...
				CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Mary_Ann", iLocal_349, 161007533);
			}
			iLocal_460 = 0;
			iLocal_164 = 0;
			if (iLocal_644 == -1)
...
void func_380()
{
	if (func_313(iLocal_349))
	{
		if (iLocal_158 < 8 && iLocal_158 > 1)
		{
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_349, 1), Local_678[func_393()], 1) < MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_678[func_393()], 1))
			{
				if (iLocal_656 != 2)
				{
					iLocal_656 = 2;
...
void func_395()
{
	if (iLocal_709 < iLocal_677)
	{
		...
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_678[iLocal_709], 4f, 4f, 3f, 0, 1, 0) || !HUD::DOES_BLIP_EXIST(iLocal_672))
			{
				func_12(&iLocal_672);
				func_12(&iLocal_673);
				if (iLocal_674 != 0)
				...
				if (iLocal_709 < (iLocal_677 - 1))
				{
					...
					iLocal_672 = HUD::ADD_BLIP_FOR_COORD(Local_678[iLocal_709]);
					HUD::SHOW_HEIGHT_ON_BLIP(iLocal_672, 0);
					HUD::SET_BLIP_SCALE(iLocal_672, 1.2f);
					iLocal_673 = HUD::ADD_BLIP_FOR_COORD(Local_678[iLocal_709 + 1]);
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		fVar8 = MISC::GET_DISTANCE_BETWEEN_COORDS(Local_678[iLocal_709], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
		if (iLocal_674 != 0)
		{
			if (fVar8 > 100f)
			{
...
void func_400()
{
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_660, 1) > 60f || func_404(60f))
	{
		AUDIO::TRIGGER_MUSIC_EVENT("RC6A_FAIL");
		iLocal_160 = 6;
		iLocal_157 = 0;
	...
	else if (Local_177.f_1 == 0)
	{
		...
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_660, 1) > 40f || func_404(40f))
			{
				if (func_40())
				{
...
int func_404(float fParam0)
{
	if (iLocal_709 < (iLocal_677 - 1))
	{
		TASK::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_655, Local_678[iLocal_709], &iVar0);
		if (iVar0 < iLocal_658)
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_678[iLocal_709], 1) > fParam0)
			{
				return 1;
			}
		}
...
void func_421(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			func_4(0);
			MISC::CLEAR_AREA_OF_VEHICLES(-1806.495f, -525.8696f, 29.92591f, 100f, 0, 0, 0, 0, 0, 0);
			func_431();
			func_430();
			func_429();
			func_367(3, 1);
...
void func_430()
{
	...
	MISC::CLEAR_AREA_OF_VEHICLES(1829.384f, -516.19f, 27.85739f, 7f, 0, 0, 0, 0, 0, 0);
	if (!func_7(Local_549.f_2))
	{
...
void func_431()
{
	...
	STREAMING::REQUEST_MODEL(-1552967674);
	while ((((((((!STREAMING::HAS_ANIM_DICT_LOADED("rcmfanatic1") || !STREAMING::HAS_ANIM_DICT_LOADED("rcmfanatic1celebrate")) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmfanatic1yell")) || !STREAMING::HAS_ANIM_DICT_LOADED("move_f@runner")) || !STREAMING::HAS_ANIM_SET_LOADED("FEMALE_FAST_RUNNER")) || !TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_655)) || !TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Fanatic1RollingStart")) || !HUD::HAS_ADDITIONAL_TEXT_LOADED(0)) || !STREAMING::HAS_MODEL_LOADED(-1552967674))
	{
...
void func_438()
{
	if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_655))
	{
		...
		while (iVar1 <= iVar0)
		{
			...
			MISC::CLEAR_AREA_OF_VEHICLES(Var2, 4f, 0, 0, 0, 0, 0, 0);
