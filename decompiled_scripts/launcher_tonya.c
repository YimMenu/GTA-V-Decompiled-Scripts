void __EntryFunction__()
{
	...
	GAMEPLAY::CLEAR_AREA(Local_92, 5f, 1, 0, 0, 0);
	while (true)
	{
		SYSTEM::WAIT(0);
		...
		if (fVar0 < (20f * 20f) && iLocal_98)
		{
			switch (iLocal_99)
			{
				...
				case 2:
					if (func_191(&uLocal_265))
					{
						if (func_185(&uLocal_265) > GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(9f, 15f))
						{
							iLocal_268++;
							switch (iLocal_268)
							{
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_218(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_218(uParam1) && uParam1->f_4 == 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
bool func_229(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_230(&(Local_37[iVar4]), Var1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
{
	Var0 = { func_235(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
{
	Var0 = { func_235(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
...
int func_254(var uParam0)
{
	switch (iLocal_91)
	{
		case 0:
			...
			STREAMING::REQUEST_MODEL(-892841148);
		...
		case 2:
			...
			{
				uParam0->f_28[0] = PED::CREATE_PED(5, -892841148, -16.53f, -1473.12f, 29.61f, 319.56f, 1, 1);
				if (func_127(uParam0->f_28[0]))
				{
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[0], 1);
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uParam0->f_28[0], 1, 1);
					PED::SET_PED_MODEL_IS_SUPPRESSED(-892841148, 1);
		...
		case 3:
			...
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-892841148);
			return 1;
			break;
	}
	return 0;
