...
void func_184(var uParam0)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_52);
		if (fVar0 < (20f * 20f) && iLocal_56)
		{
			switch (iLocal_57)
			{
				...
				case 2:
					if (func_191(&uLocal_223))
					{
						if (func_185(&uLocal_223) > MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 15f))
						{
							iLocal_226++;
							switch (iLocal_226)
							{
...
int func_233(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_235(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
