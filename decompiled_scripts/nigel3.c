...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_75(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_58(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_75(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_53(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_53(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_53(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_53(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_86(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_86(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_75(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_229()
{
	switch (iLocal_158)
	{
		...
		case 2:
			...
			{
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_165, 0), Local_543, 1) > 25f)
				{
...
void func_249()
{
	switch (iLocal_158)
	{
		case 0:
			...
			if (SHAPETEST::GET_SHAPE_TEST_RESULT(uLocal_229[0], &(uLocal_258[0]), &(Local_261[0][0]), &(Local_261[0][1]), &(uLocal_276[0])) != 1 && SHAPETEST::GET_SHAPE_TEST_RESULT(uLocal_229[1], &(uLocal_258[1]), &(Local_261[1][0]), &(Local_261[1][1]), &(uLocal_276[0])) != 1)
			{
			...
			if ((STREAMING::HAS_ANIM_DICT_LOADED(sLocal_283) && STREAMING::HAS_MODEL_LOADED(iLocal_292)) && func_235(Local_165))
			{
				...
				if (func_235(PLAYER::PLAYER_PED_ID()) && func_235(iLocal_175))
				{
					...
					MISC::CLEAR_AREA_OF_VEHICLES(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_165, 0f, -3f, -0.47f), 10f, 1, 0, 0, 0, 0, 0);
					MISC::CLEAR_AREA_OF_VEHICLES(ENTITY::GET_ENTITY_COORDS(Local_165, 1), 10f, 1, 0, 0, 0, 0, 0);
					if (bLocal_314)
					{
...
void func_254(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_256()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_256()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_258(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_256()].f_6174.f_10, iParam0);
}
	...
	switch (iLocal_158)
	{
		...
		case 1:
			...
			if (func_235(Local_557))
			{
				...
				if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("NIGEL_03_MIX_SETTINGS"))
				{
					AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Local_557, "NIGEL_03_MIX_GROUP", 0);
					AUDIO::START_AUDIO_SCENE("NIGEL_03_MIX_SETTINGS");
					VEHICLE::START_VEHICLE_HORN(Local_557, 30000, MISC::GET_HASH_KEY("HELDDOWN"), 0);
...
int func_301(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_308() || func_307(Global_4456448.f_232883)) || func_306())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_304(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_365(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_380(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_366(iVar0, 0), 1);
	...
	switch (iLocal_158)
	{
		case 0:
			...
			else
			{
				...
				else if (SHAPETEST::GET_SHAPE_TEST_RESULT(uLocal_229[0], &(uLocal_258[0]), &(Local_261[0][0]), &(Local_261[0][1]), &(uLocal_276[0])) != 1 && SHAPETEST::GET_SHAPE_TEST_RESULT(uLocal_229[1], &(uLocal_258[1]), &(Local_261[1][0]), &(Local_261[1][1]), &(uLocal_276[0])) != 1)
				{
					if (uLocal_258[0] == 1 || uLocal_258[1] == 1)
					{
						func_316("N3TRUNK", -1);
			...
			else
			{
				switch (iLocal_279)
				{
					...
					case 5:
						...
						if ((func_401(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_165, Local_224), 0.8f) && PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID())) && !((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || TASK::IS_PED_GETTING_UP(PLAYER::PLAYER_PED_ID())))
						{
							iLocal_158 = 2;
							iLocal_159 = 1;
							iLocal_518 = 2;
		...
		case 2:
			...
			switch (iLocal_159)
			{
				...
				case 1:
					uLocal_229[0] = SHAPETEST::START_SHAPE_TEST_BOX(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_165, Local_232[2]), Local_245[2], ENTITY::GET_ENTITY_ROTATION(Local_165, 2), 2, 19, 0, 4);
					uLocal_229[1] = SHAPETEST::START_SHAPE_TEST_BOX(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_165, Local_232[3]), Local_245[3], ENTITY::GET_ENTITY_ROTATION(Local_165, 2), 2, 19, 0, 4);
					iLocal_157 = 8;
					break;
...
void func_403()
{
	if (func_235(Local_165))
	{
		uLocal_229[0] = SHAPETEST::START_SHAPE_TEST_BOX(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_165, Local_232[0]), Local_245[0], ENTITY::GET_ENTITY_ROTATION(Local_165, 2), 2, 19, 0, 4);
		uLocal_229[1] = SHAPETEST::START_SHAPE_TEST_BOX(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_165, Local_232[1]), Local_245[1], ENTITY::GET_ENTITY_ROTATION(Local_165, 2), 2, 19, 0, 4);
	}
}
	...
	switch (iLocal_158)
	{
		case 0:
			...
			if (func_480(1, 1093140480, 0))
			{
				...
				MISC::CLEAR_AREA_OF_VEHICLES(20.6534f, -1302.867f, 28.0513f, 15f, 0, 0, 0, 0, 0, 0);
				...
				ENTITY::SET_CAN_AUTO_VAULT_ON_ENTITY(Local_165, 0);
...
void func_435(struct<3> Param0, float fParam3, int iParam4)
{
	if (STREAMING::HAS_MODEL_LOADED(Local_165.f_1))
	{
		...
		VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_165, 0);
		VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_165, 0);
...
int func_503()
{
	if (Global_20805 == 4)
	{
		...
		if (iVar0 > -1)
		{
			if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_19673[iVar0])))
			{
				cVar1 = { Global_20424 };
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (fVar7 == -0.014f)
				{
					if (func_532(&Var4) > fLocal_26)
					{
						...
						{
							HUD::SET_HUD_COMPONENT_POSITION(15, Local_22.x, (Local_22.y + fLocal_25));
							Global_76881 = 1;
						}
					}
				}
