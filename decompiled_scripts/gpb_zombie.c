		...
		switch (iLocal_216)
		{
			...
			case 6:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_208, 713668775) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_208, 713668775) != 0)
				{
					...
					PED::_0x2208438012482A1A(iLocal_208, false, false);
					func_119();
					iLocal_216 = 0;
				}
				break;
			...
			case 8:
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_53(Global_111583[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
...
void func_53(int iParam0, int iParam1, float fParam2)
{
	if (iParam0 == 3)
	{
		if ((iParam1 == 3 && !iLocal_278) && fParam2 >= 0.773f)
		{
			...
			ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_277, iLocal_208, PED::GET_PED_BONE_INDEX(iLocal_208, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true);
			iLocal_278 = 1;
		}
