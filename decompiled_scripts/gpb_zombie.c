		...
		switch (iLocal_216)
		{
			...
			case 8:
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_53(Global_111583[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_62();
				bVar37 = func_63();
				func_52(Global_111583[iLocal_217]);
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_331)
					{
						Global_111583[iLocal_217] = uLocal_330;
					}
					else
					{
...
int func_8()
{
	if (Global_111583[iLocal_217] == 3 && (iLocal_223 >= 4 && iLocal_223 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_55()
{
	...
	func_58(Global_111583[iLocal_217] + 1, &sVar0, &Var1);
	...
	PED::_0x2208438012482A1A(uLocal_208, 0, 0);
	func_56(Global_111583[iLocal_217]);
}
...
int func_86(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_88(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
