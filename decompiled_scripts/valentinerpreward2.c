...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_255(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_260()
{
	...
	else
	{
		...
		if (CAM::IS_SCREEN_FADED_IN() || CAM::IS_SCREEN_FADING_IN())
		{
			...
			{
				fVar46 = (SYSTEM::TO_FLOAT(func_265(&uLocal_11, 0, 0)) / SYSTEM::TO_FLOAT(func_264()));
				fVar47 = (SYSTEM::TO_FLOAT(func_265(&uLocal_9, 0, 0)) / SYSTEM::TO_FLOAT(func_263()));
				fVar47 = (fVar47 * fVar46);
				Var48 = { func_261(Local_17, func_262(), fVar47) };
...
Vector3 func_261(struct<3> Param0, struct<3> Param3, float fParam6)
{
...
int func_265(var uParam0, bool bParam1, bool bParam2)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
	{
		if (!bParam2)
...
int func_267()
{
	if (((((((func_120(22107, -1, -1) && Global_2409299 == 7) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) && func_270(PLAYER::PLAYER_PED_ID(), 426.433f, 5614.172f, 766.414f, 1f)) && Global_2453903.f_3075.f_178 >= 1) && Global_2453903.f_3075.f_178 < 4) && func_269()) && func_268())
	{
		return 1;
	}
	return 0;
...
int func_272()
{
	...
	if (func_275("CM_PV_MEM") || func_275("CM_PV_MEM_PC"))
	{
...
void func_281()
{
	if (((func_284() == 3 && func_283()) && func_18()) && func_282(Global_4456448.f_85535))
	{
...
void func_285()
{
	...
	if (func_286(Global_2426865[PLAYER::PLAYER_ID() /*449*/].f_319.f_9))
	{
		return;
	}
...
void func_290()
{
	...
	if (func_295())
	{
		if ((!iLocal_625 && func_294()) && func_293())
		{
			iVar0 = 0;
			while (iVar0 < 1200)
			{
				if (func_292(Global_794709.f_107189[iVar0 /*13*/].f_1) || func_291(Global_794709.f_107189[iVar0 /*13*/].f_1))
				{
...
void func_304()
{
	...
	if ((func_230(PLAYER::PLAYER_ID()) && Global_2426865[PLAYER::PLAYER_ID() /*449*/].f_319.f_9 == PLAYER::PLAYER_ID()) && !MISC::IS_BIT_SET(Global_102814, 7))
	{
		if (func_312(5))
		{
			if (Global_4016696 != -1)
			{
				if (Global_2097152[func_311() /*5557*/].f_675.f_2 != -1)
				{
					if (!iLocal_623)
					{
					...
					{
						Global_2097152[func_311() /*5557*/].f_675.f_2 = Global_4016696;
					}
				}
				else
				{
...
void func_305(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (func_310() < 0 && Global_1695554)
	{
		return;
	}
	if (func_309(35))
	...
	if (bParam2)
	{
		...
		if (bParam3)
		{
			if (func_310() >= 0 && MISC::IS_BIT_SET(Global_1323703[func_310() /*142*/].f_103, 0))
			{
				func_308(33);
			}
		}
		...
		if (func_310() >= 0)
		{
			if (func_306(Global_1323703[func_310() /*142*/].f_66))
			{
				func_308(40);
			}
		}
...
int func_310()
{
	if (Global_2097152[func_311() /*5557*/].f_675.f_2 >= 317)
	{
		Global_2097152[func_311() /*5557*/].f_675.f_2 = -1;
		return -1;
	}
	return Global_2097152[func_311() /*5557*/].f_675.f_2;
}
...
void func_314()
{
	...
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (NETWORK::NETWORK_GET_HOST_OF_SCRIPT("tuner_property_carmod", Global_2426865[PLAYER::PLAYER_ID() /*449*/].f_319.f_7, 0) == PLAYER::PLAYER_ID() && func_286(Global_2426865[PLAYER::PLAYER_ID() /*449*/].f_319.f_9))
		{
			Global_1683634 = 1;
			Global_99422.f_18[45] = 0;
			return;
...
void func_316()
{
	if (func_230(PLAYER::PLAYER_ID()) && !func_228(PLAYER::PLAYER_ID()))
	{
		if (Global_1316863 && !iLocal_612)
		{
			if (Global_2426865[PLAYER::PLAYER_ID() /*449*/].f_319.f_9 != func_9())
			{
				if (func_319(Global_2426865[PLAYER::PLAYER_ID() /*449*/].f_319.f_9) && !func_318(Global_2426865[PLAYER::PLAYER_ID() /*449*/].f_319.f_9))
				{
					func_317(1);
					iLocal_612 = 1;
				}
...
{
	return func_324(&(Global_2426865[iParam0 /*449*/].f_435), 0);
}
...
{
	return func_326(func_327(iParam0));
}
...
void func_328()
{
	if (((Global_2544210.f_911 && Global_2544210.f_924) && !Global_2544210.f_5971) && !Global_2544210.f_913)
	{
		if (!iLocal_419)
		{
			func_329(Global_1323703[Global_2544210.f_958 /*142*/].f_66);
			iLocal_419 = 1;
		}
	}
	else if (iLocal_419)
...
void func_329(int iParam0)
{
	...
	while (iVar0 < 5)
	{
		iVar6 = func_346(iVar0);
		if (func_338(iVar6) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Global_1683970.f_516[iVar6 /*3*/], Global_1683970.f_516[iVar6 /*3*/].f_1, 0f) < 300f)
		{
			iVar1 = 0;
			if (func_337(iParam0))
			{
...
void func_335(struct<3> Param0, var uParam3)
{
...
int func_338(int iParam0)
{
	...
	if (func_344(PLAYER::PLAYER_ID(), 0) || (func_227(PLAYER::PLAYER_ID()) && func_117(func_343(PLAYER::PLAYER_ID())) == 12))
	{
		return 1;
	}
	if (func_342(PLAYER::PLAYER_ID()) || (func_227(PLAYER::PLAYER_ID()) && func_117(func_343(PLAYER::PLAYER_ID())) == 8))
	{
		return 1;
	}
	if (func_341(PLAYER::PLAYER_ID()) || (func_227(PLAYER::PLAYER_ID()) && func_117(func_343(PLAYER::PLAYER_ID())) == 5))
	{
		return 1;
	}
	if (func_340(PLAYER::PLAYER_ID()) || (func_227(PLAYER::PLAYER_ID()) && func_117(func_343(PLAYER::PLAYER_ID())) == 10))
	{
		return 1;
	}
	if (func_339(PLAYER::PLAYER_ID()) || (func_227(PLAYER::PLAYER_ID()) && func_117(func_343(PLAYER::PLAYER_ID())) == 6))
	{
		return 1;
	}
	return 0;
			...
			if (Global_1683970.f_4415.f_6 == -1)
			{
				if (((func_15(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) && func_16()) && !func_18())
				{
					...
					if (func_15(iVar19))
					{
						...
						func_355(iLocal_418, &uVar0);
						if (!func_349(&uVar0, iVar19, iVar21, 0))
						{
							bVar20 = true;
						}
					}
...
int func_349(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	func_354(iParam1, iParam2, &Var0, &Var3, &Var6, &Var9);
	func_353(iParam1, iParam2, &Var12, &Var15, &Var18, &Var21);
	Var24 = { func_351(Var12, Var0, 0f, 1f, 0.5f) };
	Var27 = { func_351(Var15, Var3, 0f, 1f, 0.5f) };
	Var30 = { func_351(Var18, Var6, 0f, 1f, 0.5f) };
	Var33 = { func_351(Var21, Var9, 0f, 1f, 0.5f) };
	...
	{
		if (func_350(ENTITY::GET_ENTITY_HEADING(iParam1), uParam0->f_14, 75f) || iParam3)
		{
			return 1;
		}
	}
	Var36 = { func_351(Var12, Var15, 0f, 1f, 0.5f) };
	Var39 = { func_351(Var0, Var3, 0f, 1f, 0.5f) };
	...
	{
		if (func_350(ENTITY::GET_ENTITY_HEADING(iParam1), (uParam0->f_14 - 180f), 75f) || iParam3)
		{
			return 1;
		}
	}
	...
	{
		if ((func_350(ENTITY::GET_ENTITY_HEADING(iParam1), uParam0->f_14, 75f) || func_350(ENTITY::GET_ENTITY_HEADING(iParam1), (uParam0->f_14 - 180f), 75f)) || iParam3)
		{
			return 1;
		}
	}
...
Vector3 func_351(struct<3> Param0, struct<3> Param3, float fParam6, float fParam7, float fParam8)
{
	return func_352(Param0.x, Param3.x, fParam6, fParam7, fParam8), func_352(Param0.f_1, Param3.f_1, fParam6, fParam7, fParam8), func_352(Param0.f_2, Param3.f_2, fParam6, fParam7, fParam8);
}
...
void func_353(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	struct<3> Var0;
	struct<2> Var3;
	struct<3> Var6;
...
void func_354(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	struct<2> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
{
	func_356(iParam0, &(uParam1->f_4), &(uParam1->f_7), &(uParam1->f_10), &(uParam1->f_13), &(uParam1->f_14));
	uParam1->f_2 = 1;
...
int func_360()
{
	...
	if ((func_362(PLAYER::PLAYER_ID()) && func_96()) && func_361(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1085.49f, 211.389f, -49.801f, 10f, 1))
	{
		return 1;
	}
	return 0;
...
void func_363()
{
	if (func_165(PLAYER::PLAYER_ID()))
	{
		...
		{
			case 4:
				if ((((!func_373(PLAYER::PLAYER_ID()) || func_372(PLAYER::PLAYER_ID())) || func_371(PLAYER::PLAYER_ID())) || func_370(PLAYER::PLAYER_ID())) || func_369(PLAYER::PLAYER_ID()))
				{
					func_368(0);
					func_367(1);
					func_366(0);
			...
			case 5:
				if ((((!func_370(PLAYER::PLAYER_ID()) || func_372(PLAYER::PLAYER_ID())) || func_371(PLAYER::PLAYER_ID())) || func_373(PLAYER::PLAYER_ID())) || func_369(PLAYER::PLAYER_ID()))
				{
					func_368(0);
					func_367(0);
					func_366(0);
			...
			case 6:
				if (((!func_371(PLAYER::PLAYER_ID()) || func_372(PLAYER::PLAYER_ID())) || func_373(PLAYER::PLAYER_ID())) || func_370(PLAYER::PLAYER_ID()))
				{
					func_368(0);
					func_367(0);
					func_366(0);
...
void func_374()
{
	...
	if (func_375(PLAYER::PLAYER_ID()) == 16)
	{
		if (iLocal_416 == 0)
		{
			iLocal_416 = 1;
	...
	else
	{
		...
		while (iVar2 <= 8)
		{
			if (uLocal_104[iLocal_42] != 0)
			{
				iVar3 = 0;
				bVar4 = true;
				if (func_381(&uLocal_39, iLocal_42))
				{
					bVar4 = false;
				}
				if (bVar4)
				{
					iVar3 = func_380(iLocal_42);
...
int func_379(int iParam0)
{
	...
	{
		if (func_381(&(Local_165[iParam0 /*3*/]), iVar0))
		{
				...
				if (iVar66 < 64)
				{
					if (ENTITY::DOES_ENTITY_EXIST(uVar1[iVar66]))
					{
						if (ENTITY::GET_ENTITY_MODEL(uVar1[iVar66]) == joaat("ig_rashcosvki"))
						{
							...
							if (func_361(Var67, 1707f, 2520f, 45f, 5f, 0))
							{
								if (Var67.f_2 <= 45f)
								{
...
int func_386(int iParam0)
{
	...
	while (iVar0 <= 9)
	{
		iVar1 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(ENTITY::GET_ENTITY_COORDS(Global_969056.f_119[iParam0], false), 2.5f, func_387(iVar0), false, false, false);
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
...
void func_393(int iParam0, int iParam1, bool bParam2)
{
	if (func_400())
	{
		...
		if ((!NETWORK::NETWORK_IS_ACTIVITY_SESSION() && !func_398()) && !func_394(PLAYER::PLAYER_ID()))
		{
			Global_968396 = 0;
		}
...
void func_407()
{
	func_408(&iLocal_32, -2163.247f, 1073.873f, -24.3537f, 0);
}

void func_408(int* iParam0, struct<3> Param1, bool bParam4)
{
	if (func_165(PLAYER::PLAYER_ID()) && !func_410())
	{
		if (*iParam0 == 0)
		{
		...
		else if ((MISC::GET_FRAME_COUNT() % 30) == 0)
		{
			if (func_15(*iParam0))
			{
				...
				{
					if (!func_409(ENTITY::GET_ENTITY_COORDS(*iParam0, true), Param1, 0))
					{
...
{
	if (func_165(iParam0) || func_343(PLAYER::PLAYER_ID()) == 153)
	{
...
void func_413()
{
	func_408(&iLocal_31, -2193.595f, 1104.256f, -23.2574f, 1);
}
...
void func_421()
{
	if (Global_1683964 == 1)
	{
		if (func_228(PLAYER::PLAYER_ID()))
		{
			if (func_423(PLAYER::PLAYER_ID()) == func_9() && Global_2426865[PLAYER::PLAYER_ID() /*449*/].f_319.f_9 != func_9())
			{
				if (func_26(Global_2426865[PLAYER::PLAYER_ID() /*449*/].f_319.f_16) && MISC::IS_BIT_SET(Global_2426865[PLAYER::PLAYER_ID() /*449*/].f_319, 4))
				{
					func_422(1, Global_2426865[PLAYER::PLAYER_ID() /*449*/].f_319.f_16);
				}
			}
		}
	}
...
int func_423(int iParam0)
{
	...
	{
		iVar0 = func_117(func_424(iParam0));
...
void func_427()
{
	...
	if (!iLocal_5)
	{
		if (Global_1574226)
		{
			iVar0 = func_428(joaat("mpply_char_exploit_level"));
			if (iVar0 >= 4)
			{
...
int func_430()
{
	...
	iVar0 = func_428(joaat("mpply_char_peak_exploit_level"));
	if (iVar0 < Global_262145.f_10407)
	{
		return 0;
	}
	uVar1[0] = func_428(joaat("mpply_prevseasonexploitlevel"));
	uVar1[1] = func_428(joaat("mpply_prevseason2exploitlevel"));
	uVar1[2] = func_428(joaat("mpply_prevseason3exploitlevel"));
	uVar1[3] = func_428(joaat("mpply_prevseason4exploitlevel"));
	iVar6 = 0;
