...
void func_2()
{
	...
	if (!NETWORK::NETWORK_IS_ACTIVITY_SESSION() && !func_4(PLAYER::PLAYER_ID()))
	{
		switch (iLocal_3)
		{
			case joaat("kosatka"):
...
{
	return func_5(&(Global_2425869[iParam0 /*443*/].f_429), 0);
}
...
void func_6()
{
	...
	if (func_15(PLAYER::PLAYER_ID()) == 4 && !func_11(func_14(), 0))
	{
		if (!iLocal_94)
		{
			...
			if (MISC::IS_BIT_SET(Global_4271024, 21) && STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
			{
				...
				else if (func_9(&uLocal_92, 60000, 0))
				{
					if (!iLocal_95)
					{
...
int func_11(int iParam0, int iParam1)
{
	if (iParam0 != -1)
	{
		return func_12(iParam0, func_13(iParam1));
	}
	return 0;
}
...
void func_19()
{
	if (STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() || !func_21(PLAYER::PLAYER_ID()))
	{
		iLocal_90 = 0;
		iLocal_91 = 0;
		return;
...
int func_21(int iParam0)
{
	if (iParam0 != func_24())
	{
		if (func_23(iParam0, 1, 1))
		{
			...
			{
				return func_22(Global_2425869[iParam0 /*443*/].f_314.f_6) == 20;
			}
		}
	}
	return 0;
...
{
	return func_29(func_15(iParam0));
}
...
void func_31()
{
	...
	if (func_37(1))
	{
		if (func_18(PLAYER::PLAYER_ID()) == 256 && func_35(PLAYER::PLAYER_ID()))
		{
			if (func_15(PLAYER::PLAYER_ID()) == 21)
			{
				if (!func_34(10))
				{
					func_33(10);
...
void func_40()
{
	...
	if (PLAYER::PLAYER_ID() != NETWORK::NETWORK_GET_HOST_OF_SCRIPT(func_57(), -1, 0))
	{
		return;
	}
	...
	iVar0 = func_54(&(Local_72.f_13), 0, 1);
	iVar1 = func_53(Local_72.f_10);
	bVar2 = true;
	iVar3 = 1;
	while (iVar3 <= iVar1)
	{
		if (iVar0 < func_52(&Local_72, iVar3))
		{
			Local_72 = iVar3;
			if (iVar3 == 1)
			{
				Local_72.f_2 = func_51(&Local_72, iVar0);
			}
			else
			{
				Local_72.f_2 = func_51(&Local_72, (iVar0 - func_52(&Local_72, (iVar3 - 1))));
			}
			bVar2 = false;
			Jump @212; //curOff = 194
		}
	...
	if (!bVar2)
	{
		if (Local_72 == func_53(Local_72.f_10))
		{
			iVar4 = func_50(&Local_72, iVar0);
			iVar5 = func_48(Local_72.f_10, Local_72);
	...
	Global_2419386.f_1444[1 /*15*/].f_8 = func_45(Global_2419386.f_1444[1 /*15*/].f_8, 1);
	Global_2419386.f_1444[1 /*15*/].f_10 = func_44(Global_2419386.f_1444[1 /*15*/].f_8, 0);
	Global_2419386.f_1444[1 /*15*/] = 1;
	Global_2419386.f_1444[1 /*15*/].f_3 = func_43(&(Global_2419386.f_1444[1 /*15*/]), 0);
	Global_2419386.f_1444[1 /*15*/].f_2 = 0;
	func_42(&(Global_2419386.f_1444[1 /*15*/].f_13), 0, 0);
	Global_2419386.f_1444[1 /*15*/].f_13 = NETWORK::GET_TIME_OFFSET(Global_2419386.f_1444[1 /*15*/].f_13, -Global_2419386.f_1444[1 /*15*/].f_2);
	Global_2419386.f_1444[1 /*15*/].f_1 = MISC::GET_HASH_KEY(func_41(Global_2419386.f_1444[1 /*15*/].f_10, Global_2419386.f_1444[1 /*15*/]));
}
...
int func_43(var uParam0, bool bParam1)
{
	...
	iVar1 = 0;
	iVar0 = 1;
	while (iVar0 <= func_53(uParam0->f_10))
	{
		iVar1 = (iVar1 + func_48(uParam0->f_10, iVar0));
		if (!bParam1)
		{
			if (*uParam0 == iVar0)
			{
...
int func_50(int iParam0, int iParam1)
{
	...
	return (func_48(iParam0->f_10, *iParam0) - iVar0);
}
...
int func_51(int iParam0, int iParam1)
{
	...
	{
		iVar0 = 2;
		while (iVar0 <= func_53(iParam0->f_10))
		{
			iParam1 = (iParam1 + func_48(iParam0->f_10, (iVar0 - 1)));
			if (*iParam0 == iVar0)
			{
			}
			else
...
int func_56(int iParam0)
{
	if (iParam0 != func_24())
	{
		if (func_23(iParam0, 1, 1))
		{
			...
			{
				return func_22(Global_2425869[iParam0 /*443*/].f_314.f_6) == 19;
			}
		}
	}
	return 0;
...
void func_58()
{
	...
	bVar6 = (func_39(PLAYER::PLAYER_ID()) && func_18(PLAYER::PLAYER_ID()) == 256);
	switch (Local_27.f_2)
	{
		case 0:
			if (bVar6)
			{
				switch (func_16(PLAYER::PLAYER_ID()))
				{
					case 11:
					case 20:
					case 21:
		...
		case 1:
			if (func_8(&Local_27))
			{
				if (func_9(&Local_27, 5000, 0))
				{
					iVar4 = func_65(PLAYER::PLAYER_ID());
					if (iVar4 != -1)
					{
						iVar3 = 0;
						while (iVar3 < 31)
						{
							...
							{
								Var0 = { func_64(iVar4, iVar3) };
								iVar5 = func_63(iVar4, iVar3);
								if (!func_62(Var0) && iVar5 != 0)
								{
						...
						while (iVar3 < 31)
						{
							if (MISC::IS_BIT_SET(Local_27.f_3, iVar3))
							{
								if (ENTITY::DOES_ENTITY_EXIST(Local_27.f_4[iVar3]) && func_61(Local_27.f_4[iVar3]))
								{
					...
					if (func_59(Local_27.f_3) == 0 || func_9(&Local_27, 10000, 0))
					{
						Local_27.f_2 = 2;
					}
				}
...
void func_66()
{
	...
	if (func_18(PLAYER::PLAYER_ID()) == 256)
	{
		iVar0 = -1;
		switch (func_16(PLAYER::PLAYER_ID()))
		{
			case 19:
				...
				{
					if (func_9(&uLocal_70, 20000, 0))
					{
						CAM::DO_SCREEN_FADE_OUT(0);
					}
				}
				else if (func_8(&uLocal_70))
				{
					func_7(&uLocal_70);
				}
				break;
...
void func_67()
{
	...
	{
		if ((!func_9(&uLocal_68, 1500, 0) || !CAM::IS_SCREEN_FADED_IN()) || CAM::IS_SCREEN_FADING_IN())
		{
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
			PAD::DISABLE_CONTROL_ACTION(2, 201, true);
		}
...
void func_68()
{
	...
	if (func_69(PLAYER::PLAYER_ID(), 1, 1))
	{
	...
	{
		if (func_22(Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_6) == 11)
		{
			bVar0 = true;
...
void func_71()
{
	...
	if (func_8(&uLocal_18))
	{
		...
		if (func_9(&uLocal_18, 60000, 0))
		{
			func_42(&uLocal_18, 0, 0);
			func_7(&uLocal_18);
		}
	}
	if (func_8(&uLocal_16) && func_9(&uLocal_16, 1000, 0))
	{
		if (iLocal_25 == -1)
		{
		...
		else if (func_9(&uLocal_16, 4000, 0))
		{
			...
			func_42(&uLocal_16, 0, 0);
			func_7(&uLocal_16);
		}
	}
	if (!iLocal_10 && !func_81())
	{
		return;
	}
	iLocal_10 = 1;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_9))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(iVar0))
		{
			...
			iVar1 = func_80(7867, -1, 0);
			func_77(7867, iVar1 + 1, -1, 1, 0);
			Var2.f_1 = 1;
			Var2 = 24;
	...
	else
	{
		...
		if (CAM::IS_SCREEN_FADED_IN() || CAM::IS_SCREEN_FADING_IN())
		{
			...
			if (!iLocal_11)
			{
				if (func_9(&uLocal_12, 4500, 0))
				{
					ENTITY::FREEZE_ENTITY_POSITION(iLocal_9, false);
					func_42(&uLocal_12, 0, 0);
					func_7(&uLocal_12);
			...
			{
				fVar46 = (SYSTEM::TO_FLOAT(func_54(&uLocal_14, 0, 0)) / SYSTEM::TO_FLOAT(func_75()));
				fVar47 = (SYSTEM::TO_FLOAT(func_54(&uLocal_12, 0, 0)) / SYSTEM::TO_FLOAT(func_74()));
				fVar47 = (fVar47 * fVar46);
				Var48 = { func_72(Local_20, func_73(), fVar47) };
...
Vector3 func_72(struct<3> Param0, struct<3> Param3, float fParam6)
{
...
int func_81()
{
	if (((((((func_85(22107, -1, -1) && Global_2409291 == 7) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) && func_84(PLAYER::PLAYER_PED_ID(), 426.433f, 5614.172f, 766.414f, 1f)) && Global_2452679.f_3074.f_178 >= 1) && Global_2452679.f_3074.f_178 < 4) && func_83()) && func_82())
	{
		return 1;
	}
	return 0;
...
int func_82()
{
	if (func_85(15476, -1, -1) && func_80(5451, func_79(), 0) > 577)
	{
		return 1;
	}
	return 0;
...
void func_89()
{
	...
	if (!func_8(&uLocal_6))
	{
		func_42(&uLocal_6, 0, 0);
	}
	if (!func_9(&uLocal_6, 35000, 0))
	{
		return;
	}
	iLocal_8 = 1;
...
void func_91()
{
	if ((NETWORK::GET_CLOUD_TIME_AS_INT() > func_80(9583, -1, 0) && func_94(PLAYER::PLAYER_ID()) == 258) && func_93() == 3)
	{
		func_92(-1);
	}
}
...
void func_98()
{
	if ((Global_110804 && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("director_mode")) <= 0) && func_99())
	{
...
void func_101()
{
	...
	if (!iLocal_5)
	{
		if (Global_1574217)
		{
			iVar0 = func_102(joaat("MPPLY_CHAR_EXPLOIT_LEVEL"));
			if (iVar0 >= 4)
			{
...
int func_104()
{
	...
	iVar0 = func_102(joaat("MPPLY_CHAR_PEAK_EXPLOIT_LEVEL"));
	if (iVar0 < Global_262145.f_10237)
	{
		return 0;
	}
	uVar1[0] = func_102(joaat("MPPLY_PREVSEASONEXPLOITLEVEL"));
	uVar1[1] = func_102(joaat("MPPLY_PREVSEASON2EXPLOITLEVEL"));
	uVar1[2] = func_102(joaat("MPPLY_PREVSEASON3EXPLOITLEVEL"));
	uVar1[3] = func_102(joaat("MPPLY_PREVSEASON4EXPLOITLEVEL"));
	iVar6 = 0;
...
void func_109()
{
	if (iLocal_1)
	{
		...
		func_110(0.69f, 0.06f, "STRING", sLocal_0);
	}
	if (!iLocal_1)
	{
...
void func_110(float fParam0, float fParam1, char* sParam2, char* sParam3)
{
