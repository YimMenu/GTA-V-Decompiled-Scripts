			...
			case 2:
				...
				if (iLocal_111 == 3)
				{
					if (iLocal_100 == 0)
					{
						...
						{
							if (!PED::IS_PED_IN_VEHICLE(Local_112.f_9, Local_248[0], 0))
							{
								PED::SET_PED_INTO_VEHICLE(Local_112.f_9, Local_248[0], -1);
							}
						}
					}
				}
	...
	if (func_24(Local_336))
	{
		if (func_427(Local_344))
		{
			if (func_59(3))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(Local_336, uVar0, func_42(), func_52(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_344, uVar0, func_51(), func_42(), 1000f, -8f, iVar1, 1148846080);
	...
	if (iLocal_420 > 0)
	{
		...
		while (iVar0 <= (iLocal_420 - 1))
		{
			if (iLocal_111 == 4)
			{
				...
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_133[iVar0], -2065892691);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_133[iVar0], 0);
					if (Global_110347 == 0)
					{
						PED::SET_PED_KEEP_TASK(Local_133[iVar0], 0);
					}
					else
					{
						PED::SET_PED_KEEP_TASK(Local_133[iVar0], 1);
					}
				}
			}
			...
			if (!PED::IS_PED_RAGDOLL(*iParam0) || AI::IS_PED_GETTING_UP(*iParam0))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(func_109()))
				{
					*iParam2 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					...
					AI::TASK_SYNCHRONIZED_SCENE(*iParam0, *iParam2, func_109(), func_75(), 1000f, -4f, 4626, 0, 1148846080, 0);
...
void func_121(int iParam0)
{
	...
	{
		AI::CLEAR_PED_SECONDARY_TASK(Local_133[iParam0]);
		AI::CLEAR_PED_TASKS(Local_133[iParam0]);
		AI::TASK_CLEAR_LOOK_AT(Local_133[iParam0]);
		if (func_122(1, 0, 1))
		{
		...
		else if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_133[iParam0]) == iLocal_612)
		{
			PED::SET_PED_HEARING_RANGE(Local_133[iParam0], 30f);
			PED::SET_PED_SEEING_RANGE(Local_133[iParam0], 30f);
			PED::SET_PED_ID_RANGE(Local_133[iParam0], 30f);
			PED::SET_PED_COMBAT_RANGE(Local_133[iParam0], 0);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_133[iParam0], 1, 0);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_133[iParam0], 3, 1);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_133[iParam0], 5, 1);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_133[iParam0], 0, 0);
			PED::SET_PED_FLEE_ATTRIBUTES(Local_133[iParam0], 512, 1);
			AI::TASK_LOOK_AT_ENTITY(Local_133[iParam0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_133[iParam0], PLAYER::PLAYER_PED_ID(), -1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_133[iParam0], 1);
			Local_133[iParam0].f_14 = 2;
		}
		else
		{
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_133[iParam0], 5, 0);
			AI::TASK_LOOK_AT_ENTITY(Local_133[iParam0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_133[iParam0], PLAYER::PLAYER_PED_ID(), -1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_133[iParam0], 0);
			Local_133[iParam0].f_14 = 4;
		}
	}
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_185(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_182(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
...
int func_189(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_190(Var18[0], Var18[1], Var6, Var9) || func_190(Var18[0], Var18[1], Var9, Var15)) || func_190(Var18[0], Var18[1], Var12, Var15)) || func_190(Var18[0], Var18[1], Var6, Var12)) || func_190(Var18[1], Var18[3], Var6, Var9)) || func_190(Var18[1], Var18[3], Var9, Var15)) || func_190(Var18[1], Var18[3], Var12, Var15)) || func_190(Var18[1], Var18[3], Var6, Var12)) || func_190(Var18[3], Var18[2], Var6, Var9)) || func_190(Var18[3], Var18[2], Var9, Var15)) || func_190(Var18[3], Var18[2], Var12, Var15)) || func_190(Var18[3], Var18[2], Var6, Var12)) || func_190(Var18[2], Var18[0], Var6, Var9)) || func_190(Var18[2], Var18[0], Var9, Var15)) || func_190(Var18[2], Var18[0], Var12, Var15)) || func_190(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
void func_198(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_199(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_200(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_210(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_210(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_210(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_242(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_210(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_210(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_210(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
void func_220(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_221(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_222(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_210(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_227(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_210(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_227(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_234(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_234(Var16.z)] = func_227(iParam1, Var16.x, func_234(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_234(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_222(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_222(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_222(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_222(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_259(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_253(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_253(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_210(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_314(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_210(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_210(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	if (func_24(Local_112.f_9))
	{
		...
		switch (iLocal_100)
		{
			case 0:
				...
				Local_674 = { ENTITY::GET_ENTITY_COORDS(Local_112.f_9, 0) };
				...
				if (!iLocal_397)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_120(iLocal_410, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_112(Local_112.f_9, Local_628, 30f))
									{
...
void func_320(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
	if (UI::DOES_BLIP_EXIST(*uParam0))
	{
		if (bParam5)
		{
			...
			if (iParam6 && !func_63())
			{
				if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_319(sParam2, 0, 0))
				{
		...
		else
		{
			...
			if (iParam6 && !func_63())
			{
				if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_319(sParam1, 0, 0))
				{
...
int func_339(char* sParam0)
{
	if (!func_340(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_326(sParam0)) || func_326("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_340(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_347() || func_346(Global_4456448.f_232883)) || func_345())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_343(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
	...
	if (func_24(Local_112.f_9))
	{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_112.f_10)
			{
				...
				case 31:
					if (func_120(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 750)))
					{
				...
				case 13:
					if (func_120(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
						{
							PED::_0xFE07FF6495D52E2A(Local_112.f_9, Local_628);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_112.f_9, &iVar0, 1);
						if (iVar0 != -1569615261)
						{
				...
				case 15:
					...
					{
						if (((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_248[0], 0) && func_112(Local_248[0], Local_248[0].f_1, 3f)) && func_370(ENTITY::GET_ENTITY_HEADING(Local_248[0]), Local_248[0].f_4, 20f)) && !func_369(Local_248[0], 2))
						{
							if (PED::IS_PED_IN_VEHICLE(Local_112.f_9, Local_248[0], 0) && !PED::IS_PED_BEING_JACKED(Local_112.f_9))
							{
								Local_112.f_10 = 16;
							}
							else if (func_120(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								...
								AI::TASK_ENTER_VEHICLE(Local_112.f_9, Local_248[0], 25000, -1, 3f, 8388608, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
								Local_112.f_10 = 16;
							}
						}
				...
				case 16:
					...
					else if ((((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_248[0], 1) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_112(Local_248[0], Local_248[0].f_1, 3f)) || !func_370(ENTITY::GET_ENTITY_HEADING(Local_248[0]), Local_248[0].f_4, 20f)) || func_369(Local_248[0], 2))
					{
						Local_112.f_18 = (GAMEPLAY::GET_GAME_TIMER() - 5000);
						Local_112.f_10 = 13;
					}
					else if (PED::IS_PED_SITTING_IN_VEHICLE(Local_112.f_9, Local_248[0]))
					{
						Local_112.f_10 = 33;
					}
				...
				case 17:
					if (func_7(Local_248[0]) && PED::IS_PED_SITTING_IN_VEHICLE(Local_112.f_9, Local_248[0]))
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_112.f_9, Local_248[0], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 350f, 30f, 1);
...
bool func_376(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_377(&(Local_56[iVar4]), Var1, iParam1, &(Local_56[iVar4].f_3), iParam0, iParam5);
...
{
	Var0 = { func_191(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
			...
			else
			{
				...
				else if (Local_112.f_10 == 24 && func_65(Local_112.f_9, -1519143300))
				{
					if (func_112(Local_112.f_9, Local_628, 25f))
					{
						...
						{
							if (func_120(iLocal_411, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_63())
								{
									func_3();
				...
				else
				{
					...
					if (!func_63())
					{
						if (func_120(iLocal_410, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_112(Local_112.f_9, Local_628, 20f))
							{
					...
					else
					{
						...
						if (func_7(Local_248[0]))
						{
							if ((Local_112.f_10 == 34 || Local_112.f_10 == 17) || Local_112.f_10 == 18)
							{
								...
								{
									if (func_401(Local_112.f_9, Local_248[0], Local_248[0].f_5, &Local_631, &iLocal_408, iLocal_419))
									{
									...
									func_399(Local_112.f_9, Local_248[0], Local_628);
								}
							}
						}
						else
...
int func_401(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	if (!func_112(iParam1, *uParam3[*iParam4], 15f))
	{
		if (!func_65(iParam0, -1817882002) && !func_65(iParam0, -72074166))
		{
			if (iLocal_408 < 7)
			{
				AI::TASK_VEHICLE_DRIVE_TO_COORD(iParam0, iParam1, *uParam3[*iParam4], 35f, 0, uParam2, 786468, 0f, 2f);
			}
			else
			{
				AI::TASK_VEHICLE_GOTO_NAVMESH(iParam0, iParam1, *uParam3[*iParam4], 35f, 4980772, 0f);
			}
		}
	}
	else
...
void func_408(var uParam0, var uParam1)
{
	if (!uParam0->f_7)
	{
		if (func_411(26, func_413(uParam0->f_4), 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if ((!func_63() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID())) && !UI::IS_MESSAGE_BEING_DISPLAYED())
				{
...
{
	Var0 = { func_191(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_447(int iParam0, bool bParam1, var uParam2)
{
	*uParam2 = 0;
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_149(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != 873639469) && ENTITY::GET_ENTITY_MODEL(iParam0) != -1177863319)
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_478(var uParam0, var uParam1, var uParam2)
{
	...
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_481(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_480(uParam0);
	if (func_479(*uParam0))
	{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_175(Param1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_494(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		else if (uParam1->f_66 == 340154634 || uParam1->f_66 == -1960756985)
		{
			...
			while (iVar2 <= 9)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_177(iVar2)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_177(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_177(iVar3)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_177(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_177(iVar4)))
					{
					}
					else
					{
						GAMEPLAY::SET_BIT(&(uParam1->f_77), func_177(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_177(iVar5 + 1)))
				{
...
void func_517()
{
	if (func_24(Local_112.f_9))
	{
		...
		{
			Local_285 = OBJECT::CREATE_OBJECT(413312110, ENTITY::GET_ENTITY_COORDS(Local_112.f_9, 0), 1, 1, 0);
		}
	...
	while (iVar0 <= 5)
	{
		if (func_24(Local_133[iVar0]))
		{
			...
			{
				WEAPON::GIVE_WEAPON_TO_PED(Local_133[iVar0], Local_133[iVar0].f_5, -1, 1, 1);
			}
			PED::SET_PED_CONFIG_FLAG(Local_133[iVar0], 137, 1);
	...
	while (iVar0 <= (iLocal_416 - 1))
	{
		...
		{
			VEHICLE::SET_VEHICLE_ENGINE_ON(Local_248[iVar0], 1, 1, 0);
		}
		iVar0++;
	}
}
...
int func_519()
{
	...
	if (iVar1 == iLocal_420)
	{
		...
		while (iVar2 <= (iLocal_420 - 1))
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_133[iVar2].f_18);
			iVar2++;
		}
	}
	if (iLocal_416 > 0)
	...
	if (iLocal_415 > 0)
	{
		...
		while (iVar2 <= (iLocal_415 - 1))
		{
			...
			{
				ENTITY::FREEZE_ENTITY_POSITION(Local_291[iVar2], 1);
				iVar0++;
			}
			iVar2++;
		}
...
void func_524()
{
	...
	iLocal_415 = 0;
	iLocal_418 = 0;
	Local_631[0] = { 2962.58f, 2817.19f, 42.29f };
	Local_631[1] = { 2942.482f, 2841.708f, 46.4443f };
	Local_631[2] = { 2909.12f, 2820.88f, 52.9f };
	Local_631[3] = { 2860.14f, 2816.9f, 52.56f };
	Local_631[4] = { 2821.638f, 2893.259f, 45.53f };
	Local_631[5] = { 2768.72f, 2950.61f, 39.78f };
	Local_631[6] = { 2712.31f, 2963.74f, 35.79f };
	Local_631[7] = { 2657.573f, 2981.731f, 38.9122f };
	Local_631[8] = { 2623.295f, 3077.358f, 46.24589f };
	iLocal_419 = 9;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_539()) || Global_110685) || Global_30770) || func_545()) || func_96(8, -1)) || func_544()) || func_543()) || func_537()) || func_538()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_539()) || Global_30770) || func_545()) || func_96(8, -1)) || func_537()) || func_544()) || func_543()) || func_538()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_539()) || Global_110685) || Global_30770) || func_545()) || func_96(8, -1)) || func_537()) || func_544()) || func_543()) || func_538()) || Global_111638.f_7683.f_919[iVar0] == 5) || Global_41978 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_539()) || Global_110685) || Global_30770) || func_545()) || func_96(8, -1)) || func_544()) || func_543()) || func_538()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_539()) || Global_30770) || func_545()) || func_96(8, -1)) || func_543()) || func_537()) || func_538()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_539()) || func_543()) || Global_110685) || Global_30770) || func_545()) || Global_42596) || func_96(8, -1)) || func_537()) || func_542()) || func_538()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_539()) || Global_110685) || Global_30770) || func_545()) || func_96(8, -1)) || func_537()) || func_542()) || func_544()) || func_543()) || func_538())
						{
							return 0;
						}
						break;
