...
void __EntryFunction__()
{
	...
	else if (func_428(0))
	{
		...
		{
			func_426(PLAYER::PLAYER_PED_ID(), Local_334, fLocal_115, 0, 0);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			Local_329 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
			func_415();
			func_414();
			switch (iLocal_58)
			{
		...
		switch (iLocal_58)
		{
			...
			case 3:
				...
				if (iLocal_60 == 1)
				{
					...
					if (!func_72())
					{
						func_426(PLAYER::PLAYER_PED_ID(), Local_328, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_103 == 0)
						{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_79))
		{
			if (func_60(Local_329, Local_79.f_1, 150f))
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_79.f_1, 10f, func_49(), 0))
				{
					...
					{
						ENTITY::SET_ENTITY_COORDS(Local_79, func_48(), 1, 0, 0, 1);
	...
	if (func_24(Local_75))
	{
		if (func_427(Local_77))
		{
			if (func_59(3))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(Local_75, uVar0, func_42(), func_52(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_77, uVar0, func_51(), func_42(), 1000f, -8f, iVar1, 1148846080);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_185(24) != Global_102203.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_182(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_134(Global_102203.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}
...
{
	return func_194(Global_102203.f_2890.f_12.f_66, Param0, iParam1);
}
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &Var2) && Var2.z != -1)
				{
					...
					{
						(*iParam0)[Var2.z] = func_227(iParam1, Var2.x, 14, iVar0);
					}
					else if (Var2.y != -1)
					{
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.x != 0 && Var2.x != -1) && Var2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_234(Var2.z)] = Var2.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_234(Var2.z)] = func_227(iParam1, Var2.x, func_234(Var2.z), iVar0);
					}
				}
				else if (Var2.y != -1)
				{
					(*uParam0)[func_234(Var2.z)] = Var2.y;
				}
			}
			iVar4++;
		}
...
void func_259(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_253(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_253(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
	...
	if (func_24(Local_68.f_9))
	{
		...
		switch (iLocal_60)
		{
			case 0:
				...
				Local_337 = { ENTITY::GET_ENTITY_COORDS(Local_68.f_9, 0) };
...
int func_380(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_191(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
			...
			case 1:
				if (!iLocal_108)
				{
					...
					else
					{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_112(PLAYER::PLAYER_PED_ID(), Local_328, 6.5f))
							{
								iLocal_60 = 2;
							}
						}
						else if (func_112(PLAYER::PLAYER_PED_ID(), Local_328, 2.5f))
						{
							iLocal_60 = 2;
						}
					}
...
{
	return func_489(&(Global_105187.f_2890), Param0, fParam1, 0);
}
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_175(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
