...
int func_26(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2552060[iParam0 /*3*/][func_27(iParam1)];
	...
	while (iVar0 < 32)
	{
		...
		if (func_3(iVar1, 1, 1))
		{
			if (!func_48(iVar1, 0) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
			{
				...
				{
					if ((func_47(iVar1) || !bParam10) && !Global_2426097[iVar1 /*443*/].f_263)
					{
						fVar2 = fParam6;
						if (fParam9 > 0f)
						{
...
void func_75()
{
	...
	{
		iLocal_188 = unk_0x67D02A194A2FC2BD("instructional_buttons");
	}
}
...
void func_98(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2552060[iParam0 /*3*/][func_27(iParam2)];
	if (iVar0 != 0)
	{
