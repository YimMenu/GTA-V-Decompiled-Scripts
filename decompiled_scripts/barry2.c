...
void func_32()
{
	if (bLocal_210)
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_186[0], Local_186[1], Local_186.f_7, 0, 1, 0))
		{
	...
	else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_194[0], Local_194[1], Local_194.f_7, 0, 1, 0))
	{
		func_36("B2_PRIME", 7500, 1);
		func_35(&uLocal_212);
		bLocal_210 = true;
	}
	else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_178[0], Local_178[1], Local_178.f_7, 0, 1, 0))
	{
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_157)
			{
				if (iParam0 == 1)
				{
					...
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_173, 200f, 0, 0, 0, 0, 0, 0);
...
int func_42(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8)
{
	...
	while (func_46(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_46(iVar2, iVar8)))
			{
				...
				{
					uVar9 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_46(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_46(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_46(iVar2, iVar8)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_46(iVar2, iVar8));
	...
	if (func_62(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 < Local_346)
		{
			if (func_78(&(Local_346[iVar0])))
			{
				...
				AI::TASK_SMART_FLEE_COORD(Local_346[iVar0].f_3, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
			}
			iVar0++;
		}
	}
...
void func_81(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_309(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				if (func_50(PLAYER::PLAYER_PED_ID()))
				{
					PED::RESET_PED_VISIBLE_DAMAGE(PLAYER::PLAYER_PED_ID());
				...
				func_303();
				iLocal_345 = 0;
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_173, 250f, 0, 0, 0, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_PEDS(Local_173, 50f, 0);
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(Local_173, 30f, 0);
				GRAPHICS::REMOVE_DECALS_IN_RANGE(Local_173, 500f);
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_335, 2, func_648(49), 0);
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_337, 2, 974300346, 0);
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_336, 2, 1281480215, 0);
				if (func_62(PLAYER::PLAYER_PED_ID()))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Trevor", 0, -1686040670, 0);
				}
		...
		case 3:
			...
			func_63(1, 1, 1, 1);
			func_294(PLAYER::PLAYER_PED_ID(), Local_173);
...
int func_148(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0][func_147(iParam1)];
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar72)
			{
				if (iVar8 < 51)
				{
					...
					{
						if (!DLC1::_IS_DLC_DATA_EMPTY(Var9) && !func_282(Var9.f_1))
						{
							if (iVar7 == 0)
							{
...
int func_283(int iParam0)
{
	...
	while (iVar0 < DLC1::GET_NUM_DLC_WEAPONS())
	{
		if (DLC1::GET_DLC_WEAPON_DATA(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (DLC1::_IS_DLC_DATA_EMPTY(Var1) || func_282(Var1.f_1))
				{
					return 0;
				}
			}
...
void func_289(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		...
		{
			case 0:
				STATS::STAT_SET_INT(-1142440288, uParam0->f_2244[iVar0][0], 1);
				STATS::STAT_SET_INT(-1123368730, uParam0->f_2244[iVar0][1], 1);
				STATS::STAT_SET_INT(1081345962, uParam0->f_2244[iVar0].f_5[0], 1);
				STATS::STAT_SET_INT(-1371118771, uParam0->f_2244[iVar0].f_5[1], 1);
				STATS::STAT_SET_INT(-765547619, uParam0->f_2244[iVar0].f_5[2], 1);
				STATS::STAT_SET_INT(-1080850937, uParam0->f_2244[iVar0].f_5[3], 1);
				STATS::STAT_SET_INT(-2022861412, uParam0->f_2244[iVar0].f_5[4], 1);
				STATS::STAT_SET_INT(-2018548694, uParam0->f_2244[iVar0].f_16[0], 1);
				STATS::STAT_SET_INT(1323790999, uParam0->f_2244[iVar0].f_16[1], 1);
				STATS::STAT_SET_INT(760098661, uParam0->f_2244[iVar0].f_16[2], 1);
				STATS::STAT_SET_INT(-260459075, uParam0->f_2244[iVar0].f_16[3], 1);
				STATS::STAT_SET_INT(1085789752, uParam0->f_2244[iVar0].f_16[4], 1);
				STATS::STAT_SET_INT(334003354, uParam0->f_2244[iVar0].f_16[5], 1);
				STATS::STAT_SET_INT(-500524769, uParam0->f_2244[iVar0].f_16[6], 1);
				STATS::STAT_SET_INT(-1456330957, uParam0->f_2244[iVar0].f_16[7], 1);
				STATS::STAT_SET_INT(-142720058, uParam0->f_2244[iVar0].f_16[8], 1);
				STATS::STAT_SET_INT(-855707956, uParam0->f_2244[iVar0].f_16[9], 1);
				STATS::STAT_SET_INT(-1539506602, uParam0->f_2244[iVar0].f_16[10], 1);
				STATS::STAT_SET_INT(1915755069, uParam0->f_2244[iVar0].f_16[11], 1);
				break;
			
			case 1:
				STATS::STAT_SET_INT(-126492964, uParam0->f_2244[iVar0][0], 1);
				STATS::STAT_SET_INT(190514318, uParam0->f_2244[iVar0][1], 1);
				STATS::STAT_SET_INT(-739329202, uParam0->f_2244[iVar0].f_5[0], 1);
				STATS::STAT_SET_INT(-1185380830, uParam0->f_2244[iVar0].f_5[1], 1);
				STATS::STAT_SET_INT(1030852186, uParam0->f_2244[iVar0].f_5[2], 1);
				STATS::STAT_SET_INT(1801284145, uParam0->f_2244[iVar0].f_5[3], 1);
				STATS::STAT_SET_INT(-1873234909, uParam0->f_2244[iVar0].f_5[4], 1);
				STATS::STAT_SET_INT(-1315299114, uParam0->f_2244[iVar0].f_16[0], 1);
				STATS::STAT_SET_INT(-2073999771, uParam0->f_2244[iVar0].f_16[1], 1);
				STATS::STAT_SET_INT(1865030647, uParam0->f_2244[iVar0].f_16[2], 1);
				STATS::STAT_SET_INT(-419525730, uParam0->f_2244[iVar0].f_16[3], 1);
				STATS::STAT_SET_INT(-121557213, uParam0->f_2244[iVar0].f_16[4], 1);
				STATS::STAT_SET_INT(-1021590567, uParam0->f_2244[iVar0].f_16[5], 1);
				STATS::STAT_SET_INT(-732338604, uParam0->f_2244[iVar0].f_16[6], 1);
				STATS::STAT_SET_INT(758650912, uParam0->f_2244[iVar0].f_16[7], 1);
				STATS::STAT_SET_INT(1090437037, uParam0->f_2244[iVar0].f_16[8], 1);
				STATS::STAT_SET_INT(164057391, uParam0->f_2244[iVar0].f_16[9], 1);
				STATS::STAT_SET_INT(1607797744, uParam0->f_2244[iVar0].f_16[10], 1);
				STATS::STAT_SET_INT(-1852248201, uParam0->f_2244[iVar0].f_16[11], 1);
				break;
			
			case 2:
				STATS::STAT_SET_INT(177632919, uParam0->f_2244[iVar0][0], 1);
				STATS::STAT_SET_INT(-464115177, uParam0->f_2244[iVar0][1], 1);
				STATS::STAT_SET_INT(111865610, uParam0->f_2244[iVar0].f_5[0], 1);
				STATS::STAT_SET_INT(-194950537, uParam0->f_2244[iVar0].f_5[1], 1);
				STATS::STAT_SET_INT(-378588013, uParam0->f_2244[iVar0].f_5[2], 1);
				STATS::STAT_SET_INT(-626223346, uParam0->f_2244[iVar0].f_5[3], 1);
				STATS::STAT_SET_INT(-848331628, uParam0->f_2244[iVar0].f_5[4], 1);
				STATS::STAT_SET_INT(226994293, uParam0->f_2244[iVar0].f_16[0], 1);
				STATS::STAT_SET_INT(-1921832882, uParam0->f_2244[iVar0].f_16[1], 1);
				STATS::STAT_SET_INT(1934357500, uParam0->f_2244[iVar0].f_16[2], 1);
				STATS::STAT_SET_INT(1106022718, uParam0->f_2244[iVar0].f_16[3], 1);
				STATS::STAT_SET_INT(1478409634, uParam0->f_2244[iVar0].f_16[4], 1);
				STATS::STAT_SET_INT(-863918486, uParam0->f_2244[iVar0].f_16[5], 1);
				STATS::STAT_SET_INT(-1699495217, uParam0->f_2244[iVar0].f_16[6], 1);
				STATS::STAT_SET_INT(-1327567067, uParam0->f_2244[iVar0].f_16[7], 1);
				STATS::STAT_SET_INT(2133068720, uParam0->f_2244[iVar0].f_16[8], 1);
				STATS::STAT_SET_INT(-7828357, uParam0->f_2244[iVar0].f_16[9], 1);
				STATS::STAT_SET_INT(-4568869, uParam0->f_2244[iVar0].f_16[10], 1);
				STATS::STAT_SET_INT(-225202546, uParam0->f_2244[iVar0].f_16[11], 1);
				break;
		}
		iVar0++;
	}
...
void func_300(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_301(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_309(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_314(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
{
	func_320(&Global_105187, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_320(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	*uParam0 = func_14();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_342())
		{
			func_338(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_332(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_351(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_87() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_148(func_352(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_354(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_369(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Param0, func_355(iVar0, 0), 1);
...
var func_371()
{
	...
	func_374(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_373(&uVar0, TIME::GET_CLOCK_MONTH());
	func_372(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
	...
	if (!*bParam0)
	{
		if (iLocal_582 == 1)
		{
			...
			if (iVar0 != -1)
			{
				...
				Local_346[iVar0].f_11 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_601, (iLocal_601 + iLocal_600)));
				PED::REMOVE_PED_DEFENSIVE_AREA(Local_346[iVar0].f_3, 0);
			}
			*bParam0 = 1;
		}
	}
...
float func_400(var uParam0)
{
	if (func_403(uParam0))
	{
		...
		{
			return (func_401(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_401(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
void func_407()
{
	...
	while (iVar0 < Local_346)
	{
		...
		{
			iLocal_585 = 1;
			Local_587 = { Local_346[iVar0].f_16 };
...
int func_408(var uParam0, struct<3> Param1, int iParam4, bool bParam5, bool bParam6)
{
	if (iLocal_159 != 9)
	{
		if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Param1, &uVar1, 0, 0))
		{
			Param1.z = uVar1;
		}
		if (Param1.z < 28f)
	...
	if (!bParam6)
	{
		if (!bParam5)
		{
			...
			if (iVar0 == 0)
			{
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_3, 736523883, -1, 1, 1);
			}
			else
			{
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_3, 453432689, -1, 1, 1);
			}
		}
		else
		{
...
void func_409(var uParam0, var uParam1, bool bParam2)
{
	...
	PED::SET_PED_COMBAT_ATTRIBUTES(uParam0, 13, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < uParam1->f_20);
	PED::SET_PED_COMBAT_ATTRIBUTES(uParam0, 42, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < uParam1->f_8);
	PED::SET_PED_COMBAT_ATTRIBUTES(uParam0, 11, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < uParam1->f_9);
	if (uParam1->f_19 != -1)
	{
		iVar0 = uParam1->f_19;
	}
...
{
	fVar0 = func_413(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
...
void func_419(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < iParam1)
	{
		if (func_423(&iVar1))
		{
			Var3 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_1, uParam0->f_4, Local_818[iVar0]) };
			if (bParam2)
			{
			...
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_811, "CROWD_WATCHING", Local_834[iVar1], 0, 0, 0);
			}
...
{
	if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Local_834[iParam0].f_2, &uVar0, 0, 0))
	{
	...
	Local_834[iParam0] = PED::CREATE_PED(26, Local_834[iParam0].f_1, Local_834[iParam0].f_2, Local_834[iParam0].f_5, 1, 1);
	if (!ENTITY::DOES_ENTITY_EXIST(Local_834[iParam0]))
	{
		return 0;
	}
	PED::_0x733C87D4CE22BEA2(Local_834[iParam0]);
	AUDIO::STOP_PED_SPEAKING(Local_834[iParam0], 1);
	PED::SET_PED_DIES_WHEN_INJURED(Local_834[iParam0], 1);
	PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_834[iParam0], 1);
	PED::SET_PED_MONEY(Local_834[iParam0], 0);
	ENTITY::SET_ENTITY_HEALTH(Local_834[iParam0], 100, 0);
	...
	while (iVar0 < 15)
	{
		if (Local_894[iVar0] == iParam0)
		{
			if (Local_894[iVar0].f_6 == bParam2)
			{
				if (iVar1 < Local_1000)
				{
					if (!PED::IS_ANY_PED_NEAR_POINT(Local_894[iVar0].f_1, 7f))
					{
...
int func_427()
{
	...
	while (iVar0 < Local_834)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_834[iVar0]))
		{
			if (!PED::IS_PED_INJURED(Local_834[iVar0]))
			{
				iVar1++;
			}
		}
...
{
	GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Param1, 5f, 0, 0, 0, 0, 0, 0);
	if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Param1 + Vector(0.23f, 0f, 0f), &fVar0, 0, 0))
	{
		Param1.z = fVar0;
	}
...
void func_431(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 2:
			if (iLocal_582 > 1)
			{
				if (func_428(&uLocal_1108, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(9f, 12f)))
				{
					func_418(1, 5, 5, 0);
				}
			}
...
int func_453()
{
	...
	switch (iLocal_890)
	{
		...
		case 1:
			if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_346[iLocal_805].f_3))
			{
...
void func_455()
{
	if (func_62(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (WEAPON::DOES_WEAPON_TAKE_WEAPON_COMPONENT(iLocal_548, -2034401422))
		{
			WEAPON::GIVE_WEAPON_COMPONENT_TO_PED(PLAYER::PLAYER_PED_ID(), iLocal_548, -2034401422);
		}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_459(iParam3), 0);
}
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_309(1, 1093140480, 0))
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_96.f_41[0], sLocal_337, 2, 974300346, 0);
				}
				if (func_62(Local_96.f_41[1]))
				{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_96.f_41[1], sLocal_336, 2, 1281480215, 0);
				}
...
void func_483()
{
	...
	if (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0))
	{
		...
		fLocal_168 = 206.45f;
		func_514(Local_202[0], Local_202[1], Local_202.f_7, Local_165, fLocal_168, 0f, 0f, 0f, 1, 0, 1, 0, 0);
		func_487(Local_165, fLocal_168, 0, 145);
	}
	else
	{
		func_514(Local_202[0], Local_202[1], Local_202.f_7, Local_165, fLocal_168, func_486(), 1, 0, 1, 0, 0);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_513(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_510(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_336(iParam0, 0, 0)) || func_336(iParam0, 1, 0)) || func_336(iParam0, 2, 0)) || func_327(iParam0) != 145) || func_504(iParam0)) || func_503(iParam0)) || func_502(iParam0)) || func_501(iParam0)) || !func_492(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_503(iParam0))
		{
		}
...
int func_517(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_518(Var18[0], Var18[1], Var6, Var9) || func_518(Var18[0], Var18[1], Var9, Var15)) || func_518(Var18[0], Var18[1], Var12, Var15)) || func_518(Var18[0], Var18[1], Var6, Var12)) || func_518(Var18[1], Var18[3], Var6, Var9)) || func_518(Var18[1], Var18[3], Var9, Var15)) || func_518(Var18[1], Var18[3], Var12, Var15)) || func_518(Var18[1], Var18[3], Var6, Var12)) || func_518(Var18[3], Var18[2], Var6, Var9)) || func_518(Var18[3], Var18[2], Var9, Var15)) || func_518(Var18[3], Var18[2], Var12, Var15)) || func_518(Var18[3], Var18[2], Var6, Var12)) || func_518(Var18[2], Var18[0], Var6, Var9)) || func_518(Var18[2], Var18[0], Var9, Var15)) || func_518(Var18[2], Var18[0], Var12, Var15)) || func_518(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
void func_524(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 2:
			if (func_62(Local_96.f_28[0]))
			{
				if (!func_29() || GAMEPLAY::GET_GAME_TIMER() > iLocal_595)
				{
					if (func_62(PLAYER::PLAYER_PED_ID()))
					{
...
void func_528()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_314(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_529()
{
	...
	if (func_408(&(Local_346[iVar0]), Var1, 0, 0, 0))
	{
		if (iLocal_159 == 9)
		{
...
int func_530(var uParam0)
{
	...
	if (iLocal_159 != 9)
	{
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Var0, Local_169, 1) > fLocal_172)
		{
			return 0;
		}
	}
	if (func_532(PLAYER::PLAYER_PED_ID(), Var0, 1) < fLocal_575)
	{
		return 0;
	}
	if (bLocal_596)
	{
		if (func_531(Var0, fVar4, PLAYER::PLAYER_PED_ID(), 1))
		{
			return 0;
		}
	}
...
{
	return GAMEPLAY::IS_POSITION_OCCUPIED(Param0, fParam3, 0, 0, 1, 0, 0, uParam4, iParam5);
}
...
Vector3 func_533(struct<3> Param0, float fParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	Var0 = { func_534(Var0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) };
...
int func_536(var uParam0)
{
	...
	if (uParam0->f_9 == 0)
	{
		if (func_546(uParam0->f_3, PLAYER::PLAYER_PED_ID(), 1) < fLocal_581 || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_3, PLAYER::PLAYER_PED_ID(), 1))
		{
	...
	if (bLocal_213)
	{
		if (uParam0->f_9 == 0)
		{
			func_545(ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1), fLocal_581, 255, 0, 0, 255, 32);
		}
		else
		{
			func_545(ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1), fLocal_581, 0, 0, 255, 255, 32);
		}
	}
	switch (uParam0->f_2)
	{
		...
		case 10:
			...
			if (func_414(&iVar0))
			{
				...
				if (func_541(&(Local_346[uParam0->f_14]), uParam0->f_3, 1))
				{
					...
					AI::CLEAR_PED_TASKS(Local_346[uParam0->f_14].f_3);
					...
					AI::TASK_PERFORM_SEQUENCE(Local_346[uParam0->f_14].f_3, uVar2);
		...
		case 11:
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(Local_346[uParam0->f_14].f_3, 242628503) == 7)
				{
					...
					AI::TASK_PERFORM_SEQUENCE(Local_346[uParam0->f_14].f_3, uVar7);
		...
		case 12:
			...
			if (func_414(&iVar0))
			{
				if (func_541(&(Local_346[iVar0]), uParam0->f_3, 0))
				{
					...
					uParam0->f_10++;
					uParam0->f_5 = 0f;
					ENTITY::SET_ENTITY_VISIBLE(Local_346[iVar0].f_3, 0, 0);
					Var8 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_3, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-2.5f, 2.5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-6.5f, -10f), -0.7f) };
					AI::OPEN_SEQUENCE_TASK(&uVar11);
					AI::TASK_SWAP_WEAPON(0, 1);
					AI::TASK_LEAVE_VEHICLE(0, uParam0->f_3, 256);
					AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Var8, PLAYER::PLAYER_PED_ID(), 1f, 1, 1.5f, 2f, 1, 0, 0, -957453492, 20000);
					AI::CLOSE_SEQUENCE_TASK(uVar11);
					AI::TASK_PERFORM_SEQUENCE(Local_346[iVar0].f_3, uVar11);
...
int func_538(struct<3> Param0, float fParam3)
{
	...
	while (iVar0 < Local_346)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_346[iVar0].f_3))
		{
			if (func_532(Local_346[iVar0].f_3, Param0, 1) < fParam3)
			{
				return 1;
			}
		}
...
void func_551(var uParam0)
{
	...
	if (!func_562(uParam0))
	{
		if ((ENTITY::IS_ENTITY_DEAD(uParam0->f_3, 0) || PED::IS_PED_INJURED(uParam0->f_3)) || PED::IS_PED_DEAD_OR_DYING(uParam0->f_3, 0))
		{
			...
			func_561("CLOWN_DEATH", "CLOWNS", ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1), 10);
			uParam0->f_2 = 15;
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_3, 0))
			{
				PED::EXPLODE_PED_HEAD(uParam0->f_3, 100416529);
			}
	...
	switch (uParam0->f_2)
	{
		...
		case 12:
			...
			if (func_560(uParam0) == 4 && AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) <= 1)
			{
				return;
			}
...
int func_553(var uParam0, char* sParam1, float fParam2, float fParam3, int iParam4)
{
	if (ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_3, sParam1, &(uParam0->f_7), 3))
	{
		if (!*iParam4)
		{
			if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uParam0->f_3, sParam1, &(uParam0->f_7)) >= fParam2 && !WEAPON::HAS_PED_GOT_WEAPON(uParam0->f_3, 736523883, 0))
			{
		...
		{
			if (!WEAPON::HAS_PED_GOT_WEAPON(uParam0->f_3, 736523883, 0))
			{
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_3, 736523883, -1, 1, 1);
			}
			*iParam4 = 0;
...
int func_558(int iParam0, var uParam1, float fParam2)
{
	...
	*uParam1 = 0;
	...
	while (iVar0 <= (Local_834 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_834[iVar0]))
		{
			if (!ENTITY::IS_ENTITY_DEAD(Local_834[iVar0], 0))
			{
				if (!PED::IS_PED_INJURED(Local_834[iVar0]) && !PED::IS_PED_DEAD_OR_DYING(Local_834[iVar0], 1))
				{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_AT_COORDS(sParam0, sParam1, Param2, func_459(iParam5));
}
...
void func_564(int iParam0)
{
	...
	if (ENTITY::IS_ENTITY_DEAD(Local_834[iParam0], 0) || PED::IS_PED_DEAD_OR_DYING(Local_834[iParam0], 1))
	{
		if (Local_834[iParam0].f_6 < 5)
		{
			if (WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(Local_834[iParam0], iLocal_548, 0))
			{
			}
			func_75(&iLocal_811);
			Local_834[iParam0].f_8 = GAMEPLAY::GET_GAME_TIMER() + 500;
	...
	{
		case 0:
			Local_834[iParam0].f_9 = (Local_834[iParam0].f_9 + (GAMEPLAY::GET_FRAME_TIME() * 512f));
			if (Local_834[iParam0].f_9 < 2f)
			{
				ENTITY::SET_ENTITY_VISIBLE(Local_834[iParam0], 0, 0);
			}
			else
			{
				ENTITY::SET_ENTITY_VISIBLE(Local_834[iParam0], 1, 0);
				if (Local_834[iParam0].f_9 > 255f)
				{
					Local_834[iParam0].f_9 = 255f;
					ENTITY::RESET_ENTITY_ALPHA(Local_834[iParam0]);
					Local_834[iParam0].f_6 = 1;
				}
				else if (ENTITY::IS_ENTITY_ON_SCREEN(Local_834[iParam0]))
				{
					func_552(Local_834[iParam0], SYSTEM::FLOOR(Local_834[iParam0].f_9), &iLocal_810);
				}
				else
				{
					ENTITY::RESET_ENTITY_ALPHA(Local_834[iParam0]);
		...
		case 1:
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(Local_834[iParam0]))
			{
		...
		case 2:
			if (func_62(PLAYER::PLAYER_PED_ID()))
			{
				if (func_62(Local_834[iParam0]))
				{
					...
					AI::TASK_SMART_FLEE_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_834[iParam0], Var0), 200f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uVar3);
					AI::CLEAR_PED_TASKS(Local_834[iParam0]);
					AI::TASK_PERFORM_SEQUENCE(Local_834[iParam0], uVar3);
		...
		case 3:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_834[iParam0], Local_178[0], Local_178[1], Local_178.f_7, 0, 1, 0))
			{
				Local_834[iParam0].f_8 = GAMEPLAY::GET_GAME_TIMER() + 500;
				Local_834[iParam0].f_6 = 4;
			}
		...
		case 4:
			PED::EXPLODE_PED_HEAD(Local_834[iParam0], 100416529);
			PED::APPLY_DAMAGE_TO_PED(Local_834[iParam0], 1000, 1, 0);
			Local_834[iParam0].f_8 = GAMEPLAY::GET_GAME_TIMER() + 500;
			Local_834[iParam0].f_6 = 5;
			break;
		
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() > Local_834[iParam0].f_8)
			{
				if (ENTITY::IS_ENTITY_DEAD(Local_834[iParam0], 0) || PED::IS_PED_INJURED(Local_834[iParam0]))
				{
					Local_834[iParam0].f_8 = GAMEPLAY::GET_GAME_TIMER() + 500;
					Local_834[iParam0].f_9 = 255f;
		...
		case 6:
			if (GAMEPLAY::GET_GAME_TIMER() > Local_834[iParam0].f_8)
			{
				Local_834[iParam0].f_9 = (Local_834[iParam0].f_9 - (GAMEPLAY::GET_FRAME_TIME() * 1024f));
				if (Local_834[iParam0].f_9 < 0f)
				{
					Local_834[iParam0].f_9 = 0f;
				}
				func_552(Local_834[iParam0], SYSTEM::FLOOR(Local_834[iParam0].f_9), &iLocal_810);
				if (Local_834[iParam0].f_9 <= 0f || !ENTITY::IS_ENTITY_ON_SCREEN(Local_834[iParam0]))
				{
					Local_834[iParam0].f_7 = 0;
...
void func_565(int iParam0)
{
	...
	{
		if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_834[iParam0], sLocal_814, sLocal_815, 3))
		{
			AI::TASK_PLAY_ANIM(Local_834[iParam0], sLocal_814, sLocal_815, 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.5f), 0, 0, 0);
		}
	}
	else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_834[iParam0], sLocal_812, sLocal_813, 3))
	{
		AI::TASK_PLAY_ANIM(Local_834[iParam0], sLocal_812, sLocal_813, 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.5f), 0, 0, 0);
	}
}
...
int func_566(int iParam0)
{
	...
	Var0 = { ENTITY::GET_ENTITY_COORDS(Local_834[iParam0], 0) };
	if (Local_834[iParam0].f_10)
	{
		return 1;
	}
	if (GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(Var0, (5f - 1f), 1, 1))
	{
		return 1;
	}
	iVar3 = 0;
	while (iVar3 < Local_834)
	{
		if (iVar3 != iParam0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_834[iVar3]))
			{
				if (PED::IS_PED_DEAD_OR_DYING(Local_834[iVar3], 1) || PED::IS_PED_INJURED(Local_834[iVar3]))
				{
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Var0, ENTITY::GET_ENTITY_COORDS(Local_834[iVar3], 0), 0) < 20f)
					{
						return 1;
					}
				}
...
void func_615()
{
	Local_818[0] = { 0f, 2f, 0f };
	Local_818[1] = { -1f, 1.75f, 0f };
	Local_818[2] = { 1.25f, 1.75f, 0f };
	Local_818[3] = { 2f, 2.25f, 0f };
	Local_818[4] = { -2.25f, 2.5f, 0f };
}
...
{
	Var0 = 2;
	Var8 = { func_519(Param0[1] - Param0[0]) * Vector(fParam8, fParam8, fParam8) };
