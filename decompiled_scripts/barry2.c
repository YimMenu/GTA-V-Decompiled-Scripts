		...
		case 5:
			if (MISC::GET_GAME_TIMER() > iLocal_157)
			{
				if (iParam0 == 1)
				{
					...
					MISC::CLEAR_AREA_OF_VEHICLES(Local_173, 200f, 0, 0, 0, 0, 0, 0);
	...
	if (func_62(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 < Local_346)
		{
			if (func_78(&(Local_346[iVar0])))
			{
				...
				TASK::TASK_SMART_FLEE_COORD(Local_346[iVar0].f_3, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
			}
			iVar0++;
		}
	}
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_309(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				...
				func_303();
				iLocal_345 = 0;
				MISC::CLEAR_AREA_OF_VEHICLES(Local_173, 250f, 0, 0, 0, 0, 0, 0);
...
void func_279(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	if (iVar0 != 0)
	{
		WEAPON::_SET_PED_WEAPON_LIVERY_COLOR(iParam0, iParam1, iVar0, uParam3);
	}
}
...
void func_344(int iParam0, var uParam1)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::_GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_282(Var11.f_1)) && iVar72 < 51)
			{
	...
	if (!*bParam0)
	{
		if (iLocal_582 == 1)
		{
			...
			if (iVar0 != -1)
			{
				...
				Local_346[iVar0].f_11 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_601, (iLocal_601 + iLocal_600)));
...
float func_400(var uParam0)
{
	if (func_403(uParam0))
	{
		...
		{
			return (func_401(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_401(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
{
	if (MISC::GET_GROUND_Z_FOR_3D_COORD(Local_834[iParam0].f_2, &uVar0, 0, 0))
	{
...
{
	MISC::CLEAR_AREA_OF_VEHICLES(Param1, 5f, 0, 0, 0, 0, 0, 0);
...
void func_431(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 2:
			if (iLocal_582 > 1)
			{
				if (func_428(&uLocal_1108, MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 12f)))
				{
					func_418(1, 5, 5, 0);
				}
			}
...
Vector3 func_533(struct<3> Param0, float fParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	Var0 = { func_534(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) };
...
int func_536(var uParam0)
{
	...
	switch (uParam0->f_2)
	{
		...
		case 10:
			...
			if (func_414(&iVar0))
			{
				...
				if (func_541(&(Local_346[uParam0->f_14]), uParam0->f_3, 1))
				{
					...
					TASK::CLEAR_PED_TASKS(Local_346[uParam0->f_14].f_3);
					...
					TASK::TASK_PERFORM_SEQUENCE(Local_346[uParam0->f_14].f_3, uVar2);
		...
		case 11:
			...
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(Local_346[uParam0->f_14].f_3, 242628503) == 7)
				{
					TASK::OPEN_SEQUENCE_TASK(&uVar7);
					TASK::TASK_LEAVE_VEHICLE(0, uParam0->f_3, 0);
					TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
					TASK::CLOSE_SEQUENCE_TASK(uVar7);
					TASK::TASK_PERFORM_SEQUENCE(Local_346[uParam0->f_14].f_3, uVar7);
		...
		case 12:
			...
			if (func_414(&iVar0))
			{
				if (func_541(&(Local_346[iVar0]), uParam0->f_3, 0))
				{
					...
					TASK::TASK_PERFORM_SEQUENCE(Local_346[iVar0].f_3, uVar11);
...
void func_564(int iParam0)
{
	...
	if (ENTITY::IS_ENTITY_DEAD(Local_834[iParam0], 0) || PED::IS_PED_DEAD_OR_DYING(Local_834[iParam0], 1))
	{
		if (Local_834[iParam0].f_6 < 5)
		{
			...
			func_75(&iLocal_811);
			Local_834[iParam0].f_8 = MISC::GET_GAME_TIMER() + 500;
	...
	{
		case 0:
			Local_834[iParam0].f_9 = (Local_834[iParam0].f_9 + (MISC::GET_FRAME_TIME() * 512f));
		...
		case 2:
			if (func_62(PLAYER::PLAYER_PED_ID()))
			{
				if (func_62(Local_834[iParam0]))
				{
					...
					TASK::TASK_SMART_FLEE_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_834[iParam0], Var0), 200f, -1, 0, 0);
					TASK::CLOSE_SEQUENCE_TASK(uVar3);
					TASK::CLEAR_PED_TASKS(Local_834[iParam0]);
					TASK::TASK_PERFORM_SEQUENCE(Local_834[iParam0], uVar3);
		...
		case 5:
			if (MISC::GET_GAME_TIMER() > Local_834[iParam0].f_8)
			{
		...
		case 6:
			if (MISC::GET_GAME_TIMER() > Local_834[iParam0].f_8)
			{
				Local_834[iParam0].f_9 = (Local_834[iParam0].f_9 - (MISC::GET_FRAME_TIME() * 1024f));
...
void func_565(int iParam0)
{
	if (Local_834[iParam0].f_1 == iLocal_808)
	{
		...
		{
			TASK::TASK_PLAY_ANIM(Local_834[iParam0], sLocal_814, sLocal_815, 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.5f), 0, 0, 0);
		}
	}
	else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_834[iParam0], sLocal_812, sLocal_813, 3))
	{
		TASK::TASK_PLAY_ANIM(Local_834[iParam0], sLocal_812, sLocal_813, 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.5f), 0, 0, 0);
	}
}
	...
	while (iVar3 < Local_834)
	{
		if (iVar3 != iParam0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_834[iVar3]))
			{
				...
				{
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(Var0, ENTITY::GET_ENTITY_COORDS(Local_834[iVar3], 0), 0) < 20f)
					{
						return 1;
					}
				}
