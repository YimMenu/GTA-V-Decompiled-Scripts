...
int func_2()
{
	...
	while (iVar0 < iLocal_237)
	{
		...
		{
			Var5 = { ENTITY::GET_ENTITY_COORDS(iLocal_237[iVar0], 1) };
...
void func_26(int iParam0, int iParam1)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &cLocal_345, &(Local_394[iParam1]), 2))
				{
					fVar0 = -1f;
					fVar1 = -1f;
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_345, &(Local_394[iParam1]), "WalkInterruptible", &fVar0, &fVar1) || func_35(&cLocal_345, &(Local_394[iParam1]), "WalkInterruptible", &fVar0, &fVar1))
					{
				...
				else
				{
					...
					else
					{
						...
						Local_284[iParam1] = { Local_277[iParam1] };
			...
			case 10:
				...
				PED::SET_PED_RESET_FLAG(iLocal_237[iParam1], 249, 1);
				PED::SET_PED_RESET_FLAG(iLocal_237[iParam1], 335, 1);
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_237[iParam1], &cLocal_345, &(Local_427[iParam1]), 2))
				{
					if (iLocal_70 == 288)
					{
						if (iLocal_731 <= 0)
			...
			case 12:
				...
				PED::SET_PED_RESET_FLAG(iLocal_237[iParam1], 249, 1);
				PED::SET_PED_RESET_FLAG(iLocal_237[iParam1], 335, 1);
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_237[iParam1], &cLocal_345, &(Local_493[iParam1]), 2))
				{
					if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_724))
					{
						iLocal_724 = PED::CREATE_SYNCHRONIZED_SCENE(Local_273, 0f, 0f, fLocal_276, 2);
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_34(iParam3), 0);
}
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96074))
		{
			...
			while (iVar0 < iLocal_237)
			{
				if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
				{
					...
					fVar6 = -1f;
					fVar7 = -1f;
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_345, &(Local_394[iVar0]), "WalkInterruptible", &fVar6, &fVar7) || func_35(&cLocal_345, &(Local_394[iVar0]), "WalkInterruptible", &fVar6, &fVar7))
					{
						fVar1 = -8f;
						iVar2 = 2;
						iVar3 = 0;
...
void func_47()
{
	...
	while (iVar0 < iLocal_237)
	{
		if (iLocal_243[iVar0] != 0)
		{
			iLocal_237[iVar0] = PED::CREATE_PED(26, iLocal_243[iVar0], Local_273 + Local_277[iVar0], 0, 1, 1);
...
void func_48()
{
	...
	switch (iLocal_70)
	{
		...
		case 235:
			...
			Local_277[0] = { -1.5421f, 0.8274f, -1.0288f };
			Local_277[1] = { -0.9636f, 1.1757f, -1.0243f };
			Local_284[0] = { 0f, 0f, 0f };
			Local_284[1] = { 0f, 0f, 0f };
			fLocal_291[0] = -130f;
			fLocal_291[1] = -130f;
			fLocal_294[0] = 0f;
			fLocal_294[1] = 0f;
		...
		case 247:
			...
			Local_277[0] = { -0.3866f, 0.1726f, 1f };
			Local_277[1] = { -0.0726f, -0.4742f, 1f };
			Local_284[0] = { Vector(1.5806f, -1719.606f, -1291.475f) - Local_273 };
			Local_284[1] = { Local_284[0] };
			fLocal_291[0] = 0f;
			fLocal_291[1] = 0f;
			fLocal_294[0] = 20f;
			...
			Local_259[0] = { 0f, 0f, -1f };
			Local_266[0] = { 0f, 0f, 2.16f };
			iLocal_256[1] = 1280564504;
			Local_259[1] = { 0f, 0f, -1f };
			Local_266[1] = { 0f, 0f, -4.32f };
			break;
		...
		case 286:
			...
			StringCopy(&(Local_427[0]), "", 64);
			Local_277[0] = { 4.261f, -2.388f, 0.5f };
			Local_284[0] = { 10.5918f, -34.5146f, 0f };
