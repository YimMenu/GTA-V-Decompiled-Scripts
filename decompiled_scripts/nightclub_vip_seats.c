...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		uVar0 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_169.f_1);
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_169.f_4)
	{
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			uVar33 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_169.f_1);
		...
		case 8:
			uVar34 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_169.f_1);
...
{
	Var0 = { uParam0[uParam0->f_169.f_2]->f_8.f_3 };
...
int func_56(var uParam0)
{
	...
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			{
				if (func_63(PLAYER::GET_PLAYER_PED(iVar1), uParam0[uParam0->f_169.f_2]) || func_58(iVar1) == uParam0->f_169.f_2)
				{
					return 1;
				}
			}
...
int func_57(var uParam0)
{
	...
	while (iVar11 < 10)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar11]) && !PED::IS_PED_INJURED(uVar0[iVar11])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar11])) && (func_63(uVar0[iVar11], uParam0[uParam0->f_169.f_2]) || SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uVar0[iVar11], 0), uParam0[uParam0->f_169.f_2]->f_1 + uParam0[uParam0->f_169.f_2]->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar11++;
...
int func_86()
{
	if (Global_2425662[PLAYER::PLAYER_ID()].f_310.f_8 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("nightclub_vip_seats", Global_2425662[PLAYER::PLAYER_ID()].f_310.f_8, 1, 0))
		{
			return 0;
		}
