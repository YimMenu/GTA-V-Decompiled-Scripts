void __EntryFunction__()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < Global_31031 + 10000 && !func_106())
	{
		func_113(0);
	}
	...
	while (iVar0 == 1)
	{
		...
		if (((func_108() || GAMEPLAY::GET_MISSION_FLAG()) || func_107()) || !func_109())
		{
			if (!func_89() && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-892862129) == 0)
			{
				if (func_108())
				{
				}
		...
		if (((((((((((((iLocal_250 == 0 || iLocal_250 == 1) || iLocal_250 == 3) || iLocal_250 == 8) || iLocal_250 == 9) || iLocal_250 == 7) && func_84(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_436 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar30 == 0) && bLocal_439 == 1) && !Global_3) && func_7()) && bVar81)
		{
			...
			if (func_4(iLocal_298, 1))
			{
				...
				iLocal_250 = 13;
				iVar29 = 0;
				iVar82 = func_78(GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()));
				if (func_77(iVar82))
				{
					if (!func_76(iVar82))
					{
						func_67(GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()), 0);
					}
				}
				func_2(&iLocal_298);
			}
...
void func_104()
{
	...
	PED::SET_PED_PROP_INDEX(uLocal_240, 0, 0, 0, 0);
	uLocal_448 = OBJECT::CREATE_OBJECT(-1202268978, ENTITY::GET_ENTITY_COORDS(uLocal_240, 1), 1, 1, 0);
