...
{
	if (MISC::IS_BIT_SET(Global_31504, iParam0))
	{
		if (!bParam1)
		{
			MISC::CLEAR_BIT(&Global_31504, iParam0);
...
{
	func_27(&Global_105842, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_54(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2592627[iParam0 /*3*/][func_52(iParam1)];
...
{
	MISC::SET_BIT(&Global_31504, iParam0);
	StringCopy(&(Global_31505[iParam0 /*6*/]), SCRIPT::GET_THIS_SCRIPT_NAME(), 24);
...
void func_164(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96701[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96701[iVar0]) == func_36(iParam0, iParam1))
				{
...
int func_302(int iParam0)
{
	if (iParam0 != func_89())
	{
		...
		else if ((Global_1312902 && iParam0 == PLAYER::PLAYER_ID()) && func_181(iParam0, 1, 0))
		{
			return Global_2426865[iParam0 /*449*/].f_319.f_6 != -1;
		}
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102858.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102858.f_4, false))
		{
			if (func_371(24) != Global_102858.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_368(ENTITY::GET_ENTITY_COORDS(Global_102858.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
