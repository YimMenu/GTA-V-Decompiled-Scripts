...
void func_5()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_15(&Global_2549636))
	{
		if (!func_13(&Global_2549636, 3500, 1) || NETWORK::NETWORK_IS_PLAYER_FADING(PLAYER::PLAYER_ID()))
		{
			if (!func_12())
			{
...
void func_6(int iParam0)
{
	...
	{
		if (!func_13(&(Global_2549641[iParam0 /*2*/]), 3500, 1) || NETWORK::NETWORK_IS_PLAYER_FADING(iParam0))
		{
			if (!func_12())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
...
void func_65(var uParam0)
{
	...
	iVar0 = func_68(uParam0->f_18 == joaat("nimbus"), "Plane_1", "Plane");
	if (CUTSCENE::_0x4FCD976DA686580C(iVar0) != 2)
	{
		return;
	}
	uParam0->f_22 = ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY(iVar0, uParam0->f_18));
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_22))
	{
		return;
	}
...
int func_79(var uParam0)
{
	...
	{
		uParam0->f_21 = PED::_CLONE_PED_EX(func_195(), false, false, true, true);
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_21))
		{
			return 0;
		}
	...
	{
		uParam0->f_21 = PED::_CLONE_PED_EX(func_195(), false, false, false, false);
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_21))
		{
			return 0;
		}
...
int func_86(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2552060[iParam0 /*3*/][func_87(iParam1)];
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 7, -1, false, -1, func_105(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 7, -1, false, -1, func_105(iParam2));
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_113(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_129(Var16.f_2)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_129(Var16.f_2)] = func_113(iParam1, Var16.x, func_129(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
void func_144(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 7, -1, false, -1, func_105(iParam0));
			if (iVar57 > iVar56)
			{
