#region Local Var
	...
	var uLocal_84 = 0;
	struct<4> Local_85[8];
	int iLocal_118[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
	var uLocal_127[1] = { 0 };
	var uLocal_129 = 0;
	struct<4> Local_130 = { 0, 0, 0, 0 } ;
	int iLocal_134 = 0;
...
void __EntryFunction__()
{
	...
	{
		if (func_317(PLAYER::PLAYER_ID(), 0, 1))
		{
			if (!func_313(ScriptParam_0))
			{
				func_306();
			}
		}
...
{
	return MISC::IS_BIT_SET(Global_1630816[iParam0 /*597*/].f_11.f_6, iParam1);
}
...
bool func_12(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	return MISC::IS_BIT_SET(Local_77.f_2[iVar0], iVar1);
}
...
int func_23()
{
	...
	if (!func_294(0))
	{
		if (func_101(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), &Local_130, &(Local_130.f_3)))
		{
			func_100(0);
		}
	}
	...
	{
		MISC::CLEAR_AREA(Local_130, 5f, true, false, false, false);
		if (func_95(&(Local_77.f_6), func_99(), Local_130, Local_130.f_3, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0))
		{
			iVar0 = func_16();
			...
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_99());
			return 1;
		}
	}
	return 0;
...
int func_36(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12074)
	{
		...
		iVar0 = Global_2555716[iParam0 /*3*/][func_37(iParam1)];
...
int func_74(int iParam0, int iParam1, int iParam2)
{
	...
	if ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_75()) && Global_1314058)
	{
...
void func_79(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_89(iVar0 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_89(iVar0 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			iVar1 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_89(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_89(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_89(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_89(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_89(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_89(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (MISC::IS_BIT_SET(uParam1->f_77, func_89(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_89(iVar4));
					}
				}
				iVar4++;
			}
		...
		{
			if (MISC::IS_BIT_SET(uParam1->f_77, func_89(4)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_89(4));
			}
		}
		...
		{
			MISC::SET_BIT(&(uParam1->f_77), func_89(1));
		}
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_89(iVar5 + 1)))
				{
...
int func_95(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	float fVar0;
	int iVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		*uParam0 = NETWORK::VEH_TO_NET(iVar1);
		...
		if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(*uParam0))
		{
			...
			func_96(Param2, fParam5, iParam1, iVar1);
			return 1;
		}
	}
	return 0;
...
void func_96(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (func_97(PLAYER::PLAYER_ID(), Param0, iParam4) > -1)
	{
...
int func_97(int iParam0, struct<3> Param1, int iParam4)
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
void func_100(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	MISC::SET_BIT(&(uLocal_127[iVar0]), iVar1);
}

int func_101(struct<3> Param0, var uParam3, var uParam4)
{
	struct<31> Var0;
	...
	Var0.f_4 = 1000f;
	Var0.f_27 = 1;
	if (func_102(Param0, 0f, 0f, 0f, func_99(), 1, uParam3, uParam4, &Var0))
	{
		return 1;
	}
	return 0;
...
int func_102(struct<3> Param0, struct<3> Param3, int iParam6, int iParam7, var uParam8, var uParam9, var uParam10)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (func_236() && !Global_2405077.f_679 == MISC::GET_FRAME_COUNT())
	{
	...
	if (!SCRIPT::GET_ID_OF_THIS_THREAD() == Global_2405077.f_674)
	{
		if (!Global_2405077.f_675 == 0)
		{
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2405077.f_678) < func_233(0))
			{
				return 0;
			}
			else
	...
	else
	{
		...
		if (!Global_2405077.f_675 == 0)
		{
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2405077.f_678) > func_233(1))
			{
				Global_2405077.f_675 = 0;
			}
		}
	...
	if (Global_2405077.f_675 == 0)
	{
		...
		func_225();
		func_235();
		if (!uParam10->f_27 || (((((((func_224(Param0, 1, 1133903872) && !uParam10->f_28) && !Global_2544210.f_924) && !Global_2544210.f_913) && !Global_2544210.f_921) && !Global_2544210.f_925) && !Global_2544210.f_933) && !Global_2544210.f_945))
		{
			func_205(Param0, iParam6);
		}
		if (func_191(Param0))
		{
			func_205(Param0, iParam6);
	...
	switch (Global_2405077.f_675)
	{
		case 2:
			if (PATHFIND::ARE_NODES_LOADED_FOR_AREA((Param0.x - 100f), (Param0.f_1 - 100f), (Param0.x + 100f), (Param0.f_1 + 100f)))
			{
				...
				if (((uParam10->f_3 && func_185(Param0, fVar2, fVar3, fVar4, 1f, 0, 0, 0, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0)) && !uParam10->f_7) && !func_183(Param0, *uParam9, iParam6, PLAYER::PLAYER_ID(), 0))
				{
					Global_2405077.f_682 = { Param0 };
				...
				func_127(Global_2405077.f_682, Global_2405077.f_685, iParam6, &(Global_2405077.f_672));
			...
			if (Global_2405077.f_670)
			{
				if (Global_2405077.f_672 == Global_2405077.f_673)
				{
					if (Global_2405077.f_671)
					{
						...
						{
							if (func_126(Global_2405077.f_682, Global_2405077.f_685, iParam6, 1, 1036831949))
							{
				...
				if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2405077.f_699) < 10000)
				{
					if (NETWORK::NETWORK_ENTITY_AREA_DOES_EXIST(Global_2405077.f_698))
					{
						if (NETWORK::_0x4DF7CFFF471A7FB1(Global_2405077.f_698))
						{
							...
							{
								if (func_122(Global_2405077.f_682, Global_2405077.f_685, iParam6, PLAYER::PLAYER_ID(), 0) || func_104(Global_2405077.f_682, Global_2405077.f_685, iParam6, 1, 0, 0, 0, 1, 0))
								{
									func_124(Global_2405077.f_682, 0);
									func_123(-1);
								}
		...
		case 5:
			...
			func_129(&(Global_2405077.f_682), &(Global_2405077.f_685), &Var66);
...
int func_104(struct<3> Param0, float fParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar0 < 32)
	{
		...
		{
			if (func_317(iVar1, bParam5, bParam6))
			{
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam8 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_121(iVar1)))
					{
						...
						{
							if (((PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1 && iParam10) && bParam7) && func_116(iVar1))
							{
							}
							else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								...
								if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::GET_PLAYER_PED(iVar1), false))
								{
									...
									if (ENTITY::DOES_ENTITY_EXIST(iVar3) && !ENTITY::IS_ENTITY_DEAD(iVar3, false))
									{
										...
										if (func_115(Param0, fParam3, iParam4, Var5, fVar8, iVar4, 0))
										{
											return 1;
										}
									}
								...
								if (func_105(func_114(iVar1), Param0, fParam3, iParam4, fVar2))
								{
									return 1;
								}
							}
...
int func_105(struct<3> Param0, struct<3> Param3, float fParam6, int iParam7, float fParam8)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	if (SYSTEM::VDIST(Param0, Param3) < func_113(iParam7, 1008981770))
	{
		func_106(Param3, fParam6, iParam7, &Var0, &Var3, &fVar6, fParam8);
...
void func_106(struct<3> Param0, float fParam3, int iParam4, var uParam5, var uParam6, var uParam7, float fParam8)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	Var0 = { 0f, 1f, 0f };
	func_112(&Var0, 0f, 0f, fParam3);
	Var0 = { Var0 / FtoV(SYSTEM::VMAG(Var0)) };
	func_107(iParam4, &Var3, &Var6, 1086324736, 1080033280, 1077936128);
...
float func_113(int iParam0, float fParam1)
{
	...
	func_107(iParam0, &Var0, &Var3, 1086324736, 1080033280, 1077936128);
	Var6 = { Var3 - Var0 };
...
int func_115(struct<3> Param0, float fParam3, int iParam4, struct<3> Param5, float fParam8, int iParam9, int iParam10)
{
	if (func_105(Param0, Param5, fParam8, iParam9, 1036831949))
	{
		return 1;
	}
	func_106(Param0, fParam3, iParam4, &Global_1713901, &(Global_1713901.f_3), &(Global_1713901.f_6), 1036831949);
	func_106(Param5, fParam8, iParam9, &(Global_1713901.f_7), &(Global_1713901.f_10), &(Global_1713901.f_13), 1036831949);
...
int func_120(int iParam0, int iParam1)
{
	...
	{
		Global_2518253 = { func_119(iParam0) };
		Global_2518266 = { func_119(iParam1) };
...
int func_122(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		{
			iVar1 = iVar0;
			if (func_317(iVar1, 0, 1) && func_317(iParam5, 0, 1))
			{
				if (Global_2418033.f_261[iVar0])
				{
					if (func_105(Global_2418033.f_131[iVar0 /*3*/], Param0, fParam3, iParam4, 1036831949))
					{
						return 1;
					}
				}
				else if (func_105(func_114(iVar1), Param0, fParam3, iParam4, 1036831949))
				{
					return 1;
				}
			}
			...
			else if (func_317(iVar1, 0, 0))
			{
				...
				{
					if (func_105(func_114(iVar1), Param0, fParam3, iParam4, 1036831949))
					{
						return 1;
					}
				}
...
void func_124(struct<3> Param0, int iParam3)
{
	...
	if (iParam3 == 0 && func_125(Param0, 0.01f))
	{
		return;
	}
...
int func_126(struct<3> Param0, float fParam3, int iParam4, bool bParam5, float fParam6)
{
	struct<3> Var0;
	struct<3> Var3;
	var uVar6;
	...
	else
	{
		...
		while (iVar7 < 3)
		{
			...
			{
				func_106(Param0, fParam3, iParam4, &Var0, &Var3, &uVar6, fParam6);
				if (bParam5)
				{
...
void func_127(struct<3> Param0, var uParam3, int iParam4, var uParam5)
{
	struct<8> Var0;
	
	*uParam5 = func_128(&Param0, &uParam3, &iParam4);
	Var0 = 1926582096;
	Var0.f_1 = PLAYER::PLAYER_ID();
	Var0.f_2 = { Param0 };
	Var0.f_5 = uParam3;
		...
		if (PATHFIND::IS_VEHICLE_NODE_ID_VALID(iVar8))
		{
						...
						if ((uParam2->f_13 || uVar7 & 64 == 0) || uParam2->f_33 == 1)
						{
							if (uParam2->f_14 || uVar7 & 16 == 0)
							{
								if ((uVar7 & 128 == 0 && uVar7 & 256 == 0) && uVar7 & 512 == 0)
								{
									if (!func_159(Var1))
									{
										Var1 = { func_154(Var1, &fVar4, iVar9, uParam2->f_9, *uParam2, bVar10, uParam2->f_11, uParam2->f_34, &bVar11, bVar12, 1, uParam2->f_51, uParam2->f_60) };
														...
														if (func_149(Var1, uParam2))
														{
															if ((uParam2->f_48 && !func_169(&Var1, 0)) || uParam2->f_48 == 0)
															{
																...
																if (SYSTEM::VMAG(Var1) > 0f)
																{
																	...
																	{
																		if ((uParam2->f_12 && !func_148(Var1, fVar4, uParam2->f_34, PLAYER::PLAYER_ID(), 0, uParam2->f_56)) || !uParam2->f_12)
																		{
																			if (!uParam2->f_15 || !func_174(uParam2->f_35, &Var1, &(uParam2->f_38), &(uParam2->f_45), 0, 1))
																			{
																				if (uParam2->f_8)
																				{
																					...
																					iVar23 = 0;
																					if (!func_147(Var1, fVar4, uParam2->f_34))
																					{
																						if (uParam2->f_3 > 7f)
																						{
																							if (func_185(Var1, 6f, 1f, 1f, 5f, iVar19, bVar20, iVar21, fVar22, uParam2->f_58, -1, 1, uParam2->f_3, 0, 0, 0, 0))
																							{
																								iVar23 = 1;
																							}
																						}
																						else if (func_185(Var1, 6f, 1f, 1f, 5f, iVar19, bVar20, iVar21, fVar22, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_104(Var1, fVar4, uParam2->f_34, 1, 1, 0, 0, 0, 0))
																						{
																							iVar23 = 1;
																						}
																					}
																					if (iVar23 || uParam2->f_33 >= 2)
																					{
																						if (((uParam2->f_29 || uParam2->f_30) || uParam2->f_52) || uParam2->f_33 >= 2)
																						{
																							...
																							if (uParam2->f_52)
																							{
																								iVar24 = func_139(Var1, uParam2->f_54, &fVar25);
																							}
			...
			if (iVar0 >= (40 + iVar15) || iVar0 >= 100)
			{
				...
				else
				{
					...
					{
						func_135(iVar15, *uParam0, &iVar0, &Var1, &fVar4, uParam2, bVar10, iVar9, iVar5, fVar13, fVar14, bVar11);
						Var31 = { Var1 };
						fVar34 = fVar4;
						if (!uParam2->f_50)
						{
						...
						if (func_174(uParam2->f_35, &Var31, &(uParam2->f_38), &(uParam2->f_45), bVar35, 1) || func_169(&Var31, bVar35))
						{
							if (!uParam2->f_50)
							{
								uParam2->f_33 = 0;
...
void func_131(var uParam0, var uParam1, var uParam2, struct<3> Param3)
{
	...
	while (iVar2 < *uParam0)
	{
		...
		if (fVar1 < fVar0)
		{
			if (!func_132(*(uParam0[iVar2 /*4*/]), 5f, PLAYER::PLAYER_ID(), 0, 0))
			{
				fVar0 = fVar1;
				iVar3 = iVar2;
			}
...
{
	if (func_134(Param0, fParam3, iParam4, iParam5, 0) || func_133(Param0, iParam4, iParam6))
	{
		return 1;
	}
	return 0;
...
int func_134(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	while (iVar0 < 32)
	{
		if (!iParam4 == iVar0 || iParam5 == 1)
		{
			...
			if (bParam6)
			{
				if (func_317(iVar1, 0, 1) && func_317(iParam4, 0, 1))
				{
			...
			if (!bVar2)
			{
				if (func_317(iVar1, 0, 1) && func_317(iParam4, 0, 1))
				{
					...
					else if (SYSTEM::VDIST(func_114(iVar1), Param0) < 1f)
					{
						return 1;
					}
				}
				...
				{
					if (SYSTEM::VDIST(func_114(iVar1), Param0) < 1f)
					{
						return 1;
					}
				}
...
void func_135(int iParam0, struct<3> Param1, int iParam4, var* uParam5, float* fParam6, var uParam7, bool bParam8, int iParam9, int iParam10, float fParam11, float fParam12, bool bParam13)
{
	int iVar0;
	...
	while (iVar0 < 30)
	{
		...
		*uParam5 = { func_154(*uParam5, fParam6, iParam9, uParam7->f_9, *uParam7, bParam8, uParam7->f_11, uParam7->f_34, &bParam13, 0, 0, uParam7->f_51, uParam7->f_60) };
		if (!func_159(*uParam5))
		{
			iVar0 = 999;
			return;
...
void func_138(struct<3> Param0, float fParam3, int iParam4)
{
	struct<3> Var0;
	var uVar3;
	...
	if (iParam4 <= Global_2412555.f_162 && iParam4 < 39)
	{
		...
		{
			func_138(Var0, uVar3, iParam4 + 1);
		}
	}
}

int func_139(struct<3> Param0, float fParam3, float fParam4)
{
	int iVar0;
	struct<3> Var1;
	int iVar4;
		...
		if (!func_145(iParam0))
		{
			if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iParam0))
			{
				if (!PLAYER::GET_PLAYER_TEAM(iParam0) == PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()))
				{
					...
					{
						if (!func_141(PLAYER::GET_PLAYER_TEAM(iParam0), PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()), 0))
						{
							return 1;
						}
					}
...
int func_147(struct<3> Param0, float fParam3, int iParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1) && !ENTITY::IS_ENTITY_DEAD(iVar1, false))
	{
		...
		if (func_115(Param0, fParam3, iParam4, Var3, fVar6, iVar2, 0))
		{
			return 1;
		}
	}
...
int func_148(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	if (func_122(Param0, fParam3, iParam4, iParam5, iParam6) || func_183(Param0, fParam3, iParam4, iParam5, iParam7))
	{
		return 1;
	}
	return 0;
...
int func_149(struct<3> Param0, var uParam3)
{
	if (uParam3->f_18)
	{
		...
		{
			case 0:
				if (func_152(Param0, uParam3->f_19, uParam3->f_25, 0, 0))
				{
					return 1;
				}
				break;
			...
			case 1:
				if (func_150(Param0, uParam3->f_19, uParam3->f_22, 0, 0))
				{
					return 1;
				}
				break;
...
int func_150(struct<3> Param0, struct<3> Param3, struct<3> Param6, bool bParam9, bool bParam10)
{
	func_151(&Param3, &Param6);
...
bool func_152(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7, bool bParam8)
{
	if (bParam7 && bParam8)
	{
		Param0.f_2 = 0f;
	...
	if (func_142(PLAYER::PLAYER_ID(), 1, 0))
	{
		if (Global_4718592.f_32298 > 0)
		{
			...
			while (iVar0 < Global_4718592.f_32298)
			{
				...
				{
					if (func_105(Param0, Global_4718592.f_32299[iVar0 /*121*/], Global_4718592.f_32299[iVar0 /*121*/].f_6, Global_4718592.f_32299[iVar0 /*121*/].f_7, fParam3))
					{
						return 1;
					}
				}
		...
		if (Global_969056.f_268 > 0)
		{
			...
			while (iVar0 < Global_969056.f_268)
			{
				...
				{
					if (func_105(Param0, ENTITY::GET_ENTITY_COORDS(Global_969056.f_233[iVar0], true), ENTITY::GET_ENTITY_HEADING(Global_969056.f_233[iVar0]), ENTITY::GET_ENTITY_MODEL(Global_969056.f_233[iVar0]), 0.5f))
					{
						return 1;
					}
				}
		...
		if (Global_969056.f_266 > 0)
		{
			...
			while (iVar0 < Global_969056.f_266)
			{
				...
				{
					if (func_105(Param0, ENTITY::GET_ENTITY_COORDS(Global_969056.f_119[iVar0], true), ENTITY::GET_ENTITY_HEADING(Global_969056.f_119[iVar0]), ENTITY::GET_ENTITY_MODEL(Global_969056.f_119[iVar0]), 0.5f))
					{
						return 1;
					}
				}
...
Vector3 func_154(struct<3> Param0, float* fParam3, int iParam4, bool bParam5, struct<3> Param6, bool bParam9, bool bParam10, int iParam11, var uParam12, int iParam13, bool bParam14, bool bParam15, var uParam16)
{
	struct<3> Var0;
	var uVar3;
	var uVar4;
	...
	if (uVar4 & 1024 == 0 && !bParam10)
	{
		...
		if (bParam14)
		{
			...
			if (VEHICLE::IS_THIS_MODEL_A_HELI(iParam11) && func_156(Param0))
			{
				return 0f, 0f, 0f;
			}
		}
		...
		else
		{
			...
			if (!iParam11 == 0)
			{
				if (uVar4 & 8 != 0)
				{
					fVar14 = func_155(iParam11, 3.5f);
				}
				else
				{
					fVar14 = func_155(iParam11, 1.5f);
				}
				if (fVar14 > 1.8f)
				{
...
float func_155(int iParam0, float fParam1)
{
	...
	func_107(iParam0, &fVar0, &fVar3, 1086324736, 1080033280, 1077936128);
	fVar6 = (fVar3 - fVar0);
	if (fVar6 < fParam1)
	{
		return fParam1;
...
float func_158(struct<3> Param0, struct<3> Param3)
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
bool func_160(struct<3> Param0, var uParam3)
{
...
int func_162(var uParam0, bool bParam1)
{
	...
	if (func_168(*uParam0))
	{
		if (bParam1)
		{
			...
			func_167(&Var1, Global_2405077.f_592, Global_2405077.f_595, 1036831949, 0, fVar4);
			if (func_163(Var1, &uVar0) || func_168(Var1))
			{
				Var1 = { *uParam0 };
				func_167(&Var1, Global_2405077.f_592, Global_2405077.f_595, 1036831949, 1, fVar4);
			}
			*uParam0 = { Var1 };
		}
	}
...
int func_164(struct<3> Param0, var uParam3, float fParam4, bool bParam5, bool bParam6)
{
	switch (uParam3->f_10)
	{
		case 0:
			return func_152(Param0, *uParam3, ((uParam3->f_6 + fParam4) + (IntToFloat(Global_2405077.f_2733) * uParam3->f_8)), bParam5, bParam6);
			break;
		
		case 1:
			return func_150(Param0, *uParam3 + Vector((fParam4 * -1f), (fParam4 * -1f), (fParam4 * -1f)), uParam3->f_3 + Vector(fParam4, fParam4, fParam4), bParam5, bParam6);
			break;
...
void func_167(var uParam0, struct<3> Param1, float fParam4, float fParam5, bool bParam6, float fParam7)
{
	struct<3> Var0;
	struct<3> Var3;
	...
	else
	{
		...
		if (fParam7 == 0f)
		{
			func_112(&Var0, 0f, 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f));
		}
		else
		{
			func_112(&Var0, 0f, 0f, fParam7);
		}
	}
...
Vector3 func_170(struct<3> Param0, struct<3> Param3, struct<3> Param6, float fParam9, int iParam10, float fParam11, bool bParam12)
{
	int iVar0;
	struct<3> Var1;
	...
	{
		case 0:
			func_167(&Param0, Param3, fParam9, fParam11, bParam12, 0);
			break;
		
		case 1:
			func_173(&Param0, Param3, Param6, fParam11, bParam12);
			break;
		
		case 2:
			func_171(&Param0, Param3, Param6, fParam9, fParam11, bParam12);
			break;
	}
	iVar0 = 0;
	while (iVar0 < 40)
	{
		...
		{
			case 0:
				if (!func_152(Var1, Param3, fParam9, 0, 0))
				{
					return Var1;
				}
				break;
			...
			case 1:
				if (!func_150(Var1, Param3, Param6, 0, 0))
				{
					return Var1;
				}
				break;
...
void func_171(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7, float fParam8, bool bParam9)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (fVar9 < (fParam7 * 0.5f))
	{
		...
		else if (func_158(Var6, Var29) >= 0f)
		{
			Var6 = { Var6 * FtoV(((((fVar16 * 0.5f) + fVar9) + fParam8) * -1f)) };
		}
		else
...
Vector3 func_172(struct<3> Param0, struct<3> Param3)
{
...
void func_173(var uParam0, struct<2> Param1, var uParam3, struct<2> Param4, var uParam6, float fParam7, bool bParam8)
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_174(struct<3> Param0, var uParam3, var uParam4, var uParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	bool bVar1;
	...
	if (func_227(Param0))
	{
		if (func_177(uParam3, bParam6, 0, 1, 1))
		{
			if (bParam6)
			{
			}
	...
	if (bParam7)
	{
		if (func_125(*uParam3, 1056964608))
		{
			return 1;
		}
	}
	...
	while (iVar0 < *uParam4)
	{
		if (SYSTEM::VDIST(*uParam3, *(uParam4[iVar0 /*3*/])) < (*uParam5)[iVar0])
		{
			if (bParam6)
			{
				func_167(uParam3, *(uParam4[iVar0 /*3*/]), (*uParam5)[iVar0], 1036831949, 0, 0);
			}
			bVar1 = true;
		}
		iVar0++;
			...
			if (iVar2 > -1 && iVar2 < 101)
			{
				...
				if (SYSTEM::VMAG(Var3) > 0f)
				{
					if ((uParam2->f_57 && SYSTEM::VDIST(Var3, uParam2->f_35) > uParam2->f_4) || uParam2->f_57 == 0)
					{
						...
						{
							if ((uParam2->f_12 && !func_148(Var3, fVar6, uParam2->f_34, PLAYER::PLAYER_ID(), 0, uParam2->f_56)) || !uParam2->f_12)
							{
								if (!uParam2->f_15 || !func_174(uParam2->f_35, &Var3, &(uParam2->f_38), &(uParam2->f_45), 0, 1))
								{
									if (uParam2->f_8)
									{
										...
										bVar12 = false;
										if (!func_147(Var3, fVar6, uParam2->f_34))
										{
											if (uParam2->f_3 > 7f)
											{
												if (func_185(Var3, 6f, 1f, 1f, 5f, iVar8, bVar9, iVar10, fVar11, uParam2->f_58, -1, 1, uParam2->f_3, 0, 0, 0, 0))
												{
													bVar12 = true;
												}
											}
											else if (func_185(Var3, 6f, 1f, 1f, 5f, iVar8, bVar9, iVar10, fVar11, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_104(Var3, fVar6, uParam2->f_34, 1, 1, 0, 0, uParam2->f_58, 0))
											{
												bVar12 = true;
											}
										}
										if (bVar12)
										{
											if ((uParam2->f_29 || uParam2->f_30) || uParam2->f_52)
											{
												...
												if (uParam2->f_52)
												{
													iVar13 = func_139(Var3, uParam2->f_54, &fVar14);
												}
...
int func_183(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 < 32)
	{
		if (!iParam5 == iVar0 || iParam6 == 1)
		{
			...
			while (iVar1 < 2)
			{
				if (func_184(Param0, iParam4, Global_2418033.f_461[iVar0 /*11*/][iVar1 /*5*/], Global_2418033.f_461[iVar0 /*11*/][iVar1 /*5*/].f_4))
				{
					if (func_115(Param0, fParam3, iParam4, Global_2418033.f_461[iVar0 /*11*/][iVar1 /*5*/], Global_2418033.f_461[iVar0 /*11*/][iVar1 /*5*/].f_3, Global_2418033.f_461[iVar0 /*11*/][iVar1 /*5*/].f_4, 0))
					{
						if (func_317(iVar2, 0, 1) && func_317(iParam5, 0, 1))
						{
							return 1;
						}
						else
...
int func_184(struct<3> Param0, int iParam3, struct<3> Param4, int iParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
	
	fVar0 = func_113(iParam3, 1008981770);
	fVar1 = func_113(iParam7, 1008981770);
...
int func_185(struct<3> Param0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, int iParam9, float fParam10, bool bParam11, int iParam12, bool bParam13, float fParam14, bool bParam15, float fParam16, bool bParam17, bool bParam18)
{
	...
	if (fParam14 > 0f)
	{
		if (func_190(Param0, fParam14, 1, 1, bParam15, bParam17, bParam11, bParam15))
		{
			return 0;
		}
	}
	...
	if (bParam8)
	{
		if (fParam6 > 0f)
		{
			if (func_186(Param0, fParam6, iParam7, iParam9, fParam10, bParam11, iParam12, fParam16, bParam17))
			{
				return 0;
			}
		}
...
int func_186(struct<3> Param0, float fParam3, int iParam4, int iParam5, float fParam6, bool bParam7, int iParam8, float fParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (iParam4 && !bParam7)
	{
		if (func_317(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_187(PLAYER::PLAYER_ID()), Param0, true) <= (fVar2 + fParam3))
				{
	...
	while (iVar0 < 32)
	{
		...
		if (func_317(iVar1, 1, 1))
		{
			if (!func_30(iVar1, 0) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
			{
				...
				{
					if ((func_121(iVar1) || !bParam10) && !Global_2426865[iVar1 /*449*/].f_268)
					{
						fVar2 = fParam6;
						if (fParam9 > 0f)
						{
						...
						if (!bParam7)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_187(iVar1), Param0, true) <= (fVar2 + fParam3))
								{
...
int func_190(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8, var uParam9)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		{
			if (func_317(iVar1, bParam4, bParam5))
			{
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam7 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_121(iVar1)))
					{
						...
						{
							if (((PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1 && uParam9) && bParam6) && func_116(iVar1))
							{
							}
							else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_114(iVar1), Param0, true) < fParam3)
								{
									return 1;
								}
							}
...
int func_193(int iParam0)
{
	...
	if (func_202(PLAYER::PLAYER_ID(), 0) || (func_199(PLAYER::PLAYER_ID()) && func_70(func_198(PLAYER::PLAYER_ID())) == 12))
	{
		return 1;
	}
	if (func_197(PLAYER::PLAYER_ID()) || (func_199(PLAYER::PLAYER_ID()) && func_70(func_198(PLAYER::PLAYER_ID())) == 8))
	{
		return 1;
	}
	if (func_196(PLAYER::PLAYER_ID()) || (func_199(PLAYER::PLAYER_ID()) && func_70(func_198(PLAYER::PLAYER_ID())) == 5))
	{
		return 1;
	}
	if (func_195(PLAYER::PLAYER_ID()) || (func_199(PLAYER::PLAYER_ID()) && func_70(func_198(PLAYER::PLAYER_ID())) == 10))
	{
		return 1;
	}
	if (func_194(PLAYER::PLAYER_ID()) || (func_199(PLAYER::PLAYER_ID()) && func_70(func_198(PLAYER::PLAYER_ID())) == 6))
	{
		return 1;
	}
	return 0;
...
int func_204(struct<3> Param0, int iParam3)
{
	int iVar0;
...
void func_205(struct<3> Param0, int iParam3)
{
	...
	if (!func_223())
	{
		...
		if (iVar1 > -1)
		{
			...
			switch (iVar1)
			{
				...
				case 30:
					if (func_218(iParam3))
					{
						func_219(Global_1590908[PLAYER::PLAYER_ID() /*874*/].f_267.f_29);
					}
					break;
		...
		else if (func_215(Param0, &iVar2, &iVar6) || (func_192(Param0, &(iVar2[0])) && (VEHICLE::IS_THIS_MODEL_A_PLANE(iParam3) || VEHICLE::IS_THIS_MODEL_A_HELI(iParam3))))
		{
			func_234();
			iVar0 = 0;
			while (iVar0 < iVar2)
			{
				...
				if (!iVar6[iVar0] && func_214(iVar2[iVar0], -1))
				{
					if (func_218(iParam3))
					{
				...
				{
					if (((func_213(PLAYER::PLAYER_PED_ID()) || func_212(PLAYER::PLAYER_PED_ID())) && VEHICLE::IS_THIS_MODEL_A_PLANE(iParam3)) || VEHICLE::IS_THIS_MODEL_A_HELI(iParam3))
					{
						if (func_211(iParam3))
						{
							func_210(iVar2[iVar0]);
						}
						else if (func_209(iParam3))
						{
...
void func_207(struct<3> Param0, float fParam3, int iParam4, bool bParam5)
{
	struct<2> Var0;
	struct<2> Var3;
	float fVar6;
	...
	if (!iParam4 == 0)
	{
		func_107(iParam4, &Var0, &Var3, 1086324736, 1080033280, 1077936128);
		...
		func_221(Var10, fParam3);
	}
	else
	{
		func_221(Param0, fParam3);
	}
}
...
int func_215(struct<2> Param0, var uParam2, var uParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_224(struct<2> Param0, var uParam2, bool bParam3, float fParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_229(struct<3> Param0, float fParam3)
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_164(Param0, &(Global_2405077.f_45[iVar0 /*12*/]), fParam3, 0, 0))
			{
				return iVar0;
			}
		}
...
int func_230(struct<3> Param0, float fParam3)
{
	int iVar0;
...
int func_236()
{
	if (!Global_2405077.f_605 == 0 && NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2405077.f_610) < func_233(0))
	{
		return 1;
	}
	return 0;
...
int func_237()
{
	...
	if (!func_239(PLAYER::PLAYER_ID()) && !func_238())
	{
		return 0;
	}
	return 1;
...
void func_241(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	MISC::SET_BIT(&(Local_77.f_2[iVar0]), iVar1);
}
...
void func_243()
{
	...
	if (func_245(NETWORK::PARTICIPANT_ID()) != 3 && func_20() == 3)
	{
		func_244(3);
	}
	switch (func_245(NETWORK::PARTICIPANT_ID()))
	{
		case 0:
			if (func_20() > 0)
			{
...
{
	MISC::CLEAR_BIT(&(Global_1630816[PLAYER::PLAYER_ID() /*597*/].f_11.f_6), iParam0);
}
...
{
	MISC::SET_BIT(&(Global_1630816[PLAYER::PLAYER_ID() /*597*/].f_11.f_6), iParam0);
}
...
int func_252()
{
	...
	if (func_253(NETWORK::PARTICIPANT_ID(), 1))
	{
		if (func_255() == 0)
		{
			func_254(1);
...
bool func_253(int iParam0, int iParam1)
{
	...
	iVar0 = (iParam1 / 32);
	iVar1 = (iParam1 % 32);
	return MISC::IS_BIT_SET(Local_85[iParam0 /*4*/].f_2[iVar0], iVar1);
}

void func_254(int iParam0)
{
	Global_1630816[PLAYER::PLAYER_ID() /*597*/].f_11.f_302 = iParam0;
}

int func_255()
{
	return Global_1630816[PLAYER::PLAYER_ID() /*597*/].f_11.f_302;
}
...
void func_259()
{
	...
	if (func_265(PLAYER::PLAYER_PED_ID(), func_16(), 120f, 1))
	{
		if (!func_253(NETWORK::PARTICIPANT_ID(), 1))
		{
			func_264(1);
	...
	else if (func_253(NETWORK::PARTICIPANT_ID(), 1))
	{
		func_263(1);
	}
	if (!func_253(NETWORK::PARTICIPANT_ID(), 0) && func_260())
	{
		func_264(0);
	}
}
...
int func_260()
{
	if (func_257())
	{
		if (!func_265(PLAYER::PLAYER_PED_ID(), func_16(), 1000f, 1))
		{
			return 1;
		}
		if (func_262(PLAYER::PLAYER_ID(), 1, 1))
		{
			return 1;
		}
...
bool func_265(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
void func_267()
{
	...
	if (iVar0 != func_269())
	{
		switch (func_269())
		{
			...
			case 0:
				if ((func_257() && !func_253(NETWORK::PARTICIPANT_ID(), 0)) && iVar0 == 2)
				{
					func_264(0);
				}
				break;
...
void func_274()
{
	...
	switch (func_19())
	{
		...
		case 2:
			if (((((!func_12(3) && !func_253(NETWORK::PARTICIPANT_ID(), 2)) && func_7()) && !NETWORK::NETWORK_IS_ENTITY_FADING(func_16())) && func_277(func_10())) && func_276(func_16()) == 0)
			{
		...
		case 3:
			if (((!func_12(4) && !func_253(NETWORK::PARTICIPANT_ID(), 3)) && func_7()) && !ENTITY::IS_ENTITY_VISIBLE(func_16()))
			{
				func_264(3);
			}
			break;
		...
		case 4:
			if (((!func_12(5) && !func_253(NETWORK::PARTICIPANT_ID(), 4)) && func_7()) && func_277(func_10()))
			{
				iVar0 = func_10();
				func_275(&iVar0);
				func_264(4);
...
void func_279()
{
	if (func_285())
	{
		...
		{
			iLocal_134 = HUD::ADD_BLIP_FOR_ENTITY(func_16());
			HUD::SET_BLIP_SPRITE(iLocal_134, func_284());
			func_281(&iLocal_134, func_283());
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_134, func_280());
		}
	}
	else if (HUD::DOES_BLIP_EXIST(iLocal_134))
	{
...
void func_291()
{
	...
	while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		...
		{
			iLocal_118[iVar0] = iVar0;
			iVar1 = NETWORK::NETWORK_GET_PLAYER_INDEX(iLocal_118[iVar0]);
			if (func_317(iVar1, 0, 1))
			{
				if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
				{
					if (!bVar2)
					{
						if (func_253(iLocal_118[iVar0], 1))
						{
							bVar2 = true;
						}
					}
					if (!func_12(1))
					{
						if (func_253(iLocal_118[iVar0], 0))
						{
							func_241(1);
						}
					}
					if (!func_12(3))
					{
						if (func_253(iLocal_118[iVar0], 2))
						{
							func_241(3);
						}
					}
					if (!func_12(4))
					{
						if (func_253(iLocal_118[iVar0], 3))
						{
							func_241(4);
						}
					}
					if (!func_12(5))
					{
						if (func_253(iLocal_118[iVar0], 4))
						{
							func_241(5);
						}
					}
...
void func_292(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	MISC::CLEAR_BIT(&(Local_77.f_2[iVar0]), iVar1);
}
...
bool func_294(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	return MISC::IS_BIT_SET(uLocal_127[iVar0], iVar1);
}
...
int func_295()
{
	...
	if (func_296() != 0)
	{
		if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(func_296()) == 0)
		{
			return 1;
		}
	}
...
{
	func_248(15);
	Global_1630816[PLAYER::PLAYER_ID() /*597*/].f_11.f_303 = 0;
}
...
int func_313(struct<21> Param0)
{
	...
	func_314(0, -1, 0);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_77, 8);
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_85, 33);
