void __EntryFunction__()
{
	...
	while (true)
	{
		...
		GAMEPLAY::CLEAR_AREA(-1931.548f, 3026.929f, 31.8104f, 15f, 1, 0, 0, 0);
		switch (iLocal_537)
		{
			case 0:
...
void func_1()
{
	switch (iLocal_467)
	{
		case 0:
			...
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_421, 10f, 0, 0, 0, 0, 0, 0);
			iLocal_467 = 1;
			break;
		...
		case 2:
			if ((STREAMING::HAS_MODEL_LOADED(1702441027) && STREAMING::HAS_MODEL_LOADED(1925237458)) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("OfficerMarch01"))
			{
				iLocal_467 = 3;
			}
			break;
		...
		case 3:
			switch (iLocal_466)
			{
				case 0:
					...
					AI::TASK_FOLLOW_WAYPOINT_RECORDING(iLocal_413, "OfficerMarch01", 0, 0, -1);
					iLocal_466++;
					break;
				...
				case 2:
					...
					while (iVar0 < 5)
					{
						...
						{
							if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_413))
							{
								AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uLocal_414[iVar0], iLocal_413, Local_430[iVar0], 1f, -1, 1036831949, 1);
							}
						}
						iVar0++;
					}
				...
				if (bLocal_49)
				{
					if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
					{
						...
						while (iVar0 < 5)
						{
							...
							{
								AI::CLEAR_PED_TASKS(uLocal_414[iVar0]);
							}
							iVar0++;
						}
						iLocal_465 = 1;
						...
						else if (!iLocal_462)
						{
							if (!iLocal_463)
							{
								...
								while (iVar0 < 5)
								{
									...
									{
										AI::CLEAR_PED_TASKS(uLocal_414[iVar0]);
										AI::TASK_STAND_STILL(uLocal_414[iVar0], -1);
									}
									iVar0++;
								}
								iLocal_463 = 1;
							...
							if (!PED::IS_PED_INJURED(iLocal_413))
							{
								...
								AI::TASK_GO_STRAIGHT_TO_COORD(0, Local_424, 1f, 20000, 1193033728, 1056964608);
								AI::TASK_TURN_PED_TO_FACE_COORD(0, Local_427, 0);
								AI::CLOSE_SEQUENCE_TASK(uVar1);
								AI::TASK_PERFORM_SEQUENCE(iLocal_413, uVar1);
...
void func_3()
{
	switch (iLocal_284)
	{
		...
		case 2:
			if ((STREAMING::HAS_MODEL_LOADED(1702441027) && STREAMING::HAS_MODEL_LOADED(1925237458)) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("AccomMarching01"))
			{
				iLocal_284 = 3;
			}
			break;
...
void func_4()
{
	if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
	{
		...
		{
			AI::TASK_COMBAT_PED(uLocal_228[0], PLAYER::PLAYER_PED_ID(), 0, 16);
		}
		if (!ENTITY::IS_ENTITY_DEAD(uLocal_228[1], 0))
		{
			AI::TASK_COMBAT_PED(uLocal_228[1], PLAYER::PLAYER_PED_ID(), 0, 16);
		}
	}
	else
	{
		if (!ENTITY::IS_ENTITY_DEAD(uLocal_228[0], 0))
		{
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(uLocal_228[0], 242628503) != 1)
				{
					AI::CLEAR_PED_TASKS(uLocal_228[0]);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_282);
					AI::OPEN_SEQUENCE_TASK(&uLocal_282);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_255, 1f, 20000, 0.25f, 0, fLocal_258);
					AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_GUARD_STAND_ARMY", -1, 0);
					AI::CLOSE_SEQUENCE_TASK(uLocal_282);
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_228[0], 0))
					{
						AI::TASK_PERFORM_SEQUENCE(uLocal_228[0], uLocal_282);
					}
					AI::CLEAR_SEQUENCE_TASK(&uLocal_282);
					iLocal_269 = 1;
				}
		...
		if (!ENTITY::IS_ENTITY_DEAD(uLocal_228[1], 0))
		{
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(uLocal_228[1], 242628503) != 1)
				{
					AI::CLEAR_PED_TASKS(uLocal_228[1]);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_283);
					AI::OPEN_SEQUENCE_TASK(&uLocal_283);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_259, 1f, 20000, 0.25f, 0, fLocal_262);
					AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_GUARD_STAND_ARMY", -1, 0);
					AI::CLOSE_SEQUENCE_TASK(uLocal_283);
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_228[1], 0))
					{
						AI::TASK_PERFORM_SEQUENCE(uLocal_228[1], uLocal_283);
					}
					AI::CLEAR_SEQUENCE_TASK(&uLocal_283);
					iLocal_271 = 1;
				}
	...
	switch (iLocal_275)
	{
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1588.977f, 2793.941f, 14.98289f, -1575.664f, 2779.558f, 26.11536f, 29.75f, 0, 1, 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_228[0]))
					{
						if (func_9(&uLocal_50, "ARMYAUD", "ARMY_WRN1", 9, 0, 0, 0))
						{
							...
							if (!ENTITY::IS_ENTITY_DEAD(uLocal_228[0], 0))
							{
								AI::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_228[0], -1587.327f, 2798.517f, 15.8582f, 1f, 20000, 0.25f, 0, 216.3294f);
							}
							iLocal_275 = 1;
						}
					}
				...
				if (func_34(&uLocal_277))
				{
					...
					if (fLocal_280 > 7f)
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1588.977f, 2793.941f, 14.98289f, -1575.664f, 2779.558f, 26.11536f, 29.75f, 0, 1, 0))
						{
							if (!ENTITY::IS_ENTITY_DEAD(uLocal_228[0], 0))
							{
								if (AI::GET_SCRIPT_TASK_STATUS(uLocal_228[0], 1227113341) != 1)
								{
									AI::TASK_AIM_GUN_AT_ENTITY(uLocal_228[0], PLAYER::PLAYER_PED_ID(), -1, 0);
		...
		case 2:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uLocal_228[0], 0))
			{
				...
				{
					if (AI::GET_SCRIPT_TASK_STATUS(uLocal_228[0], 167901368) != 1)
					{
						AI::TASK_SHOOT_AT_ENTITY(uLocal_228[0], PLAYER::PLAYER_PED_ID(), -1, 0);
	...
	switch (iLocal_276)
	{
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -2306.916f, 3390.545f, 29.17826f, -2322.245f, 3401.719f, 35.63131f, 36f, 0, 1, 0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_228[1]))
				{
					if (func_9(&uLocal_50, "ARMYAUD", "ARMY_WRN2", 9, 0, 0, 0))
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(uLocal_228[1], 0))
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_228[0], -2307.763f, 3385.597f, 29.9984f, 1f, 20000, 0.25f, 0, 58.9552f);
						}
						iLocal_276 = 1;
					}
				}
				...
				if (func_34(&uLocal_277))
				{
					...
					if (fLocal_280 > 7f)
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -2306.916f, 3390.545f, 29.17826f, -2322.245f, 3401.719f, 35.63131f, 36f, 0, 1, 0))
						{
							if (!ENTITY::IS_ENTITY_DEAD(uLocal_228[1], 0))
							{
								if (AI::GET_SCRIPT_TASK_STATUS(uLocal_228[1], 1227113341) != 1)
								{
									AI::TASK_AIM_GUN_AT_ENTITY(uLocal_228[1], PLAYER::PLAYER_PED_ID(), -1, 0);
		...
		case 2:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uLocal_228[1], 0))
			{
				...
				{
					if (AI::GET_SCRIPT_TASK_STATUS(uLocal_228[1], 167901368) != 1)
					{
						AI::TASK_SHOOT_AT_ENTITY(uLocal_228[1], PLAYER::PLAYER_PED_ID(), -1, 0);
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 5)
						{
							PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 4, 0);
							PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), 0);
...
float func_6(var uParam0)
{
	if (func_34(uParam0))
	{
		...
		{
			return (func_7(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_7(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - fParam1);
		...
		if (bLocal_49)
		{
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
			{
				...
				while (iVar0 < 2)
				{
					...
					{
						AI::CLEAR_PED_TASKS(uLocal_225[iVar0]);
					}
					iVar0++;
				}
				iLocal_273 = 1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_224) && !PED::IS_PED_INJURED(iLocal_224))
	{
		if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_224))
		{
			if (iLocal_265)
			{
				...
				{
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_232, 10f, 0, 0, 0, 0, 0, 0);
				...
				else if (!iLocal_263)
				{
					if (!iLocal_264)
					{
						...
						while (iVar0 < 2)
						{
							...
							{
								AI::CLEAR_PED_TASKS(uLocal_225[iVar0]);
								AI::TASK_STAND_STILL(uLocal_225[iVar0], -1);
							}
							iVar0++;
						}
						iLocal_264 = 1;
					...
					{
						AI::OPEN_SEQUENCE_TASK(&uLocal_281);
						AI::TASK_GO_STRAIGHT_TO_COORD(0, Local_235, 1f, 20000, 1193033728, 1056964608);
						AI::TASK_TURN_PED_TO_FACE_COORD(0, Local_238, 0);
						AI::CLOSE_SEQUENCE_TASK(uLocal_281);
						AI::TASK_PERFORM_SEQUENCE(iLocal_224, uLocal_281);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_281);
						iLocal_263 = 1;
					}
				}
			}
...
void func_36()
{
	...
	while (iVar0 < 2)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(iLocal_224) && ENTITY::DOES_ENTITY_EXIST(uLocal_225[iVar0])) && !PED::IS_PED_INJURED(iLocal_224)) && !PED::IS_PED_INJURED(uLocal_225[iVar0]))
		{
			...
			AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uLocal_225[iVar0], iLocal_224, Local_241[iVar0], 1f, -1, 1036831949, 1);
		}
		iVar0++;
	}
}
							...
							if (!ENTITY::DOES_ENTITY_EXIST(iLocal_285))
							{
								...
								if (!func_39(Var3))
								{
									if (!CAM::IS_SPHERE_VISIBLE(Var3, 10f))
									{
										...
										ENTITY::_SET_ENTITY_REGISTER(iLocal_285, 0);
										...
										AI::TASK_PLANE_MISSION(uLocal_291, iLocal_285, iLocal_286, PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 6, 70f, -1f, 30f, 500, 50, 1);
										iLocal_345 = 1;
									}
								}
							}
	...
	if (!bLocal_344)
	{
		...
		if ((((ENTITY::DOES_ENTITY_EXIST(iLocal_285) && !ENTITY::IS_ENTITY_DEAD(iLocal_285, 0)) && !ENTITY::IS_ENTITY_DEAD(uLocal_291, 0)) && ENTITY::DOES_ENTITY_EXIST(iLocal_286)) && !ENTITY::IS_ENTITY_DEAD(iLocal_286, 0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				{
					AI::CLEAR_PED_TASKS(iLocal_291);
					AI::TASK_PLANE_MISSION(iLocal_291, iLocal_285, iLocal_286, PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 8, 70f, -1f, 30f, 500, 50, 1);
	...
	switch (iLocal_303)
	{
		...
		case 1:
			...
			while (iVar4 < 3)
			{
				...
				{
					AI::OPEN_SEQUENCE_TASK(&(uVar0[iVar4]));
					AI::TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_287[iVar4], Local_327[iVar4], 25f, 0, 321739290, 786469, 5f, -1f);
					AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
					AI::TASK_SHOOT_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, -957453492);
					AI::CLOSE_SEQUENCE_TASK(uVar0[iVar4]);
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_297[iVar4], 0))
					{
						AI::TASK_PERFORM_SEQUENCE(uLocal_297[iVar4], uVar0[iVar4]);
					}
					AI::CLEAR_SEQUENCE_TASK(&(uVar0[iVar4]));
				}
				iVar4++;
			}
			iLocal_303 = 2;
		...
		case 2:
			...
			while (iVar4 < 3)
			{
				...
				{
					if (AI::GET_SCRIPT_TASK_STATUS(uLocal_297[iVar4], -1817882002) != 1)
					{
...
void func_46()
{
	iLocal_302 = (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 65535) % 4);
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
...
void func_48()
{
	...
	while (iVar0 < 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_293[iVar0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_293[iVar0], 0))
		{
			...
			AI::TASK_COMBAT_PED(uLocal_293[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!CAM::IS_SPHERE_VISIBLE(Local_255, 10f) || func_55(PLAYER::PLAYER_PED_ID(), Local_255, 1) > 100f)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_228[0]))
			{
				...
				GAMEPLAY::CLEAR_AREA(Local_255, 10f, 1, 0, 0, 0);
				...
				AI::TASK_START_SCENARIO_AT_POSITION(uLocal_228[0], "WORLD_HUMAN_GUARD_STAND_ARMY", Local_255, fLocal_258, -1, 0, 1);
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(uLocal_228[0], 0))
				{
					AI::TASK_LOOK_AT_ENTITY(uLocal_228[0], PLAYER::PLAYER_PED_ID(), -1, 1024, 4);
				}
				return 1;
			}
		}
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!CAM::IS_SPHERE_VISIBLE(Local_259, 10f) || func_55(PLAYER::PLAYER_PED_ID(), Local_259, 1) > 100f)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_228[1]))
			{
				...
				GAMEPLAY::CLEAR_AREA(Local_259, 10f, 1, 0, 0, 0);
				...
				AI::TASK_START_SCENARIO_AT_POSITION(uLocal_228[1], "WORLD_HUMAN_GUARD_STAND_ARMY", Local_259, fLocal_262, -1, 0, 1);
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(uLocal_228[1], 0))
				{
					AI::TASK_LOOK_AT_ENTITY(uLocal_228[1], PLAYER::PLAYER_PED_ID(), -1, 1024, 4);
				}
				return 1;
			}
		}
...
void func_59()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_285))
	{
		...
		{
			AI::CLEAR_PED_TASKS(iLocal_291);
			AI::TASK_PLANE_MISSION(iLocal_291, iLocal_285, 0, PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 8, 70f, -1f, 30f, 500, 50, 1);
			PED::SET_PED_KEEP_TASK(iLocal_291, 1);
...
void func_60()
{
	...
	{
		if (UI::DOES_BLIP_EXIST(uLocal_481))
		{
			UI::REMOVE_BLIP(&uLocal_481);
		}
	...
	{
		if (UI::DOES_BLIP_EXIST(uLocal_482))
		{
			UI::REMOVE_BLIP(&uLocal_482);
		}
	...
	{
		if (UI::DOES_BLIP_EXIST(uLocal_483))
		{
			UI::REMOVE_BLIP(&uLocal_483);
		}
...
void func_62()
{
	...
	{
		if (UI::DOES_BLIP_EXIST(uLocal_420))
		{
			UI::REMOVE_BLIP(&uLocal_420);
		}
...
int func_64()
{
	...
	if (!func_27(14) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-892862129) > 0)
	{
		return 1;
	}
	return 0;
...
void func_65()
{
	...
	while (iVar0 < 8)
	{
		...
		{
			if (UI::DOES_BLIP_EXIST(uLocal_403[iVar0]))
			{
				UI::REMOVE_BLIP(&(uLocal_403[iVar0]));
			}
...
void func_66()
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (UI::DOES_BLIP_EXIST(uLocal_356[iVar0]))
			{
				UI::REMOVE_BLIP(&(uLocal_356[iVar0]));
			}
...
void func_68()
{
	...
	while (iVar0 < 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_228[iVar0]))
		{
			...
			{
				AI::TASK_START_SCENARIO_IN_PLACE(uLocal_228[iVar0], "WORLD_HUMAN_GUARD_STAND_ARMY", -1, 0);
	...
	{
		if (UI::DOES_BLIP_EXIST(uLocal_231))
		{
			UI::REMOVE_BLIP(&uLocal_231);
		}
