		...
		if (iLocal_241 != -1)
		{
			if (!func_220())
			{
				*uParam0 = func_219(iLocal_241);
				...
				MISC::SET_BIT(&(Global_111638.f_18569[*uParam0 /*6*/]), 0);
				MISC::SET_BIT(&(Global_111638.f_18569[*uParam0 /*6*/]), 2);
				MISC::CLEAR_BIT(&(Global_111638.f_18569[*uParam0 /*6*/]), 3);
				Global_110725[*uParam0 /*10*/].f_1 = 0;
				if (!func_217(0))
				{
					Global_110725[*uParam0 /*10*/].f_3 = 0;
				}
				if (!func_209(*uParam0))
				{
...
int func_52(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0 /*3*/][func_53(iParam1)];
...
int func_167(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_169(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_226(float fParam0)
{
	...
	while (iVar0 < 5)
	{
		Var1 = { Global_31146[(iLocal_239 + iVar0) /*23*/][0 /*3*/] };
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(Var2, Var1, 1) <= fParam0 && MISC::ABSF((Var2.z - Var1.z)) < 1.5f)
		{
			return iVar0;
		}
		iVar0++;
...
void func_228(var uParam0, struct<3> Param1)
{
	...
	while (true)
	{
		...
		Local_249 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
		if ((!(*uParam0 == 52 && Local_249.z > 34f) && !(*uParam0 == 53 && Local_249.z > 71f)) && !(*uParam0 == 54 && Local_249.z > 30f))
		{
	...
	while (MISC::GET_GAME_TIMER() < iVar2)
	{
		if (STREAMING::HAS_MODEL_LOADED(iVar0))
		{
			*uParam0 = WEAPON::CREATE_WEAPON_OBJECT(iParam1, -1, Param2, 1, 1065353216, 0, 0, 1);
			...
			{
				if (WEAPON::HAS_WEAPON_GOT_WEAPON_COMPONENT(*uParam0, func_277(&uVar1, iParam1, joaat("gun_root"), 0)))
				{
					WEAPON::REMOVE_WEAPON_COMPONENT_FROM_WEAPON_OBJECT(*uParam0, func_277(&uVar1, iParam1, joaat("gun_root"), 0));
				}
				else if (WEAPON::HAS_WEAPON_GOT_WEAPON_COMPONENT(*uParam0, func_277(&uVar1, iParam1, joaat("gun_root"), 1)))
				{
					WEAPON::REMOVE_WEAPON_COMPONENT_FROM_WEAPON_OBJECT(*uParam0, func_277(&uVar1, iParam1, joaat("gun_root"), 1));
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
			{
...
int func_335(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
var func_341(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
...
void func_342(var uParam0)
{
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[1], uParam0->f_28[0], PED::GET_PED_BONE_INDEX(uParam0->f_28[0], iVar4), Var6, Var5, 1, 0, 0, 0, 2, 1);
...
void func_344(var uParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_154(uParam0);
...
void func_349(var uParam0)
{
	...
	if (func_128(uParam0->f_28[0]))
	{
		...
		PED::SET_PED_NAME_DEBUG(uParam0->f_28[0], "RAMP:PED 0");
		func_344(&(uParam0->f_41[1]), iVar7, Var0, 0f);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[1], uParam0->f_28[0], PED::GET_PED_BONE_INDEX(uParam0->f_28[0], iVar2), Var4, Var3, 1, 1, 0, 0, 2, 1);
	...
	if (func_128(uParam0->f_28[1]))
	{
		...
		PED::SET_PED_NAME_DEBUG(uParam0->f_28[1], "RAMP:PED 1");
		func_344(&(uParam0->f_41[2]), iVar7, Var0, 0f);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[2], uParam0->f_28[1], PED::GET_PED_BONE_INDEX(uParam0->f_28[1], iVar2), Var4, Var3, 1, 1, 0, 0, 2, 1);
...
int func_352(int iParam0, var uParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_353((*iParam0)[0], Param2, fParam3, uParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_353((*iParam0)[iVar0], Param2, fParam3, uParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_353(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_354(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_354(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
