...
int func_1()
{
	...
	switch (Local_113.f_1)
	{
		case 0:
			...
			{
				GAMEPLAY::SET_BIT(&(Local_113.f_2), 4);
				func_18(2);
			}
			...
			if (GAMEPLAY::IS_BIT_SET(Local_113.f_2, 1))
			{
				func_18(2);
			}
			if (func_12(Local_113.f_5) || func_10(Local_113.f_5, 1, 0))
			{
				GAMEPLAY::SET_BIT(&(Local_113.f_2), 2);
				func_18(2);
			}
			break;
			...
			else
			{
				if (!func_21(&(Local_113.f_16)))
				{
					if (!func_13(Global_262145.f_12494, &uVar0, 1123024896, 0))
					{
						...
						GAMEPLAY::SET_BIT(&(Local_113.f_2), 6);
					}
				}
				...
				else
				{
					...
					GAMEPLAY::CLEAR_BIT(&(Local_113.f_2), 6);
				}
				...
				if (func_19(&(Local_113.f_12), Global_262145.f_12490, 0) || bVar1)
				{
					...
					if (!bVar1)
					{
						GAMEPLAY::SET_BIT(&(Local_113.f_2), 0);
					}
					else
					{
						func_2();
...
void func_2()
{
	if (!GAMEPLAY::IS_BIT_SET(Local_113.f_2, 5))
	{
		if (GAMEPLAY::IS_BIT_SET(Local_113.f_2, 3))
		{
			Var0 = 1975453628;
			...
			Var0.f_10 = func_6();
			func_3(Var0, func_4());
			GAMEPLAY::SET_BIT(&(Local_113.f_2), 5);
		}
		else if (GAMEPLAY::IS_BIT_SET(Local_113.f_2, 0))
		{
			Var14 = 1975453628;
		...
		else if (GAMEPLAY::IS_BIT_SET(Local_113.f_2, 2) || GAMEPLAY::IS_BIT_SET(Local_113.f_2, 1))
		{
			Var28 = 1975453628;
...
int func_4()
{
	...
	while (iVar1 < 32)
	{
		...
		if (func_5(iVar2, 0, 0))
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_135[iVar1].f_2, 0))
			{
...
int func_7()
{
	if ((((GAMEPLAY::IS_BIT_SET(Local_113.f_2, 0) || GAMEPLAY::IS_BIT_SET(Local_113.f_2, 1)) || GAMEPLAY::IS_BIT_SET(Local_113.f_2, 2)) || GAMEPLAY::IS_BIT_SET(Local_113.f_2, 3)) || GAMEPLAY::IS_BIT_SET(Local_113.f_2, 4))
	{
		return 1;
	}
	return 0;
...
void func_22()
{
	if (!GAMEPLAY::IS_BIT_SET(Local_113.f_2, 1))
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Local_113.f_2), 1);
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(Local_113.f_2, 1) && !GAMEPLAY::IS_BIT_SET(Local_113.f_2, 2))
	{
		iVar0 = NETWORK::NETWORK_GET_PARTICIPANT_INDEX(func_16());
		if (iVar0 >= 0 && iVar0 < 32)
		{
			if (GAMEPLAY::IS_BIT_SET(Local_135[iVar0].f_2, 11))
			{
				GAMEPLAY::SET_BIT(&(Local_113.f_2), 2);
				if (Local_113.f_1 == 0)
				{
...
int func_23()
{
	...
	Var0[0] = { -1976.481f, -638.13f, 4.6219f };
	Var0[1] = { 2306.744f, -400.686f, 86.3213f };
	Var0[2] = { 3505.623f, 3787.041f, 28.9708f };
	Var0[3] = { -1976.225f, 4546.3f, 56.0401f };
	iVar19 = 0;
	while (iVar19 <= 3)
	{
		uVar13[iVar19] = func_15(PLAYER::PLAYER_PED_ID(), Var0[iVar19], 1);
		iVar19++;
	}
	fVar18 = uVar13[0];
	iVar20 = 1;
...
void func_32()
{
	...
	func_684();
	func_674();
	switch (Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_1)
	{
		case 0:
			if (func_673())
			{
		...
		case 1:
			if (func_673())
			{
				...
				if (bLocal_100)
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 8))
					{
						func_631();
						GAMEPLAY::SET_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 8);
					}
				}
				...
				if (GAMEPLAY::IS_BIT_SET(Local_113.f_2, 6))
				{
					func_666(4);
				}
			}
			else if (bLocal_100)
			{
				...
				{
					func_633(0);
					if (GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 0))
					{
						func_666(8);
					}
					else
			...
			if (!GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 7))
			{
				func_562(-1, 0, 0, -1, 0, 0);
				GAMEPLAY::SET_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 7);
			}
		...
		case 2:
			...
			if (func_673())
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 11))
				{
					func_859();
					return;
				}
			...
			func_86();
			func_315();
			if (GAMEPLAY::IS_BIT_SET(Local_113.f_2, 0))
			{
				if (func_673())
				{
					func_633(10);
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_113.f_2, 1))
			{
				if (func_628(NETWORK::PARTICIPANT_ID_TO_INT()))
				{
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_113.f_2, 2))
			{
				if (func_673())
				{
					func_633(12);
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_113.f_2, 3))
			{
				if (func_673())
				{
					if (func_81())
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_113.f_2, 4))
			{
				if (func_673())
				{
					func_633(16);
...
int func_47(int iParam0)
{
	switch (iParam0)
	{
		...
		case 180:
		case 148:
			if (Global_1590535[PLAYER::PLAYER_ID()] == 148 && func_41(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_35, 1))
			{
				return 1;
			}
			else
...
{
	iVar0 = 2;
	bVar1 = ((func_78(iParam0) && !func_77(iParam0)) && !GAMEPLAY::IS_BIT_SET(Global_1628237[iParam0].f_1, 8));
...
{
	if (!GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 6))
	{
		if (iParam0 != func_11())
		{
			func_83(0, iParam0);
		...
		GAMEPLAY::SET_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 6);
	}
}
...
void func_86()
{
	...
	Var0.f_18 = -1;
	Var0.f_19 = -1;
	if (!GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 5))
	{
		if (GAMEPLAY::IS_BIT_SET(Local_113.f_2, 3))
		{
			...
			GAMEPLAY::SET_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 5);
		}
		else if (GAMEPLAY::IS_BIT_SET(Local_113.f_2, 0))
		{
			if (func_664(PLAYER::PLAYER_ID(), func_16(), 1))
	...
	switch (iParam0)
	{
		...
		case 190:
			if (func_105())
			{
				...
				{
					Var7 = { func_133() };
					unk_0x8586789730B10CAF(iParam1, GAMEPLAY::GET_HASH_KEY(func_132(Var7)), func_131(Var7), iParam4);
				}
			}
			else if (func_134())
			{
		...
		case 226:
			if (func_117())
			{
				if (!func_134())
				{
					unk_0x8586789730B10CAF(iParam1, GAMEPLAY::GET_HASH_KEY(func_132(func_116(PLAYER::PLAYER_ID()))), 5, iParam4);
				}
			}
			else if (func_134())
			{
	...
	if (iParam4 == -592022605 || iParam4 == -1915191729)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam1))
		{
			if (ENTITY::IS_ENTITY_A_PED(iParam1))
			{
				...
				func_145(PED::GET_PED_BONE_COORDS(uVar1, 31086, 0f, 0f, 0f), iVar0, 0, sParam8, iParam10);
			}
		}
	}
	else
...
void func_161(int iParam0, int iParam1, int iParam2)
{
	if (func_180())
	{
		...
		if (func_167(PLAYER::PLAYER_ID()))
		{
			...
			Global_1590535[PLAYER::PLAYER_ID()].f_211.f_6 = func_165(iParam0, 1);
		}
...
int func_178(int iParam0)
{
	if (iParam0 < 0)
	{
		if (GAMEPLAY::ABSI(iParam0) > func_168(PLAYER::PLAYER_ID()))
		{
...
int func_199(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iParam1) || iParam5)
	{
		...
		UI::_SET_NOTIFACTION_COLOR_NEXT(func_208(iParam1, -2, 1, 0, 0));
		UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(func_206(&Var1));
		if (!iParam3 == 0)
		{
...
int func_208(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_235(PLAYER::PLAYER_ID()) || (func_234() && func_233())) && !GAMEPLAY::IS_BIT_SET(Global_2537071.f_4591, 31)) && !bParam4)
	{
		uVar1 = func_232();
				...
				if (NETWORK::_NETWORK_GET_PED_PLAYER(iVar1) != -1)
				{
					if (func_5(NETWORK::_NETWORK_GET_PED_PLAYER(iVar1), 0, 1))
					{
						if ((iParam1 > -1 && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
						{
							...
							{
								return func_220(iParam0, NETWORK::_NETWORK_GET_PED_PLAYER(iVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
	...
	if ((iParam1 > -1 && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
	{
		...
		{
			return func_220(iParam0, PLAYER::PLAYER_ID(), iParam1, bParam2, bParam3);
		}
	}
	return func_220(iParam0, PLAYER::PLAYER_ID(), iParam1, bParam2, bParam3);
}
...
int func_210(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if (bParam1)
	{
		if (iParam2 > -1)
		{
			if (func_173(iVar0, iParam2, 0) && !GAMEPLAY::IS_BIT_SET(Global_4456448.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_214(1);
...
int func_220(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar1)
	{
		if (iVar0 != -1)
		{
			...
			if ((func_222(iParam1, iParam0, iVar0, 0) && !GAMEPLAY::IS_BIT_SET(Global_4456448.f_15, 18)) || ((func_173(PLAYER::GET_PLAYER_TEAM(iParam1), PLAYER::GET_PLAYER_TEAM(iParam0), 0) && GAMEPLAY::IS_BIT_SET(Global_4456448.f_15, 23)) && !GAMEPLAY::IS_BIT_SET(Global_4456448.f_15, 18)))
			{
				return func_214(1);
			}
...
int func_230(int iParam0, int iParam1, bool bParam2)
{
	...
	if (iParam0 > -1 && iParam1 != func_11())
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_4456448.f_15, 26) && !func_173(iParam0, PLAYER::GET_PLAYER_TEAM(iParam1), 0))
		{
			iVar0 = func_221(1);
		}
	}
...
var func_257(struct<5> Param0, int iParam5)
{
	...
	else if (iParam0 == 190)
	{
		if (uParam1->f_10 > 0)
		{
			if (func_105())
			{
				...
				iVar7 = func_281(PLAYER::PLAYER_ID(), Var0, *uParam3);
				if (Var0.f_1 == 1)
				{
	...
	else if (iParam0 == 168)
	{
		if (bParam1)
		{
			if (func_118(PLAYER::PLAYER_ID()))
			{
				if (uParam2->f_5)
				{
					*iParam3 = (*iParam3 + func_294(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_182));
				}
				else
				{
					*uParam4 = uParam2->f_7;
...
int func_294(int iParam0)
{
	if (func_301(iParam0))
	{
		...
		if (iVar1 < func_295(iParam0))
		{
			...
			{
				iVar0 = (iVar0 + func_299(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 6)));
				iVar2++;
			}
		}
	}
...
void func_315()
{
	if (GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 7))
	{
		...
		GAMEPLAY::CLEAR_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 7);
	}
}
...
bool func_386(int iParam0, bool bParam1)
{
	if (Global_1590373 != func_11())
	{
		...
		if (bParam1)
		{
			...
			{
				if (GAMEPLAY::IS_BIT_SET(Global_2425662[Global_1590373].f_195, 24) || func_387(Global_1590373))
				{
					return 1;
				}
			}
...
int func_416(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iVar0 != 0)
	{
		unk_0x501478855A6074CE(func_328(func_137()), func_327(func_137()), func_434(), func_433(), iVar1, iVar0);
	}
	func_418(iVar0);
	func_417(iVar0);
	return iVar0;
...
void func_437(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, int iParam5, bool bParam6, int iParam7)
{
	...
	if (func_559() || iParam2 == 28)
	{
		...
		{
			func_508(1);
			if ((!func_506() && !func_504()) || GAMEPLAY::IS_BIT_SET(Global_2537071.f_4588, 1))
			{
				if (func_503())
				{
					func_499();
						...
						while (iVar52 < 32)
						{
							...
							if ((func_492(iVar35) && func_488(iVar35, iParam2)) && func_5(iVar35, 0, 1))
							{
								...
								*uParam4[iVar52] = { func_160(iVar35) };
								...
								if (func_468(iParam5))
								{
									func_467(iVar35, uParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar43, iVar47, &Var57, uParam0[iVar52]->f_40, iVar48, bParam6);
								}
								else
								{
									func_467(iVar35, uParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar46, iVar47, &Var57, uParam0[iVar52]->f_40, iVar48, bParam6);
								}
							...
							if (func_492(iVar35))
							{
								if (func_5(PLAYER::INT_TO_PLAYERINDEX(iVar52), 0, 1))
								{
									...
									*uParam4[iVar52] = { func_160(iVar35) };
									...
									uParam3->f_38[iVar44].f_1 = iVar53;
									func_450(iVar35, PLAYER::GET_PLAYER_NAME(iVar35), uParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar51, iVar50);
									iVar53++;
								}
							}
							iVar52++;
		...
		if (iVar2 != func_11())
		{
			if (func_5(iVar2, 0, 1))
			{
				if (uParam0->f_38[iVar0].f_1 != -1)
				{
					...
					func_448(uParam1, uParam0->f_38[iVar0].f_1, iVar1, Global_1590535[iVar0].f_211.f_6);
				}
			}
		}
		iVar0++;
...
int func_503()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2537071.f_4588, 0) && func_79())
	{
		return 1;
	}
	if (GAMEPLAY::IS_BIT_SET(Global_2537071.f_4588, 1) && func_79())
	{
		return 1;
	}
	return 0;
...
char* func_517(var uParam0)
{
	...
	switch (func_44(PLAYER::PLAYER_ID()))
	{
		...
		case 192:
			if (func_518(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_181))
			{
				return "GB_DPAD_BSET";
			}
			return "GB_DPAD_BBUY";
...
{
	if (iParam0 == 20 && (!func_456() || GAMEPLAY::IS_STRING_NULL_OR_EMPTY(uParam1)))
	{
		uVar0 = func_532();
		return uVar0;
	}
...
int func_536()
{
	...
	else if (!func_542(PLAYER::PLAYER_ID(), 1, 0) && Global_1311716[0] > 0)
	{
		return 0;
	}
...
void func_585()
{
	...
	Var0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(func_16()), 0) };
	Var3 = { ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0) };
	fVar6 = SYSTEM::VDIST(Var0, Var3);
	if (fVar6 < 25f)
	{
		GRAPHICS::DRAW_MARKER(2, Var0 + Vector(2f, 0f, 0f), 0f, 0f, 0f, 180f, 0f, 0f, 0.5f, 0.5f, 0.5f, uLocal_94[0], uLocal_94[1], uLocal_94[2], 100, 1, 1, 2, 0, 0, 0, 0);
	}
}
...
{
	iVar0 = func_44(PLAYER::PLAYER_ID());
	if (((func_384(Global_1590535[PLAYER::PLAYER_ID()].f_274.f_28) || func_612(PLAYER::PLAYER_ID())) || func_611(PLAYER::PLAYER_ID())) || func_610(PLAYER::PLAYER_ID()))
	{
...
int func_628(int iParam0)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_135[iParam0].f_2, 0))
	{
		return 0;
	}
	return 1;
...
char* func_648()
{
	...
	if (iVar0 != func_11())
	{
		...
		uVar1 = func_649(&(Global_1628237[iVar0].f_11.f_104));
...
char* func_657(int iParam0)
{
	if (iParam0 == PLAYER::PLAYER_ID())
	{
		uVar0 = func_649(&(Global_1628237[iParam0].f_11.f_104));
		return uVar0;
	}
	...
	if (iVar1 != func_11())
	{
		uVar0 = func_649(&(Global_1628237[iVar1].f_11.f_104));
...
int func_663()
{
	if ((func_5(PLAYER::PLAYER_ID(), 1, 1) && !UI::IS_PAUSE_MENU_ACTIVE()) && !func_552())
	{
		return 1;
	}
	return 0;
...
void func_666(int iParam0)
{
	...
	{
		case 0:
			if (!GAMEPLAY::IS_BIT_SET(iLocal_92, iParam0))
			{
				if (func_672(0))
				{
...
{
	if ((((!func_552() && !UI::IS_PAUSE_MENU_ACTIVE()) && !UI::IS_RADAR_HIDDEN()) && func_5(PLAYER::PLAYER_ID(), 1, 1)) && !func_79())
	{
		if (bParam0)
		{
			if (!UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
...
void func_674()
{
	...
	if (func_680(PLAYER::PLAYER_ID(), Global_262145.f_12494, &uVar1, func_682(&uLocal_111, 13, -1), 1123024896, 0))
	{
	...
	switch (func_677(NETWORK::PARTICIPANT_ID_TO_INT()))
	{
		...
		case 1:
			...
			{
				uLocal_112 = NETWORK::GET_NETWORK_TIME();
			}
			if (iVar0 && !func_682(&uLocal_111, 3, -1))
			{
				if (!func_682(&uLocal_111, 1, -1))
				{
					...
					if (AUDIO::PREPARE_MUSIC_EVENT(uVar2) && func_682(&uLocal_111, 11, -1))
					{
	...
	if (func_682(&uLocal_111, 6, -1) && (func_682(&uLocal_111, 5, -1) || func_677(NETWORK::PARTICIPANT_ID_TO_INT()) == 2))
	{
	...
	if (func_21(&(Local_113.f_16)) && func_683(Local_113.f_16, 10000, 0))
	{
		if (!func_682(&uLocal_111, 10, -1))
		{
			...
			AUDIO::PLAY_SOUND_FRONTEND(iLocal_110, "10s", "MP_MISSION_COUNTDOWN_SOUNDSET", 0);
...
void func_684()
{
	switch (Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_1)
	{
		case 1:
			if (func_673())
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 3))
				{
					if (func_685(82, "GB_INTTXT_HBB", 2, 0, 0, 0, 0, 1, 0, 1))
					{
						GAMEPLAY::SET_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 3);
					}
				}
			}
			else if (func_664(PLAYER::PLAYER_ID(), func_16(), 0))
...
int func_687(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_19665)
	{
		if (Global_19486.f_1 == 6)
		{
			...
			func_690(1);
			func_693(Global_19467, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19466), -1082130432, -1082130432, -1082130432);
		}
	}
					...
					if (iVar0 == Global_7363[iVar1].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (Global_2460675)
							{
								if (iVar1 == 14)
								{
									func_691(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1].f_10), SYSTEM::TO_FLOAT(Global_21868), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
								}
							}
							Global_7925[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7363[iVar1].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_691(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1].f_10), SYSTEM::TO_FLOAT(Global_21873), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76622)
								{
									...
									func_691(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19486)
									...
									func_691(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7363[iVar1].f_10 == 57 && iVar1 == 23)
							{
								...
								func_691(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
							}
							else
							{
								func_691(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
							}
							Global_7925[iVar0] = 1;
						}
					}
...
{
	if (func_708(sParam0, PLAYER::GET_PLAYER_NAME(uParam1), sParam2, bParam4, iParam3))
	{
		Global_1312585 = 14;
	...
	switch (Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_1)
	{
		case 0:
			if (!func_17(Local_113.f_7))
			{
				if (func_664(PLAYER::PLAYER_ID(), func_16(), 1))
				{
					if (func_750(PLAYER::PLAYER_ID(), Global_262145.f_12494, &uVar0, 1123024896, 0))
					{
						if (UI::DOES_BLIP_EXIST(uLocal_90))
						{
							UI::REMOVE_BLIP(&uLocal_90);
						}
					}
					else if (!UI::DOES_BLIP_EXIST(uLocal_90))
					{
						uLocal_90 = UI::ADD_BLIP_FOR_COORD(Local_113.f_7);
						UI::_0x75A16C3DA34F1245(uLocal_90, 1);
						UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_90, "GB_HTB_BLIP1");
						UI::SET_BLIP_FLASHES(uLocal_90, 1);
						UI::SET_BLIP_FLASH_TIMER(uLocal_90, 7000);
						UI::SET_BLIP_SPRITE(uLocal_90, 458);
						UI::SET_BLIP_PRIORITY(uLocal_90, 12);
						UI::SET_BLIP_SCALE(uLocal_90, Global_262145.f_12355);
						func_749(&uLocal_90, iLocal_81);
					}
					if (!UI::DOES_BLIP_EXIST(uLocal_89))
					{
						uLocal_89 = UI::ADD_BLIP_FOR_RADIUS(Local_113.f_7, SYSTEM::TO_FLOAT((Global_262145.f_12494 - 1)));
						func_749(&uLocal_89, iLocal_81);
						UI::_0x75A16C3DA34F1245(uLocal_89, 1);
						UI::_0xC4278F70131BAA6D(uLocal_89, 1);
						UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_89, "GB_HTB_BLIP0");
					}
					if (func_748(Local_113.f_5) != iLocal_93)
					{
						iLocal_93 = func_748(Local_113.f_5);
						UI::SET_BLIP_ALPHA(uLocal_89, iLocal_93);
					}
				}
			}
			break;
		...
		case 1:
			...
			{
				func_746();
				if (!GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 4))
				{
					if (!func_21(&(Local_113.f_16)) && !func_21(&(Local_113.f_18)))
					{
						if (!GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 2))
						{
							func_745(1, 0);
							GAMEPLAY::SET_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 2);
						}
					}
					else if (GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 2))
					{
						func_745(0, 0);
						GAMEPLAY::CLEAR_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 2);
					}
				}
			}
			else
			{
				...
				if (!func_664(PLAYER::PLAYER_ID(), func_16(), 0))
				{
					if (bLocal_100)
					{
						if (Local_135[NETWORK::NETWORK_GET_PARTICIPANT_INDEX(Local_113.f_5)].f_1 == 1 && !GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::NETWORK_GET_PARTICIPANT_INDEX(Local_113.f_5)].f_2, 2))
						{
							if (!GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 10))
							{
								...
								GAMEPLAY::SET_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 10);
							}
						}
						else if (GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 10))
						{
							...
							GAMEPLAY::CLEAR_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 10);
						}
					}
				}
			}
			if (!func_17(Local_113.f_7))
			{
				...
				if (!UI::DOES_BLIP_EXIST(uLocal_89))
				{
					...
					UI::_0xC4278F70131BAA6D(uLocal_89, 1);
					UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_89, "GB_HTB_BLIP0");
					UI::SET_BLIP_ALPHA(uLocal_89, Global_262145.f_12239);
				}
...
int func_736(int iParam0)
{
	...
	if (GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()) == func_737())
	{
		return 1;
	}
	return 0;
...
void func_744()
{
	if (GAMEPLAY::IS_BIT_SET(Local_135[func_16()].f_2, 4))
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 9))
		{
			if (func_16() != func_137())
			{
				AUDIO::PLAY_SOUND_FRONTEND(-1, "Boss_Blipped", "GTAO_Magnate_Hunt_Boss_SoundSet", 0);
				GAMEPLAY::SET_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 9);
			}
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 9))
	{
		GAMEPLAY::CLEAR_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 9);
	}
}
...
void func_745(bool bParam0, bool bParam1)
{
	if ((!SCRIPT::IS_THREAD_ACTIVE(Global_2416079.f_1595) || Global_2416079.f_1595 == SCRIPT::GET_ID_OF_THIS_THREAD()) || bParam1)
	{
		if (bParam0)
		{
			...
			GAMEPLAY::SET_BIT(&(Global_2425662[PLAYER::PLAYER_ID()].f_68.f_2), 23);
		}
		else
		{
			Global_2416079.f_1595 = -1;
			GAMEPLAY::CLEAR_BIT(&(Global_2425662[PLAYER::PLAYER_ID()].f_68.f_2), 23);
		}
	}
	else if (!bParam1)
	{
...
void func_746()
{
	...
	else if (func_21(&uLocal_108))
	{
		...
		{
			func_8(&uLocal_108);
			GAMEPLAY::CLEAR_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 4);
	...
	{
		if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_102) > IntToFloat(Global_262145.f_12491))
		{
			func_8(&uLocal_106);
			if (GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 4))
			{
		...
		else if (IntToFloat(func_731(&uLocal_106, 0, 0)) > Global_262145.f_12492)
		{
			...
			if (!GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 4))
			{
				GAMEPLAY::SET_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 4);
			}
		}
		iLocal_105++;
	}
...
void func_747(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	if ((!SCRIPT::IS_THREAD_ACTIVE(Global_2416079.f_1573) || Global_2416079.f_1573 == SCRIPT::GET_ID_OF_THIS_THREAD()) || bParam4)
	{
		if (bParam0)
		{
			...
			GAMEPLAY::SET_BIT(&(Global_2425662[PLAYER::PLAYER_ID()].f_68.f_2), 19);
			Global_2416079.f_1574 = NETWORK::GET_NETWORK_TIME();
		}
		else
		{
			Global_2416079.f_1573 = -1;
			GAMEPLAY::CLEAR_BIT(&(Global_2425662[PLAYER::PLAYER_ID()].f_68.f_2), 19);
		}
		Global_2425662[PLAYER::PLAYER_ID()].f_68.f_4 = iParam2;
		Global_2425662[PLAYER::PLAYER_ID()].f_68.f_5 = iParam3;
...
void func_753(int iParam0)
{
	...
	if (iVar2 == func_16())
	{
		if (ENTITY::DOES_ENTITY_EXIST(Var4.f_1))
		{
			if (ENTITY::IS_ENTITY_A_PED(Var4.f_1))
			{
				...
				if (PED::IS_PED_A_PLAYER(uVar1))
				{
					...
					{
						if (GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::NETWORK_GET_PARTICIPANT_INDEX(iVar3)].f_2, 0))
						{
							if (iVar3 != func_11())
							{
								if (func_5(iVar3, 0, 0))
		...
		else
		{
			...
			{
				Local_113.f_6 = iVar3;
				GAMEPLAY::SET_BIT(&(Local_113.f_2), 3);
				func_18(2);
			}
		}
	}
...
void func_759()
{
	...
	{
		case 1:
			if (func_750(PLAYER::PLAYER_ID(), (Global_262145.f_12494 - 1), &uVar0, 1123024896, 0))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 8))
				{
					func_631();
...
void func_760()
{
	...
	if (func_673())
	{
		if (func_775())
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 11))
			{
				GAMEPLAY::SET_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 11);
			}
		}
	}
	switch (func_677(NETWORK::PARTICIPANT_ID_TO_INT()))
	{
		case 1:
			...
			if (bLocal_101)
			{
				if (GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 0))
				{
					GAMEPLAY::CLEAR_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 0);
					if (func_673())
					{
						func_764(0, 0);
						func_763(2);
			...
			else if (func_750(PLAYER::PLAYER_ID(), 500, &uVar0, 1123024896, 0))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 0))
				{
					GAMEPLAY::SET_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 0);
					if (func_673())
					{
						func_764(1, 0);
						func_763(2);
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2, 0))
			{
				GAMEPLAY::CLEAR_BIT(&(Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_2), 0);
				if (func_673())
				{
...
{
	GAMEPLAY::CLEAR_BIT(&Global_1573344, iParam0);
}

void func_763(int iParam0)
{
	GAMEPLAY::SET_BIT(&Global_1573344, iParam0);
}
...
int func_769(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_739() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_28(func_767(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
{
	if ((((func_78(PLAYER::PLAYER_ID()) && !func_77(PLAYER::PLAYER_ID())) && !GAMEPLAY::IS_BIT_SET(Global_1628237[PLAYER::PLAYER_ID()].f_1, 8)) && (func_67(PLAYER::PLAYER_ID()) || func_66(PLAYER::PLAYER_ID()))) || func_17(Param1))
	{
		return;
	}
...
void func_797(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Global_2425662[Global_2439138.f_1894.f_703.f_16].f_404, 0) && func_798())
		{
			iParam0 = 23;
		}
	}
...
{
	Local_135[NETWORK::PARTICIPANT_ID_TO_INT()].f_1 = iParam0;
}
...
void func_828()
{
	...
	UI::GET_HUD_COLOUR(iLocal_81, &(uLocal_94[0]), &(uLocal_94[1]), &(uLocal_94[2]), &(uLocal_94[3]));
}
...
void func_831()
{
	...
	while (iVar0 < 32)
	{
		...
		{
			if (func_664(iVar1, iVar2, 1) || func_832(iVar1, PLAYER::PLAYER_ID()))
			{
...
{
	Local_135[NETWORK::PARTICIPANT_ID_TO_INT()] = iParam0;
}
...
int func_850(bool bParam0)
{
	...
	{
		bVar0 = false;
		if (Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57 != func_11())
		{
			if (func_5(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57, 0, 1))
			{
		...
		if (bVar0)
		{
			if (bParam0)
			{
				...
				if (Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57 != func_11() && NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57))
				{
					Global_1626725 = func_208(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57, -2, 0, 0, 0);
					if (!func_40(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57))
					{
						func_198(88);
					}
				}
...
int func_851()
{
	...
	if (func_737() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_737()) == 0)
		{
			return 1;
		}
	}
...
void func_860(bool bParam0, int iParam1)
{
	...
	if (Global_1628237[PLAYER::PLAYER_ID()].f_11.f_33 != -1)
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Global_1574650.f_1, 14) && !func_78(PLAYER::PLAYER_ID()))
		{
			func_811(0);
		}
	}
...
{
	if (!func_874(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_337[iParam0], func_875(), 0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_337[iParam0] = { func_875() };
	}
	if (!func_874(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_324[iParam0], func_875(), 0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_324[iParam0] = { func_875() };
	}
}
...
{
	if (!func_874(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_150[iParam0], func_875(), 0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_150[iParam0] = { func_875() };
	}
	if (!func_874(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_125[iParam0], func_875(), 0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_125[iParam0] = { func_875() };
	}
}
...
void func_888(int iParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		{
			func_890(iParam0, (Global_1590535[PLAYER::PLAYER_ID()].f_274.f_183[iParam0].f_2 - (func_894(iVar2, bParam2) / 2)));
		}
...
{
	return GAMEPLAY::IS_BIT_SET(Global_1573344, iParam0);
}
...
void func_911(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_135(0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57 = func_137();
	}
	if (func_47(iParam0))
	{
		func_413();
