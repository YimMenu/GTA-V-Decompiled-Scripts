...
void func_20(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_22()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_22()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_28(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_22()].f_6174.f_10, iParam0);
}
		...
		if (iVar5 == 1 && Global_22350.f_5728)
		{
			...
			if (GAMEPLAY::GET_HASH_KEY(&(Global_4268421.f_21)) != 0 && Global_4268421.f_65 != -1)
			{
				...
				if (Global_4268421.f_67 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_109(Global_4268421.f_67), func_106(Global_4268421.f_67, 1), ((Global_22347 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
				}
				fVar51 = (fVar51 + (((UI::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
								...
								if (bVar33)
								{
									...
									if (GAMEPLAY::GET_HASH_KEY(&(Global_22350.f_73[iVar24])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_91() && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(1768762336) > 0)
											{
												if (iVar8 == 0)
												{
...
int func_117(bool bParam0, bool bParam1)
{
	...
	if ((((((((!CAM::IS_SCREEN_FADED_IN() || (func_119(8, -1) && func_118() != 65)) || (UI::GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || NETWORK::_0x2EAC52B4019E2782()) || Global_76882) || Global_22350.f_8416) || UI::IS_WARNING_MESSAGE_ACTIVE()) || Global_98796.f_1417)
	{
		return 0;
	}
	return 1;
...
float func_135(var uParam0)
{
	if (func_138(uParam0))
	{
		...
		{
			return (func_136(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_136(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_142(iParam3), 0);
}
...
int func_145()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			{
				if (func_86(0) || SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(1779901043) > 0)
				{
					func_133();
					return 0;
				}
...
int func_162()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_89, 1) < IntToFloat(iVar0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == 0)
		{
			return 1;
		}
	}
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(cLocal_184))
				{
					if (iLocal_193)
					{
						...
						while (iVar0 <= (iLocal_174 - 1))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(uLocal_103[iVar0], 0) && !func_164(uLocal_103[iVar0], -2017877118))
								{
							...
							{
								uLocal_103[iVar0] = PED::CREATE_PED(25, iLocal_174[iVar0], Local_136[iVar0], fLocal_158[iVar0], 1, 1);
								ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uLocal_103[iVar0], Local_136[iVar0], 0, 0, 1);
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(cLocal_184))
				{
					if (iLocal_193)
					{
						...
						while (iVar1 <= (iLocal_174 - 3))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(uLocal_103[iVar1], 0) && !func_164(uLocal_103[iVar1], -2017877118))
								{
									ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uLocal_103[iVar1], Local_136[iVar1], 0, 0, 1);
									if (iVar1 != 2 && iVar1 != 3)
									{
							...
							{
								uLocal_103[iVar1] = PED::CREATE_PED(25, iLocal_174[iVar1], Local_136[iVar1], fLocal_158[iVar1], 1, 1);
			...
			if (func_165())
			{
				...
				while (iVar2 < 3)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_166[iVar2]))
					{
						...
						else if (func_14(iLocal_166[iVar2]) && STREAMING::HAS_MODEL_LOADED(767028979))
						{
							iLocal_170[iVar2] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_166[iVar2], 25, 767028979, -1, 1, 1);
					...
					{
						iLocal_166[iVar2] = VEHICLE::CREATE_VEHICLE(iLocal_182, Local_122[iVar2], fLocal_132[iVar2], 1, 1, 0);
				...
				{
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(767028979);
				}
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0, 30))
	{
		if (GAMEPLAY::IS_BIT_SET(uParam0, 29))
		{
			switch (func_171(uParam0))
			{
				...
				case 6:
					return AUDIO::REQUEST_SCRIPT_AUDIO_BANK(cParam1, GAMEPLAY::IS_BIT_SET(uParam0, 27), -1);
					break;
	...
	if (Local_83.f_1 == 1 || Local_83.f_1 == 2)
	{
		switch (Local_83)
		{
			case 0:
				...
				Local_136[0] = { -157.19f, -1555.36f, 35.07f };
				Local_136[1] = { -157.04f, -1557.57f, 35.11f };
				Local_136[2] = { -159.83f, -1557.39f, 34.96f };
				Local_136[3] = { -156.64f, -1551.96f, 34.92f };
				Local_136[4] = { -156.25f, -1552.58f, 34.93f };
				Local_136[5] = { -153.23f, -1553.05f, 34.93f };
				Local_136[6] = { -155.3f, -1556.41f, 35.13f };
			...
			case 1:
				...
				Local_136[0] = { 367.24f, 293.81f, 103.41f };
				Local_136[1] = { 368.73f, 296.89f, 103.41f };
				Local_136[2] = { 366.94f, 296.34f, 103.43f };
				Local_136[3] = { 375.21f, 291.85f, 103.25f };
				Local_136[4] = { 374.81f, 292.47f, 103.26f };
				Local_136[5] = { 371.51f, 291.85f, 103.31f };
				Local_136[6] = { 373.86f, 296.3f, 103.31f };
				fLocal_158[0] = -64.83f;
			...
			case 2:
				...
				Local_136[0] = { -809.45f, -2554.82f, 13.76f };
				Local_136[1] = { -808.47f, -2552.43f, 13.76f };
				Local_136[2] = { -806.32f, -2552.87f, 13.76f };
				Local_136[3] = { -808.59f, -2559.5f, 13.76f };
				Local_136[4] = { -809.1f, -2558.97f, 13.76f };
				Local_136[5] = { -812.82f, -2559.48f, 13.76f };
				Local_136[6] = { -810.72f, -2555.37f, 13.76f };
				fLocal_158[0] = -86.65f;
			...
			case 3:
				...
				Local_201 = { -1000.759f, -2436.092f, 17.16946f };
				Local_204 = { -986.7399f, -2424.87f, 22.16946f };
				Local_136[0] = { 778.16f, -1158.78f, 28.88f };
				Local_136[1] = { 780.82f, -1158.1f, 28.73f };
				Local_136[2] = { 781.52f, -1158.81f, 28.7f };
				Local_136[3] = { 779.16f, -1165.74f, 28.72f };
				Local_136[4] = { 779.86f, -1165.52f, 28.72f };
				Local_136[5] = { 780.75f, -1161.99f, 28.65f };
				Local_136[6] = { 783.8f, -1165.61f, 28.74f };
			...
			case 4:
				...
				fLocal_116 = 258.32f;
				Local_136[0] = { -1065.07f, -1151.02f, 2.16f };
				Local_136[1] = { -1065.35f, -1149.36f, 2.16f };
				Local_136[2] = { -1067.13f, -1151.68f, 2.16f };
				Local_136[3] = { -1066.3f, -1149.38f, 2.16f };
				Local_136[4] = { -1066.01f, -1152.26f, 2.16f };
				fLocal_158[0] = 75.06f;
	...
	else if (Local_83.f_1 == 3)
	{
		switch (Local_83)
		{
			case 5:
				...
				fLocal_116 = 351.81f;
				Local_122[0] = { 3073.57f, 648.09f, 0.01f };
				fLocal_132[0] = 5.72f;
				Local_122[1] = { 3071.53f, 648.79f, -0.09f };
				fLocal_132[1] = 351.33f;
				Local_122[2] = { 3068.73f, 645.53f, -0.07f };
			...
			case 6:
				...
				fLocal_116 = 222.9f;
				Local_122[0] = { 3456.64f, 5195.91f, 0.12f };
				fLocal_132[0] = 211.54f;
				Local_122[1] = { 3453.19f, 5192.84f, -0.17f };
				fLocal_132[1] = 201.55f;
				Local_122[2] = { 3451.06f, 5189.43f, -0.3f };
			...
			case 7:
				...
				fLocal_116 = 163.95f;
				Local_122[0] = { 198.62f, 3620.46f, 29.91f };
				fLocal_132[0] = 175.4f;
				Local_122[1] = { 202.78f, 3619.69f, 29.87f };
				fLocal_132[1] = 163.69f;
				Local_122[2] = { 210.14f, 3618.88f, 29.87f };
			...
			case 8:
				...
				fLocal_116 = 180.09f;
				Local_122[0] = { 643.09f, -2146.11f, -0.09f };
				fLocal_132[0] = 143.89f;
				Local_122[1] = { 638.21f, -2145.3f, -0.1f };
				fLocal_132[1] = 172.41f;
				Local_122[2] = { 633.56f, -2143.83f, -0.04f };
...
int func_181()
{
	...
	if (func_65(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (((func_14(uVar0) && PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uVar0)) && !func_203(PLAYER::PLAYER_PED_ID(), uVar0, -1)) && ENTITY::GET_ENTITY_MODEL(uVar0) != -956048545)
		{
			return 0;
		}
	}
	...
	if (!func_167())
	{
		...
		while (iVar1 <= (iLocal_170 - 1))
		{
			if (func_65(iLocal_170[iVar1]))
			{
				...
				{
					AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_166[iVar1], 30f, 786597);
				}
				else
				{
					AI::TASK_WANDER_STANDARD(0, 1193033728, 0);
	...
	if (func_183())
	{
		...
		while (iVar4 <= (iLocal_170 - 1))
		{
			...
			if (func_65(iLocal_170[iVar4]))
			{
				...
				{
					AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_166[iVar4], 50f, 786468);
				}
				else
				{
					AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
		...
		switch (Local_83)
		{
			case 0:
				Global_111612[0] = 1;
				Global_111618[0] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 1:
				Global_111612[1] = 1;
				Global_111618[1] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 2:
				Global_111612[2] = 1;
				Global_111618[2] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 3:
				Global_111612[3] = 1;
				Global_111618[3] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 4:
				Global_111612[4] = 1;
				Global_111618[4] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 5:
				Global_111602[0] = 1;
				Global_111607[0] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 6:
				Global_111602[1] = 1;
				Global_111607[1] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 7:
				Global_111602[2] = 1;
				Global_111607[2] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 8:
				Global_111602[3] = 1;
				Global_111607[3] = GAMEPLAY::GET_GAME_TIMER();
				break;
		}
		return 0;
	}
...
bool func_187(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_188(&(Local_40[iVar4]), Var1, iParam1, &(Local_40[iVar4].f_3), iParam0, iParam5);
...
int func_204()
{
	...
	{
		case 5:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24971.f_2, 0);
			break;
		
		case 6:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24971.f_2, 1);
			break;
		
		case 7:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24971.f_2, 2);
			break;
		
		case 8:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24971.f_2, 3);
			break;
		
		case 0:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24974.f_3, 0);
			break;
		
		case 1:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24974.f_3, 1);
			break;
		
		case 2:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24974.f_3, 2);
			break;
		
		case 3:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24974.f_3, 3);
			break;
		
		case 4:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24974.f_3, 4);
			break;
	}
	return 0;
}
...
int func_211(int iParam0)
{
	...
	{
		case 0:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24974.f_1, 0);
			break;
		
		case 1:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24974.f_1, 1);
			break;
		
		case 2:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24974.f_1, 2);
			break;
		
		case 3:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24974.f_1, 3);
			break;
		
		case 4:
			return GAMEPLAY::IS_BIT_SET(Global_111638.f_24974.f_1, 4);
			break;
	}
	return 0;
}
	...
	while (iVar0 < 3)
	{
		if (func_15(iLocal_170[iVar0]))
		{
			if (func_15(iLocal_166[iVar0]))
			{
				...
				AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_170[iVar0], iLocal_166[iVar0], 20f, 786599);
