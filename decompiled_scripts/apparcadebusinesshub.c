...
void func_57()
{
	...
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_140))
		{
			iVar0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_140);
			if (!func_4())
			{
				switch (iVar0)
				{
...
void func_91()
{
	...
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_139))
		{
			iVar0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_139);
...
void func_95(int iParam0, int iParam1, bool bParam2)
{
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(sLocal_142) || Global_1695700 == -1)
	{
	}
	else
	{
...
void func_109()
{
	if (!MISC::IS_BIT_SET(iLocal_122, 2) && !func_4())
	{
		if (!MISC::IS_BIT_SET(iLocal_122, 6))
		{
			...
			iLocal_140 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
...
void func_110()
{
	if (func_111())
	{
		if (!MISC::IS_BIT_SET(iLocal_122, 2))
		{
			...
			iLocal_139 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
...
void func_154()
{
	if (MISC::GET_FRAME_COUNT() != Global_1695700.f_5)
	{
...
int func_182(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_212(PLAYER::PLAYER_ID()) || (func_211() && func_210())) && !MISC::IS_BIT_SET(Global_2540612.f_4655, 31)) && !bParam4)
	{
		iVar1 = func_209();
...
int func_219(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
	...
	if (!Global_19865)
	{
		if (Global_19681.f_1 == 6)
		{
			...
			func_221(1);
			func_223(Global_19662, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19661), -1082130432, -1082130432, -1082130432);
		}
	}
...
int func_242(int iParam0)
{
	...
	if (func_52(iParam0, 0, 1))
	{
		...
		iVar1 = ((iVar0 + func_243()) - NETWORK::GET_CLOUD_TIME_AS_INT());
		return iVar1;
	}
	return -1;
}
...
void func_263(bool bParam0, bool bParam1, int iParam2)
{
	...
	if (Global_1630317[PLAYER::PLAYER_ID() /*595*/].f_11 != PLAYER::PLAYER_ID())
	{
		...
		if (MISC::IS_BIT_SET(Global_2540612.f_1797, 15))
		{
			MISC::CLEAR_BIT(&(Global_2540612.f_1797), 15);
		}
		if (func_292(15))
		{
			func_291(15);
...
void func_281(int iParam0, int iParam1, char* sParam2, int iParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	char cVar2[32];
...
struct<16> func_284(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2589380[iParam0 /*3*/][func_282(iParam2)];
	iVar1 = Global_2589380[iParam1 /*3*/][func_282(iParam2)];
...
void func_286(char* sParam0, bool bParam1)
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		...
		if (bVar16)
		{
			StringCopy(&(Global_1630317[PLAYER::PLAYER_ID() /*595*/].f_11.f_333), sParam0, 64);
		}
	}
}
...
int func_311(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2552060[iParam0 /*3*/][func_282(iParam1)];
		if (STATS::STAT_GET_INT(iVar0, &uVar1, -1))
		{
			return uVar1;
		}
...
int func_327(var uParam0, int iParam1, bool bParam2, char* sParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam2)
	{
		...
		{
			Var0 = { func_340(PLAYER::PLAYER_ID()) };
			if (MISC::IS_STRING_NULL_OR_EMPTY(&Var0))
			{
...
int func_329(char* sParam0)
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		...
		while (iVar1 < 32)
		{
			...
			{
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1630317[iVar0 /*595*/].f_11.f_104)) && MISC::ARE_STRINGS_EQUAL(&(Global_1630317[iVar0 /*595*/].f_11.f_104), sParam0))
				{
					return 1;
				}
			}
...
int func_330(char* sParam0)
{
	...
	while (iVar2 <= (HUD::GET_LENGTH_OF_LITERAL_STRING(sParam0) - 1))
	{
		...
		if (!func_331(MISC::GET_HASH_KEY(sVar3), sVar3))
		{
			iVar1 = 0;
		}
		iVar2++;
...
void func_341()
{
	...
	{
		Global_1678289.f_4459 = func_353(PLAYER::PLAYER_ID());
		func_365(1);
	}
	else if (func_342())
	{
...
void func_355()
{
	...
	iLocal_138 = unk_0x67D02A194A2FC2BD("ARCADE_BUSINESS_HUB");
...
int func_356(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
void func_366()
{
	...
	STATS::_0x810B5FCC52EC7FF0(iLocal_125, iVar0, iVar1, iVar2);
}
