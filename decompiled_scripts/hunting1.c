		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (func_308(PLAYER::PLAYER_PED_ID()))
				{
					...
					if (!func_212())
					{
						func_229(PLAYER::PLAYER_PED_ID(), Local_415, fLocal_416, 0, 1);
					}
			...
			if (((Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 1 && Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 0) && Local_260[iVar0 /*54*/].f_52 != 4) && Local_260[iVar0 /*54*/].f_52 != 5)
			{
				if (!func_308(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6))
				{
					if (!Local_260[iVar0 /*54*/][iVar1 /*17*/].f_1)
					{
						...
						Local_421[iVar0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, 1) };
						iLocal_303[iVar0] = 1;
...
void func_323(int iParam0, int iParam1)
{
	...
	switch (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3)
	{
		...
		case 6:
			if (ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0 && ENTITY::IS_ENTITY_AT_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_326(iParam0), 0, 0, 0))
				{
					iVar1 = 0;
					iVar1 = 0;
					while (iVar1 < 3)
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_212())
				{
					func_229(PLAYER::PLAYER_PED_ID(), Local_377, fLocal_378, 0, 1);
					func_352();
				}
				iLocal_257 = 2;
			}
	...
	while (iVar0 < 5)
	{
		...
		switch (Local_259[iVar0 /*29*/].f_13)
		{
			...
			case 8:
				...
				{
					Var2 = { ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_12, 1) };
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_259[iVar0 /*29*/].f_12, 0))
					{
...
int func_372()
{
	...
	if (func_308(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_308(iLocal_348))
		{
			...
			if (func_373(PLAYER::PLAYER_PED_ID(), iLocal_348, 0) <= 10f && MISC::ABSF((Var0.z - Var1.z)) < 1.5f)
			{
				return 1;
			}
		}
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				iLocal_255 = 13;
				MISC::CLEAR_AREA_OF_VEHICLES(Local_376, 50f, 0, 0, 0, 0, 0, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(Local_374, 50f, 0, 0, 0, 0, 0, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(Local_375, 50f, 0, 0, 0, 0, 0, 0);
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				func_380();
				func_354();
				func_353();
				...
				if (!func_212())
				{
					func_229(PLAYER::PLAYER_PED_ID(), Local_358, fLocal_305, 0, 1);
					func_352();
				}
				iLocal_257 = 2;
			}
...
void func_390()
{
	if (!PED::IS_PED_INJURED(iLocal_348) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), Local_385, 0, 1, 0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == 0)
		{
...
void func_393()
{
	...
	if (!bLocal_283)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_357, 5f, 5f, 5f, 0, 1, 0) && func_394(1077936128, 1))
		{
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_212())
				{
					func_229(PLAYER::PLAYER_PED_ID(), Local_356, fLocal_304, 0, 1);
				}
				func_8(&iLocal_262);
				func_228(1);
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_212())
				{
					func_229(PLAYER::PLAYER_PED_ID(), Local_380, fLocal_381, 0, 1);
					func_352();
				}
				func_228(1);
				MISC::CLEAR_AREA_OF_VEHICLES(Local_379, 2f, 0, 0, 0, 0, 0, 0);
				func_7();
				iLocal_257 = 2;
			}
			break;
...
int func_436(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_260(iVar2, iVar6) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_260(iVar2, iVar6)))
			{
				...
				{
					uVar7 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_260(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_260(iVar2, iVar6) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_260(iVar2, iVar6)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_260(iVar2, iVar6));
				func_437(uVar1, func_260(iVar2, iVar6));
			}
		}
		iVar6++;
	}
	...
	if (func_308(PLAYER::PLAYER_PED_ID()))
	{
		...
		switch (iLocal_255)
		{
			...
			case 6:
				...
				else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_361, Local_362, 7f, 0, 1, 0) && func_372())
				{
					if (func_485())
					{
						func_380();
			...
			case 17:
				...
				switch (iLocal_331)
				{
					...
					case 4:
						if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_348, 713668775) == 7 || (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_413, Local_414, 3.5f, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_348, Local_413, Local_414, 3.5f, 0, 1, 0)))
						{
							PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
							iLocal_255 = 18;
						}
			...
			case 18:
				...
				{
					Var0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_413, Local_414, 3.5f, 0, 1, 0) || Var0.z > 41f)
					{
		...
		switch (iLocal_328)
		{
			case 0:
				switch (iParam0)
				{
					...
					case 1:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_348, Local_369, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_482(iLocal_348, fLocal_305, 30f))
						{
							iLocal_328 = 1;
						}
						break;
					...
					case 2:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_348, Local_372, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_482(iLocal_348, fLocal_313, 30f))
						{
							iLocal_328 = 1;
						}
						break;
