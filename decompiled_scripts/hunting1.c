...
int func_273(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_289(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_274(iVar0, 0), 1);
	...
	while (iVar0 < 2)
	{
		...
		while (iVar1 < 3)
		{
			if (((Local_499[iVar0][iVar1].f_3 != 1 && Local_499[iVar0][iVar1].f_3 != 0) && Local_499[iVar0].f_52 != 4) && Local_499[iVar0].f_52 != 5)
			{
				...
				else if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_499[iVar0][iVar1].f_6, 1), 2f, 0))
				{
					iLocal_624 = 0;
					iLocal_628 = 1;
					iLocal_716 = 0;
				...
				case 2:
					...
					while (iLocal_716 < 3)
					{
						if (!Local_499[iVar0][iLocal_716].f_1)
						{
							...
							{
								TASK::TASK_GO_TO_COORD_ANY_MEANS(Local_499[iVar0][iLocal_716].f_6, Local_959[iVar0], MISC::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_323(int iParam0, int iParam1)
{
	if (Local_499[iParam0][iParam1].f_3 != 0 && Local_499[iParam0][iParam1].f_3 != 13)
	{
		...
		{
			PED::SET_PED_INCREASED_AVOIDANCE_RADIUS(Local_499[iParam0][iParam1].f_6);
		}
	...
	switch (Local_499[iParam0][iParam1].f_3)
	{
		...
		case 3:
			...
			{
				Local_499[iParam0][iParam1].f_7 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(3000, 8000));
		...
		case 4:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				if (MISC::GET_GAME_TIMER() > Local_499[iParam0][iParam1].f_7 && Local_499[iParam0][iParam1].f_4 == 0)
				{
		...
		case 5:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				Local_499[iParam0][iParam1].f_10 = MISC::GET_RANDOM_INT_IN_RANGE(0, 8);
				if (!iLocal_650[Local_499[iParam0][iParam1].f_10])
				{
					iLocal_650[Local_499[iParam0][iParam1].f_9] = 0;
					if (Local_499[iParam0][iParam1].f_4 == 0)
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_499[iParam0][iParam1].f_6, Local_921[Local_499[iParam0][iParam1].f_10], 1f, -1, 0.25f, 512, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f));
					}
					...
					{
						TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_499[iParam0][iParam1].f_6, Local_499[iParam0][iLocal_715].f_6, Local_499[iParam0][iParam1].f_11, 1f, -1, 1.5f, 1);
					}
			...
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				if (Local_499[iParam0][iParam1].f_4 == 0 && ENTITY::IS_ENTITY_AT_COORD(Local_499[iParam0][iParam1].f_6, Local_921[Local_499[iParam0][iParam1].f_9], func_326(iParam0), 0, 0, 0))
				{
					...
					while (iVar1 < 3)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
						{
							TASK::CLEAR_PED_TASKS(Local_499[iParam0][iParam1].f_6);
							TASK::TASK_WANDER_IN_AREA(Local_499[iParam0][iParam1].f_6, Local_921[Local_499[iParam0][iParam1].f_9], 7.5f, 0f, 1f);
		...
		case 11:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				...
				{
					TASK::TASK_SMART_FLEE_COORD(Local_499[iParam0][iParam1].f_6, Local_959[iParam0], 50f, -1, 0, 0);
				}
				else
				{
					TASK::TASK_SMART_FLEE_COORD(Local_499[iParam0][iParam1].f_6, Local_499[iParam0][iParam1].f_14, 50f, -1, 0, 0);
				}
		...
		case 12:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				if (iLocal_687[iParam0])
				{
					...
					{
						TASK::TASK_GO_TO_COORD_ANY_MEANS(Local_499[iParam0][iParam1].f_6, Local_959[iParam0], MISC::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_345(int iParam0, int iParam1)
{
	...
	{
		if (!HUD::DOES_BLIP_EXIST(Local_499[iParam0][iParam1]))
		{
			Local_499[iParam0][iParam1] = func_315(Local_499[iParam0][iParam1].f_6, 1, 0, 5);
			if (HUD::DOES_BLIP_EXIST(Local_499[iParam0][iParam1]))
			{
				HUD::SET_BLIP_SCALE(Local_499[iParam0][iParam1], 0.7f);
			}
			if (!ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
...
void func_346(int iParam0, int iParam1)
{
	if (!func_308(Local_499[iParam0][iParam1].f_6))
	{
		...
		Local_499[iParam0][iParam1].f_6 = PED::CREATE_PED(26, iLocal_727, Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f), 1, 1);
		if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6))
		{
...
void func_347(int iParam0, int iParam1)
{
	if (!func_308(Local_499[iParam0][iParam1].f_6))
	{
		...
		if (!iLocal_650[Local_499[iParam0][iParam1].f_10])
		{
			Local_499[iParam0][iParam1].f_5 = MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f);
...
void func_356()
{
	...
	while (iVar0 < 3)
	{
		if (HUD::DOES_BLIP_EXIST(Local_322[iVar0].f_9))
		{
			HUD::REMOVE_BLIP(&(Local_322[iVar0].f_9));
		}
...
void func_364()
{
	...
	while (iVar0 < 5)
	{
		...
		switch (Local_353[iVar0].f_13)
		{
			...
			case 2:
				Local_353[iVar0].f_7 = MISC::GET_RANDOM_INT_IN_RANGE(0, 5);
					...
					if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0].f_28) && !ENTITY::IS_ENTITY_DEAD(Local_353[iVar0].f_28, 0))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0].f_12))
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0].f_11))
							{
								...
								TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_353[iVar0].f_12, Local_353[iVar0].f_28, Local_353[iVar0].f_19, 8f, 0, 0, 786599, 5f, 2f);
								iLocal_705++;
			...
			case 4:
				if (func_308(Local_353[iVar0].f_12) && func_377(Local_353[iVar0].f_28))
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(Local_353[iVar0].f_28, Local_353[iVar0].f_19, 10f, 10f, 10f, 0, 0, 0))
					{
						...
						{
							if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_353[iVar0].f_28, 1), 5f, 1))
							{
								iLocal_629 = 1;
							}
						}
					...
					{
						TASK::CLEAR_PED_TASKS(Local_353[iVar0].f_12);
						VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(Local_353[iVar0].f_28, 0);
						TASK::TASK_VEHICLE_DRIVE_WANDER(Local_353[iVar0].f_12, Local_353[iVar0].f_28, 8f, 786599);
			...
			case 5:
				if (func_308(Local_353[iVar0].f_12) && func_377(Local_353[iVar0].f_28))
				{
					...
					{
						TASK::TASK_VEHICLE_PARK(Local_353[iVar0].f_12, Local_353[iVar0].f_28, Var1, ENTITY::GET_ENTITY_HEADING(Local_353[iVar0].f_28), 3, 270f, 1);
					}
					else if (func_349())
					{
						TASK::TASK_VEHICLE_TEMP_ACTION(Local_353[iVar0].f_12, Local_353[iVar0].f_28, 5, 2000);
					}
					else
					{
						TASK::TASK_VEHICLE_TEMP_ACTION(Local_353[iVar0].f_12, Local_353[iVar0].f_28, 4, 2000);
					}
					func_2();
			...
			case 6:
				if ((func_230(Local_353[iVar0].f_28) && func_308(Local_353[iVar0].f_12)) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (VEHICLE::IS_VEHICLE_STOPPED(Local_353[iVar0].f_28))
					{
						...
						{
							TASK::TASK_LEAVE_VEHICLE(Local_353[iVar0].f_12, Local_353[iVar0].f_28, 1);
						}
						else
						{
							func_369(iVar0);
			...
			case 8:
				if ((func_308(Local_353[iVar0].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1)) && func_377(Local_353[iVar0].f_28))
				{
					...
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_353[iVar0].f_12, 0))
					{
						if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(Var4, 3f, 1))
						{
							...
							TASK::CLEAR_PED_TASKS(Local_353[iVar0].f_12);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_353[iVar0].f_12, 1);
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_353[iVar0].f_12, Local_353[iVar0].f_25, 1f, -1, 0.25f, 0, Local_353[iVar0].f_6);
				...
				if (func_308(Local_353[iVar0].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(Var4, 3f, 1))
					{
						if (ENTITY::IS_ENTITY_AT_COORD(Local_353[iVar0].f_12, Local_353[iVar0].f_25, 1f, 1f, 1f, 0, 0, 1))
						{
							TASK::CLEAR_PED_TASKS(Local_353[iVar0].f_12);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_353[iVar0].f_12, 1);
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_353[iVar0].f_12, Local_353[iVar0].f_28, 0);
			...
			case 10:
				if (func_308(Local_353[iVar0].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(Var4, 3f, 1))
					{
						Local_353[iVar0].f_15 = TASK::GET_SCRIPT_TASK_STATUS(Local_353[iVar0].f_12, -875674219);
			...
			case 11:
				if (func_308(Local_353[iVar0].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(Var4, 3f, 1))
					{
						TASK::OPEN_SEQUENCE_TASK(&(Local_353[iVar0].f_14));
						...
						TASK::CLOSE_SEQUENCE_TASK(Local_353[iVar0].f_14);
						TASK::TASK_PERFORM_SEQUENCE(Local_353[iVar0].f_12, Local_353[iVar0].f_14);
						TASK::CLEAR_SEQUENCE_TASK(&(Local_353[iVar0].f_14));
						Local_353[iVar0].f_8 = MISC::GET_GAME_TIMER() + 20000;
			...
			case 12:
				if (func_308(Local_353[iVar0].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(Var4, 3f, 1))
					{
						if (MISC::GET_GAME_TIMER() > Local_353[iVar0].f_8)
						{
			...
			case 13:
				if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_353[iVar0].f_28, 0), ENTITY::GET_ENTITY_COORDS(Local_353[iVar0].f_12, 1), 0) > 100f)
					{
						Local_353[iVar0].f_13 = 15;
					}
				}
		...
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_800, ENTITY::GET_ENTITY_COORDS(Local_353[iVar0].f_28, 1), 1) > 450f)
			{
				Local_353[iVar0].f_13 = 15;
			}
		}
...
void func_367(int iParam0)
{
	...
	if (func_308(iVar0))
	{
		if (func_377(Local_353[iParam0].f_28))
		{
			...
			TASK::OPEN_SEQUENCE_TASK(&(Local_353[iParam0].f_14));
			TASK::TASK_ENTER_VEHICLE(0, Local_353[iParam0].f_28, 60000, -1, 1f, 1, 0);
			TASK::TASK_VEHICLE_DRIVE_WANDER(0, Local_353[iParam0].f_28, 60f, 786468);
			TASK::CLOSE_SEQUENCE_TASK(Local_353[iParam0].f_14);
			TASK::TASK_PERFORM_SEQUENCE(iVar0, Local_353[iParam0].f_14);
			PED::SET_PED_KEEP_TASK(iVar0, 1);
			TASK::CLEAR_SEQUENCE_TASK(&(Local_353[iParam0].f_14));
		}
...
void func_369(int iParam0)
{
	...
	{
		TASK::CLEAR_PED_TASKS(Local_353[iParam0].f_12);
		...
		if (func_377(Local_353[iParam0].f_28))
		{
			...
			{
				TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_353[iParam0].f_12, Local_353[iParam0].f_28, Local_353[iParam0].f_19, 80f, 1, 0, 786469, 5f, 2f);
				Local_353[iParam0].f_13 = 14;
			}
			else
			{
				TASK::TASK_SMART_FLEE_COORD(Local_353[iParam0].f_12, Local_748, 10000f, -1, 0, 0);
...
int func_372()
{
	if (func_308(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_308(iLocal_734))
		{
			...
			if (func_373(PLAYER::PLAYER_PED_ID(), iLocal_734, 0) <= 10f && MISC::ABSF((Var0.z - Var3.z)) < 1.5f)
			{
				return 1;
			}
		}
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				iLocal_319 = 13;
				MISC::CLEAR_AREA_OF_VEHICLES(Local_800, 50f, 0, 0, 0, 0, 0, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(Local_794, 50f, 0, 0, 0, 0, 0, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(Local_797, 50f, 0, 0, 0, 0, 0, 0);
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				func_380();
				func_354();
				func_353();
		...
		if (!HUD::DOES_BLIP_EXIST(Local_322[iVar0].f_9))
		{
			if (func_230(Local_322[iVar0]))
			{
				if (!Local_322[iVar0].f_7)
				{
					...
					HUD::SET_BLIP_COLOUR(Local_322[iVar0].f_9, 1);
				}
			}
		}
		iVar0++;
...
int func_408()
{
	...
	else
	{
		...
		while (iVar0 < 3)
		{
			MISC::CLEAR_AREA_OF_OBJECTS(Local_322[iVar0].f_1, 2f, 0);
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				func_228(1);
				MISC::CLEAR_AREA_OF_VEHICLES(Local_807, 2f, 0, 0, 0, 0, 0, 0);
				func_7();
				iLocal_321 = 2;
			}
			break;
		...
		switch (iLocal_319)
		{
			...
			case 2:
				if (func_308(iLocal_734))
				{
					if (func_488())
					{
						...
						WEAPON::REMOVE_WEAPON_FROM_PED(iLocal_734, 100416529);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, Local_778, 1f, 60000, 0.25f, 512, Local_322[iLocal_721].f_6);
						PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, 0);
						iLocal_319 = 4;
					}
				}
			...
			case 16:
				if (func_477())
				{
					iLocal_717 = 0;
					func_458();
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, Local_946[0], 1f, 60000, 0.25f, 0, 40000f);
					PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, 1);
					func_314(0, 0);
					iLocal_319 = 17;
				}
			...
			case 17:
				...
				switch (iLocal_717)
				{
					case 0:
						...
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, Local_946[1], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_717++;
						}
						break;
					...
					case 1:
						...
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, Local_946[2], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_717++;
						}
						break;
					...
					case 2:
						...
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, Local_946[3], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_717++;
						}
						break;
					...
					case 4:
						if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_734, 713668775) == 7 || (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_907, Local_910, 3.5f, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_734, Local_907, Local_910, 3.5f, 0, 1, 0)))
						{
							PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, 0);
							iLocal_319 = 18;
						}
...
void func_478()
{
	...
	while (iVar0 < 3)
	{
		if (MISC::IS_BULLET_IN_AREA(Local_322[iVar0].f_1, 10f, 1))
		{
			if (!func_223())
			{
			...
			case 0:
				switch (iParam0)
				{
					case 0:
						...
						if (iLocal_616)
						{
							if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_734, Local_778, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !PED::IS_PED_HEADING_TOWARDS_POSITION(iLocal_734, Local_322[iLocal_721].f_1, 30f))
							{
	...
	if (!bParam1 || iLocal_616)
	{
		if (func_488())
		{
			...
			if (func_308(iLocal_734))
			{
				...
				if (bParam1)
				{
					TASK::TASK_TURN_PED_TO_FACE_COORD(0, Local_322[iLocal_721].f_1, 0);
				}
				if (bParam0)
				{
...
void func_492()
{
	if (!PED::IS_PED_INJURED(iLocal_734))
	{
		if (((MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) - Vector(2f, 2f, 2f), -1813897027, 0) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) - Vector(2f, 2f, 2f), 741814745, 0)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) - Vector(2f, 2f, 2f), 615608432, 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_734, 0), 10f))
		{
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				...
				MISC::CLEAR_AREA_OF_VEHICLES(1804.501f, 3922.917f, 32.8091f, 2f, 0, 0, 0, 0, 0, 0);
			}
			if (bVar4)
			{
				iLocal_79 = 3;
