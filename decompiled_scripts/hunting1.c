...
{
	func_233(&Global_105842, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_252(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2592627[iParam0 /*3*/][func_76(iParam1)];
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				iLocal_319 = 13;
				MISC::CLEAR_AREA_OF_VEHICLES(Local_800, 50f, false, false, false, false, false, false);
				MISC::CLEAR_AREA_OF_VEHICLES(Local_794, 50f, false, false, false, false, false, false);
				MISC::CLEAR_AREA_OF_VEHICLES(Local_797, 50f, false, false, false, false, false, false);
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				func_380();
				func_354();
				func_353();
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				func_228(1);
				MISC::CLEAR_AREA_OF_VEHICLES(Local_807, 2f, false, false, false, false, false, false);
				func_7();
				iLocal_321 = 2;
			}
			break;
...
{
	if (((!func_510(0) || Global_77517) || Global_77506 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77502)
