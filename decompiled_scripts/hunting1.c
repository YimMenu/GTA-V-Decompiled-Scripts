void __EntryFunction__()
{
	...
	uLocal_82 = WEAPON::GET_WEAPONTYPE_MODEL(100416529);
	uLocal_83 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(-767279652);
	uLocal_84 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(-1489156508);
...
void func_224()
{
	if (iLocal_621)
	{
		...
		WEAPON::SET_PED_AMMO_BY_TYPE(PLAYER::PLAYER_PED_ID(), 1285032059, uLocal_723);
	}
	else
	{
		WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), -1569615261, 1);
		WEAPON::REMOVE_WEAPON_FROM_PED(PLAYER::PLAYER_PED_ID(), 100416529);
	}
	bLocal_632 = true;
}
...
void func_228(int iParam0)
{
	...
	if (func_308(iVar0))
	{
		if (!WEAPON::HAS_PED_GOT_WEAPON(iVar0, 100416529, 0))
		{
...
{
	func_233(&Global_105187, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_233(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	*uParam0 = func_221();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_255())
		{
			func_251(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_245(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_268(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_290())
		{
			*uParam0 = func_273(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_270(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_15() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_77(func_271(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_273(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_289(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Param0, func_274(iVar0, 0), 1);
...
var func_291()
{
	...
	func_294(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_293(&uVar0, TIME::GET_CLOCK_MONTH());
	func_292(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
	...
	if (iLocal_724 < 3)
	{
		if (!bLocal_641)
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_769, Local_772, 20f, 0, 1, 0))
			{
				...
				if (iLocal_659[17])
				{
					if (!func_223() || GAMEPLAY::GET_PROFILE_SETTING(203) == 0)
					{
						if (!iLocal_633)
						{
							if (iLocal_724 == 0)
...
void func_311()
{
	Var0[0] = { 1815.183f, 3887.537f, 32.7844f };
	Var0[1] = { 1627.545f, 3578.125f, 34.148f };
	Var0[2] = { 1574.247f, 3667.258f, 33.3797f };
	Var0[3] = { 1600.847f, 3605.45f, 34.1463f };
	fVar13[0] = 114.6666f;
	fVar13[1] = 57.4417f;
	fVar13[2] = 287.0027f;
	fVar13[3] = 23.9956f;
	...
	while (iVar23 < 4)
	{
		if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(iVar18[iVar23], Var0[iVar23], 1))
		{
			uLocal_975[iVar23] = VEHICLE::CREATE_VEHICLE(iVar18[iVar23], Var0[iVar23], fVar13[iVar23], 1, 1, 0);
		}
		iVar23++;
	}
...
{
	if (!UI::DOES_BLIP_EXIST(iLocal_610))
	{
	...
	if (UI::DOES_BLIP_EXIST(iLocal_610))
	{
		if (!bParam0)
		{
			UI::SET_BLIP_SCALE(iLocal_610, 0.75f);
		}
		UI::SET_BLIP_FLASHES(iLocal_610, iParam1);
	}
}
		...
		while (iVar1 < 3)
		{
			if (((Local_499[iVar0][iVar1].f_3 != 1 && Local_499[iVar0][iVar1].f_3 != 0) && Local_499[iVar0].f_52 != 4) && Local_499[iVar0].f_52 != 5)
			{
				if (!func_308(Local_499[iVar0][iVar1].f_6))
				{
					if (!Local_499[iVar0][iVar1].f_1)
					{
						...
						Local_959[iVar0] = { ENTITY::GET_ENTITY_COORDS(Local_499[iVar0][iVar1].f_6, 1) };
						iLocal_687[iVar0] = 1;
						Local_499[iVar0][iVar1].f_1 = 1;
						if (Local_499[iVar0][0].f_1 == 1)
						{
							if (!ENTITY::IS_ENTITY_DEAD(Local_499[iVar0][1].f_6, 0))
							{
								Local_499[iVar0][1].f_4 = 0;
								iLocal_715 = 1;
							}
							else if (!ENTITY::IS_ENTITY_DEAD(Local_499[iVar0][2].f_6, 0))
							{
				...
				else if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_499[iVar0][iVar1].f_6, 1), 2f, 0))
				{
					iLocal_624 = 0;
					iLocal_628 = 1;
					iLocal_716 = 0;
					...
					while (iLocal_716 < 3)
					{
						...
						{
							Local_499[iVar0][iLocal_716].f_14 = { ENTITY::GET_ENTITY_COORDS(Local_499[iVar0][iLocal_716].f_6, 1) };
							Local_499[iVar0].f_52 = 4;
						}
			...
			switch (Local_499[iVar0].f_52)
			{
				...
				case 4:
					...
					while (iLocal_716 < 3)
					{
						if ((ENTITY::DOES_ENTITY_EXIST(Local_499[iVar0][iLocal_716].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iVar0][iLocal_716].f_6, 0)) && !PED::IS_PED_INJURED(Local_499[iVar0][iLocal_716].f_6))
						{
				...
				case 2:
					...
					while (iLocal_716 < 3)
					{
						...
						{
							if (ENTITY::DOES_ENTITY_EXIST(Local_499[iVar0][iLocal_716].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iVar0][iLocal_716].f_6, 0))
							{
								AI::TASK_GO_TO_COORD_ANY_MEANS(Local_499[iVar0][iLocal_716].f_6, Local_959[iVar0], GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_323(int iParam0, int iParam1)
{
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
		{
			PED::_0x570389D1C3DE3C6B(Local_499[iParam0][iParam1].f_6);
		}
	...
	switch (Local_499[iParam0][iParam1].f_3)
	{
		...
		case 3:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				Local_499[iParam0][iParam1].f_7 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 8000));
		...
		case 4:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				if (GAMEPLAY::GET_GAME_TIMER() > Local_499[iParam0][iParam1].f_7 && Local_499[iParam0][iParam1].f_4 == 0)
				{
					...
					while (iVar0 < 3)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iVar0].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iVar0].f_6, 0))
						{
		...
		case 5:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				Local_499[iParam0][iParam1].f_10 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 8);
				if (!iLocal_650[Local_499[iParam0][iParam1].f_10])
				{
					iLocal_650[Local_499[iParam0][iParam1].f_9] = 0;
					if (Local_499[iParam0][iParam1].f_4 == 0)
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_499[iParam0][iParam1].f_6, Local_921[Local_499[iParam0][iParam1].f_10], 1f, -1, 0.25f, 512, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f));
					}
					else if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iLocal_715].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iLocal_715].f_6, 0))
					{
						AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_499[iParam0][iParam1].f_6, Local_499[iParam0][iLocal_715].f_6, Local_499[iParam0][iParam1].f_11, 1f, -1, 1.5f, 1);
					}
		...
		case 6:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				if (Local_499[iParam0][iParam1].f_4 == 0 && ENTITY::IS_ENTITY_AT_COORD(Local_499[iParam0][iParam1].f_6, Local_921[Local_499[iParam0][iParam1].f_9], func_326(iParam0), 0, 0, 0))
				{
					iVar1 = 0;
					iVar1 = 0;
					while (iVar1 < 3)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
						{
							AI::CLEAR_PED_TASKS(Local_499[iParam0][iParam1].f_6);
							AI::TASK_WANDER_IN_AREA(Local_499[iParam0][iParam1].f_6, Local_921[Local_499[iParam0][iParam1].f_9], 7.5f, 0f, 1f);
		...
		case 11:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				...
				{
					AI::TASK_SMART_FLEE_COORD(Local_499[iParam0][iParam1].f_6, Local_959[iParam0], 50f, -1, 0, 0);
				}
				else
				{
					AI::TASK_SMART_FLEE_COORD(Local_499[iParam0][iParam1].f_6, Local_499[iParam0][iParam1].f_14, 50f, -1, 0, 0);
				}
				PED::SET_PED_KEEP_TASK(Local_499[iParam0][iParam1].f_6, 1);
		...
		case 12:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				if (iLocal_687[iParam0])
				{
					if (func_325(Local_499[iParam0][iParam1].f_6, Local_959[iParam0], 1) >= 45f)
					{
						AI::TASK_GO_TO_COORD_ANY_MEANS(Local_499[iParam0][iParam1].f_6, Local_959[iParam0], GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
		...
		case 10:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				if (func_325(Local_499[iParam0][iParam1].f_6, Local_959[iParam0], 0) < 2f)
				{
					AI::CLEAR_PED_TASKS(Local_499[iParam0][iParam1].f_6);
		...
		case 8:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iLocal_715].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iLocal_715].f_6, 0))
				{
					AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_499[iParam0][iParam1].f_6, Local_499[iParam0][iLocal_715].f_6, Local_499[iParam0][iParam1].f_11, 1f, -1, 1.5f, 1);
		...
		case 13:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6))
			{
				if (ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
				{
				...
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_499[iParam0][iParam1].f_6);
			}
...
int func_324(int iParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		if (func_308(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if ((WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iParam0, 100416529, 0) || WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iParam0, 205991906, 0)) || WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iParam0, -952879014, 0))
				{
					return 1;
				}
				else
...
{
	if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_769, Local_772, 20f, 0, 1, 0) && ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6)) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0)) && iLocal_633) && iLocal_724 < 3)
	{
		if (!UI::DOES_BLIP_EXIST(Local_499[iParam0][iParam1]))
		{
			Local_499[iParam0][iParam1] = func_315(Local_499[iParam0][iParam1].f_6, 1, 0, 5);
			if (UI::DOES_BLIP_EXIST(Local_499[iParam0][iParam1]))
			{
				UI::SET_BLIP_SCALE(Local_499[iParam0][iParam1], 0.7f);
			}
			if (!ENTITY::IS_ENTITY_DEAD(Local_499[iParam0][iParam1].f_6, 0))
			{
				ENTITY::SET_ENTITY_CAN_BE_DAMAGED(Local_499[iParam0][iParam1].f_6, 1);
			}
		}
	}
	else
...
void func_346(int iParam0, int iParam1)
{
	if (!func_308(Local_499[iParam0][iParam1].f_6))
	{
		if (iParam1 == 1)
		{
			Var0 = { Local_921[Local_499[iParam0][0].f_9] + Local_814 };
			Local_499[iParam0][iParam1].f_11 = { Local_814 };
		}
		else if (iParam1 == 2)
		{
			Var0 = { Local_921[Local_499[iParam0][0].f_9] + Local_817 };
			Local_499[iParam0][iParam1].f_11 = { Local_817 };
		}
		Local_499[iParam0][iParam1].f_6 = PED::CREATE_PED(26, iLocal_727, Var0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f), 1, 1);
		if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6))
		{
			ENTITY::SET_ENTITY_HEALTH(Local_499[iParam0][iParam1].f_6, 100, 0);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_499[iParam0][iParam1].f_6, 1);
			Local_499[iParam0][iParam1].f_3 = 8;
		}
	}
}
...
void func_347(int iParam0, int iParam1)
{
	if (!func_308(Local_499[iParam0][iParam1].f_6))
	{
		...
		if (!iLocal_650[Local_499[iParam0][iParam1].f_10])
		{
			Local_499[iParam0][iParam1].f_5 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f);
			Local_499[iParam0][iParam1].f_6 = PED::CREATE_PED(26, iLocal_727, Local_921[Local_499[iParam0][iParam1].f_10], Local_499[iParam0][iParam1].f_5, 1, 1);
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0][iParam1].f_6))
			{
				ENTITY::SET_ENTITY_HEALTH(Local_499[iParam0][iParam1].f_6, 100, 0);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_499[iParam0][iParam1].f_6, 1);
...
void func_348(int iParam0, int iParam1)
{
	if (func_349())
	{
		AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "COYOTE_BARK_MASTER", Local_499[iParam0][iParam1].f_6, 0, 0, 0);
	}
	else
	{
		AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "COYOTE_CRY_MASTER", Local_499[iParam0][iParam1].f_6, 0, 0, 0);
	}
}
...
void func_356()
{
	...
	while (iVar0 < 3)
	{
		if (UI::DOES_BLIP_EXIST(Local_322[iVar0].f_9))
		{
			UI::REMOVE_BLIP(&(Local_322[iVar0].f_9));
		}
...
void func_358()
{
	...
	Local_499[1][1].f_4 = 1;
	Local_499[1][2].f_4 = 1;
	Local_921[0] = { 1649.871f, 3537.377f, 35.1815f };
	Local_921[1] = { 1665.333f, 3530.153f, 35.4407f };
	Local_921[2] = { 1656.255f, 3529.328f, 35.4361f };
	Local_921[3] = { 1666.931f, 3520.032f, 35.4593f };
	Local_921[4] = { 1663.532f, 3499.703f, 35.3817f };
	Local_921[5] = { 1654.591f, 3509.783f, 35.1706f };
	Local_921[6] = { 1642.802f, 3516.568f, 35.5786f };
	Local_921[7] = { 1653.029f, 3510.479f, 35.3398f };
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 2)
	{
...
void func_364()
{
	...
	while (iVar0 < 5)
	{
		...
		{
			func_378(iVar0);
			if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0].f_28))
			{
				if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_763, Local_766, 10f, 0, 1, 0))
				{
					if (!bLocal_636)
					{
						if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
						{
							bLocal_636 = true;
							func_318(6);
						}
		...
		switch (Local_353[iVar0].f_13)
		{
			...
			case 2:
				Local_353[iVar0].f_7 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 5);
				if ((!VEHICLE::IS_ANY_VEHICLE_NEAR_POINT(Local_353[Local_353[iVar0].f_7].f_16, 4.5f) && iLocal_705 < 3) && ENTITY::WOULD_ENTITY_BE_OCCLUDED(Local_353[iVar0].f_9, Local_353[iVar0].f_16, 1))
				{
					Local_353[iVar0].f_28 = VEHICLE::CREATE_VEHICLE(Local_353[iVar0].f_9, Local_353[iVar0].f_16, Local_353[iVar0].f_4, 1, 1, 0);
					if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0].f_28) && !ENTITY::IS_ENTITY_DEAD(Local_353[iVar0].f_28, 0))
					{
						ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_353[iVar0].f_28, 1);
						VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(Local_353[iVar0].f_28, 1);
						Local_353[iVar0].f_7 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 5);
						Local_353[iVar0].f_12 = PED::CREATE_PED_INSIDE_VEHICLE(Local_353[iVar0].f_28, 26, Local_353[Local_353[iVar0].f_7].f_10, -1, 1, 1);
						if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0].f_12))
						{
							Local_353[iVar0].f_11 = OBJECT::CREATE_OBJECT(iLocal_731, Local_353[iVar0].f_16, 1, 1, 0);
							if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0].f_11))
							{
								ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_353[iVar0].f_11, Local_353[iVar0].f_12, PED::GET_PED_BONE_INDEX(Local_353[iVar0].f_12, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
								ENTITY::SET_ENTITY_VISIBLE(Local_353[iVar0].f_11, 0, 0);
								ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_353[iVar0].f_12, 1, 1);
								ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_353[iVar0].f_12, 1);
								Local_353[iVar0].f_2 = 0;
								Local_353[iVar0].f_1 = 0;
								Local_353[iVar0].f_3 = 0;
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_353[iVar0].f_12, 1);
								AI::TASK_VEHICLE_DRIVE_TO_COORD(Local_353[iVar0].f_12, Local_353[iVar0].f_28, Local_353[iVar0].f_19, 8f, 0, 0, 786599, 5f, 2f);
								iLocal_705++;
			...
			case 4:
				...
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(Local_353[iVar0].f_28, Local_353[iVar0].f_19, 10f, 10f, 10f, 0, 0, 0))
					{
							...
							if (func_324(Local_353[iVar0].f_28))
							{
								if (func_375(iVar0))
								{
									if (!Local_353[iVar0].f_1)
									{
										...
										func_374(iVar0);
										ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_353[iVar0].f_28);
						...
						{
							if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_353[iVar0].f_28, 1), 5f, 1))
							{
								iLocal_629 = 1;
							}
						}
					...
					{
						AI::CLEAR_PED_TASKS(Local_353[iVar0].f_12);
						VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(Local_353[iVar0].f_28, 0);
						AI::TASK_VEHICLE_DRIVE_WANDER(Local_353[iVar0].f_12, Local_353[iVar0].f_28, 8f, 786599);
						PED::SET_PED_KEEP_TASK(Local_353[iVar0].f_12, 1);
						Local_353[iVar0].f_13 = 15;
					}
				}
				else
			...
			case 5:
				...
				{
					AI::CLEAR_PED_TASKS(Local_353[iVar0].f_12);
					Var1 = { func_368(Local_353[iVar0].f_28) };
					if (!func_267(Var1, 0f, 0f, 0f, 0))
					{
						AI::TASK_VEHICLE_PARK(Local_353[iVar0].f_12, Local_353[iVar0].f_28, Var1, ENTITY::GET_ENTITY_HEADING(Local_353[iVar0].f_28), 3, 270f, 1);
					}
					else if (func_349())
					{
						AI::TASK_VEHICLE_TEMP_ACTION(Local_353[iVar0].f_12, Local_353[iVar0].f_28, 5, 2000);
					}
					else
					{
						AI::TASK_VEHICLE_TEMP_ACTION(Local_353[iVar0].f_12, Local_353[iVar0].f_28, 4, 2000);
					}
					func_2();
			...
			case 6:
				if ((func_230(Local_353[iVar0].f_28) && func_308(Local_353[iVar0].f_12)) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (VEHICLE::IS_VEHICLE_STOPPED(Local_353[iVar0].f_28))
					{
						AI::CLEAR_PED_TASKS(Local_353[iVar0].f_12);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_353[iVar0].f_12, 1);
						if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1) || !Local_353[iVar0].f_2)
						{
							AI::TASK_LEAVE_VEHICLE(Local_353[iVar0].f_12, Local_353[iVar0].f_28, 1);
						}
						else
						{
							func_369(iVar0);
			...
			case 7:
				if (func_308(Local_353[iVar0].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_353[iVar0].f_12, 0))
					{
						if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1) || !Local_353[iVar0].f_2)
						{
					...
					else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
					{
						func_369(iVar0);
					}
				}
			...
			case 8:
				if ((func_308(Local_353[iVar0].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1)) && func_377(Local_353[iVar0].f_28))
				{
					Var4 = { ENTITY::GET_ENTITY_COORDS(Local_353[iVar0].f_12, 1) };
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_353[iVar0].f_12, 0))
					{
						if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(Var4, 3f, 1))
						{
							Local_353[iVar0].f_25 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_353[iVar0].f_28, Local_353[iVar0].f_22) };
							Local_353[iVar0].f_6 = (ENTITY::GET_ENTITY_HEADING(Local_353[iVar0].f_28) + Local_353[iVar0].f_5);
							AI::CLEAR_PED_TASKS(Local_353[iVar0].f_12);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_353[iVar0].f_12, 1);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_353[iVar0].f_12, Local_353[iVar0].f_25, 1f, -1, 0.25f, 0, Local_353[iVar0].f_6);
			...
			case 9:
				if (func_308(Local_353[iVar0].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(Var4, 3f, 1))
					{
						if (ENTITY::IS_ENTITY_AT_COORD(Local_353[iVar0].f_12, Local_353[iVar0].f_25, 1f, 1f, 1f, 0, 0, 1))
						{
							AI::CLEAR_PED_TASKS(Local_353[iVar0].f_12);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_353[iVar0].f_12, 1);
							AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_353[iVar0].f_12, Local_353[iVar0].f_28, 0);
			...
			case 10:
				if (func_308(Local_353[iVar0].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(Var4, 3f, 1))
					{
						Local_353[iVar0].f_15 = AI::GET_SCRIPT_TASK_STATUS(Local_353[iVar0].f_12, -875674219);
			...
			case 11:
				if (func_308(Local_353[iVar0].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(Var4, 3f, 1))
					{
						AI::OPEN_SEQUENCE_TASK(&(Local_353[iVar0].f_14));
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "exit", 8f, -8f, -1, 0, 0, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "enter_call", 8f, -8f, -1, 0, 0, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "idle_a_call", 8f, -8f, -1, 1, 0, 0, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(Local_353[iVar0].f_14);
						AI::TASK_PERFORM_SEQUENCE(Local_353[iVar0].f_12, Local_353[iVar0].f_14);
						AI::CLEAR_SEQUENCE_TASK(&(Local_353[iVar0].f_14));
						Local_353[iVar0].f_8 = GAMEPLAY::GET_GAME_TIMER() + 20000;
			...
			case 12:
				if (func_308(Local_353[iVar0].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(Var4, 3f, 1))
					{
						if (GAMEPLAY::GET_GAME_TIMER() > Local_353[iVar0].f_8)
						{
							if (ENTITY::IS_ENTITY_VISIBLE(Local_353[iVar0].f_11))
							{
								ENTITY::SET_ENTITY_VISIBLE(Local_353[iVar0].f_11, 0, 0);
							}
							else
						...
						else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_353[iVar0].f_12, "ODDJOBS@HUNTER", "enter_call", 3) && !ENTITY::IS_ENTITY_VISIBLE(Local_353[iVar0].f_11))
						{
							ENTITY::SET_ENTITY_VISIBLE(Local_353[iVar0].f_11, 1, 0);
						}
					}
					else
					{
			...
			case 13:
				if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_353[iVar0].f_28, 0), ENTITY::GET_ENTITY_COORDS(Local_353[iVar0].f_12, 1), 0) > 100f)
					{
						Local_353[iVar0].f_13 = 15;
					}
				}
			...
			case 15:
				...
				if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0].f_12))
				{
					if (!ENTITY::IS_ENTITY_DEAD(Local_353[iVar0].f_12, 0))
					{
						PED::SET_PED_KEEP_TASK(Local_353[iVar0].f_12, 1);
					}
		...
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_800, ENTITY::GET_ENTITY_COORDS(Local_353[iVar0].f_28, 1), 1) > 450f)
			{
				Local_353[iVar0].f_13 = 15;
			}
		}
...
void func_367(int iParam0)
{
	...
	if (func_308(iVar0))
	{
		if (func_377(Local_353[iParam0].f_28))
		{
			...
			AI::OPEN_SEQUENCE_TASK(&(Local_353[iParam0].f_14));
			AI::TASK_ENTER_VEHICLE(0, Local_353[iParam0].f_28, 60000, -1, 1f, 1, 0);
			AI::TASK_VEHICLE_DRIVE_WANDER(0, Local_353[iParam0].f_28, 60f, 786468);
			AI::CLOSE_SEQUENCE_TASK(Local_353[iParam0].f_14);
			AI::TASK_PERFORM_SEQUENCE(iVar0, Local_353[iParam0].f_14);
			PED::SET_PED_KEEP_TASK(iVar0, 1);
			AI::CLEAR_SEQUENCE_TASK(&(Local_353[iParam0].f_14));
		}
...
Vector3 func_368(int iParam0)
{
	if (func_377(iParam0))
	{
		...
		{
			if (PATHFIND::_0x16F46FB18C8009E4(Var3, 0, &Var3))
			{
...
void func_369(int iParam0)
{
	...
	{
		AI::CLEAR_PED_TASKS(Local_353[iParam0].f_12);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_353[iParam0].f_12, 1);
		if (func_377(Local_353[iParam0].f_28))
		{
			if (PED::IS_PED_IN_VEHICLE(Local_353[iParam0].f_12, Local_353[iParam0].f_28, 0))
			{
				AI::TASK_VEHICLE_DRIVE_TO_COORD(Local_353[iParam0].f_12, Local_353[iParam0].f_28, Local_353[iParam0].f_19, 80f, 1, 0, 786469, 5f, 2f);
				Local_353[iParam0].f_13 = 14;
			}
			else
			{
				AI::TASK_SMART_FLEE_COORD(Local_353[iParam0].f_12, Local_748, 10000f, -1, 0, 0);
				Local_353[iParam0].f_13 = 13;
			}
		}
		Local_353[iParam0].f_2 = 1;
		PED::SET_PED_KEEP_TASK(Local_353[iParam0].f_12, 1);
	}
	else
	{
...
int func_372()
{
	if (func_308(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_308(iLocal_734))
		{
			Var3 = { ENTITY::GET_ENTITY_COORDS(iLocal_734, 1) };
			if (func_373(PLAYER::PLAYER_PED_ID(), iLocal_734, 0) <= 10f && GAMEPLAY::ABSF((Var0.z - Var3.z)) < 1.5f)
			{
				return 1;
			}
		}
...
void func_374(int iParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(Local_353[iParam0].f_28, 0))
	{
		ENTITY::SET_ENTITY_CAN_BE_DAMAGED(Local_353[iParam0].f_28, 0);
	}
...
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_353[iParam0].f_28) && !ENTITY::IS_ENTITY_DEAD(Local_353[iParam0].f_28, 0))
	{
		if (VEHICLE::IS_VEHICLE_TYRE_BURST(Local_353[iParam0].f_28, 1, 0))
		{
			Local_353[iParam0].f_22 = { 2.5f, 3f, 0f };
			Local_353[iParam0].f_5 = 90f;
			return 1;
		}
		else if (VEHICLE::IS_VEHICLE_TYRE_BURST(Local_353[iParam0].f_28, 5, 0))
		{
			Local_353[iParam0].f_22 = { 2.5f, -3f, 0f };
			Local_353[iParam0].f_5 = 90f;
			return 1;
		}
		else if (VEHICLE::IS_VEHICLE_TYRE_BURST(Local_353[iParam0].f_28, 4, 0))
		{
			Local_353[iParam0].f_22 = { -2.5f, -3f, 0f };
			Local_353[iParam0].f_5 = -90f;
			return 1;
		}
		else if (VEHICLE::IS_VEHICLE_TYRE_BURST(Local_353[iParam0].f_28, 0, 0))
		{
			Local_353[iParam0].f_22 = { -2.5f, 3f, 0f };
			Local_353[iParam0].f_5 = -90f;
			return 1;
...
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_353[iParam0].f_12))
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_353[iParam0].f_12, 0) || !ENTITY::IS_ENTITY_DEAD(Local_353[iParam0].f_12, 0))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iParam0].f_12, PLAYER::PLAYER_PED_ID(), 1))
			{
				func_369(iParam0);
			}
		}
...
void func_381()
{
	if (bLocal_639)
	{
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_353[0].f_9);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_353[1].f_9);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_353[2].f_9);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_353[3].f_9);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_353[4].f_9);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_353[0].f_10);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_353[1].f_10);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_353[2].f_10);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_353[3].f_10);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_353[4].f_10);
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				iLocal_319 = 13;
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_800, 50f, 0, 0, 0, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_794, 50f, 0, 0, 0, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_797, 50f, 0, 0, 0, 0, 0, 0);
				AI::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				func_380();
				func_354();
				func_353();
...
{
	func_387();
	STREAMING::REQUEST_MODEL(Local_353[0].f_9);
	STREAMING::REQUEST_MODEL(Local_353[1].f_9);
	STREAMING::REQUEST_MODEL(Local_353[2].f_9);
	STREAMING::REQUEST_MODEL(Local_353[3].f_9);
	STREAMING::REQUEST_MODEL(Local_353[4].f_9);
	STREAMING::REQUEST_MODEL(Local_353[0].f_10);
	STREAMING::REQUEST_MODEL(Local_353[1].f_10);
	STREAMING::REQUEST_MODEL(Local_353[2].f_10);
	STREAMING::REQUEST_MODEL(Local_353[3].f_10);
	STREAMING::REQUEST_MODEL(Local_353[4].f_10);
	STREAMING::REQUEST_MODEL(iLocal_731);
	while ((((((((((!STREAMING::HAS_MODEL_LOADED(Local_353[0].f_9) || !STREAMING::HAS_MODEL_LOADED(Local_353[1].f_9)) || !STREAMING::HAS_MODEL_LOADED(Local_353[2].f_9)) || !STREAMING::HAS_MODEL_LOADED(Local_353[3].f_9)) || !STREAMING::HAS_MODEL_LOADED(Local_353[4].f_9)) || !STREAMING::HAS_MODEL_LOADED(Local_353[0].f_10)) || !STREAMING::HAS_MODEL_LOADED(Local_353[1].f_10)) || !STREAMING::HAS_MODEL_LOADED(Local_353[2].f_10)) || !STREAMING::HAS_MODEL_LOADED(Local_353[3].f_10)) || !STREAMING::HAS_MODEL_LOADED(Local_353[4].f_10)) || !STREAMING::HAS_MODEL_LOADED(iLocal_731))
	{
		SYSTEM::WAIT(0);
	}
	bLocal_639 = true;
...
void func_387()
{
	Local_353[0] = { func_388(884422927, 1155.058f, 3533.135f, 33.9186f, 34.9236f, 2097407511, Local_794) };
	Local_353[1] = { func_388(1177543287, 1655.803f, 3492.451f, 35.5714f, 105.5303f, 1328415626, Local_797) };
	Local_353[2] = { func_388(-808457413, 1516.076f, 3376.604f, 36.6333f, 359.8644f, 1822107721, Local_797) };
	Local_353[3] = { func_388(-1207771834, 1140.058f, 3533.135f, 33.9186f, 269f, 1328415626, Local_794) };
	Local_353[4] = { func_388(-599568815, 1508.076f, 3372.604f, 36.6333f, 359.8644f, 2097407511, Local_797) };
}
...
void func_390()
{
	if (!PED::IS_PED_INJURED(iLocal_734) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_734, PLAYER::PLAYER_PED_ID(), Local_823, 0, 1, 0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == 0)
		{
...
void func_393()
{
	...
	if (!bLocal_630)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_745, 5f, 5f, 5f, 0, 1, 0) && func_394(1077936128, 1))
		{
...
void func_395()
{
	...
	GAMEPLAY::CLEAR_AREA_OF_PEDS(Local_904, 5f, 0);
}
		...
		if (!UI::DOES_BLIP_EXIST(Local_322[iVar0].f_9))
		{
			if (func_230(Local_322[iVar0]))
			{
				if (!Local_322[iVar0].f_7)
				{
					...
					UI::SET_BLIP_COLOUR(Local_322[iVar0].f_9, 1);
				}
			}
		}
		iVar0++;
...
int func_402(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_403(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(iVar0, func_403(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(iVar0, iParam1);
	}
	...
	while (iVar0 < 3)
	{
		...
		if (Local_322[iVar0].f_7 == 1)
		{
			if (!Local_322[iVar0].f_8)
			{
				...
				{
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_322[iVar0]);
					iLocal_724++;
				}
				else
				{
...
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_322[iParam0]) && !Local_322[iParam0].f_7)
	{
		Local_322[iParam0].f_5 = ENTITY::GET_ENTITY_HEALTH(Local_322[iParam0]);
		if (Local_322[iParam0].f_5 < 100)
		{
			...
			OBJECT::_0xE7E4C198B0185900(Local_322[iParam0], 1, 0);
		}
	}
}
...
void func_407()
{
	GAMEPLAY::CLEAR_AREA_OF_PEDS(Local_877, 3f, 0);
	PED::SET_PED_NON_CREATION_AREA(Local_880, Local_883);
	GAMEPLAY::CLEAR_AREA_OF_PEDS(Local_886, 3f, 0);
	PED::SET_PED_NON_CREATION_AREA(Local_889, Local_892);
	GAMEPLAY::CLEAR_AREA_OF_PEDS(Local_895, 3f, 0);
...
int func_408()
{
	...
	else
	{
		...
		while (iVar0 < 3)
		{
			GAMEPLAY::CLEAR_AREA_OF_OBJECTS(Local_322[iVar0].f_1, 2f, 0);
			Local_322[iVar0] = OBJECT::CREATE_OBJECT(iLocal_726, Local_322[iVar0].f_1, 1, 1, 0);
			if (ENTITY::DOES_ENTITY_EXIST(Local_322[iVar0]))
			{
				ENTITY::SET_ENTITY_HEADING(Local_322[iVar0], Local_322[iVar0].f_4);
				OBJECT::SET_OBJECT_TARGETTABLE(Local_322[iVar0], 0);
				ENTITY::SET_ENTITY_HEALTH(Local_322[iVar0], 100, 0);
				ENTITY::SET_ENTITY_DYNAMIC(Local_322[iVar0], 1);
				Local_322[iVar0].f_7 = 0;
				Local_322[iVar0].f_8 = 0;
			}
			iVar0++;
		}
		if (((ENTITY::DOES_ENTITY_EXIST(Local_322[0]) && ENTITY::DOES_ENTITY_EXIST(Local_322[1])) && ENTITY::DOES_ENTITY_EXIST(Local_322[2])) && func_409())
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_726);
			iLocal_618 = 0;
			return 1;
...
int func_409()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_322[iLocal_721]))
	{
...
void func_411()
{
	...
	else
	{
		...
		if (UI::DOES_BLIP_EXIST(iLocal_610))
		{
			if (!UI::IS_BLIP_FLASHING(iLocal_610))
			{
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				func_228(1);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_807, 2f, 0, 0, 0, 0, 0, 0);
				func_7();
				iLocal_321 = 2;
			}
			break;
	...
	switch (iLocal_321)
	{
		...
		case 1:
			switch (iLocal_706)
			{
				...
				case 1:
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_741, 850900610))
					{
						if (!bLocal_623)
						{
					...
					if (CUTSCENE::HAS_CUTSCENE_FINISHED())
					{
						...
						WEAPON::SET_PED_INFINITE_AMMO(PLAYER::PLAYER_PED_ID(), 1, 100416529);
						iLocal_706++;
					}
					break;
			...
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				if (func_408())
				{
					if (func_308(iLocal_734))
					{
						...
						{
							func_229(iLocal_734, Local_791, fLocal_698, 0, 1);
							WEAPON::REMOVE_WEAPON_FROM_PED(iLocal_734, 100416529);
							AI::CLEAR_PED_TASKS(iLocal_734);
							iLocal_319 = 2;
						}
					}
...
void func_424(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_426(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_431(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_432(Var18[0], Var18[1], Var6, Var9) || func_432(Var18[0], Var18[1], Var9, Var15)) || func_432(Var18[0], Var18[1], Var12, Var15)) || func_432(Var18[0], Var18[1], Var6, Var12)) || func_432(Var18[1], Var18[3], Var6, Var9)) || func_432(Var18[1], Var18[3], Var9, Var15)) || func_432(Var18[1], Var18[3], Var12, Var15)) || func_432(Var18[1], Var18[3], Var6, Var12)) || func_432(Var18[3], Var18[2], Var6, Var9)) || func_432(Var18[3], Var18[2], Var9, Var15)) || func_432(Var18[3], Var18[2], Var12, Var15)) || func_432(Var18[3], Var18[2], Var6, Var12)) || func_432(Var18[2], Var18[0], Var6, Var9)) || func_432(Var18[2], Var18[0], Var9, Var15)) || func_432(Var18[2], Var18[0], Var12, Var15)) || func_432(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_436(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_260(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_260(iVar2, iVar8)))
			{
				...
				{
					uVar9 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_260(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_260(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_260(iVar2, iVar8)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_260(iVar2, iVar8));
...
int func_440(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_443(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_446()
{
	...
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_711 || func_373(PLAYER::PLAYER_PED_ID(), iLocal_734, 1) <= 3f)
		{
...
void func_450()
{
	...
	{
		iLocal_621 = 1;
		uLocal_723 = WEAPON::GET_PED_AMMO_BY_TYPE(PLAYER::PLAYER_PED_ID(), 1285032059);
	}
}
...
void func_454()
{
	WEAPON::REQUEST_WEAPON_ASSET(100416529, 31, 2);
	while (!WEAPON::HAS_WEAPON_ASSET_LOADED(100416529))
	{
		SYSTEM::WAIT(0);
	}
}
	...
	if (func_308(PLAYER::PLAYER_PED_ID()))
	{
		...
		switch (iLocal_319)
		{
			...
			case 2:
				if (func_308(iLocal_734))
				{
					if (func_488())
					{
						...
						WEAPON::REMOVE_WEAPON_FROM_PED(iLocal_734, 100416529);
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, Local_778, 1f, 60000, 0.25f, 512, Local_322[iLocal_721].f_6);
						PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, 0);
						iLocal_319 = 4;
					}
				}
			...
			case 5:
				...
				{
					if (WEAPON::HAS_PED_GOT_WEAPON(iLocal_734, 100416529, 0))
					{
						WEAPON::REMOVE_WEAPON_FROM_PED(iLocal_734, 100416529);
					}
					if (func_488())
			...
			case 6:
				...
				else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_757, Local_760, 7f, 0, 1, 0) && func_372())
				{
					if (func_485())
					{
						func_380();
			...
			case 12:
				if (func_371(&uLocal_153, cLocal_739, "HUNT1_TYARR", 7, 0, 0, 0))
				{
					...
					iLocal_714 = 0;
					AI::TASK_LOOK_AT_ENTITY(iLocal_734, PLAYER::PLAYER_PED_ID(), -1, 1024, 2);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, Local_781, 1f, 60000, 0.25f, 512, fLocal_691);
					PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, 0);
					iLocal_319 = 14;
				}
				break;
			...
			case 16:
				if (func_477())
				{
					iLocal_717 = 0;
					func_458();
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, Local_946[0], 1f, 60000, 0.25f, 0, 40000f);
					PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, 1);
					func_314(0, 0);
					iLocal_319 = 17;
				}
			...
			case 17:
				...
				if (!iLocal_659[15])
				{
					if (func_372())
					{
						if (!func_223())
						{
							if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_748, 1) > 10f)
							{
				...
				{
					case 0:
						if (func_325(iLocal_734, Local_946[0], 0) < 2f)
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, Local_946[1], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_717++;
						}
						break;
					
					case 1:
						if (func_325(iLocal_734, Local_946[1], 0) < 2f)
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, Local_946[2], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_717++;
						}
						break;
					
					case 2:
						if (func_325(iLocal_734, Local_946[2], 0) < 2f)
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, Local_946[3], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_717++;
						}
						break;
					
					case 3:
						if (func_325(iLocal_734, Local_946[3], 0) < 2f)
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, Local_784, 1f, 60000, 0.25f, 512, fLocal_697);
							iLocal_717++;
						}
						break;
					
					case 4:
						if (AI::GET_SCRIPT_TASK_STATUS(iLocal_734, 713668775) == 7 || (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_907, Local_910, 3.5f, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_734, Local_907, Local_910, 3.5f, 0, 1, 0)))
						{
							PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, 0);
							iLocal_319 = 18;
						}
			...
			case 18:
				...
				{
					Var0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_907, Local_910, 3.5f, 0, 1, 0) || Var0.z > 41f)
					{
						if (func_371(&uLocal_153, cLocal_739, "HUNT_ROOF", 7, 0, 0, 0))
						{
							AI::CLEAR_PED_TASKS(iLocal_734);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, Local_788, 1f, 60000, 0.25f, 512, fLocal_699);
							iLocal_659[16] = 1;
							PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, 0);
							iLocal_319 = 21;
						}
				...
				if (!func_223())
				{
					...
					else if (!func_223())
					{
						if (func_308(iLocal_734))
						{
							...
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_966, 1f, 60000, 0.25f, 0, 40000f);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_969, 1f, 60000, 0.25f, 0, 40000f);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_972, 1f, 60000, 0.25f, 0, 40000f);
...
void func_458()
{
	Local_946[0] = { 1524.567f, 3567.502f, 34.3611f };
	Local_946[1] = { 1543.957f, 3572.729f, 34.3627f };
	Local_946[2] = { 1561.888f, 3587.101f, 34.3606f };
	Local_946[3] = { 1594.385f, 3598.806f, 34.4349f };
}
...
void func_478()
{
	...
	while (iVar0 < 3)
	{
		if (GAMEPLAY::IS_BULLET_IN_AREA(Local_322[iVar0].f_1, 10f, 1))
		{
			if (!func_223())
			{
				if (!func_398("HT_SHDISH", 0, 0) || GAMEPLAY::GET_PROFILE_SETTING(203) == 0)
				{
					if (!Local_322[iVar0].f_7)
					{
			...
			case 0:
				switch (iParam0)
				{
					case 0:
						...
						if (iLocal_616)
						{
							if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_734, Local_778, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !PED::_0xFCF37A457CB96DC0(iLocal_734, Local_322[iLocal_721].f_1, 30f))
							{
					...
					case 1:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_734, Local_781, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_482(iLocal_734, fLocal_691, 30f))
						{
							iLocal_714 = 1;
						}
						break;
					...
					case 2:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_734, Local_788, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_482(iLocal_734, fLocal_699, 30f))
						{
							iLocal_714 = 1;
						}
						break;
	...
	if (!bParam1 || iLocal_616)
	{
		if (func_488())
		{
			...
			if (func_308(iLocal_734))
			{
				...
				if (bParam1)
				{
					AI::TASK_TURN_PED_TO_FACE_COORD(0, Local_322[iLocal_721].f_1, 0);
				}
				if (bParam0)
				{
...
void func_491(bool bParam0)
{
	...
	if (func_308(iLocal_734) && func_308(PLAYER::PLAYER_PED_ID()))
	{
		if (func_462())
		{
			...
			while (iVar1 < 5)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar1].f_12))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar1].f_12, PLAYER::PLAYER_PED_ID(), 1))
					{
						ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_353[iVar1].f_12);
						iLocal_707++;
					}
				}
				iVar1++;
...
void func_492()
{
	if (!PED::IS_PED_INJURED(iLocal_734))
	{
		if (((GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) - Vector(2f, 2f, 2f), -1813897027, 0) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) - Vector(2f, 2f, 2f), 741814745, 0)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) - Vector(2f, 2f, 2f), 615608432, 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_734, 0), 10f))
		{
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				...
				{
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_28[0], 100416529, 0, 1, 1);
				}
				else
				{
					bVar4 = false;
		...
		case 3:
			...
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_PED(uParam0->f_28[0], 100416529, -1489156508);
				PED::SET_PED_CONFIG_FLAG(uParam0->f_28[0], 104, 1);
				WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_28[0], 100416529, 1);
