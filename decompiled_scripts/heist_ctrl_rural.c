void __EntryFunction__()
{
	...
	while (!func_296(5))
	{
		...
		if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(896333358) > 0)
		{
			func_2();
		}
		SYSTEM::WAIT(0);
...
void func_153()
{
	...
	if (func_296(40))
	{
		...
		else if (MISC::IS_BIT_SET(uLocal_41, 11))
		{
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				else if (MISC::IS_BIT_SET(uLocal_41, 16))
				{
					MISC::CLEAR_BIT(&uLocal_41, 11);
				}
			}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_186(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_258(var uParam0, int iParam1)
{
	...
	else
	{
		...
		if (func_240(func_99()) != iParam1 || bVar0)
		{
			...
			else if (!((MISC::IS_BIT_SET(Global_111638.f_9080.f_2[27], 1) && !Global_3) && !func_118(0)))
			{
				if (uParam0->f_23)
				{
					bVar1 = true;
