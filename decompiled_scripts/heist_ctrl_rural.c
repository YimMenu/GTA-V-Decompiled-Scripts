void __EntryFunction__()
{
	...
	while (!func_296(5))
	{
		if (!Global_76891 && !func_295(14))
		{
			...
			func_271(&Local_176);
			func_153();
			if (func_151(0) || GAMEPLAY::IS_BIT_SET(Local_176.f_449, 2))
			{
				func_67(&Local_176);
				func_4(&Local_176);
				func_3(&Local_176);
		...
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(896333358) > 0)
		{
			func_2();
		}
		SYSTEM::WAIT(0);
...
void func_153()
{
	...
	if (func_296(40))
	{
		if (func_296(39))
		{
			if (((CUTSCENE::HAS_CUTSCENE_LOADED() && STREAMING::HAS_MODEL_LOADED(-1686040670)) && STREAMING::HAS_ANIM_DICT_LOADED("MISSHEISTPALETOSCORE1LEADINOUT")) && STREAMING::HAS_PTFX_ASSET_LOADED())
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_129, "MICHAEL", 0, 225514697, 0);
				}
				if (!ENTITY::IS_ENTITY_DEAD(uLocal_132[2], 0))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_132[2], "TREVOR", 0, -1686040670, 0);
				}
				func_125(1);
				func_72(1);
		...
		else if (CUTSCENE::IS_CUTSCENE_PLAYING())
		{
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Trevor", 0))
			{
				...
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1686040670);
				if (!func_118(0))
				{
		...
		else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_42)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				...
				{
					VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(iLocal_46, 0, 1);
				}
			}
			func_162(&iLocal_44);
...
var func_180()
{
	func_190(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_189(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_188(&uVar0, TIME::GET_CLOCK_HOURS());
	func_183(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_182(&uVar0, TIME::GET_CLOCK_MONTH());
	func_181(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_186(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_196(var uParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	if ((!PED::IS_PED_INJURED((*uParam0)[uParam0->f_7]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && (*uParam0)[uParam0->f_7] != PLAYER::PLAYER_PED_ID())
	{
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			PLAYER::_0xD2B315B6689D537D(PLAYER::PLAYER_ID(), func_296(68));
		}
...
int func_258(var uParam0, int iParam1)
{
	...
	else
	{
		...
		if (func_240(func_99()) != iParam1 || bVar0)
		{
			...
			else if (!((GAMEPLAY::IS_BIT_SET(Global_111638.f_9080.f_2[27], 1) && !Global_3) && !func_118(0)))
			{
				if (uParam0->f_23)
				{
					bVar1 = true;
...
void func_279(var uParam0)
{
	...
	while (iVar0 < uParam0->f_1.f_33)
	{
		if (func_32(*uParam0, uParam0->f_1.f_75[iVar0]))
		{
			...
			Var4 = { func_280(uParam0, &(uParam0->f_1.f_34[iVar0])) };
		...
		while (iVar0 < uParam0->f_1.f_33)
		{
			if (func_32(*uParam0, uParam0->f_1.f_75[iVar0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_428[iVar0]))
				{
					...
					Var6 = { func_280(uParam0, &(uParam0->f_1.f_34[iVar0])) };
				...
				if (func_291("RBHS_MCS_3"))
				{
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_46, 0))
							{
								VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(iLocal_46, 0, 0);
							}
						}
						...
						if (func_99() == 0)
						{
							...
							{
								CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_132[2], "TREVOR", 2, -1686040670, 0);
						...
						else if (func_99() == 2)
						{
							...
							{
								CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_129, "MICHAEL", 2, 225514697, 0);
					...
					else
					{
						...
						{
							if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Trevor", -1686040670)))
							{
								uLocal_132[2] = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Trevor", -1686040670));
						...
						if (GAMEPLAY::IS_BIT_SET(uLocal_41, 3))
						{
							...
							{
								iLocal_129 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Michael", 225514697));
