...
void func_6()
{
	...
	{
		func_8(13, SYSTEM::FLOOR(Global_112293.f_10192.f_3853));
	}
...
int func_31(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_74(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_74(iParam1), Global_77059[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iParam1), Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4, 0);
		}
	}
...
int func_34(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_77059[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iVar0), Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_74(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iVar0), Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4, iParam4);
						}
						func_65(iVar0);
						if (Global_77057 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iParam1), Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_74(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iParam1), Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4, iParam4);
		}
		if (Global_77057 == 1)
		{
			iVar2 = 0;
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 8, -1, false, -1, func_74(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 8, -1, false, -1, func_74(iParam2));
...
int func_69(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12074)
	{
		...
		iVar0 = Global_2555716[iParam0 /*3*/][func_68(iParam1)];
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_57(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_80(Var16.f_2)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_80(Var16.f_2)] = func_57(iParam1, Var16.x, func_80(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_69(func_88(iParam1, uParam0->f_2), Global_77056, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_69(func_87(iParam1, uParam0->f_2), Global_77056, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_69(iVar1, Global_77056, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_92(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_85(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77229)
		{
			...
			func_85(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 8, -1, false, -1, func_74(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_147(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_77059[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_74(iParam1)) && Global_77059[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_74(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_154()
{
	...
	{
		if (func_149(Global_112293.f_2361.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_159(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_160(&sVar32, Var0.f_3, Global_99407, bParam1, bParam2);
	}
}
...
void func_165()
{
	...
	{
		func_154();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_166(Global_112293.f_2361.f_539.f_4321));
	}
	else
	{
...
void func_258(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_328(&(Global_99370.f_3));
				if (iVar10 > -1)
				{
...
{
	func_260(&Global_105842, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_279(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2592627[iParam0 /*3*/][func_68(iParam1)];
...
void func_283(int iParam0, bool bParam1)
{
	...
	if (func_151(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_284(iParam0, &(Global_112293.f_2361.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
Vector3 func_301(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_311(Global_101476);
			break;
		
		case 46:
			if (Global_1590745 != func_224())
			{
				if (func_310(Global_1590745))
				{
					return func_303(2, 2);
				}
				else if (func_302(Global_1590745))
				{
...
int func_329(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_330(Global_112293.f_9083.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_330(Global_112293.f_9083.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_330(Global_112293.f_9083.f_99.f_205[11]);
			break;
		
		case 90:
			return func_330(Global_112293.f_9083.f_99.f_205[7]);
			break;
		
		case 93:
			return func_330(Global_112293.f_9083.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
void func_335(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102858.f_4))
	{
		...
		{
			if (func_362(24) != Global_102858.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_359(ENTITY::GET_ENTITY_COORDS(Global_102858.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_336(Global_102858.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_337(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_354(&(Global_76066.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_112293.f_32747.f_4801 = func_317();
			}
...
void func_338(int iParam0, int iParam1)
{
	...
	func_271(iParam0, &(Global_112293.f_32747.f_5510));
}
...
int func_354(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_294(Global_112293.f_32747.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_294(Global_112293.f_2361.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_294(Global_112293.f_2361.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_355(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_354(&(Global_76066.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_357(iParam0);
			func_356(uParam1, &(Global_112293.f_32747.f_69[Global_76066.f_555[0 /*21*/].f_14 /*78*/]));
	...
	if (Global_77502 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_406(Global_77503, Global_77505, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_417(0) || Global_77517) || Global_77506 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77502)
...
{
	return func_419(iParam0, Global_42009);
}
		...
		if (bParam2)
		{
			if (!Global_77248)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8327[iParam1 /*4*/] = { func_454(iParam0) };
					...
					{
						Global_8278[1 /*6*/] = { func_454(iParam0) };
...
int func_475()
{
	...
	iVar0 = func_331(&(Global_99370.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_477()
{
	...
	{
		if (func_328(&(Global_99370.f_3)) > -1)
		{
			return 1;
		}
	}
