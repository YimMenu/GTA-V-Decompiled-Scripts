...
void func_1()
{
	switch (iLocal_41)
	{
		...
		case 1:
			...
			else if (ENTITY::IS_ENTITY_AT_COORD(Local_43.f_4, Local_53, 6f, 6f, 2f, 1, 1, 0))
			{
				func_214(&iLocal_42);
				iLocal_41 = 0;
				iLocal_40 = 6;
...
int func_31(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_76434[1 /*14*/] = { func_82(iVar0, iParam1, uVar6[iParam1], -1) };
...
int func_34(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76434[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1 /*14*/] = { func_82(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1 /*14*/] = { func_82(iVar10, 14, uVar15[iVar1], -1) };
			func_50(iParam0, Global_76434[1 /*14*/].f_12, Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4);
			func_65(14);
			if (Global_76432 == 1)
			{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &Var2) && Var2.z != -1)
				{
					...
					{
						(*iParam0)[Var2.z] = func_57(iParam1, Var2.x, 14, iVar0);
					}
					else if (Var2.y != -1)
					{
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.x != 0 && Var2.x != -1) && Var2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_80(Var2.z)] = Var2.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_80(Var2.z)] = func_57(iParam1, Var2.x, func_80(Var2.z), iVar0);
					}
				}
				else if (Var2.y != -1)
				{
					(*uParam0)[func_80(Var2.z)] = Var2.y;
				}
			}
			iVar4++;
		}
...
void func_84(int iParam0)
{
	...
	func_85(&(Global_76434[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_92(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_85(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_85(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
void func_159(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_160(&uVar1, Var0.f_3, Global_98781, iParam1, iParam2);
	}
}
...
void func_258(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_328(&(Global_98744.f_3));
				if (iVar6 > -1)
				{
...
int func_279(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2583656[iParam0 /*3*/][func_68(iParam1)];
...
void func_284(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::_GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_286(Var7.f_1)) && iVar9 < 51)
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_362(24) != Global_102203.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_359(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_336(Global_102203.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}

void func_336(int iParam0, struct<3> Param1, var uParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_355(iParam3, &Var0, Param1, uParam2, func_267(iParam0));
...
void func_355(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4)
{
	if (func_354(&(Global_75441.f_555[0 /*21*/]), iParam0))
	{
	...
	if (Global_76876 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_406(Global_76877, Global_76879, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_442(struct<3> Param0, float fParam1, bool bParam2)
{
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_49, Local_43.f_4, 0, Local_50, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
