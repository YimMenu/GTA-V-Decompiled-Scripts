		...
		case 0:
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
			{
				...
				else
				{
					iLocal_437 = 1;
					iLocal_438 = 1;
					if (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || !func_212())
					{
						func_210(2);
						iLocal_436 = 0;
					}
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_74(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_74(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_92(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_85(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_85(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_74(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_165()
{
	...
	{
		func_154();
		GRAPHICS::_0xBF59707B3E5ED531(func_166(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
		...
		case 1:
			if (ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, Local_161, 10f, 10f, 2f, 0, 1, 0))
			{
				...
				else
				{
					...
					else if ((iLocal_433 && func_209(5)) && (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || !func_212()))
					{
						func_210(5);
					}
				}
...
void func_217()
{
	if (!iLocal_434)
	{
		iLocal_435 = GAMEPLAY::GET_GAME_TIMER() + 3500;
		iLocal_434 = 1;
	}
	else if (!iLocal_433)
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_435)
		{
			if (iLocal_429 == 1)
			{
...
void func_242()
{
	switch (iLocal_143)
	{
		case 0:
			func_214(&iLocal_144);
			if (!func_212() || GAMEPLAY::GET_PROFILE_SETTING(203) == 0)
			{
				func_210(2);
				func_253(&uLocal_450);
				iLocal_431 = 0;
			...
			iLocal_429 = 1;
			iLocal_249 = GAMEPLAY::GET_GAME_TIMER() + 2500;
			iLocal_143 = 1;
			break;
		
		case 1:
			func_248(&uLocal_450, &uLocal_251, "BAR3AAU", &sLocal_451, &cLocal_457);
			if (!iLocal_248 && GAMEPLAY::GET_GAME_TIMER() > iLocal_249)
			{
...
void func_245()
{
	if (iLocal_428 && iLocal_426 < 4)
	{
		if (!func_212() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
		{
			...
			{
				iLocal_425 = 1;
				iLocal_427 = GAMEPLAY::GET_GAME_TIMER();
			}
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_427) > Local_416[iLocal_426].f_1 && (func_247() || iLocal_426 == 0))
			{
				if (iLocal_426 != 2 || ENTITY::GET_ENTITY_SPEED(Local_145.f_4) > 10f)
				{
					if (func_235() || GAMEPLAY::GET_PROFILE_SETTING(203) == 0)
					{
...
void func_254()
{
	switch (iLocal_143)
	{
		case 0:
			func_214(&iLocal_144);
			iLocal_144 = func_208(Local_145.f_4, 1, 5);
			UI::SET_BLIP_ROUTE(iLocal_144, 1);
			if (func_209(3) && (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || !func_212()))
			{
				func_210(3);
				func_253(&uLocal_450);
			}
	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
			{
				func_214(&iLocal_144);
				iLocal_144 = func_213(Local_161, 5, 1);
				if (func_209(0) && (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || !func_212()))
				{
					func_210(0);
					func_253(&uLocal_450);
				}
		...
		case 1:
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
			{
				...
				else
				{
					...
					if (!iLocal_432)
					{
						if (((GAMEPLAY::GET_GAME_TIMER() - iLocal_427) > 8000 && iLocal_426 >= 4) && !func_212())
						{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_272(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_297(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_7() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_69(func_298(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_300(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_315(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Param0, func_301(iVar0, 0), 1);
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_323(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
	...
	switch (Local_186[iParam0].f_24)
	{
		...
		case 1:
			if (func_207(PLAYER::PLAYER_PED_ID(), Local_186[iParam0].f_3, 275f))
			{
				if (func_386(iParam0))
				{
					Local_186[iParam0].f_25 = GAMEPLAY::GET_GAME_TIMER() + 1750;
		...
		case 2:
			if (GAMEPLAY::GET_GAME_TIMER() > Local_186[iParam0].f_25)
			{
				func_370(iParam0, 1);
			}
...
void func_370(int iParam0, int iParam1)
{
	...
	if (func_204(Local_186[iParam0].f_1))
	{
		...
		PED::_0x52D59AB61DDC05DD(Local_186[iParam0].f_1, 1);
		func_368(&(Local_186[iParam0].f_1), 1, 0, 1);
	}
	if (func_204(Local_186[iParam0].f_2))
	{
		...
		PED::_0x52D59AB61DDC05DD(Local_186[iParam0].f_2, 1);
...
int func_372(int iParam0)
{
	if (func_204(iParam0))
	{
		...
		else if (GAMEPLAY::IS_PROJECTILE_IN_AREA(Var0 - Vector(3f, 3f, 3f), Var0 + Vector(3f, 3f, 3f), 1))
		{
			return 1;
		}
...
int func_385(int iParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		else if (GAMEPLAY::IS_PROJECTILE_IN_AREA(Var0 - Vector(5f, 5f, 5f), Var0 + Vector(5f, 5f, 5f), 1))
		{
			return 1;
		}
	}
...
int func_389()
{
	if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(Local_145.f_4))
	{
		if (iLocal_153)
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_154) > 7000)
			{
				return 1;
			}
		}
...
int func_390()
{
	switch (iLocal_439)
	{
		...
		case 1:
			iLocal_440 = TIME::GET_MILLISECONDS_PER_GAME_MINUTE() * 120;
			iLocal_440 = (iLocal_440 + GAMEPLAY::GET_GAME_TIMER());
			iLocal_441 = (iLocal_440 - TIME::GET_MILLISECONDS_PER_GAME_MINUTE() * 30);
		...
		case 2:
			if (GAMEPLAY::GET_GAME_TIMER() >= iLocal_440)
			{
				return 1;
			}
			else
			{
				if ((!iLocal_443 && GAMEPLAY::GET_GAME_TIMER() >= iLocal_441) && !func_212())
				{
...
void func_391()
{
	...
	if (iVar0 >= iLocal_446)
	{
		if ((iVar0 - iLocal_447) > 500)
		{
			...
			iLocal_447 = GAMEPLAY::GET_GAME_TIMER() + 1000;
		}
	}
	else if (iVar0 >= iLocal_445)
	{
		if ((iVar0 - iLocal_447) > 500)
		{
			...
			iLocal_447 = GAMEPLAY::GET_GAME_TIMER();
		}
	}
	...
	switch (iLocal_143)
	{
		case 0:
			if (!func_398())
			{
				...
				UI::CLEAR_PRINTS();
				UI::CLEAR_HELP(1);
				if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_449))
				{
					sLocal_449 = "DEFAULT";
				}
				if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_449, "DEFAULT"))
				{
					func_472(1);
				}
				else
...
void func_399()
{
	if (iLocal_442)
	{
		...
		{
			iVar0 = (iLocal_440 - GAMEPLAY::GET_GAME_TIMER());
			if (iVar0 < 0)
			{
				iVar0 = 0;
			}
...
void func_420()
{
	if (func_204(Local_145.f_4))
	{
		...
		VEHICLE::_0x51BB2D88D31A914B(Local_145.f_4, 0);
		VEHICLE::_0x192547247864DFDD(Local_145.f_4, 0);
		if (!bLocal_152)
		{
