void __EntryFunction__()
{
	...
	iLocal_159 = 1913437669;
	Local_161 = { -1138.977f, -1252.549f, 6.05f };
	iLocal_246 = -1973172295;
	iLocal_247 = -912318012;
	...
	{
		func_423(&(Local_186[0]), &(Local_81.f_35[1]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_28[0]))
	{
		func_422(&(Local_186[0].f_1), &(Local_81.f_28[0]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_28[1]))
	{
		func_422(&(Local_186[0].f_2), &(Local_81.f_28[1]));
	}
	func_420();
	while (true)
	{
...
void func_1()
{
	switch (iLocal_143)
	{
		...
		case 1:
			...
			else if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
			{
				HUD::CLEAR_PRINTS();
				iLocal_437 = 0;
				iLocal_436 = 1;
			...
			else if (ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, Local_161, 6f, 6f, 2f, 1, 1, 0))
			{
				func_214(&iLocal_144);
				iLocal_143 = 0;
				iLocal_142 = 6;
...
void func_3(int iParam0, bool bParam1)
{
	...
	{
		func_170(&(Global_110725[iVar0].f_9));
	}
	if (bParam1)
	{
...
void func_21(var uParam0)
{
	*uParam0 = 145;
	...
	while (iVar1 < 3)
	{
		...
		func_26(&(uParam0->f_25[0][iVar1]));
		func_26(&(uParam0->f_25[1][iVar1]));
		iVar0 = 0;
		while (iVar0 < 12)
		{
...
int func_31(int iParam0, int iParam1, int iParam2)
{
	...
	Global_76434[1] = { func_82(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_76434[1] = { func_82(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_74(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_74(iParam1), Global_76434[1].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, 0);
		}
	}
...
int func_32(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_147(iParam0, Global_111638.f_2358.f_539[iVar0].f_64, Global_111638.f_2358.f_539[iVar0].f_63))
		{
...
int func_34(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76434[1] = { func_82(iVar10, iParam1, iParam2, -1) };
		if (!func_72(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76434[1] = { func_82(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1] = { func_82(iVar10, 14, uVar28[iVar1], -1) };
							func_50(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
							func_65(14);
							if (Global_76432 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_74(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_65(iVar0);
						if (Global_76432 == 1)
						{
			...
			{
				Global_76434[1] = { func_82(iVar10, iVar0, func_40(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1] = { func_82(iVar10, 14, uVar69[iVar1], -1) };
			func_50(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
			func_65(14);
			if (Global_76432 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_74(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_74(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
{
	Global_76434[1] = { func_82(iParam0, iParam1, iParam2, -1) };
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								if (!func_43(-1692214353, iVar3, iVar5, iVar4, &iVar6))
								{
									if (iVar6 != -99)
									{
										iVar0 = iVar6;
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_74(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_74(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_52(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_52(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_52(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_52(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_65(int iParam0)
{
	...
	{
		func_71(iParam0, Global_76434[1].f_5, Global_76434[1].f_2, 2, Global_76434[1].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76434[1].f_6, 1) && MISC::IS_BIT_SET(Global_76434[1].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2548434[iParam0][func_68(iParam2)];
	if (iVar0 != 0)
	{
...
int func_69(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0][func_68(iParam1)];
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_147(iParam0, Global_111638.f_2358.f_539[iVar0].f_61, Global_111638.f_2358.f_539[iVar0].f_60) || iParam3 == 1)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_57(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_80(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_80(Var16.z)] = func_57(iParam1, Var16.x, func_80(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_80(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
...
void func_84(int iParam0)
{
	...
	func_85(&(Global_76434[0]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_92(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_85(&(Global_76434[0]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_85(&(Global_76434[0]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_85(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_85(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_74(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_147(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_147(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_147(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76434[2] = { func_82(iVar0, 14, iVar4, -1) };
									if (Global_76434[2].f_12 == iVar3)
									{
										if (func_147(iParam0, 14, iVar4))
										{
											if (!func_38(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76434[2])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76434[2] = { func_82(iVar0, iVar2, iVar1, -1) };
						if (!func_38(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76434[2])))
						{
							return 0;
						}
					}
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_74(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_74(iParam1)))
	{
		return 1;
	}
	return 0;
...
{
	func_175(iParam0, 1);
	Global_111638.f_18569[iParam0].f_3 = func_174();
...
{
	if (Local_167[iParam0].f_1 < Local_167[iParam0] || Local_167[iParam0] == -1)
	{
		return 1;
	}
	return 0;
...
void func_210(int iParam0)
{
	if (func_209(iParam0))
	{
		func_211(Local_167[iParam0].f_2, 7500, 1);
		Local_167[iParam0].f_1++;
	}
}
...
int func_213(struct<3> Param0, int iParam3, int iParam4)
{
	iVar0 = 0;
...
int func_235()
{
	...
	while (iLocal_250 <= 5)
	{
		if (func_236(Local_167[iLocal_250].f_2, 0, 0))
		{
			iVar0 = 1;
		}
		iLocal_250++;
...
int func_240(int iParam0, int iParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_245()
{
	...
	{
		if (!func_212() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
		{
			if (!iLocal_425)
			{
				iLocal_425 = 1;
			...
			if ((MISC::GET_GAME_TIMER() - iLocal_427) > Local_416[iLocal_426].f_1 && (func_247() || iLocal_426 == 0))
			{
				if (iLocal_426 != 2 || ENTITY::GET_ENTITY_SPEED(Local_145.f_4) > 10f)
				{
					if (func_235() || MISC::GET_PROFILE_SETTING(203) == 0)
					{
						if (func_246(&uLocal_251, "BAR3AAU", Local_416[iLocal_426], 7, 1, 0, 0))
						{
							iLocal_425 = 0;
							iLocal_426++;
						}
					}
					else if (func_246(&uLocal_251, "BAR3AAU", Local_416[iLocal_426], 7, 0, 0, 0))
					{
						iLocal_425 = 0;
						iLocal_426++;
					}
...
{
	func_260(&Global_105187, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_260(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	*uParam0 = func_230();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_282())
		{
			func_278(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
{
	uVar0 = Global_2583656[iParam0][func_68(iParam1)];
...
void func_283(int iParam0, bool bParam1)
{
	...
	if (func_151(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_284(iParam0, &(Global_111638.f_2358.f_539.f_298[iVar0]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_290(int iParam0)
{
	...
	if (func_151(iVar0) && !PED::IS_PED_INJURED(uParam0))
	{
...
int func_295(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_316())
		{
			*uParam0 = func_300(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_300(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_315(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_301(iVar0, 0), 1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_362(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_359(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_336(Global_102203.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_336(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_355(iParam5, &Var0, Param1, uParam4, func_267(iParam0));
...
void func_337(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_354(&(Global_75441.f_555[0]), iParam0))
	{
		return;
	}
...
int func_354(var uParam0, int iParam1)
{
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_294(Global_111638.f_32744.f_1864[uParam0->f_14], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_294(Global_111638.f_2358.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_294(Global_111638.f_2358.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, 0))
		{
...
void func_355(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6)
{
	if (func_354(&(Global_75441.f_555[0]), iParam0))
	{
		...
		{
			func_357(iParam0);
			func_356(uParam1, &(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]));
...
void func_366()
{
	...
	if ((iLocal_245 && Local_186[0].f_24 == 1) && Local_186[1].f_24 == 1)
	{
...
{
	switch (Local_186[iParam0].f_24)
	{
		case 0:
			if (!ENTITY::DOES_ENTITY_EXIST(Local_186[iParam0].f_1))
			{
				if (func_204(Local_186[iParam0]))
				{
					if (STREAMING::HAS_MODEL_LOADED(iLocal_247))
					{
						Local_186[iParam0].f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_186[iParam0], 6, iLocal_247, -1, 1, 1);
						Local_186[iParam0].f_2 = PED::CREATE_PED_INSIDE_VEHICLE(Local_186[iParam0], 6, iLocal_247, 0, 1, 1);
					}
				}
				else if (STREAMING::HAS_MODEL_LOADED(iLocal_246))
				{
					Local_186[iParam0] = VEHICLE::CREATE_VEHICLE(iLocal_246, Local_186[iParam0].f_3, Local_186[iParam0].f_6, 1, 1, 0);
				}
			}
			else if (!ENTITY::IS_ENTITY_DEAD(Local_186[iParam0].f_1, 0))
			{
				PED::SET_PED_AS_COP(Local_186[iParam0].f_1, 1);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0].f_1, 1);
				WEAPON::GIVE_DELAYED_WEAPON_TO_PED(Local_186[iParam0].f_1, 453432689, 100, 1);
				PED::SET_PED_ACCURACY(Local_186[iParam0].f_1, 10);
				if (func_204(Local_186[iParam0].f_2))
				{
					PED::SET_PED_AS_COP(Local_186[iParam0].f_2, 1);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0].f_2, 1);
					WEAPON::GIVE_DELAYED_WEAPON_TO_PED(Local_186[iParam0].f_2, 453432689, 100, 1);
					PED::SET_PED_ACCURACY(Local_186[iParam0].f_2, 10);
				}
				Local_186[iParam0].f_24 = 1;
			}
			break;
		
		case 1:
			if (func_207(PLAYER::PLAYER_PED_ID(), Local_186[iParam0].f_3, 275f))
			{
				if (func_386(iParam0))
				{
					Local_186[iParam0].f_25 = MISC::GET_GAME_TIMER() + 1750;
					Local_186[iParam0].f_24 = 2;
				}
				else if ((func_385(Local_186[iParam0]) || func_372(Local_186[iParam0].f_1)) || func_372(Local_186[iParam0].f_2))
				{
					func_370(iParam0, 0);
				}
				else if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
			...
			{
				if (!Local_186[iParam0].f_26 && ENTITY::DOES_ENTITY_EXIST(Local_186[iParam0].f_1))
				{
					func_369(&(Local_186[iParam0].f_1));
					Local_186[iParam0].f_26 = 1;
				}
				if (!Local_186[iParam0].f_27 && ENTITY::DOES_ENTITY_EXIST(Local_186[iParam0].f_2))
				{
					func_369(&(Local_186[iParam0].f_2));
					Local_186[iParam0].f_27 = 1;
				}
				if (!Local_186[iParam0].f_28 && ENTITY::DOES_ENTITY_EXIST(Local_186[iParam0]))
				{
					func_203(&(Local_186[iParam0]));
					Local_186[iParam0].f_28 = 1;
				}
				if ((Local_186[iParam0].f_26 && Local_186[iParam0].f_27) && Local_186[iParam0].f_28)
				{
					Local_186[iParam0].f_24 = 4;
				}
			}
			if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
			{
				if ((func_372(Local_186[iParam0].f_1) || func_372(Local_186[iParam0].f_2)) || func_385(Local_186[iParam0]))
				{
					func_370(iParam0, 0);
				}
			}
		...
		case 2:
			if (MISC::GET_GAME_TIMER() > Local_186[iParam0].f_25)
			{
				func_370(iParam0, 1);
			}
			else if ((func_372(Local_186[iParam0].f_1) || func_372(Local_186[iParam0].f_2)) || func_385(Local_186[iParam0]))
			{
				func_370(iParam0, 0);
			}
			break;
		...
		case 3:
			if (!func_207(PLAYER::PLAYER_PED_ID(), Local_186[iParam0].f_3, 275f))
			{
				if (!Local_186[iParam0].f_26 && ENTITY::DOES_ENTITY_EXIST(Local_186[iParam0].f_1))
				{
					func_368(&(Local_186[iParam0].f_1), 1, 0, 1);
					Local_186[iParam0].f_26 = 1;
				}
				if (!Local_186[iParam0].f_27 && ENTITY::DOES_ENTITY_EXIST(Local_186[iParam0].f_2))
				{
...
void func_370(int iParam0, int iParam1)
{
	...
	if (func_204(Local_186[iParam0].f_1))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0].f_1, 0);
		PED::SET_PED_HIGHLY_PERCEPTIVE(Local_186[iParam0].f_1, 1);
		func_368(&(Local_186[iParam0].f_1), 1, 0, 1);
	}
	if (func_204(Local_186[iParam0].f_2))
	{
		PED::SET_PED_AS_COP(Local_186[iParam0].f_2, 1);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0].f_2, 0);
		PED::SET_PED_HIGHLY_PERCEPTIVE(Local_186[iParam0].f_2, 1);
		func_368(&(Local_186[iParam0].f_2), 1, 0, 1);
	}
	if (iParam1 && func_204(Local_186[iParam0]))
	{
		VEHICLE::SET_VEHICLE_ENGINE_ON(Local_186[iParam0], 1, 1, 0);
		func_371(&(Local_186[iParam0]));
	}
...
bool func_375(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_376(&(Local_37[iVar4]), Var1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
{
	Var0 = { func_381(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_145.f_4, Local_186[iParam0].f_7[0][0], Local_186[iParam0].f_7[0][1], Local_186[iParam0].f_7[0].f_7, 0, 1, 0))
	{
		return 1;
	}
	else if (Local_186[iParam0].f_7[1].f_7 != 0f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_145.f_4, Local_186[iParam0].f_7[1][0], Local_186[iParam0].f_7[1][1], Local_186[iParam0].f_7[1].f_7, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
void func_393(bool bParam0)
{
	if (bParam0)
	{
		...
		while (iLocal_250 <= 1)
		{
			func_369(&(Local_186[iLocal_250].f_1));
			func_369(&(Local_186[iLocal_250].f_2));
			iLocal_250++;
		}
		iLocal_250 = 0;
		while (iLocal_250 <= 1)
		{
			func_203(&(Local_186[iLocal_250]));
			iLocal_250++;
		}
	}
	else
	{
		func_394(&uLocal_155, 0);
		func_371(&(Local_145.f_4));
		iLocal_250 = 0;
		while (iLocal_250 <= 1)
		{
			func_368(&(Local_186[iLocal_250].f_1), 1, 0, 1);
			func_368(&(Local_186[iLocal_250].f_2), 1, 0, 1);
			func_371(&(Local_186[iLocal_250]));
			iLocal_250++;
		}
	}
	if (iLocal_245)
...
{
	if (Local_167[iParam0] == -1)
	{
	}
	else
	{
		Local_167[iParam0].f_1 = Local_167[iParam0];
	}
}
...
void func_441(bool bParam0)
{
	...
	while (iLocal_250 <= 1)
	{
		...
		if (bParam0)
		{
			Local_186[iLocal_250].f_26 = 0;
			Local_186[iLocal_250].f_27 = 0;
			Local_186[iLocal_250].f_28 = 0;
			Local_186[iLocal_250].f_24 = 0;
			if (!iLocal_245)
			{
		...
		{
			Local_186[iLocal_250].f_26 = 1;
			Local_186[iLocal_250].f_27 = 1;
			Local_186[iLocal_250].f_28 = 1;
			Local_186[iLocal_250].f_24 = 4;
			if (iLocal_245)
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_247);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_246);
...
void func_442(struct<3> Param0, float fParam3, bool bParam4)
{
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_155, Local_145.f_4, 0, Local_156, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
		...
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1] = { func_454(iParam0) };
					...
					{
						Global_7966[1] = { func_454(iParam0) };
...
void func_459()
{
	Local_186[0].f_3 = { 1195.3f, -1312.74f, 34.75f };
	Local_186[0].f_6 = 282.4f;
	Local_186[0].f_7[0][0] = { 1216.144f, -1287.004f, 33.97642f };
	Local_186[0].f_7[0][1] = { 1202.456f, -1306.054f, 39.47411f };
	Local_186[0].f_7[0].f_7 = 16.5f;
	Local_186[0].f_7[1][0] = { 1204.858f, -1296.131f, 33.97642f };
	Local_186[0].f_7[1][1] = { 1198.832f, -1365.926f, 39.47705f };
	Local_186[0].f_7[1].f_7 = 37.5f;
	Local_186[0].f_24 = 0;
	Local_186[1].f_3 = { 1162.71f, -1357.86f, 33.73f };
	Local_186[1].f_6 = 266.7f;
	Local_186[1].f_7[0][0] = { 1164.457f, -1363.839f, 33.51062f };
	Local_186[1].f_7[0][1] = { 1180.637f, -1359.837f, 39.11396f };
	Local_186[1].f_7[0].f_7 = 15.5f;
	Local_186[1].f_7[1][0] = { 0f, 0f, 0f };
	Local_186[1].f_7[1][1] = { 0f, 0f, 0f };
	Local_186[1].f_7[1].f_7 = 0f;
	Local_186[1].f_24 = 0;
}

void func_460()
{
	Local_167[0] = { func_461("B3ADELV", 1) };
	Local_167[1] = { func_461("B3AGETIN", 1) };
	Local_167[2] = { func_461("B3AWAN1", -1) };
	Local_167[3] = { func_461("B3ARTV", 1) };
	Local_167[4] = { func_461("B3AEXIT", 1) };
	Local_167[5] = { func_461("B3ALEAVE", 1) };
}
...
void func_462()
{
	Local_416[0] = "BAR3A_C1";
	Local_416[0].f_1 = 1000;
	Local_416[1] = "BAR3A_W2";
	Local_416[1].f_1 = 19000;
	Local_416[2] = "BAR3A_W1";
	Local_416[2].f_1 = 20000;
	Local_416[3] = "BAR3A_W4";
	Local_416[3].f_1 = 22000;
}
