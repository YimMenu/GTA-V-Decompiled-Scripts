...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		uVar0 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_141.f_4)
	{
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			uVar33 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
		...
		case 8:
			uVar34 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
...
int func_85()
{
	if (Global_2425662[PLAYER::PLAYER_ID()].f_310.f_8 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("business_hub_garage_seats", Global_2425662[PLAYER::PLAYER_ID()].f_310.f_8, 1, 0))
		{
			return 0;
		}
...
{
	func_91(iParam0, &Var0, &uVar3);
	(*uParam1)[iParam2] = iParam3;
	uParam1[iParam2]->f_8 = { Var0 };
	uParam1[iParam2]->f_8.f_3 = { 0f, 0f, uVar3 };
	uParam1[iParam2]->f_1 = { func_89(func_90(), uVar3) + Var0 };
	uParam1[iParam2]->f_1.f_3 = { func_89(func_88(), uVar3) + Var0 };
