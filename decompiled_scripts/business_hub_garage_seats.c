...
int func_85()
{
	if (Global_2425662[PLAYER::PLAYER_ID() /*421*/].f_310.f_8 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("business_hub_garage_seats", Global_2425662[PLAYER::PLAYER_ID() /*421*/].f_310.f_8, 1, 0))
		{
			return 0;
		}
...
void func_87(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_91(iParam0, &Var0, &uVar1);
	(*uParam1)[iParam2 /*14*/] = iParam3;
	(uParam1[iParam2 /*14*/])->f_8 = { Var0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, uVar1 };
	(uParam1[iParam2 /*14*/])->f_1 = { func_89(func_90(), uVar1) + Var0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_89(func_88(), uVar1) + Var0 };
