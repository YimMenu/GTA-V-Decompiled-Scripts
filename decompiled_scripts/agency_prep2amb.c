...
void func_175()
{
	if ((MISC::IS_BIT_SET(iLocal_49, 0) && Global_41431 == 15) && !func_208())
	{
		if (iLocal_38 == 0)
		{
...
void func_224()
{
	...
	if (((((((Global_41431 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_49, 5)) && !func_208()) && Global_76619 == -1) && !func_234()) && !func_84(9)) || func_103(35))
	{
		func_233();
		func_231();
		switch (iLocal_39)
