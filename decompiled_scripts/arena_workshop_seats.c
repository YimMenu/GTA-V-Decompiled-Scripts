...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		uVar0 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_43.f_1);
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_43.f_4)
	{
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			uVar9 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_43.f_1);
		...
		case 8:
			uVar10 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_43.f_1);
...
int func_86()
{
	if (Global_2425662[PLAYER::PLAYER_ID() /*421*/].f_310.f_8 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("arena_workshop_seats", Global_2425662[PLAYER::PLAYER_ID() /*421*/].f_310.f_8, 1, 0))
		{
			return 0;
		}
...
Vector3 func_90(struct<3> Param0, var uParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
