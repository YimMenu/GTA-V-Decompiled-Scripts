...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_85.f_4)
	{
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			uVar42 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_85.f_1);
		...
		case 8:
			uVar43 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_85.f_1);
