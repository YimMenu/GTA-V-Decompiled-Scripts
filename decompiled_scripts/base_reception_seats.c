...
void func_11(var uParam0)
{
	...
	Var20 = { *uParam0[uParam0->f_85.f_2] };
	switch (uParam0->f_85.f_4)
	{
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			uVar42 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_85.f_1);
		...
		case 8:
			uVar43 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_85.f_1);
...
{
	Var0 = { uParam0[uParam0->f_85.f_2]->f_8.f_3 };
...
bool func_46(var uParam0)
{
	...
	Stack.Push(uParam0[uParam0->f_85.f_2]);
...
int func_47(var uParam0)
{
	...
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if ((iVar1 != PLAYER::PLAYER_ID() && func_48(iVar1, 1, 1)) && func_50(PLAYER::GET_PLAYER_PED(iVar1), uParam0[uParam0->f_85.f_2]))
			{
				return 1;
			}
		}
...
void func_56(var uParam0)
{
	...
	func_57(&(uParam0->f_85), 2, AI::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
int func_73()
{
	if (Global_1590380 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_reception_seats", Global_1590380, 1, 0))
		{
			return 0;
		}
...
void func_77(int iParam0, var uParam1, int iParam2)
{
	...
	while (iVar4 < 2)
	{
		...
		uParam1[(*iParam2)[iVar4]]->f_8 = { func_80(func_81(iVar4), fVar3) + Var0 };
		uParam1[(*iParam2)[iVar4]]->f_8.f_3 = { 0f, 0f, (fVar3 + 174f) };
		uParam1[(*iParam2)[iVar4]]->f_1 = { func_80(func_79(iVar4), fVar3) + Var0 };
		uParam1[(*iParam2)[iVar4]]->f_1.f_3 = { func_80(func_78(iVar4), fVar3) + Var0 };
