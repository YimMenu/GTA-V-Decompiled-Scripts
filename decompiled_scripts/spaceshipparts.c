...
void func_5()
{
	...
	{
		if (func_9(Global_112293.f_2361.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
int func_19(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_112293.f_10047.f_108, func_25(func_26(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
