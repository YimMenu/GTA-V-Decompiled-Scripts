...
void func_6()
{
	...
	while (iVar1 < iVar0)
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_903.f_32, iVar1))
		{
			Var2 = { func_12(iVar1) };
			if (!func_11(Var2, 0f, 0f, 0f, 0))
			{
				if (!NETWORK::NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(Local_903.f_19[iVar1]))
				{
					...
					{
						GAMEPLAY::SET_BIT(&(Local_903.f_32), iVar1);
	...
	if (func_2(&uLocal_848, 300000, 0))
	{
		...
		while (iVar1 < iVar0)
		{
			if (GAMEPLAY::IS_BIT_SET(Local_903.f_32, iVar1))
			{
				GAMEPLAY::CLEAR_BIT(&(Local_903.f_32), iVar1);
			}
			iVar1++;
		}
		func_7(&uLocal_848);
...
int func_8(var uParam0, var uParam1, struct<3> Param2, int iParam5)
{
	if (!func_10(Param2))
	{
		...
		if (func_9(iVar0))
		{
			...
			*uParam0 = OBJECT::CREATE_AMBIENT_PICKUP(-301062413, Param2 + Vector(0f, 0f, 0f), iVar1, -1, iVar0, iParam5, 1);
...
void func_15(int iParam0)
{
	...
	GAMEPLAY::SET_BIT(&(Local_903.f_1), iParam0);
}
...
{
	return GAMEPLAY::IS_BIT_SET(Local_903.f_1, iParam0);
}
	...
	if (!func_17(3))
	{
		if (bVar0)
		{
			...
			if (!func_5(&(Local_903.f_7)))
			{
				...
				if (Local_903.f_4 > 0)
				{
					uVar2 = NETWORK::GET_TIME_OFFSET(NETWORK::GET_NETWORK_TIME(), (-1 * Local_903.f_4));
...
bool func_28()
{
	if (!func_17(1))
	{
		...
		{
			Local_903.f_31 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3);
		}
			...
			if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
			{
				...
				if (!func_47(iVar13, 0))
				{
					...
					if (func_27() == 1)
					{
						if (func_44(iVar1, 2))
						{
							if (!GAMEPLAY::IS_BIT_SET(Local_903.f_2, iVar0))
							{
								iVar5++;
								GAMEPLAY::SET_BIT(&(Local_903.f_2), iVar0);
							}
							else
							{
								iVar5++;
						...
						else if (GAMEPLAY::IS_BIT_SET(Local_903.f_2, iVar0))
						{
							GAMEPLAY::CLEAR_BIT(&(Local_903.f_2), iVar0);
						}
					}
					else if (func_27() == 3)
					{
...
{
	GAMEPLAY::CLEAR_BIT(&(Local_903.f_1), iParam0);
}

bool func_44(int iParam0, int iParam1)
{
	return GAMEPLAY::IS_BIT_SET(Local_938[iParam0].f_1, iParam1);
}
...
void func_51()
{
	if (!func_729(5))
	{
		...
		while (iVar0 < func_13())
		{
			if (UI::DOES_BLIP_EXIST(uLocal_853[iVar0]))
			{
				UI::REMOVE_BLIP(&(uLocal_853[iVar0]));
			}
			iVar0++;
		}
		func_74();
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Global_2425662[Global_2439138.f_1894.f_703.f_16].f_404, 0) && func_59())
		{
			iParam0 = 23;
		}
	}
	...
	if (!func_729(8))
	{
		...
		while (iVar0 < 32)
		{
			...
			if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar1))
			{
				...
				{
					if (GAMEPLAY::IS_BIT_SET(uLocal_844, iVar0))
					{
...
int func_77(int iParam0)
{
	...
	if (GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()) == func_78())
	{
		return 1;
	}
	return 0;
...
{
	GAMEPLAY::CLEAR_BIT(&(Local_938[NETWORK::PARTICIPANT_ID_TO_INT()].f_1), iParam0);
}
...
{
	GAMEPLAY::SET_BIT(&(Local_938[NETWORK::PARTICIPANT_ID_TO_INT()].f_1), iParam0);
}
...
int func_100(int iParam0)
{
	switch (iParam0)
	{
		...
		case 180:
		case 148:
			if (Global_1590535[PLAYER::PLAYER_ID()] == 148 && func_46(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_35, 1))
			{
				return 1;
			}
			else
...
{
	iVar0 = 2;
	bVar1 = ((func_121(iParam0) && !func_120(iParam0)) && !GAMEPLAY::IS_BIT_SET(Global_1628237[iParam0].f_1, 8));
...
int func_142(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0][func_143(iParam1)];
	...
	switch (iParam0)
	{
		...
		case 190:
			if (func_145())
			{
				...
				{
					Var7 = { func_173() };
					unk_0x8586789730B10CAF(iParam1, GAMEPLAY::GET_HASH_KEY(func_172(Var7)), func_171(Var7), iParam4);
				}
			}
			else if (func_174())
			{
		...
		case 226:
			if (func_158())
			{
				if (!func_174())
				{
					unk_0x8586789730B10CAF(iParam1, GAMEPLAY::GET_HASH_KEY(func_172(func_157(PLAYER::PLAYER_ID()))), 5, iParam4);
				}
			}
			else if (func_174())
			{
...
int func_160(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (!bVar0)
	{
		if (!UNK3::_0xB24F0944DA203D9E(func_49()) || UNK3::_0x810E8431C0614BF9())
		{
			Global_4264536 = 1;
			return 0;
		}
...
void func_201(int iParam0, int iParam1, int iParam2)
{
	if (func_220())
	{
		...
		if (func_207(PLAYER::PLAYER_ID()))
		{
			...
			Global_1590535[PLAYER::PLAYER_ID()].f_211.f_6 = func_205(iParam0, 1);
		}
...
int func_218(int iParam0)
{
	if (iParam0 < 0)
	{
		if (GAMEPLAY::ABSI(iParam0) > func_208(PLAYER::PLAYER_ID()))
		{
...
int func_239(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iParam1) || iParam5)
	{
		...
		UI::_SET_NOTIFACTION_COLOR_NEXT(func_246(iParam1, -2, 1, 0, 0));
		UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(func_244(&Var1));
		if (!iParam3 == 0)
		{
...
int func_246(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_274(PLAYER::PLAYER_ID()) || (func_273() && func_272())) && !GAMEPLAY::IS_BIT_SET(Global_2537071.f_4591, 31)) && !bParam4)
	{
		uVar1 = func_271();
		if (ENTITY::DOES_ENTITY_EXIST(uVar1))
		{
			if (PED::IS_PED_A_PLAYER(iVar1))
			{
				...
				{
					if (func_993(NETWORK::_NETWORK_GET_PED_PLAYER(iVar1), 0, 1))
					{
						if ((iParam1 > -1 && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
						{
							...
							{
								return func_258(iParam0, NETWORK::_NETWORK_GET_PED_PLAYER(iVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
	...
	if ((iParam1 > -1 && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
	{
		...
		{
			return func_258(iParam0, PLAYER::PLAYER_ID(), iParam1, bParam2, bParam3);
		}
	}
	return func_258(iParam0, PLAYER::PLAYER_ID(), iParam1, bParam2, bParam3);
}
...
int func_248(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if (bParam1)
	{
		if (iParam2 > -1)
		{
			if (func_213(iVar0, iParam2, 0) && !GAMEPLAY::IS_BIT_SET(Global_4456448.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_252(1);
...
int func_258(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar1)
	{
		if (iVar0 != -1)
		{
			...
			if ((func_260(iParam1, iParam0, iVar0, 0) && !GAMEPLAY::IS_BIT_SET(Global_4456448.f_15, 18)) || ((func_213(PLAYER::GET_PLAYER_TEAM(iParam1), PLAYER::GET_PLAYER_TEAM(iParam0), 0) && GAMEPLAY::IS_BIT_SET(Global_4456448.f_15, 23)) && !GAMEPLAY::IS_BIT_SET(Global_4456448.f_15, 18)))
			{
				return func_252(1);
			}
...
int func_269(int iParam0, int iParam1, bool bParam2)
{
	...
	if (iParam0 > -1 && iParam1 != func_29())
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_4456448.f_15, 26) && !func_213(iParam0, PLAYER::GET_PLAYER_TEAM(iParam1), 0))
		{
			iVar0 = func_259(1);
		}
	}
...
var func_298(struct<5> Param0, int iParam5)
{
	...
	else if (iParam0 == 190)
	{
		if (uParam1->f_10 > 0)
		{
			if (func_145())
			{
				...
				iVar7 = func_323(PLAYER::PLAYER_ID(), Var0, *uParam3);
				if (Var0.f_1 == 1)
				{
	...
	else if (iParam0 == 168)
	{
		if (bParam1)
		{
			if (func_41(PLAYER::PLAYER_ID()))
			{
				if (uParam2->f_5)
				{
					*iParam3 = (*iParam3 + func_336(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_182));
				}
				else
				{
					*uParam4 = uParam2->f_7;
...
int func_336(int iParam0)
{
	if (func_343(iParam0))
	{
		...
		if (iVar1 < func_337(iParam0))
		{
			...
			{
				iVar0 = (iVar0 + func_341(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 6)));
				iVar2++;
			}
		}
	}
...
void func_356(int iParam0, int iParam1)
{
	if (iParam1 != func_29())
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam1))
		{
			...
			else if (func_357(iParam1, PLAYER::PLAYER_ID()))
			{
				iVar0 = 1;
			}
		}
...
int func_379()
{
	if ((func_993(PLAYER::PLAYER_ID(), 1, 1) && !UI::IS_PAUSE_MENU_ACTIVE()) && !func_380())
	{
		return 1;
	}
	return 0;
...
void func_381(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, int iParam5, bool bParam6, int iParam7)
{
	...
	if (func_499() || iParam2 == 28)
	{
		...
		{
			func_449(1);
			if ((!func_448() && !func_447()) || GAMEPLAY::IS_BIT_SET(Global_2537071.f_4588, 1))
			{
				if (func_446())
				{
					func_444();
				...
				else
				{
					...
					if (uParam3->f_27 == 0)
					{
						...
						while (iVar52 < 32)
						{
							...
							if ((func_436(iVar35) && func_432(iVar35, iParam2)) && func_993(iVar35, 0, 1))
							{
								...
								*uParam4[iVar52] = { func_200(iVar35) };
								...
								if (func_413(iParam5))
								{
									func_412(iVar35, uParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar43, iVar47, &Var57, uParam0[iVar52]->f_40, iVar48, bParam6);
								}
								else
								{
									func_412(iVar35, uParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar46, iVar47, &Var57, uParam0[iVar52]->f_40, iVar48, bParam6);
								}
						...
						{
							iVar35 = PLAYER::INT_TO_PLAYERINDEX(iVar52);
							if (func_993(iVar35, 0, 1) && !GAMEPLAY::IS_BIT_SET(iVar49, iVar35))
							{
								iVar35 = PLAYER::INT_TO_PLAYERINDEX(iVar52);
							}
							else
							...
							if (func_436(iVar35))
							{
								if (func_993(PLAYER::INT_TO_PLAYERINDEX(iVar52), 0, 1))
								{
									...
									*uParam4[iVar52] = { func_200(iVar35) };
									...
									uParam3->f_38[iVar44].f_1 = iVar53;
									func_394(iVar35, PLAYER::GET_PLAYER_NAME(iVar35), uParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar51, iVar50);
									iVar53++;
								}
							}
							iVar52++;
		...
		if (iVar2 != func_29())
		{
			if (func_993(iVar2, 0, 1))
			{
				if (uParam0->f_38[iVar0].f_1 != -1)
				{
					...
					func_392(uParam1, uParam0->f_38[iVar0].f_1, iVar1, Global_1590535[iVar0].f_211.f_6);
				}
			}
		}
		iVar0++;
...
int func_441(int iParam0)
{
	if (func_993(iParam0, 0, 1))
	{
		if (func_993(PLAYER::PLAYER_ID(), 0, 1))
		{
			if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(iParam0, PLAYER::PLAYER_ID()) || func_67(iParam0) == 233)
			{
				return 1;
			}
		}
...
int func_446()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2537071.f_4588, 0) && func_122())
	{
		return 1;
	}
	if (GAMEPLAY::IS_BIT_SET(Global_2537071.f_4588, 1) && func_122())
	{
		return 1;
	}
	return 0;
...
char* func_458(var uParam0)
{
	...
	switch (func_67(PLAYER::PLAYER_ID()))
	{
		...
		case 192:
			if (func_459(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_181))
			{
				return "GB_DPAD_BSET";
			}
			return "GB_DPAD_BBUY";
...
{
	if (iParam0 == 20 && (!func_400() || GAMEPLAY::IS_STRING_NULL_OR_EMPTY(uParam1)))
	{
		uVar0 = func_473();
		return uVar0;
	}
...
int func_477()
{
	...
	else if (!func_483(PLAYER::PLAYER_ID(), 1, 0) && Global_1311716[0] > 0)
	{
		return 0;
	}
...
void func_505()
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (((((VEHICLE::DOES_VEHICLE_HAVE_WEAPONS(iVar0) || ENTITY::GET_ENTITY_MODEL(iVar0) == 970385471) || ENTITY::GET_ENTITY_MODEL(iVar0) == -82626025) || ENTITY::GET_ENTITY_MODEL(iVar0) == 788747387) || ENTITY::GET_ENTITY_MODEL(iVar0) == -1860900134) || ENTITY::GET_ENTITY_MODEL(iVar0) == -1600252419)
		{
...
void func_506()
{
	...
	while (iVar0 < func_13())
	{
		if (!UI::DOES_BLIP_EXIST(uLocal_853[iVar0]))
		{
			...
			{
				uLocal_853[iVar0] = UI::ADD_BLIP_FOR_ENTITY(NETWORK::NET_TO_OBJ(Local_903.f_19[iVar0]));
				UI::SET_BLIP_SPRITE(uLocal_853[iVar0], 351);
				UI::SET_BLIP_COLOUR(uLocal_853[iVar0], 2);
				UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_853[iVar0], "GB_AMMOPICKBLIP");
			}
		}
		iVar0++;
	}
...
void func_507()
{
	GAMEPLAY::SET_BIT(&(Global_2537071.f_5123), 1);
}
...
void func_508(int iParam0, bool bParam1, var uParam2, int iParam3)
{
	...
	if (GAMEPLAY::ARE_STRINGS_EQUAL(func_513(iVar1), "IE_PRE_COUNTDOWN_STOP"))
	{
		iVar0 = 35000;
	}
	else
				...
				if (Global_2425662[PLAYER::PLAYER_ID()].f_222 == 99)
				{
					if (!func_44(NETWORK::PARTICIPANT_ID(), 8))
					{
						if (!func_5(&uLocal_896))
						{
							if (func_517())
							{
								AUDIO::PLAY_SOUND_FRONTEND(iLocal_847, "Out_of_Bounds_Explode", "MP_MISSION_COUNTDOWN_SOUNDSET", 0);
							}
							else
							{
								AUDIO::PLAY_SOUND_FRONTEND(iLocal_847, "Out_of_Bounds", "MP_MISSION_COUNTDOWN_SOUNDSET", 0);
							}
						...
						if (func_5(&uLocal_896))
						{
							...
							else if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
							{
								...
								Local_938[NETWORK::PARTICIPANT_ID_TO_INT()].f_4++;
							}
							else
							{
...
int func_519()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var0, Var3, uVar6, 0, 1, 0))
		{
			return 1;
		}
	}
...
void func_540()
{
	...
	if (!func_729(7))
	{
		func_553(&uLocal_83);
		func_705(7);
		GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(func_552(func_34(PLAYER::PLAYER_ID())), 50f, 1);
	}
...
float func_545(var uParam0)
{
	if (func_550(uParam0))
	{
		...
		{
			return (func_546(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_546(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - fParam1);
		...
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (!func_85())
			{
				...
				if (func_518(iVar0))
				{
					...
					if (GAMEPLAY::IS_BIT_SET(Local_903.f_2, NETWORK::PARTICIPANT_ID_TO_INT()))
					{
						if (!func_44(NETWORK::PARTICIPANT_ID(), 1))
						{
...
{
	GAMEPLAY::SET_BIT(&uLocal_835, iParam0);
}
...
char* func_558(int iParam0)
{
	if (iParam0 == PLAYER::PLAYER_ID())
	{
		uVar0 = func_563(&(Global_1628237[iParam0].f_11.f_104));
		return uVar0;
	}
	...
	if (((func_62(iParam0, 28) || func_62(PLAYER::PLAYER_ID(), 28)) || func_560(iParam0)) && !func_559(iParam0))
	{
	...
	if (iVar1 != func_29())
	{
		uVar0 = func_563(&(Global_1628237[iVar1].f_11.f_104));
...
int func_565()
{
	if (((((!func_380() && !UI::IS_PAUSE_MENU_ACTIVE()) && !UI::IS_RADAR_HIDDEN()) && func_993(PLAYER::PLAYER_ID(), 1, 1)) && !func_122()) && !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
	{
		return 1;
	}
	return 0;
...
{
	GAMEPLAY::CLEAR_BIT(&uLocal_835, iParam0);
}

bool func_572(int iParam0)
{
	return GAMEPLAY::IS_BIT_SET(uLocal_835, iParam0);
}

int func_573()
{
	Var0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
	Var3 = { func_552(func_575(PLAYER::PLAYER_ID())) };
	fVar6 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Var0, Var3, 0);
	fVar7 = (func_574(func_575(PLAYER::PLAYER_ID())) / 2f);
	if (fVar6 <= fVar7)
	{
		if (GAMEPLAY::ABSF((Var3.z - Var0.z)) <= fVar7)
		{
			return 1;
		}
	}
...
{
	Var0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
	Var3 = { func_552(func_34(PLAYER::PLAYER_ID())) };
	fVar6 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Var0, Var3, 0);
...
void func_577()
{
	UI::GET_HUD_COLOUR(iLocal_862, &uVar0, &uVar1, &uVar2, &uVar3);
	fVar4 = 16.125f;
	fVar5 = 3.75f;
	fVar6 = func_574(func_34(PLAYER::PLAYER_ID()));
	Var7 = { func_552(func_34(PLAYER::PLAYER_ID())) };
	Var7.z = (Var7.z - fVar5);
		...
		if (func_5(&(Local_903.f_5)))
		{
			...
			if (iLocal_846 < func_3())
			{
				...
				if (iVar5 != func_29())
				{
					...
					{
						if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_880))
						{
...
void func_612()
{
	...
	if (!UI::DOES_BLIP_EXIST(uLocal_852))
	{
		...
		uLocal_852 = unk_0xCE5D0E5E315DB238(Var0, uVar3, uVar4);
		UI::SET_BLIP_ROTATION(uLocal_852, uVar5);
		func_613(&uLocal_852, 29);
		UI::SET_BLIP_ALPHA(uLocal_852, 180);
		UI::_0x75A16C3DA34F1245(uLocal_852, 0);
	}
}
...
void func_616()
{
	if (!UI::DOES_BLIP_EXIST(uLocal_851))
	{
		uLocal_851 = UI::ADD_BLIP_FOR_COORD(func_552(func_34(PLAYER::PLAYER_ID())));
		UI::SET_BLIP_SPRITE(uLocal_851, 495);
		UI::SET_BLIP_FLASHES(uLocal_851, 1);
		UI::SET_BLIP_FLASH_TIMER(uLocal_851, 7000);
		UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_851, "CELL_JOUST");
		UI::SET_BLIP_PRIORITY(uLocal_851, 9);
	...
	if (!UI::DOES_BLIP_EXIST(uLocal_850))
	{
		uLocal_850 = UI::ADD_BLIP_FOR_RADIUS(func_552(func_34(PLAYER::PLAYER_ID())), (func_574(func_34(PLAYER::PLAYER_ID())) / 2f));
		func_613(&uLocal_850, iLocal_862);
		UI::SET_BLIP_ALPHA(uLocal_850, 100);
		UI::SET_BLIP_SCALE(uLocal_850, 1.4f);
		UI::_0x75A16C3DA34F1245(uLocal_850, 0);
	}
}
...
bool func_637(int iParam0, bool bParam1)
{
	if (Global_1590373 != func_29())
	{
		...
		if (bParam1)
		{
			...
			{
				if (GAMEPLAY::IS_BIT_SET(Global_2425662[Global_1590373].f_195, 24) || func_638(Global_1590373))
				{
					return 1;
				}
			}
...
{
	GAMEPLAY::SET_BIT(&uLocal_834, iParam0);
}

char* func_706()
{
	iVar0 = func_264(PLAYER::PLAYER_ID());
	if (iVar0 != func_29())
	{
		if (iVar0 != PLAYER::PLAYER_ID())
		{
			if (((func_62(iVar0, 28) || func_62(PLAYER::PLAYER_ID(), 28)) || func_560(iVar0)) && !func_559(iVar0))
			{
		...
		uVar1 = func_563(&(Global_1628237[iVar0].f_11.f_104));
...
void func_710()
{
	...
	while (iVar0 < 32)
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar1))
		{
			if (func_279(iVar1, iVar2, 1) || func_711(iVar1, PLAYER::PLAYER_ID()))
			{
...
{
	return GAMEPLAY::IS_BIT_SET(uLocal_834, iParam0);
}
...
{
	iVar0 = func_67(PLAYER::PLAYER_ID());
	if (((func_635(Global_1590535[PLAYER::PLAYER_ID()].f_274.f_28) || func_754(PLAYER::PLAYER_ID())) || func_753(PLAYER::PLAYER_ID())) || func_752(PLAYER::PLAYER_ID()))
	{
...
void func_786(int iParam0)
{
	if (SCRIPT::GET_EVENT_DATA(1, iParam0, &Var0, 13))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Var0))
		{
			...
			{
				uVar13 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(Var0);
												...
												if (func_519())
												{
													if (!func_357(iVar15, iVar14) && func_789(iVar15))
													{
														if (func_787(Var0))
														{
															if (func_45(iVar14))
															{
																Local_938[NETWORK::PARTICIPANT_ID_TO_INT()].f_3 = (Local_938[NETWORK::PARTICIPANT_ID_TO_INT()].f_3 + (Global_262145.f_18296 * Global_262145.f_18297));
															}
															else
															{
																Local_938[NETWORK::PARTICIPANT_ID_TO_INT()].f_3 = (Local_938[NETWORK::PARTICIPANT_ID_TO_INT()].f_3 + (Global_262145.f_18295 * Global_262145.f_18297));
															}
														}
														else if (func_45(iVar14))
														{
															Local_938[NETWORK::PARTICIPANT_ID_TO_INT()].f_3 = (Local_938[NETWORK::PARTICIPANT_ID_TO_INT()].f_3 + Global_262145.f_18296);
														}
														else
														{
															Local_938[NETWORK::PARTICIPANT_ID_TO_INT()].f_3 = (Local_938[NETWORK::PARTICIPANT_ID_TO_INT()].f_3 + Global_262145.f_18295);
														}
													}
...
int func_788(int iParam0)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(iParam0, 1))
	{
		...
		if ((((ENTITY::GET_ENTITY_MODEL(iVar0) == 6774487 || ENTITY::GET_ENTITY_MODEL(iVar0) == -2128233223) || ENTITY::GET_ENTITY_MODEL(iVar0) == -48031959) || ENTITY::GET_ENTITY_MODEL(iVar0) == -1269889662) || ENTITY::GET_ENTITY_MODEL(iVar0) == -440768424)
		{
			return 1;
		}
	}
...
void func_792()
{
	...
	while (iVar0 < 32)
	{
		...
		if (iVar1 != PLAYER::PLAYER_ID())
		{
			if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar1))
			{
				if (!GAMEPLAY::IS_BIT_SET(uLocal_842, iVar0))
				{
					unk_0xA7C511FA1C5BDA38(iVar1, 0);
					GAMEPLAY::SET_BIT(&iLocal_842, iVar0);
				}
				else if (!NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iVar1))
				{
					if (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)))
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (!GAMEPLAY::IS_BIT_SET(uLocal_841, iVar0))
							{
								if (((!func_794(PLAYER::PLAYER_PED_ID(), PLAYER::GET_PLAYER_PED(iVar1)) && !func_793(PLAYER::GET_PLAYER_PED(iVar1))) && !func_357(PLAYER::PLAYER_ID(), iVar1)) && (func_576() || func_573()))
								{
									unk_0xA7C511FA1C5BDA38(iVar1, 1);
									GAMEPLAY::SET_BIT(&iLocal_841, iVar0);
								}
							}
							else if (func_794(PLAYER::PLAYER_PED_ID(), PLAYER::GET_PLAYER_PED(iVar1)))
							{
								unk_0xA7C511FA1C5BDA38(iVar1, 0);
								GAMEPLAY::CLEAR_BIT(&iLocal_841, iVar0);
							}
							else if (func_793(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								unk_0xA7C511FA1C5BDA38(iVar1, 0);
								GAMEPLAY::CLEAR_BIT(&iLocal_841, iVar0);
							}
							else if (func_357(PLAYER::PLAYER_ID(), iVar1))
							{
								unk_0xA7C511FA1C5BDA38(iVar1, 0);
								GAMEPLAY::CLEAR_BIT(&iLocal_841, iVar0);
							}
				...
				else if (func_44(NETWORK::PARTICIPANT_ID(), 1))
				{
					if (Local_938[iLocal_843].f_5 >= 2)
					{
						...
						{
							if (!GAMEPLAY::IS_BIT_SET(iLocal_841, iVar0))
							{
								if (!(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1))))
								{
									if (!func_794(PLAYER::PLAYER_PED_ID(), PLAYER::GET_PLAYER_PED(iVar1)) && !func_793(PLAYER::GET_PLAYER_PED(iVar1)))
									{
										unk_0xA7C511FA1C5BDA38(iVar1, 1);
										GAMEPLAY::SET_BIT(&iLocal_841, iVar0);
									}
						...
						else if (GAMEPLAY::IS_BIT_SET(iLocal_841, iVar0))
						{
							if (func_44(NETWORK::NETWORK_GET_PARTICIPANT_INDEX(iVar1), 1))
							{
								unk_0xA7C511FA1C5BDA38(iVar1, 0);
...
void func_795()
{
	iVar1 = PLAYER::INT_TO_PLAYERINDEX(iLocal_845);
	iVar2 = func_34(PLAYER::PLAYER_ID());
	if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar1))
	{
		if (NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iVar1))
						...
						if (iVar0 != NETWORK::PARTICIPANT_ID())
						{
							...
							if (iVar3 != iVar2)
							{
								if (func_17(11))
								{
									if (func_44(iVar0, 1))
									{
										if (!GAMEPLAY::IS_BIT_SET(iLocal_844, iLocal_845))
										{
											func_82(iVar1, 432, 1, 0);
											func_75(iVar1, func_81(iLocal_863), 1, 0);
											GAMEPLAY::SET_BIT(&iLocal_844, iLocal_845);
										}
									}
								}
							}
		...
		else if (GAMEPLAY::IS_BIT_SET(iLocal_844, iLocal_845))
		{
			func_82(iVar1, 432, 0, 0);
			func_75(iVar1, func_81(iLocal_863), 0, 0);
			GAMEPLAY::CLEAR_BIT(&iLocal_844, iLocal_845);
		}
	}
	iLocal_845++;
	if (iLocal_845 >= 32)
...
void func_796()
{
	...
	while (iVar1 < 32)
	{
		Local_730[iVar1] = func_29();
		Local_730[iVar1].f_1 = -1;
		Local_730[iVar1].f_2 = uVar3;
		GAMEPLAY::CLEAR_BIT(&uLocal_837, iVar1);
		GAMEPLAY::CLEAR_BIT(&uLocal_839, iVar1);
		iVar1++;
	}
	iVar0 = 0;
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		...
		GAMEPLAY::CLEAR_BIT(&uLocal_838, iVar0);
	...
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar0))
		{
			...
			GAMEPLAY::SET_BIT(&uLocal_838, iVar0);
			iVar2 = NETWORK::NETWORK_GET_PLAYER_INDEX(Local_89[iVar0]);
			iVar1 = iVar2;
			if (func_993(iVar2, 0, 1))
			{
				iVar20++;
				Local_730[iVar1] = iVar2;
				Local_89[iVar0].f_1 = iVar1;
				Local_730[iVar1].f_1 = iVar0;
				Local_730[iVar1].f_2 = PLAYER::GET_PLAYER_PED(iVar2);
				StringCopy(&(Local_89[iVar0].f_2), PLAYER::GET_PLAYER_NAME(iVar2), 64);
				GAMEPLAY::SET_BIT(&uLocal_837, iVar1);
				if (ENTITY::IS_ENTITY_DEAD(Local_730[iVar1].f_2, 0))
				{
					GAMEPLAY::SET_BIT(&uLocal_839, iVar1);
				}
				if (func_45(Local_730[iVar1]))
				{
					Local_89[iVar0].f_18 = 1;
				}
				else if (func_104(Local_730[iVar1], 0))
				{
					Local_89[iVar0].f_19 = 1;
				}
				if (iLocal_843 == iVar0)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(Local_730[iVar1].f_2, 0))
					{
					}
				}
				if (Local_89[iVar0].f_18)
				{
					if (!GAMEPLAY::IS_BIT_SET(uLocal_839, iVar1) && !GAMEPLAY::IS_BIT_SET(iLocal_839, PLAYER::PLAYER_ID()))
					{
					}
				}
...
{
	iLocal_843 = -1;
	if (GAMEPLAY::IS_BIT_SET(uLocal_837, PLAYER::PLAYER_ID()))
	{
		if (GAMEPLAY::IS_BIT_SET(uLocal_838, NETWORK::PARTICIPANT_ID_TO_INT()))
		{
...
int func_813(bool bParam0)
{
	...
	{
		bVar0 = false;
		if (Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57 != func_29())
		{
			if (func_993(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57, 0, 1))
			{
		...
		if (bVar0)
		{
			if (bParam0)
			{
				...
				if (Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57 != func_29() && NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57))
				{
					Global_1626725 = func_246(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57, -2, 0, 0, 0);
					if (!func_45(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57))
					{
						func_238(88);
					}
				}
...
void func_820(bool bParam0, int iParam1)
{
	...
	if (Global_1628237[PLAYER::PLAYER_ID()].f_11.f_33 != -1)
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Global_1574650.f_1, 14) && !func_121(PLAYER::PLAYER_ID()))
		{
			func_715(0);
		}
	}
	...
	func_771(29);
	Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57 = func_29();
...
{
	if (!func_11(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_337[iParam0], func_851(), 0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_337[iParam0] = { func_851() };
	}
	if (!func_11(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_324[iParam0], func_851(), 0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_324[iParam0] = { func_851() };
	}
}
...
{
	if (!func_11(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_150[iParam0], func_851(), 0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_150[iParam0] = { func_851() };
	}
	if (!func_11(Global_1628237[PLAYER::PLAYER_ID()].f_11.f_125[iParam0], func_851(), 0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_125[iParam0] = { func_851() };
	}
}
...
void func_864(int iParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		{
			func_866(iParam0, (Global_1590535[PLAYER::PLAYER_ID()].f_274.f_183[iParam0].f_2 - (func_870(iVar2, bParam2) / 2)));
		}
...
int func_928(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iVar0 != 0)
	{
		unk_0x501478855A6074CE(func_704(func_177()), func_703(func_177()), func_660(), func_659(), iVar1, iVar0);
	}
	func_930(iVar0);
	func_929(iVar0);
	return iVar0;
...
void func_943()
{
	...
	while (iVar1 < 32)
	{
		...
		while (iVar2 < 2)
		{
			...
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(iVar0, uLocal_858[iVar2], -1533126372);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(iVar0, -1533126372, uLocal_858[iVar2]);
	...
	while (iVar2 < 2)
	{
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 2017343592, uLocal_858[iVar2]);
...
void func_945(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_175(0))
	{
		Global_1628237[PLAYER::PLAYER_ID()].f_11.f_57 = func_177();
	}
	if (func_100(iParam0))
	{
		func_926();
