...
void func_1(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4)
{
	...
	while (iVar0 < func_320(uParam2))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_299(&(uParam2->f_15[iVar0]))))
		{
			if (ENTITY::IS_ENTITY_DEAD(func_299(&(uParam2->f_15[iVar0])), 0) && !func_298(uParam2, iVar0, 16777216))
			{
				func_296(uParam2);
				return;
			}
	...
	if (func_279(uParam0, 1) || func_325(1))
	{
		...
		while (iVar0 < func_320(uParam2))
		{
			if (ENTITY::DOES_ENTITY_EXIST(func_299(&(uParam2->f_15[iVar0]))))
			{
				if (!ENTITY::IS_ENTITY_DEAD(func_299(&(uParam2->f_15[iVar0])), 0))
				{
					ENTITY::SET_ENTITY_COORDS(func_299(&(uParam2->f_15[iVar0])), func_278(&(uParam2->f_15[iVar0])), 1, 0, 0, 1);
				}
			}
			iVar0++;
		}
...
void func_2(var uParam0, var uParam1, bool bParam2)
{
	...
	while (iVar0 < func_320(uParam0))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(func_299(&(uParam0->f_15[iVar0]))))
		{
			if (!ENTITY::IS_ENTITY_DEAD(func_299(&(uParam0->f_15[iVar0])), 0))
			{
				ENTITY::SET_ENTITY_COORDS(func_299(&(uParam0->f_15[iVar0])), func_266(uParam1, iVar1, iVar0), 1, 0, 0, 1);
			}
		}
		iVar0++;
	}
...
void func_9(var uParam0, int iParam1, struct<3> Param2, int iParam5, bool bParam6)
{
	...
	func_10(&(uParam0->f_15[iParam1]), Param2, iParam5, bParam6);
}
...
{
	func_50(&(uParam0->f_15[uParam0->f_157]), Param1);
}

void func_59(var uParam0, struct<3> Param1, int iParam4)
{
	func_10(&(uParam0->f_15[uParam0->f_157]), Param1, iParam4, 1);
}
...
void func_67(var uParam0, var uParam1, var uParam2)
{
	...
	switch (func_34(uParam2))
	{
		...
		case 4:
			if (func_170(PLAYER::PLAYER_PED_ID(), uParam2->f_15[func_270(uParam2)].f_2, 0) < 1f)
			{
...
int func_98(var uParam0, var uParam1)
{
	...
	Var0 = { ENTITY::GET_ENTITY_COORDS(func_250(uParam1), 0) };
...
int func_172(var uParam0, var uParam1)
{
	...
	Var1 = { ENTITY::GET_ENTITY_COORDS(func_250(uParam1), 0) };
...
char* func_178(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	...
	Var2 = { ENTITY::GET_ENTITY_COORDS(func_299(uParam0), 1) };
	if (bParam3)
	{
...
{
	func_49(&(uParam0->f_15[uParam0->f_157]), Param1);
}
...
Vector3 func_196(var uParam0, var uParam1)
{
	...
	{
		Var0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_19(uParam0), (func_116(uParam0) + fVar3), (((-func_144(uParam1, func_140(uParam0)) * func_197(func_136(uParam0))) * func_143(func_28(&(uParam0->f_15[func_270(uParam0)])))) * ((func_165(uParam0, 1) * fVar4) / 100f)), 0f, 0f) };
	}
	else if (func_35(uParam0) != 3)
	{
		Var0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_19(uParam0), func_116(uParam0), (((-func_144(uParam1, func_140(uParam0)) * func_197(func_136(uParam0))) * func_143(func_28(&(uParam0->f_15[func_270(uParam0)])))) * (func_165(uParam0, 1) / 100f)), 0f, 0f) };
	}
	else
	{
...
void func_212(var uParam0, var uParam1)
{
	...
	{
		PED::_0x2208438012482A1A(func_299(uParam0), 1, 0);
...
int func_215(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, float fParam12)
{
	...
	if (!func_224())
	{
		...
		{
			if (((bParam9 && func_220(PLAYER::PLAYER_ID(), 1, 0)) && STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && Global_2425662[PLAYER::PLAYER_ID()].f_222 == 1)
			{
			}
			else if (func_219() == 28)
			{
...
int func_242(var uParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_250(uParam1)))
		{
			Var0 = { ENTITY::GET_ENTITY_COORDS(func_250(uParam1), 1) };
		}
	}
...
{
	func_48(&(uParam0->f_15[uParam0->f_157]), Param1);
}
...
void func_254(var uParam0, int iParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	if (bVar10)
	{
		...
		else if ((SYSTEM::VDIST2(func_265(uParam0, iParam1), func_41(uParam2, func_313(uParam0))) < 1600f && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(func_274(uParam0, iParam1), 1), func_41(uParam2, func_313(uParam0))) < 1600f) && !func_298(uParam0, iParam1, 67108864))
		{
...
int func_269(var uParam0, var uParam1, int iParam2)
{
	...
	Var1 = { ENTITY::GET_ENTITY_COORDS(func_251(&(uParam1->f_15[iParam2])), 0) };
	if (SYSTEM::VDIST2(Var1, func_41(uParam0, func_313(uParam1))) > (55f * 55f))
	{
		return 0;
	}
...
void func_300(var uParam0, int iParam1, var uParam2, int iParam3, var uParam4)
{
	...
	Var3 = { ENTITY::GET_ENTITY_COORDS(iParam1, 1) };
	Var6 = { ENTITY::GET_ENTITY_COORDS(func_299(uParam0), 1) };
...
void func_308(var uParam0, int iParam1, struct<3> Param2)
{
	...
	func_48(&(uParam0->f_15[iParam1]), Param2);
}
...
void func_314(var uParam0, var uParam1, int iParam2)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(func_284(uParam1, iParam2)))
	{
		...
		PED::_0x2F3C3D9F50681DE4(func_284(uParam1, iParam2), 1);
	}
}
...
void func_315(var uParam0, int iParam1, var uParam2)
{
	...
	func_316(&(uParam0->f_15[iParam1]), uParam2);
}
...
void func_339(var uParam0)
{
	...
	{
		(*uParam0)[iVar0] = (SYSTEM::VDIST(func_327(uParam0, iVar0), func_249(uParam0, iVar0)) + SYSTEM::VDIST(func_249(uParam0, iVar0), func_41(uParam0, iVar0)));
...
void func_344(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		while (iVar1 < func_320(uParam0[iVar0]))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0[iVar0]->f_15[iVar1].f_2))
			{
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uParam0[iVar0]->f_15[iVar1].f_2));
			}
			iVar1++;
		}
		if (ENTITY::DOES_ENTITY_EXIST(uParam0[iVar0]->f_152[0]))
		{
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uParam0[iVar0]->f_152[0]));
		}
		if (ENTITY::DOES_ENTITY_EXIST(uParam0[iVar0]->f_152[1]))
		{
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uParam0[iVar0]->f_152[1]));
		}
		iVar0++;
	}
}
