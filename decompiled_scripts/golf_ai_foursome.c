...
int func_215(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, float fParam12)
{
	...
	if (!func_224())
	{
		...
		{
			if (((bParam9 && func_220(PLAYER::PLAYER_ID(), 1, 0)) && STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && Global_2426865[PLAYER::PLAYER_ID() /*449*/].f_231 == 1)
			{
			}
			else if (func_219() == 28)
			{
	...
	if (((!Param0.x == Global_2441237.f_1353 || !Param0.f_1 == Global_2441237.f_1353.f_1) || !Param0.f_2 == Global_2441237.f_1353.f_2) || !fParam3 == Global_2441237.f_1356)
	{
		...
		{
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2441237.f_1357) < func_218(0))
			{
				return 0;
			}
			PLAYER::STOP_PLAYER_TELEPORT();
...
void func_225(bool bParam0, bool bParam1)
{
	...
	func_228();
	if (!MISC::IS_BIT_SET(Global_1590908[PLAYER::PLAYER_ID() /*874*/].f_267.f_27, 14) && !func_227())
	{
		func_226();
	}
}
