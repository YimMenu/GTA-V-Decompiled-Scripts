	...
	if (bParam2)
	{
		...
		if (func_3(func_327(uParam1, iVar1), func_41(uParam1, iVar1), &Var2, &fVar4, 0f, 0f, 0f, 0f, 0f, 0f, 0))
		{
			...
			while (iVar5 < 2)
			{
				...
				{
					if (!ENTITY::IS_ENTITY_DEAD(func_294(uParam0, iVar5), 0) && !CAM::IS_SPHERE_VISIBLE(Var2 + FtoV(SYSTEM::TO_FLOAT(iVar5)) * Var3, 5f))
					{
						ENTITY::SET_ENTITY_COORDS(func_294(uParam0, iVar5), Var2 + FtoV(SYSTEM::TO_FLOAT(iVar5)) * Var3, 1, 0, 0, 1);
...
int func_3(struct<3> Param0, struct<2> Param1, var uParam2, var uParam3, float fParam4, struct<3> Param5, struct<2> Param6, float fParam7, bool bParam8)
{
	...
	if (MISC::ABSF((MISC::GET_HEADING_FROM_VECTOR_2D((Param1 - Param0.x), (Param1.f_1 - Param0.y)) - *fParam4)) > 90f)
	{
...
void func_105(var uParam0, var uParam1, var uParam2)
{
	...
	Var9 = { Var7 * Vector(-Var5.x, -Var5.x, -Var5.x) * Vector(0.05f, 0.05f, 0.05f) + Var8 * Vector(Var5.y, Var5.y, Var5.y) * Vector(0.2f, 0.2f, 0.2f) };
	...
	if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0))
	{
		...
		if (!bLocal_299)
		{
			Var9 = { Var7 * Vector(-Var5.x, -Var5.x, -Var5.x) * Vector(0.2f, 0.2f, 0.2f) + Var8 * Vector(Var5.y, Var5.y, Var5.y) * Vector(0.2f, 0.2f, 0.2f) };
		...
		if (!func_279(uParam0, 64))
		{
			if (fVar11 != 0f && SYSTEM::VMAG2(Var2) > 9.5f)
			{
				...
				Var16 = { FtoV(func_8(Local_306, Var15)) * Var15 };
				Var14 = { FtoV(-(1f + fVar11)) * Var16 + Local_306 };
				Var17 = { Local_306 - Var16 };
	...
	{
		Local_306 = { ENTITY::GET_ENTITY_VELOCITY(iVar0) };
	}
	func_311(uParam0, 32);
}
...
void func_114(var uParam0)
{
	...
	{
		uParam0->f_6 = (uParam0->f_6 + Var1.y);
	}
}
...
int func_126(var uParam0, var uParam1, var uParam2)
{
	...
	else
	{
		...
		fVar15 = func_8(Var8, func_6(Var14.x, Var14.y, 0f));
		fVar16 = func_27(((Var8.x * Var14.y) - (Var8.y * Var14.x)) < 0f, -1f, 1f);
		if (MISC::ABSF(fVar15) < SYSTEM::COS(15f))
		{
			Var14 = { func_131(Var14, (fVar16 * (MISC::ACOS(MISC::ABSF(fVar15)) - 15f))) };
		}
		Var10.y = ((Var14.y / MISC::ABSF(Var14.y)) * SYSTEM::SQRT(MISC::ABSF((((Var10.z * Var10.z) - 1f) / (((Var14.x * Var14.x) / (Var14.y * Var14.y)) + 1f)))));
		Var10.x = ((Var14.x * Var10.y) / Var14.y);
...
float func_170(int iParam0, int iParam1, bool bParam2)
{
	...
	return (SYSTEM::POW((Var0.x - Var1.x), 2f) + SYSTEM::POW((Var0.y - Var1.y), 2f));
}
...
void func_204(var uParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, var uParam6, bool bParam7)
{
	...
	if (iParam5 || func_40(uParam0, 1048576))
	{
		...
		{
			if ((MISC::ABSF((fVar3 - Var2.z)) < 0.35f || fVar3 < Var1.z) || bParam7)
			{
				Var1.z = fVar3;
			}
		}
...
int func_215(struct<3> Param0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, float fParam10)
{
	...
	if (!func_224())
	{
		...
		{
			if (((bParam7 && func_220(PLAYER::PLAYER_ID(), 1, 0)) && STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && Global_2425662[PLAYER::PLAYER_ID() /*421*/].f_222 == 1)
			{
			}
			else if (func_219() == 28)
			{
	...
	if (Global_2439138.f_1233)
	{
		...
		if (Global_2439138.f_1240 > -1)
		{
			...
			if (func_216(&(Global_2439138.f_1240), Param0, fParam1, iVar0))
			{
				func_225(bParam4, bParam7);
				return 1;
			}
...
void func_254(var uParam0, int iParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	fVar1 = 144f;
	bVar6 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(func_294(uParam0, func_272(uParam0, iParam1)), 1), uParam0->f_15[iParam1 /*34*/].f_10) < fVar1;
...
int func_269(var uParam0, var uParam1, int iParam2)
{
	...
	Var1 = { ENTITY::GET_ENTITY_COORDS(func_251(&(uParam1->f_15[iParam2 /*34*/])), 0) };
	if (SYSTEM::VDIST2(Var1, func_41(uParam0, func_313(uParam1))) > (55f * 55f))
	{
		return 0;
	}
...
int func_287(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (!bLocal_310)
		{
			iLocal_311 = ENTITY::GET_ENTITY_HEALTH(iParam0);
			bLocal_310 = true;
		}
		iLocal_312 = ENTITY::GET_ENTITY_HEALTH(iParam0);
	...
	while (iVar2 < (iParam3 + 1 / 2))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(func_294(uParam1, iVar2)))
		{
			...
			if (func_43(func_327(uParam0, iParam2) + Var3, func_41(uParam0, func_313(uParam1)), &Var0, &uVar1))
			{
				...
				ENTITY::_SET_ENTITY_SOMETHING(func_294(uParam1, iVar2), 1);
			}
		}
		iVar2++;
	}
