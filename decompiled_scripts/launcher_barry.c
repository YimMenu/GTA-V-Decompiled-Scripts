void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_205(Var0.f_28[0]))
		{
			if (Var0 == 2)
			{
				if (func_203(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], 1), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
			...
			{
				if (func_203(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], 1), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0 == 4)
			{
				func_188(&uLocal_105, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], 1), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar64 = 0;
		if (func_187(Var0))
...
{
	if ((((func_205(PLAYER::PLAYER_PED_ID()) && func_205(iParam0->f_28[0])) && !func_145()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_201(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_217(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_217(uParam1) && uParam1->f_4 == 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
bool func_228(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_229(&(Local_37[iVar4]), Var1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
{
	Var0 = { func_234(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
{
	Var0 = { func_234(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
		...
		case 3:
			if (func_205(uParam0->f_35[1]))
			{
				if (func_205(uParam0->f_28[0]))
				{
					...
					WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uParam0->f_28[0], 453432689, 100, 1);
				}
				if (func_205(uParam0->f_28[1]))
				{
					PED::SET_PED_AS_COP(uParam0->f_28[1], 1);
					PED::SET_PED_INTO_VEHICLE(uParam0->f_28[1], uParam0->f_35[1], 0);
					WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uParam0->f_28[1], 453432689, 100, 1);
				}
			}
			iVar16 = 0;
			while (iVar16 <= (iVar0 - 1))
