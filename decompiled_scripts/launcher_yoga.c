...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_61) && !ENTITY::IS_ENTITY_DEAD(iLocal_61, 0))
		{
			...
			uLocal_65 = SYSTEM::VDIST2(Local_63, ScriptParam_95.f_1[0 /*3*/]);
			uLocal_65 = uLocal_65;
			Local_83 = { Local_63 };
			...
			switch (iLocal_67)
			{
				case 0:
					...
					else
					{
						...
						if ((Local_63.z - ScriptParam_95.f_1[0 /*3*/].f_2) > 500f)
						{
						}
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						if (!func_70(3) && !Global_98778)
						{
							...
							{
								if ((!func_84(uLocal_66, 1) || !ENTITY::DOES_ENTITY_EXIST(func_69())) && !Global_98778)
								{
									func_77(10);
									break;
								}
				...
				case 6:
					...
					if (func_84(uLocal_66, 2097152))
					{
						if (!func_70(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_50))
						{
							func_77(10);
						}
					}
...
int func_86()
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		uVar2[0] = SYSTEM::VDIST2(Var0, Var1[0 /*3*/]);
		uVar2[1] = SYSTEM::VDIST2(Var0, Var1[1 /*3*/]);
		if (uVar2[0] < uVar2[1])
		{
			return 0;
		}
