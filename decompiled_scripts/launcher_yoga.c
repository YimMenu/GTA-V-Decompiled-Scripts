void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_84(uLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_42(uLocal_86))
								{
									...
									else if (!func_84(uLocal_94, 2048) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_40(&iLocal_96);
