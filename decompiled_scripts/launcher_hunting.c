void __EntryFunction__()
{
	...
	iLocal_94 = WEAPON::GET_WEAPONTYPE_MODEL(100416529);
	iLocal_95 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(-767279652);
	iLocal_96 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(-1489156508);
	...
	while (true)
	{
		...
		if (func_169(&Var0, 0) && MISC::ABSF((Var61.z - Var67.z)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_260(&Var0, 1);
...
int func_113(int iParam0)
{
	if (func_143(&(iParam0->f_1)))
	{
		...
		func_114(*iParam0);
		uVar0 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&(iParam0->f_1), iParam0, 61, 35000);
...
int func_197(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 10)
	{
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, iParam0->f_17[0], 8f))
		{
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_200(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_200(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
bool func_211(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_212(&(Local_37[iVar4]), Var1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
{
	Var0 = { func_217(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
{
	Var0 = { func_217(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
...
int func_236(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				iLocal_100 = WEAPON::CREATE_WEAPON_OBJECT(100416529, 0, Local_97, 0, 1065353216, 0, 0, 1);
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iLocal_100, -767279652);
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iLocal_100, -1489156508);
			}
			if (bVar7)
			{
				iLocal_91 = 3;
