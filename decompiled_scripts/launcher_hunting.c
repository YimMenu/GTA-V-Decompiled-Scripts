void __EntryFunction__()
{
	...
	GAMEPLAY::CLEAR_AREA(Var61, 3f, 1, 0, 0, 0);
	while (true)
	{
		SYSTEM::WAIT(0);
		if (!func_197(&Var0, 1))
		...
		if (func_169(&Var0, 0) && GAMEPLAY::ABSF((Var61.z - Var67.z)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_260(&Var0, 1);
...
{
	if ((((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && !func_146()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_188(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
