void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_142(uLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_92(iLocal_86))
								{
									...
									else if (!func_142(uLocal_94, 2048) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_90(&iLocal_96);
...
int func_52()
{
	...
	while (iVar0 < func_53())
	{
		if (!ENTITY::DOES_ENTITY_EXIST(Local_329[iVar0]) || !ENTITY::DOES_ENTITY_EXIST(Local_329[iVar0].f_1))
		{
			return 0;
		}
		iVar0++;
...
void func_54()
{
	...
	if (func_23(&uLocal_147) >= 8f)
	{
		...
		if (iVar0 > 0 && iVar0 <= 3)
		{
			if (ENTITY::IS_ENTITY_DEAD(Local_329[(iVar0 - 1)], 0))
			{
				return;
			}
			switch (iVar0)
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_157, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		switch (iLocal_328)
		{
			...
			case 1:
				...
				AI::TASK_PERFORM_SEQUENCE(iLocal_157, uVar1);
				AI::CLEAR_SEQUENCE_TASK(&uVar1);
				iLocal_328 = 2;
				break;
			
			case 2:
				if ((AI::GET_SCRIPT_TASK_STATUS(iLocal_157, 242628503) != 1 || PED::IS_PED_FACING_PED(iLocal_157, PLAYER::PLAYER_PED_ID(), 20f)) && !AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
				{
			...
			case 4:
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_157, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 225f)
				{
					...
					AI::TASK_PERFORM_SEQUENCE(iLocal_157, uVar2);
...
void func_80()
{
	...
	while (iVar2 < 5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_329[iVar2].f_1) && ENTITY::DOES_ENTITY_EXIST(Local_329[iVar2]))
		{
			if (func_85(Local_329[iVar2], 1, 0, 0, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_329[iVar2].f_1, 1))
			{
				func_83();
				func_82(iLocal_105);
				PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
			}
			if (!PED::IS_PED_INJURED(Local_329[iVar2]))
			{
				if (func_26(&(Local_125[iVar2])))
				{
					if (func_23(&(Local_125[iVar2])) > uLocal_150[iVar2])
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_329[iVar2].f_1, 0) && PED::IS_PED_IN_VEHICLE(Local_329[iVar2], Local_329[iVar2].f_1, 0))
						{
							iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500);
							iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500);
							AI::OPEN_SEQUENCE_TASK(&uVar3);
							AI::TASK_VEHICLE_TEMP_ACTION(0, Local_329[iVar2].f_1, 1, iVar0);
							AI::TASK_VEHICLE_TEMP_ACTION(0, Local_329[iVar2].f_1, 31, iVar1);
							AI::CLOSE_SEQUENCE_TASK(uVar3);
							if (!PED::IS_PED_INJURED(Local_329[iVar2]))
							{
								AI::TASK_PERFORM_SEQUENCE(Local_329[iVar2], uVar3);
							}
							AI::CLEAR_SEQUENCE_TASK(&uVar3);
						}
						func_33(&(Local_125[iVar2]));
						uLocal_150[iVar2] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 3f);
					}
				}
				else
				{
					func_35(&(Local_125[iVar2]));
				}
			}
			if (!ENTITY::IS_ENTITY_DEAD(Local_329[iVar2], 0))
			{
				if ((ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_329[iVar2]) && !PED::IS_PED_RAGDOLL(Local_329[iVar2])) && !AI::IS_PED_GETTING_UP(Local_329[iVar2]))
				{
				...
				{
					AI::OPEN_SEQUENCE_TASK(&uVar3);
					AI::TASK_ACHIEVE_HEADING(0, Local_329[iVar2].f_9, 1000);
					AI::TASK_PLAY_ANIM(0, Local_329[iVar2].f_12, Local_329[iVar2].f_13, 4f, -8f, -1, 1, 0, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uVar3);
					AI::TASK_PERFORM_SEQUENCE(Local_329[iVar2], uVar3);
					AI::CLEAR_SEQUENCE_TASK(&uVar3);
					Local_329[iVar2].f_11 = 0;
				}
				if (PED::IS_PED_RAGDOLL(Local_329[iVar2]) || AI::IS_PED_GETTING_UP(Local_329[iVar2]))
				{
					if (!Local_329[iVar2].f_10 && (PED::IS_PED_RAGDOLL(Local_329[iVar2]) || AI::IS_PED_GETTING_UP(Local_329[iVar2])))
					{
						Local_329.f_101++;
					}
				...
				else if (Local_329[iVar2].f_10)
				{
					...
					AI::TASK_PLAY_ANIM(0, "gestures@m@standing@casual", func_81(), 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_ACHIEVE_HEADING(0, Local_329[iVar2].f_9, 1000);
					AI::TASK_PLAY_ANIM(0, Local_329[iVar2].f_12, Local_329[iVar2].f_13, 4f, -8f, -1, 1, 0, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uVar3);
					AI::TASK_PERFORM_SEQUENCE(Local_329[iVar2], uVar3);
...
{
	return func_87(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), uParam0, iParam1);
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_111()) || Global_110685) || Global_30770) || func_110()) || func_96(8, -1)) || func_109()) || func_108()) || func_107()) || func_98()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_111()) || Global_30770) || func_110()) || func_96(8, -1)) || func_107()) || func_109()) || func_108()) || func_98()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_111()) || Global_110685) || Global_30770) || func_110()) || func_96(8, -1)) || func_107()) || func_109()) || func_108()) || func_98()) || Global_111638.f_7683.f_919[iVar0] == 5) || Global_41978 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_111()) || Global_110685) || Global_30770) || func_110()) || func_96(8, -1)) || func_109()) || func_108()) || func_98()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_111()) || Global_30770) || func_110()) || func_96(8, -1)) || func_108()) || func_107()) || func_98()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_111()) || func_108()) || Global_110685) || Global_30770) || func_110()) || Global_42596) || func_96(8, -1)) || func_107()) || func_106()) || func_98()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_111()) || Global_110685) || Global_30770) || func_110()) || func_96(8, -1)) || func_107()) || func_106()) || func_109()) || func_108()) || func_98())
						{
							return 0;
						}
						break;
...
void func_118()
{
	if (fLocal_110 > 9f)
	{
		...
		while (iVar5 < Local_329)
		{
			...
			{
				Local_329[iVar5].f_1 = VEHICLE::CREATE_VEHICLE(func_122(0), Local_329[iVar5].f_2, Local_329[iVar5].f_5, 1, 1, 0);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_329[iVar5].f_1, 1084227584);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_329[iVar5].f_1, 1);
				if (func_123(Local_329[iVar5].f_6))
				{
					Local_329[iVar5] = PED::CREATE_PED_INSIDE_VEHICLE(Local_329[iVar5].f_1, 4, func_121(), -1, 1, 1);
					VEHICLE::SET_VEHICLE_ENGINE_ON(Local_329[iVar5].f_1, 1, 0, 0);
				}
				else
				{
					Local_329[iVar5] = PED::CREATE_PED(4, func_121(), Local_329[iVar5].f_6, Local_329[iVar5].f_9, 1, 1);
					iVar1 = iVar5;
					switch (iVar1)
					{
						case 0:
					...
					AI::TASK_PERFORM_SEQUENCE(Local_329[iVar5], uVar0);
					AI::CLEAR_SEQUENCE_TASK(&uVar0);
				}
				PED::SET_PED_HELMET(Local_329[iVar5], 1);
				PED::GIVE_PED_HELMET(Local_329[iVar5], 1, 4096, -1);
			}
			iVar5++;
		}
		Local_329.f_83.f_1 = VEHICLE::CREATE_VEHICLE(func_122(1), Local_329.f_83.f_2, Local_329.f_83.f_5, 1, 1, 0);
		...
		{
			Local_329.f_83 = PED::CREATE_PED_INSIDE_VEHICLE(Local_329.f_83.f_1, 4, func_121(), -1, 1, 1);
			VEHICLE::SET_VEHICLE_ENGINE_ON(Local_329.f_83.f_1, 1, 0, 0);
		}
		else
		{
			Local_329.f_83 = PED::CREATE_PED(4, func_121(), Local_329.f_83.f_6, Local_329.f_83.f_9, 1, 1);
			...
			AI::OPEN_SEQUENCE_TASK(&uVar0);
			AI::TASK_STAND_STILL(0, func_120((GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 65535) % 1000), 1, 1000));
	...
	if (!ENTITY::IS_ENTITY_DEAD(Local_329[0], 0))
	{
		func_119(&uLocal_163, 1, Local_329[0], "MALE1", 0, 1);
	}
	if (!ENTITY::IS_ENTITY_DEAD(Local_329[1], 0))
	{
		func_119(&uLocal_163, 2, Local_329[1], "MALE2", 0, 1);
	}
	if (!ENTITY::IS_ENTITY_DEAD(Local_329[2], 0))
	{
...
void func_125(struct<3> Param0, float fParam3, struct<3> Param4, float fParam7)
{
	...
	while (iVar0 < Local_329)
	{
		...
		{
			Local_329[iVar0].f_2 = { Param0 };
			Local_329[iVar0].f_5 = fParam3;
			Local_329[iVar0].f_6 = { Param4 };
...
bool func_144(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		return GAMEPLAY::IS_BIT_SET(Global_31146[iVar0].f_11, 15);
	}
	return GAMEPLAY::IS_BIT_SET(Global_31146[iVar0].f_11, 0);
}
...
int func_147(struct<3> Param0, var uParam3)
{
	...
	Var1[2] = { func_148(2) };
	Var1[6] = { func_148(6) };
	fVar23 = SYSTEM::VDIST2(Param0, Var1[0]);
	iVar24 = 0;
	fVar25 = 0f;
	iVar24 = 1;
	while (iVar24 <= (7 - 1))
	{
		fVar25 = SYSTEM::VDIST2(Param0, Var1[iVar24]);
		if (fVar25 < fVar23)
		{
			iVar0 = iVar24;
			fVar23 = fVar25;
