...
void func_322()
{
	...
	else
	{
		...
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_180.f_4[Local_165.f_9], 1) > 130f)
		{
			if (Local_165.f_9 + 1 <= Local_180.f_126)
			{
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_180.f_4[Local_165.f_9 + 1], 1) < 100f)
				{
					func_246(10);
				}
				else
...
bool func_327(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_58[iVar4].f_3) < iParam4);
}
...
void func_351()
{
	...
	else
	{
		...
		else
		{
			if (func_271())
			{
				fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_180.f_4[Local_165.f_9], 1);
			}
			if (func_28(Local_878.f_28[0]))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_878.f_28[0], 1), Local_180.f_4[iLocal_853], 1);
			}
			if (fVar0 > fVar1)
			{
				if (iLocal_850 != 2)
	...
	if (!HUD::DOES_BLIP_EXIST(uParam0->f_2))
	{
		...
		if (uParam0->f_9 == (uParam1->f_126 - 1))
		{
			if (uParam0->f_11 == uParam1->f_127)
			{
				...
				fVar16 = MISC::GET_DISTANCE_BETWEEN_COORDS(uParam1->f_4[uParam0->f_9], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1);
				if (uParam0->f_4 != 0)
				{
					if (uParam0->f_13 > 100f)
					{
			...
			else
			{
				...
				GRAPHICS::_SET_CHECKPOINT_ICON_RGBA(uParam0->f_4, uVar8, uVar9, uVar10, iVar11);
				GRAPHICS::SET_CHECKPOINT_CYLINDER_HEIGHT(uParam0->f_4, 3f, 3f, 100f);
				fVar17 = MISC::GET_DISTANCE_BETWEEN_COORDS(uParam1->f_4[uParam0->f_9], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1);
				if (uParam0->f_4 != 0)
				{
					if (uParam0->f_13 > 100f)
					{
		...
		else
		{
			...
			GRAPHICS::_SET_CHECKPOINT_ICON_RGBA(uParam0->f_4, uVar8, uVar9, uVar10, iVar11);
			GRAPHICS::SET_CHECKPOINT_CYLINDER_HEIGHT(uParam0->f_4, 3f, 3f, 100f);
			fVar18 = MISC::GET_DISTANCE_BETWEEN_COORDS(uParam1->f_4[uParam0->f_9], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1);
			if (uParam0->f_4 != 0)
			{
				if (uParam0->f_13 > 100f)
				{
		...
		else
		{
			...
			else if (iLocal_842 == 1)
			{
				...
				if (!CUTSCENE::IS_CUTSCENE_PLAYING())
				{
					...
					MISC::CLEAR_AREA_OF_VEHICLES(850.99f, 1284.06f, 358.39f, 14f, 0, 0, 0, 0, 0, 0);
					MISC::CLEAR_AREA_OF_VEHICLES(856.54f, 1270.78f, 358.24f, 14f, 0, 0, 0, 0, 0, 0);
					MISC::CLEAR_AREA_OF_VEHICLES(850.71f, 1256.57f, 356.34f, 14f, 0, 0, 0, 0, 0, 0);
					MISC::CLEAR_AREA_OF_VEHICLES(840.86f, 1245.39f, 352.97f, 14f, 0, 0, 0, 0, 0, 0);
					if (!iLocal_843)
					{
						func_256(1, 1, 1, 1);
					}
