...
int func_79(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_122(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_122(iParam1), Global_76434[1].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_122(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, 0);
		}
	}
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_122(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_122(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_122(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_113(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_122(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_122(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_122(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
void func_98(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_99(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_122(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_122(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_100(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_100(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_100(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_100(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_117(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0][func_116(iParam1)];
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_105(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_128(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_128(Var16.z)] = func_105(iParam1, Var16.x, func_128(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_128(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_117(func_136(iParam1, uParam0->f_2), Global_76431, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_117(func_135(iParam1, uParam0->f_2), Global_76431, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_117(iVar1, Global_76431, 0);
				if (!GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_139(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_122(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_194(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_122(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_122(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_207()
{
	...
	{
		func_16();
		GRAPHICS::_0xBF59707B3E5ED531(func_208(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
...
void func_265()
{
	...
	{
		func_371();
		func_360((GAMEPLAY::GET_GAME_TIMER() - iLocal_163), "", -1, -1, "", iLocal_850, 2, 0, 0, 1, -1, -1, 0, 12, -1, -1, 0, 6, -1, 0, 0, 1, -1, 0, -1082130432, 1, 1);
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_276(iParam3), 0);
}
...
void func_278()
{
	...
	if (func_29(uLocal_136[0]) && func_29(uLocal_136[1]))
	{
		if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(uLocal_136[0], uLocal_136[1]))
		{
			Var0 = { -ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uLocal_136[1], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) };
...
void func_279()
{
	switch (iLocal_117)
	{
		...
		case 1:
			AI::WAYPOINT_RECORDING_GET_COORD("Fan2_BikeRoute", iLocal_134, &Var0);
			if (func_29(uLocal_136[1]))
			{
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_136[1], 1), Var0, 1) < 2f)
				{
					func_267("*** Mary Ann seems to have got herself back on track, carrying on as normal from #", iLocal_134);
					func_282(iLocal_134);
					iLocal_117 = 0;
				}
				if ((!CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(uLocal_136[1], 1), 3f) && !CAM::IS_SPHERE_VISIBLE(Var0, 3f)) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_118) > 2500)
				{
					iLocal_117 = 2;
				}
			}
		...
		case 2:
			AI::WAYPOINT_RECORDING_GET_COORD("Fan2_BikeRoute", iLocal_134, &Var0);
			AI::WAYPOINT_RECORDING_GET_COORD("Fan2_BikeRoute", iLocal_134 + 1, &Var3);
...
{
	fVar0 = func_281(ENTITY::GET_ENTITY_COORDS(iParam0, 1), Param1, 1);
			...
			if (func_271())
			{
				if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 5f)
				{
					...
					if (VEHICLE::IS_ANY_VEHICLE_NEAR_POINT(Var0, 3.5f))
					{
						...
						if (iVar3 != 0)
						{
							if (!VEHICLE::IS_VEHICLE_MODEL(iVar3, -186537451) || !VEHICLE::IS_VEHICLE_MODEL(iVar3, 1127861609))
							{
								iLocal_857 = 1;
...
void func_286(var uParam0, int iParam1, bool bParam2, float fParam3, int iParam4)
{
	...
	{
		*uParam0 = func_287(ENTITY::GET_ENTITY_COORDS(iParam1, 1), 0);
		if (bParam2)
		{
...
int func_287(struct<3> Param0, int iParam3)
{
	...
	UI::SET_BLIP_SCALE(iVar0, func_288(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
void func_322()
{
	...
	else
	{
		...
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_180.f_4[Local_165.f_9], 1) > 130f)
		{
			if (Local_165.f_9 + 1 <= Local_180.f_126)
			{
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_180.f_4[Local_165.f_9 + 1], 1) < 100f)
				{
					func_246(10);
				}
				else
...
void func_323()
{
	if (iLocal_110 == 1 || iLocal_110 == 2)
	{
		...
		{
			STREAMING::REQUEST_MODEL(-37334073);
			if (STREAMING::HAS_MODEL_LOADED(-37334073))
			{
				...
				else
				{
					...
					if (!func_28(iLocal_869) && func_29(iLocal_864))
					{
						...
						{
							iLocal_869 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_864, 26, -37334073, -1, 1, 1);
		...
		if (func_29(iLocal_864) && func_28(iLocal_869))
		{
			if (bLocal_859)
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-37334073);
				if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_864))
				{
...
bool func_327(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_328(&(Local_58[iVar4]), Var1, iParam1, &(Local_58[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (GAMEPLAY::GET_GAME_TIMER() - Local_58[iVar4].f_3) < iParam4);
}
...
{
	Var0 = { func_333(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
{
	Var0 = { func_333(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
...
void func_345()
{
	if (iLocal_110 == 1 || iLocal_110 == 2)
	{
		...
		{
			if (!func_28(iLocal_867) && STREAMING::HAS_MODEL_LOADED(-951490775))
			{
				iLocal_867 = PED::CREATE_PED(26, -951490775, 590.1751f, 1203.141f, 307.694f, 293.4f, 1, 1);
			...
			if (!func_28(iLocal_868) && STREAMING::HAS_MODEL_LOADED(623927022))
			{
				iLocal_868 = PED::CREATE_PED(26, 623927022, 592.1368f, 1200.911f, 307.7926f, 286.58f, 1, 1);
				func_36("Created jogger 2");
				if (func_455())
				{
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(623927022);
				}
			}
...
void func_346()
{
	if (!func_455())
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 435.1628f, 1275.777f, 269.5054f, 455.5966f, 1285.542f, 278.7485f, 8.5f, 0, 1, 0))
		{
			if (iLocal_860 == 0)
			{
				STREAMING::REQUEST_MODEL(-377465520);
				...
				if (((STREAMING::HAS_MODEL_LOADED(-377465520) && STREAMING::HAS_MODEL_LOADED(1912215274)) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(500, "Fan2_Driver")) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(500, "Fan2_DriverCop"))
				{
					...
					if (!func_28(iLocal_865) && func_29(iLocal_862))
					{
						...
						{
							iLocal_865 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_862, 26, 623927022, -1, 1, 1);
							func_36("Created car.");
						}
					}
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-377465520);
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(623927022);
					...
					if (!func_28(iLocal_866) && func_29(iLocal_863))
					{
						...
						{
							iLocal_866 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_863, 6, 1581098148, -1, 1, 1);
			...
			if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 5f)
			{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_131) > 4000)
				{
					...
					if (iVar3 != 0)
					{
						...
						if ((!VEHICLE::IS_VEHICLE_MODEL(iVar3, -186537451) && !VEHICLE::IS_VEHICLE_MODEL(iVar3, 1127861609)) && !VEHICLE::IS_VEHICLE_SEAT_FREE(iVar3, -1, 0))
						{
...
void func_351()
{
	if (ENTITY::IS_ENTITY_AT_COORD(Local_878.f_28[0], Local_180.f_4[iLocal_853], 6f, 6f, 6f, 0, 1, 0))
	{
		iLocal_853++;
	...
	else
	{
		...
		else
		{
			if (func_271())
			{
				fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_180.f_4[Local_165.f_9], 1);
			}
			if (func_28(Local_878.f_28[0]))
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_878.f_28[0], 1), Local_180.f_4[iLocal_853], 1);
			}
			if (fVar0 > fVar1)
			{
				if (iLocal_850 != 2)
...
int func_354(var uParam0, var uParam1, int iParam2)
{
	if (func_359(uParam0, uParam1->f_130) || iParam2 == 0)
	{
		...
		UI::GET_HUD_COLOUR(func_355(uVar4), &uVar5, &uVar6, &uVar7, &iVar8);
		uParam0->f_13 = SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), uParam1->f_4[uParam0->f_9]);
		if (uParam0->f_4 != 0)
		{
...
int func_356(int iParam0, var uParam1)
{
	...
	{
		Var3 = { uParam1->f_4[iParam0 + 1] };
	}
	if ((iParam0 - 1) >= 0)
	{
		Var6 = { uParam1->f_4[(iParam0 - 1)] };
	}
	Var9 = { Var6 - Var0 };
	Var12 = { Var3 - Var0 };
...
void func_357(var uParam0, var uParam1)
{
	...
	iVar7 = 10;
	UI::GET_HUD_COLOUR(func_355(iVar6), &uVar8, &uVar9, &uVar10, &iVar11);
	if (UI::DOES_BLIP_EXIST(uParam0->f_2))
	{
		UI::REMOVE_BLIP(&(uParam0->f_2));
		GRAPHICS::DELETE_CHECKPOINT(uParam0->f_4);
		...
		iLocal_44 = 180;
		Var0 = { uParam1->f_4[(uParam0->f_9 - 1)] };
		Var0 = { Var0 + Vector(7.5f, 0f, 0f) };
		if (uParam0->f_9 == (uParam1->f_126 - 1))
		{
			uParam0->f_5 = GRAPHICS::CREATE_CHECKPOINT(iVar7, Var0, uParam1->f_4[uParam0->f_9], fVar4, uVar12, uVar13, uVar14, iLocal_44, 0);
		...
		{
			uParam0->f_5 = GRAPHICS::CREATE_CHECKPOINT(func_356((uParam0->f_9 - 1), uParam1), Var0, uParam1->f_4[uParam0->f_9], fVar4, uVar12, uVar13, uVar14, iLocal_44, 0);
			GRAPHICS::SET_CHECKPOINT_CYLINDER_HEIGHT(uParam0->f_5, 3f, 3f, 100f);
			GRAPHICS::SET_CHECKPOINT_RGBA(uParam0->f_5, uVar12, uVar13, uVar14, iLocal_44);
			GRAPHICS::_SET_CHECKPOINT_ICON_RGBA(uParam0->f_5, uVar12, uVar13, uVar14, iLocal_44);
		}
	...
	if (!UI::DOES_BLIP_EXIST(uParam0->f_2))
	{
		uParam0->f_2 = UI::ADD_BLIP_FOR_COORD(uParam1->f_4[uParam0->f_9]);
		...
		Var0 = { uParam1->f_4[uParam0->f_9] };
		Var0 = { Var0 + Vector(7.5f, 0f, 0f) };
		if (uParam0->f_9 == (uParam1->f_126 - 1))
		{
			if (uParam0->f_11 == uParam1->f_127)
			{
				uParam0->f_4 = GRAPHICS::CREATE_CHECKPOINT(iVar7, Var0, uParam1->f_4[uParam0->f_9], fVar4, uVar8, uVar9, uVar10, 100, 0);
				...
				fVar16 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(uParam1->f_4[uParam0->f_9], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1);
				if (uParam0->f_4 != 0)
				{
					if (uParam0->f_13 > 100f)
					{
			...
			{
				uParam0->f_4 = GRAPHICS::CREATE_CHECKPOINT(iVar7, Var0, uParam1->f_4[0], fVar4, uVar8, uVar9, uVar10, iVar11, 0);
				UI::GET_HUD_COLOUR(13, &uVar8, &uVar9, &uVar10, &iVar11);
				GRAPHICS::SET_CHECKPOINT_RGBA(uParam0->f_4, uVar8, uVar9, uVar10, iVar11);
				UI::GET_HUD_COLOUR(134, &uVar8, &uVar9, &uVar10, &iVar11);
				GRAPHICS::_SET_CHECKPOINT_ICON_RGBA(uParam0->f_4, uVar8, uVar9, uVar10, iVar11);
				GRAPHICS::SET_CHECKPOINT_CYLINDER_HEIGHT(uParam0->f_4, 3f, 3f, 100f);
				fVar17 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(uParam1->f_4[uParam0->f_9], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1);
				if (uParam0->f_4 != 0)
				{
					if (uParam0->f_13 > 100f)
					{
		...
		{
			uParam0->f_4 = GRAPHICS::CREATE_CHECKPOINT(iVar6, Var0, uParam1->f_4[uParam0->f_9 + 1], fVar4, uVar8, uVar9, uVar10, 150, 0);
			UI::GET_HUD_COLOUR(13, &uVar8, &uVar9, &uVar10, &iVar11);
			GRAPHICS::SET_CHECKPOINT_RGBA(uParam0->f_4, uVar8, uVar9, uVar10, iVar11);
			UI::GET_HUD_COLOUR(134, &uVar8, &uVar9, &uVar10, &iVar11);
			GRAPHICS::_SET_CHECKPOINT_ICON_RGBA(uParam0->f_4, uVar8, uVar9, uVar10, iVar11);
			GRAPHICS::SET_CHECKPOINT_CYLINDER_HEIGHT(uParam0->f_4, 3f, 3f, 100f);
			fVar18 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(uParam1->f_4[uParam0->f_9], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1);
			if (uParam0->f_4 != 0)
			{
				if (uParam0->f_13 > 100f)
				{
	...
	if (bVar5)
	{
		if (!UI::DOES_BLIP_EXIST(uParam0->f_3))
		{
			if (uParam0->f_10 < (uParam1->f_126 - 1))
			{
				uParam0->f_3 = UI::ADD_BLIP_FOR_COORD(uParam1->f_4[uParam0->f_10]);
...
int func_358(var uParam0, var uParam1)
{
	...
	if (uParam0->f_9 > -1)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(*uParam0, uParam1->f_4[uParam0->f_9], fLocal_43, fLocal_43, fLocal_43, 0, 1, 0))
		{
			return 1;
		}
	}
...
int func_359(var uParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1, 0))
	{
		if (PED::IS_PED_IN_VEHICLE(*uParam0, uParam0->f_1, 0))
		{
			...
			else if ((VEHICLE::IS_VEHICLE_MODEL(uParam0->f_1, 1127131465) || VEHICLE::IS_VEHICLE_MODEL(uParam0->f_1, 1938952078)) || VEHICLE::IS_VEHICLE_MODEL(uParam0->f_1, 2046537925))
			{
				return 0;
			}
			else
...
{
	uParam0->f_4[uParam0->f_126] = { Param1 };
	uParam0->f_126++;
}
...
void func_388(int iParam0)
{
	...
	else if (iParam0 == 4)
	{
		...
		while (iVar0 < 2)
		{
			if (func_29(uLocal_136[iVar0]))
			{
				ENTITY::SET_ENTITY_COORDS(uLocal_136[iVar0], Local_151[iVar0], 1, 0, 0, 1);
			...
			{
				func_344(&(uLocal_136[iVar0]), iLocal_140, Local_151[iVar0], fLocal_158[iVar0], iVar0, 0);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_136[iVar0], 1084227584);
...
void func_391(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_392(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_395()
{
	if (func_28(Local_878.f_28[1]))
	{
		...
		Var1 = { ENTITY::GET_ENTITY_COORDS(Local_878.f_28[1], 1) };
		Var1.z = uVar0;
...
void func_397()
{
	...
	while (iVar0 < 2)
	{
		if (func_29(uLocal_136[iVar0]))
		{
			ENTITY::SET_ENTITY_COORDS(uLocal_136[iVar0], Local_141[iVar0], 1, 0, 0, 1);
		...
		{
			func_344(&(uLocal_136[iVar0]), iLocal_140, Local_141[iVar0], fLocal_148[iVar0], iVar0, 0);
			func_267("Bike doesn't exist, recreate: ", iVar0);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_136[iVar0], 1084227584);
...
void func_398()
{
	...
	if (func_28(Local_878.f_28[1]))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_878.f_28[1], "MaryAnnes_Friend", 0, -37334073, 0);
	}
	else
	{
...
int func_409(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_250(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_413(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 3:
			...
			STREAMING::REQUEST_MODEL(623927022);
			...
			if ((((((((((VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(500, "Fan2_Cyclist") && AI::GET_IS_WAYPOINT_RECORDING_LOADED("Fan2_BikeRoute")) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("Fan2_Jogger1")) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("Fan2_Jogger2")) && STREAMING::HAS_MODEL_LOADED(iLocal_140)) && STREAMING::HAS_MODEL_LOADED(1127861609)) && STREAMING::HAS_MODEL_LOADED(1581098148)) && STREAMING::HAS_MODEL_LOADED(-951490775)) && STREAMING::HAS_MODEL_LOADED(623927022)) && STREAMING::HAS_ANIM_DICT_LOADED("rcm_fanatic2")) && STREAMING::HAS_ANIM_DICT_LOADED("rcmfanatic2"))
			{
				iVar0 = 1;
			}
			else
...
void func_417()
{
	...
	Local_141[0] = { 808.8217f, 1276.939f, 359.4989f };
	fLocal_148[0] = 261.78f;
	Local_141[1] = { 820.96f, 1274.52f, 359.47f };
	fLocal_148[1] = 268.5713f;
	Local_151[0] = { 280.9698f, 948.4752f, 209.7963f };
	fLocal_158[0] = 167.6198f;
	Local_151[1] = { 284.93f, 968.38f, 210.09f };
