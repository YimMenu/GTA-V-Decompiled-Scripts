...
{
	fLocal_25 = (Global_4269954[iParam0 /*3*/] - Local_20.x);
	fLocal_26 = (SYSTEM::COS(((3.14159f / 180f) * Local_20.x)) * (Global_4269954[iParam0 /*3*/].f_1 - Local_20.f_1));
...
{
	fLocal_29 = SYSTEM::SQRT(SYSTEM::VDIST2(Global_4269954[iParam0 /*3*/], Local_20));
...
{
	fLocal_28 = SYSTEM::SQRT((((Global_4269954[iParam0 /*3*/] - Local_20.x) * (Global_4269954[iParam0 /*3*/] - Local_20.x)) + ((Global_4269954[iParam0 /*3*/].f_1 - Local_20.f_1) * (Global_4269954[iParam0 /*3*/].f_1 - Local_20.f_1))));
	return fLocal_28;
}
...
float func_15()
{
	...
	fLocal_26 = (SYSTEM::COS(((3.14159f / 180f) * Local_20.x)) * (Global_21911.f_1 - Local_20.f_1));
	fLocal_27 = MISC::ATAN2(fLocal_25, fLocal_26);
	if (fLocal_27 < 0f)
	{
		fLocal_27 = (fLocal_27 + 360f);
...
float func_17()
{
	fLocal_28 = SYSTEM::SQRT((((Global_21911 - Local_20.x) * (Global_21911 - Local_20.x)) + ((Global_21911.f_1 - Local_20.f_1) * (Global_21911.f_1 - Local_20.f_1))));
	return fLocal_28;
}
