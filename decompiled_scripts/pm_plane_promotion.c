...
void func_1()
{
	...
	{
		case 0:
			STREAMING::REQUEST_MODEL(-2122757008);
			if (STREAMING::HAS_MODEL_LOADED(-2122757008))
			{
				iLocal_241 = Global_110348.f_222[0];
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_241))
				{
					iLocal_241 = VEHICLE::CREATE_VEHICLE(-2122757008, Var0, 121.2244f, 1, 1, 0);
				...
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-2122757008);
				HUD::CLEAR_PRINTS();
		...
		if (CAM::IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				...
				else
				{
					...
					else if (!func_41(Var3, HUD::GET_BLIP_COORDS(uParam0->f_5), 0.1f, 0))
					{
...
int func_35(var uParam0)
{
	...
	else if (func_36(1, 0, 1) || MISC::IS_BIT_SET(uParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_45(iParam2), 1);
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_132(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_129(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_81(Global_102203.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_107(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_143()
{
	...
	while (iVar0 <= 9)
	{
		...
		{
			fVar1 = 0f;
			MISC::GET_GROUND_Z_FOR_3D_COORD(Local_242[iVar0], &fVar1, 0, 0);
...
void func_148()
{
	...
	if (HUD::DOES_BLIP_EXIST(Local_242[0].f_4))
	{
		HUD::REMOVE_BLIP(&(Local_242[0].f_4));
	}
	if (HUD::DOES_BLIP_EXIST(Local_242[0].f_5))
	{
		HUD::REMOVE_BLIP(&(Local_242[0].f_5));
	}
	if (HUD::DOES_BLIP_EXIST(Local_242[1].f_4))
	{
		HUD::REMOVE_BLIP(&(Local_242[1].f_4));
	}
	if (HUD::DOES_BLIP_EXIST(Local_242[1].f_5))
	{
		HUD::REMOVE_BLIP(&(Local_242[1].f_5));
	}
