...
{
	func_110(&Global_105842, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_133(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2592627[iParam0 /*3*/][func_131(iParam1)];
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102858.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102858.f_4, false))
		{
			if (func_260(24) != Global_102858.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_257(ENTITY::GET_ENTITY_COORDS(Global_102858.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
...
void func_325()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[2 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_95867.f_28[2]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95867.f_28[2], true, true);
			Local_169[2 /*2*/] = Global_95867.f_28[2];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[3 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_95867.f_28[3]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95867.f_28[3], true, true);
