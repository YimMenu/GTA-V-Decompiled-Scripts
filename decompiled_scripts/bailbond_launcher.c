		...
		switch (Global_111638.f_24981.f_2)
		{
					...
					if (!func_247())
					{
						if (func_225(4, 62, 2, -1, 0))
						{
							if (func_222(Local_43.f_4, Local_43.f_5))
							{
								...
								GAMEPLAY::CLEAR_BIT(&(Global_111638.f_24981), 9);
			...
			case 1:
				if (func_192() == 2)
				{
					...
					if (!GAMEPLAY::IS_BIT_SET(Global_111638.f_24981, 8))
					{
						if (!func_247())
						{
							GAMEPLAY::SET_BIT(&(Global_111638.f_24981), 8);
						}
						else
						{
							SYSTEM::WAIT(2000);
					...
					else if (func_247())
					{
						...
						else
						{
							if (GAMEPLAY::IS_BIT_SET(Global_111638.f_24981, 8))
							{
								GAMEPLAY::CLEAR_BIT(&(Global_111638.f_24981), 8);
							}
							SYSTEM::WAIT(2000);
						}
					}
...
void func_28(int iParam0)
{
	switch (iParam0)
	{
		case 1:
		case 2:
			GAMEPLAY::SET_BIT(&(Global_111638.f_24981), func_73(Local_43.f_4));
			if (iParam0 == 1)
			{
				func_72(0);
				iVar0 = 8;
				GAMEPLAY::SET_BIT(&(Global_111638.f_24981), func_71(Local_43.f_4));
			}
			else
			{
				func_72(1);
				iVar0 = 4;
				GAMEPLAY::CLEAR_BIT(&(Global_111638.f_24981), func_71(Local_43.f_4));
			...
			if (func_36())
			{
				if (GAMEPLAY::IS_BIT_SET(Global_111638.f_24981, func_71(Local_43.f_4)))
				{
					iLocal_218 = func_201();
...
void func_30()
{
	...
	iVar0 = (iVar0 - 1);
	if (iVar0 >= 0 && GAMEPLAY::IS_BIT_SET(Global_111638.f_24981, func_71(iVar0)))
	{
		Local_43.f_5 = 1;
	}
	else
...
int func_35()
{
	...
	while (iVar0 <= (4 - 1))
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_111638.f_24981, iVar0))
		{
			return iVar0;
		}
		iVar0++;
...
{
	if (!GAMEPLAY::IS_BIT_SET(Global_111638.f_24981, 9))
	{
		if (func_17(Global_111638.f_24981.f_3))
		{
			if (func_249())
			{
				if (func_225(4, 62, 2, -1, 0))
				{
					...
					{
						GAMEPLAY::SET_BIT(&(Global_111638.f_24981), 9);
					}
				}
			}
		}
...
void func_79(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	*uParam0 = func_192();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_108())
		{
			func_101(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
int func_124(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_126() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_102(func_125(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_128(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_144(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Param0, func_129(iVar0, 0), 1);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_158()) || Global_30770) || func_164()) || func_163(8, -1)) || func_156()) || func_145()) || func_162()) || func_157()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_158()) || Global_110685) || Global_30770) || func_164()) || func_163(8, -1)) || func_145()) || func_162()) || func_157()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_158()) || Global_30770) || func_164()) || func_163(8, -1)) || func_162()) || func_156()) || func_157()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_158()) || func_162()) || Global_110685) || Global_30770) || func_164()) || Global_42596) || func_163(8, -1)) || func_156()) || func_161()) || func_157()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_158()) || Global_110685) || Global_30770) || func_164()) || func_163(8, -1)) || func_156()) || func_161()) || func_145()) || func_162()) || func_157())
						{
							return 0;
						}
						break;
...
void func_173(var uParam0, var uParam1)
{
	if (!uParam0->f_7)
	{
		if (func_31(26, func_32(uParam0->f_4), 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if ((!func_191() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID())) && !UI::IS_MESSAGE_BEING_DISPLAYED())
				{
...
int func_201()
{
	func_200(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_199(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_198(&uVar0, TIME::GET_CLOCK_HOURS());
	func_196(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_197(&uVar0, TIME::GET_CLOCK_MONTH());
	func_195(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
void func_206(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_208()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_208()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_207(iParam0));
...
bool func_212(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_208()].f_6174.f_10, iParam0);
}
...
int func_225(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(iParam0, func_108()) && !GAMEPLAY::IS_BIT_SET(iParam4, 19))
			{
				return 0;
			}
		}
	...
	{
		if (!GAMEPLAY::IS_BIT_SET(iParam0, func_108()))
		{
			return 0;
		}
	}
...
float func_228(var uParam0)
{
	if (func_231(uParam0))
	{
		...
		{
			return (func_229(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
	...
	if (iLocal_225 != 0)
	{
		...
		switch (iLocal_225)
		{
			...
			case 2:
				...
				{
					GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uLocal_220, "SHOW_SHARD_MIDSIZED_MESSAGE");
			...
			case 3:
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_223) > 7000)
				{
					if (!iLocal_52)
					{
						GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(uLocal_220, "SHARD_ANIM_OUT");
...
void func_253()
{
	if (Global_111638.f_24981.f_1 == 0)
	{
		...
		{
			GAMEPLAY::CLEAR_BIT(&(Global_111638.f_24981), 0);
			GAMEPLAY::CLEAR_BIT(&(Global_111638.f_24981), 1);
			GAMEPLAY::CLEAR_BIT(&(Global_111638.f_24981), 2);
			GAMEPLAY::CLEAR_BIT(&(Global_111638.f_24981), 3);
			GAMEPLAY::CLEAR_BIT(&(Global_111638.f_24981), 4);
			GAMEPLAY::CLEAR_BIT(&(Global_111638.f_24981), 5);
			GAMEPLAY::CLEAR_BIT(&(Global_111638.f_24981), 6);
			GAMEPLAY::CLEAR_BIT(&(Global_111638.f_24981), 7);
			GAMEPLAY::CLEAR_BIT(&(Global_111638.f_24981), 8);
			GAMEPLAY::CLEAR_BIT(&(Global_111638.f_24981), 9);
			iLocal_218 = func_201();
