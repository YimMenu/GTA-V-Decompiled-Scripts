...
void func_1()
{
	...
	while (iVar0 < Global_110945)
	{
		...
		{
			iVar1 = iVar0;
			if (MISC::GET_GAME_TIMER() > Global_110945[iVar0 /*28*/].f_21 && Global_110945[iVar0 /*28*/].f_21 != -1)
			{
				if (func_3(iVar0))
				{
			...
			else if (func_3(iVar0))
			{
				...
				{
					if (!MISC::IS_BIT_SET(Global_110945[iVar0 /*28*/].f_27, 0))
					{
						Global_110945[iVar0 /*28*/].f_21 = (Global_110945[iVar0 /*28*/].f_21 + SYSTEM::ROUND((MISC::GET_FRAME_TIME() * 1000f)));
						if (HUD::IS_FLOATING_HELP_TEXT_ON_SCREEN(iVar1))
						{
							MISC::SET_BIT(&(Global_110945[iVar0 /*28*/].f_27), 0);
						}
					}
				}
				if (Global_110945[iVar0 /*28*/].f_24.f_2 != 9999f)
				{
					...
					{
						if (!ENTITY::IS_ENTITY_DEAD(Global_110945[iVar0 /*28*/].f_23, false))
						{
							if (!MISC::IS_BIT_SET(Global_110945[iVar0 /*28*/].f_27, 3))
							{
								HUD::SET_FLOATING_HELP_TEXT_WORLD_POSITION(iVar1, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_110945[iVar0 /*28*/].f_23, Global_110945[iVar0 /*28*/].f_24));
							}
							else
							{
								HUD::SET_FLOATING_HELP_TEXT_TO_ENTITY(iVar1, Global_110945[iVar0 /*28*/].f_23, Global_110945[iVar0 /*28*/].f_24, Global_110945[iVar0 /*28*/].f_24.f_1);
							}
						}
					}
					else if ((Global_110945[iVar0 /*28*/].f_24 != 0f || Global_110945[iVar0 /*28*/].f_24.f_1 != 0f) || Global_110945[iVar0 /*28*/].f_24.f_2 != 0f)
					{
						HUD::SET_FLOATING_HELP_TEXT_WORLD_POSITION(iVar1, Global_110945[iVar0 /*28*/].f_24);
					}
				}
				else
				{
					HUD::SET_FLOATING_HELP_TEXT_SCREEN_POSITION(iVar1, Global_110945[iVar0 /*28*/].f_24, Global_110945[iVar0 /*28*/].f_24.f_1);
				}
			}
			else if ((MISC::GET_GAME_TIMER() - Global_110945[iVar0 /*28*/].f_22) > 1000)
			{
				func_2(iVar0);
			}
		}
...
int func_3(int iParam0)
{
	...
	iVar0 = iParam0;
	if (!MISC::ARE_STRINGS_EQUAL(&(Global_110945[iParam0 /*28*/]), "") && !MISC::IS_STRING_NULL(&(Global_110945[iParam0 /*28*/])))
	{
		if (MISC::IS_BIT_SET(Global_110945[iParam0 /*28*/].f_27, 1))
		{
			if (MISC::IS_BIT_SET(Global_110945[iParam0 /*28*/].f_27, 2))
			{
		...
		else if (MISC::IS_BIT_SET(Global_110945[iParam0 /*28*/].f_27, 2))
		{
