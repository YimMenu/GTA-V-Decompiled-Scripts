...
void func_1()
{
	...
	while (iVar0 < Global_110290)
	{
		...
		{
			iVar1 = iVar0;
			if (MISC::GET_GAME_TIMER() > Global_110290[iVar0].f_21 && Global_110290[iVar0].f_21 != -1)
			{
				if (func_3(iVar0))
				{
			...
			else if (func_3(iVar0))
			{
				...
				{
					if (!MISC::IS_BIT_SET(Global_110290[iVar0].f_27, 0))
					{
						Global_110290[iVar0].f_21 = (Global_110290[iVar0].f_21 + SYSTEM::ROUND((MISC::GET_FRAME_TIME() * 1000f)));
						if (HUD::IS_FLOATING_HELP_TEXT_ON_SCREEN(iVar1))
						{
							MISC::SET_BIT(&(Global_110290[iVar0].f_27), 0);
						}
					}
				}
				if (Global_110290[iVar0].f_24.f_2 != 9999f)
				{
					if (Global_110290[iVar0].f_23 != 0)
					{
						...
						{
							if (!MISC::IS_BIT_SET(Global_110290[iVar0].f_27, 3))
							{
								HUD::SET_FLOATING_HELP_TEXT_WORLD_POSITION(iVar1, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_110290[iVar0].f_23, Global_110290[iVar0].f_24));
							}
							else
							{
								HUD::SET_FLOATING_HELP_TEXT_TO_ENTITY(iVar1, Global_110290[iVar0].f_23, Global_110290[iVar0].f_24, Global_110290[iVar0].f_24.f_1);
							}
						}
					}
					else if ((Global_110290[iVar0].f_24 != 0f || Global_110290[iVar0].f_24.f_1 != 0f) || Global_110290[iVar0].f_24.f_2 != 0f)
					{
						HUD::SET_FLOATING_HELP_TEXT_WORLD_POSITION(iVar1, Global_110290[iVar0].f_24);
					}
				}
				else
				{
					HUD::SET_FLOATING_HELP_TEXT_SCREEN_POSITION(iVar1, Global_110290[iVar0].f_24, Global_110290[iVar0].f_24.f_1);
				}
			}
			else if ((MISC::GET_GAME_TIMER() - Global_110290[iVar0].f_22) > 1000)
			{
				func_2(iVar0);
			}
		}
