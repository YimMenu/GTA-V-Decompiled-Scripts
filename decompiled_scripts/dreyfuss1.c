			...
			switch (iLocal_562)
			{
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						MISC::CLEAR_AREA_OF_VEHICLES(-1473.376f, 517.8441f, 116.8854f, 30f, 0, 0, 0, 0, 0, 0);
						func_311(500, 0);
						iLocal_562++;
					}
					break;
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_356(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
