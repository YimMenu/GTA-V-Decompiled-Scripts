...
void func_246()
{
	switch (iLocal_155)
	{
		case 0:
			...
			if (UI::DOES_BLIP_EXIST(iLocal_157))
			{
				UI::SET_BLIP_SCALE(iLocal_157, 0.7f);
			}
			if (func_437(iLocal_156))
			{
				...
				AI::TASK_PERFORM_SEQUENCE(iLocal_156, uLocal_160);
		...
		case 1:
			...
			if (!func_437(iLocal_156))
			{
				...
				if (!GAMEPLAY::IS_BIT_SET(Global_111638.f_18569.f_382, 0))
				{
					GAMEPLAY::SET_BIT(&(Global_111638.f_18569.f_382), 0);
				}
				func_295(4);
			}
			...
			else
			{
				...
				func_247();
				AI::SET_PED_DESIRED_MOVE_BLEND_RATIO(iLocal_156, 1.8f);
			}
			break;
...
void func_248(int iParam0, int iParam1, int iParam2, var uParam3, char* sParam4, char* sParam5, bool bParam6)
{
	...
	if (!*uParam3)
	{
		if (!iLocal_537)
		{
			if (!*iParam0)
			{
				if ((func_249(iLocal_156) && !PED::IS_PED_RAGDOLL(iLocal_156)) && !AI::IS_PED_IN_WRITHE(iLocal_156))
				{
					if (func_259(PLAYER::PLAYER_PED_ID(), iLocal_156, fLocal_334, 1))
					{
						if (!func_242())
	...
	if (UI::DOES_BLIP_EXIST(*iParam0))
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - *uParam3) > 500)
		{
			if (UI::GET_BLIP_COLOUR(*iParam0) == 1)
			{
				...
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_262(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED() || func_262(sParam2, 0, 0))
					{
...
int func_272(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_279() || func_278(Global_4456448.f_232883)) || func_277())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_275(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_297()
{
	if (func_437(iLocal_156))
	{
		if (WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_156, 911657153, 0))
		{
			if (func_437(iLocal_156))
			{
	...
	switch (iLocal_155)
	{
		case 0:
			...
			if (func_437(Local_86.f_35[0]))
			{
				...
				while (iVar0 < 3)
				{
					Local_526[iVar0] = { ENTITY::GET_ENTITY_COORDS(Local_86.f_35[0], 1) };
					iVar0++;
				}
			}
		...
		case 1:
			...
			else
			{
				if (func_437(Local_86.f_35[0]))
				{
					...
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_156, Local_86.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 90f, 786469, 100f, 1f, 1);
						iLocal_333 = 1;
					}
				}
				func_250(0);
				...
				{
					AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_156, Local_86.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 90f, 786468, 100f, 1f, 1);
					iLocal_332 = 1;
				}
				if (!func_304())
				{
...
int func_300()
{
	if (func_437(Local_86.f_35[0]))
	{
		if (PED::IS_PED_IN_VEHICLE(iLocal_156, Local_86.f_35[0], 0))
		{
			...
			{
				func_302();
				if (func_301(Local_526[0], Local_526[2], 2f))
				{
					return 0;
				}
				else
...
{
	iLocal_536 = GAMEPLAY::GET_GAME_TIMER();
	Local_526[0] = { Local_526[1] };
	Local_526[1] = { Local_526[2] };
	Local_526[2] = { ENTITY::GET_ENTITY_COORDS(Local_86.f_35[0], 1) };
}
	...
	switch (iLocal_155)
	{
		case 0:
			...
			if (func_437(iLocal_156))
			{
				...
				if (func_3(Local_86.f_35[0]))
				{
					...
					AI::TASK_PERFORM_SEQUENCE(iLocal_156, uLocal_159);
					uLocal_330 = VEHICLE::_0x2CE544C68FB812A0(ENTITY::GET_ENTITY_COORDS(Local_86.f_35[0], 1), 100f, 10f, 0);
				}
				else
				{
					AI::TASK_SMART_FLEE_PED(iLocal_156, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
				}
			}
		...
		case 1:
			...
			else
			{
				...
				if ((func_307(242628503) && AI::GET_SEQUENCE_PROGRESS(iLocal_156) > 0) && func_303())
				{
					func_295(3);
				}
			}
...
{
	if (AI::GET_SCRIPT_TASK_STATUS(iLocal_156, iParam0) == 1 || AI::GET_SCRIPT_TASK_STATUS(iLocal_156, iParam0) == 0)
	{
		return 1;
	}
	return 0;
...
int func_308()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_86.f_35[0]))
	{
		...
		{
			if (AI::GET_SEQUENCE_PROGRESS(iLocal_156) > 0)
			{
				...
				else if (!ENTITY::IS_ENTITY_AT_COORD(Local_86.f_35[0], Local_82, 5f, 5f, 100f, 0, 1, 0))
				{
...
void func_310()
{
	if (func_249(iLocal_156) && func_3(Local_86.f_35[0]))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_156, Local_86.f_35[0]))
		{
			if (UI::DOES_BLIP_EXIST(iLocal_157))
			{
				UI::SET_BLIP_SCALE(iLocal_157, 1f);
			}
			iLocal_155 = 2;
		}
	}
...
int func_314()
{
	if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1482.992f, 523.4556f, 117.9981f, 15f, -349730013, 0) && OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1477.865f, 525.6363f, 118.0456f, 15f, -1918480350, 0))
	{
		OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(-349730013, -1482.992f, 523.4556f, 117.9981f, 1, 0f, 0);
		OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(-1918480350, -1477.865f, 525.6363f, 118.0456f, 1, 0f, 0);
		OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(-349730013, -1482.992f, 523.4556f, 117.9981f, 1, 1f, 0);
		OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(-1918480350, -1477.865f, 525.6363f, 118.0456f, 1, -1f, 0);
		return 1;
	}
	return 0;
}
...
void func_316()
{
	switch (iLocal_155)
	{
		case 0:
			...
			iLocal_565 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1459.57f, 485.16f, 115.2f, 10f, 2057317573, 1, 0, 1);
			...
			switch (iLocal_562)
			{
				case 0:
					if (func_437(PLAYER::PLAYER_PED_ID()))
					{
						...
						{
							AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_156, -1, 0, 2);
							iLocal_562++;
						}
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_156, -1475.366f, 500.3797f, 116.6013f, 3f, 20000, 0.25f, 1, 1193033728);
						}
					}
					break;
			}
...
void func_326(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_327(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_376(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_373(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_369(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_380(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_381(Var18[0], Var18[1], Var6, Var9) || func_381(Var18[0], Var18[1], Var9, Var15)) || func_381(Var18[0], Var18[1], Var12, Var15)) || func_381(Var18[0], Var18[1], Var6, Var12)) || func_381(Var18[1], Var18[3], Var6, Var9)) || func_381(Var18[1], Var18[3], Var9, Var15)) || func_381(Var18[1], Var18[3], Var12, Var15)) || func_381(Var18[1], Var18[3], Var6, Var12)) || func_381(Var18[3], Var18[2], Var6, Var9)) || func_381(Var18[3], Var18[2], Var9, Var15)) || func_381(Var18[3], Var18[2], Var12, Var15)) || func_381(Var18[3], Var18[2], Var6, Var12)) || func_381(Var18[2], Var18[0], Var6, Var9)) || func_381(Var18[2], Var18[0], Var9, Var15)) || func_381(Var18[2], Var18[0], Var12, Var15)) || func_381(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
	...
	if (iLocal_564 == 0)
	{
		if (func_437(iLocal_156))
		{
			if (func_294(PLAYER::PLAYER_PED_ID(), iLocal_156, 1) < 3f)
			{
				...
				AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_156, 0);
			}
		}
	}
}
...
void func_419(int iParam0)
{
	...
	if (!func_430())
	{
		func_422(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 12, 5000, 0, 0);
	}
	func_421(0, -1, 1);
	if (iParam0 == 1)
	{
...
void func_425()
{
	...
	if (func_437(iLocal_156))
	{
		...
		AI::SET_PED_PATHS_WIDTH_PLANT(iLocal_156, 0);
...
void func_436()
{
	...
	func_432();
	GAMEPLAY::CLEAR_BIT(&(Global_111638.f_18569.f_382), 0);
