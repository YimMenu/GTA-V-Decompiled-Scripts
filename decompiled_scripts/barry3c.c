...
void func_1()
{
	...
	switch (iLocal_157)
	{
		...
		case 1:
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[0][0], Local_439[0][1], fLocal_454[0], 0, 1, 0))
			{
				iLocal_157 = 2;
			}
			else
...
int func_2()
{
	if (func_415(iLocal_188) && func_415(Local_159.f_4))
	{
		if (func_3())
		{
			if (VEHICLE::_IS_CARGOBOB_HOOK_ACTIVE(iLocal_188) && VEHICLE::IS_VEHICLE_ATTACHED_TO_CARGOBOB(iLocal_188, Local_159.f_4))
			{
				bLocal_180 = true;
				return 1;
			}
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_415(iVar0))
		{
			...
			if ((((iVar1 == -1323100960 || iVar1 == -442313018) || iVar1 == -50547061) || iVar1 == 1621617168) || iVar1 == 1394036463)
			{
				...
				while (iLocal_250 <= 7)
				{
					if (func_415(Local_191[iLocal_250].f_4) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_191[iLocal_250].f_4, 0))
					{
						bVar2 = true;
...
void func_5(bool bParam0)
{
	...
	else
	{
		...
		while (iLocal_250 <= 7)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_191[iLocal_250].f_4))
			{
				if (!func_9(PLAYER::PLAYER_PED_ID(), Local_191[iLocal_250], 175f) && func_8(PLAYER::PLAYER_PED_ID(), Local_191[iLocal_250].f_4, 1) > 175f)
				{
					func_6(&(Local_191[iLocal_250].f_4));
				}
			}
			else if (!Local_191[iLocal_250].f_6 && func_9(PLAYER::PLAYER_PED_ID(), Local_191[iLocal_250], 100f))
			{
				Local_191[iLocal_250].f_4 = VEHICLE::CREATE_VEHICLE(-1323100960, Local_191[iLocal_250], Local_191[iLocal_250].f_3, 1, 1, 0);
				if (iLocal_250 == 6)
				{
					VEHICLE::SET_VEHICLE_COLOURS(Local_191[iLocal_250].f_4, 39, 43);
				}
				else
				{
					VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_191[iLocal_250].f_4, 0);
				}
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_191[iLocal_250].f_4, 1084227584);
				VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Local_191[iLocal_250].f_4, 0, 0);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_191[iLocal_250].f_4, 1);
			}
			iLocal_250++;
		}
	}
...
{
	Local_458[iParam0].f_1 = iParam1;
}

void func_12(int iParam0)
{
	if (Local_458[iParam0].f_1 < Local_458[iParam0] || Local_458[iParam0] == -1)
	{
		func_14(Local_458[iParam0].f_2, 7500, 1);
		func_13(&uLocal_143);
		Local_458[iParam0].f_1++;
	}
}
	...
	switch (iLocal_157)
	{
		case 0:
			...
			if (func_415(iLocal_188))
			{
				...
				UI::SET_BLIP_ROUTE(iLocal_158, 1);
				if (bLocal_180)
				{
					func_12(7);
				}
		...
		case 1:
			...
			else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[0][0], Local_439[0][1], fLocal_454[0], 0, 0, 0) && !ENTITY::IS_ENTITY_IN_AIR(Local_159.f_4))
			{
				Var0 = { ENTITY::GET_ENTITY_COORDS(Local_159.f_4, 1) };
				if (Var0.z < 6.7f)
				{
					iLocal_156 = 12;
					iLocal_157 = 0;
...
int func_44()
{
	...
	while (iLocal_250 <= 8)
	{
		if (func_45(Local_458[iLocal_250].f_2, 0, 0))
		{
			return 1;
		}
		iLocal_250++;
		...
		case 2:
			...
			if (func_4())
			{
				if (func_2())
				{
					...
					else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[0][0], Local_439[0][1], fLocal_454[0], 0, 1, 0))
					{
						iLocal_156 = 6;
					}
					else
...
{
	UI::CLEAR_THIS_PRINT(Local_458[iParam0].f_2);
}
...
void func_51()
{
	...
	switch (iLocal_157)
	{
		...
		case 1:
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[1][0], Local_439[1][1], fLocal_454[1], 0, 1, 0))
			{
...
int func_81(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_124(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_124(iParam1), Global_76434[1].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, 0);
		}
	}
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_124(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_115(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_124(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_124(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_124(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_124(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_130(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_130(Var16.z)] = func_107(iParam1, Var16.x, func_130(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_130(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_119(func_138(iParam1, uParam0->f_2), Global_76431, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_119(func_137(iParam1, uParam0->f_2), Global_76431, 0);
			if (GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				GAMEPLAY::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_119(iVar1, Global_76431, 0);
				if (!GAMEPLAY::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					GAMEPLAY::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_141(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_135(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_135(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_124(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_196(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_124(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_124(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_209()
{
	...
	{
		func_34();
		GRAPHICS::_0xBF59707B3E5ED531(func_210(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
...
{
	func_252(&Global_105187, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_252(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	*uParam0 = func_33();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_274())
		{
			func_270(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_264(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_289(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_57() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_119(func_290(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_292(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_307(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Param0, func_293(iVar0, 0), 1);
...
var func_309()
{
	func_319(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_318(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_317(&uVar0, TIME::GET_CLOCK_HOURS());
	func_312(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_311(&uVar0, TIME::GET_CLOCK_MONTH());
	func_310(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_315(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
	...
	switch (iLocal_157)
	{
		...
		case 1:
			...
			else if (func_2())
			{
				...
				else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[1][0], Local_439[1][1], fLocal_454[1], 0, 1, 0))
				{
					iLocal_156 = 10;
					iLocal_157 = 0;
				}
	...
	switch (iLocal_157)
	{
		...
		case 1:
			...
			else if (!func_2())
			{
				if (func_3())
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[1][0], Local_439[1][1], fLocal_454[1], 0, 0, 0))
					{
			...
			else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[0][0], Local_439[0][1], fLocal_454[0], 1, 1, 0))
			{
				iLocal_157 = 2;
			}
			else if (iLocal_486)
		...
		case 2:
			...
			{
				if (func_3() && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[0][0], Local_439[0][1], fLocal_454[0], 0, 0, 0))
				{
					if (!ENTITY::IS_ENTITY_IN_AIR(Local_159.f_4))
					{
						Var0 = { ENTITY::GET_ENTITY_COORDS(Local_159.f_4, 1) };
		...
		case 0:
			...
			if (iLocal_248)
			{
				...
				else
				{
					...
					if (!UI::DOES_BLIP_EXIST(iLocal_158))
					{
						iLocal_158 = func_46(Local_159.f_4, 1, 5);
					}
					iLocal_157 = 1;
...
{
	if (Local_458[iParam0] == -1)
	{
	}
	else
	{
		Local_458[iParam0].f_1 = Local_458[iParam0];
	}
}
...
int func_338()
{
	...
	while (iLocal_250 <= 7)
	{
		if (!Local_191[iLocal_250].f_6 && func_9(PLAYER::PLAYER_PED_ID(), Local_191[iLocal_250], 8f))
		{
			return 1;
		}
		iLocal_250++;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_367(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_364(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
...
void func_423(struct<3> Param0, float fParam3)
{
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_172, Local_159.f_4, 0, Local_173, Local_176, 0, 0, 0, 0, 2, 1);
}
...
void func_461()
{
	Local_458[0] = { func_462("B3CENTV", 1) };
	Local_458[1] = { func_462("B3CDELV", 1) };
	Local_458[2] = { func_462("B3CWAN1", -1) };
	Local_458[3] = { func_462("B3CNOGO", 1) };
	Local_458[4] = { func_462("B3CREVRS", 1) };
	Local_458[5] = { func_462("B3CLEAVE", 1) };
	Local_458[6] = { func_462("B3CRTTT", 1) };
	Local_458[7] = { func_462("B3CGBTB", 1) };
	Local_458[8] = { func_462("B3CRTCB", 1) };
}
