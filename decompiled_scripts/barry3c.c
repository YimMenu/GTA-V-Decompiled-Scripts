...
void func_19()
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			...
			{
				Var0 = { ENTITY::GET_ENTITY_COORDS(Local_97.f_4, 1) };
				if (Var0.z < 6.7f)
				{
					iLocal_94 = 12;
					iLocal_95 = 0;
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.x != 0 && Var2.x != -1) && Var2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_130(Var2.z)] = Var2.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_130(Var2.z)] = func_107(iParam1, Var2.x, func_130(Var2.z), iVar0);
					}
				}
				else if (Var2.y != -1)
				{
					(*uParam0)[func_130(Var2.z)] = Var2.y;
				}
			}
			iVar4++;
		}
...
void func_141(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_135(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_135(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
void func_203(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_204(&uVar1, Var0.f_3, Global_98781, iParam1, iParam2);
	}
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102203.f_4, 0))
		{
			if (func_367(24) != Global_102203.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_364(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_341(Global_102203.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}
			...
			switch (iLocal_294)
			{
				...
				case 3:
					if (MISC::GET_GAME_TIMER() > iLocal_291)
					{
						...
						{
							AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_296, "IGNITION_FAIL", Local_97.f_4, "BARRY_03_SOUNDSET", 0, 0);
							AUDIO::SET_VARIABLE_ON_SOUND(uLocal_296, "HOLD TIME", (SYSTEM::TO_FLOAT((1200 + iLocal_295 * 250)) / 1000f));
...
void func_423(struct<3> Param0, float fParam1)
{
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_106, Local_97.f_4, 0, Local_107, Local_108, 0, 0, 0, 0, 2, 1);
}
