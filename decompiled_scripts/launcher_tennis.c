...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			Local_64 = { ENTITY::GET_ENTITY_COORDS(iLocal_62, 1) };
			uLocal_66 = SYSTEM::VDIST2(Local_64, ScriptParam_100.f_1[0 /*3*/]);
			uLocal_66 = uLocal_66;
			Local_84 = { Local_64 };
			...
			switch (iLocal_68)
			{
				...
				case 3:
					...
					if (!func_178(iLocal_73))
					{
						...
						{
							bVar1 = true;
							if (MISC::ARE_STRINGS_EQUAL(&(Global_98744.f_3), &cLocal_53))
							{
								cLocal_53 = { Local_52 };
								bVar1 = false;
							}
					...
					else
					{
						...
						if (!func_165(3) && !Global_98778)
						{
							...
							{
								if ((!func_180(uLocal_67, 1) || !ENTITY::DOES_ENTITY_EXIST(func_164())) && !Global_98778)
								{
									func_173(10);
									break;
								}
						...
						if (bVar2)
						{
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_86, Local_87, fLocal_88, 1, 0, iLocal_76) || (fLocal_90 > 0f && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_139(Local_86, Local_87, 0.5f), 0) > fLocal_90))
							{
								bVar2 = false;
							}
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&cLocal_53))
					{
						...
						if (iVar3 == 1)
						{
							...
							uLocal_51 = SYSTEM::START_NEW_SCRIPT(&cLocal_53, iLocal_70);
				...
				case 6:
					...
					if (func_180(uLocal_67, 2097152))
					{
						if (!func_165(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_51))
						{
							func_173(10);
						}
					}
					...
					{
						STATS::PLAYSTATS_ODDJOB_DONE(SYSTEM::ROUND((func_11(&uLocal_80) * 1000f)), iLocal_72, 0);
						func_10(&uLocal_80);
						...
						if (iLocal_72 != -1)
						{
							if (func_180(Global_110289, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_72), 0, Global_98781, 0);
...
int func_60(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0 /*3*/][func_61(iParam1)];
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_57(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_57(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
