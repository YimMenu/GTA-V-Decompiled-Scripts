void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() || func_72() == 5)) && !func_60())
		{
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_343, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) > (3f + 2f))
			{
				func_81();
			}
		}
...
void func_1()
{
	...
	switch (iLocal_326)
	{
		...
		case 3:
			...
			func_11(1);
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
			uLocal_331 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uLocal_330);
...
{
	return MISC::IS_BIT_SET(Global_1377170.f_241.f_136[func_47(9)][iParam0], func_46(9));
}
