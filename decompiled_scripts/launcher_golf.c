...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			Local_63 = { ENTITY::GET_ENTITY_COORDS(iLocal_61, 1) };
			...
			switch (iLocal_67)
			{
				case 0:
					...
					else
					{
						...
						if ((Local_63.z - ScriptParam_93.f_1[0 /*3*/].f_2) > 500f)
						{
						}
					}
					break;
				...
				case 3:
					...
					if (!func_86(iLocal_72))
					{
						...
						{
							bVar1 = true;
							if (MISC::ARE_STRINGS_EQUAL(&(Global_98744.f_3), &cLocal_52))
							{
								cLocal_52 = { Local_51 };
								bVar1 = false;
							}
					...
					else
					{
						...
						if (!func_74(3) && !Global_98778)
						{
							...
							{
								if ((!func_88(uLocal_66, 1) || !ENTITY::DOES_ENTITY_EXIST(func_73())) && !Global_98778)
								{
									func_81(10);
									break;
								}
						...
						if (bVar2)
						{
							...
							else if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_61, ScriptParam_93.f_1[0 /*3*/], fLocal_85, fLocal_85, 2f, 0, 1, iLocal_75))
							{
								bVar2 = false;
							}
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&cLocal_52))
					{
						...
						if (iVar4 == 1)
						{
							...
							uLocal_50 = SYSTEM::START_NEW_SCRIPT(&cLocal_52, iLocal_69);
				...
				case 6:
					...
					{
						STATS::PLAYSTATS_ODDJOB_DONE(SYSTEM::ROUND((func_9(&uLocal_79) * 1000f)), iLocal_71, 0);
						func_8(&uLocal_79);
						...
						if (iLocal_71 != -1)
						{
							if (func_88(Global_110289, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_17(iLocal_71), 0, Global_98781, 0);
