void __EntryFunction__()
{
	...
	sVar1 = "tvscreen";
	bVar28 = true;
	Var29 = { ENTITY::GET_ENTITY_COORDS(iScriptParam_0, 1) - ENTITY::GET_ENTITY_FORWARD_VECTOR(iScriptParam_0) * Vector(0.6f, 0.6f, 0.6f) };
	Var29.z = (Var29.z + 0.5f);
	...
	while (bVar28)
	{
			...
			if (Global_1590386)
			{
				if (!bVar0)
				{
					...
					if (iVar32 == 1385417869)
					{
						...
						iLocal_127 = OBJECT::CREATE_OBJECT(-1769322543, ENTITY::GET_ENTITY_COORDS(iLocal_127, 1), 0, 1, 0);
						ENTITY::SET_ENTITY_ROTATION(iLocal_127, Var33, 2, 1);
						bVar0 = true;
					}
				}
			}
		...
		if (((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && ENTITY::DOES_ENTITY_EXIST(iLocal_127)) && !CUTSCENE::IS_CUTSCENE_PLAYING()) && PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
		{
			if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_FROM_ENTITY(iLocal_127))
			{
				...
				if (((((((((((((((((!bVar36 && !Global_31037) && !func_221(0)) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0)) && !func_220()) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var29, Var39, 0, 1, 1)) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_127)) && !GAMEPLAY::IS_BIT_SET(Global_2359302, 15)) && !func_219()) && !(Global_76622 && func_218())) && !(!Global_76622 && func_217())) && !((Global_76622 && GAMEPLAY::IS_BIT_SET(Global_4456448.f_14, 24)) && NETWORK::NETWORK_IS_ACTIVITY_SESSION())) && !((Global_76622 && func_216()) && func_215())) && !(Global_76622 && func_213(PLAYER::PLAYER_ID()) == 5)) && !NETWORK::NETWORK_IS_IN_MP_CUTSCENE()) && !Global_75434) && !func_210()) && (!func_223() || func_209(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_127), 90f)))
				{
					if ((!func_208(Global_1590535[PLAYER::PLAYER_ID()].f_274.f_28) && !func_207(Global_1590535[PLAYER::PLAYER_ID()].f_274.f_28, -1)) && !func_206(PLAYER::PLAYER_ID()))
					{
					...
					if (((iLocal_116 != -1 && func_180(iLocal_116, 1)) && !AI::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID())) && func_179())
					{
						if (iLocal_116 != -1)
						{
							func_204(&iLocal_116);
						...
						if (!bVar0)
						{
							...
							while (bVar43)
							{
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_127) || !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_127, 1), 1.5f, 1.5f, 4f, 0, 1, 1))
								{
									Global_73828 = 1;
								}
					...
					else if ((((iLocal_116 != -1 && CONTROLS::IS_CONTROL_JUST_PRESSED(2, 52)) && !AI::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID())) && func_179()) && func_176())
					{
						if (iLocal_116 != -1)
						{
							func_204(&iLocal_116);
						...
						func_170();
						GAMEPLAY::SET_BIT(&(Global_1676377.f_4), 28);
						while (GAMEPLAY::IS_BIT_SET(Global_1676377.f_4, 28))
						{
							SYSTEM::WAIT(0);
						}
						func_3();
...
void func_3()
{
	if (!PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1) && ENTITY::DOES_ENTITY_EXIST(iLocal_127))
	{
			...
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				if (func_4(2, &sVar0))
				{
					if (iLocal_128 != 0)
					{
						...
						iLocal_129 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_133, ENTITY::GET_ENTITY_ROTATION(iLocal_127, 2), 2, 0, 0, 1065353216, 0, 1065353216);
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &sVar0, "exit", 8f, -4f, 5, 0, 1148846080, 0);
...
int func_9()
{
	...
	if (func_10() != 0)
	{
		if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_10()) == 0)
		{
			return 1;
		}
	}
					...
					if (iVar0 == Global_7363[iVar1].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (Global_2460675)
							{
								if (iVar1 == 14)
								{
									func_40(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1].f_10), SYSTEM::TO_FLOAT(Global_21868), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
								}
							}
							Global_7925[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7363[iVar1].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_40(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1].f_10), SYSTEM::TO_FLOAT(Global_21873), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76622)
								{
									...
									func_40(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19486)
									...
									func_40(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7363[iVar1].f_10 == 57 && iVar1 == 23)
							{
								...
								func_40(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
							}
							else
							{
								func_40(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
							}
							Global_7925[iVar0] = 1;
						}
					}
...
int func_85()
{
	...
	while (iVar0 < 7)
	{
		if (Global_1628237[PLAYER::PLAYER_ID()].f_11.f_11[iVar0] == func_8())
		{
			StringCopy(&Var17, "", 64);
...
void func_92()
{
	...
	if ((!GAMEPLAY::IS_DURANGO_VERSION() && NETWORK::_0x595F028698072DD9(0, -1, 1)) || func_95())
	{
		func_94(28);
	}
	else
...
void func_112(bool bParam0, bool bParam1, int iParam2)
{
	...
	if (Global_1628237[PLAYER::PLAYER_ID()].f_11 != PLAYER::PLAYER_ID())
	{
		...
		unk_0x6BC0ACD0673ACEBE(func_63(), &uVar8, &uVar9);
		...
		if (iParam2 == 1)
		{
			unk_0x0B565B0AAE56A0E8(func_116(func_117()), func_115(func_117()), func_114(), func_113(), Global_1628237[PLAYER::PLAYER_ID()].f_11.f_451, 4, Global_1628237[PLAYER::PLAYER_ID()].f_11.f_489);
		}
	}
}
...
int func_151(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0][func_103(iParam1)];
...
int func_164(int iParam0)
{
	if (func_7(iParam0, 0, 1))
	{
		...
		iVar1 = ((iVar0 + func_165()) - NETWORK::_GET_POSIX_TIME());
		return iVar1;
	}
	return -1;
}
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_4(0, &sVar0))
		{
			while (!bVar19)
			{
				...
				if (!func_175(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Var16, 0.05f, 0) && !func_209(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_127), 5f))
				{
					if (!func_172(PLAYER::PLAYER_PED_ID(), 2106541073))
					{
						AI::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), Var16, 1f, 5000, ENTITY::GET_ENTITY_HEADING(iLocal_127), 0.25f);
					}
				}
				else
				{
				...
				GRAPHICS::DRAW_DEBUG_LINE(Var16, ENTITY::GET_ENTITY_COORDS(iLocal_127, 1), 0, 255, 0, 255);
...
void func_171(int iParam0)
{
	...
	switch (iLocal_128)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&sVar0))
			{
				if (AI::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 2106541073) == 7 && STREAMING::HAS_ANIM_DICT_LOADED(&sVar0))
				{
					...
					iLocal_129 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_133, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, 0, 0, 1065353216, 0, 1065353216);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &sVar0, "enter", 4f, -2f, 5, 0, 1148846080, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_129);
					STREAMING::REMOVE_ANIM_DICT(&sVar0);
					iLocal_128 = 1;
				}
		...
		case 1:
			...
			iVar50 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(iLocal_129);
			if (!iLocal_120)
			{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&sVar16) && (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar50) || PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar50) >= 0.96f))
			{
				...
				if ((((GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_136, "idle_a") && iVar51 == 0) || (GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_136, "idle_b") && iVar51 == 1)) || (GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_136, "idle_c") && iVar51 == 2)) || (GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_136, "idle_d") && iVar51 == 3))
				{
					iVar51++;
					if (iVar51 >= iVar49)
					{
				...
				iLocal_129 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_133, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, 0, 1, 1065353216, 0, 1065353216);
				switch (iVar51)
				{
					case 0:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &sVar16, "idle_a", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_129);
					...
					case 1:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &sVar16, "idle_b", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_129);
					...
					case 2:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &sVar16, "idle_c", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_129);
					...
					case 3:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &sVar16, "idle_d", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_129);
		...
		case 3:
			...
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_129) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar50))
			{
				...
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &sVar16, sVar48, 4f, -2f, 5, 0, 1148846080, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_129);
				iLocal_128 = 3;
				return;
			}
...
bool func_176()
{
	return GAMEPLAY::IS_BIT_SET(Global_1676377.f_461, 30);
}
...
int func_177()
{
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Global_1676377.f_461, 0) || GAMEPLAY::IS_BIT_SET(Global_1676377.f_461, 2))
		{
			return 1;
		}
	}
...
{
	if (func_207(Global_1590535[iParam0].f_274.f_28, -1) && !GAMEPLAY::IS_BIT_SET(Global_1590535[iParam0].f_274.f_26, 1))
	{
		return 1;
	}
	return 0;
...
int func_226()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_127))
	{
		if (ENTITY::GET_ENTITY_MODEL(iLocal_127) == 743064848 || func_236(PLAYER::PLAYER_ID()))
		{
			return 1;
		}
	}
