...
int func_190(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_198(PLAYER::PLAYER_PED_ID()) && func_198(iParam0->f_28[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_194(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_194(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
int func_195(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_178(2))
	{
		if (!func_145())
		{
			if (((func_198(PLAYER::PLAYER_PED_ID()) && func_198(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_194(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_193(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_191(&uVar0, cParam2, sParam3, 7, 0, 0);
...
int func_248(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_249(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
...
int func_249(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
...
void func_256(var uParam0, var uParam1, struct<3> Param2, float fParam3)
{
	func_257(uParam0);
...
void func_258(var uParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_259(uParam0);
