...
void func_187(int iParam0)
{
	...
	if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_97) >= 900)
	{
		if (func_198(iParam0->f_28[0]))
		{
			if (!func_145())
...
{
	if ((((func_198(PLAYER::PLAYER_PED_ID()) && func_198(iParam0->f_28[0])) && !func_145()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_194(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_195(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	if (func_178(2))
	{
		if (!func_145())
		{
			if (((func_198(PLAYER::PLAYER_PED_ID()) && func_198(iParam0->f_28[0])) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_194(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_193(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_191(&uVar0, cParam4, sParam5, 7, 0, 0);
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_210(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_210(uParam1) && uParam1->f_4 == 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				...
				GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Var8, &(Var8.f_2), 0, 0);
...
void func_274(int iParam0, bool bParam1)
{
	...
	if (UI::DOES_BLIP_EXIST(uLocal_98))
	{
		UI::REMOVE_BLIP(&uLocal_98);
	}
