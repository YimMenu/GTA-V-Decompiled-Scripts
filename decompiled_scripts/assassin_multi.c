...
void func_145()
{
	...
	if (!iLocal_139)
	{
		func_151(&uLocal_150, &Local_727, &Global_61732, 0);
...
{
	func_306(&Global_105407, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_313(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2588062[iParam0 /*3*/][func_65(iParam1)];
...
int func_376(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_19865)
	{
		if (Global_19681.f_1 == 6)
		{
			...
			func_378(1);
			func_380(Global_19662, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19661), -1082130432, -1082130432, -1082130432);
		}
	}
...
{
	return func_418(&(Global_105407.f_2890), Param0, fParam3, 0);
}
...
void func_475(var uParam0)
{
	...
	switch (iLocal_1464)
	{
		case 0:
			...
			if (bLocal_1535)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_1465))
				{
					...
					iLocal_1506 = STREAMING::FORMAT_FOCUS_HEADING(-700.1226f, -916.8699f, 18.1667f, 350f, 12, 127);
		...
		case 3:
			...
			if (STREAMING::_0x07C313F94746702C(iLocal_1506))
			{
				STREAMING::_0x1EE7D8DF4425F053(iLocal_1506);
			}
