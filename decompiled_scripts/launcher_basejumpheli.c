		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_85) && !ENTITY::IS_ENTITY_DEAD(iLocal_85, 0))
		{
			...
			switch (iLocal_95)
			{
				...
				case 6:
					...
					if (func_159(uLocal_94, 2097152))
					{
						if (!func_137(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_52))
						{
							func_152(10);
						}
					}
...
void func_16(var uParam0, int iParam1)
{
	if (CAM::DOES_CAM_EXIST(*uParam0) && CAM::IS_CAM_ACTIVE(*uParam0))
	{
		...
		fVar9 = MISC::ATAN2((Var3.z - Var6.z), MISC::GET_DISTANCE_BETWEEN_COORDS(Var3, Var6, 0));
		if (fVar9 > Var0.x)
		{
...
void func_51()
{
	...
	uVar11 = func_110(func_111(iLocal_121) == -1660661558, 0.45f, 0.3f);
	...
	if (func_107(Local_287.f_3, Local_287, 1, 1, 1, 1, 0) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_287.f_3) && !PED::IS_PED_INJURED(Local_287.f_3))
		{
			...
			{
				TASK::TASK_VEHICLE_MISSION_COORS_TARGET(Local_287.f_3, Local_287, ENTITY::GET_ENTITY_COORDS(Local_287, 1) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_287) + Vector(500f, 0f, 0f), 4, VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(Local_287), 262144, 50f, 50f, 1);
			}
			else
			{
	...
	fVar10 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_106(iLocal_121));
	if (fVar10 < 11664f)
	{
		if (!iLocal_460)
		{
	...
	if (fVar10 < 10000f)
	{
		...
		{
			if ((STREAMING::HAS_MODEL_LOADED(func_105(iLocal_121)) && ENTITY::DOES_ENTITY_EXIST(Local_287)) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_287, 0))
			{
				Local_287.f_3 = PED::CREATE_PED_INSIDE_VEHICLE(Local_287, 4, func_105(iLocal_121), -1, 1, 1);
				...
				VEHICLE::SET_HELI_BLADES_SPEED(Local_287, uVar11);
			}
		}
		else
		{
	...
	func_16(&uLocal_461, Local_287);
	if ((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_287, 1) && !PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())) && func_76(Local_287.f_3, Local_287))
	{
		Var7 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_287, PED::GET_PED_BONE_COORDS(PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f)) };
		if (Var7.x < 0f || Var7.y < 1f)
		{
			...
			if (!CAM::DOES_CAM_EXIST(uLocal_461))
			{
				func_65(0, 0, 1);
				func_58(1);
				uLocal_461 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, func_57(iLocal_121), func_56(iLocal_121), func_55(iLocal_121), 0, 2);
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_287, 0))
			{
				...
				if (iVar0 != 0 && iVar0 != 1)
				{
					...
					func_22(&uLocal_462);
					while (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_287, 0) && func_53(&uLocal_462) < 2f)
					{
						SYSTEM::WAIT(0);
					}
					func_9(&uLocal_462);
					...
					if (!ENTITY::IS_ENTITY_DEAD(Local_287.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(Local_287, 0))
					{
						...
						TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_287, ENTITY::GET_ENTITY_COORDS(Local_287, 1) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_287) + Vector(500f, 0f, 0f), 4, VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(Local_287), 262144, 50f, 50f, 1);
	...
	if (!bVar12)
	{
		if ((VEHICLE::IS_VEHICLE_DRIVEABLE(Local_287, 0) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_287, 1)) < 225f) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
		{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_110685) || Global_30770) || func_133()) || func_119(8, -1)) || func_132()) || func_131()) || func_130()) || func_121()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_134()) || Global_30770) || func_133()) || func_119(8, -1)) || func_130()) || func_132()) || func_131()) || func_121()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_110685) || Global_30770) || func_133()) || func_119(8, -1)) || func_130()) || func_132()) || func_131()) || func_121()) || Global_111638.f_7683.f_919[iVar0] == 5) || Global_41978 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_110685) || Global_30770) || func_133()) || func_119(8, -1)) || func_132()) || func_131()) || func_121()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_134()) || func_131()) || Global_110685) || Global_30770) || func_133()) || Global_42596) || func_119(8, -1)) || func_130()) || func_129()) || func_121()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_142(struct<3> Param0, float fParam3)
{
	...
	if (bVar1)
	{
		...
		if (iLocal_121 == 3)
		{
			Local_287 = VEHICLE::CREATE_VEHICLE(744705981, Param0, fParam3, 1, 1, 0);
			VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_287, 5);
		}
		else
		{
			Local_287 = VEHICLE::CREATE_VEHICLE(-1660661558, Param0, fParam3, 1, 1, 0);
			VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_287, 6);
		}
		iLocal_86 = Local_287;
		ENTITY::_SET_ENTITY_SOMETHING(iLocal_86, 1);
...
void func_147()
{
	if (iLocal_121 == 3)
	{
		func_148(&uLocal_119, 744705981);
	}
	else
	{
		func_148(&uLocal_119, -1660661558);
	}
}
