			...
			while (iVar0 < iLocal_51)
			{
				if (!PED::IS_PED_INJURED(iLocal_51[iVar0]))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
					{
						...
						{
							AI::TASK_ENTER_VEHICLE(iLocal_51[iVar0], iLocal_54, -1, func_248(iLocal_54), 1073741824, 1, 0);
						}
					}
					else
					{
	...
	while (true)
	{
			...
			switch (iLocal_510)
			{
						...
						if (func_161())
						{
							if ((iLocal_46 == 3 && !(CAM::IS_SPHERE_VISIBLE(Local_77, 3f) && func_160(PLAYER::PLAYER_PED_ID(), Local_77, 1) < 150f)) || iLocal_46 != 3)
							{
								if (iLocal_46 == 3)
								{
									...
									{
										GAMEPLAY::CLEAR_AREA(Local_77, 4f, 1, 0, 0, 0);
									}
									iLocal_48 = 4;
									bLocal_109 = true;
								}
				...
				case 2:
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_54) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						...
						else if (((!ENTITY::IS_ENTITY_OCCLUDED(iLocal_54) && iLocal_48 == 4) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_96, Local_99, fLocal_102, 0, 1, 0)) || func_158())
						{
							func_139(1);
						}
		...
		else
		{
			...
			if (!UI::DOES_BLIP_EXIST(uLocal_63))
			{
				...
				if (((!ENTITY::IS_ENTITY_DEAD(iLocal_54, 0) && bLocal_109) && !bLocal_111) && (!func_138(0) || (WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), 741814745, 0) && !func_138(1))))
				{
					switch (iLocal_134)
					{
						case 0:
						...
						case 2:
							if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_135) > 2000 && WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), 741814745, 0))
							{
...
int func_2()
{
	...
	if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && (((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && bLocal_114) && OBJECT::DOES_PICKUP_EXIST(uLocal_137)) || (!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && OBJECT::DOES_PICKUP_EXIST(uLocal_137)))) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_54, 1)) < 20f) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), OBJECT::GET_PICKUP_COORDS(uLocal_137)) < 20f)
	{
		...
		{
			if (ENTITY::GET_ENTITY_MODEL(iVar1) == 1581098148 || ENTITY::GET_ENTITY_MODEL(iVar1) == 368603149)
			{
				return 1;
			}
		}
...
void func_30(struct<3> Param0, bool bParam3)
{
	if (!bLocal_121 && !bLocal_111)
	{
		if (!bParam3)
		{
			if (bLocal_109)
			{
				Param0 = { OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, 0f, -3.3f, 0f), 1067030938, 1069547520) };
			}
			else
			{
				Param0 = { OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_51[iLocal_130], 0), 1067030938, 1069547520) };
			}
		}
		...
		if (bParam3)
		{
			uLocal_137 = OBJECT::CREATE_PICKUP_ROTATE(-562499202, Param0, ENTITY::GET_ENTITY_ROTATION(iLocal_56, 2), 0, uLocal_128, 2, 1, 0);
		}
		else
		{
			uLocal_137 = OBJECT::CREATE_PICKUP(-562499202, Param0, uLocal_138, uLocal_128, 1, 0);
		}
...
int func_32(var uParam0)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_33(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return uVar0;
}
...
void func_34()
{
	...
	switch (iLocal_49)
	{
		...
		case 1:
			if (VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 2) == 0f && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 3) == 0f)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
				{
					...
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_56, iLocal_54, 0, Local_81, Local_84, 0, 0, 0, 0, 2, 1);
					iLocal_49 = 2;
				}
			}
			break;
					...
					if (((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 2) > 0.25f) && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 3) > 0.25f) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
						{
							if (ENTITY::IS_ENTITY_ATTACHED(iLocal_56))
							{
								...
								ROPE::ACTIVATE_PHYSICS(iLocal_56);
								OBJECT::SET_ACTIVATE_OBJECT_PHYSICS_AS_SOON_AS_IT_IS_UNFROZEN(iLocal_56, 1);
								Local_477 = { ENTITY::GET_ENTITY_COORDS(iLocal_56, 1) - ENTITY::GET_ENTITY_COORDS(iLocal_54, 1) * Vector(1.5f, 1.5f, 1.5f) };
							...
							else if (GAMEPLAY::_0x7F8F6405F4777AF6(ENTITY::GET_ENTITY_COORDS(iLocal_56, 1), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, Local_470), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, Local_473), 0) >= 1f)
							{
								iLocal_49 = 3;
								iLocal_123[0] = 0;
								iLocal_123[1] = 0;
		...
		case 3:
			...
			{
				if (ENTITY::GET_ENTITY_SPEED(iLocal_56) == 0f && (GAMEPLAY::GET_GAME_TIMER() - iLocal_476) > 1000)
				{
...
int func_36()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_57) && ENTITY::IS_ENTITY_ATTACHED(iLocal_57))
	{
		if (!iLocal_466)
		{
			if (GAMEPLAY::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(iLocal_57, 1), 741814745, 0.25f, 0) || OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_57, 1), 0.3f, WEAPON::GET_WEAPONTYPE_MODEL(741814745), 0))
			{
				iLocal_466 = 1;
			}
		}
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iLocal_50)
		{
			case 0:
				...
				{
					if (func_27() < 30f && !PED::IS_PED_INJURED(Local_140[3]))
					{
		...
		if (!PED::IS_PED_INJURED(iLocal_51[iParam0]))
		{
			if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_56, iLocal_51[iParam0]))
			{
				...
				else
				{
					...
					AI::TASK_PLAY_ANIM(iLocal_51[iParam0], "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
			}
		}
	}
...
void func_77(int iParam0, bool bParam1)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		Var0 = { func_35(ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_54, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))) };
		fVar3 = ((ENTITY::GET_ENTITY_HEADING(iLocal_54) + GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(Var0.x, Var0.y)) + 45f);
		fVar4 = ((ENTITY::GET_ENTITY_HEADING(iLocal_54) + GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(Var0.x, Var0.y)) - 45f);
		Var5[0] = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_54, 1), fVar3, 0f, 4.5f, 0f) };
		Var5[1] = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_54, 1), fVar4, 0f, 4.5f, 0f) };
		func_78(&fVar3);
		func_78(&fVar4);
		...
		while (iVar12 < iLocal_51)
		{
			...
			{
				if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar12], 1), Var5[iVar12]) > 2f)
				{
					bVar13 = true;
				}
			}
		...
		if (bVar13)
		{
			...
			while (iVar12 < iLocal_51)
			{
				if ((((((!PED::IS_PED_INJURED(iLocal_51[iVar12]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar12], 1), Var5[iVar12]) > 2f) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_504[iVar12]) > 1000) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_51[iVar12], 0)) && !iLocal_481[iVar12]) && (iParam0 == -1 || iParam0 == iVar12))
				{
					if (bParam1)
					{
						if (func_72())
						{
							Local_501 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
						}
						AI::OPEN_SEQUENCE_TASK(&uVar14);
						if (func_72() || func_38(Local_501))
						{
							AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Var5[iVar12], PLAYER::PLAYER_PED_ID(), 2f, 0, 1056964608, 1082130432, 1, 0, 0, -957453492, 20000);
							AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
						}
						else
						{
							AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, Var5[iVar12], Local_501, 2f, 0, 1056964608, 1082130432, 1, 0, 0, -957453492);
							AI::TASK_AIM_GUN_AT_COORD(0, Local_501, -1, 1, 0);
						}
						AI::CLOSE_SEQUENCE_TASK(uVar14);
						AI::TASK_PERFORM_SEQUENCE(iLocal_51[iVar12], uVar14);
						AI::CLEAR_SEQUENCE_TASK(&uVar14);
					}
					iLocal_504[iVar12] = GAMEPLAY::GET_GAME_TIMER();
				}
				iVar12++;
			}
		}
		...
		switch (iLocal_50)
		{
			case 0:
				if (!bLocal_109)
				{
					...
					Local_491 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@security_van", "sec_case_into_van_panic", Local_485, Local_488, 0, 2) };
					if (((!PED::IS_PED_INJURED(iLocal_51[1]) && !ENTITY::IS_ENTITY_DEAD(iLocal_51[1], 0)) && !PED::IS_PED_INJURED(iLocal_51[0])) && !ENTITY::IS_ENTITY_DEAD(iLocal_51[0], 0))
					{
						...
						if (OBJECT::DOES_PICKUP_EXIST(uLocal_137))
						{
							if (bLocal_110)
							{
								AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, OBJECT::GET_PICKUP_COORDS(uLocal_137), 2f, -1, 0.25f, 0, 1193033728);
							}
							else
							{
								AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, OBJECT::GET_PICKUP_COORDS(uLocal_137), 1f, -1, 0.25f, 0, 1193033728);
							}
							iLocal_50++;
						}
						else
			...
			case 1:
				...
				{
					if ((GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), OBJECT::GET_PICKUP_COORDS(uLocal_137), 1) < 2f && !PED::IS_PED_RAGDOLL(iParam0)) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_136) > 3000)
					{
						if (WEAPON::IS_PED_ARMED(iParam0, 4))
						{
							WEAPON::SET_CURRENT_PED_WEAPON(iParam0, -1569615261, 1);
						}
						OBJECT::REMOVE_PICKUP(uLocal_137);
						func_85(iParam0);
						WEAPON::SET_CURRENT_PED_WEAPON(iParam0, -1569615261, 1);
			...
			case 2:
				if (!PED::IS_PED_INJURED(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
				{
					if (AI::GET_SCRIPT_TASK_STATUS(iParam0, 713668775) != 1)
					{
						if (bLocal_110)
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, Local_491, 2f, -1, 0.1f, 512, Local_488.z);
						}
						else
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, Local_491, 1f, -1, 0.1f, 512, Local_488.z);
						}
						iLocal_50++;
					}
				}
			...
			case 3:
				if (!PED::IS_PED_INJURED(iParam0))
				{
					...
					else
					{
						...
						{
							if (GAMEPLAY::ABSF((fVar0 - Local_488.z)) < 15f)
							{
								...
								if (bLocal_110)
								{
									AI::TASK_SYNCHRONIZED_SCENE(iParam0, iLocal_494, "random@security_van", "sec_case_into_van_panic", 4f, 4f, 3, 0, 4f, 0);
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_54, iLocal_494, "van_case_into_van_panic", "random@security_van", 4f, -1000f, 0, -1000f);
								}
								else
								{
									AI::TASK_SYNCHRONIZED_SCENE(iParam0, iLocal_494, "random@security_van", "sec_case_into_van_calm", 4f, -4f, 3, 0, 4f, 0);
					...
					if (!bLocal_109)
					{
						if ((ENTITY::DOES_ENTITY_EXIST(iLocal_56) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_56, iParam0)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_494) > fLocal_508)
						{
							if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_56, iLocal_54))
							{
								...
								ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_56, iLocal_54, 0, ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_54, ENTITY::GET_ENTITY_COORDS(iLocal_56, 1)), 90f, 0f, 0f, 0, 0, 0, 0, 2, 1);
							}
							bLocal_109 = true;
						}
					}
...
int func_80(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::DOES_ENTITY_EXIST(iLocal_54))
	{
		...
		Var7[0] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var1, Var4.f_1, 0f) };
		Var7[1] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var4, Var4.f_1, 0f) };
		Var7[2] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var4, Var1.f_1, 0f) };
		Var7[3] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var1, Var1.f_1, 0f) };
		fVar72 = -3.7f;
		fVar73 = 1.35f;
		Var20[0] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (-fVar73 - 0.25f), fVar72, 0f) };
		Var20[1] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (fVar73 + 0.25f), fVar72, 0f) };
		Var20[2] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (fVar73 - 0.25f), (fVar72 - 1.55f), 0f) };
		Var20[3] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (-fVar73 + 0.25f), (fVar72 - 1.55f), 0f) };
		Var33[0] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, -fVar73, 0.5f, 0f) };
		Var33[1] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (-fVar73 - 0.75f), 0.5f, 0f) };
		Var33[2] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (-fVar73 - 0.75f), 1.5f, 0f) };
		Var33[3] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, -fVar73, 1.5f, 0f) };
		Var46[0] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, fVar73, 0.5f, 0f) };
		Var46[1] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (fVar73 + 0.75f), 0.5f, 0f) };
		Var46[2] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (fVar73 + 0.75f), 1.5f, 0f) };
		Var46[3] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, fVar73, 1.5f, 0f) };
		if (!bLocal_109)
		{
...
void func_85(int iParam0)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
		{
			ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_56, iParam0, PED::GET_PED_BONE_INDEX(iParam0, 28422), Local_90, Local_93, 1, 0, 0, 0, 2, 1);
		}
	}
}
	...
	switch (iLocal_50)
	{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_89()))
				{
					if (!PED::IS_PED_INJURED(func_89()))
					{
						...
						{
							AI::TASK_ENTER_VEHICLE(func_89(), iLocal_54, 20000, -1, 2f, 1, 0);
						}
					}
				}
		...
		case 1:
			if (func_88())
			{
				...
				{
					AI::TASK_VEHICLE_MISSION_PED_TARGET(func_89(), iLocal_54, PLAYER::PLAYER_PED_ID(), 8, 50f, 786484, 100f, 5f, 1);
					iLocal_50++;
				}
			}
			break;
		...
		case 2:
			if (func_87())
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_89()))
				{
					AI::TASK_VEHICLE_MISSION(func_89(), iLocal_54, 0, 5, 0f, 786484, 100f, 100f, 1);
					iLocal_50++;
				}
			}
			break;
...
void func_95(int iParam0)
{
	if (!PED::IS_PED_INJURED(iLocal_51[iParam0]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (iLocal_131 == 0)
		{
			iLocal_131 = DECISIONEVENT::ADD_SHOCKING_EVENT_AT_POSITION(118, ENTITY::GET_ENTITY_COORDS(iLocal_51[iParam0], 1), -1082130432);
		}
	}
}
...
int func_112(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_118() || func_117(Global_4456448.f_232883)) || func_116())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_114(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
{
	GAMEPLAY::SET_BIT(&(Global_111638.f_24990.f_6), iParam0);
}
...
{
	return GAMEPLAY::IS_BIT_SET(Global_111638.f_24990.f_6, iParam0);
}
				...
				if (!PED::IS_PED_INJURED(iLocal_51[0]) && !PED::IS_PED_INJURED(iLocal_51[1]))
				{
					...
					if (PED::IS_PED_IN_VEHICLE(iLocal_51[0], iLocal_54, 0) && PED::IS_PED_IN_VEHICLE(iLocal_51[1], iLocal_54, 0))
					{
						if (iLocal_47 == 2)
						{
							...
							AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_54, -574.6195f, -847.232f, 25.2925f, 10f, 0, 1747439474, 786603, 2f, 4f);
						...
						{
							AI::OPEN_SEQUENCE_TASK(&uVar1);
							AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_54, -551.2968f, -1119.418f, 20.4011f, 10f, 0, 1747439474, 786603, 2f, 4f);
							AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_54, 10f, 786603);
							AI::CLOSE_SEQUENCE_TASK(uVar1);
						...
						{
							AI::OPEN_SEQUENCE_TASK(&uVar2);
							AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_54, 2786.752f, 4358.032f, 48.6794f, 10f, 0, 1747439474, 786603, 2f, 4f);
							AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_54, 10f, 786603);
							AI::CLOSE_SEQUENCE_TASK(uVar2);
...
int func_149()
{
	...
	{
		Var0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - ENTITY::GET_ENTITY_COORDS(iLocal_54, 1) };
		Var3 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_54) };
		Var6 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_54, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) };
		if (((Var6.y > 1f && (((PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_54) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_54)) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_51[0])) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_51[1]))) && GAMEPLAY::ABSF(GAMEPLAY::GET_ANGLE_BETWEEN_2D_VECTORS(Var3.x, Var3.y, Var0.x, Var0.y)) < 60f) && GAMEPLAY::GET_ANGLE_BETWEEN_2D_VECTORS(Var3.z, Var3.y, Var0.z, Var0.y) < 30f)
		{
			return 1;
		}
	}
	...
	if ((!PED::IS_PED_INJURED(iLocal_51[0]) && !PED::IS_PED_INJURED(iLocal_51[1])) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
	{
		switch (iLocal_50)
		{
			case 0:
				Local_485 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_54, 0) };
				Local_488 = { ENTITY::GET_ENTITY_ROTATION(iLocal_54, 2) };
				Local_491 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@security_van", "sec_case_into_van_calm", Local_485, Local_488, 0, 2) };
				bLocal_496 = false;
				iLocal_497 = 0;
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_54, 1084227584);
				AI::OPEN_SEQUENCE_TASK(&uLocal_58);
				AI::TASK_STAND_STILL(0, 5000);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_491, 1f, -1, 0.1f, 512, Local_488.z);
				AI::TASK_ACHIEVE_HEADING(0, Local_488.z, 0);
				AI::CLOSE_SEQUENCE_TASK(uLocal_58);
			...
			case 1:
				...
				if (GAMEPLAY::ABSF((fVar0 - Local_488.z)) < 15f && SYSTEM::VDIST(Local_491, ENTITY::GET_ENTITY_COORDS(iLocal_51[1], 1)) < 0.2f)
				{
		...
		if (iLocal_48 != 4)
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_51[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_51[0], "random@security_van", "driver_idle", 3))
				{
					if (iLocal_47 != 2)
					{
						AI::TASK_PLAY_ANIM_ADVANCED(iLocal_51[0], "random@security_van", "driver_exit_panic", Local_485, Local_488, 1000f, -8f, -1, 4096, 0f, 2, 0);
					}
					else
					{
						AI::CLEAR_PED_TASKS(iLocal_51[0]);
...
int func_156()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 7) || (iVar0 == 883325847 && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())))
		{
...
int func_158()
{
	...
	while (iVar0 < iLocal_51)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_51[iVar0]))
		{
			...
			{
				if ((GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar0], 1), 5f, 1) || func_37(ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar0], 1) + Vector(5f, 10f, 10f), ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar0], 1) - Vector(5f, 5f, 5f), 0f, 0f, 0f, 0, 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_51[iVar0], PLAYER::PLAYER_PED_ID(), 1))
				{
					bLocal_110 = true;
					return 1;
				}
...
void func_159()
{
	...
	iLocal_57 = OBJECT::CREATE_OBJECT(-1249748547, Local_77, 1, 1, 0);
	...
	PATHFIND::_0x07FB139B592FA687((Local_77.x - 200f), (Local_77.y - 200f), (Local_77.x + 200f), (Local_77.y + 200f));
	if (iLocal_46 == 3)
	{
	...
	{
		iLocal_51[1] = PED::CREATE_PED(26, iLocal_103, Local_67[1], fLocal_74[1], 1, 1);
		iLocal_51[0] = PED::CREATE_PED(26, iLocal_103, Local_67[0], fLocal_74[0], 1, 1);
	...
	while (iVar0 < iLocal_51)
	{
		...
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_51[iVar0], 453432689, -1, 0, 1);
...
int func_183()
{
	if ((Global_111627 == func_65() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_111628)
	{
		return 1;
	}
	return 0;
...
void func_187()
{
	...
	switch (iLocal_47)
	{
		case 1:
			...
			fLocal_80 = -64.3539f;
			Local_67[0] = { -335.564f, -1462.237f, 29.5452f };
			fLocal_74[0] = 158.3857f;
			Local_67[1] = { -342.7024f, -1475.043f, 29.6004f };
		...
		case 2:
			...
			fLocal_80 = -89.02679f;
			Local_67[0] = { -589.4673f, -865.4055f, 24.7622f };
			fLocal_74[0] = 12.5464f;
			Local_67[1] = { -578.4414f, -874.5964f, 24.9183f };
		...
		case 3:
			...
			fLocal_80 = 188.9862f;
			Local_67[0] = { -398.4612f, 6051.296f, 30.5003f };
			fLocal_74[0] = 251.7138f;
			Local_67[1] = { -378.408f, 6035.689f, 30.498f };
		...
		case 4:
			...
			fLocal_80 = 263.4662f;
			Local_67[0] = { -600.8182f, -1103.778f, 21.3292f };
			fLocal_74[0] = 338.8304f;
			Local_67[1] = { -595.3461f, -1096.054f, 21.1785f };
...
int func_207()
{
	...
	func_210(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_209(&uVar0, TIME::GET_CLOCK_MONTH());
	func_208(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_1()) || Global_110685) || Global_30770) || func_223()) || func_24(8, -1)) || func_222()) || func_221()) || func_220()) || func_219()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_1()) || Global_30770) || func_223()) || func_24(8, -1)) || func_220()) || func_222()) || func_221()) || func_219()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_1()) || Global_110685) || Global_30770) || func_223()) || func_24(8, -1)) || func_222()) || func_221()) || func_219()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_1()) || Global_30770) || func_223()) || func_24(8, -1)) || func_221()) || func_220()) || func_219()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_1()) || func_221()) || Global_110685) || Global_30770) || func_223()) || Global_42596) || func_24(8, -1)) || func_220()) || func_218()) || func_219()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_1()) || Global_110685) || Global_30770) || func_223()) || func_24(8, -1)) || func_220()) || func_218()) || func_222()) || func_221()) || func_219())
						{
							return 0;
						}
						break;
