...
void func_265(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
void func_273()
{
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
	{
		if (func_440(Local_386.f_28[0]))
		{
			...
			TASK::TASK_PERFORM_SEQUENCE(Local_386.f_28[0], iLocal_389);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_389);
			PED::FORCE_PED_MOTION_STATE(Local_386.f_28[0], 247561816, false, 1, false);
		}
	}
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_standing_idle", 0))
	{
		if (func_440(Local_386.f_28[1]))
		{
			PED::FORCE_PED_MOTION_STATE(Local_386.f_28[1], 1063765679, false, 1, false);
			TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_with_notepad", 0))
	{
		if (func_440(Local_386.f_28[2]))
		{
			PED::FORCE_PED_MOTION_STATE(Local_386.f_28[2], 1063765679, false, 1, false);
			TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1026, 2);
...
int func_330(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
...
int func_409(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_411(iParam0, uVar1[iVar3], 1) && func_410(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_405(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
