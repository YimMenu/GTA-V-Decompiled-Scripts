...
void func_273()
{
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_standing_idle", 0))
	{
		if (func_440(Local_443.f_28[1]))
		{
			PED::FORCE_PED_MOTION_STATE(Local_443.f_28[1], 1063765679, false, 1, false);
			TASK::OPEN_SEQUENCE_TASK(&iLocal_506);
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_with_notepad", 0))
	{
		if (func_440(Local_443.f_28[2]))
		{
			PED::FORCE_PED_MOTION_STATE(Local_443.f_28[2], 1063765679, false, 1, false);
			TASK::OPEN_SEQUENCE_TASK(&iLocal_506);
			TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1026, 2);
			TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1103.72f, 289.46f, 63.23f, PLAYER::PLAYER_PED_ID(), 1f, false, 0.1f, 4f, true, 0, true, -957453492, 20000);
			TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1106.08f, 288.55f, 63.31f, PLAYER::PLAYER_PED_ID(), 1f, false, 0.1f, 4f, true, 0, true, -957453492, 20000);
			TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, true);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_506);
...
{
	if (((!func_322(0) || Global_77517) || Global_77506 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77502)
...
void func_397(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96701[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96701[iVar0]) == func_398(iParam0, iParam1))
				{
