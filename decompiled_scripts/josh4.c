void __EntryFunction__()
{
	...
	iLocal_84 = 1581098148;
	iLocal_85 = 1912215274;
	iLocal_103 = 1;
	iLocal_104 = 1;
	...
	if (func_454())
	{
		...
		func_332(&iLocal_86, -1100.04f, 280.6f, 63.53f, 267.48f, 0, 0, 1, 1, 0, -1903012613, 0, 145, 1);
...
void func_1()
{
	...
	switch (iLocal_88)
	{
		case 0:
			...
			{
				AI::TASK_LOOK_AT_ENTITY(Local_443.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			}
			GAMEPLAY::_SET_UNK_MAP_FLAG(2);
			iLocal_511 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_88 = 1;
			break;
...
int func_70(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0][func_69(iParam1)];
...
void func_209()
{
	if (iLocal_528 == 0)
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1208.581f, 309.8494f, 80.69189f, -1041.645f, 319.5811f, 60.40263f, 178.5f, 0, 1, 0))
		{
			...
			iLocal_531 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_528++;
		}
	}
	else if (iLocal_528 == 1)
	{
		if (iLocal_102 != 0)
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_531) > 6000)
			{
				if (iLocal_102 == 3)
				{
	...
	switch (iLocal_102)
	{
		case 0:
			if (iLocal_101 == 3)
			{
				if (func_440(Local_443.f_28[0]))
				{
					AI::CLEAR_PED_TASKS(Local_443.f_28[0]);
					if (func_204(iLocal_508))
					{
						if (GAMEPLAY::IS_POSITION_OCCUPIED(-1138.421f, 298.0307f, 65.90032f, 4f, 0, 1, 0, 0, 0, iLocal_508, 0))
						{
							func_488("Back gate blocked");
							Local_110 = { -1130.35f, 307.92f, 65.19f };
							AI::OPEN_SEQUENCE_TASK(&uLocal_506);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_110, 2f, 20000, 1f, 1, 1193033728);
							...
							AI::CLOSE_SEQUENCE_TASK(uLocal_506);
							PED::SET_PED_KEEP_TASK(Local_443.f_28[0], 1);
							AI::TASK_PERFORM_SEQUENCE(Local_443.f_28[0], uLocal_506);
						}
						else
						{
							...
							if (func_204(iLocal_508))
							{
								AI::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_508, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
							}
							else
							{
								AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					...
					else
					{
						...
						if (func_204(iLocal_508))
						{
							AI::TASK_ENTER_VEHICLE(0, iLocal_508, 20000, -1, 1073741824, 1, 0);
							AI::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_508, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
						}
						else
						{
					...
					AI::CLEAR_SEQUENCE_TASK(&uLocal_506);
				}
				iLocal_532 = GAMEPLAY::GET_GAME_TIMER();
			...
			if (func_440(Local_443.f_28[0]))
			{
				...
				if (func_204(iLocal_508))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_443.f_28[0], iLocal_508, 1))
					{
						...
						{
							AI::CLEAR_PED_TASKS(Local_443.f_28[0]);
							AI::TASK_LEAVE_ANY_VEHICLE(Local_443.f_28[0], 0, 4416);
							AI::TASK_SMART_FLEE_PED(Local_443.f_28[0], PLAYER::PLAYER_PED_ID(), 510f, -1, 0, 0);
							func_234(&iLocal_508);
						}
					}
					if (func_440(PLAYER::PLAYER_PED_ID()))
				...
				if (func_440(PLAYER::PLAYER_PED_ID()) && func_440(Local_443.f_28[0]))
				{
					if (iLocal_529 < 3)
					{
						...
						{
							if (!func_206() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_532) > 8000)
							{
...
void func_237()
{
	switch (Local_89.f_11)
	{
		case 0:
			...
			while (iLocal_510 <= 4)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_534[iLocal_510], Local_534[iLocal_510].f_3, Local_534[iLocal_510].f_6, 0, 1, 2))
				{
					...
					Local_89 = { Local_570[iLocal_510] };
					Local_89.f_3 = Local_586[iLocal_510];
					Local_89.f_4 = Local_586[iLocal_510].f_1;
					Local_89.f_5 = Local_586[iLocal_510].f_2;
					Local_89.f_6 = Local_586[iLocal_510].f_3;
					switch (iLocal_510)
					{
						case 0:
							Local_89.f_9 = 0;
		...
		case 1:
			if (!ENTITY::DOES_ENTITY_EXIST(Local_89.f_7))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(Local_89.f_8, 453432689, -1, 0, 1);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_89.f_8, 1);
				AI::CLEAR_PED_TASKS(Local_89.f_8);
			...
			if (func_204(Local_89.f_7))
			{
				if (func_440(Local_89.f_8))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(Local_89.f_8, 0))
					{
						...
						VEHICLE::_0x1F2E4E06DEA8992B(Local_89.f_7, 1);
...
void func_239()
{
	switch (iLocal_101)
	{
		case 0:
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_511) > 4000)
			{
		...
		case 2:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_511) > 20000)
			{
				func_488("************************************** TIMEOUT - ARREST next frame");
				if (func_440(Local_443.f_28[1]))
				{
					AI::CLEAR_PED_TASKS(Local_443.f_28[1]);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_443.f_28[1], 0);
					AI::TASK_ARREST_PED(Local_443.f_28[1], PLAYER::PLAYER_PED_ID());
				}
				iLocal_101 = 4;
				iLocal_511 = GAMEPLAY::GET_GAME_TIMER();
			}
		...
		case 3:
			...
			if (!iLocal_518)
			{
				...
				while (iVar0 <= (Local_443.f_28 - 1))
				{
					if (func_440(Local_443.f_28[iVar0]))
					{
						AI::CLEAR_PED_TASKS(Local_443.f_28[iVar0]);
						...
						AI::CLOSE_SEQUENCE_TASK(uLocal_506);
						AI::TASK_PERFORM_SEQUENCE(Local_443.f_28[iVar0], uLocal_506);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_506);
					}
					iVar0++;
				}
				...
				iLocal_518 = 1;
				iLocal_530 = GAMEPLAY::GET_GAME_TIMER();
			}
			else
			{
				iVar1 = 1;
				...
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_530) > 15000)
				{
					iVar1 = 1;
					while (iVar1 <= (Local_443.f_28 - 1))
					{
...
bool func_243(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_244(&(Local_37[iVar4]), Var1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
void func_259()
{
	...
	else
	{
		...
		{
			case 0:
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_105) > 1000)
				{
					iLocal_103 = 1;
				}
				break;
			...
			case 1:
				if (!func_206() && !UI::IS_MESSAGE_BEING_DISPLAYED())
				{
					if (iLocal_104)
					{
						func_228(&uLocal_113, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_262()
{
	...
	if (CUTSCENE::_0xB56BBBCC2955D9CB())
	{
		if (func_440(Local_443.f_28[1]))
		{
			...
			CUTSCENE::_0x2A56C06EBEF2B0D9("Cop_standing_idle", Local_443.f_28[1], 0);
		}
		if (func_440(Local_443.f_28[2]))
		{
			func_488("Trying to set Cop 2 component variation (intro loop)");
			CUTSCENE::_0x2A56C06EBEF2B0D9("Cop_with_notepad", Local_443.f_28[2], 0);
		}
	}
	switch (iLocal_88)
	{
		case 0:
			if (!GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_83, ""))
			{
				if (iLocal_519 == 0)
				{
...
void func_273()
{
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
	{
		if (func_440(Local_443.f_28[0]))
		{
			...
			AI::TASK_PLAY_ANIM(0, "rcmjosh4", "josh_leadout_loop", 4f, -4f, -1, 262153, 0, 0, 0, 0);
			AI::CLOSE_SEQUENCE_TASK(uLocal_506);
			AI::TASK_PERFORM_SEQUENCE(Local_443.f_28[0], uLocal_506);
			AI::CLEAR_SEQUENCE_TASK(&uLocal_506);
			PED::FORCE_PED_MOTION_STATE(Local_443.f_28[0], 247561816, 0, 1, 0);
		}
	}
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_standing_idle", 0))
	{
		if (func_440(Local_443.f_28[1]))
		{
			PED::FORCE_PED_MOTION_STATE(Local_443.f_28[1], 1063765679, 0, 1, 0);
			AI::OPEN_SEQUENCE_TASK(&uLocal_506);
			AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1026, 2);
			AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
			AI::TASK_PLAY_ANIM(0, "combat@gestures@pistol@glances", "90", 8f, -1000f, -1, 262184, 0, 0, 0, 0);
			AI::CLOSE_SEQUENCE_TASK(uLocal_506);
			AI::TASK_PERFORM_SEQUENCE(Local_443.f_28[1], uLocal_506);
			AI::CLEAR_SEQUENCE_TASK(&uLocal_506);
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_with_notepad", 0))
	{
		if (func_440(Local_443.f_28[2]))
		{
			PED::FORCE_PED_MOTION_STATE(Local_443.f_28[2], 1063765679, 0, 1, 0);
			AI::OPEN_SEQUENCE_TASK(&uLocal_506);
			AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1026, 2);
			AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1103.72f, 289.46f, 63.23f, PLAYER::PLAYER_PED_ID(), 1f, 0, 0.1f, 1082130432, 1, 0, 1, -957453492, 20000);
			AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1106.08f, 288.55f, 63.31f, PLAYER::PLAYER_PED_ID(), 1f, 0, 0.1f, 1082130432, 1, 0, 1, -957453492, 20000);
			AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
			AI::CLOSE_SEQUENCE_TASK(uLocal_506);
			AI::TASK_PERFORM_SEQUENCE(Local_443.f_28[2], uLocal_506);
			AI::CLEAR_SEQUENCE_TASK(&uLocal_506);
...
void func_275(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_277(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_285(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_286(Var18[0], Var18[1], Var6, Var9) || func_286(Var18[0], Var18[1], Var9, Var15)) || func_286(Var18[0], Var18[1], Var12, Var15)) || func_286(Var18[0], Var18[1], Var6, Var12)) || func_286(Var18[1], Var18[3], Var6, Var9)) || func_286(Var18[1], Var18[3], Var9, Var15)) || func_286(Var18[1], Var18[3], Var12, Var15)) || func_286(Var18[1], Var18[3], Var6, Var12)) || func_286(Var18[3], Var18[2], Var6, Var9)) || func_286(Var18[3], Var18[2], Var9, Var15)) || func_286(Var18[3], Var18[2], Var12, Var15)) || func_286(Var18[3], Var18[2], Var6, Var12)) || func_286(Var18[2], Var18[0], Var6, Var9)) || func_286(Var18[2], Var18[0], Var9, Var15)) || func_286(Var18[2], Var18[0], Var12, Var15)) || func_286(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
void func_289()
{
	...
	if (func_440(Local_443.f_28[1]))
	{
		iLocal_504 = WEAPON::CREATE_WEAPON_OBJECT(453432689, -1, ENTITY::GET_ENTITY_COORDS(Local_443.f_28[1], 1), 1, 1065353216, 0, 0, 1);
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_443.f_28[1], "Cop_standing_idle", 0, 0, 0);
		func_488("*** Registered Cop standing");
	}
	if (func_440(Local_443.f_28[2]))
	{
		iLocal_505 = WEAPON::CREATE_WEAPON_OBJECT(453432689, -1, ENTITY::GET_ENTITY_COORDS(Local_443.f_28[2], 1), 1, 1065353216, 0, 0, 1);
...
void func_297(int iParam0)
{
	...
	if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1138.32f, 299.69f, 65.94f, 5f, 546378757, 0))
	{
		OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(546378757, -1138.32f, 299.69f, 65.94f, 0, 0f, 0);
	}
	if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1137.52f, 297.02f, 65.81f, 5f, -1249591818, 0))
	{
		OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(-1249591818, -1137.054f, 295.5856f, 67.18046f, 0, 0f, 0);
	}
	if (func_440(Local_443.f_28[0]))
	{
		if (iParam0 == 1)
		{
			...
			AI::TASK_PLAY_ANIM(Local_443.f_28[0], "rcmjosh4", "josh_leadout_loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
		}
	...
	if (iParam0 == 1)
	{
		if (func_440(Local_443.f_28[2]))
		{
			WEAPON::GIVE_WEAPON_TO_PED(Local_443.f_28[2], 453432689, -1, 1, 1);
	...
	if (iParam0 == 1)
	{
		if (func_440(Local_443.f_28[1]))
		{
			WEAPON::GIVE_WEAPON_TO_PED(Local_443.f_28[1], 453432689, -1, 1, 1);
			...
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0))
			{
				if (func_440(PLAYER::PLAYER_PED_ID()) && func_264(Local_443.f_28[0]))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1105.571f, 290.008f, 62.87176f, -1100.577f, 290.4298f, 66.45212f, 4.5f, 0, 1, 0))
					{
						if (!func_300())
						{
							...
							{
								AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_443.f_28[0], 0);
							}
						}
						else
						{
				...
				if (!iLocal_519)
				{
					if (func_264(Local_443.f_28[0]))
					{
						...
						{
							AI::TASK_PLAY_ANIM(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 2f, -8f, -1, 2, 0, 0, 0, 0);
							func_488("Done Josh leadin anim");
							if (func_264(Local_443.f_28[2]))
							{
								AI::TASK_PLAY_ANIM(Local_443.f_28[2], "rcmjosh4", "josh_4_leadin_cop_a", 8f, -8f, -1, 2, 0, 0, 0, 0);
								func_488("Done Notepad cop leadin anim");
							}
							if (func_264(Local_443.f_28[1]))
							{
								AI::TASK_PLAY_ANIM(Local_443.f_28[1], "rcmjosh4", "josh_4_leadin_cop_b", 8f, -8f, -1, 2, 0, 0, 0, 0);
...
int func_329(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		ENTITY::CREATE_FORCED_OBJECT(-1107.01f, 289.38f, 64.76f, 5f, 546378757, 0);
	...
	if (bParam1)
	{
		ENTITY::CREATE_FORCED_OBJECT(-1101.62f, 290.36f, 64.76f, 5f, -1249591818, 0);
		...
		if (Global_111638.f_2358.f_539.f_2407[0][iParam1] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[0][iParam1]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[0][iParam1], Param2, fParam5, 0, 0, 0);
				...
				func_391(iParam0, &(Global_111638.f_2358.f_539.f_2407[0][iParam1].f_31), &(Global_111638.f_2358.f_539.f_2407[0][iParam1].f_81));
		...
		else if (Global_111638.f_2358.f_539.f_2407[1][iParam1] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[1][iParam1]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[1][iParam1], Param2, fParam5, 0, 0, 0);
				...
				func_391(iParam0, &(Global_111638.f_2358.f_539.f_2407[1][iParam1].f_31), &(Global_111638.f_2358.f_539.f_2407[1][iParam1].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == -1435919434)
...
void func_334(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	if ((func_152(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_338(iParam1, &(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_31), &(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_81));
			if (bParam3)
			{
				...
				Global_111638.f_20113[iParam0].f_31 = func_337(*iParam1);
				...
				func_335(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_5, Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_7, iVar3, 1, &(Global_111638.f_20113[iParam0].f_1));
				...
				func_335(Global_111638.f_2358.f_539.f_2407[iParam2][iParam0].f_6, -1, iVar3, 0, &(Global_111638.f_20113[iParam0].f_2));
			}
		}
	}
}
...
int func_339(int iParam0, bool bParam1, var uParam2)
{
	*uParam2 = 0;
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_340(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != 873639469) && ENTITY::GET_ENTITY_MODEL(iParam0) != -1177863319)
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_341(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			...
			{
				return func_342(Global_2425662[iParam0].f_310.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_346(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_342(Global_2425662[iParam0].f_310.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_347(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_342(Global_2425662[iParam0].f_310.f_5) == 7;
			}
		}
	}
	return 0;
...
int func_364(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1 && Global_2425662[iParam0].f_310.f_8 != func_217())
			{
				return func_342(Global_2425662[iParam0].f_310.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_365(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1 && Global_2425662[iParam0].f_310.f_8 != func_217())
			{
				return func_342(Global_2425662[iParam0].f_310.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_366(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0].f_310.f_5 != -1)
			{
				return func_342(Global_2425662[iParam0].f_310.f_5) == 9;
			}
		}
	}
	return 0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_371(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_283(iParam0, 0, 0)) || func_283(iParam0, 1, 0)) || func_283(iParam0, 2, 0)) || func_387(iParam0) != 145) || func_386(iParam0)) || func_385(iParam0)) || func_340(iParam0)) || func_384(iParam0)) || !func_374(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_385(iParam0))
		{
		}
...
int func_391(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_363(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_394(*uParam0, ((*uParam1)[38] - 1)))
	{
...
void func_399(struct<3> Param0, float fParam3, int iParam4)
{
	...
	while (iVar0 < 68)
	{
		if (func_404(&(Global_75441.f_555[0]), iVar0))
		{
...
void func_400(int iParam0)
{
	...
	if (func_404(&(Global_75441.f_555[0]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_181(iParam0, 0)) && Global_76350.f_66 == 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0].f_14] != 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0].f_14] > 3) && (!func_402(0, Global_75441.f_555[0].f_12) || !func_402(1, Global_75441.f_555[0].f_12)))
			{
				func_401(&(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]), &Global_76350);
...
int func_402(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_403(&(Global_111638.f_32744.f_5038[iVar0])))
	{
		return 0;
	}
	return func_375(Global_111638.f_32744.f_5038[iVar0][iParam0].f_66, 0);
}
...
int func_404(var uParam0, int iParam1)
{
	*uParam0 = { 0f, 0f, 0f };
	...
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_405(Global_111638.f_32744.f_1864[uParam0->f_14], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_405(Global_111638.f_2358.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_405(Global_111638.f_2358.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	if (func_424(uParam0))
	{
		...
		if (func_423(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_409(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_409(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_411(iParam0, uVar1[iVar6], 1) && func_410(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_405(Param1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_412(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_371(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_371(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_371(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == 340154634 || uParam1->f_66 == -1960756985)
		{
			...
			while (iVar2 <= 9)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_371(iVar2)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_371(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_371(iVar3)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_371(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_371(iVar4)))
					{
					}
					else
					{
						GAMEPLAY::SET_BIT(&(uParam1->f_77), func_371(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_415(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_414())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_371(iVar5 + 1)))
				{
...
int func_424(var uParam0)
{
	...
	if (uParam0->f_12.f_66 == -2122757008 && func_410(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
		...
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1] = { func_434(iParam0) };
					...
					{
						Global_7966[1] = { func_434(iParam0) };
...
void func_439()
{
	...
	Local_89.f_11 = 0;
	Local_534[0] = { -1152.526f, 278.2318f, 65.69334f };
	Local_534[0].f_3 = { -1136.277f, 239.0551f, 69.44059f };
	Local_534[0].f_6 = 3.25f;
	Local_534[1] = { -1151.918f, 287.2276f, 66.04018f };
	Local_534[1].f_3 = { -1137.051f, 290.5453f, 70.0429f };
	Local_534[1].f_6 = 3.25f;
	Local_534[2] = { -1093.003f, 295.5289f, 63.11537f };
	Local_534[2].f_3 = { -1069.194f, 293.5286f, 67.53568f };
	Local_534[2].f_6 = 3.25f;
	Local_534[3] = { -1050.776f, 284.3935f, 63.15669f };
	Local_534[3].f_3 = { -1050.369f, 244.0945f, 67.86394f };
	Local_534[3].f_6 = 3.25f;
	Local_534[4] = { -1065.411f, 229.6216f, 61.88657f };
	Local_534[4].f_3 = { -1104.021f, 232.1321f, 68.14975f };
	Local_534[4].f_6 = 3.25f;
	Local_570[0] = { -1357.57f, 200.1279f, 58.075f };
	Local_586[0] = 0.0072f;
	Local_586[0].f_1 = 0.0163f;
	Local_586[0].f_2 = -0.5901f;
	Local_586[0].f_3 = 0.8071f;
	Local_570[1] = { -1219.035f, 401.5473f, 74.713f };
	Local_586[1] = -0.0145f;
	Local_586[1].f_1 = 0.0329f;
	Local_586[1].f_2 = -0.6893f;
	Local_586[1].f_3 = 0.7235f;
	Local_570[2] = { -1113.06f, 397.6948f, 69.1133f };
	Local_586[2] = -0.0155f;
	Local_586[2].f_1 = -0.04f;
	Local_586[2].f_2 = 0.7661f;
	Local_586[2].f_3 = -0.6413f;
	Local_570[3] = { -885.071f, 240.0283f, 71.7539f };
	Local_586[3] = -0.0576f;
	Local_586[3].f_1 = 0f;
	Local_586[3].f_2 = 0.5936f;
	Local_586[3].f_3 = 0.8027f;
	Local_570[4] = { -1020.495f, 121.0783f, 53.0567f };
	Local_586[4] = 0.0234f;
	Local_586[4].f_1 = 0.0126f;
	Local_586[4].f_2 = 0.2792f;
	Local_586[4].f_3 = 0.9599f;
...
int func_442(var uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				...
				if (func_440(uParam0->f_28[1]))
				{
					...
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_28[1], 453432689, -1, 0, 1);
					if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh4"))
					{
						AI::CLEAR_PED_TASKS(uParam0->f_28[1]);
						AI::TASK_PLAY_ANIM(uParam0->f_28[1], "rcmjosh4", "BECKON_A_COP_B", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
				else
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[2]))
			{
				...
				if (func_440(uParam0->f_28[2]))
				{
					...
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_28[2], 453432689, -1, 0, 1);
					if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh4"))
					{
						AI::CLEAR_PED_TASKS(uParam0->f_28[2]);
						AI::TASK_PLAY_ANIM(uParam0->f_28[2], "rcmjosh4", "BECKON_A_COP_A", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
				else
				{
		...
		case 3:
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1138.32f, 299.69f, 65.94f, 5f, 546378757, 0))
			{
				OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(546378757, -1138.32f, 299.69f, 65.94f, 1, 0f, 0);
			}
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1137.52f, 297.02f, 65.81f, 5f, -1249591818, 0))
			{
				OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(-1249591818, -1137.054f, 295.5856f, 67.18046f, 1, 0f, 0);
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
			{
...
void func_443(var uParam0, bool bParam1)
{
	...
	VEHICLE::_0x2B6747FAA9DB9D6B(*uParam0, 1);
}
