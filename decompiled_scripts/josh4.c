...
float func_208(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
	...
	switch (iLocal_49)
	{
		...
		case 1:
			if (func_440(Local_386.f_28[0]))
			{
				...
				if (func_440(PLAYER::PLAYER_PED_ID()) && func_440(Local_386.f_28[0]))
				{
					if (iLocal_410 < 3)
					{
...
void func_273()
{
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
	{
		if (func_440(Local_386.f_28[0]))
		{
			...
			TASK::TASK_PERFORM_SEQUENCE(Local_386.f_28[0], uLocal_389);
			TASK::CLEAR_SEQUENCE_TASK(&uLocal_389);
			PED::FORCE_PED_MOTION_STATE(Local_386.f_28[0], 247561816, 0, 1, 0);
		}
	}
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_standing_idle", 0))
	{
		if (func_440(Local_386.f_28[1]))
		{
			PED::FORCE_PED_MOTION_STATE(Local_386.f_28[1], 1063765679, 0, 1, 0);
			TASK::OPEN_SEQUENCE_TASK(&uLocal_389);
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_with_notepad", 0))
	{
		if (func_440(Local_386.f_28[2]))
		{
			PED::FORCE_PED_MOTION_STATE(Local_386.f_28[2], 1063765679, 0, 1, 0);
			TASK::OPEN_SEQUENCE_TASK(&uLocal_389);
			TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1026, 2);
...
void func_299()
{
	...
	switch (iLocal_46)
	{
		...
		case 1:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0))
			{
				if (func_440(PLAYER::PLAYER_PED_ID()) && func_264(Local_386.f_28[0]))
				{
				...
				{
					if ((func_440(PLAYER::PLAYER_PED_ID()) && func_264(Local_386.f_28[0])) && !func_300())
					{
						if (!func_293(PLAYER::PLAYER_PED_ID(), -875674219))
						{
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_386.f_28[0], 0);
	...
	if (Global_76876 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_311(Global_76877, Global_76879, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_325()
{
	...
	if (!func_331())
	{
		func_330(PLAYER::PLAYER_PED_ID(), Local_53, fLocal_54, 1, 1);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	}
	func_297(1);
...
void func_399(struct<3> Param0, float fParam1, int iParam2)
{
	int iVar0;
...
{
	return func_407(&(Global_105187.f_2890), Param0, fParam1, 0);
}
...
int func_409(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_411(iParam0, uVar1[iVar3], 1) && func_410(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_405(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_443(var uParam0, bool bParam1)
{
	...
	func_444(uParam0, iLocal_39, Var0, fVar1);
...
void func_445(var uParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_233(uParam0);
