					...
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
						switch (iLocal_47)
						{
							...
							case 3:
								...
								else if (HUD::DOES_BLIP_EXIST(uLocal_89[0]))
								{
									HUD::REMOVE_BLIP(&(uLocal_89[0]));
								}
								...
								else if (HUD::DOES_BLIP_EXIST(uLocal_89[1]))
								{
									HUD::REMOVE_BLIP(&(uLocal_89[1]));
								}
							...
							case 4:
								...
								if (bLocal_64)
								{
									if (!PED::IS_PED_INJURED(iLocal_58))
									{
										...
										else if (!HUD::DOES_BLIP_EXIST(uLocal_88))
										{
...
int func_46(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11511)
	{
		...
		uVar0 = Global_2548434[iParam0 /*3*/][func_43(iParam1)];
...
int func_172(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_208(Global_111638.f_24990.f_43[iParam1]))
		{
			return 0;
		}
