...
void __EntryFunction__()
{
	...
	while (iVar0 == 1)
	{
		...
		if (bLocal_331)
		{
			...
			StringIntConCat(&cVar13, Global_111583[iLocal_217], 64);
			...
			StringIntConCat(&cVar13, iLocal_221[Global_111583[iLocal_217]], 64);
			GRAPHICS::DRAW_DEBUG_TEXT_2D(&cVar13, 0.02f, 0.83f, 0f, 0, 0, 255, 255);
		}
		Var15 = { ENTITY::GET_ENTITY_COORDS(uLocal_208, 1) };
		if (((ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(uLocal_208) && !iLocal_216 == 25) && !iLocal_216 == 5) && !iLocal_216 == 6)
		{
			...
			AUDIO::_PLAY_AMBIENT_SPEECH1(uLocal_208, "GENERIC_CURSE_MED", "SPEECH_PARAMS_FORCE", 1);
		}
		...
		if (!bLocal_268)
		{
			...
			{
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(uLocal_208, 1)) < 16f)
				{
		...
		switch (iLocal_216)
		{
			...
			case 6:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_208, 713668775) != 1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_208, 713668775) != 0)
				{
					...
					PED::_0x2208438012482A1A(uLocal_208, 0, 0);
					func_121();
					iLocal_216 = 0;
				}
				break;
			...
			case 8:
				...
				else if (!func_66())
				{
					...
					if (iLocal_223 < iLocal_221[Global_111583[iLocal_217]] && iVar8)
					{
						func_67();
						iLocal_216 = 7;
					}
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_56(Global_111583[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_65();
				bVar37 = func_66();
				func_55(Global_111583[iLocal_217]);
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_330)
					{
						Global_111583[iLocal_217] = uLocal_329;
					}
					else
					{
						Global_111583[iLocal_217]++;
					}
					if (!Global_111583[iLocal_217] < iLocal_218)
					{
						Global_111583[iLocal_217] = 0;
					}
					func_104(0, 1);
					iLocal_216 = 0;
				}
...
void func_58()
{
	...
	func_61(Global_111583[iLocal_217] + 1, &sVar0, &Var1);
	...
	PED::_0x2208438012482A1A(uLocal_208, 0, 0);
	func_59(Global_111583[iLocal_217]);
}
...
int func_62()
{
	...
	Var0 = { Local_230 };
	StringIntConCat(&Var0, Global_111583[iLocal_217] + 1, 16);
	func_53(&uLocal_37, 3, uLocal_208, &Local_205, 0, 1);
	if (bLocal_266)
	{
		iVar1 = 1;
...
int func_66()
{
	if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_208, -2017877118) != 1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_208, -2017877118) != 0)
	{
		return 0;
	}
	return 1;
...
void func_70(char* sParam0)
{
	...
	StringIntConCat(sParam0, Global_111583[iLocal_217] + 1, 16);
}
...
int func_88(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_90(ENTITY::GET_ENTITY_COORDS(uParam1, 1) - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		Var1 = { func_90(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_107()
{
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_277, uLocal_208, PED::GET_PED_BONE_INDEX(uLocal_208, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	PED::SET_PED_PROP_INDEX(uLocal_208, 1, 0, 0, 0);
}
...
{
	return func_114(Global_111638.f_20112, uParam0);
}
