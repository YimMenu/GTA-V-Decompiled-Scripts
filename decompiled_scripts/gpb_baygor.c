void __EntryFunction__()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < Global_31031 + 10000 && !func_109())
	{
		func_116(0);
	}
	...
	while (iVar0 == 1)
	{
		...
		if (((func_111() || GAMEPLAY::GET_MISSION_FLAG()) || func_110()) || !func_112())
		{
			if (!func_92() && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-892862129) == 0)
			{
				if (func_111())
				{
				}
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if ((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_240)) && fVar43 < 25f) && func_91(PLAYER::PLAYER_PED_ID()) != -1569615261) && func_88(uLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984, 0))
			{
				if (!func_92())
				{
					func_94();
		...
		switch (iLocal_250)
		{
			...
			case 8:
				...
				else if (iLocal_440 == 1)
				{
					...
					{
						func_56(Global_111583[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_240, &Local_372, &Local_356));
					}
				}
				break;
		...
		if (((((((((((((iLocal_250 == 0 || iLocal_250 == 1) || iLocal_250 == 3) || iLocal_250 == 8) || iLocal_250 == 9) || iLocal_250 == 7) && func_87(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_436 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar30 == 0) && bLocal_439 == 1) && !Global_3) && func_7()) && bVar81)
		{
			...
			if (func_4(iLocal_298, 1))
			{
				...
				iLocal_250 = 13;
				iVar29 = 0;
				iVar82 = func_81(GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()));
				if (func_80(iVar82))
				{
					if (!func_79(iVar82))
					{
						func_71(GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()), 0);
					}
				}
				func_2(&iLocal_298);
			}
...
void func_34()
{
	iLocal_254 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, uLocal_253);
}
...
void func_58()
{
	func_61(Global_111583[iLocal_251] + 1, &sVar0, &Var8);
...
int func_85(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_86(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_86(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
int func_88(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	{
		Var3 = { func_90(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_107()
{
	uLocal_448 = OBJECT::CREATE_OBJECT(-2015467307, ENTITY::GET_ENTITY_COORDS(uLocal_240, 1), 1, 1, 0);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_448, uLocal_240, PED::GET_PED_BONE_INDEX(uLocal_240, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	PED::SET_PED_PROP_INDEX(uLocal_240, 1, 0, 0, 0);
}

void func_108()
{
	iLocal_36 = 1380197501;
