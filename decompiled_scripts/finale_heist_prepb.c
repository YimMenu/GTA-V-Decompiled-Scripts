...
void func_8(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_10(Global_111858.f_18529[iVar0], &Var2, &fVar5))
			{
...
{
	return func_39(&(Global_102423.f_2890), Param0, fParam3, 0);
}
...
{
	return func_105(Global_102423.f_2890.f_12.f_66, Param0, iParam3);
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102423.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102423.f_4, false))
		{
			if (func_169(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_166(ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_150(Global_102423.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
