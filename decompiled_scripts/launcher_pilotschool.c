			...
			switch (iLocal_59)
			{
				case 0:
					...
					else
					{
						...
						if ((Local_55.z - ScriptParam_88.f_1[0 /*3*/].f_2) > 500f)
						{
						}
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						if (!func_72(3) && !Global_98778)
						{
							...
							{
								if ((!func_86(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_71())) && !Global_98778)
								{
									func_79(10);
									break;
								}
				...
				case 6:
					...
					if (func_86(uLocal_58, 2097152))
					{
						if (!func_72(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_50))
						{
							func_79(10);
						}
					}
...
var func_26()
{
	...
	uVar0 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&Local_51, &uLocal_78, 4, iLocal_61);
