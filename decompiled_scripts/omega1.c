...
int func_36(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_76434[1 /*14*/] = { func_87(iVar0, iParam1, uVar6[iParam1], -1) };
...
int func_39(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76434[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1 /*14*/] = { func_87(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1 /*14*/] = { func_87(iVar10, 14, uVar15[iVar1], -1) };
			func_55(iParam0, Global_76434[1 /*14*/].f_12, Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4);
			func_70(14);
			if (Global_76432 == 1)
			{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar3 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar3, &Var2) && Var2.z != -1)
				{
					...
					{
						(*iParam0)[Var2.z] = func_62(iParam1, Var2.x, 14, iVar0);
					}
					else if (Var2.y != -1)
					{
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar4, &Var2))
			{
				if ((Var2.x != 0 && Var2.x != -1) && Var2.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_85(Var2.z)] = Var2.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_85(Var2.z)] = func_62(iParam1, Var2.x, func_85(Var2.z), iVar0);
					}
				}
				else if (Var2.y != -1)
				{
					(*uParam0)[func_85(Var2.z)] = Var2.y;
				}
			}
			iVar4++;
		}
...
void func_89(int iParam0)
{
	...
	func_90(&(Global_76434[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_97(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_90(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_90(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
void func_164(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&uVar1, {func_161(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar1, 0, Global_98781, 0);
		func_165(&uVar1, Var0.f_3, Global_98781, iParam1, iParam2);
	}
}
	...
	switch (iLocal_41)
	{
		...
		case 1:
			...
			if (CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				...
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_217, Local_39.f_28[0], PED::GET_PED_BONE_INDEX(Local_39.f_28[0], 64729), Local_218, Local_219, 0, 0, 0, 0, 2, 1);
				}
...
void func_275()
{
	...
	while (iVar0 < 16)
	{
		if (func_228(uVar1[iVar0]) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar1[iVar0], Local_225[0 /*3*/], Local_225[1 /*3*/], fLocal_226, 0, 1, 0))
		{
...
int func_318(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_319(uParam0, iParam1, Param2, fParam3, 1))
	{
...
int func_319(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
	...
	if (func_228(iParam0))
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, Local_225[0 /*3*/], Local_225[1 /*3*/], fLocal_226, 0, 1, 0))
		{
			...
			if (STREAMING::IS_MODEL_VALID(iVar3))
			{
				...
				else if (Var0[0 /*3*/].f_1 > Var1.y)
				{
					bVar2 = true;
				}
				else if (Var0[0 /*3*/].f_2 > Var1.z)
				{
					bVar2 = true;
				}
				if (bVar2)
...
void func_395(struct<3> Param0, float fParam1, int iParam2)
{
	int iVar0;
...
{
	return func_403(&(Global_105187.f_2890), Param0, fParam1, 0);
}
...
int func_405(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_407(iParam0, uVar1[iVar3], 1) && func_406(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_401(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
...
int func_450(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_456())
	{
		...
		{
			iVar2 = func_451(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
