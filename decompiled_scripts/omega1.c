				...
				if (func_228(Local_81.f_28[0]))
				{
					if (func_228(PLAYER::PLAYER_PED_ID()))
					{
						if (!iLocal_147)
						{
							...
							else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_330) > 7500)
							{
								if (!bLocal_145)
								{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_79(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_79(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_97(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_90(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_90(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_79(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_170()
{
	...
	{
		func_159();
		GRAPHICS::_0xBF59707B3E5ED531(func_171(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
...
int func_229()
{
	if (func_228(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			AI::TASK_SMART_FLEE_PED(Local_81.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			iLocal_144 = 3;
			func_251(5);
			return 0;
		}
	...
	if (func_229())
	{
		switch (iLocal_143)
		{
			case 0:
				if (func_228(Local_81.f_28[0]))
				{
					AI::TASK_PERFORM_SEQUENCE(Local_81.f_28[0], uLocal_326);
				}
			...
			case 1:
				if (func_228(Local_81.f_28[0]))
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_328) > 3000)
					{
						iLocal_143 = 2;
					}
				}
...
void func_287()
{
	...
	if (func_229())
	{
		if (GAMEPLAY::GET_GAME_TIMER() < iLocal_327 && !func_288(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 4f, 1))
		{
			...
			AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 2000, 0, 2);
		}
		else
		{
			func_253(2);
...
void func_297()
{
	...
	if (func_229())
	{
		if ((((STREAMING::HAS_ANIM_DICT_LOADED("rcmrc_omega_1leadinoutscrap_1_rcm") && STREAMING::HAS_ANIM_DICT_LOADED("rcmrc_omega_1")) && UI::HAS_ADDITIONAL_TEXT_LOADED(0)) && STREAMING::HAS_MODEL_LOADED(iLocal_317)) && STREAMING::HAS_MODEL_LOADED(iLocal_318))
		{
			AI::OPEN_SEQUENCE_TASK(&uLocal_326);
			AI::TASK_PLAY_ANIM(0, "rcmrc_omega_1leadinoutscrap_1_rcm", "leadout_scrap_1_rcm_omega", 8f, -8f, -1, 262144, 0, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, "rcmrc_omega_1", "omega_idle_geiger_counter", 8f, -8f, -1, 262145, 0, 0, 0, 0);
			AI::CLOSE_SEQUENCE_TASK(uLocal_326);
			if (func_228(Local_81.f_28[0]))
			{
			...
			iLocal_327 = GAMEPLAY::GET_GAME_TIMER() + 3500;
			func_253(1);
		}
	}
}
...
void func_325(int iParam0)
{
	...
	if (func_228(iParam0))
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, Local_331[0], Local_331[1], fLocal_338, 0, 1, 0))
		{
			...
			{
				GAMEPLAY::GET_MODEL_DIMENSIONS(iVar14, &(Var0[1]), &(Var0[2]));
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_367(iVar0 + 1));
			}
			iVar0++;
		}
	...
	if (func_420(uParam0))
	{
		...
		if (func_419(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_405(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_401(Param1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_408(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_367(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_367(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_367(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == 340154634 || uParam1->f_66 == -1960756985)
		{
			...
			while (iVar2 <= 9)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_367(iVar2)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_367(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_367(iVar3)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_367(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_367(iVar4)))
					{
					}
					else
					{
						GAMEPLAY::SET_BIT(&(uParam1->f_77), func_367(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_411(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_410())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_367(iVar5 + 1)))
				{
