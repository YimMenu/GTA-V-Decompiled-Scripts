...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_79(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_79(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_97(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_79(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_164(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_165(&sVar1, Var0.f_3, Global_98781, bParam1, bParam2);
	}
}
	...
	switch (iLocal_41)
	{
		...
		case 1:
			...
			if (CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				...
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_39.f_41[0], Local_39.f_28[0], PED::GET_PED_BONE_INDEX(Local_39.f_28[0], 18905), 0.09f, 0.072f, -0.006f, 298f, 194f, 178f, false, false, false, false, 2, true);
				}
				if (func_228(Local_39.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_217))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_217, Local_39.f_28[0], PED::GET_PED_BONE_INDEX(Local_39.f_28[0], 64729), Local_218, Local_219, false, false, false, false, 2, true);
				}
...
void func_260(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
void func_275()
{
	...
	while (iVar0 < 16)
	{
		if (func_228(uVar1[iVar0]) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar1[iVar0], Local_225[0 /*3*/], Local_225[1 /*3*/], fLocal_226, false, true, 0))
		{
...
int func_405(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_407(iParam0, uVar1[iVar3], 1) && func_406(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_401(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
