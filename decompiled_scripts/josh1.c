...
void func_1()
{
	switch (iLocal_145)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh1leadinout") && STREAMING::HAS_MODEL_LOADED(94130617))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_147))
				{
					if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, 546378757, 0))
					{
						OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(546378757, -1107.01f, 289.38f, 64.76f, 0, 0f, 0);
					}
					iLocal_147 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1107.01f, 289.38f, 64.76f, 5f, 546378757, 1, 0, 1);
				}
				iLocal_145 = 1;
			}
			break;
		...
		case 1:
			...
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_149))
			{
		...
		case 2:
			...
			if (func_293(Local_83.f_28[0]))
			{
				...
				if (iLocal_162 == 0)
				{
					PED::FORCE_PED_MOTION_STATE(Local_83.f_28[0], -668482597, 0, 0, 1);
				}
			}
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, 546378757, 0))
			{
		...
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1] = { func_208(iParam0) };
					...
					{
						Global_7966[1] = { func_208(iParam0) };
	...
	switch (iLocal_145)
	{
		case 0:
			if (func_260(1, 1093140480, 0))
			{
				...
				MISC::CLEAR_AREA_OF_VEHICLES(-1146.306f, 295.9831f, 66.13612f, 9f, 0, 0, 0, 0, 0, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(-1143.244f, 280.2762f, 65.41892f, 12f, 0, 0, 0, 0, 0, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(-1152.426f, 313.6157f, 67.10429f, 12f, 0, 0, 0, 0, 0, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(-1165.966f, 332.6786f, 68.81f, 12f, 0, 0, 0, 0, 0, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(-1178.729f, 346.4572f, 70.04675f, 12f, 0, 0, 0, 0, 0, 0);
				...
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, 546378757, 0))
				{
					...
					OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(546378757, -1107.01f, 289.38f, 64.76f, 1, 90f, 0);
				}
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!iLocal_160)
				{
					...
					if (func_294(Local_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147))
					{
						...
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_147);
						PED::FORCE_PED_MOTION_STATE(Local_83.f_28[0], -1871534317, 0, 1, 1);
						iLocal_160 = 1;
					}
				}
			}
			...
			if (CUTSCENE::WAS_CUTSCENE_SKIPPED())
			{
				...
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, 546378757, 0))
				{
					ENTITY::REMOVE_MODEL_HIDE(-1107.01f, 289.38f, 64.76f, 5f, 546378757, 0);
					OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(546378757, -1107.01f, 289.38f, 64.76f, 1, 0f, 0);
				}
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1101.62f, 290.36f, 64.76f, 5f, -1249591818, 0))
				{
					ENTITY::REMOVE_MODEL_HIDE(-1101.62f, 290.36f, 64.76f, 5f, -1249591818, 0);
					OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(-1249591818, -1101.62f, 290.36f, 64.76f, 1, 0f, 0);
				}
			}
			if (!CUTSCENE::IS_CUTSCENE_ACTIVE())
			{
				...
				if (!iLocal_160)
				{
					...
					if (func_294(Local_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147))
					{
						...
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_147);
						PED::_0x2208438012482A1A(Local_83.f_28[0], 0, 0);
						iLocal_160 = 1;
					}
				}
				iLocal_145 = 2;
...
int func_254(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((((((((((((((func_255(Var18[0], Var18[1], Var6, Var9) || func_255(Var18[0], Var18[1], Var9, Var15)) || func_255(Var18[0], Var18[1], Var12, Var15)) || func_255(Var18[0], Var18[1], Var6, Var12)) || func_255(Var18[1], Var18[3], Var6, Var9)) || func_255(Var18[1], Var18[3], Var9, Var15)) || func_255(Var18[1], Var18[3], Var12, Var15)) || func_255(Var18[1], Var18[3], Var6, Var12)) || func_255(Var18[3], Var18[2], Var6, Var9)) || func_255(Var18[3], Var18[2], Var9, Var15)) || func_255(Var18[3], Var18[2], Var12, Var15)) || func_255(Var18[3], Var18[2], Var6, Var12)) || func_255(Var18[2], Var18[0], Var6, Var9)) || func_255(Var18[2], Var18[0], Var9, Var15)) || func_255(Var18[2], Var18[0], Var12, Var15)) || func_255(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
void func_298(var uParam0, bool bParam1)
{
	...
	func_299(uParam0, iLocal_81, Var0, fVar3);
...
void func_299(var uParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_300(uParam0);
...
int func_301(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_302(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
...
int func_302(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)
{
	if (!func_152(iParam1))
	{
