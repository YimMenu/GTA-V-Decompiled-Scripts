	...
	switch (iLocal_83)
	{
		...
		case 1:
			...
			if (!iLocal_94)
			{
				if (func_294(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
				{
					...
					PED::_0x2208438012482A1A(Local_81.f_28[0], true, false);
		...
		case 2:
			...
			if (func_293(Local_81.f_28[0]))
			{
				...
				if (iLocal_96 == 0)
				{
					PED::FORCE_PED_MOTION_STATE(Local_81.f_28[0], -668482597, false, 0, true);
				}
			}
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false))
			{
...
void func_235(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!iLocal_94)
				{
					...
					if (func_294(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
					{
						...
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
						PED::FORCE_PED_MOTION_STATE(Local_81.f_28[0], -1871534317, false, 1, true);
						iLocal_94 = 1;
					}
				}
			}
			...
			if (!CUTSCENE::IS_CUTSCENE_ACTIVE())
			{
				...
				if (!iLocal_94)
				{
					...
					if (func_294(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
					{
						...
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
						PED::_0x2208438012482A1A(Local_81.f_28[0], false, false);
						iLocal_94 = 1;
					}
				}
				iLocal_83 = 2;
...
int func_245(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
