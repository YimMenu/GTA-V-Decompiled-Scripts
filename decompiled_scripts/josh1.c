...
void func_1()
{
	switch (iLocal_83)
	{
		...
		case 1:
			...
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_87))
			{
		...
		case 2:
			...
			if (func_293(Local_81.f_28[0]))
			{
				...
				if (iLocal_96 == 0)
				{
					PED::FORCE_PED_MOTION_STATE(Local_81.f_28[0], -668482597, 0, 0, 1);
				}
			}
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
			{
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!iLocal_94)
				{
					...
					if (func_294(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
					{
						...
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
						PED::FORCE_PED_MOTION_STATE(Local_81.f_28[0], -1871534317, 0, 1, 1);
						iLocal_94 = 1;
					}
				}
			}
	...
	if (Global_76876 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_279(Global_76877, Global_76879, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_298(var uParam0, bool bParam1)
{
	...
	func_299(uParam0, iLocal_79, Var0, fVar1);
...
void func_299(var uParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_300(uParam0);
...
int func_301(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_302(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
...
int func_302(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
