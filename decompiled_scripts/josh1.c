	...
	switch (iLocal_145)
	{
		...
		case 2:
			...
			if (func_293(Local_83.f_28[0]))
			{
				...
				if (iLocal_162 == 0)
				{
					PED::FORCE_PED_MOTION_STATE(Local_83.f_28[0], -668482597, false, 0, true);
				}
			}
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false))
			{
		...
		if (bParam2)
		{
			if (!Global_77248)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8327[iParam1 /*4*/] = { func_208(iParam0) };
					...
					{
						Global_8278[1 /*6*/] = { func_208(iParam0) };
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!iLocal_160)
				{
					...
					if (func_294(Local_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147))
					{
						...
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_147);
						PED::FORCE_PED_MOTION_STATE(Local_83.f_28[0], -1871534317, false, 1, true);
						iLocal_160 = 1;
					}
				}
			}
	...
	if (Global_77502 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_279(Global_77503, Global_77505, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_290(0) || Global_77517) || Global_77506 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77502)
...
{
	return func_292(iParam0, Global_42009);
}
...
int func_327()
{
	...
	iVar0 = func_328(&(Global_99370.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_331()
{
	...
	{
		if (func_326(&(Global_99370.f_3)) > -1)
		{
			return 1;
		}
	}
