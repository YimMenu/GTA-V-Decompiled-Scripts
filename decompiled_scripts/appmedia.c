	...
	while (true)
	{
		...
		if (iLocal_24 == 0)
		{
			if (Global_19798.f_1 != 9)
			{
				...
				{
					case 7:
						if ((iLocal_210 == 0 && iLocal_211 == 0) && Global_22160 == 0)
						{
							func_22();
							func_16();
						}
					...
					case 8:
						if ((func_15(2, Global_19766, 0) && iLocal_210 == 0) && iLocal_211 == 0)
						{
							func_14();
							Global_19776 = 1;
							if (Global_19798.f_1 > 3)
							{
								if (MISC::IS_BIT_SET(Global_7669, 15))
								{
								}
								func_13();
							}
...
void func_9()
{
	if ((iLocal_210 == 1 && iLocal_211 == 0) && Global_22160 == 6)
	{
		if (iLocal_212)
		{
			Local_207.x = (Local_207.x - 1f);
	...
	if (MISC::IS_BIT_SET(Global_7669, 15))
	{
		...
		iLocal_211 = 0;
		func_7(Global_19779, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
		func_6(Global_19779, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_MSMENU_3", 0, 0, 0, 0);
		if (Global_19786)
		{
		...
		MISC::CLEAR_BIT(&Global_7668, 17);
		func_7(Global_19779, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
		func_4(Global_19779, "SET_HEADER", &(Local_52[iLocal_23 /*6*/]), 0, 0, 0, 0);
	}
}
...
void func_17()
{
	func_7(Global_19779, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_20()
{
	func_7(Global_19779, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_19787, true);
	func_21();
}
		...
		if (func_15(2, Global_19767, 0))
		{
			...
			if (iVar0 > -1)
			{
				...
				if (Global_19798.f_1 > 3)
				{
					...
					{
						func_7(Global_19779, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_6(Global_19779, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_MSMENU_2", 0, 0, 0, 0);
						func_7(Global_19779, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_4(Global_19779, "SET_HEADER", &(Local_52[iLocal_23 /*6*/]), 0, 0, 0, 0);
						if (Global_19786)
						{
