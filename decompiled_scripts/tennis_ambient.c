...
void __EntryFunction__()
{
	...
	if (((func_338(10) && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis")) == 0) || Global_95672) && !ScriptParam_0.f_1)
	{
...
void func_262(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!PED::IS_PED_INJURED(func_265(uParam0[iParam1 /*94*/])) && !PED::IS_PED_INJURED(func_265(uParam0[iParam2 /*94*/])))
	{
		...
		else
		{
			if (!bParam4)
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_265(uParam0[iParam1 /*94*/]), PED::GET_PED_BONE_INDEX(func_265(uParam0[iParam1 /*94*/]), 28422), Local_238, Local_241, false, false, false, false, 2, true);
			}
			ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_265(uParam0[iParam2 /*94*/]), PED::GET_PED_BONE_INDEX(func_265(uParam0[iParam2 /*94*/]), 28422), Local_238, Local_241, false, false, false, false, 2, true);
		}
	}
}
