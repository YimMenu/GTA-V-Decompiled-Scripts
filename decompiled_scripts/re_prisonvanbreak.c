...
void func_2()
{
	...
	if (!bLocal_260)
	{
		if ((ENTITY::IS_ENTITY_DEAD(iLocal_222, 0) || PED::IS_PED_INJURED(iLocal_222)) || PED::IS_PED_HURT(iLocal_222))
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(-1249748547))
			{
				Local_271 = { PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_222, 1067030938, 1069547520) };
				Local_271.z = (Local_271.z + 0.3f);
				uLocal_292[0] = OBJECT::CREATE_PICKUP_ROTATE(-831529621, Local_271 + Vector(-0.49f, 0f, 0f), -90f, 0f, 0f, 0, 5000, 2, 1, -1249748547);
	...
	if (!bLocal_261)
	{
		if ((ENTITY::IS_ENTITY_DEAD(iLocal_223, 0) || PED::IS_PED_INJURED(iLocal_223)) || PED::IS_PED_HURT(iLocal_223))
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(-1249748547))
			{
				Local_271 = { PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_223, 1067030938, 1069547520) };
				Local_271.z = (Local_271.z + 0.3f);
				uLocal_292[1] = OBJECT::CREATE_PICKUP_ROTATE(-831529621, Local_271 + Vector(-0.49f, 0f, 0f), -90f, 0f, 0f, 0, 5000, 2, 1, -1249748547);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_222))
			{
				if (ENTITY::IS_ENTITY_DEAD(iLocal_222, 0) || PED::IS_PED_INJURED(iLocal_222))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_222, PLAYER::PLAYER_PED_ID(), 1))
					{
						...
						{
							AI::TASK_COMBAT_PED(iLocal_223, PLAYER::PLAYER_PED_ID(), 0, 16);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_223))
			{
				if (ENTITY::IS_ENTITY_DEAD(iLocal_223, 0) || PED::IS_PED_INJURED(iLocal_223))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_223, PLAYER::PLAYER_PED_ID(), 1))
					{
						...
						{
							AI::TASK_COMBAT_PED(iLocal_222, PLAYER::PLAYER_PED_ID(), 0, 16);
	...
	else if (!iLocal_266 && !bLocal_49)
	{
		...
		if (((ENTITY::IS_ENTITY_DEAD(iLocal_222, 0) && ENTITY::IS_ENTITY_DEAD(iLocal_223, 0)) && STREAMING::HAS_MODEL_LOADED(1171614426)) && STREAMING::HAS_ANIM_DICT_LOADED("random@countrysiderobbery"))
		{
			UI::REMOVE_BLIP(&uLocal_295);
			UI::REMOVE_BLIP(&uLocal_296);
			func_59(&uLocal_54, 5);
			...
			{
				uLocal_237 = VEHICLE::CREATE_VEHICLE(1171614426, 267.94f, 2700.48f, 43.1f, 180f, 1, 1, 0);
			}
			else
			{
				uLocal_237 = VEHICLE::CREATE_VEHICLE(1171614426, 185.94f, 2603.48f, 46.9f, 0f, 1, 1, 0);
			}
			VEHICLE::SET_VEHICLE_SIREN(uLocal_237, 1);
			iLocal_224 = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_237, 20, -1286380898, -1, 1, 1);
			iLocal_225 = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_237, 20, -1286380898, 0, 1, 1);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_222))
			{
				...
				AI::TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_237, 307.1379f, 2640.042f, 43.4639f, 18f, 0, 1171614426, 786475, 5f, 5f);
				AI::TASK_GO_TO_ENTITY(0, iLocal_222, -1, 2f, 1f, 10f, 0);
				AI::TASK_LOOK_AT_ENTITY(0, iLocal_222, -1, 2052, 2);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_222, 0);
				...
				AI::TASK_PERFORM_SEQUENCE(iLocal_224, uLocal_269);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_223))
			{
				...
				AI::TASK_GO_TO_ENTITY(0, iLocal_223, -1, 2f, 1f, 10f, 0);
				AI::TASK_LOOK_AT_ENTITY(0, iLocal_223, -1, 2052, 2);
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_223, 0);
				AI::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "enter", 2f, -2f, -1, 0, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "base", 2f, -2f, -1, 1, 0, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(uLocal_269);
				AI::TASK_PERFORM_SEQUENCE(iLocal_225, uLocal_269);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_269);
			...
			if (!PED::IS_PED_INJURED(iLocal_226[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_236))
			{
				...
				AI::OPEN_SEQUENCE_TASK(&uLocal_269);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_236, 0) + Vector(0f, 5f, 0f), 1f, -1, 1048576000, 0, 1193033728);
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_226[1], 0) && ENTITY::DOES_ENTITY_EXIST(iLocal_230))
			{
				...
				WEAPON::SET_CURRENT_PED_WEAPON(iLocal_226[1], -1569615261, 1);
				AI::OPEN_SEQUENCE_TASK(&uLocal_269);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_230, 0) + Vector(0f, 1f, 0f), 2f, -1, 1048576000, 0, 1193033728);
				AI::TASK_LOOK_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_230, 0), -1, 2052, 2);
				AI::TASK_TURN_PED_TO_FACE_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_230, 0), 0);
				AI::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "enter", 2f, -2f, -1, 0, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "base", 2f, -2f, -1, 1, 0, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(uLocal_269);
			...
			if (!PED::IS_PED_INJURED(iLocal_226[2]) && ENTITY::DOES_ENTITY_EXIST(iLocal_223))
			{
				...
				{
					AI::OPEN_SEQUENCE_TASK(&uLocal_269);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_223, 0) + Vector(0f, 1f, 0f), 1f, -1, 1048576000, 0, 1193033728);
					AI::TASK_SWAP_WEAPON(0, 0);
	...
	if (!iLocal_282)
	{
		if (!PED::IS_PED_INJURED(iLocal_222))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_222, 0))
			{
				...
				if (((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_291, PLAYER::PLAYER_PED_ID(), 1) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_291, PLAYER::PLAYER_PED_ID(), 10f, 10f, 10f, 0, 1, 0)) || PED::IS_PED_BEING_JACKED(iLocal_222)) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_291, 0)) || WEAPON::HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(PLAYER::PLAYER_PED_ID(), iLocal_291, 741814745, -1))
				{
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_222, 0);
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_267, 1862763509);
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_222, 0))
					{
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_222, 324215364, 200, 1, 1);
						WEAPON::SET_CURRENT_PED_WEAPON(iLocal_222, 324215364, 1);
						AI::TASK_DRIVE_BY(iLocal_222, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 50, 0, -753768974);
					}
					if (!PED::IS_PED_INJURED(iLocal_223))
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_223, 0))
						{
							...
							WEAPON::GIVE_WEAPON_TO_PED(iLocal_223, 324215364, 200, 1, 1);
							WEAPON::SET_CURRENT_PED_WEAPON(iLocal_223, 324215364, 1);
							AI::TASK_DRIVE_BY(iLocal_223, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 50, 0, -753768974);
						}
					}
					bLocal_50 = true;
					iLocal_282 = 1;
		...
		if (!PED::IS_PED_INJURED(iLocal_223))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_223, 0))
			{
				...
				if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_291, PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_BEING_JACKED(iLocal_223)) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_291, 0)) || WEAPON::HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(PLAYER::PLAYER_PED_ID(), iLocal_291, 741814745, -1))
				{
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_267, 1862763509);
					if (!PED::IS_PED_INJURED(iLocal_222))
					{
...
void func_61()
{
	...
	{
		if (!VEHICLE::_0x639431E895B9AA57(iLocal_222, iLocal_236, -1, 0, 0) && !VEHICLE::_0x639431E895B9AA57(iLocal_222, iLocal_236, 0, 0, 0))
		{
			AI::TASK_SMART_FLEE_COORD(iLocal_222, Local_219, 1000f, -1, 0, 0);
			PED::SET_PED_KEEP_TASK(iLocal_222, 1);
			iLocal_285 = 1;
		}
	}
	...
	{
		if (!VEHICLE::_0x639431E895B9AA57(iLocal_223, iLocal_236, -1, 0, 0) && !VEHICLE::_0x639431E895B9AA57(iLocal_223, iLocal_236, 0, 0, 0))
		{
			AI::TASK_SMART_FLEE_COORD(iLocal_223, Local_219, 1000f, -1, 0, 0);
			PED::SET_PED_KEEP_TASK(iLocal_223, 1);
			iLocal_285 = 1;
		}
	}
...
void func_62()
{
	...
	{
		Local_271 = { ENTITY::GET_ENTITY_COORDS(iLocal_222, 1) };
	}
	else if (!ENTITY::IS_ENTITY_DEAD(iLocal_223, 0))
	{
		Local_271 = { ENTITY::GET_ENTITY_COORDS(iLocal_223, 1) };
	}
	Local_271.z = (Local_271.z - 0.11f);
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_222, 0))
	{
		SYSTEM::SETTIMERA(0);
		if (!bLocal_50)
...
void func_64()
{
	if (!bLocal_284)
	{
		...
		if (iLocal_265 == 1)
		{
			if (!PED::IS_PED_INJURED(iLocal_222) && !ENTITY::IS_ENTITY_DEAD(iLocal_236, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_222, iLocal_236, 0))
				{
					...
					AI::OPEN_SEQUENCE_TASK(&uLocal_269);
					AI::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_236, PLAYER::PLAYER_PED_ID(), 8, 100f, 786469, 1000f, 10f, 1);
					AI::CLOSE_SEQUENCE_TASK(uLocal_269);
					AI::TASK_PERFORM_SEQUENCE(iLocal_222, uLocal_269);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_269);
					PED::SET_PED_KEEP_TASK(iLocal_222, 1);
					bLocal_284 = true;
				}
		...
		if (iLocal_265 == 2)
		{
			if (!PED::IS_PED_INJURED(iLocal_223) && !ENTITY::IS_ENTITY_DEAD(iLocal_236, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_223, iLocal_236, 0))
				{
					...
					AI::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_236, PLAYER::PLAYER_PED_ID(), 8, 100f, 786469, 1000f, 10f, 1);
					AI::CLOSE_SEQUENCE_TASK(uLocal_269);
					AI::TASK_PERFORM_SEQUENCE(iLocal_223, uLocal_269);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_269);
					PED::SET_PED_KEEP_TASK(iLocal_223, 1);
					bLocal_284 = true;
				}
		...
		if (iLocal_265 == 3)
		{
			...
			{
				func_59(&uLocal_54, 5);
				AI::TASK_ENTER_VEHICLE(iLocal_223, iLocal_236, -1, -1, 2f, 8, 0);
				iLocal_265 = 2;
			}
			if (PED::IS_PED_INJURED(iLocal_223) && !PED::IS_PED_INJURED(iLocal_222))
			{
				func_59(&uLocal_54, 6);
				AI::TASK_ENTER_VEHICLE(iLocal_222, iLocal_236, -1, -1, 2f, 8, 0);
				iLocal_265 = 1;
			}
		}
		if (iLocal_265 == 4)
	...
	if ((ENTITY::IS_ENTITY_DEAD(iLocal_226[0], 0) && ENTITY::IS_ENTITY_DEAD(iLocal_226[1], 0)) && ENTITY::IS_ENTITY_DEAD(iLocal_226[2], 0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_236, 0))
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_222) && !PED::IS_PED_HURT(iLocal_222))
			{
				...
				iLocal_265 = 1;
				AI::CLEAR_PED_TASKS(iLocal_222);
				AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_222, 1);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_222, 1);
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_222);
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_236);
				AI::OPEN_SEQUENCE_TASK(&uLocal_269);
				AI::TASK_ENTER_VEHICLE(0, iLocal_236, -1, -1, 2f, 9, 0);
				AI::CLOSE_SEQUENCE_TASK(uLocal_269);
				AI::TASK_PERFORM_SEQUENCE(iLocal_222, uLocal_269);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_269);
				if (!PED::IS_PED_INJURED(iLocal_223) && !PED::IS_PED_HURT(iLocal_223))
				{
					...
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_236);
					AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_223, 1);
					AI::TASK_ENTER_VEHICLE(iLocal_223, iLocal_236, -1, 0, 2f, 1, 0);
					iLocal_265 = 3;
				}
			}
			else if (!PED::IS_PED_INJURED(iLocal_223))
			{
				...
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_236);
				AI::OPEN_SEQUENCE_TASK(&uLocal_269);
				AI::TASK_ENTER_VEHICLE(0, iLocal_236, -1, -1, 2f, 1, 0);
				AI::CLOSE_SEQUENCE_TASK(uLocal_269);
				AI::TASK_PERFORM_SEQUENCE(iLocal_223, uLocal_269);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_269);
				iLocal_265 = 2;
...
void func_67(int iParam0, var uParam1, int iParam2, float fParam3)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		if (*uParam1 < 5)
		{
			...
			if (GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var0), fParam3, 1, 1) || GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var0), fParam3, 0, 1))
			{
				switch (*uParam1)
				{
					case 0:
...
void func_69()
{
	...
	{
		if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_236, PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_236, 0)) || WEAPON::HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(PLAYER::PLAYER_PED_ID(), iLocal_236, 741814745, -1))
		{
			bLocal_50 = true;
			SYSTEM::SETTIMERA(0);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_267, 1862763509);
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_236, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_236, 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_222))
					{
						...
						AI::TASK_ENTER_VEHICLE(iLocal_222, iLocal_236, -1, -1, 2f, 524296, 0);
					}
					else if (!PED::IS_PED_INJURED(iLocal_223))
					{
						func_59(&uLocal_54, 5);
						func_56(&uLocal_54, 5, iLocal_223, "RECSBRobber1", 0, 1);
						func_66(&uLocal_54, "recsbau", "recsb_deadcr", "recsb_deadcr_1", 4, 0, 0);
						AI::TASK_ENTER_VEHICLE(iLocal_223, iLocal_236, -1, -1, 2f, 524296, 0);
					}
				}
				else if (!bLocal_49)
				{
...
int func_72()
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), -1281684762) || PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), 788747387))
			{
				return 1;
			}
		}
...
void func_73()
{
	...
	while (iVar1 < iLocal_232)
	{
		...
		{
			if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_232[iVar1], PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_232[iVar1], 0)) || WEAPON::HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(PLAYER::PLAYER_PED_ID(), iLocal_232[iVar1], 741814745, -1))
			{
				bLocal_49 = true;
			}
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
...
void func_91()
{
	...
	STREAMING::REQUEST_MODEL(-1286380898);
	STREAMING::REQUEST_MODEL(-1683328900);
	STREAMING::REQUEST_MODEL(-2095439403);
	if ((((STREAMING::HAS_MODEL_LOADED(-277793362) && STREAMING::HAS_MODEL_LOADED(-1736970383)) && STREAMING::HAS_MODEL_LOADED(-1286380898)) && STREAMING::HAS_MODEL_LOADED(-1683328900)) && STREAMING::HAS_MODEL_LOADED(-2095439403))
	{
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(-2095439403, 1);
		...
		iLocal_236 = VEHICLE::CREATE_VEHICLE(-2095439403, 326.78f, 2626.56f, 43.5081f, 45.21f, 1, 1, 0);
		iLocal_232[0] = VEHICLE::CREATE_VEHICLE(-1683328900, 314.1008f, 2641.67f, 43.5055f, 258.9436f, 1, 1, 0);
		iLocal_232[1] = VEHICLE::CREATE_VEHICLE(-1683328900, 330.7097f, 2646.913f, 43.685f, 120.9436f, 1, 1, 0);
		iLocal_232[2] = VEHICLE::CREATE_VEHICLE(-1683328900, 321.4496f, 2649.388f, 43.5706f, 105.9436f, 1, 1, 0);
		...
		iLocal_222 = PED::CREATE_PED(19, -1736970383, 321.31f, 2615.66f, 43.4963f, 346f, 1, 1);
		iLocal_223 = PED::CREATE_PED(19, -1736970383, 326.25f, 2624.51f, 43.4846f, 341f, 1, 1);
		iLocal_230 = PED::CREATE_PED(6, -277793362, 325.3731f, 2631.16f, 43.5248f, 87f, 1, 1);
		iLocal_226[0] = PED::CREATE_PED(6, -277793362, 310.6203f, 2642.854f, 43.5173f, 226f, 1, 1);
		iLocal_226[1] = PED::CREATE_PED(6, -277793362, 319.5652f, 2650.067f, 43.5411f, 189f, 1, 1);
		iLocal_226[2] = PED::CREATE_PED(6, -277793362, 324.0396f, 2650.964f, 43.5983f, 214f, 1, 1);
		...
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_223, 453432689, 200, 1, 1);
		PED::SET_PED_SEEING_RANGE(iLocal_223, 100f);
		PED::SET_PED_HEARING_RANGE(iLocal_223, 100f);
		AI::TASK_GUARD_CURRENT_POSITION(iLocal_223, 35f, 35f, 1);
		...
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_222, 453432689, 200, 1, 1);
		PED::SET_PED_SEEING_RANGE(iLocal_222, 100f);
		PED::SET_PED_HEARING_RANGE(iLocal_222, 100f);
		AI::TASK_GUARD_CURRENT_POSITION(iLocal_222, 35f, 35f, 1);
		...
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_226[0], 487013001, 200, 1, 1);
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_226[1], 453432689, 200, 1, 1);
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_226[2], 487013001, 200, 1, 1);
		...
		AI::TASK_SEEK_COVER_FROM_PED(iLocal_226[0], iLocal_222, 3000, 0);
		AI::TASK_SEEK_COVER_FROM_PED(iLocal_226[1], iLocal_222, 3000, 0);
		AI::TASK_SEEK_COVER_FROM_PED(iLocal_226[2], iLocal_222, 3000, 0);
		if (func_51() == 0)
		{
...
int func_112()
{
	func_118(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_117(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_116(&uVar0, TIME::GET_CLOCK_HOURS());
	func_115(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_114(&uVar0, TIME::GET_CLOCK_MONTH());
	func_113(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_129()) || Global_110685) || Global_30770) || func_128()) || func_53(8, -1)) || func_127()) || func_126()) || func_125()) || func_124()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_129()) || Global_30770) || func_128()) || func_53(8, -1)) || func_125()) || func_127()) || func_126()) || func_124()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_129()) || Global_110685) || Global_30770) || func_128()) || func_53(8, -1)) || func_125()) || func_127()) || func_126()) || func_124()) || Global_111638.f_7683.f_919[iVar0] == 5) || Global_41978 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_129()) || Global_110685) || Global_30770) || func_128()) || func_53(8, -1)) || func_127()) || func_126()) || func_124()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_129()) || Global_30770) || func_128()) || func_53(8, -1)) || func_126()) || func_125()) || func_124()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_129()) || func_126()) || Global_110685) || Global_30770) || func_128()) || Global_42596) || func_53(8, -1)) || func_125()) || func_123()) || func_124()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_129()) || Global_110685) || Global_30770) || func_128()) || func_53(8, -1)) || func_125()) || func_123()) || func_127()) || func_126()) || func_124())
						{
							return 0;
						}
						break;
