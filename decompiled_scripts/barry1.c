void __EntryFunction__()
{
	...
	fLocal_180 = 0.8f;
	iLocal_181 = 1;
	iLocal_188 = 100416529;
	iLocal_189 = 1593441988;
	iLocal_190 = -1568386805;
	iLocal_191 = 1119849093;
	fLocal_208 = 255f;
	iLocal_209 = 1119849093;
	sLocal_328 = "Barry";
	...
	sLocal_352 = "enter";
	sLocal_353 = "idle_d";
	iLocal_357 = 1684083350;
	iLocal_358 = 186956100;
	iLocal_359 = 1716800000;
...
void func_3(int iParam0)
{
	...
	{
		if (func_4(&(Local_586[iVar0])))
		{
			Local_586[iVar0].f_1 = 4;
			iVar1++;
		}
		iVar0++;
	}
		...
		case 5:
			if (MISC::GET_GAME_TIMER() > iLocal_158)
			{
				if (iParam0 == 1)
				{
					...
					MISC::CLEAR_AREA_OF_VEHICLES(Local_174, 200f, 0, 0, 0, 0, 0, 0);
...
{
	func_56(&(Global_105187.f_2890), Param0, fParam3);
}
...
void func_60(int iParam0)
{
	...
	while (iVar0 < Local_586)
	{
		func_61(&(Local_586[iVar0]), iParam0);
		iVar0++;
	}
}
...
void func_68()
{
	...
	while (iVar0 < Local_586)
	{
		if (func_4(&(Local_586[iVar0])))
		{
			func_64(&(Local_586[iVar0]));
			Local_586[iVar0].f_1 = 0;
			TASK::TASK_SMART_FLEE_COORD(Local_586[iVar0].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
		}
		iVar0++;
	}
}
...
int func_75(var uParam0, float fParam1)
{
	if (!uParam0->f_15)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_11))
		{
			...
			CAM::SET_CAM_ROT((*uParam0)[uParam0->f_24], -87.5f, 0f, Var3.z, 2);
			CAM::SET_CAM_FOV((*uParam0)[uParam0->f_24], CAM::GET_FINAL_RENDERED_CAM_FOV());
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (func_333(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				...
				func_332();
				MISC::CLEAR_AREA_OF_VEHICLES(Local_174, 250f, 0, 0, 0, 0, 0, 0);
				...
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_330, 2, 974300346, 0);
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_329, 2, 1281480215, 0);
				if (func_575(PLAYER::PLAYER_PED_ID()))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Michael", 0, 225514697, 0);
				}
		...
		case 2:
			...
			else
			{
				...
				if (CUTSCENE::CAN_SET_ENTER_STATE_FOR_REGISTERED_ENTITY(sLocal_330, 0))
				{
					...
					{
						ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_96.f_41[2], Local_96.f_41[0], 0, 0f, -0.25f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					}
				}
			}
			break;
...
void func_83(int iParam0, bool bParam1)
{
	...
	{
		func_243(&(Global_110725[iVar0].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void func_100(var uParam0)
{
	*uParam0 = 145;
	...
	while (iVar1 < 3)
	{
		...
		func_105(&(uParam0->f_25[0][iVar1]));
		func_105(&(uParam0->f_25[1][iVar1]));
		iVar0 = 0;
		while (iVar0 < 12)
		{
...
int func_110(int iParam0, int iParam1, int iParam2)
{
	...
	Global_76434[1] = { func_161(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_76434[1] = { func_161(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_153(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_153(iParam1), Global_76434[1].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_153(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, 0);
		}
	}
...
int func_111(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_225(iParam0, Global_111638.f_2358.f_539[iVar0].f_64, Global_111638.f_2358.f_539[iVar0].f_63))
		{
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76434[1] = { func_161(iVar10, iParam1, iParam2, -1) };
		if (!func_151(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76434[1] = { func_161(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1] = { func_161(iVar10, 14, uVar28[iVar1], -1) };
							func_129(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
							func_144(14);
							if (Global_76432 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_153(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_153(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_153(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_144(iVar0);
						if (Global_76432 == 1)
						{
			...
			{
				Global_76434[1] = { func_161(iVar10, iVar0, func_119(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1] = { func_161(iVar10, 14, uVar69[iVar1], -1) };
			func_129(iParam0, Global_76434[1].f_12, Global_76434[1].f_3, Global_76434[1].f_4);
			func_144(14);
			if (Global_76432 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_153(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_153(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_153(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
{
	Global_76434[1] = { func_161(iParam0, iParam1, iParam2, -1) };
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								if (!func_122(-1692214353, iVar3, iVar5, iVar4, &iVar6))
								{
									if (iVar6 != -99)
									{
										iVar0 = iVar6;
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_153(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_136(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_153(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_131(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_131(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_131(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_131(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_144(int iParam0)
{
	...
	{
		func_150(iParam0, Global_76434[1].f_5, Global_76434[1].f_2, 2, Global_76434[1].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76434[1].f_6, 1) && MISC::IS_BIT_SET(Global_76434[1].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_145(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_149(iParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
		...
		func_146(iVar2, uVar3, iVar0, 1, 0);
	}
}
...
void func_146(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2548434[iParam0][func_147(iParam2)];
	if (iVar0 != 0)
	{
...
int func_148(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0][func_147(iParam1)];
...
int func_152(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_225(iParam0, Global_111638.f_2358.f_539[iVar0].f_61, Global_111638.f_2358.f_539[iVar0].f_60) || iParam3 == 1)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_136(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_159(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_159(Var16.z)] = func_136(iParam1, Var16.x, func_159(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_159(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
...
void func_163(int iParam0)
{
	...
	func_164(&(Global_76434[0]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_148(func_167(iParam1, uParam0->f_2), Global_76431, 0);
			if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_148(func_166(iParam1, uParam0->f_2), Global_76431, 0);
			if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_148(iVar1, Global_76431, 0);
				if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_164(&(Global_76434[0]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_164(&(Global_76434[0]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_164(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_164(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_153(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_225(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_225(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_225(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76434[2] = { func_161(iVar0, 14, iVar4, -1) };
									if (Global_76434[2].f_12 == iVar3)
									{
										if (func_225(iParam0, 14, iVar4))
										{
											if (!func_117(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76434[2])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76434[2] = { func_161(iVar0, iVar2, iVar1, -1) };
						if (!func_117(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76434[2])))
						{
							return 0;
						}
					}
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_153(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_153(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_233(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
...
{
	func_248(iParam0, 1);
	Global_111638.f_18569[iParam0].f_3 = func_247();
...
void func_278(var uParam0, int iParam1)
{
	...
	fVar3 = 23.45f;
	func_279(uParam0, iParam1, Var0, fVar3);
}

void func_279(var uParam0, var uParam1, struct<3> Param2, float fParam5)
{
	func_14(uParam0);
...
void func_283()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(func_331()) && !func_58(Local_925, Local_166, 0))
	{
		...
		{
			ENTITY::SET_ENTITY_COORDS(func_331(), Local_925, 1, 0, 0, 1);
...
void func_285(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_316(&(Global_75441.f_555[0]), iParam0))
	{
		return;
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_311(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_316(var uParam0, int iParam1)
{
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_58(Global_111638.f_32744.f_1864[uParam0->f_14], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_58(Global_111638.f_2358.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_58(Global_111638.f_2358.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, 0))
		{
...
void func_319(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6)
{
	if (func_316(&(Global_75441.f_555[0]), iParam0))
	{
		...
		{
			func_321(iParam0);
			func_320(uParam1, &(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]));
...
{
	return func_329(Global_102203.f_2890.f_12.f_66, Param0, iParam3);
}
...
void func_341(struct<3> Param0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
...
void func_351()
{
	...
	if (MISC::GET_GAME_TIMER() > iLocal_582)
	{
		if (func_367(&iVar1))
		{
			...
			{
				func_359(&(Local_586[iVar1]), Var2, 0, 0);
				Local_586[iVar1].f_32 = 1;
				Local_586[iVar1].f_14 = 150f;
				iLocal_582 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_583, iLocal_584));
				func_358(&(Local_586[iVar1]));
			}
...
int func_352(var uParam0)
{
	...
	{
		*uParam0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(fLocal_580, fLocal_581), 6f) };
	}
...
int func_353(var uParam0, bool bParam1)
{
	...
	if (!OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Local_200[0], Local_200[1], Local_200.f_7, 0, 1))
	{
		return 0;
	}
	if (bLocal_185)
...
bool func_354(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
...
{
	uVar0 = func_362(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
...
int func_364(var uParam0)
{
	...
	while (iVar0 < 9)
	{
		if (iVar1 < Var2.x)
		{
			if (!PED::IS_ANY_PED_NEAR_POINT(Local_897[iVar0], 1.5f))
			{
				func_365(&Var2, iVar1, Local_897[iVar0]);
				iVar1++;
			}
		}
		else
	...
	else
	{
		...
		*uParam0 = { Var2[iVar30] };
		if (func_58(Var2[iVar30], 0f, 0f, 0f, 0))
		{
		}
		else
		{
...
int func_373(var uParam0, float fParam1)
{
...
{
	uParam0->f_1 = (func_377(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
void func_383(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_367(&iVar0))
			{
				func_359(&(Local_586[iVar0]), 212.9178f, -920.5014f, 30.6922f, 0, 0);
				Local_586[iVar0].f_14 = 15f;
				func_358(&(Local_586[iVar0]));
			}
			if (func_367(&iVar0))
			{
				func_359(&(Local_586[iVar0]), 213.2008f, -917.9012f, 30.6923f, 2, 0);
				Local_586[iVar0].f_14 = 15f;
				func_358(&(Local_586[iVar0]));
			}
			if (func_367(&iVar0))
			{
				func_359(&(Local_586[iVar0]), 217.8108f, -916.817f, 30.6923f, 4, 0);
				Local_586[iVar0].f_14 = 15f;
				func_358(&(Local_586[iVar0]));
			}
			if (func_367(&iVar0))
			{
				func_359(&(Local_586[iVar0]), 211.0789f, -912.207f, 30.6923f, 8, 0);
				Local_586[iVar0].f_14 = 15f;
				func_358(&(Local_586[iVar0]));
			}
			func_282(500, 0);
	...
	if (iLocal_879 < iParam4)
	{
		if (func_373(&uLocal_890, fLocal_893))
		{
			if (func_367(&iVar0))
			{
				...
				{
					if (func_359(&(Local_586[iVar0]), Var1, 0, 0))
					{
						if (bParam5)
						{
							func_358(&(Local_586[iVar0]));
...
int func_406(var uParam0, int iParam1, char* sParam2, int iParam3)
{
	...
	func_405(uParam0[iParam1]);
	(*uParam0)[iParam1] = 8;
	uParam0[iParam1]->f_3 = sParam2;
	uParam0[iParam1]->f_5 = iParam3;
	return 1;
}
...
int func_411(var uParam0, int iParam1)
{
	...
	switch ((*uParam0)[iParam1])
	{
		...
		case 4:
			if (!AUDIO::REQUEST_SCRIPT_AUDIO_BANK(uParam0[iParam1]->f_3, 0, -1))
			{
				return 0;
			}
			break;
...
int func_412(var uParam0, int iParam1)
{
	...
	switch ((*uParam0)[iParam1])
	{
		...
		case 4:
			AUDIO::REQUEST_SCRIPT_AUDIO_BANK(uParam0[iParam1]->f_3, 0, -1);
			break;
		...
		case 9:
			GRAPHICS::REQUEST_STREAMED_TEXTURE_DICT(uParam0[iParam1]->f_3, 0);
			break;
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_333(1, 1093140480, 0))
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_96.f_41[0], sLocal_330, 2, 974300346, 0);
				}
				if (func_575(Local_96.f_41[1]))
				{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_96.f_41[1], sLocal_329, 2, 1281480215, 0);
				}
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_96.f_41[2], sLocal_332, 2, 2022656922, 0);
				}
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_96.f_41[3], sLocal_333, 2, -680040094, 0);
				}
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_96.f_41[4], sLocal_334, 2, -1630172026, 0);
				}
				if (func_575(PLAYER::PLAYER_PED_ID()))
				{
...
void func_416(float fParam0, float fParam1, char* sParam2, var uParam3, int iParam4)
{
...
void func_418()
{
	if (func_328(func_330(), 1))
	{
		if (func_575(func_331()))
		{
			Local_925 = { ENTITY::GET_ENTITY_COORDS(func_331(), 1) };
	...
	func_419(Local_192[0], Local_192[1], Local_192.f_7, Local_166, fLocal_169, func_330(), 1, 1, 1, 0, 0);
	if (func_328(func_330(), 1))
	{
		func_284(func_331(), Local_925, fLocal_928, 24, 0);
	}
...
int func_422(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_423(Var18[0], Var18[1], Var6, Var9) || func_423(Var18[0], Var18[1], Var9, Var15)) || func_423(Var18[0], Var18[1], Var12, Var15)) || func_423(Var18[0], Var18[1], Var6, Var12)) || func_423(Var18[1], Var18[3], Var6, Var9)) || func_423(Var18[1], Var18[3], Var9, Var15)) || func_423(Var18[1], Var18[3], Var12, Var15)) || func_423(Var18[1], Var18[3], Var6, Var12)) || func_423(Var18[3], Var18[2], Var6, Var9)) || func_423(Var18[3], Var18[2], Var9, Var15)) || func_423(Var18[3], Var18[2], Var12, Var15)) || func_423(Var18[3], Var18[2], Var6, Var12)) || func_423(Var18[2], Var18[0], Var6, Var9)) || func_423(Var18[2], Var18[0], Var9, Var15)) || func_423(Var18[2], Var18[0], Var12, Var15)) || func_423(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_428(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_432(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_432(iVar2, iVar8)))
			{
				...
				{
					uVar9 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_432(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_432(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_432(iVar2, iVar8)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_432(iVar2, iVar8));
				func_429(uVar1, func_432(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
void func_435(int iParam0)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar1 <= (8 - 1))
		{
			Global_111638.f_2358.f_539.f_1730[iVar1][iVar0] = HUD::_HUD_WEAPON_WHEEL_GET_SLOT_HASH(iVar1);
			iVar1++;
		}
	}
}
...
void func_445()
{
	...
	while (iVar0 < Local_586)
	{
		if (func_4(&(Local_586[iVar0])) && Local_586[iVar0].f_1 == 9)
		{
			if (fVar1 == -1f || (Local_586[iVar0].f_10 < fVar1 && Local_586[iVar0].f_10 != -1f))
			{
				iLocal_561 = iVar0;
				Local_586[iVar0].f_10 = fVar1;
			}
		}
		iVar0++;
	}
	...
	else
	{
		...
		else if (iVar1 == 2)
		{
			if (iVar0 > 0)
			{
				...
				{
					fLocal_179 = 0f;
					if (MISC::ABSF((uParam0->f_27.f_2 - Var2.z)) < 1f)
					{
						if ((MISC::GET_FRAME_COUNT() % 20) == 0)
						{
							MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Var5, Var8, 0, 1, 453432689, 0, 0, 1, -1082130432);
						}
						if (iLocal_851 == 1)
						{
...
void func_453(var uParam0)
{
	...
	if (func_456(&Var9, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, 1), ENTITY::GET_ENTITY_COORDS(uParam0->f_5, 1), Var3, Var6))
	{
		if (CAM::IS_SPHERE_VISIBLE(Var9, 0.5f))
		{
			iVar14 = func_454(Var3, Var0, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, 1));
			iVar15 = func_454(Var3, Var0, ENTITY::GET_ENTITY_COORDS(uParam0->f_5, 1));
...
{
	func_459(ENTITY::GET_ENTITY_COORDS(iParam0, 1), Param1, &fVar0, &fVar1, 1);
...
void func_462(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_463(iParam3), 0);
}
...
{
	uVar0 = func_362(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(iParam1, 1), 1);
	ENTITY::SET_ENTITY_HEADING(iParam0, uVar0);
}

int func_471(int iParam0, int iParam1, float fParam2, int iParam3)
{
	Var0 = { func_424(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_473(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	iVar0 = 0;
	bVar1 = true;
	if (bVar1)
...
int func_477(var uParam0)
{
	if (!func_481(uParam0))
	{
		...
		if (ENTITY::IS_ENTITY_DEAD(uParam0->f_2, 0) || PED::IS_PED_INJURED(uParam0->f_2))
		{
			...
			func_480("ALIEN_DEATH", "ALIENS", ENTITY::GET_ENTITY_COORDS(uParam0->f_2, 1), 10);
			func_64(uParam0);
			func_66(&(uParam0->f_17));
			func_14(&(uParam0->f_4));
			func_14(&(uParam0->f_5));
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_AT_COORDS(sParam0, sParam1, Param2, func_463(iParam5));
}
...
int func_513(var uParam0)
{
	...
	switch (iLocal_82)
	{
		case 0:
			...
			uParam0->f_25 = 1;
			uParam0->f_27 = 0;
			uParam0->f_17[0] = { 190.0315f, -956.3355f, 29.09192f };
			uParam0->f_17[1] = { 178.0458f, -950.6594f, 31.09358f };
			uParam0->f_24 = 23f;
			iVar12 = 0;
		...
		case 2:
			...
			{
				if (func_514(&(uParam0->f_28[0]), 49, Var8, uVar11, "RC LAUNCHER: BARRY 1", 1))
				{
...
int func_514(var uParam0, int iParam1, struct<3> Param2, var uParam5, char* sParam6, int iParam7)
{
	if (func_515(uParam0, iParam1, Param2, uParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
...
int func_515(var uParam0, int iParam1, struct<3> Param2, int iParam5, bool bParam6)
{
	if (!func_31(iParam1))
	{
...
void func_534(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_87() == 0)
		{
			uVar0 = func_148(func_535(iParam0), -1, 0);
			MISC::CLEAR_BIT(&uVar0, iParam1);
			func_146(func_535(iParam0), uVar0, -1, 1, 0);
		}
	}
	else
	{
...
{
	if (!MISC::IS_BIT_SET(uParam0->f_114, iParam1) || (*uParam0)[iParam1] == 0)
	{
		return 1;
	}
	switch ((*uParam0)[iParam1])
	{
		...
		case 8:
			if (HUD::HAS_ADDITIONAL_TEXT_LOADED(uParam0[iParam1]->f_5))
			{
				HUD::CLEAR_ADDITIONAL_TEXT(uParam0[iParam1]->f_5, 0);
			}
			break;
...
void func_563(int iParam0)
{
	if (func_31(iParam0))
	{
		Global_111638.f_2358.f_539.f_298[iParam0] = { Global_111638.f_2358.f_539.f_1764 };
	}
}
...
void func_564(int iParam0, bool bParam1)
{
	...
	if (func_31(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			func_436(iParam0, &(Global_111638.f_2358.f_539.f_298[iVar0]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_565(int iParam0, bool bParam1)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar1 <= (8 - 1))
		{
			HUD::_HUD_WEAPON_WHEEL_SET_SLOT_HASH(Global_111638.f_2358.f_539.f_1730[iVar1][iVar0]);
			iVar1++;
		}
	}
}
			...
			if (iVar1 != 0 && iVar1 != 1993361168)
			{
				...
				if (iVar3 != 0)
				{
					if (iVar3 != -1569615261)
					{
						...
						while (iVar4 != 0)
						{
							if (MISC::IS_BIT_SET(uParam1[iVar5]->f_2, iVar6))
							{
								if (!WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar3, iVar4))
								{
									...
									if (func_570(iVar4))
									{
										WEAPON::_SET_PED_WEAPON_LIVERY_COLOR(iParam0, iVar3, iVar4, uParam1[iVar5]->f_4);
										func_569(iParam0, iVar3, iVar4, uParam1[iVar5]->f_4);
									}
								}
							}
					...
					if (iVar3 != -1569615261)
					{
						...
						while (iVar6 < FILES::_GET_NUM_DLC_WEAPON_COMPONENTS_SP(iVar8))
						{
							if (FILES::_GET_DLC_WEAPON_COMPONENT_DATA_SP(iVar8, iVar6, &Var48))
							{
								...
								{
									if (MISC::IS_BIT_SET(uParam1->f_221[iVar70].f_2, iVar71))
									{
										if (!WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar3, Var48.f_3))
										{
											...
											{
												WEAPON::_SET_PED_WEAPON_LIVERY_COLOR(iParam0, iVar3, Var48.f_3, uParam1->f_221[iVar70].f_4);
												func_569(iParam0, iVar3, Var48.f_3, uParam1->f_221[iVar70].f_4);
											}
										}
									}
...
void func_569(int iParam0, int iParam1, int iParam2, var uParam3)
{
	iVar0 = func_430(iParam2);
	if (iVar0 != 0)
	{
		WEAPON::_SET_PED_WEAPON_LIVERY_COLOR(uParam0, iParam1, iVar0, uParam3);
	}
}
