...
{
	func_56(&(Global_105407.f_2890), Param0, fParam3);
}
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 7, -1, false, -1, func_153(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_136(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 7, -1, false, -1, func_153(iParam2));
...
void func_146(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2552060[iParam0 /*3*/][func_147(iParam2)];
	if (iVar0 != 0)
	{
...
int func_148(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2552060[iParam0 /*3*/][func_147(iParam1)];
...
void func_163(int iParam0)
{
	...
	func_164(&(Global_76647[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 7, -1, false, -1, func_153(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_232(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_233(&sVar32, Var0.f_3, Global_98992, bParam1, bParam2);
	}
}
...
{
	return func_329(Global_102423.f_2890.f_12.f_66, Param0, iParam3);
}
