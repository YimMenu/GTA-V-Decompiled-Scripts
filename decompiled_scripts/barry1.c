void __EntryFunction__()
{
	...
	iLocal_89 = 49;
	iLocal_90 = 64;
	uLocal_94 = UI::_0x4A9923385BDB9DAD();
	uLocal_95 = UI::_GET_BLIP_INFO_ID_ITERATOR();
	sLocal_159 = "";
	iLocal_160 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(19))
	{
		...
		if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_159, "B1_FAIL3"))
		{
			func_560("B1_FAIL3", 1);
		}
...
void func_1()
{
	...
	if (iLocal_181)
	{
		if (bVar0 == 0 && bLocal_559 == 0)
		{
			...
			iLocal_182 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			func_3(0);
			iLocal_181 = 0;
		}
	}
	...
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_182 && bLocal_559 == 0)
		{
			func_2("B1_FAIL");
		}
	}
...
void func_10(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			func_60(1);
			AUDIO::TRIGGER_MUSIC_EVENT("RC18A_STOP");
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_159))
			{
				func_543(1);
			}
			else
		...
		case 2:
			...
			else if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_159, "B1_FAIL"))
			{
			...
			else if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_159, "B1_FAIL2"))
			{
				func_11();
			}
			break;
...
void func_11()
{
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_158 && iLocal_158 != -1)
	{
	...
	switch (iLocal_161)
	{
		...
		case 1:
			if (iParam0 == 0)
			{
				...
				AI::TASK_PLAY_ANIM(0, sLocal_338, sLocal_352, 8f, -8f, -1, 0, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, sLocal_338, sLocal_353, 8f, -8f, -1, 1, 0, 0, 0, 0);
			...
			iLocal_158 = GAMEPLAY::GET_GAME_TIMER() + 6000;
		...
		case 2:
			...
			if (iParam0 == 1)
			{
				if (func_40(&uLocal_390, "BARY1AU", "BARY1_PREOUT", 8, 0, 0, 0) || GAMEPLAY::GET_GAME_TIMER() > iLocal_158)
				{
					if (GAMEPLAY::GET_GAME_TIMER() < iLocal_158)
					{
					}
					iLocal_158 = GAMEPLAY::GET_GAME_TIMER() + 4500;
					bVar3 = true;
				}
			}
			else if (func_17(&uLocal_390, "BARY1AU", "BARY1_PREOUT", "BARY1_PREOUT_2", 8, 0, 0) || GAMEPLAY::GET_GAME_TIMER() > iLocal_158)
			{
				iLocal_158 = GAMEPLAY::GET_GAME_TIMER() + 2000;
				if (GAMEPLAY::GET_GAME_TIMER() < iLocal_158)
				{
				}
				bVar3 = true;
		...
		case 4:
			...
			if (iParam0 == 1)
			{
				...
				{
					func_16();
					GRAPHICS::_START_SCREEN_EFFECT(sLocal_337, 0, 0);
					iLocal_158 = GAMEPLAY::GET_GAME_TIMER() + 3500;
					bVar3 = true;
				}
			}
			else
		...
		case 3:
			if (iParam0 == 1)
			{
				bVar3 = GAMEPLAY::GET_GAME_TIMER() > iLocal_158;
			}
			else
			{
				if (GAMEPLAY::GET_GAME_TIMER() < iLocal_158)
			...
			if (bVar3 == 1)
			{
				...
				iLocal_158 = GAMEPLAY::GET_GAME_TIMER() + 1000;
				iLocal_161 = 5;
			}
			break;
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_158)
			{
				if (iParam0 == 1)
				{
					...
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_174, 200f, 0, 0, 0, 0, 0, 0);
...
void func_16()
{
	if (GRAPHICS::_GET_SCREEN_EFFECT_IS_ACTIVE(sLocal_335))
	{
		GRAPHICS::_STOP_SCREEN_EFFECT(sLocal_335);
	}
	if (GRAPHICS::_GET_SCREEN_EFFECT_IS_ACTIVE(sLocal_336))
	{
		GRAPHICS::_STOP_SCREEN_EFFECT(sLocal_336);
	}
	if (GRAPHICS::_GET_SCREEN_EFFECT_IS_ACTIVE(sLocal_337))
	{
		GRAPHICS::_STOP_SCREEN_EFFECT(sLocal_337);
	}
}
...
void func_68()
{
	...
	while (iVar0 < Local_586)
	{
		if (func_4(&(Local_586[iVar0])))
		{
			...
			AI::TASK_SMART_FLEE_COORD(Local_586[iVar0].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
		}
		iVar0++;
	}
}
...
void func_70(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			AI::TASK_PLAY_ANIM(0, sLocal_338, sLocal_348, 8f, -8f, -1, 0, 0, 0, 0, 0);
			AI::TASK_PLAY_ANIM(0, sLocal_338, sLocal_351, 8f, -2f, -1, 0, 0, 0, 0, 0);
		...
		case 4:
			fLocal_208 = (fLocal_208 - (GAMEPLAY::GET_FRAME_TIME() * 512f));
			if (fLocal_208 <= 0f)
			{
				fLocal_208 = 0f;
		...
		case 3:
			...
			{
				func_2("B1_FAIL3");
				iLocal_158 = GAMEPLAY::GET_GAME_TIMER() + 50;
			}
			break;
	}
}
...
int func_71()
{
	switch (iLocal_965)
	{
		case 0:
			...
			iLocal_966 = GAMEPLAY::GET_GAME_TIMER() + 400;
			iLocal_965++;
			break;
		
		case 1:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_966)
			{
		...
		case 2:
			...
			{
				iLocal_966 = GAMEPLAY::GET_GAME_TIMER() + 500;
				iLocal_965++;
			}
			break;
...
int func_75(var uParam0, float fParam1)
{
	if (!uParam0->f_15)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_11))
		{
			...
			{
				fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iVar11, 1), CAM::GET_CAM_COORD(uParam0->f_11), 1);
			}
			else
			{
				fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iVar11, 0), CAM::GET_CAM_COORD(uParam0->f_11), 1);
			}
			...
			if (bVar9)
			{
				Var6 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar10, CAM::_GET_GAMEPLAY_CAM_COORDS()) };
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar10, Var6, 1);
			}
			else
			{
				Var6 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar11, CAM::_GET_GAMEPLAY_CAM_COORDS()) };
		...
		if (CAM::DOES_CAM_EXIST(uParam0->f_9))
		{
			...
			if (!Global_22211.f_111)
			{
				...
				if (Global_22211.f_109 == -1)
				{
					...
					Global_22211.f_110 = GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME());
				}
	...
	if (uParam0->f_17)
	{
		...
		uParam0->f_24 = 0;
		uParam0->f_27 = 0;
		if (Global_22211.f_109 != -1 && Global_22211.f_110 == GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()))
		{
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (func_333(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				...
				func_332();
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_174, 250f, 0, 0, 0, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_PEDS(Local_174, 50f, 0);
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(Local_174, 30f, 0);
				GRAPHICS::REMOVE_DECALS_IN_RANGE(Local_174, 500f);
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_130(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_153(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_136(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_153(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_131(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_131(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || DLC1::_0x341DE7ED1D2A1BFD(func_131(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || DLC1::_0x341DE7ED1D2A1BFD(func_131(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_164(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_164(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_153(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_238()
{
	...
	{
		func_30();
		GRAPHICS::_0xBF59707B3E5ED531(func_239(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
...
void func_280(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_281(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_283()
{
	...
	{
		GAMEPLAY::CLEAR_AREA(Local_925, 3f, 1, 0, 0, 0);
...
var func_305()
{
	func_315(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_314(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_313(&uVar0, TIME::GET_CLOCK_HOURS());
	func_308(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_307(&uVar0, TIME::GET_CLOCK_MONTH());
	func_306(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_311(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_344(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 2:
			if (iLocal_874 != 0 && GAMEPLAY::GET_GAME_TIMER() > iLocal_874)
			{
				iLocal_874 = 0;
				iLocal_873 = 0;
			}
			if (AUDIO::IS_AUDIO_SCENE_ACTIVE(sLocal_340))
			{
				AUDIO::SET_AUDIO_SCENE_VARIABLE(sLocal_340, "DrugsEffect", ((SYSTEM::SIN((((SYSTEM::TO_FLOAT(GAMEPLAY::GET_GAME_TIMER()) / 1000f) * 45f) % 360f)) * 0.25f) + 0.25f));
			}
...
void func_345()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_363)
	{
		return;
	}
	if (!bLocal_360)
	...
	{
		iLocal_363 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(20000, 40000));
		if ((iLocal_362 - GAMEPLAY::GET_GAME_TIMER()) < 2500)
		{
			iLocal_362 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 5000));
		}
	}
}
...
void func_351()
{
	...
	if (!iLocal_556)
	{
		iLocal_582 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_583, iLocal_584));
		return;
	}
	if (bLocal_559)
	{
		iLocal_582 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_583 * 3, iLocal_584 * 2));
		return;
	}
...
int func_352(var uParam0)
{
	...
	{
		*uParam0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(fLocal_580, fLocal_581), 6f) };
	}
...
int func_353(var uParam0, bool bParam1)
{
	...
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Var0, Local_170, 1) > fLocal_173)
	{
		return 0;
	}
...
{
	return GAMEPLAY::IS_POSITION_OCCUPIED(Param0, fParam3, 0, 0, 1, 0, 0, iParam4, iParam5);
}
...
Vector3 func_356(struct<3> Param0, float fParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	Var0 = { func_357(Var0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) };
...
int func_359(var uParam0, struct<3> Param1, int iParam4, bool bParam5)
{
	...
	*uParam0 = 1;
	uParam0->f_32 = 0;
	uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + iParam4 * 500);
	uParam0->f_16 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_568, iLocal_569));
	uParam0->f_10 = func_360(uParam0->f_2, PLAYER::PLAYER_PED_ID(), 1);
	uParam0->f_11 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(2f, 3f);
	uParam0->f_14 = (fLocal_857 + (GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(fLocal_861, fLocal_862) * fLocal_857));
	uParam0->f_15 = 0f;
	if (iLocal_184 == 1)
	{
	}
	AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_338, sLocal_350, 1000f, -8f, -1, 1, 0, 0, 0, 0);
	iLocal_876++;
	return 1;
}
...
int func_364(var uParam0)
{
	...
	{
		iVar30 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, iVar1);
		*uParam0 = { Var2[iVar30] };
...
float func_376(var uParam0)
{
	if (func_379(uParam0))
	{
		...
		{
			return (func_377(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_377(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
void func_383(int iParam0)
{
	...
	{
		case 0:
			GAMEPLAY::SET_TIME_SCALE(fLocal_180);
			AUDIO::_0xDDC635D5B3262C56("BARRY_01_SLOWMO");
		...
		if (func_373(&uLocal_890, fLocal_893))
		{
			if (func_367(&iVar0))
			{
				if (func_385(Param0, fParam3, &Var1))
				{
					...
					func_380(&uLocal_890);
					fLocal_893 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(1.5f, 2.5f);
				}
				else
				{
					func_380(&uLocal_890);
...
void func_386()
{
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_361)
	{
		return;
	}
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
{
	func_41(&uLocal_390, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	iLocal_361 = GAMEPLAY::GET_GAME_TIMER() + 1500;
	iLocal_363 = (iLocal_361 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(20000, 40000));
	iLocal_362 = (iLocal_361 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(12000, 18000));
	iLocal_364 = GAMEPLAY::GET_GAME_TIMER();
	bLocal_360 = false;
}
	...
	switch (*iParam0)
	{
		...
		case 3:
			...
			if (iLocal_354 == 0)
			{
				...
				if (!GRAPHICS::_GET_SCREEN_EFFECT_IS_ACTIVE(sLocal_336))
				{
					GRAPHICS::_START_SCREEN_EFFECT(sLocal_336, 0, 1);
				}
			}
			else
			{
...
void func_435(int iParam0)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar1 <= (8 - 1))
		{
			Global_111638.f_2358.f_539.f_1730[iVar1][iVar0] = UI::_0xA13E93403F26C812(iVar1);
			iVar1++;
		}
	}
}
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_339) && !func_336())
			{
				...
				{
					AI::TASK_PLAY_ANIM(Local_96.f_28[0], sLocal_339, "leadin", 8f, -4f, -1, 2, 0, 0, 0, 0);
					AI::TASK_LOOK_AT_ENTITY(Local_96.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
					*iParam0 = 2;
					iLocal_157 = GAMEPLAY::GET_GAME_TIMER() + 30000;
				}
			}
			break;
		...
		case 2:
			if (func_575(Local_96.f_28[0]))
			{
				if (!func_336() || GAMEPLAY::GET_GAME_TIMER() > iLocal_157)
				{
					*iParam0 = 4;
				}
			}
	...
	if (func_575(PLAYER::PLAYER_PED_ID()))
	{
		if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 189.1399f, -955.8049f, 29.09192f, 187.5274f, -955.0106f, 31.09192f, 2.5f, 0, 1, 0))
			{
				...
				if (func_575(Local_96.f_28[0]))
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_96.f_28[0], 0);
				}
			}
		}
	}
...
void func_444()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_563)
	{
		iLocal_561 = -1;
	}
...
void func_446(var uParam0)
{
	...
	if (func_475(uParam0) && bLocal_559 == 1)
	{
		...
		AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_338, sLocal_349, 8f, -8f, -1, 1, 0, 0, 0, 0);
		func_64(uParam0);
		func_66(&(uParam0->f_17));
		uParam0->f_1 = 13;
		uParam0->f_26 = 0;
	...
	switch (uParam0->f_1)
	{
		...
		case 2:
			...
			PED::SET_PED_CAN_BE_TARGETTED(uParam0->f_2, 0);
			func_361(uParam0->f_2);
			AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_338, sLocal_350, 8f, -8f, -1, 1, 0, 0, 0, 0);
		...
		case 9:
			...
			if (!uParam0->f_32)
			{
				...
				{
					AI::TASK_GO_TO_ENTITY(uParam0->f_2, PLAYER::PLAYER_PED_ID(), 20000, 1056964608, 1073741824, 1073741824, 0);
				}
			}
			if (!func_9())
			{
		...
		case 13:
			...
			if (bLocal_559 == 1)
			{
				...
				{
					AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_338, sLocal_349, 4f, -4f, -1, 1, 0, 0, 0, 0);
				}
				return;
			}
			uParam0->f_1 = 14;
			uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE((iLocal_562 - 1500), (iLocal_562 - 500)));
			break;
		
		case 14:
			PED::SET_PED_NAME_DEBUG(uParam0->f_2, "WATCH END");
			if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_7 && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_338, sLocal_346, 3))
			{
				uParam0->f_1 = 9;
			}
			break;
		...
		case 18:
			if (!PED::IS_PED_RUNNING_RAGDOLL_TASK(uParam0->f_2))
			{
				...
				uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_856);
				func_65(&(uParam0->f_21));
				func_65(&(uParam0->f_22));
				func_65(&(uParam0->f_23));
				func_65(&(uParam0->f_24));
				...
				AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_338, "MIND_CONTROL_B_Loop", 4f, -8f, -1, 1, 0, 0, 0, 0);
				uParam0->f_1 = 19;
			}
			break;
		...
		case 20:
			...
			if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) != 1)
			{
				AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_338, "MIND_CONTROL_B_LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
			}
			if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) == 1)
			{
		...
		case 7:
			if (func_447(uParam0) || GAMEPLAY::GET_GAME_TIMER() > uParam0->f_7)
			{
...
void func_449(var uParam0)
{
	...
	if (uParam0->f_26 == 0)
	{
		uParam0->f_26 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(Var5, Var8, 511, uParam0->f_2, 7);
	}
	else
	{
		iVar1 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_26, &iVar0, &Var11, &uVar14, &uVar17);
		if (iVar1 == 0)
		{
			uParam0->f_26 = 0;
		}
		else if (iVar1 == 2)
		{
			if (iVar0 > 0)
			{
				...
				uParam0->f_27 = { GAMEPLAY::_0x21C235BC64831E5A(Var11, Var5, Var8, 0) };
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(uParam0->f_27, Var2, 1) <= 0.7f)
				{
					fLocal_179 = 0f;
					if (GAMEPLAY::ABSF((uParam0->f_27.f_2 - Var2.z)) < 1f)
					{
						if ((GAMEPLAY::GET_FRAME_COUNT() % 20) == 0)
						{
							GAMEPLAY::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Var5, Var8, 0, 1, 453432689, 0, 0, 1, -1082130432);
						}
						if (iLocal_851 == 1)
						{
						...
						if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_8)
						{
							...
							uParam0->f_8 = (GAMEPLAY::GET_GAME_TIMER() + SYSTEM::ROUND((IntToFloat(iLocal_854) * 1.25f)));
							CONTROLS::SET_PAD_SHAKE(0, (iLocal_854 / 2), 255);
							CONTROLS::SET_PAD_SHAKE(0, (iLocal_854 / 2), 255);
						}
					}
				}
...
void func_451()
{
	...
	{
		iLocal_364 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4000, 7000));
	}
}
...
void func_453(var uParam0)
{
	...
	Var3 = { func_457(CAM::_GET_GAMEPLAY_CAM_ROT(2)) };
	Var6 = { Var0 + Var3 * FtoV(CAM::_0xD0082607100D7193()) };
...
void func_461(var uParam0)
{
	...
	else if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -982327190) != 1)
	{
		...
		uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_855 * 2);
	}
	if (!func_9())
	{
		return;
	...
	if (uParam0->f_26 == 0)
	{
		...
		uParam0->f_26 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(Var3, Var6, 511, PLAYER::PLAYER_PED_ID(), 7);
	...
	{
		iVar1 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_26, &iVar0, &Var6, &uVar9, &uVar12);
		if (iVar1 == 2)
		{
			if (iVar0 == 0 && func_9())
			{
				...
				AI::TASK_PLAY_ANIM(0, sLocal_338, "MIND_CONTROL_B_Enter", 8f, -8f, -1, 2, 0, 0, 0, 0);
				...
				uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_855);
				func_66(&(uParam0->f_17));
				uParam0->f_17 = AUDIO::GET_SOUND_ID();
				AUDIO::PLAY_SOUND_FROM_ENTITY(uParam0->f_17, "MIND_CONTROL", uParam0->f_2, "BARRY_01_SOUNDSET", 0, 0);
			}
...
{
	iLocal_563 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_564);
	bLocal_559 = true;
	CAM::_0xCCD078C2665D2973(1);
	PED::SET_PED_NAME_DEBUG(uParam0->f_2, "SUMMON");
	func_442();
	iVar0 = func_467(CONTROLS::GET_DISABLED_CONTROL_NORMAL(0, 30));
	...
	if (uParam0->f_18 > iLocal_565 || AI::GET_SCRIPT_TASK_STATUS(uParam0->f_2, 242628503) > 1)
	{
		...
		{
			AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_338, sLocal_345, 8f, -8f, -1, 0, 0, 0, 0, 0);
		}
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_338, sLocal_344, 3))
		{
			AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
			AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_338, sLocal_346, 8f, -4f, -1, 0, 0, 0, 0, 0);
	...
	if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_7)
	{
		AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_338, sLocal_347, 8f, -8f, -1, 0, 0, 0, 0, 0);
		func_66(&(uParam0->f_17));
		func_465();
	}
}
...
void func_468(var uParam0)
{
	...
	func_361(uParam0->f_2);
	AI::OPEN_SEQUENCE_TASK(&uVar0);
	AI::TASK_PLAY_ANIM(0, sLocal_338, sLocal_341, 8f, -8f, -1, 0, 0, 0, 0, 0);
	AI::TASK_PLAY_ANIM(0, sLocal_338, sLocal_343, 8f, -8f, -1, 1, 0, 0, 0, 0);
	AI::CLOSE_SEQUENCE_TASK(uVar0);
	...
	AI::OPEN_SEQUENCE_TASK(&uVar0);
	AI::TASK_PLAY_ANIM(0, sLocal_338, sLocal_342, 8f, -8f, -1, 0, 0, 0, 0, 0);
	AI::TASK_PLAY_ANIM(0, sLocal_338, sLocal_344, 8f, -8f, -1, 1, 0, 0, 0, 0);
	AI::CLOSE_SEQUENCE_TASK(uVar0);
	AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar0);
	AI::CLEAR_SEQUENCE_TASK(&uVar0);
	PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
	...
	if (iLocal_875 == 0)
	{
		...
		uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_566) + 2000;
		CAM::SET_GAMEPLAY_PED_HINT(uParam0->f_2, 0f, 0f, 0f, 1, iLocal_566 + 2000, 2000, 2000);
	}
	else
	{
		uParam0->f_7 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_566);
...
bool func_472(var uParam0)
{
	...
	return ((iLocal_560 == 1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_563) && uParam0->f_30 == iLocal_561);
}
...
int func_477(var uParam0)
{
	if (!func_481(uParam0))
	{
		...
		if (ENTITY::IS_ENTITY_DEAD(uParam0->f_2, 0) || PED::IS_PED_INJURED(uParam0->f_2))
		{
			...
			if (iLocal_873 == 0)
			{
				iLocal_874 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			}
			iLocal_873++;
...
void func_479()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_362)
	{
		return;
	}
	if (!bLocal_360)
	...
	{
		iLocal_362 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10000, 20000));
		if ((iLocal_363 - GAMEPLAY::GET_GAME_TIMER()) < 2500)
		{
			iLocal_363 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 5000));
		}
	}
}
...
void func_509()
{
	...
	if (func_522() == 1)
	{
		...
		if (func_575(PLAYER::PLAYER_PED_ID()))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_338, sLocal_344, 3))
			{
				AI::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), sLocal_338, sLocal_344, -1056964608);
			}
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_338, sLocal_342, 3))
			{
				AI::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), sLocal_338, sLocal_342, -1056964608);
			}
			ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 1, 0);
			func_435(PLAYER::PLAYER_PED_ID());
			WEAPON::REMOVE_ALL_PED_WEAPONS(PLAYER::PLAYER_PED_ID(), 1);
	...
	switch (iLocal_82)
	{
		...
		case 3:
			if (func_575(uParam0->f_28[0]))
			{
				...
				AI::TASK_PLAY_ANIM(uParam0->f_28[0], uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 9, 0, 0, 0, 0);
...
int func_537(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_87() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_148(func_535(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar72)
			{
				if (iVar8 < 51)
				{
					...
					{
						if (!DLC1::_IS_DLC_DATA_EMPTY(Var9) && !func_437(Var9.f_1))
						{
							if (iVar7 == 0)
							{
...
int func_572(int iParam0)
{
	...
	while (iVar0 < DLC1::GET_NUM_DLC_WEAPONS())
	{
		if (DLC1::GET_DLC_WEAPON_DATA(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (DLC1::_IS_DLC_DATA_EMPTY(Var1) || func_437(Var1.f_1))
				{
					return 0;
				}
			}
