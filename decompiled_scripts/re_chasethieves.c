					...
					if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iParam0))
					{
						if (fVar9 < fVar0)
						{
							if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 17))
							{
								...
								func_35("\n");
								func_31("		time since not LockedOn = ", (GAMEPLAY::GET_GAME_TIMER() - iLocal_2));
								func_35("\n");
								bVar2 = true;
...
void func_39()
{
	...
	if (func_1(PLAYER::PLAYER_PED_ID()) && func_1(iLocal_87))
	{
		switch (iLocal_202)
		{
			...
			case 1:
				STREAMING::REQUEST_ANIM_DICT(sLocal_227);
				STREAMING::REQUEST_MODEL(-1379254308);
				func_218(0);
				func_217();
				if (((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) && !func_216()) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_227)) && STREAMING::HAS_MODEL_LOADED(-1379254308))
				{
					if (iLocal_591 == -1)
					{
					...
					if (!PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_87) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_591) > 2000)
					{
						...
						uLocal_173 = OBJECT::CREATE_OBJECT(-1379254308, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1, 1, 0);
						...
						func_100(&iVar8, 0);
						GAMEPLAY::CLEAR_AREA_OF_OBJECTS(Var0, 20f, 2);
						GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(Var0, 20f, 0);
						GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Var0, 5f, 0, 0, 0, 0, 0, 0);
						GAMEPLAY::CLEAR_AREA(Var0, 2f, 1, 0, 0, 0);
						GAMEPLAY::CLEAR_AREA(PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_227, sLocal_229, Var0, Var3, 0, 2), 2f, 1, 0, 0, 0);
			...
			case 2:
				...
				if (((PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_200) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_200) == 1f) || func_94()) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), -571081548))
				{
					...
					func_89(&uLocal_173);
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1379254308);
				...
				else
				{
					...
					{
						if ((ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_173, PLAYER::PLAYER_PED_ID()) && iLocal_247 == 0) && func_98(&uLocal_248, "RECHAAU", sVar6, sVar7, 4, 0, 0))
						{
...
void func_45(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_47()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_47()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UI::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_46(iParam0));
...
bool func_53(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_47()].f_6174.f_10, iParam0);
}
...
void func_90()
{
	...
	{
		func_92(iLocal_87, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), 0f, 2f, 1f), uLocal_180, 1, 1);
		PED::_0x2208438012482A1A(iLocal_87, 0, 0);
...
void func_101(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_102(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_113(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_113(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_113(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_145(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_113(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_113(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_113(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_113(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_130(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_137(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_137(Var16.z)] = func_130(iParam1, Var16.x, func_137(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_137(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
...
void func_159(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_153(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_153(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_113(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_214(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_113(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_113(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_248()
{
	if (iLocal_72 == 1)
	{
		...
		if (func_1(iLocal_87) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_87, sLocal_589, "pickup_low", 3))
		{
			...
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_177, 1f, 20000, 0.25f, 0, 1193033728);
			}
			AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
			AI::CLOSE_SEQUENCE_TASK(uLocal_186);
			AI::TASK_PERFORM_SEQUENCE(iLocal_87, uLocal_186);
	...
	else if ((((bLocal_69 == 0 && OBJECT::DOES_PICKUP_EXIST(uLocal_588)) && func_1(iLocal_87)) && ENTITY::IS_ENTITY_AT_COORD(iLocal_87, OBJECT::GET_PICKUP_COORDS(uLocal_588), 15f, 15f, 2f, 0, 1, 0)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_87, sLocal_583, sLocal_584, 3))
	{
		...
		Var0 = { OBJECT::GET_PICKUP_COORDS(uLocal_588) - Vector(15f, 15f, 15f) };
		Var3 = { OBJECT::GET_PICKUP_COORDS(uLocal_588) + Vector(15f, 15f, 15f) };
		if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_589) && !PED::IS_ANY_PED_SHOOTING_IN_AREA(Var0, Var3, 0, 1))
		{
			...
			if (!func_93(iLocal_87, 242628503))
			{
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, OBJECT::GET_PICKUP_COORDS(uLocal_588), 2f, 20000, 0.25f, 0, 1193033728);
				}
				AI::TASK_TURN_PED_TO_FACE_COORD(0, OBJECT::GET_PICKUP_COORDS(uLocal_588), 0);
				AI::TASK_PLAY_ANIM(0, sLocal_589, "pickup_low", 8f, -8f, -1, 0, 0, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(uLocal_186);
				AI::TASK_PERFORM_SEQUENCE(iLocal_87, uLocal_186);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_186);
			}
...
void func_250()
{
	...
	{
		Local_240 = { OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_82, 0), 1067030938, 1069547520) };
		GAMEPLAY::SET_BIT(&uLocal_221, 3);
		GAMEPLAY::SET_BIT(&uLocal_221, 4);
		GAMEPLAY::SET_BIT(&uLocal_221, 1);
		uLocal_588 = OBJECT::CREATE_PICKUP(1575005502, Local_240, uLocal_221, iLocal_199, 1, iLocal_226);
		func_247();
...
void func_251()
{
	...
	{
		if (GAMEPLAY::IS_BULLET_IN_AREA(Local_62, 50f, 0))
		{
			func_224(0);
...
void func_252()
{
	if (func_1(iLocal_87))
	{
		...
		switch (iLocal_77)
		{
			...
			case 1:
				if (((!func_216() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_78) > 1000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_PCA", 4, 0, 0, 0))
				{
					iLocal_78 = GAMEPLAY::GET_GAME_TIMER();
					iLocal_220 = 2;
					iLocal_77++;
			...
			case 2:
				if (((!func_216() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_78) > 5000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_PCB", 4, 0, 0, 0))
				{
					iLocal_78 = GAMEPLAY::GET_GAME_TIMER();
					iLocal_220 = 3;
					iLocal_77++;
			...
			case 3:
				if (((!func_216() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_78) > 6000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_PCC", 4, 0, 0, 0))
				{
					iLocal_78 = GAMEPLAY::GET_GAME_TIMER();
					iLocal_220 = 4;
					iLocal_77++;
			...
			case 4:
				if (((!func_216() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_78) > 6000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 15f, 15f, 15f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_PCD", 4, 0, 0, 0))
				{
					iLocal_220 = 5;
					iLocal_77++;
				}
...
void func_257()
{
	switch (iLocal_61)
	{
		...
		case 3:
			...
			if (((((((iLocal_75 < 4 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_76) > 10000) && func_1(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_216()) && !PED::IS_PED_INJURED(iLocal_82)) && func_255(PLAYER::PLAYER_PED_ID(), iLocal_82, 1) < 40f) && func_5(&uLocal_248, "RECHAAU", "RECHA_YELL", 4, 0, 0, 0))
			{
				iLocal_75++;
				iLocal_76 = GAMEPLAY::GET_GAME_TIMER();
			}
...
void func_258()
{
	if (((((((iLocal_191 == 1 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_80) > 8000) && !func_216()) && func_1(iLocal_82)) && func_1(iLocal_87)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_82, 20f, 20f, 20f, 0, 1, 0)) && !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_82, iLocal_87, 30f, 30f, 30f, 0, 1, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_taunt", 4, 0, 0, 0))
	{
		iLocal_80 = GAMEPLAY::GET_GAME_TIMER();
	}
}
...
int func_262()
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_97[0], 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_97[1], 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_100[0]))
		{
			...
			if (AI::GET_SCRIPT_TASK_STATUS(iLocal_100[0], -1273030092) == 1)
			{
				if (!AI::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_100[0]))
				{
					AI::TASK_DRIVE_BY(iLocal_100[0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 70, 1, -753768974);
				}
			}
		}
		if (!PED::IS_PED_INJURED(iLocal_100[1]))
		{
			if (AI::GET_SCRIPT_TASK_STATUS(iLocal_100[1], -1273030092) == 1)
			{
				if (!AI::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_100[1]))
				{
					AI::TASK_DRIVE_BY(iLocal_100[1], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 70, 1, -753768974);
				}
			}
		}
		return 1;
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (VEHICLE::_0xA4822F1CF23F4810(&Var6, &Var0, &Var3, 0, 1127481344, 75f, 0, 1, 1))
				{
					...
					while (iLocal_188 < 2)
					{
						...
						uLocal_97[iLocal_188] = VEHICLE::CREATE_VEHICLE(301427732, Var0, Var3.z, 1, 1, 0);
						...
						{
							AI::TASK_VEHICLE_MISSION(iLocal_100[iLocal_188], uLocal_97[iLocal_188], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iVar9, 40f, 786469, 5f, 10f, 1);
						}
						else
						{
							AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_100[iLocal_188], uLocal_97[iLocal_188], PLAYER::PLAYER_PED_ID(), iVar9, 40f, 786469, 5f, 10f, 1);
						}
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_100[iLocal_188], 2017895192, 999999, 1, 1);
						VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_97[iLocal_188], ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()));
						iVar9 = 11;
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_103[iLocal_188], 2017895192, 999999, 1, 1);
						AI::TASK_DRIVE_BY(iLocal_103[iLocal_188], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 70, 0, -753768974);
...
int func_274(char* sParam0)
{
	if (!func_275(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_228(sParam0)) || func_228("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_275(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_282() || func_281(Global_4456448.f_232883)) || func_280())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_278(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_297(var uParam0)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_298(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return uVar0;
}
...
void func_304()
{
	...
	else
	{
		...
		if (func_1(iLocal_87))
		{
			...
			{
				AI::OPEN_SEQUENCE_TASK(&uLocal_186);
				AI::TASK_PLAY_ANIM(0, sLocal_583, sLocal_584, 8f, -4f, 8200, 0, 0, 0, 0, 0);
				if (func_1(iLocal_82))
				{
					...
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_177, 2f, 20000, 2f, 8192, 1193033728);
					AI::TASK_PLAY_ANIM(0, sLocal_586, sLocal_587, 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
				AI::CLOSE_SEQUENCE_TASK(uLocal_186);
				AI::TASK_PERFORM_SEQUENCE(iLocal_87, uLocal_186);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_186);
...
void func_308(var uParam0, var uParam1)
{
	if (UI::DOES_BLIP_EXIST(uParam0))
	{
		...
		if (!UI::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_309(0))
		{
			func_244(1);
		}
	}
...
int func_313(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
	{
		UI::SET_BLIP_SCALE(uVar0, func_298(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
...
int func_322()
{
	if (iLocal_203 == 1)
	{
		...
		fVar6 = 167.5f;
		if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var0, Var3, fVar6, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_204, 20f, 20f, 20f, 0, 1, 0)) || GAMEPLAY::IS_BULLET_IN_ANGLED_AREA(Var0, Var3, fVar6, 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(Var0, Var3, fVar6, -1312131151, 0)) || PED::IS_PED_INJURED(iLocal_82))
		{
			return 1;
		}
	}
	else if (iLocal_203 == 2)
	{
		...
		fVar6 = 100f;
		if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var0, Var3, fVar6, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_207, 20f, 20f, 20f, 0, 1, 0)) || GAMEPLAY::IS_BULLET_IN_ANGLED_AREA(Var0, Var3, fVar6, 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(Var0, Var3, fVar6, -1312131151, 0)) || PED::IS_PED_INJURED(iLocal_82))
		{
			return 1;
		}
	}
	else if (iLocal_203 == 3)
	{
		...
		fVar6 = 96.75f;
		if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var0, Var3, fVar6, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_177, 20f, 20f, 20f, 0, 1, 0)) || GAMEPLAY::IS_BULLET_IN_ANGLED_AREA(Var0, Var3, fVar6, 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(Var0, Var3, fVar6, -1312131151, 0)) || PED::IS_PED_INJURED(iLocal_82))
		{
			return 1;
		}
	}
...
void func_336()
{
	GAMEPLAY::CLEAR_AREA(Local_88, 20f, 1, 0, 0, 0);
	...
	switch (iLocal_203)
	{
		case 1:
			...
			WEAPON::GIVE_WEAPON_TO_PED(iLocal_83, 453432689, -1, 0, 1);
			WEAPON::GIVE_WEAPON_TO_PED(iLocal_82, 453432689, -1, 0, 1);
			func_337(iLocal_83);
			func_337(iLocal_82);
			break;
		...
		case 2:
			iLocal_83 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_92, 22, iLocal_222, -1, 1, 1);
			WEAPON::GIVE_WEAPON_TO_PED(iLocal_83, 2017895192, -1, 0, 1);
			WEAPON::GIVE_WEAPON_TO_PED(iLocal_82, 453432689, -1, 0, 1);
			func_337(iLocal_83);
			func_337(iLocal_82);
			break;
		...
		case 3:
			...
			if (iLocal_224 == -1745203402)
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_84, 453432689, -1, 0, 1);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_85, 453432689, -1, 0, 1);
				func_337(iLocal_84);
				func_337(iLocal_85);
			}
			break;
	...
	Local_237 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_580, sLocal_582, Local_231, Local_234, 0, 2) };
	ENTITY::SET_ENTITY_HEADING(iLocal_82, Local_237.z);
	...
	Local_237 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_580, sLocal_581, Local_231, Local_234, 0, 2) };
	ENTITY::SET_ENTITY_HEADING(iLocal_87, Local_237.z);
	...
	if (iLocal_203 == 2)
	{
		...
		Var3[0] = { 381.5702f, -867.3578f, 28.1573f };
		Var3[1] = { 379.5334f, -867.1062f, 28.1713f };
		fVar10[0] = 236.3457f;
		fVar10[1] = 232.1922f;
		iLocal_188 = 0;
		while (iLocal_188 <= 1)
		{
			uVar0[iLocal_188] = VEHICLE::CREATE_VEHICLE(iLocal_224, Var3[iLocal_188], fVar10[iLocal_188], 1, 1, 0);
	...
	GAMEPLAY::SET_BIT(&iLocal_217, 5);
	GAMEPLAY::SET_BIT(&iLocal_217, 4);
	GAMEPLAY::SET_BIT(&iLocal_217, 0);
	GAMEPLAY::SET_BIT(&iLocal_217, 1);
	if (iLocal_579 == 0)
	{
		iLocal_579 = DECISIONEVENT::ADD_SHOCKING_EVENT_AT_POSITION(101, Local_62, 60000f);
	}
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_392()) || Global_30770) || func_391()) || func_25(8, -1)) || func_388()) || func_390()) || func_389()) || func_387()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_392()) || Global_110685) || Global_30770) || func_391()) || func_25(8, -1)) || func_390()) || func_389()) || func_387()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_392()) || Global_30770) || func_391()) || func_25(8, -1)) || func_389()) || func_388()) || func_387()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_392()) || func_389()) || Global_110685) || Global_30770) || func_391()) || Global_42596) || func_25(8, -1)) || func_388()) || func_386()) || func_387()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_392()) || Global_110685) || Global_30770) || func_391()) || func_25(8, -1)) || func_388()) || func_386()) || func_390()) || func_389()) || func_387())
						{
							return 0;
						}
						break;
...
Vector3 func_401()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_204, 1);
		iLocal_203 = 1;
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_207, 1) < fVar0)
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_207, 1);
			iLocal_203 = 2;
		}
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_210, 1) < fVar0)
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_210, 1);
			iLocal_203 = 3;
		}
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_213, 1) < fVar0)
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_213, 1);
			iLocal_203 = 4;
		}
		if (iLocal_203 == 1)
		{
...
int func_415()
{
	if ((Global_111627 == func_358() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_111628)
	{
		return 1;
	}
	return 0;
