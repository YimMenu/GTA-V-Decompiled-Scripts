...
void func_11()
{
	...
	while (iVar5 < 7)
	{
		if (iLocal_55[iVar5] != -1)
		{
			...
			{
				fVar6 = MISC::GET_DISTANCE_BETWEEN_COORDS(Var0, HUD::GET_BLIP_COORDS(Global_31346[iLocal_55[iVar5] /*23*/].f_19), true);
				if (fVar6 < fVar4)
				{
					fVar4 = fVar6;
					iVar3 = iVar5;
...
{
	if (iLocal_68 && MISC::IS_BIT_SET(Global_31346[iParam0 /*23*/].f_11, 13))
	{
		MISC::SET_BIT(&(Global_31346[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if (iLocal_69 && ((MISC::IS_BIT_SET(Global_31346[iParam0 /*23*/].f_11, 7) || MISC::IS_BIT_SET(Global_31346[iParam0 /*23*/].f_11, 11)) || MISC::IS_BIT_SET(Global_31346[iParam0 /*23*/].f_11, 16)))
	{
		MISC::SET_BIT(&(Global_31346[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if (iLocal_70 && MISC::IS_BIT_SET(Global_31346[iParam0 /*23*/].f_11, 14))
	{
		MISC::SET_BIT(&(Global_31346[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if (iLocal_65 && ((MISC::IS_BIT_SET(Global_31346[iParam0 /*23*/].f_11, 10) || MISC::IS_BIT_SET(Global_31346[iParam0 /*23*/].f_11, 8)) || MISC::IS_BIT_SET(Global_31346[iParam0 /*23*/].f_11, 19)))
	{
		MISC::SET_BIT(&(Global_31346[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	...
	if (iLocal_72 && MISC::IS_BIT_SET(Global_31346[iParam0 /*23*/].f_11, 27))
	{
		MISC::SET_BIT(&(Global_31346[iParam0 /*23*/].f_11), 18);
		return 1;
	}
	if ((iLocal_73 && (MISC::IS_BIT_SET(Global_31346[iParam0 /*23*/].f_11, 1) || MISC::IS_BIT_SET(Global_31346[iParam0 /*23*/].f_11, 2))) || Global_31346[iParam0 /*23*/].f_16 == 1)
	{
		MISC::SET_BIT(&(Global_31346[iParam0 /*23*/].f_11), 18);
		return 1;
	}
