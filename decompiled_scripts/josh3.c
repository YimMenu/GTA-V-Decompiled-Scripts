...
void func_125(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_118(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_118(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_198()
{
	...
	{
		func_187();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_199(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
		...
		case 1:
			...
			if (func_16(PLAYER::PLAYER_PED_ID()))
			{
				...
				else
				{
					...
					while (iVar0 < 3)
					{
						if ((((Local_871[iVar0].f_13 == 0 && iVar0 > iLocal_933) && (MISC::GET_GAME_TIMER() - iLocal_853) > 500) && !func_295(Local_871[iVar0].f_14)) && func_294(Local_871[iVar0].f_14, Local_871[iVar0].f_17))
						{
							func_289(iVar0);
						}
						iVar0++;
					...
					if (Local_871[2].f_13 == 1)
					{
						...
						else if ((MISC::GET_GAME_TIMER() - iLocal_854) > 1500)
						{
							iLocal_586 = 2;
						}
...
void func_273()
{
	...
	{
		if (HUD::DOES_BLIP_EXIST(Local_269[iVar0].f_3))
		{
			HUD::REMOVE_BLIP(&(Local_269[iVar0].f_3));
		}
	...
	while (iVar0 < Local_269)
	{
		...
		if (!HUD::DOES_BLIP_EXIST(Local_269[iVar0].f_3))
		{
			if (!func_277(Local_269[iVar0], 0f, 0f, 0f, 0))
			{
				...
				HUD::SET_BLIP_HIDDEN_ON_LEGEND(Local_269[iVar0].f_3, 1);
				HUD::SET_BLIP_SCALE(Local_269[iVar0].f_3, 0.4f);
				HUD::SHOW_HEIGHT_ON_BLIP(Local_269[iVar0].f_3, 0);
				if (!bParam0)
				{
					HUD::SET_BLIP_ALPHA(Local_269[iVar0].f_3, 0);
				}
				HUD::SET_BLIP_COLOUR(Local_269[iVar0].f_3, 5);
			}
		}
		else
		{
			Local_269[iVar0] = { HUD::GET_BLIP_COORDS(Local_269[iVar0].f_3) };
			if (!bParam0)
			{
				HUD::SET_BLIP_ALPHA(Local_269[iVar0].f_3, 0);
			}
			...
			{
				HUD::SET_BLIP_ALPHA(Local_269[iVar0].f_3, 255);
			}
			iLocal_94++;
		}
		Local_269[iVar0].f_4 = 0;
...
int func_275(struct<3> Param0, int iParam3)
{
	...
	HUD::SET_BLIP_SCALE(uVar0, func_276(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
void func_280()
{
	...
	if (bLocal_262 == 0)
	{
		if (FIRE::GET_CLOSEST_FIRE_POS(&Var1, Local_269[0]))
		{
			...
			while (iVar0 < Local_269)
			{
				if (iVar0 > 0)
				{
					fVar4 = (fVar4 + MISC::GET_DISTANCE_BETWEEN_COORDS(Local_269[(iVar0 - 1)], Local_269[iVar0], 1));
				}
				if (Local_269[iVar0].f_4)
				{
					if (FIRE::GET_CLOSEST_FIRE_POS(&Var1, Local_269[iVar0]))
					{
						fVar6 = MISC::GET_DISTANCE_BETWEEN_COORDS(Local_269[iVar0], Var1, 1);
						if (fVar6 < fVar7)
						{
							fVar7 = fVar6;
							fVar8 = fVar4;
	...
	if (bLocal_262 == 1)
	{
		...
		while (iVar0 < Local_106)
		{
			if ((MISC::GET_GAME_TIMER() - Local_106[iVar0].f_4) > 1000)
			{
				GRAPHICS::FADE_DECALS_IN_RANGE(Local_106[iVar0].f_1, 0.4f, 1f);
			}
			if ((MISC::GET_GAME_TIMER() - Local_106[iVar0].f_4) > 6000)
			{
				FIRE::REMOVE_SCRIPT_FIRE(Local_106[iVar0]);
			}
			iVar0++;
...
void func_282(struct<3> Param0, int iParam3)
{
	...
	Local_106[iLocal_266].f_4 = MISC::GET_GAME_TIMER();
				...
				if (MISC::GET_GAME_TIMER() > iLocal_96)
				{
					if (!bLocal_86)
					{
						...
						while (iVar0 < Local_269)
						{
							if (HUD::DOES_BLIP_EXIST(Local_269[iVar0].f_3))
							{
								fVar2 = MISC::GET_DISTANCE_BETWEEN_COORDS(Local_99, HUD::GET_BLIP_COORDS(Local_269[iVar0].f_3), 1);
								fVar3 = MISC::GET_DISTANCE_BETWEEN_COORDS(Local_269[iVar0], HUD::GET_BLIP_COORDS(Local_269[iVar0].f_3), 1);
							...
							if (iLocal_92 != -1)
							{
								...
								if (MISC::ABSI((iLocal_93 - iVar5)) < 3 && MISC::ABSI((iLocal_93 - iVar5)) > 0)
								{
									if (iLocal_93 < iVar5)
									{
										...
										while (iVar6 <= (iVar5 - 1))
										{
											if (HUD::DOES_BLIP_EXIST(Local_269[iVar6].f_3))
											{
												if (HUD::GET_BLIP_ALPHA(Local_269[iVar6].f_3) > 0)
												{
													HUD::SET_BLIP_ALPHA(Local_269[iVar6].f_3, 0);
								...
								if (iVar5 == 0)
								{
									if (HUD::DOES_BLIP_EXIST(Local_269[iVar5].f_3))
									{
										if (HUD::GET_BLIP_ALPHA(Local_269[iVar5].f_3) > 0)
										{
											HUD::SET_BLIP_ALPHA(Local_269[iVar5].f_3, 0);
...
void func_287(int iParam0)
{
	if (Local_934 == 0)
	{
		...
		else if ((MISC::GET_GAME_TIMER() - Local_934.f_1) > 500)
		{
			func_288(iParam0);
		}
	}
	...
	if (iLocal_932 == 0)
	{
		...
		if (func_16(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			else
			{
				...
				fVar3 = MISC::GET_ANGLE_BETWEEN_2D_VECTORS(Var0.x, Var0.y, Local_618.x, Local_618.y);
				fVar3 = (fVar3 + 180f);
...
void func_291(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_292(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_298(int iParam0)
{
	...
	{
		fVar4 = MISC::GET_DISTANCE_BETWEEN_COORDS(Var0, Local_269[iVar5], 1);
		if (fVar4 < fVar3)
		{
	...
	if (iParam0 == 1)
	{
		if (iLocal_87 == 0)
		{
			...
			while (iVar0 < Local_269)
			{
				if (HUD::DOES_BLIP_EXIST(Local_269[iVar0].f_3))
				{
					if (HUD::GET_BLIP_ALPHA(Local_269[iVar0].f_3) < 255)
					{
						HUD::REMOVE_BLIP(&(Local_269[iVar0].f_3));
					}
					else
...
void func_311()
{
	if ((((iLocal_843 < 3 && (MISC::GET_GAME_TIMER() - iLocal_857) > 10000) && func_246(1)) && func_312()) && func_256(&uLocal_662, "JOSH3AU", "JOSH3_POUR", 8, 0, 0, 0))
	{
		iLocal_843++;
		iLocal_857 = MISC::GET_GAME_TIMER();
	}
...
void func_318()
{
	if (iLocal_642 == 0)
	{
		...
		else if ((MISC::GET_GAME_TIMER() - iLocal_852) > 7500)
		{
			func_320("JOSH3_03");
			iLocal_642 = 1;
		}
...
void func_352(int iParam0, var uParam1)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::_GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_354(Var11.f_1)) && iVar72 < 51)
			{
...
int func_364(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_8() == 0)
		{
			return MISC::IS_BIT_SET(func_102(func_365(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_367(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_382(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_368(iVar0, 0), 1);
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_390(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_402()
{
	if (iLocal_834 == 0)
	{
		if ((((func_246(1) && iLocal_833 == 1) && iLocal_849 > -1) && (MISC::GET_GAME_TIMER() - iLocal_849) > 15000) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			func_248(&uLocal_662, 3, 0, "JOSH", 0, 1);
	...
	else
	{
		if (iLocal_835 == 0 && func_246(1))
		{
			...
			else if ((MISC::GET_GAME_TIMER() - iLocal_856) > 2000)
			{
		...
		if (iLocal_836 == 0)
		{
			...
			else if ((MISC::GET_GAME_TIMER() - iLocal_855) > 5000)
			{
...
void func_419()
{
	if (iLocal_830 == 0)
	{
		if (((((MISC::GET_GAME_TIMER() - iLocal_848) > 25000 && func_246(1)) && func_16(iLocal_988)) && func_251(PLAYER::PLAYER_PED_ID(), 566.53f, -1770.4f, 28.35f, 10f)) && func_256(&uLocal_662, "JOSH3AU", "JOSH3_REMIND", 8, 0, 0, 0))
		{
			iLocal_830 = 1;
			iLocal_831 = 0;
		}
	...
	else if (iLocal_831 == 0)
	{
		...
		{
			Var0 = { func_423() };
			if (((MISC::ARE_STRINGS_EQUAL(&Var0, "JOSH3_REMIND") && func_16(PLAYER::PLAYER_PED_ID())) && func_16(iLocal_988)) && func_422(PLAYER::PLAYER_PED_ID(), iLocal_988, 1) > 30f)
			{
				func_420();
				iLocal_831 = 1;
			}
	...
	switch (uParam4->f_3)
	{
		...
		case 2:
			...
			if (fVar0 >= 0.99f || fVar0 == -1f)
			{
				...
				CLOCK::SET_CLOCK_TIME(func_505(iVar5), func_491(iVar5), func_490(iVar5));
				if (bParam7)
				{
					GRAPHICS::_0x03FC694AE06C5A20();
				}
			...
			CLOCK::SET_CLOCK_TIME(func_505(iVar5), func_491(iVar5), func_490(iVar5));
			if (func_488(iVar5) != CLOCK::GET_CLOCK_DAY_OF_MONTH())
			{
				CLOCK::SET_CLOCK_DATE(func_488(iVar5), func_391(iVar5), func_389(iVar5));
			}
			func_486();
...
{
	uParam0->f_1 = (func_497(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
float func_498(var uParam0)
{
	if (func_500(uParam0))
	{
		...
		{
			return (func_497(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
void func_516(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_517(iParam0) && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_89532[26].f_6) == 0)
			{
				Global_111638.f_7256[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_111638.f_7256[iParam0], 1, 1);
			}
...
void func_520()
{
	if ((((((iLocal_847 > -1 && (MISC::GET_GAME_TIMER() - iLocal_847) > 15000) && func_246(1)) && func_16(PLAYER::PLAYER_PED_ID())) && func_16(iLocal_988)) && func_422(PLAYER::PLAYER_PED_ID(), iLocal_988, 1) < 20f) && func_256(&uLocal_662, "JOSH3AU", "JOSH3_HANG", 8, 0, 0, 0))
	{
...
void func_521()
{
	...
	else if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_612, Global_22, HUD::DOES_BLIP_EXIST(uLocal_651), 1, 0))
	{
		func_479();
		iLocal_586 = 2;
	}
	...
	{
		if ((MISC::GET_GAME_TIMER() - iLocal_846) > 2000 && !func_247())
		{
	...
	if (func_603(uParam0))
	{
		...
		if (func_602(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_579(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_277(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_584(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_340(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_340(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_340(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == 340154634 || uParam1->f_66 == -1960756985)
		{
			...
			while (iVar2 <= 9)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_340(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_340(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_340(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_340(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (MISC::IS_BIT_SET(uParam1->f_77, func_340(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_340(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_592(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_591())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_340(iVar5 + 1)))
				{
