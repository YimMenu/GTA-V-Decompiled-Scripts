...
void func_202(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_203(UI::_SET_NOTIFICATION_MESSAGE(&cVar2, &cVar2, 0, 2, UI::_GET_LABEL_TEXT(func_204(iParam1)), 0));
		}
		else
		{
			func_203(UI::_SET_NOTIFICATION_MESSAGE("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, UI::_GET_LABEL_TEXT(func_204(iParam1)), 0));
		}
		switch (Global_19486)
		{
			case 0:
...
void func_229(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_231(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
		...
		case 1:
			if (func_272(PLAYER::PLAYER_PED_ID(), Local_86.f_28[0], 1) >= 4.5f)
			{
				if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
				{
					...
					CAM::_0xF8BDBF3D573049A1(fLocal_316);
					CAM::_0xD1F8363DFAD03848(fLocal_317);
					CAM::_0x5D7B620DAE436138(fLocal_318);
					CAM::_0xC92717EF615B6704(fLocal_319);
			...
			if (iLocal_314 == 0)
			{
				if (func_272(PLAYER::PLAYER_PED_ID(), Local_86.f_28[0], 1) <= 2.5f)
				{
					...
					AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_86.f_28[0], 0);
					iLocal_314 = 1;
				}
			}
				...
				if (func_244(Local_86.f_28[0]))
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_86.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_86.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall") < 0.1f)
						{
							...
							AI::TASK_LOOK_AT_ENTITY(Local_86.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 12, 2);
							AI::TASK_PLAY_ANIM(Local_86.f_28[0], "rcmepsilonism5", "leadin_action", 8f, -8f, -1, 2, 0, 0, 0, 0);
							iLocal_84 = 2;
						}
					}
				}
