...
void func_28()
{
	switch (iLocal_146)
	{
		case 0:
			...
			iLocal_322 = GAMEPLAY::GET_GAME_TIMER() + 7500;
		...
		case 1:
			...
			{
				if ((!func_237() && func_236(Local_83.f_28[0])) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_323) > 5000)
				{
					if (UI::IS_MESSAGE_BEING_DISPLAYED())
					{
						if (func_2(&uLocal_148, "EPS3AUD", "EP3_FOLLOW", 8, 1, 0, 0))
						{
							iLocal_322 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_325++;
						}
					}
			...
			else if ((!UI::IS_MESSAGE_BEING_DISPLAYED() && !func_237()) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_322) > iLocal_324)
			{
			...
			if (func_236(Local_83.f_28[0]))
			{
				if (func_237())
				{
					if (iLocal_325 < 5)
					{
						...
						{
							AI::TASK_LOOK_AT_ENTITY(Local_83.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						}
					}
				}
				else if (PED::IS_PED_HEADTRACKING_PED(Local_83.f_28[0], PLAYER::PLAYER_PED_ID()))
				{
					AI::TASK_CLEAR_LOOK_AT(Local_83.f_28[0]);
				}
				...
				if ((((((GRAPHICS::_0x2F09F7976C512404(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), 5f) || GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), 5f, 0)) || GAMEPLAY::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), -1568386805, 5f, 0)) || GAMEPLAY::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), -1312131151, 5f, 0)) || GAMEPLAY::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), -1813897027, 5f, 0)) || GAMEPLAY::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), 615608432, 5f, 0)) || GAMEPLAY::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), 1233104067, 5f, 0))
				{
					AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
					AI::OPEN_SEQUENCE_TASK(&uLocal_318);
					AI::TASK_PLAY_ANIM(0, "rcmepsilonism3", "outro", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uLocal_318);
					AI::TASK_PERFORM_SEQUENCE(Local_83.f_28[0], uLocal_318);
					iLocal_313 = 3;
					func_314(2);
				}
...
void func_29()
{
	...
	{
		Global_111638.f_10044.f_104 = TIME::GET_CLOCK_DAY_OF_MONTH();
	}
...
void func_186()
{
	...
	{
		func_15();
		GRAPHICS::_0xBF59707B3E5ED531(func_187(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
...
void func_227(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_228(UI::_SET_NOTIFICATION_MESSAGE(&cVar2, &cVar2, 0, 2, UI::_GET_LABEL_TEXT(func_229(iParam1)), 0));
		}
		else
		{
			func_228(UI::_SET_NOTIFICATION_MESSAGE("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, UI::_GET_LABEL_TEXT(func_229(iParam1)), 0));
		}
		switch (Global_19486)
		{
			case 0:
	...
	switch (iLocal_146)
	{
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_147, 0))
			{
				if (func_236(Local_83.f_28[0]))
				{
					AI::TASK_PLAY_ANIM(Local_83.f_28[0], sLocal_144, "base_loop", 1000f, -8f, -1, 262145, 0.01f, 0, 0, 0);
		...
		case 2:
			...
			if (func_236(Local_83.f_28[0]))
			{
				AI::TASK_PLAY_ANIM(Local_83.f_28[0], sLocal_144, "base_loop", 1000f, -8f, -1, 262145, 0, 0, 0, 0);
				func_254(Local_83.f_28[0], 1843.82f, 4705.74f, 40.8f, 143.14f, 1, 1);
			}
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("MICHAEL", 0))
			{
...
void func_287()
{
	...
	switch (iLocal_146)
	{
		case 0:
			...
			UI::REQUEST_ADDITIONAL_TEXT("EPS3", 0);
			while (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_144) && !UI::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				SYSTEM::WAIT(0);
			}
			if (func_246(PLAYER::PLAYER_PED_ID()))
			...
			AI::OPEN_SEQUENCE_TASK(&uLocal_317);
			...
			AI::CLOSE_SEQUENCE_TASK(uLocal_317);
			if (func_238(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) >= 4f)
			{
				if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
				{
					if (func_236(Local_83.f_28[0]))
					{
						...
						CAM::_0xF8BDBF3D573049A1(fLocal_327);
						CAM::_0xD1F8363DFAD03848(fLocal_328);
						CAM::_0x5D7B620DAE436138(fLocal_329);
						CAM::_0xC92717EF615B6704(fLocal_330);
		...
		case 1:
			if (func_236(Local_83.f_28[0]))
			{
				if (iLocal_316 == 0)
				{
					if (((func_238(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) <= 3f && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1847.705f, 4703.014f, 36.58427f, 1844.084f, 4709.532f, 39.73755f, 5f, 0, 1, 0)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1842.977f, 4705.946f, 36.78089f, 1842.161f, 4707.852f, 40.10524f, 2.5f, 0, 1, 0)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1843.527f, 4704.969f, 36.83727f, 1844.178f, 4703.326f, 40.25331f, 2.5f, 0, 1, 0))
					{
						...
						AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 0);
						AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 7000, 0, 2);
						iLocal_316 = 1;
					}
				}
				if (func_238(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) >= 4f)
			...
			if (!bLocal_314)
			{
				...
				{
					AI::TASK_LOOK_AT_ENTITY(Local_83.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					AI::TASK_PLAY_ANIM(Local_83.f_28[0], sLocal_144, "leadin", 8f, -8f, -1, 786434, 0, 0, 0, 0);
				}
			}
			else if (!func_237())
			{
