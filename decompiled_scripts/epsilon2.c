...
void func_17(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_18(iParam0) && SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_89532[26].f_6) == 0)
			{
				Global_111638.f_7256[iParam0] = 1;
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_111638.f_7256[iParam0], 1, 1);
			}
...
var func_20()
{
	func_30(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_29(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_28(&uVar0, TIME::GET_CLOCK_HOURS());
	func_23(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_22(&uVar0, TIME::GET_CLOCK_MONTH());
	func_21(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_26(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_76434[1].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_72(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_104(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_72(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
void func_82(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_83(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
		...
		if (!DLC1::_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (DLC1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &Var16) && Var16.z != -1)
				{
					...
					{
						(*iParam0)[Var16.z] = func_89(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.y != -1)
					{
		...
		while (iVar36 < Var1.f_4)
		{
			if (DLC1::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_96(Var16.z)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_96(Var16.z)] = func_89(iParam1, Var16.x, func_96(Var16.z), iVar0);
					}
				}
				else if (Var16.y != -1)
				{
					(*uParam0)[func_96(Var16.z)] = Var16.y;
				}
			}
			iVar36++;
		}
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_72(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_176(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_72(iParam1)) && Global_76434[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_72(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_183(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((((((((((((((func_184(Var18[0], Var18[1], Var6, Var9) || func_184(Var18[0], Var18[1], Var9, Var15)) || func_184(Var18[0], Var18[1], Var12, Var15)) || func_184(Var18[0], Var18[1], Var6, Var12)) || func_184(Var18[1], Var18[3], Var6, Var9)) || func_184(Var18[1], Var18[3], Var9, Var15)) || func_184(Var18[1], Var18[3], Var12, Var15)) || func_184(Var18[1], Var18[3], Var6, Var12)) || func_184(Var18[3], Var18[2], Var6, Var9)) || func_184(Var18[3], Var18[2], Var9, Var15)) || func_184(Var18[3], Var18[2], Var12, Var15)) || func_184(Var18[3], Var18[2], Var6, Var12)) || func_184(Var18[2], Var18[0], Var6, Var9)) || func_184(Var18[2], Var18[0], Var9, Var15)) || func_184(Var18[2], Var18[0], Var12, Var15)) || func_184(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_210(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_217(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_255()
{
	...
	if (iVar0 < 4)
	{
		STATS::STAT_SET_INT(-1016034844, 4, 1);
		func_320(23, 4);
	}
	func_256(74, 0);
}
...
int func_281(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_72(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_72(iParam1), Global_76434[1].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, 0);
		}
	}
...
void func_289()
{
	...
	{
		func_8();
		GRAPHICS::_0xBF59707B3E5ED531(func_290(Global_111638.f_2358.f_539.f_4321));
	}
	else
	{
