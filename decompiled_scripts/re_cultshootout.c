...
void func_24()
{
	...
	switch (iLocal_47)
	{
		...
		case 1:
			...
			else if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_48, 100f, 100f, 100f, 0, 1, 0))
			{
				func_25();
			}
			break;
...
void func_29(int iParam0, int iParam1)
{
	...
	if (iParam1 <= func_52(iParam0))
	{
		...
		{
			func_31(func_37(iParam0, iParam1), Local_43.x, Local_43.y);
		}
...
int func_68(var uParam0)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_69(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return uVar0;
}
		...
		else
		{
			...
			switch (iLocal_127)
			{
				case 0:
					...
					{
						if ((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_103[iLocal_125], PLAYER::PLAYER_PED_ID(), 15f, 15f, 40f, 0, 1, 0) && PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_103[iLocal_125])) || PED::_0x6CD5A433374D4CFB(iLocal_103[iLocal_125], PLAYER::PLAYER_PED_ID()))
						{
...
int func_73(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_69(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
...
int func_95()
{
	...
	while (iVar0 < iLocal_103)
	{
		if (!PED::IS_PED_INJURED(iLocal_103[iVar0]))
		{
			...
			if ((((((GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1), 5f, 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_103[iVar0], PLAYER::PLAYER_PED_ID(), 1)) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_103[iVar0])) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) + Vector(15f, 15f, 15f), -37975472, 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) + Vector(15f, 15f, 15f), -1813897027, 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) + Vector(15f, 15f, 15f), -1568386805, 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) + Vector(15f, 15f, 15f), 741814745, 1))
			{
				return 1;
			}
		}
...
void func_96()
{
	STREAMING::REQUEST_MODEL(663522487);
	STREAMING::REQUEST_MODEL(1069929536);
	STREAMING::REQUEST_MODEL(1603932804);
	if ((STREAMING::HAS_MODEL_LOADED(663522487) && STREAMING::HAS_MODEL_LOADED(1069929536)) && STREAMING::HAS_MODEL_LOADED(1603932804))
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(Local_48 - Vector(20f, 50f, 50f), Local_48 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(1069929536, 1);
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
		GAMEPLAY::ENABLE_DISPATCH_SERVICE(3, 0);
		iLocal_110[0] = VEHICLE::CREATE_VEHICLE(1069929536, 2209.17f, 5572.897f, 52.7565f, 255.5161f, 1, 1, 0);
		...
		iLocal_110[1] = VEHICLE::CREATE_VEHICLE(1069929536, 2195.473f, 5607.506f, 52.5648f, 168.4012f, 1, 1, 0);
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_110[1], 1, 0);
		VEHICLE::SET_VEHICLE_EXTRA(iLocal_110[1], 1, 0);
		iVar0 = 0;
		GAMEPLAY::SET_BIT(&iVar0, 1);
		uLocal_113 = OBJECT::CREATE_PICKUP_ROTATE(-831529621, Local_51, -1.368082f, 0.230633f, 176.8749f, iVar0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(40000, 100000), 2, 1, 1603932804);
		Local_54[0] = { 2205.769f, 5631.985f, 55.553f };
		fLocal_80[0] = 352.2203f;
		Local_54[1] = { 2210.584f, 5580.684f, 52.8132f };
		fLocal_80[1] = 300.5012f;
		Local_54[2] = { 2201.302f, 5589.279f, 52.9354f };
		fLocal_80[2] = 53.1602f;
		Local_54[3] = { 2202.535f, 5613.367f, 52.6781f };
		fLocal_80[3] = 70f;
		Local_54[4] = { 2200.764f, 5614.076f, 52.6852f };
		fLocal_80[4] = 53f;
		Local_54[5] = { 2193.714f, 5595.456f, 52.7615f };
		...
		while (iLocal_125 < 6)
		{
			iLocal_103[iLocal_125] = PED::CREATE_PED(26, 663522487, Local_54[iLocal_125], fLocal_80[iLocal_125], 1, 1);
			...
			if (iLocal_126 == 0)
			{
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_103[iLocal_125], 2017895192, -1, 1, 1);
			}
			else if (iLocal_126 == 1)
			{
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_103[iLocal_125], 324215364, -1, 1, 1);
			}
			else
			{
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_103[iLocal_125], -1074790547, -1, 1, 1);
			}
...
int func_111()
{
	if ((Global_111627 == func_53() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_111628)
	{
		return 1;
	}
	return 0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_110685) || Global_30770) || func_133()) || func_88(8, -1)) || func_132()) || func_131()) || func_130()) || func_129()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_134()) || Global_30770) || func_133()) || func_88(8, -1)) || func_130()) || func_132()) || func_131()) || func_129()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_110685) || Global_30770) || func_133()) || func_88(8, -1)) || func_130()) || func_132()) || func_131()) || func_129()) || Global_111638.f_7683.f_919[iVar0] == 5) || Global_41978 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_110685) || Global_30770) || func_133()) || func_88(8, -1)) || func_132()) || func_131()) || func_129()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_134()) || func_131()) || Global_110685) || Global_30770) || func_133()) || Global_42596) || func_88(8, -1)) || func_130()) || func_128()) || func_129()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
