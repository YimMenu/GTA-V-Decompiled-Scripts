void __EntryFunction__()
{
	...
	if (Var0 == 32)
	{
		...
		GAMEPLAY::CLEAR_AREA(Var61, 40f, 1, 0, 0, 0);
	}
	else if (Var0 == 34)
	{
		uLocal_97 = func_245();
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_207(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], 1), 1056964608))
				{
...
var func_170(struct<3> Param0, int iParam3)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_171(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
{
	if ((((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && !func_146()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_191(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_213(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_213(uParam1) && uParam1->f_4 == 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
bool func_222(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_223(&(Local_37[iVar4]), Var1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
{
	Var0 = { func_228(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
{
	Var0 = { func_228(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
...
int func_247(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			uParam0->f_25 = 1;
			uParam0->f_17[0] = { -303.512f, 6211.81f, 30.48759f };
...
int func_258(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			STREAMING::REQUEST_ANIM_DICT("rcmminute1");
			GAMEPLAY::CLEAR_AREA(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			iLocal_91 = 1;
			break;
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				if (func_127(uParam0->f_28[0]))
				{
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						...
						AI::TASK_PLAY_ANIM(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (func_127(uParam0->f_28[1]))
				{
					...
					AI::TASK_PLAY_ANIM(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, 0, 0, 0);
