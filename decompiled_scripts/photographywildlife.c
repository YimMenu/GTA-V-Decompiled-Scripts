...
void func_1()
{
	switch (iLocal_221)
	{
		case 0:
			...
			func_30();
			func_21();
			if (MISC::IS_BIT_SET(Global_111638.f_10044.f_99, 1) && !bLocal_214)
			{
				iLocal_221++;
			}
			break;
	...
	switch (iLocal_81)
	{
		case 0:
			if (bLocal_214)
			{
				if (!func_29())
				{
					uLocal_211 = unk_0x67D02A194A2FC2BD("MIDSIZED_MESSAGE");
...
void func_42()
{
	if (iLocal_217)
	{
		if ((func_17(&uLocal_208) > 5f && func_45() >= 1) && !MISC::IS_BIT_SET(Global_111638.f_10044.f_99, 1))
		{
			switch (iLocal_224)
			{
				case 0:
