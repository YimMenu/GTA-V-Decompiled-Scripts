...
void func_42()
{
	if (iLocal_238)
	{
		if ((func_17(&uLocal_229) > 5f && func_45() >= 1) && !MISC::IS_BIT_SET(Global_111638.f_10044.f_99, 1))
		{
			switch (iLocal_251)
			{
				case 0:
...
int func_72()
{
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(-113320193) > 0)
	{
		return 1;
	}
