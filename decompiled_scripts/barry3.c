...
void func_211()
{
	switch (iLocal_42)
	{
		...
		case 1:
			...
			{
				if ((func_217(uLocal_47[0], Local_237, 30f) || func_214(uLocal_47[0], PLAYER::PLAYER_PED_ID(), 1126825984, 0)) || func_214(uLocal_47[1], PLAYER::PLAYER_PED_ID(), 1126825984, 0))
				{
...
void func_287()
{
	...
	else if (iLocal_42 == 1)
	{
		...
		{
			if (!bLocal_57 && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 415.4781f, -771.7041f, 27.85562f, 415.5606f, -759.9372f, 31.36162f, 7.25f, 0, 1, 0) || func_288()))
			{
				bLocal_57 = true;
