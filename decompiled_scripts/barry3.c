...
void func_211()
{
	switch (iLocal_144)
	{
		...
		case 1:
			...
			{
				if ((func_217(uLocal_149[0], Local_360, 30f) || func_214(uLocal_149[0], PLAYER::PLAYER_PED_ID(), 1126825984, 0)) || func_214(uLocal_149[1], PLAYER::PLAYER_PED_ID(), 1126825984, 0))
				{
...
{
	Var0 = { func_216(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
void func_218(bool bParam0)
{
	if (bParam0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_148))
		{
			...
			AI::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_148, 0), 200f, -1, 0, 0);
...
int func_237()
{
	if ((!ENTITY::DOES_ENTITY_EXIST(iLocal_148) && STREAMING::HAS_MODEL_LOADED(iLocal_153)) && STREAMING::HAS_MODEL_LOADED(iLocal_154))
	{
		...
		WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uLocal_149[0], 453432689, -1, 1);
		WEAPON::SET_PED_INFINITE_AMMO(uLocal_149[0], 1, 453432689);
		uLocal_149[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_148, 6, iLocal_154, 0, 1, 1);
		WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uLocal_149[1], 453432689, -1, 1);
		WEAPON::SET_PED_INFINITE_AMMO(uLocal_149[1], 1, 453432689);
		VEHICLE::SET_VEHICLE_SIREN(iLocal_148, 1);
		VEHICLE::SET_VEHICLE_FORWARD_SPEED(iLocal_148, 20f);
		AI::TASK_VEHICLE_DRIVE_TO_COORD(uLocal_149[0], iLocal_148, Local_360, 20f, 1, iLocal_153, 786603, 5f, 5f);
		return 1;
	}
	return 0;
}
...
void func_262(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_AREA_OF_PEDS(func_263(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_270(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_271(Var18[0], Var18[1], Var6, Var9) || func_271(Var18[0], Var18[1], Var9, Var15)) || func_271(Var18[0], Var18[1], Var12, Var15)) || func_271(Var18[0], Var18[1], Var6, Var12)) || func_271(Var18[1], Var18[3], Var6, Var9)) || func_271(Var18[1], Var18[3], Var9, Var15)) || func_271(Var18[1], Var18[3], Var12, Var15)) || func_271(Var18[1], Var18[3], Var6, Var12)) || func_271(Var18[3], Var18[2], Var6, Var9)) || func_271(Var18[3], Var18[2], Var9, Var15)) || func_271(Var18[3], Var18[2], Var12, Var15)) || func_271(Var18[3], Var18[2], Var6, Var12)) || func_271(Var18[2], Var18[0], Var6, Var9)) || func_271(Var18[2], Var18[0], Var9, Var15)) || func_271(Var18[2], Var18[0], Var12, Var15)) || func_271(Var18[2], Var18[0], Var6, Var12))
		{
			return 1;
		}
	}
...
bool func_311(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_312(&(Local_37[iVar4]), Var1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
{
	Var0 = { func_216(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_358(int iParam0, bool bParam1, var uParam2)
{
	*uParam2 = 0;
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_359(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != 873639469) && ENTITY::GET_ENTITY_MODEL(iParam0) != -1177863319)
		{
			*uParam2 = 2;
			return 0;
		}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_390(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_268(iParam0, 0, 0)) || func_268(iParam0, 1, 0)) || func_268(iParam0, 2, 0)) || func_406(iParam0) != 145) || func_405(iParam0)) || func_404(iParam0)) || func_359(iParam0)) || func_403(iParam0)) || !func_393(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_404(iParam0))
		{
		}
...
int func_410(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_382(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_413(*uParam0, ((*uParam1)[38] - 1)))
	{
...
{
	return func_426(&(Global_105187.f_2890), Param0, fParam3, 0);
}
	...
	if (func_443(uParam0))
	{
		...
		if (func_442(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_428(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_428(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_430(iParam0, uVar1[iVar6], 1) && func_429(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_424(Param1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_431(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_390(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_390(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_390(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == 340154634 || uParam1->f_66 == -1960756985)
		{
			...
			while (iVar2 <= 9)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_390(iVar2)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_390(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_390(iVar3)))
				{
				}
				else
				{
					GAMEPLAY::SET_BIT(&(uParam1->f_77), func_390(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_390(iVar4)))
					{
					}
					else
					{
						GAMEPLAY::SET_BIT(&(uParam1->f_77), func_390(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_434(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_433())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_390(iVar5 + 1)))
				{
