...
void func_211()
{
	switch (iLocal_42)
	{
		...
		case 1:
			...
			{
				if ((func_217(iLocal_47[0], Local_237, 30f) || func_214(iLocal_47[0], PLAYER::PLAYER_PED_ID(), 1126825984, 0)) || func_214(iLocal_47[1], PLAYER::PLAYER_PED_ID(), 1126825984, 0))
				{
...
int func_214(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_216(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_236(bool bParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_39.f_41[0]))
	{
		if (bParam0)
		{
			...
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_39.f_41[0], iLocal_45, PED::GET_PED_BONE_INDEX(iLocal_45, 60309), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true);
			}
		}
...
int func_237()
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iLocal_46) && STREAMING::HAS_MODEL_LOADED(iLocal_49)) && STREAMING::HAS_MODEL_LOADED(iLocal_50))
	{
		Var0 = { Local_235 };
		fVar1 = fLocal_240;
		if (func_238(PLAYER::PLAYER_PED_ID(), Local_235, 1) < func_238(PLAYER::PLAYER_PED_ID(), Local_236, 1))
		{
			Var0 = { Local_236 };
			fVar1 = fLocal_241;
		}
...
bool func_244()
{
	if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (func_234(iLocal_45, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 15f, 1))
			{
				bLocal_55 = true;
				AUDIO::STOP_SCRIPTED_CONVERSATION(false);
				func_218(0);
...
int func_284(int iParam0, var uParam1)
{
	...
	iVar0 = Global_2583656[iParam0 /*3*/][func_68(uParam1)];
...
void func_287()
{
	...
	else if (iLocal_42 == 1)
	{
		...
		{
			if (!bLocal_57 && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 415.4781f, -771.7041f, 27.85562f, 415.5606f, -759.9372f, 31.36162f, 7.25f, false, true, 0) || func_288()))
			{
				bLocal_57 = true;
...
int func_303(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
...
int func_307()
{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(iLocal_45))
	{
		...
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_45, PLAYER::PLAYER_PED_ID(), true) || func_324(PLAYER::PLAYER_PED_ID(), iLocal_45, 1))
		{
...
{
	return func_426(&(Global_105187.f_2890), Param0, fParam1, 0);
}
...
int func_428(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_430(iParam0, uVar1[iVar3], 1) && func_429(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_424(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
