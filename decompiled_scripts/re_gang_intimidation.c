void __EntryFunction__()
{
	...
	iVar7 = 0;
	iLocal_51 = 3;
	Local_226 = { ScriptParam_0.f_1[0] };
	Local_229[0] = { 1283.85f, -1622.501f, 53.2255f };
	fLocal_239[0] = 198.9926f;
	Local_229[1] = { 1286.655f, -1627f, 53.225f };
	fLocal_239[1] = 22.3073f;
	Local_229[2] = { 1286.452f, -1624.782f, 53.225f };
	...
	while (iVar0 != 7)
	{
		...
		switch (iVar0)
		{
			...
			case 4:
				...
				AI::TASK_PLAY_ANIM(iVar22, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, -1, 49, 0, 0, 0, 0);
				...
				while (iVar24 <= (iLocal_51 - 1))
				{
					...
					{
						iVar18[iVar24] = PED::CREATE_PED(12, Var1[iVar24], Local_229[iVar24], fLocal_239[iVar24], 1, 1);
				...
				WEAPON::GIVE_WEAPON_TO_PED(iVar18[0], 2017895192, 40, 1, 1);
			...
			case 5:
				...
				if (iVar7 < 3)
				{
					if ((((((((func_79(&iVar18, &uVar11, &uVar10, &uVar9, uVar8, bVar12, 1075838976, 0) || func_78(iVar18[0], 0)) || func_78(iVar18[1], 0)) || func_78(iVar18[2], 0)) || GAMEPLAY::IS_BULLET_IN_AREA(Local_229[0], 40f, 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(Local_229[0] - Vector(25f, 25f, 25f), Local_229[0] + Vector(25f, 25f, 25f), -37975472, 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(Local_229[0] - Vector(25f, 25f, 25f), Local_229[0] + Vector(25f, 25f, 25f), -1813897027, 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(Local_229[0] - Vector(25f, 25f, 25f), Local_229[0] + Vector(25f, 25f, 25f), -1568386805, 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(Local_229[0] - Vector(25f, 25f, 25f), Local_229[0] + Vector(25f, 25f, 25f), 741814745, 1))
					{
						iVar25 = 0;
						while (iVar25 < iVar18)
						{
						...
						if (!PED::IS_PED_INJURED(iVar22))
						{
							if (!PED::IS_PED_INJURED(iVar22))
							{
								AI::CLEAR_PED_TASKS(iVar22);
								AI::OPEN_SEQUENCE_TASK(&iLocal_50);
								AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1000, 2048, 2);
								AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
								AI::CLOSE_SEQUENCE_TASK(iLocal_50);
								AI::TASK_PERFORM_SEQUENCE(iVar22, iLocal_50);
								AI::CLEAR_SEQUENCE_TASK(&iLocal_50);
...
int func_1(int iParam0, struct<6> Param1, int iParam7, int iParam8, int iParam9, int iParam10)
{
	if (*iParam0 >= 3)
	{
		...
		{
			if ((!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_257, 9f, 9f, 9f, 0, 1, 0) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1276.21f, -1613.05f, 53f, 9f, 9f, 9f, 0, 1, 0)) || AI::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()))
			{
				*iParam0 = 6;
			}
		}
	...
	switch (*iParam0)
	{
			...
			if (func_60(iParam7, iParam8))
			{
				...
				if (!PED::IS_PED_INJURED(iParam7))
				{
					...
					if (!func_78(iParam7, 0))
					{
						...
						{
							if ((WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::_0x6CD5A433374D4CFB(iParam7, PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
							{
								...
								{
									AI::CLEAR_PED_SECONDARY_TASK(iParam7);
									AI::TASK_LOOK_AT_ENTITY(iParam7, PLAYER::PLAYER_PED_ID(), 5000, 1024, 2);
									func_76();
									SYSTEM::WAIT(1000);
									...
									if (!PED::IS_PED_INJURED(iParam7))
									{
										AI::TASK_SMART_FLEE_PED(iParam7, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
				...
				else if (PED::IS_PED_RAGDOLL(iParam7))
				{
					...
					{
						AI::STOP_ANIM_TASK(iParam7, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", -1056964608);
					}
				}
			}
			else
		...
		case 2:
			...
			Local_257 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
...
int func_35(struct<6> Param0, int iParam6, var uParam7)
{
	switch (iLocal_252)
	{
		...
		case 1:
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iParam6, 242628503) == 7 || ENTITY::IS_ENTITY_AT_ENTITY(iParam6, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0))
				{
					if (!func_75())
					{
		...
		case 2:
			if (!PED::IS_PED_INJURED((*uParam7)[2]))
			{
				if (!PED::IS_PED_INJURED((*uParam7)[0]))
				{
					...
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_229[0], 1f, -1, 0.25f, 0, 40000f);
					AI::TASK_ACHIEVE_HEADING(0, fLocal_239[0], 0);
					AI::TASK_PLAY_ANIM_ADVANCED(0, Param0.f_5, "sit_down_idle_01", Local_229[0], 0f, 0f, fLocal_239[0], 1000f, -4f, -1, 1, 0, 2, 0);
					AI::CLOSE_SEQUENCE_TASK(iLocal_50);
				...
				if (!PED::IS_PED_INJURED((*uParam7)[1]))
				{
					...
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_229[1], 1f, -1, 0.25f, 0, 40000f);
...
int func_60(int iParam0, var uParam1)
{
	switch (iLocal_255)
	{
						...
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID()))
						{
							if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) < 5f)
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iParam0, 10f, 10f, 10f, 0, 1, 0))
								{
									...
									AI::CLOSE_SEQUENCE_TASK(iLocal_50);
									AI::TASK_PERFORM_SEQUENCE(iParam0, iLocal_50);
									AI::CLEAR_SEQUENCE_TASK(&iLocal_50);
									if (UI::DOES_BLIP_EXIST(uLocal_225))
									{
		...
		case 1:
			...
			{
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_243, 13f, 0, 0, 0, 0, 0, 0);
				AI::CLEAR_PED_SECONDARY_TASK(iParam0);
				if (!PED::IS_PED_INJURED(iParam0))
				{
					AI::OPEN_SEQUENCE_TASK(&iLocal_50);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_243, 2f, 20000, 0.25f, 0, 32.2195f);
			...
			else if (!PED::IS_PED_INJURED(iParam0))
			{
				if (SYSTEM::TIMERA() > 8000 && ENTITY::IS_ENTITY_AT_COORD(iParam0, Local_243, 3f, 3f, 3f, 0, 1, 0))
				{
					if (PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 60f))
					{
						if (func_164())
						{
							AI::TASK_PLAY_ANIM(iParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_a", 2f, -2f, -1, 48, 0, 0, 0, 0);
						}
						else
						{
							AI::TASK_PLAY_ANIM(iParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, -1, 0, 0, 0, 0, 0);
						}
		...
		case 4:
			if (!PED::IS_PED_INJURED(iParam0))
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_243, 2f, 20000, 0.25f, 0, 40000f);
				AI::CLOSE_SEQUENCE_TASK(iLocal_50);
				AI::CLEAR_SEQUENCE_TASK(&iLocal_50);
				iLocal_50 = 0;
			}
...
int func_63()
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), 782665360))
			{
				return 1;
			}
		}
					...
					if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iParam0))
					{
						if (fVar9 < fVar0)
						{
							if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 17))
							{
								...
								func_85("\n");
								func_81("		time since not LockedOn = ", (GAMEPLAY::GET_GAME_TIMER() - iLocal_45));
								func_85("\n");
								bVar2 = true;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_100()) || Global_110685) || Global_30770) || func_99()) || func_58(8, -1)) || func_98()) || func_97()) || func_96()) || func_95()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_100()) || Global_30770) || func_99()) || func_58(8, -1)) || func_96()) || func_98()) || func_97()) || func_95()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_100()) || Global_110685) || Global_30770) || func_99()) || func_58(8, -1)) || func_96()) || func_98()) || func_97()) || func_95()) || Global_111638.f_7683.f_919[iVar0] == 5) || Global_41978 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_100()) || Global_110685) || Global_30770) || func_99()) || func_58(8, -1)) || func_98()) || func_97()) || func_95()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_100()) || Global_30770) || func_99()) || func_58(8, -1)) || func_97()) || func_96()) || func_95()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_100()) || func_97()) || Global_110685) || Global_30770) || func_99()) || Global_42596) || func_58(8, -1)) || func_96()) || func_94()) || func_95()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_100()) || Global_110685) || Global_30770) || func_99()) || func_58(8, -1)) || func_96()) || func_94()) || func_98()) || func_97()) || func_95())
						{
							return 0;
						}
						break;
