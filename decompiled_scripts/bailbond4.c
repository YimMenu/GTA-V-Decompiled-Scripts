void __EntryFunction__()
{
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			Local_619 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
			func_422();
			func_421();
			switch (iLocal_98)
			{
	...
	if (func_23(Local_322))
	{
		if (func_434(Local_330))
		{
			if (func_58(2))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(Local_322, uVar0, func_41(), func_51(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_330, uVar0, func_50(), func_41(), 1000f, -8f, iVar1, 1148846080);
...
void func_121(int iParam0)
{
	...
	{
		if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_132[iParam0]) == iLocal_597)
		{
			...
			AI::TASK_LOOK_AT_ENTITY(Local_132[iParam0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			if (!PED::IS_PED_FLEEING(Local_132[iParam0]))
			{
				if (PED::IS_PED_USING_ANY_SCENARIO(Local_132[iParam0]))
				{
					PED::_0xF1C03A5352243A30(Local_132[iParam0]);
				}
				AI::TASK_CLEAR_LOOK_AT(Local_132[iParam0]);
				AI::CLEAR_PED_SECONDARY_TASK(Local_132[iParam0]);
				AI::CLEAR_PED_TASKS(Local_132[iParam0]);
				AI::TASK_HANDS_UP(Local_132[iParam0], -1, PLAYER::PLAYER_PED_ID(), -1, 0);
			}
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_132[iParam0], 1);
			Local_132[iParam0].f_14 = 2;
		}
		else
		{
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0], 13, 0);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0], 5, 0);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0], 17, 1);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0], 0, 1);
	...
	if (func_23(Local_112.f_9))
	{
		...
		switch (iLocal_100)
		{
			case 0:
				...
				Local_634 = { ENTITY::GET_ENTITY_COORDS(Local_112.f_9, 0) };
				...
				if (!iLocal_382)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_120(iLocal_397, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_112(Local_112.f_9, Local_619, 30f))
									{
			...
			switch (Local_112.f_10)
			{
				...
				case 31:
					if (func_120(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_622, PLAYER::PLAYER_PED_ID(), 1f, 1, 1056964608, 1082130432, 1, 0, 0, -957453492, 20000);
						...
						AI::TASK_SET_SPHERE_DEFENSIVE_AREA(0, Local_622, 50f);
						AI::CLOSE_SEQUENCE_TASK(uLocal_418);
						AI::TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_418);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_418);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
				...
				case 33:
					if (func_120(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_622, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.5f, 4f, 1, 0, 0, -687903391, 20000);
				...
				case 35:
					if (func_120(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						AI::OPEN_SEQUENCE_TASK(&uLocal_418);
						AI::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 750, 0);
						AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_622, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.75f, 4f, 1, 0, 0, -687903391, 20000);
						AI::CLOSE_SEQUENCE_TASK(uLocal_418);
						AI::TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_418);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_418);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
				...
				case 13:
					if (func_120(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
						{
							PED::_0xFE07FF6495D52E2A(Local_112.f_9, Local_619);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_112.f_9, &iVar0, 1);
						if (iVar0 != -1569615261)
						{
				...
				case 15:
					...
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_191[0], 0) && func_112(Local_191[0], Local_191[0].f_1, 3f)) && func_369(ENTITY::GET_ENTITY_HEADING(Local_191[0]), Local_191[0].f_4, 20f))
						{
							if (PED::IS_PED_IN_VEHICLE(Local_112.f_9, Local_191[0], 0) && !PED::IS_PED_BEING_JACKED(Local_112.f_9))
							{
								Local_112.f_10 = 16;
							}
							else if (func_120(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								...
								AI::TASK_ENTER_VEHICLE(Local_112.f_9, Local_191[0], 25000, -1, 2f, 8388608, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
								Local_112.f_10 = 16;
							}
						}
				...
				case 16:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_191[0], 0) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_112(Local_191[0], Local_191[0].f_1, 3f)) || !func_369(ENTITY::GET_ENTITY_HEADING(Local_191[0]), Local_191[0].f_4, 20f))
					{
						Local_112.f_10 = 13;
					}
					else if (PED::IS_PED_SITTING_IN_VEHICLE(Local_112.f_9, Local_191[0]))
					{
						Local_112.f_10 = 39;
					}
				...
				case 17:
					if (func_102(Local_191[0]) && PED::IS_PED_SITTING_IN_VEHICLE(Local_112.f_9, Local_191[0]))
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_112.f_9, Local_191[0], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 350f, 30f, 1);
			...
			else
			{
				...
				else if (Local_112.f_10 == 24 && func_64(Local_112.f_9, -1519143300))
				{
					if (func_112(Local_112.f_9, Local_619, 25f))
					{
						...
						{
							if (func_120(iLocal_398, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_62())
								{
									func_5();
				...
				else
				{
					...
					if (!func_62())
					{
						if (func_120(iLocal_397, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_112(Local_112.f_9, Local_619, 20f))
							{
		...
		if (func_23(Local_132[iVar0]))
		{
			...
			switch (Local_132[iVar0].f_14)
			{
				...
				case 2:
					...
					{
						if (!func_23(Local_112.f_9) || (PED::IS_PED_FLEEING(Local_112.f_9) && AI::GET_PED_DESIRED_MOVE_BLEND_RATIO(Local_112.f_9) > 1f))
						{
							if (AI::GET_SCRIPT_TASK_STATUS(Local_132[iVar0], -1519143300) == 1)
							{
								if (iVar0 == 0)
								{
									iVar2 = 750;
								...
								AI::UPDATE_TASK_HANDS_UP_DURATION(Local_132[iVar0], iVar2);
							}
							else
							{
								AI::CLEAR_PED_TASKS(Local_132[iVar0]);
								AI::CLEAR_PED_SECONDARY_TASK(Local_132[iVar0]);
							}
							Local_132[iVar0].f_14 = 4;
							func_116(&(Local_132[iVar0].f_6));
						}
					...
					{
						func_116(&(Local_132[iVar0].f_6));
						if (func_112(Local_132[iVar0], Local_619, 5f))
						{
							if (!func_363(Local_132[iVar0].f_16, 10))
							{
								PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_132[iVar0], ENTITY::GET_ENTITY_COORDS(Local_132[iVar0], 1), 5f, 0, 0);
								AI::TASK_COMBAT_PED(Local_132[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_132[iVar0], 1);
							}
						}
					}
					else
					{
						if (!func_112(Local_132[iVar0], Local_619, 7f))
						{
							AI::CLEAR_PED_TASKS(Local_132[iVar0]);
							AI::TASK_LOOK_AT_ENTITY(Local_132[iVar0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_132[iVar0], PLAYER::PLAYER_PED_ID(), -1);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_132[iVar0], 0);
						}
...
int func_401(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, float fParam6)
{
	if (func_23(iParam0))
	{
		...
		{
			Var0 = { ENTITY::GET_ENTITY_COORDS(iParam0, 1) };
			if (GAMEPLAY::IS_BULLET_IN_AREA(Var0, fParam5, 1))
			{
				return 1;
			}
			if (func_112(iParam0, Local_619, fParam2))
			...
			Var3.y = (Var3.y - fParam6);
			Var3.z = (Var3.z - fParam6);
			Var6.x = (Var6.x + fParam6);
			Var6.y = (Var6.y + fParam6);
			Var6.z = (Var6.z + fParam6);
			if (GAMEPLAY::IS_PROJECTILE_IN_AREA(Var3, Var6, 1))
			{
				return 1;
			}
...
void func_524()
{
	...
	while (iVar0 <= 2)
	{
		if (func_23(Local_132[iVar0]))
		{
			...
			if (iVar0 == 0 || iVar0 == 2)
			{
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_132[iVar0], iLocal_597);
			}
			...
			switch (iVar0)
			{
				case 0:
					...
					AI::SET_SEQUENCE_TO_REPEAT(uLocal_418, 1);
					AI::CLOSE_SEQUENCE_TASK(uLocal_418);
					AI::TASK_PERFORM_SEQUENCE(Local_132[iVar0], uLocal_418);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_418);
					break;
...
int func_526()
{
	...
	if (iVar1 == iLocal_407)
	{
		...
		while (iVar2 <= (iLocal_407 - 1))
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_132[iVar2].f_18);
			iVar2++;
		}
	}
	if (iLocal_404 > 0)
	...
	if (iLocal_403 > 0)
	{
		...
		while (iVar2 <= (iLocal_403 - 1))
		{
			...
			{
				ENTITY::FREEZE_ENTITY_POSITION(Local_277[iVar2], 1);
				iVar0++;
			}
			iVar2++;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_546()) || Global_110685) || Global_30770) || func_552()) || func_95(8, -1)) || func_551()) || func_550()) || func_544()) || func_545()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_546()) || Global_30770) || func_552()) || func_95(8, -1)) || func_544()) || func_551()) || func_550()) || func_545()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_546()) || Global_110685) || Global_30770) || func_552()) || func_95(8, -1)) || func_544()) || func_551()) || func_550()) || func_545()) || Global_111638.f_7683.f_919[iVar0] == 5) || Global_41978 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_546()) || Global_110685) || Global_30770) || func_552()) || func_95(8, -1)) || func_551()) || func_550()) || func_545()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_546()) || Global_30770) || func_552()) || func_95(8, -1)) || func_550()) || func_544()) || func_545()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_546()) || func_550()) || Global_110685) || Global_30770) || func_552()) || Global_42596) || func_95(8, -1)) || func_544()) || func_549()) || func_545()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_546()) || Global_110685) || Global_30770) || func_552()) || func_95(8, -1)) || func_544()) || func_549()) || func_551()) || func_550()) || func_545())
						{
							return 0;
						}
						break;
