void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUM_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(1142066399) > 1)
	{
...
int func_18(var uParam0, int iParam1)
{
	...
	if (uParam0->f_11)
	{
		...
		if (!func_25(44))
		{
			...
			{
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_23(iVar8), Var5, 0) > 200f)
				{
...
int func_28(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Global_111638.f_10044.f_108, func_33(func_34(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
int func_36(var uParam0, var uParam1, struct<3> Param2)
{
	...
	if (uParam1[iVar0]->f_10)
	{
		...
		{
			if (OBJECT::HAS_PICKUP_BEEN_COLLECTED(uParam1[iVar0]->f_1) || func_49(uParam1[iVar0]->f_1))
			{
	...
	{
		if ((SYSTEM::VDIST2(Param2, OBJECT::GET_PICKUP_COORDS(uParam1[iVar0]->f_1)) > (60f * 60f) || func_38(13)) || func_38(14))
		{
...
int func_63()
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (ENTITY::GET_ENTITY_MODEL(uVar0) == 1033245328 || ENTITY::GET_ENTITY_MODEL(uVar0) == 276773164)
			{
				return 1;
			}
			else
...
void func_64()
{
	...
	if (func_24(&Local_42, &Local_55, Var0, &iLocal_388))
	{
		...
		fVar6 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Var3, Var0, 0);
		if (fVar6 > 200f)
		{
			func_66();
			if (!iLocal_406)
			...
			if (func_63())
			{
				...
				if (!UI::DOES_BLIP_EXIST(uLocal_390))
				{
					uLocal_390 = UI::ADD_BLIP_FOR_RADIUS(Var3, 200f);
		...
		else
		{
			...
			if (Local_42.f_1.f_4 < Local_42.f_1.f_3)
			{
				...
				else
				{
					...
					{
						uLocal_392 = UI::ADD_BLIP_FOR_RADIUS(Var3, fLocal_403);
					...
					if (func_63())
					{
						...
						while (iVar7 <= 3)
						{
							...
							{
								uLocal_393[iVar7] = UI::ADD_BLIP_FOR_RADIUS(Var3, (fLocal_403 + fLocal_398[iVar7]));
